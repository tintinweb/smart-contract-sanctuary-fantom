...
// File contracts/FortniteToken.sol
...
contract FortniteToken is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 50,000,000,000,000 FNTs
    ...
    constructor(uint256 _startTime, address _devFund) public ERC20("Fortnite Token", "FNT") {
        _mint(msg.sender, 50000000000000 ether); 
