...
contract Cronje is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 CRONJE
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("CRONJE", "CRONJE") {
        _mint(msg.sender, 1 ether); // mint 1 CRONJE Share for initial pools deployment
