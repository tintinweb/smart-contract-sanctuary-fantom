...
interface IVault {
    ...
    function buyUDSA(address _token, address _receiver) external returns (uint256);

    function sellUDSA(address _token, address _receiver) external returns (uint256);
...
contract Reader is Governable {
    ...
    uint256 public constant UDSA_DECIMALS = 18;
    ...
    function getMaxAmountIn(
        ...
        if (maxUsdaAmount != 0) {
            ...
            maxAmountIn = maxAmountIn.mul(10**tokenInDecimals).div(10**UDSA_DECIMALS);
    ...
    function getAmountOut(
        ...
        uint256 feeBasisPoints;
        {
            ...
            usdaAmount = usdaAmount.mul(10**UDSA_DECIMALS).div(10**tokenInDecimals);
