...
contract LCELBeta is Context, Ownable {

//vars
	address public store = 0x59b14a6a25102263BCa9D4Af3A10d2aFe1e082B4;
	address private devW = 0xD39E67617976cb95a6CE7762DeE1B4A0f9478fbb;
	address private rndm = 0x87d57F92852D7357Cf32Ac4F6952204f2B0c1A27;
	address public gameItems = 0xc9145f4B57781084af63c6807928867d804217D3;
	address public champBase = 0x58fAaE1424ba4D8300767dD9e636B7a28772489a;
    address public champLogic = 0x111ff1A1A4AAfc90eb33356CD17D17ae67c70dda;
	address public itemBase = 0x5C6E5Ef3B0d49353935655d795d91601BA10cbaF;
    IConqStorage db = IConqStorage(store);
    IitemLogic items = IitemLogic(gameItems);
    IRNDM tokenContract = IRNDM(rndm);
	uint256 public feeStep = 0.01 ether;
	uint256 public startStep = 0.012 ether;
	uint256 public attackMul = 10;
	uint256 public assistMul = 5;
	uint256 public hijackMul = 3;
...
//PUBLIC
  ...
  function hijackMessage(string memory _country,string memory _message) external {
    ...
    require(tokenContract.transferFrom(
        msg.sender,
        address(this),
        db.getValueOfCountry(_country) * hijackMul
        ) == true,
...
//ADMIN
  ...
  function setHijackPrice(uint256 value) external onlyOwner {
      hijackMul = value;
  }
