...
contract HecBridgeSplitter is AccessControlUpgradeable, PausableUpgradeable {
	...
	function getReserveBridgesCounthahah() external view returns (uint256) {
    ...
    **/
	...
	/**
        ...
        @return bool
     */
	function isReservedBridge(address _address) public view returns (bool) {
	...
	/**
        ...
        @return bool
     */
	function isReservedAsset(address _address) public view returns (bool) {
     ...
     */
	function _performBridge(address callTargetAddress, bytes memory callData, uint256 sendValue) internal {
		bool success;
		bytes memory result;
