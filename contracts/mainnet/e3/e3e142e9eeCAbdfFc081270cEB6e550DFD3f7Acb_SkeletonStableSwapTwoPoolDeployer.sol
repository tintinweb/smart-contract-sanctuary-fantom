...
contract SkeletonStableSwapTwoPool is Ownable, ReentrancyGuard {
...
import "@openzeppelin-4.5.0/contracts/access/Ownable.sol";
import "./SkeletonStableSwapTwoPool.sol";

contract SkeletonStableSwapTwoPoolDeployer is Ownable {
    uint256 public constant N_COINS = 2;
    ...
    function createSwapPair(
        ...
        bytes memory bytecode = type(SkeletonStableSwapTwoPool).creationCode;
        ...
        SkeletonStableSwapTwoPool(swapContract).initialize(coins, _A, _fee, _admin_fee, _admin, _LP);
