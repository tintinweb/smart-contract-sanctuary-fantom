    ...
    ClampedRandomizer
{
    ...
    uint256 public maxPerPerson = 150;
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("Spawn of the Pit", "SOTP") ClampedRandomizer(maxSupply) {     
    ...
    function mint(uint256 amount) public payable whenNotPaused {
        ...
        require(msg.value == wlPrice * amount, "Error: invalid price");
    ...
    function isAddressWhitelisted(address user) public view returns(bool) {return isWhiteListed[user];}

    function whitelistPrice() public view returns (uint256) { return wlPrice; }
