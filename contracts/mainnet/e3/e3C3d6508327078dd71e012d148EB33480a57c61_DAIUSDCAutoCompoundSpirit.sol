 ...
 */
contract DAIUSDCAutoCompoundSpirit is IStrategy, Ownable, Pausable {
    ...
    constructor(
        ...
        rewardTokenToLp0Route = [rewardToken, wftm, lpToken0]; // spirit -> wftm -> usdc
        rewardTokenToLp1Route = [rewardToken, wftm, lpToken0, lpToken1]; // spririt -> wftm -> usdc -> dai
