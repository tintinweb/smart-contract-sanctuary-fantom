...
contract TombMonsterZapper is Ownable {
   ...
   // @in - LP we want to throw in
    ...
    function _swapNativeToEqualTokensAndProvide(address token0, address token1, uint256 amount, address routerAddress, address recipient) private returns (uint256) {
        ...
        if (pair._token0 == WNATIVE) {
            ...
            uint256 amountToken1 = _swapNativeForToken(pair._token1,  args._swapAmt, address(this), args._routerAddr);
            ...
            _dustDistribution(amountToken0, amountToken1, pair._amountToken0, pair._amountToken1,  pair._token1, pair._token0, args._recipient);
            return pair._liqTokenAmt;
