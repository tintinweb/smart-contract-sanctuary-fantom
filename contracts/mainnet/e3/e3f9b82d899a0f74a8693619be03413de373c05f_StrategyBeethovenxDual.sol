...
contract StrategyBeethovenxDual is StratManager, FeeManager {
    ...
    bytes32 public wantPoolId; // Target LP Pool
    bytes32 public nativeSwapPoolId; // Swap to native token pool
    bytes32 public inputSwapPoolId; // Token used to get more LP tokens
    bytes32 public rewardSwapPoolId; // Pool used to sell secondary rewards
