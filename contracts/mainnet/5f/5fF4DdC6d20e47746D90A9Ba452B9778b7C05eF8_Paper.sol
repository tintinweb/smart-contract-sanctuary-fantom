...
contract Paper is ERC20Burnable, Operator {
    /**
     * @notice Constructs the DOLLAR Paper ERC-20 contract.
     */
    constructor() ERC20("PAPER", "PAPER") {}

    /**
     * @notice Operator mints basis papers to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of basis papers to mint to
