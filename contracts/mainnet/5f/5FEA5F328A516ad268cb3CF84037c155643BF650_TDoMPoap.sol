...
contract TDoMPoap is ERC721Enumerable, Ownable, ERC2981 {
  using Strings for uint256;

  bytes4 private constant _INTERFACE_ID_ERC2981 = 0x2a55205a;
  string baseURI;
  string public baseExtension = ".json";
  string private metadataName = "TDoMMetadata";
  address[] private team = [
    0x11584D6AaeBFdbF48Cd5A11599BF40b5bC386837  //Funeral - art
  ];
  uint256 public cost = 2 ether;
  uint256 public maxMintAmount = 1;
  bool public publicPaused = true;
  address public royaltyAddr = 0x11584D6AaeBFdbF48Cd5A11599BF40b5bC386837;
  ...
  constructor(
    ...
    _setReceiver(address(royaltyAddr));
    ...
    returns (string memory)
  {
    ...
    return bytes(currentBaseURI).length > 0
        ? string(abi.encodePacked(currentBaseURI, metadataName, baseExtension))
        : "";
  }
