...
// File contracts/BIFI/strategies/Beethovenx/StrategyBeethovenxDualRewardsSpookyRouter.sol

pragma solidity ^0.8.0;

contract StrategyBeethovenxDualRewardsSpookyRouter is StratFeeManager, GasFeeThrottler {
    ...
    constructor(
        ...
        input.input = _nativeToInputRoute[_nativeToInputRoute.length - 1];
    ...
    function addLiquidity() internal {
        ...
        balancerJoin(wantPoolId, input.input, inputBal);
    }
    ...
    function _giveAllowances() internal {
        ...
        IERC20(input.input).safeApprove(unirouter, type(uint256).max);
    }
