...
//==============================deposit fee addition needed=========================================================
    ...
    function nftDeposit(uint256 _pid, uint256[] calldata _tokenIds) external onlyOneBlock {
    ...
    // Withdraw tokens.
    function nftwithdraw(uint256 _pid, uint256[] calldata _tokenIds) external onlyOneBlock {
