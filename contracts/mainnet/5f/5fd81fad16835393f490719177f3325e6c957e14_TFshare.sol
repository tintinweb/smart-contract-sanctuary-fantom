...
contract TFshare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 50,000 TFshare
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("TFshare Shares", "TFshare") {
        _mint(msg.sender, 1 ether); // mint 1 TFShare for initial pools deployment
