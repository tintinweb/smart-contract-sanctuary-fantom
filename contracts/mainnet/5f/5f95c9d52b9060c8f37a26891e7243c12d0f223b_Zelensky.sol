...
contract Zelensky is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 ZELENSKY
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 79500 ether;
    ...
    uint256 public constant VESTING_DURATION = 490 days;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("ZELENSKY", "ZELENSKY") {
        _mint(msg.sender, 1 ether); // mint 1 ZELENSKY Share for initial pools deployment
