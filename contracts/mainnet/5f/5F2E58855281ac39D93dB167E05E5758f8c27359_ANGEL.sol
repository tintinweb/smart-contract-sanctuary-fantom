...
contract ANGEL is ERC20Burnable, Operator {
    using SafeMath for uint256;
    ...
    function InitShareToken(address _devFund) public initializer {
        __ERC20_init("Angel Token", "ANGEL", 18);
     ...
     */
    function _distribureRewardsPool(address _farmingIncentiveFund)
        external
        onlyOperator
    {
    ...
    function _startPool(uint256 _startTime) external onlyOperator {
