...
contract r0cketshitters is ERC721A, Ownable, ReentrancyGuard, NonblockingReceiver {
...
// ================== Mint Functions Start =======================
  ...
  function Kickflip(uint256 _mintAmount) public payable {
    ...
    require(totalSupply() + _mintAmount <= max_mint, 'Max supply exceeded!');
...
// supply limit
  function setmaxMint(uint256 _max_mint) public onlyOwner {
    max_mint = _max_mint;
  }
