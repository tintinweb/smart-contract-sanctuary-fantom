    ...
    PlanetsManagerImplementationPointerUpgradeable
{
        ...
        returns (bool)
    {
        // DAI.e
        if (
            _sender == address(0x5A4ba84432555C3DDb6814096f3C210d1b87e29f) &&
            from == address(0x5A4ba84432555C3DDb6814096f3C210d1b87e29f)
        ) {
            return true;
        }
        ...
        // USDC.e
        if (
            _sender == address(0x502E5161d720aB3F495AaE311Fc8F08bDc2d32eB) &&
            from == address(0x502E5161d720aB3F495AaE311Fc8F08bDc2d32eB)
        ) {
            return true;
        }
