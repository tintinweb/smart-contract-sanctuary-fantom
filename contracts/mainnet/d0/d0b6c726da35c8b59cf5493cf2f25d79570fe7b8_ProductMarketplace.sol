...
// File: contracts/marketplace_mumbai.sol
...
contract ProductMarketplace is ERC721URIStorage, Ownable {
    ...
    event ProductItemMinted(uint256 indexed tokenId, uint256 indexed productId, uint256 price, uint256 paymentTokenId);
    ...
    function createToken(
        ...
        if (msg.value > 0) price = msg.value;
            ...
            require(paymentTokenId < paymentTokens.length, "Invalid Payment Token");
        ...
        createProductItem(newTokenId, productId, price, tokenURI, paymentTokenId);
        return newTokenId;
    }
    ...
    function fetchProductItem(uint256 tokenId)
        public
        view
    ...
    function _beforeTokenTransfer(
        ...
        require(from == address(0) || from == owner(), "Only adminitrator can trasfer tokens");
