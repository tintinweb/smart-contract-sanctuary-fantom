...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    function initialize(
        ...
        rewardLockupEpochs = 3; // Lock for 3 epochs (28h) before release claimReward
    ...
    function getCapitalPrice() external view returns (uint256) {
        return treasury.getCapitalPrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            capital.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        capital.safeTransferFrom(msg.sender, address(this), amount);
