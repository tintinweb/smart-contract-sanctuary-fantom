    ...
    ClampedRandomizer
{
    ...
    uint256 public maxPerPerson = 420;
    uint256 public price = 30000000000000000000000000000;
    ...
    ) ERC721("Blue Pepes", "BPEPES") ClampedRandomizer(maxSupply) {
