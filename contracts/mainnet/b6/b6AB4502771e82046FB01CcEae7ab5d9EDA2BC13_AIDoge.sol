...
// File: contracts/interfaces/IUniswapV02Router.sol
interface IUniswapV02Router is IUniswapV2Router01 {
...
contract AIDoge is ERC20, Ownable {
    ...
    IUniswapV02Router private immutable swapRouter;
    ...
    constructor(
        ...
        uint256 _totalSupply = 21000000000 * 1e18;
        ...
        swapRouter = IUniswapV02Router(_swapRouter);
        WETH = IWETH(_weth);
