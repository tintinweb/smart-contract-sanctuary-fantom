...
contract SoullyWorldNFTGarageContract is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public saleStart = 1646074621;
  address private devAddress = 0xB106c39D2408c15D750f21797e232890E7C3eBEc;
  address private partyAddress = 0x536E7b0Ae4a759da2138c497BEE8F30c7197C8a4;
  ...
  ) ERC721("Soully World", "SOULLYWORLD") {
    ...
    returns (string memory)
  {
    ...
    string memory websiteBaseURI = "https://api1.nftgarage.world/serve/assets/soullyworld/metadata/";
  ...
  function withdraw() public onlyOwner {
    uint256 nftg_amount = (address(this).balance/5);
    uint256 remaining_amount = address(this).balance - nftg_amount;
