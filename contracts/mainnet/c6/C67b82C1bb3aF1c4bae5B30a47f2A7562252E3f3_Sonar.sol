 ...
 *    ╚══════╝ ╚═════╝ ╚═╝  ╚═══╝╚═╝  ╚═╝╚═╝  ╚═╝
 *                                               
 * Re-written by @MaxflowO2 for @PotluckProtocol
 *
 * Original Source:
 * https://bscscan.com/address/0x18b2a687610328590bc8f2e5fedde3b582a49cda#code
 *
 * Changelog can be found on github repos!
 */
...
contract Sonar is Ownable, Pausable, ReentrancyGuard {
     ...
     *   _adminAddress: admin address - paymentSplitter.Sol address basically
     ...
     *   _minBetAmount: minimum bet amounts (in wei)
     *   _oracleUpdateAllowance: oracle update allowance
     *   _treasuryFee: treasury fee (1000 = 10%)
     */
    constructor() {
        oracle = AggregatorV3Interface(0xf4766552D15AE4d256Ad41B6cf2933482B0680dc); // Set for FTM/USD - mainnet FTM
        adminAddress = 0x1b69720cA30BF47FEe8CcdE2e73836d3E3f07021;
