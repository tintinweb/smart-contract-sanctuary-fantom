...
contract InfinitePrinter is ContractGuard, Operator {
    ...
    function initialize(
        ...
        // First 30 epochs with custom expansion
        bootstrapEpochs = 31; // 31 days 
        bootstrapSupplyExpansionPercent = 150; // expansion can be altered
    ...
    function setExtraFunds(
        ...
        require(_protocolFundSharedPercent <= 2000, "out of range"); // max 20%
        require(_teamFund != address(0), "zero");
        require(_teamFundSharedPercent <= 500, "out of range"); // max 5%
    ...
    function allocateSeigniorage() external onlyOneBlock checkCondition checkEpoch checkOperator {
        ...
        if (epoch < bootstrapEpochs) {
            ...
            uint256 _percentage = _calculateMaxSupplyExpansionPercent(oBolSupply);
            _sendToBoardroom(oBolSupply.mul(_percentage).div(10000));
                }
