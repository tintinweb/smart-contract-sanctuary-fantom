...
contract SigmaNodes is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SigmaNodes", "SIGMANODES") {
        ...
        marketingWallet = address(0xa189c9BF5e4a5271Aa11484e10672f519157a9E8); // set as marketing wallet
        devWallet = address(0xa5a9C6bd1dB23F5dB70F90f817Ef55fDab7Cc10d); // set as dev wallet
