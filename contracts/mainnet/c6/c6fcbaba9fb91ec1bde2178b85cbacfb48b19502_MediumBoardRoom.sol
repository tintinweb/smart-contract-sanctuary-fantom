...
contract MediumBoardRoom is ShareWrapper, ContractGuard {
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;
    ...
    function initialize(
        ...
        withdrawLockupEpochs = 24; // Lock for 24 epochs (144h) before release withdraw
        rewardLockupEpochs = 12; // Lock for 12 epochs (72h) before release claimReward
