...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    function getCrystalPrice() external view returns (uint256) {
        return treasury.getCrystalPrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            if(withdrawFeeBP > 0) {
                ...
                crystal.safeTransfer(feeAddress, withdrawFee);
            }
            userReward = reward.sub(withdrawFee);
            crystal.safeTransfer(msg.sender, userReward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        crystal.safeTransferFrom(msg.sender, address(this), amount);
