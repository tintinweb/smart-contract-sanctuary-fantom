...
contract sHADESToken is ERC20Permit, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 21900000 * 10**9;
    ...
    constructor() ERC20("Staked HADE", "sHADE", 9) ERC20Permit() {
    ...
    /**
        @notice increases sHADE supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sHADE
