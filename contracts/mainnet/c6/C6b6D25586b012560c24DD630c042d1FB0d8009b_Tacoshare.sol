...
/*
    ...
    https://tacofinance.world/
*/
contract Tacoshare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 tSHAREs
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 56100 ether; // 56100
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("sTACO", "sTACO") {
