...
contract RewardDistributorV2 is RewardDistributorStorageV2, Exponential {
     ...
     * @param rewardType 0 = stlLIF3, 1 = AVAX
     ...
     * @param rewardType 0 = stlLIF3, 1 = AVAX
     * @param holder The address to claim stlLIF3 for
     * @param jTokens The list of markets to claim stlLIF3 in
     */
     ...
     * @param _joe The stlLIF3 token address
     */
     ...
     * @param newRewardSupplySpeed New stlLIF3 or AVAX supply speed for market
     */
     ...
     * @param rewardType 0 = stlLIF3, 1 = AVAX
     * @param jToken The market whose speed to update
     * @param newRewardBorrowSpeed New stlLIF3 or AVAX borrow speed for market
     */
     ...
     * @param jTokens The markets to return the pending stlLIF3 reward in
     ...
     * @param rewardType 0 = stlLIF3, 1 = AVAX
     * @param holder The address to return the pending stlLIF3 reward for
     * @param jToken The market to return the pending stlLIF3 reward in
     * @return uint256 The stlLIF3 reward for that user
     */
