...
contract Marco is ERC20 {
    ERC20 public token;


    constructor() ERC20("Farmgod Explorers Interchain Token", "MARCO") {
     ...
     */
    function mintMarco(uint256 _amount) public {
        require(_amount >= 1 * 10 ** 9, "minimum burn is 1 ECHO");
        ...
        _mint(msg.sender, _amount); // 69,420 ECHO burned mints 69,420 MARCO
    }
