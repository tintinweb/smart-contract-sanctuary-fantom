...
contract FTMMooCurveMIM2CRVOracle is IOracle {
    using BoringMath for uint256;

    ICurvePool constant public mimPool = ICurvePool(0x2dd7C9371965472E5A5fD28fbE165007c61439E1);
    IAggregator constant public MIM = IAggregator(0x28de48D3291F31F839274B8d82691c77DF1c5ceD);
    ...
    function _get() internal view returns (uint256) {
        ...
        uint256 yVCurvePrice = mimPool.get_virtual_price() * minStable * perShare;
    ...
    function name(bytes calldata) public view override returns (string memory) {
        return "Chainlink MooCurveMIM2CRV";
    }

    /// @inheritdoc IOracle
    function symbol(bytes calldata) public view override returns (string memory) {
        return "LINK/MooCurveMIM2CRV";
    }
}