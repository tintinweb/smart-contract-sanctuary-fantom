...
contract InterestShares is ERC20Burnable, Operator {
    using SafeMath for uint256;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund1, address _devFund2, address _devFund3, address _devFund4) public ERC20("Capital Finance Interest Shares", "INTREST") {
        _mint(msg.sender, 100 ether); // mint 100 INTEREST for initial pools deployment
