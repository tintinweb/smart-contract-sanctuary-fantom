...
contract LobsterDAO is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 80000 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'LobsterDAO';
    string private constant _symbol = 'LOBSTER';

    uint256 private _taxFee = 500;
    uint256 private _burnFee = 0;
    uint public max_tx_size = 80000 ether;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x6345cFa5532549A9Fe29BEb429840e1462f4A9bc, 'We can not exclude router.');
