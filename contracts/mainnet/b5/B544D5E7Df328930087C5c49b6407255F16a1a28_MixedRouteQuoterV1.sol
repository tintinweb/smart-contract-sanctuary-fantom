...
interface IImmutableState {
    /// @return Returns the address of the SkeletonSwap V2 factory
    function factoryV2() external view returns (address);

    /// @return Returns the address of SkeletonSwap V3 NFT position manager
...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, ISkeletonSwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for ISkeletonPool;
    ...
    */
    ...
    /// @inheritdoc ISkeletonSwapCallback
    function uniswapV3SwapCallback(
        int256 amount0Delta,
        int256 amount1Delta,
        bytes memory path
        ...
        ISkeletonPool pool = SmartRouterHelper.getPool(deployer, tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        ISkeletonPool pool = SmartRouterHelper.getPool(deployer, params.tokenIn, params.tokenOut, params.fee);
...
library SmartRouterHelper {
    ...
    bytes32 internal constant V2_INIT_CODE_HASH = 0x13917c9a5928946b5dfeb75c115a0cc5d34d4c5c489942f03776ac24c1639ff1;
    ...
    bytes32 internal constant V3_INIT_CODE_HASH = 0xdf7aabc163e8381786aed31aa1649740a76ef34262766dc5bca3d3aa5fcede29;
