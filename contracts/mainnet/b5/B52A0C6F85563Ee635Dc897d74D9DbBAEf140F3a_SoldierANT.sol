...
contract SoldierANT is ERC721, Ownable {
    ...
    uint256 public immutable HEAL_WINDOW = 7 days;
    ...
    function getAvailableSoldiers() public view returns(uint256[] memory) {
        ...
        for (uint i=0;i<_soldierList.length;i++){
            if (idToOnRaidMission[_soldierList[i]]){
                _soldierOnRaidCount ++;
            } else if (idToOnRaidMission[_soldierList[i]]){
                _stakedSoldierCount ++;
    ...
    function getZombieSoldiers() public view returns(uint256[] memory) {
        uint256[] memory zombieSoldierList;
        uint256[] memory _soldierList = playerToSoldiers[tx.origin];
...
//    function killSoldier (uint256 _index) public {
...
//    }
    ...
    function mint() public onlyOwner {        
        ...
        playerToSoldiers[tx.origin].push(counter); 
        counter++;
    }
