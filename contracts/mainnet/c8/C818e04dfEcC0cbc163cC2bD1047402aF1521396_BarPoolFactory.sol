...
// File: BarPool/contracts/token/ERC20/extensions/draft-IERC20Permit.sol
...
// File: BarPool/libs/UniversalERC20.sol
...
// File: BarPool/contracts/token/ERC20/extensions/IERC20Metadata.sol
...
// File: BarPool/contracts/security/ReentrancyGuard.sol
...
contract BarPool is Ownable, ReentrancyGuard {
    ...
    function initialize(
        ...
        require(msg.sender == BAR_POOL_FACTORY, "Not factory");
...
// File: BarPool/BarPoolFactory.sol


pragma solidity ^0.8.0;


// File: contracts/BarPoolFactory.sol

contract BarPoolFactory is Ownable {
    uint16 public constant MAX_FEE = 2000;
    ...
    address public defaultFeeAddress =
        0xB96FdBB9e918555bbECCD54c0d0375A44Bdc06c4;

    event NewBarPoolContract(address indexed smartChef);
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(BarPool).creationCode;
        ...
        BarPool(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerBlock,
            _startBlock,
        ...
        BarPool(smartChefAddress).updateFeePercentage(
            defaultDepositFee,
            defaultUnlockFee
        );
        BarPool(smartChefAddress).updateLockProps(
            defaultLockPeriod,
            defaultIsFlexibleLock
        );
        BarPool(smartChefAddress).updateFeeAddress(defaultFeeAddress);
        BarPool(smartChefAddress).transferOwnership(_admin);

        emit NewBarPoolContract(smartChefAddress);
    }
}