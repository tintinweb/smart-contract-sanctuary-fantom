...
contract StrategyOxdStableSpiritSinspiritLp is StrategyOxdFarmLPBase {
    // Token addresses
    address public spirit_sinspirit_lp =
        0x742C384D6EDeC91466042ba84E5e751c4eAFf962;
    address public spirit = 0x5Cc61A78F164885776AA610fb0FE1257df78E59B;
    address public sinspirit = 0x749F2B95f950c4f175E17aa80aa029CC69a30f09;
        ...
        )
    {
        ...
        swapRoutes[sinspirit].push(route(wftm, spirit, false));
        swapRoutes[sinspirit].push(route(spirit, sinspirit, true));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategyOxdStableSpiritSinspiritLp";
    }
}
