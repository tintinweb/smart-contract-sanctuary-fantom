...
contract Magnetite is OwnableUpgradeable, IMagnetite {
    ...
    constructor(address vhAuth) {
        require(block.chainid > 30000 || block.chainid == 137 || block.chainid == 25 || block.chainid == 56 || block.chainid == 250, "unsupported chain");
        _init(vhAuth);
        ...
        (COMMON_1, COMMON_2, COMMON_3, COMMON_4, COMMON_5) = block.chainid == 25 ? ( //cronos
            ...
            0x04068DA6C83AFCFA0e13ba15A6696662335D5B75, //usdt
