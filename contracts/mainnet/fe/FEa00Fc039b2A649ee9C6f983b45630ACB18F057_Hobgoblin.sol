...
contract Hobgoblin is ERC20Burnable, Operator {
    using SafeMath for uint256;
    ...
    constructor(uint256 _startTime, address _devFund, address _teamFund) public ERC20("HOBGOBLIN", "HOBGOBLIN") {
        _mint(msg.sender, 1 ether); // mint 1 HOBGOBLIN for initial pools deployment
    ...
    function setAllocations(uint256 _devAllocation, uint256 _teamAllocation) external {
        require(_devAllocation <= 10000 ether, "dev allocation too high");
        require(_teamAllocation <= 10000 ether, "team allocation too high");
    ...
    /**
     * @dev Claim pending rewards to team and dev fund
     */
