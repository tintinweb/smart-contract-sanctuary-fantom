...
contract Pragma is ERC20Detailed, Ownable, DiscounterRole {
    ...
    address public constant autoLiquidityAddress = 0x13564CE8a42F2D43eE93fBeDc4f4c5398A1E7390;
    address public constant treasuryAddress = 0x131b78F3961c90C364a7970B98988C219D56d62A;
    address public constant riskFreeValueAddress = 0x186D5B8C9E6c6265071aAc228B145C32bEc1A0C6;
    address public operationsAddress;
    address public routerContractAddress = 0xF491e7B69E4244ad4002BC14e878a34207E38c29;
    ...
    constructor() ERC20Detailed("Pragma.money Token", "PRAGMA", uint8(DECIMALS)) {
    ...
    function setFees(
        ...
        require(_totalFee <= 15, "buy fee can't be higher than 15%");
        require(_sellFee <= 20, "sellFee can't be higher than 20%");
