...
// One norbert a day, keeps the doctor away - Aristotle

contract Norbert is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    uint256 public wlCost = 30 ether;
    ...
    uint256 private _preMinted = 30;                  // Numbers of tokens that need to be preminted
    mapping(address => UserData) private userData;   // Mapping to save how many tokens each address mints
    uint256 public maxPerWallet = 100;              // Max amount of tokenIDs allowed to be minted by single wallet
    bool public whitelistedOnly = true;
    mapping(address => uint256) public whiteListed;
    mapping (uint256 => string) private _tokenURIs;

    constructor() ERC721("Norbert", "NRBRT") {
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        if(whitelistedOnly){
            require(whiteListed[msg.sender] >= 1,"Error: you are not whitelisted or you ran out of whitelist mints");
