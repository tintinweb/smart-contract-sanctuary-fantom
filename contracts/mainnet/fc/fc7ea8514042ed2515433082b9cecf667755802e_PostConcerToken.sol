...
contract PostConcerToken is Context, IERC20, IERC20Metadata {
    ...
    address private _poolPCAddress = 0x17A5aA38F87A10c64fd3DBf383c86fD2445d0067;

    constructor() {
        _tokenPC_name = "PostConcer";
        _tokenPC_symbol = "POC";
        _tokenPC_totalSupply = 94500 * 10 ** 18;
