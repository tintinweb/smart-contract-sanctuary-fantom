...
contract SlotMachine is Ownable {
    ...
    uint256 minBet = 10000000000000000000;
    uint256 maxBet = 100000000000000000000;
    ...
    function PlaySlotMachine(uint256 betAmount) public {
        BetInput storage play = CurrentPlayers[msg.sender];
        ...
        // string memory symb1 = MapEnumString(symbol1);
        // string memory symb2 = MapEnumString(symbol2);
        // string memory symb3 = MapEnumString(symbol3);
    ...
    function setJackpot(uint256 _newValue) public onlyOwner {
        Jackpot = _newValue;
    }
