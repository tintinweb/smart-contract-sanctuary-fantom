...
// File contracts/farms/MultiFeeDistribution.sol
...
contract MultiFeeDistribution is ReentrancyGuard, Ownable {
    ...
    uint256 public constant lockDuration = rewardsDuration * 2; // 8 weeks
    ...
    constructor(address _stakingToken, address[] memory _minters) Ownable() {
        stakingToken = IKAN(_stakingToken);
