...
contract Bird is ERC20Burnable, Operator {
    ...
    // Initial distribution for Bird Genesis LP pool
    uint256 public constant INITIAL_BIRD_POOL_DISTRIBUTION = 5000 ether;
    ...
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("Bird Finance", "BIRD") {
    ...
    function distributeReward(
        ...
        require(_birdPool != address(0), "!_birdGenesisPool");
        require(_airdropWallet != address(0), "!_airdropWallet");

        //Mint tokens for genesis, airdrop and bird pool
        _mint(_genesisPool, INITIAL_GENESIS_POOL_DISTRIBUTION);
        _mint(_birdPool, INITIAL_BIRD_POOL_DISTRIBUTION);
