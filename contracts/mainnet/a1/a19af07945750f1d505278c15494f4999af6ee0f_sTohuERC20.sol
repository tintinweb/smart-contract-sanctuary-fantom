...
contract sTohuERC20 is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Tohu", "sTohu", 9) ERC20Permit() {
    ...
    /**
        @notice increases sTOHU supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sTOHU
