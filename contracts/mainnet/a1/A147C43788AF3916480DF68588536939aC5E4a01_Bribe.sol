...
contract Bribe is Ownable {
  ...
  /* ========== STATE VARIABLES ========== */
    ...
    address public feeAddress;                    // fee recipient
    uint256 public platformFee = 500;             // 5%
    uint256 public constant DENOMINATOR = 1e4;    // denominates weights 10000 = 100%
  ...
  /* ========== MUTLI-SIG FUNCTIONS ========== */
    ...
    function updateFeeAmount(uint256 _feeAmount) public onlyOwner {
      require(_feeAmount < 500, "max fee"); // Max fee 5%
