...
contract StrategyOxdVolatileBeetsFbeetsLp is StrategyOxdFarmLPBase {
    // Token addresses
    address public beets_fbeets_lp = 0x5A3AA3284EE642152D4a2B55BE1160051c5eB932;
    ...
    {
        swapRoutes[beets].push(route(wftm, beets, false));
        swapRoutes[fbeets].push(route(wftm, beets, false));
        swapRoutes[fbeets].push(route(beets, fbeets, false));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategyOxdVolatileBeetsFbeetsLp";
    }
}
