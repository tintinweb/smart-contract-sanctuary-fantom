...
import "@openzeppelin/contracts/access/Ownable.sol";
import "@openzeppelin/contracts/proxy/utils/Initializable.sol";
import "./FxmDaoFund.sol";

contract FxmDaoFundFixed is Ownable {
    FxmDaoFund public daoFundOriginal;
    uint256 public claimedAmount;
    ...
    constructor(address _daoFund) {
        require(_daoFund != address(0), "FxmDaoFundFixed::constructor: Invalid address");
        daoFundOriginal = FxmDaoFund(_daoFund);
    }
