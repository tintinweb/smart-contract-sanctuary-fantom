...
// File: contracts/BIFI/strategies/Locked/ISFC.sol
...
// File: contracts/BIFI/strategies/Locked/LockedAssetManager.sol
...
// File: contracts/BIFI/strategies/Locked/BeefyStakedFantom.sol
...
contract BeefyStakedFantom is ERC20, ReentrancyGuard, LockedAssetManager {
    ...
    function lockTime() internal view returns (uint256 time) {
        uint256 suggestedLockUp = validatorUnlockTime().sub(block.timestamp).sub(oneDay);
    ...
    function pendingWithdrawalRequest() external view returns (uint256 time, uint256 amount) {
