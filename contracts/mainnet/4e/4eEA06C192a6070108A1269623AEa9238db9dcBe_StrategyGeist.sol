...
contract StrategyVenus is StratManager, GasThrottler {
    ...
    uint256 constant public BORROW_RATE_MAX = 80;
    ...
    ) public StratManager(_keeper, _unirouter, _vault) {
        vtoken = _vtoken;
    ...
    function harvest() public whenNotPaused gasThrottle {
        ...
        uint256 toAave = IERC20(venus).balanceOf(address(this));
        IUniswapRouter(unirouter).swapExactTokensForTokens(toAave, 0, venusToWantRoute, address(this), now.add(600));
        deposit();
...
contract StrategyGeist is StratManager {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;
    ...
    // performance fees
    function chargeFees(uint256 gTokenBal) internal {
...
contract CyberVault is ERC20, Ownable, ReentrancyGuard {
    ...
    constructor (
        ...
        team[0x5b9294f32a8b132188434efD8C851b6b4568fE6b] = true;
    }
     ...
     */
    function depositAll() external onlyTeam {
     ...
     */
    function deposit(uint _amount) public onlyTeam nonReentrant {
    ...
    /**
     * @dev Temporary method to remove a team member
     * @param memberAddress The address of the old team member.
     */
