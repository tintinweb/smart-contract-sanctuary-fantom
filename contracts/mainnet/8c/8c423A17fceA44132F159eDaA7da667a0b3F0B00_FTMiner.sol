/**
 *Submitted for verification at FtmScan.com on 2023-06-28
*/
...
contract FTMiner is Context, Ownable {
    using SafeMath for uint256;

    uint256 private EGGS_TO_HATCH_1MINERS = 9990000;//for final version should be seconds in a day
