...
contract TestGenesisRewardPool is Operator {
    ...
    function add(
        ...
        _token.balanceOf(address(this)); // Block non IERC20 compatible tokens from getting added
    ...
    function governanceRecoverUnsupported(IERC20 _token, uint256 _amount, address _to) external onlyOperator {
        if (block.timestamp < poolEndTime + 90 days) {
            // do not allow to drain core token (LIFE or lps) if less than 90 days after pool ends
