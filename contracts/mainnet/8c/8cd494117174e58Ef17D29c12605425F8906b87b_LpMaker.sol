...
contract LpMaker is Ownable, ILpMaker {
        ...
        address _recipient, uint256 _minAmountLp ) payable external override whitelist(_routerAddr)
    {
        ...
        value: msg.value } (_token1, _token1Amount, 0, 0, _recipient, block.timestamp);
        ...
        if (msg.value > amountETH)
            TransferHelper.safeTransferETH(msg.sender, msg.value.sub(amountETH));
    }
    /* ========== Private Functions ========== */
    ...
    function setNativeToken(address _wNATIVE) external onlyOwner {
        wNATIVE = _wNATIVE;
    }
