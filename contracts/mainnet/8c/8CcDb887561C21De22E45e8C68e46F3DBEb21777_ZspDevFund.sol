...
contract ZspDevFund is Fund {
    uint256 public constant ALLOCATION = 3_750_000 ether; // 7.5%
    uint256 public constant VESTING_DURATION = 2 * 365 * 24 * 3600; // 2 years
    uint256 public constant VESTING_START = 1657654767; // 4 week cliff: Tuesday, 12 July 2022 19:39:27
