...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 TOMB = IBEP20(0x6c021Ae822BEa943b2E66552bDe1D2696a53fbB7); // Current TOMB Rewards Mainnet 
    ...
    constructor (address _router) {
        router = _router != address(0)
            ...
            // V2 : 0xF491e7B69E4244ad4002BC14e878a34207E38c29
        _token = msg.sender;
    }
...
contract McMillion is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "McMillion";
    string constant _symbol = "MCME";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 500000000000 * 10**18 * (10 ** _decimals);
