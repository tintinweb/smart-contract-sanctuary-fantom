...
contract RShare is ERC20Burnable, Operator {
    ...
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 6990 ether;
    ...
    constructor(uint256 _startTime, address _devFund) public ERC20("RSHARE Token", "RSHARES") {
        _mint(msg.sender, 10 ether); // mint 1 RShare for initial pools deployment
