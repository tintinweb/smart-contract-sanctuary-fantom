...
// File: contracts/EqualEthFtmvAMM.sol
...
contract EqualEthFtmvAMM is Ownable, Pausable {
    ...
    function addLiquidity() internal {
        ...
        uint256 lp1Bal = IERC20(eth).balanceOf(address(this));

        IEqualizerRouter(unirouter).addLiquidity(wrapped, eth, stable, lp0Bal, lp1Bal, 1, 1, address(this), block.timestamp);
    }
