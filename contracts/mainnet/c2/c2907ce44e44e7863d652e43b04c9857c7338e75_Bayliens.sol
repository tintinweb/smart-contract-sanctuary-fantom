...
contract Bayliens is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost = 22.5 ether;
  ...
  uint256 private _preMinted = 0;               // Numbers of tokens that need to be preminted
  mapping(address => UserData) private userData; // Mapping to save how many tokens each address mints
  uint256 public maxPerWallet = 2555;              // Max amount of tokenIDs allowed to be minted by single wallet
