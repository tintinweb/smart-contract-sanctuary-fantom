...
contract airdropsWSPP is Ownable {
  struct Claimer {
    address referer;
    uint256 tier1;
    uint256 tier2;
  ...
  uint256 public _claimTokenRegister =  250 * 1e6;
  uint256 public _claimTokenTier1 = 150 * 1e5;
  uint256 public _claimTokenTier2 = 100 * 1e5;
  uint256 public _claimTokenTier3 = 50 * 1e5;
  uint256 public _claimTokenTier4 = 10 * 1e5;
