...
/** royalty splitter is at the bottom
 *
                        ..      s       .                                         s
  x8h.     x8.    x .d88"      :8      @88>                                      :8
...
contract UltimateFantoms is ERC721, ERC2981Collection, IMAX721, ERC165Storage, Ownable {
  ...
  IERC20 private constant OPR = IERC20(0x16dbD24713C1E6209142BCFEED8C170D83f84924);
  address private constant ZAPPER_ADDRESS = 0xF0ff07d19f310abab54724a8876Eee71E338c82F;
  IZap private constant ZAPPER = IZap(ZAPPER_ADDRESS);
  address private constant SPIRITLP = 0x200a8431906751bf1E8a42bbb60c35Bc6ba9aB89;

  IERC721Enumerable private constant FTMOPRs = IERC721Enumerable(0x6e85F63449F090856ca5850D19611c50488bd7fD);
  IERC721 private constant wFTMOPRs = IERC721(0x7219D365468EB94175a159E62dcbD7115d1C358D);
  IERC721Enumerable private constant CYBERs = IERC721Enumerable(0xCB0fF14CAC96aDd86223C8C7E8A6129CD92919Ab);
  IERC721 private constant wCYBERs = IERC721(0x373559E2C2d6898AF6C4e3C1b93789Ca4cB06074);
  ...
  IERC20 private constant SPRITSWAP_TOKEN = IERC20(0x5Cc61A78F164885776AA610fb0FE1257df78E59B);
  ...
  IERC20 private constant BRUSH_TOKEN = IERC20(0x85dec8c4B2680793661bCA91a8F129607571863d);
  address private constant bPATH1 = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
  address private constant bPATH2 = 0x85dec8c4B2680793661bCA91a8F129607571863d;

  IERC20 private BEETS_TOKEN = IERC20(0xF24Bcf4d1e507740041C9cFd2DddB29585aDCe1e);
  address private constant bePATH1 = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
  address private constant bePATH2 = 0xF24Bcf4d1e507740041C9cFd2DddB29585aDCe1e;

  IERC20 private constant RNDM_TOKEN = IERC20(0x87d57F92852D7357Cf32Ac4F6952204f2B0c1A27);
...
/***
  ...
  ***/
  ...
  function updateSpiritRouter(address _newRouter) public onlyOwner {
    address _oldRouter = SPIRITSWAP_ROUTER;
    SPIRITSWAP_ROUTER = _newRouter;
    emit UpdatedRouter(_oldRouter, _newRouter);
  }

  function updatePaintRouter(address _newRouter) public onlyOwner {
 ...
 */
  ...
  function publicMint(uint256 amount) public payable {
    ...
    /* BRUSH BUY AND BURN */
    /* address[] memory _brushPath;
    _brushPath = new address[](2);
    _brushPath[0] = bPATH1;
    _brushPath[1] = bPATH2;
    IGenericRouter02(PAINTSWAP_ROUTER).swapExactETHForTokens{value: _brushAlloc/2}(0, _brushPath, TREASURY, block.timestamp);
    IGenericRouter02(PAINTSWAP_ROUTER).swapExactETHForTokens{value: _brushAlloc/2}(0, _brushPath, BURN, block.timestamp); */
    ...
    } else if (_toEarn == 1 && _tokenIdCounter.current()+1 > 1) {
 ...
 */
  ...
  // @notice RandomZ here, kinda wanna remove this one, since its meant to have a curve
  ...
  function setTeamMinting(uint256 _amount) public onlyOwner {
...
contract RoyaltySplitter is Ownable {
  ...
  receive() external payable {
    ...
    if (_toEarn == 0) {
      ...
      wFTMc.deposit{value: _sendAlloc}();
      wFTM.transfer(_sendTo, wFTM.balanceOf(address(this)));
    } else if (_toEarn == 1 && ICollection.totalSupply() > 1) {
