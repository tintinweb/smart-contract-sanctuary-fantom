...
import "./interfaces/INewFeeManager.sol";
import "./interfaces/IUniswapV3Twap.sol";

contract NewFeeManager is Initializable, ContextUpgradeable, AccessControlUpgradeable, UUPSUpgradeable, INewFeeManager {
    ...
    function __FeeManagerUpgradeable_init(address handlerAddress, uint8 _chainId) internal initializer {
    ...
    function initialize(address handlerAddress, uint8 _chainId) external initializer {
        __FeeManagerUpgradeable_init(handlerAddress, _chainId);
    }
    ...
    */
    ...
    function setChainId(uint8 _chainId) public virtual override onlyRole(DEFAULT_ADMIN_ROLE) {
        chainId = _chainId;
    }
    ...
    */
    function getFee(
        ...
        feeInToken = ((feeInUSD * (10**9) * (10**fees.feeTokenDecimals)) / _feeTokenToPriceX10e9[fees.feeToken]);
...
interface INewFeeManager {
    ...
    */
    ...
    function setChainId(uint8 _chainId) external;
