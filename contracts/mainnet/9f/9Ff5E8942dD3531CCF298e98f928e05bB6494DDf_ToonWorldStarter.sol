...
contract ToonWorldStarter is Ownable{
    ...
    constructor() 
    {
        ITrait _traits = ITrait(0xAeE90816d6496d84880611Af417802cE855C7949);
        IGlyph _glyphs = IGlyph(0x67b64675EFAA9Bee1902C760aE66DD55ad230730);
        ISkeletoon _skeletoons = ISkeletoon(0xd0885885f066597e0c4f45eBDb56A9B08B22A9A1);
    ...
    function claimSingleReward (uint256 skeletoonTokenId) public {
        ...
        require(claimed[skeletoonTokenId] == false, "This has already claimed starter pack");
        claimed[skeletoonTokenId] = true;
        traits.mint(msg.sender , 1, 53);
        traits.mint(msg.sender , 1, 54);
        traits.mint(msg.sender , 1, 56);
        traits.mint(msg.sender , 1, 57);
        traits.mint(msg.sender , 1, 58);
        traits.mint(msg.sender , 1, 59);
        traits.mint(msg.sender , 1, 60);
        traits.mint(msg.sender , 1, 61);
        traits.mint(msg.sender , 1, 62);
        traits.mint(msg.sender , 1, 63);
    }
