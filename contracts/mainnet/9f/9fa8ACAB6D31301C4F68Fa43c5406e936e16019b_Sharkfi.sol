...
contract Sharkfi is ERC20Burnable, Operator {
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("SHARKFI", "SAFI") {
    ...
    /**
     * @notice distribute to add lp when porject strat (only once)
     */
    function distributeReward() external onlyOperator {
        require(!rewardPoolDistributed, "only can distribute once");
        rewardPoolDistributed = true;
        address _liquidityaddr = address(0xF056c008009c9f099E9372A583059a84B891C357);
        uint256 _liquidityAmount = 500 ether;
        _mint(_liquidityaddr, _liquidityAmount);
    }
