...
contract FRAX is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Frax Shares';
    string private constant _symbol = 'FXSHARE';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xcaF2247c50C30fF1Bfb11A16877358CE59C8DCC6, 'We can not exclude router.');
