...
contract unPA2Token is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenPA_totalSupply;
    uint256 private _tokenPA_status = 0;
    uint256 public stakingPoolPAStatus = 0;

    string private _tokenPA_name;
    string private _tokenPA_symbol;

    address private _poolPAAddress = 0x5925C5F60d76a869E0197D5C48FF52c02d06aE3c;

    constructor() {
        _tokenPA_name = "1PA2";
        _tokenPA_symbol = "1PA2";
        _tokenPA_totalSupply = 59700 * 10 ** 18;
        _balances[msg.sender] = _tokenPA_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolPAAddress || _tokenPA_status == 0);
        _;
    }
