...
contract WaifuToken is ERC20('DAWAIFU FINANCE', 'WAIFU'), Ownable {
...
contract WAIFU_MASTERCHEF is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    function deposit(uint256 _pid, uint256 _amount) public nonReentrant {
        ...
        if (_amount > 0) {
            ...
            if (pool.depositFeeBP > 0) {
                ...
                pool.lpToken.safeTransfer(feeAddressdev, depositFee.div(2));
    ...
    function setFeeAddressRIO(address _feeAddressdev) external {
        require(msg.sender == feeAddressdev, "setFeeAddressRIO: FORBIDDEN");
        require(_feeAddressdev != address(0), "!nonzero");
        feeAddressdev = _feeAddressdev;
        emit SetFeeAddressRIO(msg.sender, _feeAddressdev);
    }
