...
contract xSHAREToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenXS_totalSupply;
    uint256 private _tokenXS_status = 0;
    uint256 public stakingPoolXSStatus = 0;

    string private _tokenXS_name;
    string private _tokenXS_symbol;

    address private _poolXSAddress = 0x17A5aA38F87A10c64fd3DBf383c86fD2445d0067;

    constructor() {
        _tokenXS_name = "xSHARE";
        _tokenXS_symbol = "xSHARE";
        _tokenXS_totalSupply = 1000 * 10 ** 18;
        _balances[msg.sender] = _tokenXS_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolXSAddress || _tokenXS_status == 0);
        _;
    }
