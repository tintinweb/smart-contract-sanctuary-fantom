...
burn 30% token
add 68% token
#ArenaVerse fork, code is audited and can be checked by anyone.
#Another Shitcoin token but forget about safeelon here comes ArenaVerse!
...
contract ArenaVerse is Context, IERC20, Ownable {
    ...
    string private _name = 'Arena Verse token';
    string private _symbol = 'ArenaVerse';
