...
contract OTClp is Ownable, ContractGuard {    
    ...
    uint256 private totalTokenForSaleSwapped = 0;
    ...
    function TotalTokenForSaleSwapped() public view returns (uint256) {
        return totalTokenForSaleSwapped;
    }
    ...
    function swapToken(address _in, uint256 amount, address _router, uint256 minimumAmount) external onlyOneBlock assetWhitelist(_in, _router) {
        ...
        totalTokenForSaleSwapped = totalTokenForSaleSwapped.add(tokenForSaleAmount);
    }
    ...
    function removeAssetLp(address _assetLp,address _router)public onlyOwner {
        assetLp[_assetLp] = false;
        asset[_assetLp][_router] = false;
    }
