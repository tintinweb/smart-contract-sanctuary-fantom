...
contract VDeusMatrixSingleAutocompound is MatrixStrategyBase, MatrixSwapHelper {
    using SafeERC20 for IERC20;
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    function _setDefaultSwapPaths() internal virtual {
        // DEUS -> WFTM
        address[] memory _deusWFTM = new address[](2);
        _deusWFTM[0] = DEUS;
        _deusWFTM[1] = WFTM;
        _setSwapPath(DEUS, WFTM, SPOOKYSWAP_ROUTER, _deusWFTM);
    }
