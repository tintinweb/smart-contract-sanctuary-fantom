  ...
  ERC721Pausable
{
  ...
  // Payment address
  address public paymentAddress = 0xee0256f9bdbc01D68999C2614db31660d2c59fF7;

  // Royalties address
  address public royaltyAddress = 0xee0256f9bdbc01D68999C2614db31660d2c59fF7;

  // Royalties basis points (percentage using 2 decimals - 10000 = 100, 5000 = 50, 0 = 0)
  uint256 private royaltyBasisPoints = 300; // 3%

  // Token info
  string public constant TOKEN_NAME = 'TestNodes';
  string public constant TOKEN_SYMBOL = 'tNODE';
