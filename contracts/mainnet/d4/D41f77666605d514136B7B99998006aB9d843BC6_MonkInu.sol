...
contract MonkInu is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Monk Inu';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x6A98466485fC1feAa87318CaE1F8f1EdBef60AC5, 'We can not exclude router.');
