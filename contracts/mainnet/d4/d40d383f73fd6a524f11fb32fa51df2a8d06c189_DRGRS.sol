...
abstract contract AccessControl is Context, IAccessControl, ERC165 {
     ...
     */
    function revokeRole(bytes32 role, address account) public virtual override onlyRole(ROLE_ADMIN) {
...
contract DRGRS is Context, AccessControlEnumerable, ERC20Burnable, ERC20Pausable, ReentrancyGuard, BlackList {
    ...
    constructor() ERC20("DebtRepaymentGRcoinSwap", "DRGRS") {
        ...
        setDecimals(6);
        tokenDividend = ERC20(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75);
