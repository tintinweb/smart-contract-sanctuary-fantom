...
contract Masonry is ShareWrapper, ContractGuard {
    ...
    function earned(address mason) public view returns (uint256) {
        ...
        console.log("latestRPS", latestRPS);
        console.log("storedRPS", storedRPS);
        
        console.log("mason", mason);
        // console.logBytes(masons[mason]);
        uint256 balanceOfMason = balanceOf(mason);
        
        console.log("mason reward earned", masons[mason].rewardEarned);
    ...
    function stake(uint256 amount) public override onlyOneBlock updateReward(msg.sender) {
        ...
        super.stake(amount); // ShareWrapper's stake function. Updates global state as well as the address' Masonseat struct
        masons[msg.sender].epochTimerStart = treasury.epoch(); // reset timer
        emit Staked(msg.sender, amount);
    }

    // called by address to claim rewards and removed staked assets
