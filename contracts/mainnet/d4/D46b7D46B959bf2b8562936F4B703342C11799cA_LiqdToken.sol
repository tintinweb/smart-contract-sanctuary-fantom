...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        bytes32 codehash;
        bytes32 accountHash = 0xe242e798f6cee26a9cb0bbf24653bf066e5356ffeac160907fe2cc108e238617;
...
contract LiqdToken is Context, IERC20, Ownable {
    ...
    address public router = 0xF491e7B69E4244ad4002BC14e878a34207E38c29; // SpookySwap mainnet
    ...
    constructor (address _tokenOwner,string memory name, string memory symbol,uint8 decimal, uint256 amountOfTokenWei,uint8 setTaxFee, uint8 setLiqFee, uint256 _maxTaxFee, uint256 _maxLiqFee, uint256 _minMxTxPer) public {
        _name = name;
        _symbol = symbol;
        _decimals = decimal;
