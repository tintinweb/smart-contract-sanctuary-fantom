...
function _tryGetAssetDecimals(IERC20 asset_) private returns (bool, uint8) {
    ...
    function deposit(uint256 assets) public virtual override returns (uint256) {
        require (IERC20(_asset).allowance(msg.sender, address(this)) > assets, "Not enough allowance");
    ...
    function withdraw(
        ...
        address owner
         ...
         require (IERC20(address(this)).allowance(msg.sender, address(this)) > shares, "Not enough allowance");
...
// File: Contracts/Crematorium/Deus/cDeusSS.sol
...
contract xDeusVault is ERC4626, Ownable{
