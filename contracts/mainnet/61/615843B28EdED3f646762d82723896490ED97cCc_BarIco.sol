...
contract BarIco is Ownable {
    ...
    uint256 private _startDate = 1665846000; // When to start ICO 
    uint256 private _endDate = 1666450800; // When to end ICO 
    uint256 private _claimDate = 1666458000; // When to claim ICO 
