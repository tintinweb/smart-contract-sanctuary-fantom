...
contract Zapper is MatrixSwapHelper, Ownable {
    ...
    function _zapToLp(
        ...
        uint256 _amountIn,
        uint256 _minLpAmountOut
    ) internal returns (uint256 _lpAmountOut) {
        if (msg.value > 0) {
        ...
        IERC20(_fromToken).approve(_router, _amountIn);
        ...
        IERC20(_token0).approve(_router, _token0Out);
        IERC20(_token1).approve(_router, _token1Out);
