...
contract alifpasya is Context, IERC20, Ownable {
    ...
    string private constant _name = 'alifpasya';
    string private constant _symbol = 'pasya';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xf1247eD58FD295a1c4bF674f2b20689eaB3d3115, 'We can not exclude router.');
