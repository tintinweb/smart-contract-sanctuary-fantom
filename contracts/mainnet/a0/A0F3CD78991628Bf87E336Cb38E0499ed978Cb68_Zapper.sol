...
contract Zapper is Ownable, ReentrancyGuard, Pausable {
     ...
     * Current implementation separates 0.5% for fees. Can be changed through the constructor
     * Inputs in constructor should be ratios between the Fee and Max Fee, divisble into percents by 10000
     *
     * {treasuryFee} - divided by 10,000 to determine the % fee. Set to 0.5% by default and
    ...
    function _chargeFees(address _fromToken, uint256 _feeAmount) internal {
        address[] memory routeToWftm = new address[](2);
        routeToWftm[0] = _fromToken;
        routeToWftm[1] = wftm;
