 ...
 */
contract ERC20Controller is IERC20 {
...
library LibPresale {
    ...
    function invest(uint256 amount) internal {
        ...
        _checkLimits(investor, currentEpoch);
...
contract PresaleGettersController {
    function getCurrentEpoch()
        external
        view
        returns (LibPresale.Epoch memory, uint256)
    {
        return LibPresale.getCurrentEpoch();
    }
