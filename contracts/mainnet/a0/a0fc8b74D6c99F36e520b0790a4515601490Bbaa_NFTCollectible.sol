...
contract NFTCollectible is ERC721Enumerable, Pausable, Ownable {
    ...
    string memory baseURI) ERC721("NFT Collectible", "NFTC") {
        setBaseURI(baseURI);
...
function preSale(uint _count) public payable {
    ...
    // function setRoyaltyInfo(address _receiver, uint96 _royaltyFeesinBips_) public onlyOwner {
    //         royaltyReceiver = _receiver;
    //         royaltyFeesInBips = _royaltyFeesinBips_;
