...
abstract contract Fund is Ownable, Initializable {
    ...
    function initialize(address _f3m) external initializer {
        require(_f3m != address(0), "Fund::constructor: Invalid address");
        f3m = IERC20(_f3m);
    }
    ...
    function currentBalance() public view returns (uint256) {
        return f3m.balanceOf(address(this));
    }
    ...
    function transfer(address receiver, uint256 amount) external onlyOwner {
        ...
        f3m.safeTransfer(receiver, amount);
    }
}