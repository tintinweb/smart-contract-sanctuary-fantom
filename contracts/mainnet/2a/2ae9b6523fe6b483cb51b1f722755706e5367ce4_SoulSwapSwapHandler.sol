...
// File contracts/handlers/soulswap/SoulSwapHandler.sol

contract SoulSwapSwapHandler is UniswapV2Router02Handler {
    constructor(IUniswapV2Router02 _soulRouter, address _weth)
        UniswapV2Router02Handler(_soulRouter, _weth)
