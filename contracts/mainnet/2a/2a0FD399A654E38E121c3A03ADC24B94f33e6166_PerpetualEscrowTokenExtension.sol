...
// File @openzeppelin/contracts/token/ERC20/utils/SafeERC[email protected]
...
contract PerpetualEscrowTokenExtension is Ownable, ReentrancyGuard, DelayedActionGuard
{
	...
	constructor(address _escrowToken, address _distributor, address _recipient)
	{
	...
	function setDistributor(address _newDistributor) external onlyOwner delayed
	{
