...
contract Jackpot {
    ...
    constructor(address payable _feeReceiver, uint _depositAmount, uint _maxParticipants){
        ...
        //deposit amount is a multiplier of 1 FTM. If you input _depositAmount as 1, the deposit amount is going to be 1 FTM.
    ...
    function enter() external payable{
        ...
        require(msg.value == depositAmount,"You can only deposit depositAmount FTM");
    ...
    function pickWinner() internal {
        ...
        players[index].transfer(address(this).balance*winnerRate/100);
        feeReceiver.transfer(address(this).balance);
