...
contract CyberOperaPegToken is ERC20Burnable, Operator {
    using SafeMath for uint256;
    ...
    function _transfer(
        ...
        require(sender != address(0), "Cyber: transfer to the zero address");
        require(recipient != address(0), "Cyber: transfer to the zero address");
...
contract CyberOperaToken is CyberOperaPegToken {
    using SafeMath for uint256;
    ...
    constructor()
        public
        CyberOperaPegToken("Cyber Opera", "CYBER", 18, 1001000 ether)
    {}
}