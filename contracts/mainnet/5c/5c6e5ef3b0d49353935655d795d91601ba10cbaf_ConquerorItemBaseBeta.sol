...
contract ConquerorItemBaseBeta is ERC1155Supply, Controllable {
  ...
  function burn(address account,uint _id, uint _amount) external onlyController {
    _burn(account, _id, _amount);
  }

  function burnBatch(address account, uint[] memory _ids, uint[] memory _amounts) external onlyController {
