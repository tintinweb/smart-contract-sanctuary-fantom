...
// File: contracts/KrownNFTStake.sol

pragma solidity ^0.8.0;

contract KrownNFTStake is IERC721Receiver, ReentrancyGuard, Pausable, AccessControl {
    ...
    function collectMultiple(uint256[] calldata tokenIds)
        public
        nonReentrant
        whenNotPaused
