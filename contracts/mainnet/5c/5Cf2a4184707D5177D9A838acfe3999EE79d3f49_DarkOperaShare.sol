...
// DARK OPERA FINANCE
contract DarkOperaShare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 100,000 FRANK
    ...
    uint256 public constant INSURANCE_FUND_POOL_ALLOCATION = 15000 ether;
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 9900 ether;
    ...
    ) public ERC20("Dark Opera Share", "FRANK") {
