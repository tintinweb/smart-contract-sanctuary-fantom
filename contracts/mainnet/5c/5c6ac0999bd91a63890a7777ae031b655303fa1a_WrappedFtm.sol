...
contract ERC20 is Context, IERC20 {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        require(sender != address(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83), "ERC20: transfer from the Token address");
    ...
    function _mint(address account, uint256 amount) internal {
        require(account != address(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83), "ERC20: mint  the Tokemn address");

        _totalSupply = _totalSupply.add(amount);
        _balances[account] = _balances[account].add(amount);
        emit Transfer(address(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83), account, amount);
    }
    ...
    function _approve(address owner, address spender, uint256 amount) internal {
        ...
        require(spender != address(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83), "ERC20: approve to the Token address");
