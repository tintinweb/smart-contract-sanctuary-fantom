...
contract StrategyOxdVolatileWftmOxd2Lp is StrategyOxdFarmLPBase {
    // Token addresses
    address public wftm_oxd2_lp = 0xcB6eAB779780c7FD6d014ab90d8b10e97A1227E2;
    address public oxd2 = 0xc5A9848b9d145965d821AaeC8fA32aaEE026492d;
    ...
    {
        swapRoutes[oxd2].push(route(wftm, oxd2, false));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategyOxdVolatileWftmOxd2Lp";
    }
}
