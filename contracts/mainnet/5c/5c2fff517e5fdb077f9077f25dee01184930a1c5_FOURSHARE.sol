...
contract FOURSHARE is Context, IERC20, Ownable {
    ...
    string private constant _name = '4Share Token';
    string private constant _symbol = '4SHARES';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x8df45f817ec5DF8fF6FD5e04b6e7e6DD8b2afa65, 'We can not exclude router.');
