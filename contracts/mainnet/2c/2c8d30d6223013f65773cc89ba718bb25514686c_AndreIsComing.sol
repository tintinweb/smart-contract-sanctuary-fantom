...
/**
 *The propaganda is clear. Bringing back the degen life on Fantom with the hot favourite topic on chain rn. 
TG - t.me/swooshroosh
Tax - 7%
*/
...
contract DividendDistributor is IDividendDistributor {
 ...
 IERC20 RWRD = IERC20(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83); //wftm
...
contract AndreIsComing is IERC20, Auth {

    using SafeMath for uint256;



     address RWRD = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;  
    ...
    string constant _name = "AndreIsComing";

    string constant _symbol = "SwooshRoosh";
    ...
    uint256 public _maxWallet = _totalSupply / 30;  
...
return selling ? totalFee.add(liquidityFee) : totalFee;
    ...
    function setFees(
        ...
        totalFee = buybackFee.add(reflectionFee).add(marketingFee).add(devFee).add(liquidityFee);
