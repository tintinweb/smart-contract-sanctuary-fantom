...
contract StrategyTombMaiLP is StratManager, FeeManager, GasThrottler {
    ...
    function chargeFees(address callFeeRecipient) internal {
        ...
        IUniswapRouterETH(spookyRouter).swapExactTokensForTokens(toNative, 0, outputToNativeRoute, address(this), now);
    ...
    function addLiquidity() internal {
        ...
        if (lpToken0 != output) {
            IUniswapRouterETH(spookyRouter).swapExactTokensForTokens(outputHalf, 0, outputToLp0Route, address(this), now);
        }

        if (lpToken1 != output) {
            IUniswapRouterETH(spookyRouter).swapExactTokensForTokens(outputHalf, 0, outputToLp1Route, address(this), now);
        }
    ...
    function _giveAllowances() internal {
        ...
        IERC20(output).safeApprove(spookyRouter, uint256(-1));
    ...
    function _removeAllowances() internal {
        ...
        IERC20(output).safeApprove(spookyRouter, 0);
        IERC20(lpToken0).safeApprove(unirouter, 0);
        IERC20(lpToken1).safeApprove(unirouter, 0);
    }
