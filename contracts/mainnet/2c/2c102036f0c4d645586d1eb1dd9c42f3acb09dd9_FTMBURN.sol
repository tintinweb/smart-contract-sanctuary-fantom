...
//First everBurn Fork in FTM on steroid
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Token1 = IBEP20(0xAd84341756Bf337f5a0164515b1f6F993D194E1f); //FUSD token
...
contract FTMBURN is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;

    address public Token1 = 0xAd84341756Bf337f5a0164515b1f6F993D194E1f; //FUSD token
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83; //WFTM
    ...
    address ROUTERADDR = 0xF491e7B69E4244ad4002BC14e878a34207E38c29; //spookySwap router

    string constant _name = "FTMBURN";
...
//        emit Transfer(sender, recipient, amount);
    ...
    function swapBack(uint256 _amount) internal swapping {
        ...
        uint256 amountFTMReflection = amountFTM.mul(SellReflectionFee).div(totalFTMFee);
    ...
    function SwapBackManual(uint256 _amount)  external authorized{
        if (_balances[address(this)] >= _amount){
            ...
            try distributor.deposit{value: amountFTM}() {} catch {}
        }
    }
