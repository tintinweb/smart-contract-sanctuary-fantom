...
contract GoodMorningFantom is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Good Morning Fantom';
    string private constant _symbol = 'GMFTM';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xf9c54fb1478E81cF899CD81F706f6a730351Df27, 'We can not exclude router.');
