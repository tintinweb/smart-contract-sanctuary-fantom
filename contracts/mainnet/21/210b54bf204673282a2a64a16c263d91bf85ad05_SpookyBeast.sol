...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ADA = IBEP20(0x841FAD6EAe12c286d1Fd18d1d525DFfA75C7EFFE); // BOO
...
contract SpookyBeast is IBEP20, Auth {
    using SafeMath for uint256;

    address ADA =  0x841FAD6EAe12c286d1Fd18d1d525DFfA75C7EFFE; // BOO
    address WBNB = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SpookyBeast";
