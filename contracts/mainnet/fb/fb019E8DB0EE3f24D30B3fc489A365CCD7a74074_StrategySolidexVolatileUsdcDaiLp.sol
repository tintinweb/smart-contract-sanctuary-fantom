...
contract StrategySolidexVolatileUsdcDaiLp is StrategySolidexFarmLPBase {
    // Token addresses
    address public usdc_dai_lp = 0x4e9B80F91E954AE532fF765822fcB5a6bC36cAa6;
        ...
        )
    {
        ...
        swapRoutes[dai].push(route(wftm, usdc, false));
        swapRoutes[dai].push(route(usdc, dai, false));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategySolidexVolatileUsdcDaiLp";
    }
}
