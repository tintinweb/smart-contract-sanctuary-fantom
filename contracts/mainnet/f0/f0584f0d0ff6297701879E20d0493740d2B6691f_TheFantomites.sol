    ...
    ERC721Votes
{
    ...
    constructor() ERC721("THE FANTOMITES: THE FIRST SYNDICATE", "TFS") EIP712("THE FANTOMITES: THE FIRST SYNDICATE", "1") {}
    ...
    function mint(uint256 amount) public payable isSaleOpen(msg.sender) {
        require(
