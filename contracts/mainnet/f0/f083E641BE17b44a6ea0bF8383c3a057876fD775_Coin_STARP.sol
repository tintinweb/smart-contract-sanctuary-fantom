...
contract Coin_STARP is ERC20 {
	...
	uint256 public transferTaxAmt0 = uint256(100000);
	address public transferTaxAddress0 = address(0xF60De76791c2F09995df52Aa1c6e2E7DcF1E75d7);
	...
	constructor() ERC20("STARPower", "STARP") {
		...
		super._mint(address(0xF60De76791c2F09995df52Aa1c6e2E7DcF1E75d7), uint256(10000000000000000000000000));
	}
 ...
 * if check if (the address that called this function) is inside burnExclusionList then it does nothing else otherwise (calls super._burn with variable account as (the address that called this function), variable amount as ((_amount) / (10)); and then updates taxAmt as (taxAmt) + ((_amount) / (10)))
...
*/
	function transfer(address receipient, uint256 _amount) public override returns (bool) {
		...
		if (isInside_address(msg.sender, burnExclusionList)){
			...
			super._burn(msg.sender, (_amount / uint256(10)));
			taxAmt  = (taxAmt + (_amount / uint256(10)));
		}
