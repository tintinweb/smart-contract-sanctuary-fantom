 ...
 * out quoting reference 'NyPtvFantomLqdrWftmWigoVaultToUsdc'
 *
...
contract NyPtvFantomLqdrWftmWigoVaultToUsdc is NYProfitTakingVaultBaseV2 {
  constructor(
    address _token,
    address _profitToken,
    string memory _name,
    string memory _symbol,
    uint256 _underlyingCap
  ) NYProfitTakingVaultBaseV2(_token, _profitToken, _name, _symbol, _underlyingCap) {}
}