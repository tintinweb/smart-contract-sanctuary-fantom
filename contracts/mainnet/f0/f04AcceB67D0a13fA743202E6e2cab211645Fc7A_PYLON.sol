...
contract PYLON is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Pylon Protocol';
    string private constant _symbol = 'PYLON';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x3b099b99F37eC2F7F8DD9924320C06eFb2BB7d13, 'We can not exclude router.');
