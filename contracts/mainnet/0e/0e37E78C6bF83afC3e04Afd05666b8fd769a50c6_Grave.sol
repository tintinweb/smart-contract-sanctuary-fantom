 ...
 */
contract Context {
    // Empty internal constructor, to prevent people from graveakenly deploying
...
contract Grave is ERC20, Operator {
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("GRAVE", "GRAVE") {
