...
contract SpookySwapRestrictedStrategyAddTwoSidesOptimal is
  OwnableUpgradeSafe,
  ...
  IStrategy
{
  ...
  modifier onlyWhitelistedWorkers() {
    require(
      ...
      "SpookySwapRestrictedStrategyAddTwoSidesOptimal::onlyWhitelistedWorkers:: bad worker"
    );
    _;
  }
  ...
  function initialize(ISpookyRouter02 _router, IVault _vault) external initializer {
  ...
  function execute(
    ...
    require(
      ...
      "SpookySwapRestrictedStrategyAddTwoSidesOptimal::execute:: insufficient LP tokens received"
    );
    require(
      lpToken.transfer(msg.sender, lpToken.balanceOf(address(this))),
      "SpookySwapRestrictedStrategyAddTwoSidesOptimal::execute:: failed to transfer LP token to msg.sender"
    );
