...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWD = IBEP20(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75);
...
contract FTM2222 is IBEP20, Auth {
    using SafeMath for uint256;

    address RWD =  0x04068DA6C83AFCFA0e13ba15A6696662335D5B75;
    address WBNB = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "FTM2";
    string constant _symbol = "FTM2";
    ...
    constructor () Auth(msg.sender) {
        marketingFeeReceiver = 0x76908EC956ba0c109BBb4a6C85F67Cc474DC2B7D;
