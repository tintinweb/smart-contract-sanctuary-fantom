...
// File contracts/EqualizerEqualConkvAMM.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract EqualizerEqualConkvAMM is Ownable, Pausable {
   ...
   //Withdraws funds from masterchef
    ...
    function addLiquidity() internal {
        ...
        uint256 lp0Bal = IERC20(equal).balanceOf(address(this));
        uint256 lp1Bal = IERC20(conk).balanceOf(address(this));

        IEqualizerRouter(router).addLiquidity(equal, conk, stable, lp0Bal, lp1Bal, 1, 1, address(this), block.timestamp);  
    }
