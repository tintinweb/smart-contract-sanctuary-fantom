...
contract CAKE is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("CAKE", "CAKE") {
        _mint(msg.sender, 1 ether); // mint 1 CAKE for initial pools deployment
