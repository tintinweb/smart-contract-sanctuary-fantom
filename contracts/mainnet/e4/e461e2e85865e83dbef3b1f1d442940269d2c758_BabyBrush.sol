...
contract DividendDistributor is IDividendDistributor {
    ...
    address _token;
    address crea = 0x53CD418DC46B61B732bc9e37059e951806C8D7A2;
    ...
    IBEP20 REW = IBEP20(0x85dec8c4B2680793661bCA91a8F129607571863d);
...
contract BabyBrush is IBEP20, Auth {
    using SafeMath for uint256;

    address REW = 0x85dec8c4B2680793661bCA91a8F129607571863d;
    address WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyBrush";
    string constant _symbol = "BBRUSH";
    uint8 constant _decimals = 4;

    //Total Supply: 1.000.000
    uint256 _totalSupply = 1 * 10**6 * (10 ** _decimals);

    //max wallet holding of 0,3%
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x585353824a10D73D164034a45a694847f1B9f426;
        marketingFeeReceiver = 0x585353824a10D73D164034a45a694847f1B9f426;
