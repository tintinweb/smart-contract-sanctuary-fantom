...
contract DEXTax
{
	...
	function doSwapsForExactTokens(RouteItem[] calldata route, uint amountIn, uint amountOut, address to, uint deadline)
        internal
    {
        doSwaps(route, amountIn, deadline);
        ...
        external returns (uint[] memory amounts)
    {
        ...
        doSwapsForExactTokens(route, value, amountOut, to, deadline);
    }
