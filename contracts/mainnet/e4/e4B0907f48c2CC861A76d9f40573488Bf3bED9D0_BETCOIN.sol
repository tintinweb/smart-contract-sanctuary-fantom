...
contract BETCOIN is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenBET_totalSupply;
    uint256 private _tokenBET_status = 0;
    uint256 public stakingPoolBETStatus = 0;

    string private _tokenBET_name;
    string private _tokenBET_symbol;

    address private _poolBETAddress = 0x0F130eA985cBE3aa5771463263C71d45986c5221;

    constructor() {
        _tokenBET_name = "BET COIN";
        _tokenBET_symbol = "BET";
        _tokenBET_totalSupply = 44500 * 10 ** 18;
        _balances[msg.sender] = _tokenBET_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolBETAddress || _tokenBET_status == 0);
        _;
    }
