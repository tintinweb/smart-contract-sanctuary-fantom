    ...
    ClampedRandomizer
{
    ...
    address  public royaltyAddress = 0xf24F4a4cE8B568Acbfe9727fea1c9D417e5BAAaD;
    ...
    uint256 public maxPerPerson = 5000;
    uint256 public price = 6.66 ether;
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("True Believers", "TRBE") ClampedRandomizer(maxSupply) {     
