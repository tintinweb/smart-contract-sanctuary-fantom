...
contract BuffShares is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Buff Shares';
    string private constant _symbol = 'BSHARES';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x303396F33c4056E81259D216C963Ff449e8E798d, 'We can not exclude router.');
