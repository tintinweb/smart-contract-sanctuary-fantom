...
contract AirdropHandler is OwnableUpgradeable, UUPSUpgradeable {
    ...
    // post-initial-deploy
    uint constant claimOffset = 1 weeks;
    ...
    function startLock(
        ...
        require(block.timestamp < (claimLimit + claimOffset), "You are too late");
    ...
    function claimFTM() public {
        ...
        (bool success, ) = account.call{value: 5}("");
