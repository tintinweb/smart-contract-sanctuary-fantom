...
contract EndGame is ERC20Burnable, Operator {
    ...
    // Initial distribution for the day 2-5 ENDGAME-WETH LP -> ENDGAME pool
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("endgame.money", "ENDGAME") {
