...
contract RevestSpiritSwapLocker is IOutputReceiver, Ownable, ERC165, ERC721Holder, IFeeReporter {
    ...
    string public  metadata = 'https://revest.mypinata.cloud/ipfs/QmViFRBtDTmREtvBF3vm7rF1TPJyCGER7vqyPDZwZGT5Bn';
    ...
    constructor(address _provider, address _spirit, address _lpCustodian, address gauge) {
    ...
    function setMetadata(string memory meta) external onlyOwner {
        metadata = meta;
    }
