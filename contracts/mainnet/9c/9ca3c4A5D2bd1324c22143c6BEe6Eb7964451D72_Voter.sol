...
contract ExternalBribe is IBribe {
    ...
    uint256 internal constant DURATION = 1 days; // rewards are released over the voting period
...
contract Gauge is IGauge {
    ...
    uint256 internal constant DURATION = 1 days; // rewards are released over 1 days
    uint256 internal constant PRECISION = 10**18;
    uint256 internal constant MAX_REWARD_TOKENS = 16;
...
contract Minter is IMinter {
    uint256 internal constant WEEK = 86400; // allows minting once per week (reset every Thursday 00:00 UTC)
