...
// Stake OxDOLLAR To Earn FTM, USDC, OxShare, & DAI.
// Stake OxShare-DAI Lp To Earn FTM, USDC, OxShare, & DAI. High APY 12800% 
...
contract OxDollar is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 100,000 OxDOLLAR
    ...
    constructor() public ERC20("OxDollar", "OxDollar") {
        _mint(msg.sender, 2 ether); // mint 2 OxDollar for initial pools deployment
        devFund = msg.sender;
    }
