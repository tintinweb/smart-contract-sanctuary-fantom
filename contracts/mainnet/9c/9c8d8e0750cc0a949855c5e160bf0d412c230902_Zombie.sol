...
contract Zombie is ERC20Burnable, Operator {
    ...
    // uint256 public constant INITIAL_ZOMBIE_POOL_DISTRIBUTION = 140000 ether;
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("ZOMBIE", "ZOMBIE") {
    ...
    function distributeReward(
        ...
        require(_zombiePool != address(0), "!_zombiePool");
        require(_airdropWallet != address(0), "!_airdropWallet");
        rewardPoolDistributed = true;
        _mint(_genesisPool, INITIAL_GENESIS_POOL_DISTRIBUTION);
        // _mint(_zombiePool, INITIAL_ZOMBIE_POOL_DISTRIBUTION);
