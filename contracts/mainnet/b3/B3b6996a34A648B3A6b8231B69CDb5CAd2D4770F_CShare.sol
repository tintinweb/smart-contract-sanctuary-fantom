...
contract CShare is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime) public ERC20("CSHARE", "CSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 COPE Share for initial pools deployment
        ...
        devFund = address(0xeeA09d571fC2B70FA5aB50733EF59abddFbEA790);
        communityFund = address(0x02cd527F4Fb7263E018763BBE53c2DcAD172a7d4);
    }
