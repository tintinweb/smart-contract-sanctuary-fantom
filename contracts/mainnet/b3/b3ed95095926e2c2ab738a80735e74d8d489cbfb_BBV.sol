...
BBV Fan Token
BabyVoorhees
Bringing a community driven NFT token to the Fantom network.
Alongside a special 13k generated NFT project as well as
 the BabyVoorhees incubator and a DAO in the roadmap etc…
 All presale funds will be transferred to liquidity
Baby Voorhees official BSC
@1Baby_Voorhees
http://t.me/babyvoorhees join us on telegram while we prepare for launching on the BSC Network hodl so we can all reach lake crystal by Friday the 13th
Currency Exchangebabyvoorhees.com
...
contract BBV is BBVDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private BBVTeam;
    address private CharityBBV;
    ...
    string public override name = "BabyVoorhees";
    string public override symbol = "BabyVoorhees";
    ...
    constructor(uint totalSupplyValue, address BBVTeamAddress, address CharityBBVAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        BBVTeam = BBVTeamAddress;
        CharityBBV = CharityBBVAddress;
        
        // split the tokens according to agreed upon percentages
        balances[BBVTeam] =  totalSupply * 4 / 100;
        balances[CharityBBV] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's BBVTeam pot
