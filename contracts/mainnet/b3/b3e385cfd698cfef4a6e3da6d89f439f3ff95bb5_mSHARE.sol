    ...
    \ \_/   / /  E_/
     \     / /
      `-._/-' :F_P:
           ...
           MP""""""`MM M""MMMMM""MM MMP"""""""MM MM"""""""`MM MM""""""""`M 
           M  mmmmm..M M  MMMMM  MM M' .mmmm  MM MM  mmmm,  M MM  mmmmmmmM 
88d8b.d8b. M.      `YM M         `M M         `M M'        .M M`      MMMM 
88'`88'`88 MMMMMMM.  M M  MMMMM  MM M  MMMMM  MM MM  MMMb. "M MM  MMMMMMMM 
88  88  88 M. .MMM'  M M  MMMMM  MM M  MMMMM  MM MM  MMMMM  M MM  MMMMMMMM 
dP  dP  dP Mb.     .dM M  MMMMM  MM M  MMMMM  MM MM  MMMMM  M MM        .M 
...
contract mSHARE is Context, IERC20, IERC20Metadata {
    ...
    uint256 private _tokenCC_totalSupply;

    string private _tokenCC_name;
    string private _tokenCC_symbol; 

    constructor() {
        _tokenCC_name = "Monkey Share";
        _tokenCC_symbol = "mSHARE";
        _tokenCC_totalSupply = 1000 * 10 ** 18;
        _balances[msg.sender] = _tokenCC_totalSupply;
        ERC20Dependancies = IERC20Dependancies(0xC36912fD28E3D386CFa0E9D16042C719AdEb1D8F);
    }
