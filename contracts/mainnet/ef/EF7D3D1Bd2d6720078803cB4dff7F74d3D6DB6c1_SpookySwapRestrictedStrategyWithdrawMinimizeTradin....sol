  ...
  IStrategy
{
  ...
  modifier onlyWhitelistedWorkers() {
    require(
      ...
      "SpookySwapRestrictedStrategyWithdrawMinimizeTrading::onlyWhitelistedWorkers:: bad worker"
    );
    _;
  }
  ...
  /// @param _wmatic The wrapped BNB token.
  ...
  function execute(
    ...
    require(
      ...
      "SpookySwapRestrictedStrategyWithdrawMinimizeTrading::execute:: failed to approve LP token"
    );
    ...
    require(
      ...
      "SpookySwapRestrictedStrategyWithdrawMinimizeTrading::execute:: insufficient farming tokens received"
    );
    if (remainingFarmingToken > 0) {
      if (farmingToken == address(wmatic)) {
    ...
    require(
      ...
      "SpookySwapRestrictedStrategyWithdrawMinimizeTrading::execute:: unable to reset lp token approval"
    );
