/**
 *Submitted for verification at FtmScan.com on 2023-05-15
*/
...
contract BarIco is Ownable {
    ...
    uint256 private _startDate = 1684182764; // When to start ICO 
    uint256 private _endDate = 1685048399; // When to end ICO 
    uint256 private _claimDate = 1685048399; // When to claim ICO 
