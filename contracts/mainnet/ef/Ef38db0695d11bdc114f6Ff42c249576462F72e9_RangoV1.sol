...
contract BaseContract is PausableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function test123() public view virtual returns (address) {
        return nativeWrappedAddress;
    }
...
contract RangoMultichainProxy is BaseContract {
    ...
    function multichainBridge(
        ...
        uint value = request.toToken == NULL_ADDRESS ? (out > 0 ? out : minimumRequiredValue) : 0;
