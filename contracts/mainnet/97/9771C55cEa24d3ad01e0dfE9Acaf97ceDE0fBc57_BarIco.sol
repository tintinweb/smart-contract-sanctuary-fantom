...
contract BarIco is Ownable {
    ...
    uint256 private _startDate = 1683462804; // When to start ICO 
    uint256 private _endDate = 1684097999; // When to end ICO 
    uint256 private _claimDate = 1684097999; // When to claim ICO 

    uint256 private _hardcap = 100000 ether; // hard cap
    uint256 private _softcap = 5000 ether; // softcap
    uint256 private _icoPrice = 3 ether; // token price
    uint256 private _minPerUser = 30 ether; // min amount per user
    uint256 private _maxPerUser = 30000 ether; // max amount per user
