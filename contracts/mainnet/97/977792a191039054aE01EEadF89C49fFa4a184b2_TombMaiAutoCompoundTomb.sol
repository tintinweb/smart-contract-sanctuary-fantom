...
contract TombMaiAutoCompoundTomb is IStrategy, Ownable, Pausable {
     ...
     * {liquidityProvider} - the liquidity for
     ...
     */
    address[] public rewardTokenToWftmRoute = [rewardToken, mai, wftm];
    ...
    constructor(
        ...
        rewardTokenToLp0Route = [rewardToken, lpToken1, lpToken0];

        rewardTokenToLp1Route = [rewardToken, lpToken1];
