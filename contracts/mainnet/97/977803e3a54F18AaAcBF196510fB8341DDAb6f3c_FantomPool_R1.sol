...
contract FantomPool_R1 is PausableUpgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable, ERC165Upgradeable, IBeaconUpgradeable, IBeaconDeployer, IStakingPool_R1 {
    ...
    function _stake(address staker, uint256 amount) internal {
        ...
        emit StakeReceived(staker, amount);
    }
