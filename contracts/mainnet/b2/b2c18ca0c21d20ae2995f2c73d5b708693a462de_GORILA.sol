...
contract TaxPool is Ownable {
  ...
  uint256 public rndPercentage = 2000; address public rndWallet = 0x7593104d3e3a480A9F197c162DE63e0BBabaeBFb;
  function setRND (uint256 percent_, address wallet_) public onlyOwner { rndPercentage = percent_; rndWallet = wallet_; }
  
  uint256 public marketingPercentage = 4000; address public marketingWallet = 0x364A1bdB3a9278F17B9758be451B74f58c74822a;
  ...
  uint256 public buybackandburnPercentage = 2000; address public buybackandburnWallet = 0x6F5A77739fD0012A4b013cAd601ea1c332ad699A;
  ...
  , IERC20Metadata
{
  ...
  string private _name = "Gorila State";
  string private _symbol = "GORILA";
