...
contract Dshare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 100,000 Dshares
    ...
    constructor(address _communityFund, address _devFund1, address _devFund2) public ERC20("DigiFi", "DSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 Dshare for initial pools deployment
