...
contract PUMPSHARE is ERC20Burnable, Operator {
    using SafeMath for uint256;
    ...
    // TOTAL MAX SUPPLY = 60,000 PUMPSHAREs
    ...
    constructor(uint256 _startTime, address _devFund, uint256 _taxRate, address _taxCollectorAddress) public ERC20("PUMPSHARE", "PUMPSHARE") {
