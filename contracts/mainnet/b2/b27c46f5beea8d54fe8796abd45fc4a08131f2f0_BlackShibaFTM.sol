...
//  Telegram: https://t.me/blackshibaftm
//  Lp Lock / REWARD TOKEN / Dev SAFU
...
contract BlackShibaFTM is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BlackShibaFTM";
    string constant _symbol = "BSFTM";
    ...
    address public autoLiquidityReceiver=0x66644F4755cB0DA71Eb8D90270C7e8b2753473A2; //liq address
    address public marketingFeeReceiver=0x66644F4755cB0DA71Eb8D90270C7e8b2753473A2; // marketing address
    ...
    uint256 public swapThreshold = _totalSupply / 4000; // 0.1%
    bool inSwap;
