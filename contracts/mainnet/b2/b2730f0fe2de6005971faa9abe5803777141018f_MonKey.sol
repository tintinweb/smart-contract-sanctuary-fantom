...
library Monkey {
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(c / a == b, "Monkey: multiplication overflow");
    ...
    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        require(b > 0, "Monkey: division by zero");
        uint256 c = a / b;
    ...
    function mod(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b != 0, "Monkey: modulo by zero");
        return a % b;
    }
}
 ...
 * @title ERC20 Token
 */
contract MonKey is PausableToken, MintableToken {
  using Monkey for uint256;
