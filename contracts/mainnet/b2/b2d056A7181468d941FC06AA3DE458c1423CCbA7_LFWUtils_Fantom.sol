...
contract LFWUtils_Fantom {
    ...
    address private spiritFarming = 0x5Cc61A78F164885776AA610fb0FE1257df78E59B;
    ...
    function getGeistFarmingInfo(
        ...
        // [1] is the user's staking amount
        (farmingInfo[1], rewardDebt) = scInterface.userInfo(geistLP, _userAddress);

        // [0] is the user's pending reward
        farmingInfo[0] = farmingInfo[1]*(accRewardPerShare)/1e12  - rewardDebt;
    ...
    function getSpookyStakingInfo(
        ...
        stakingInfo = scInterface.BOOBalance(_userAddress); // user's staking amount
    }
    ...
    function getWigoFarmingInfo(
        ...
        // Initialize interface
        IWigoInterface scInterface = IWigoInterface(spiritFarming);
