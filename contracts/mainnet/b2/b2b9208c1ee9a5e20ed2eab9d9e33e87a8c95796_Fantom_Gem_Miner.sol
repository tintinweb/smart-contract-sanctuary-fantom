...
contract Fantom_Gem_Miner {
    using SafeMath for uint256;
    address payable public owner;
    string public name = "Fantom_Gem_Miner";

    uint256 public constant INVEST_MIN_AMOUNT = 5 ether;
    uint256[] public REFERRAL_PERCENTS = [100, 50, 30];
    uint256 public constant TOTAL_REF = 180;
    uint256 public constant FUND_FEE = 50;
    uint256 public constant DEV_FEE = 50;
    uint256 public constant MKT_FEE = 50;
    ...
    constructor(
        ...
        plans.push(Plan(100, 35, 100)); //100days 3.5%daily 10% Tax
        plans.push(Plan(100, 45, 150)); //100days 4.5%daily 15% Tax
        plans.push(Plan(100, 55, 200)); //100days 5.5%daily 20% Tax
    }
