...
contract DebitaV1 is ERC1155Holder {
    ...
    mapping(address => uint256) public lendingAmount_PerToken; 

    mapping(address => uint256) public waitingLendingAmount_PerToken; 
    ...
    function createLenderOption(
        ...
        lendingAmount_PerToken[_LenderToken] += _LenderAmount;
    ...
    function cancelLenderOffer(uint256 id) public {
        ...
        IERC20 B_TOKEN = IERC20(_LenderINFO.LenderToken);
         ...
         require(success);
        lendingAmount_PerToken[_LenderINFO.LenderToken] -= _LenderINFO.LenderAmount;
    ...
    function createCollateralOffer(
        ...
        waitingLendingAmount_PerToken[_wantedLenderToken] += _wantedLenderAmount;
    ...
    function cancelCollateralOffer(uint256 _id) public {
        ...
        waitingLendingAmount_PerToken[collateralInfo.wantedLenderToken] -= collateralInfo.wantedLenderAmount;
        ...
        payable
    {
        ...
        delete LendersOffers[id];
        lendingAmount_PerToken[lenderInfo.LenderToken] -= lenderInfo.LenderAmount;
        uint256 WEIamount;
