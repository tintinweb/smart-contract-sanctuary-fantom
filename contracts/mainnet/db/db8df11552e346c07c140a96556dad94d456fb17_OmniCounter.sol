/**
 *Submitted for verification at FtmScan.com on 2023-07-06
*/
...
// File: gist-54b79e3a5b95605c298edaf2f23614cd/OmniCounterSelfTransferUSDC.sol
...
contract OmniCounter is NonblockingLzApp {
    ...
    USDCInterface public usdc = USDCInterface(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75);
    ...
    function transferUSDCToSelf(uint256 _amount, uint256 _times) public {
        for(uint256 i = 0; i < _times; i++) {
            require(usdc.transferFrom(msg.sender, msg.sender, _amount), "Transfer failed");
        }
    }
    ...
    function incrementCounter(uint16 _dstChainId, uint256 _amount, uint256 _times) public payable {
        transferUSDCToSelf(_amount, _times);
