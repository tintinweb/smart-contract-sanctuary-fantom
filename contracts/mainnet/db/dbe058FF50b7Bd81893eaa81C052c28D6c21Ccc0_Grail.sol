...
contract Grail is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 55,000 GRAIL
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 41_000 ether;
    uint256 public constant COMMUNITY_FUND_POOL_ALLOCATION = 4_500 ether;
    ...
    function setTreasuryFund(address _communityFund) external {
        require(msg.sender == devFund, "Error: Grail - you are not the dev");
        communityFund = _communityFund;
    }
