...
// this contract calculates PILLS staked in Neo Pools, various gauge contracts (LQDR, SPIRIT), as well as regular PILLS held in wallet.
...
contract ZionGovernance is Ownable {
    ...
    address public poolContract = 0x9C775D3D66167685B2A3F4567B548567D2875350;
    address public lqdContract = 0x6e2ad6527901c9664f016466b8DA1357a004db0f;
    address public sptContract = 0x3A514Ce911E86164064F30Bf9134085Ae0E514aC;
    ...
    function balanceOf(address wallet) public view returns (uint balance) {
        ...
        (uint256 amount,) = IFarm(lqdContract).userInfo(35, wallet);
        amount += IERC20(sptContract).balanceOf(wallet);

        balance += ((reserve1 * amount) / totalSupply) * 2;
    }
