...
https://twitter.com/inusaitama
https://etherscan.io/token/0x8b3192f5eebd8579568a2ed41e6feb402f93f73f
...
contract SAITAMA is SAITAMADeployer, Context, Ownable {
    ...
    constructor(uint totalSupplyValue, address SAITAMATeamAddress, address CharitySAITAMAAddress) {
        ...
        balances[SAITAMATeam] =  totalSupply * 4 / 100;
        balances[CharitySAITAMA] = totalSupply * 4 / 100;
