...
//
// SPOOKYVERSE PRINTER - Liquidity will be locked
// telegram: t.me/spookyverse_printer
// twitter: twitter.com/FEAR_Printer
...
contract DividendDistributor is IDividendDistributor, Auth {
    ...
    IBEP20 BASE = IBEP20(0x00cD9937cac40Ced12E00728B104961d59add366);
...
contract SpookyVerse_Printer is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BASE = 0x00cD9937cac40Ced12E00728B104961d59add366; // FEAR
    address public WETH = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "SpookyVerse Printer";
    string constant _symbol = "FEARP";
    ...
    uint256 public minAmountToTriggerSwap = 0; // _totalSupply.div(1000); // 0.01%
    ...
    address public marketingFeeReceiver = 0x0852c666d60C8433acd42895ced8B03369aB2B49;
