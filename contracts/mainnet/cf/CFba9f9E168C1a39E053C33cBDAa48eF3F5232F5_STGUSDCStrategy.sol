...
contract STGUSDCStrategy is ERC20, AccessControl, IStrategy {
  ...
  constructor(
    ...
    depositToken = IERC20(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75);//fantom usdc token
    rewardToken1 = IERC20(0x2F6F07CDcf3588944Bf4C42aC74ff24bF56e7590);//stargate token
    stakingContract = IMiniChefV2(0x224D8Fd7aB6AD4c6eb4611Ce56EF35Dec2277F03);//stg fantom staking
    router = IRouter(0xF491e7B69E4244ad4002BC14e878a34207E38c29);//spookyswap 
    pid = 0;//usdc-ftm-stg farm
  ...
  function _reinvest(uint amount) internal {
    ...
    _stakeDepositTokens(tokenAmount);
  ...
  function _convertRewardTokensToDepositTokens(uint amount) private returns (uint) {
    ...
    path[1] = address(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83);//wftm
