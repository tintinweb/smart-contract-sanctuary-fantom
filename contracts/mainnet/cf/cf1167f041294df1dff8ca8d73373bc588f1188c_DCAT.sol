...
contract DCAT is ERC721Enumerable, Ownable, ReentrancyGuard  {
  using Strings for uint256;
  ...
  uint256 public maxMintAmount = 820;
  ...
  // public
  function mintNFT(uint256 _mintAmount) public nonReentrant() {
    require(exploiter[msg.sender] == false, "EXPLOITER GIVE ME MY MONEY");
    require(!paused, "the contract is paused");
    uint256 bronze = 1;
    require(limit[msg.sender] + _mintAmount <= 821, "LIMIT REACHED");
    require(maxMintBronze + _mintAmount <= 821, "SOLD OUT");
