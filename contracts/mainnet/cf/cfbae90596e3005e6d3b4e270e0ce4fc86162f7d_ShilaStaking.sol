...
contract ShilaStaking is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        stakingToken = IBEP20(0x7A5e9CBA63c904AF65D37b7D7B87A59E7D722F12);
        rewardToken = IBEP20(0x0078A250a5acB059Cb0C7094e38B766a307095E0);
    ...
    function updateApy(uint256 newApy) external onlyOwner {
        require(newApy <= 50000, "APY must be below 10000%");
        updatePool(0);
        apy = newApy;
    }
