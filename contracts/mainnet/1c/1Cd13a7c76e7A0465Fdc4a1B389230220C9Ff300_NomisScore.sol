...
contract NomisScore is ERC721, ERC721URIStorage, ERC721Burnable, Ownable, Pausable, EIP712 {
    ...
    */
    constructor(uint256 initialFee, uint16 initialCalcModelsCount, uint16 initialfreeMintCount) ERC721("NomisScore", "NMSS") EIP712("NMSS", "0.5") {
        _tokenIds.reset();
        _mintFee = initialFee;
    ...
    function setScore(
        ...
        bytes32 messageHash = _hashTypedDataV4(keccak256(abi.encode(
            keccak256("SetScoreMessage(uint16 score,uint16 calculationModel,address to,uint256 nonce,uint256 deadline,bytes32 metadataUrl)"),
            score,
            calculationModel,
            msg.sender,
            nonces[msg.sender],
