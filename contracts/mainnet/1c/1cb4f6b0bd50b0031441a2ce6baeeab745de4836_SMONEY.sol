...
contract SMONEY is ERC20Burnable, Operator 
{
    using SafeMath for uint256;

    uint256 public constant MAX_SUPPLY = 10 ether;
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 1 ether;
    uint256 public constant COMMUNITY_FUND_POOL_ALLOCATION = 1 ether;
    ...
    constructor() public ERC20("SMONEY", "SMONEY") {
