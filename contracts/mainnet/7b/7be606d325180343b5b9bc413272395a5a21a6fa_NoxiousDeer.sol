...
// File: contracts/NoxiousDeer.sol



pragma solidity 0.6.12;

contract NoxiousDeer is ERC20Burnable, Operator {
    using SafeMath8 for uint8;
    using SafeMath for uint256;

    // Initial distribution for Liquidity
    uint256 public constant INITIAL_LAUNCH_DISTRIBUTION = 20000 ether;
    // Distribution for Treasury wallet
    uint256 public constant INITIAL_TREASURY_WALLET_DISTRIBUTION = 2500 ether;
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("NOXDEER", "NOXDEER") {
