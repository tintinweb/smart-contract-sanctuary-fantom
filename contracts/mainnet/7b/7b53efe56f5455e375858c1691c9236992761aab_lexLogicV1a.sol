...
contract lexLogicV1a is Ownable {
    ...
    address public packs = 0x98C12b56258552F143d35be8983077eb6adBe9a4;
  ...
  function openPack(uint256 packID) external {
    require(mintGate == 1);
    IERC721 pk = IERC721(packs);
    pk.safeTransferFrom(msg.sender, void, packID);
    CChance++;
    if (CChance == modGlob) {
        CChance = 0;
    }
