...
contract xNative_Vault is Ownable, ReentrancyGuard, Pausable {
    ...
    uint256 public earlyWithdrawFeeFactor = 700;
    ...
    function withdraw(uint256 _wantAmt) public {
        ...
        if (bal < withdrawAmt) {
            ...
            INativeFarm(nativeFarm).withdraw(pid, balWithdraw, earlyWithdrawDuration);
    ...
    function harvest() external notContract whenNotPaused {
        INativeFarm(nativeFarm).withdraw(pid, 0, earlyWithdrawDuration);
    ...
    function setEarlyWithdrawFeeFactor(uint256 _earlyWithdrawFeeFactor) external onlyAdmin {
