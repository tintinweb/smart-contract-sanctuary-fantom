...
contract Pool is Ownable, ReentrancyGuard {
        ...
        )
    {
        ...
        if (collateralRatio < COLLATERAL_RATIO_MAX) {
            uint256 _fantasmValueOut = _xftmIn - _requiredFtmBalance;
        ...
        if (collateralRatio > 0) {
            _ftmFee = (_requiredFtmBalance * redemptionFee) / PRECISION; // redemption fee in FTM
            _ftmOut = _requiredFtmBalance - _ftmFee; // after fee
        }
    }
