...
contract StrategyScarface_SSHARE_FTM is BaseStrategyMC {

    address sshare_ftm_diff;

    function initializeStrategy(
        address _store,
        address _vault
    ) public initializer {
        address masterchef = address(0xD3c723e1A822997D60976e20d1f3F4f69DBeF482);
        address sshare_ftm_lp = address(0x8D786e37Ae7224ea9fbB3e47516c163e0C7d972e);
        address sshare = address(0xC90455FCCFa707F619F3B94F22BafD961E59a329);
        ...
        _setSellFloor(1e2);
        routes[sshare] = [sshare];
        routes[wftm] = [sshare, wftm];
    }
}
