...
contract CELESTIAL is ERC20Burnable, Operator {
    using SafeMath for uint256;


    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 9000 ether;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("CELESTIAL", "CELESTIAL") {
        _mint(msg.sender, 1 ether); // mint 1 CELESTIAL for initial pools deployment
