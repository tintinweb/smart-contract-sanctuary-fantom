...
library Address{
 ...
 contract PochiFTM is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x060FF06eEA263c8D9cfBFCaF32920Fd3f508C42A;
    address public buybackWallet = 0x760360426FaA2CaDdAdEfC3D886F8F18f59Cc737;

    string private constant _name = "POCHIFTM";
    string private constant _symbol = "$POCHIFTM";
