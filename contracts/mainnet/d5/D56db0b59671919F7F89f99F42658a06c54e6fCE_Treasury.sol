...
contract Treasury is ContractGuard {
    ...
    function setMaxTxAmount (uint256 _newMaxAmount) public onlyOperator {
        IBasisAsset(tomb).setMaxTxAmount(_newMaxAmount);
    }
...
interface IBasisAsset {
    ...
    function setMaxTxAmount (uint256 _newMaxAmount) external;
}
