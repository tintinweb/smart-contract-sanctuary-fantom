...
contract OxSHare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 50,000 OxSHare
    ...
    constructor() public ERC20("OxSHare", "OxSHare") {
        _mint(msg.sender, 2 ether); // mint 2 OxShare for initial pools deployment
        devFund = msg.sender;
    }
