...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xD31Fcd1f7Ba190dBc75354046F6024A9b86014d7); // SEX
...
contract SEXPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xD31Fcd1f7Ba190dBc75354046F6024A9b86014d7; // SEX
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "SEXPrinter";
    string constant _symbol = "SEXP";
    ...
    address public autoLiquidityReceiver=0x08493630967083cA4D781ce77952B1f39EaD6fFa; //liq address
    address public marketingFeeReceiver=0x08493630967083cA4D781ce77952B1f39EaD6fFa; // marketing address
