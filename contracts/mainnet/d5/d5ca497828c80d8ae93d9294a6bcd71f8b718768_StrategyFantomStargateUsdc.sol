...
// File src/strategies/fantom/strategy-stargate-farm-base.sol
pragma solidity ^0.8.6;
...
abstract contract StrategyStargateFarmBase is StrategyBase {
    ...
    constructor(
        ...
        IERC20(stg).approve(sushiRouter, type(uint256).max);
    ...
    function harvest() public override {
        ...
        if (underlying == baseToken) {
            path = abi.encodePacked(stg, poolFee, baseToken);
        } else {
        ...
        _swapSushiswapWithPath(uniswapRoutes[underlying], _stg);
...
// File src/strategies/fantom/stargate/strategy-stargate-usdc.sol
// License-Identifier: MIT
pragma solidity ^0.8.6;

contract StrategyFantomStargateUsdc is StrategyStargateFarmBase {
    // Token addresses
    address public constant _lp = 0x12edeA9cd262006cC3C4E77c90d2CD2DD4b1eb97;
    address public constant _underlying =
        0x04068DA6C83AFCFA0e13ba15A6696662335D5B75;
    address public usdc = 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75;
    address public _baseToken = 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75;
    ...
    {
        uniswapRoutes[baseToken] = [stg, usdc];
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategyFantomStargateUsdc";
    }
}