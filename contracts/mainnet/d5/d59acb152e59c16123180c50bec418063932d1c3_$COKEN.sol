...
contract $COKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Fed Inu";
    string private constant _symbol = "$COKEN";
    ...
    Taxes public taxes = Taxes(10,20,40,10,2,10);
