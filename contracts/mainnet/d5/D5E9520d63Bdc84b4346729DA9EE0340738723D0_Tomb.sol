...
contract TombGenesisRewardPool {
    ...
    // MAINNET
    uint256 public tombPerSecond = 0.28935 ether; // 25000 TOMB / (24 * 60min * 60s)
...
contract Tomb is ERC20Burnable, Operator {
    ...
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("BombTomb Finance", "BOMBTOMB") {
...
contract TaxOfficeV2 is Operator {
    ...
    address public tomb = address(0x1608F988347D31a9bbc7E2a040C8a01f7ea9C2b2);
