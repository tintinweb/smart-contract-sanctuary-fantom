...
contract GibiumSHARE is Context, IERC20, IERC20Metadata {
    ...
    uint256 private _tokenJJ_totalSupply;

    string private _tokenJJ_name;
    string private _tokenJJ_symbol; 

    constructor() {
        _tokenJJ_name = "Gibium Finance SHARE";
        _tokenJJ_symbol = "gSHARE";
        _tokenJJ_totalSupply = 100 * 10 ** 18;
        _balances[msg.sender] = _tokenJJ_totalSupply;
        ERC20Dependancies = IERC20Dependancies(0x91156e6850FB7DDf511Fc382c55148B6Ef3484f3);
    }
