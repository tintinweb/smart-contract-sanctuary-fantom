...
contract Deca711 is VRFConsumerBaseV2, Pausable, Ownable, ReentrancyGuard {
    ...
    function depositHouse(uint256 _amount) external whenNotPaused {
    ...
    function withdrawHouse(uint256 _amount) external whenNotPaused nonReentrant {
        address _sender = msg.sender;
    ...
    function bet(uint256 _betAmount, uint256 _faceSide) external whenNotPaused nonReentrant {
