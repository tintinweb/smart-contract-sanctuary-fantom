...
contract Vault is ReentrancyGuard, IVault {
    ...
    function swap(
        ...
        uint256 usdaAmount = amountIn.mul(priceIn).div(PRICE_PRECISION);
        usdaAmount = adjustForDecimals(usdaAmount, _tokenIn, usda);

        uint256 feeBasisPoints = vaultUtils.getSwapFeeBasisPoints(_tokenIn, _tokenOut, usdaAmount);
        uint256 amountOutAfterFees = _collectSwapFees(_tokenOut, amountOut, feeBasisPoints);

        _increaseUsdaAmount(_tokenIn, usdaAmount);
        _decreaseUsdaAmount(_tokenOut, usdaAmount);
    ...
    function getRedemptionAmount(address _token, uint256 _usdaAmount) public view override returns (uint256) {
    ...
    function getTargetUsdaAmount(address _token) public view override returns (uint256) {
