...
// --------------------------------------------------------------------------------------
//
// (c) Treasury 05/03/2022 | SPDX-License-Identifier: AGPL-3.0-only
...
contract Treasury is Ownable {
    ...
    modifier onlyAuth() {
        if (!authorised[msg.sender]) revert UnauthorisedCaller();
        _;
    }
