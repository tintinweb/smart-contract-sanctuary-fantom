...
contract OrderBook is ReentrancyGuard, IOrderBook {
    ...
    event Initialize(address router, address vault, address weth, address usda, uint256 minExecutionFee, uint256 minPurchaseTokenAmountUsd);
    ...
    function validateSwapOrderPriceWithTriggerAboveThreshold(address[] memory _path, uint256 _triggerRatio) public view returns (bool) {
        ...
        // That's why USDA price in USD can vary depending on the redepmtion token
