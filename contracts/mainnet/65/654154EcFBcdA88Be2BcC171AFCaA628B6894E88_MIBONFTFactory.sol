...
import "./MIBONFTTradable.sol";

contract MIBONFTFactory is Ownable {
    /// @dev Events of the contract
    event ContractCreated(address creator, address nft);
    event ContractDisabled(address caller, address nft);

    /// @notice MIBO auction contract address;
    address public mibonation;

    /// @notice MIBO auction contract address;
    address public auction;

    /// @notice MIBO marketplace contract address;
    address public marketplace;

    /// @notice MIBO bundle marketplace contract address;
    ...
    */
    ...
    /// @notice Method for deploy new MIBONFTTradable contract
        ...
        returns (address)
    {
        ...
        MIBONFTTradable nft = new MIBONFTTradable(
            _name,
            _symbol,
            // auction,
            marketplace,
    ...
    /// @notice Method for registering existing MIBONFTTradable contract
    ...
    /// @notice Method for disabling existing MIBONFTTradable contract
    /// @param  tokenContractAddress Address of NFT contract
...
/**
 * @title MIBONFTTradable
 * MIBONFTTradable - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract MIBONFTTradable is ERC721, Ownable {
    /// @dev Events of the contract
    event Minted(
        uint256 tokenId,
        address beneficiary,
    ...
    */
    ...
    /**
     * Override isApprovedForAll to whitelist MIBO contracts to enable gas-less listings.
     */
    function isApprovedForAll(address owner, address operator)
        ...
        returns (bool)
    {
        // Whitelist MIBO auction, marketplace, bundle marketplace contracts for easy trading.
        if (
            // auction == operator ||
    ...
    /**
     * Override _isApprovedOrOwner to whitelist MIBO contracts to enable gas-less listings.
     */
