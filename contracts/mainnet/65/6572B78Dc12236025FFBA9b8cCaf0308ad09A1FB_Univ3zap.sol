...
contract Univ3zap is Ownable {
  ...
  event Removal2(uint128 liquidity);
  ...
  function withdraw(address poolAddr, uint256 liquidity) public {
    ...
    emit Removal2(uint128(liquidity));
  }

  function withdraw2(address poolAddr, uint128 liquidity) public {
    // if (liquidity > 0) {
      ...
      emit Removal(amount0, amount1);
    // }
  }

  function withdraw3(address poolAddr, uint256 amount0, uint256 amount1, bool isToken0, bool isCoin) public {
