...
import "../../interfaces/spirit/ISpiritMasterChef.sol";

contract StrategySpirit is StratManager, FeeManager {
    ...
    function deposit() public whenNotPaused {
        ...
        if (pairBal > 0) {
            ISpiritMasterChef(masterChef).deposit(poolId, pairBal);
    ...
    function withdraw(uint256 _amount) external {
        ...
        if (pairBal < _amount) {
            ISpiritMasterChef(masterChef).withdraw(poolId, _amount);
    ...
    function _harvest(address callFeeRecipient) internal whenNotPaused {
        ISpiritMasterChef(masterChef).deposit(poolId, 0);
    ...
    function balanceOfPool() public view returns (uint256) {
        (uint256 _amount, ) = ISpiritMasterChef(masterChef).userInfo(
            poolId,
            address(this)
        );
        return _amount;
    ...
    function rewardsAvailable() public view returns (uint256) {
        return
            ISpiritMasterChef(masterChef).pendingSpirit(poolId, address(this));
    }
    ...
    function retireStrat() external {
        ...
        ISpiritMasterChef(masterChef).emergencyWithdraw(poolId);
    ...
    function panic() public onlyOwner {
        pause();
        ISpiritMasterChef(masterChef).withdraw(poolId, balanceOfPool());
    }
