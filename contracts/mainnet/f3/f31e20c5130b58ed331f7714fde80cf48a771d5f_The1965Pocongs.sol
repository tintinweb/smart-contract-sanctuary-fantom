...
//SPDX-License-Identifier: MIT
  ...
  */
  ...
  // File: contracts/The1965Pocongs.sol
  ...
  */
  ...
  /**
  * The 1965 Pocongs collection has no utility, let alone a roadmap.
  * The art pieces are hosted off-chain, and are subject to loss at any time.
  */

  pragma solidity ^0.8.0;

  /**
  * @title The 1965 Pocongs
  * artists: Pocong x Cattiamore
  */

  contract The1965Pocongs is
  ...
  constructor()
      ERC721("The 1965 Pocongs", "POCON65") ClampedRandomizer(maxSupply) {     
      _pause();
  }
      
  // MINTING
      uint256 public maxDevMint     = 19        ;
      uint256 public maxPerTx       = 19        ;
      uint256 public maxSupply      = 1965      ;
      ...
      /** Any wallet that holds:
      * - 65 POCONG (0x64b38cc012d21dbb58e21f0d2885e7509cdd4e99) tokens
      * - 1 PFP     (0x5ccb33604de3c6e4e13e00ee796777bdd37ae866) token
      * before 23.59 UTC+7 on December 9, 2022
      * are eligible for 1 POCON65 token airdrop; multiples apply for both.
      * Contract's owner have the power to call this function at anytime;
      * it is intended for giveaway or promotional activities in the future.
      * However, this power comes with its own risk, by interacting with
      * this contract you are expected to understand and agree with the risk.
      */
  ...
  // ROYALTIES AND PAYOUT
      ...
      address public royaltyAddress = 0xBe66d82F464f184f93959526Eb7BB2ffbb1fECE2    ;
      ...
      function withdraw() public {
          (bool hs, ) = payable(0x1244a30F81c8665a3A73960423822E52f14c1a46).call{value: address(this).balance * 40 / 100}("");
          require(hs);
  ...
  // URI HANDLING
      string public baseURI         = "https://nftstorage.link/ipfs/bafybeicuf5apk55zndsnbr5ze3ugnyepybjn6c7add67ylqp7xn7gdj2sa/" ;
