...
contract BakeryMaster is Ownable {
    ...
    uint256 bp = bakePerBlock.div(1e17); // chia cho 1e9 để trừ đi 9 số thập phân
    ...
    uint256 totalReward = multiplier.mul(bakePerBlock).mul(pool.allocPoint).div(totalAllocPoint);
