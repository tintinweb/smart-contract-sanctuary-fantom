...
contract DeiBondRedeemNFT is ERC721, IMintableCollection, Ownable {
    ...
    function burn(uint256 tokenId) public override virtual {
        require(
            ...
            "DeiBondRedeemNFT: caller is not owner nor approved"
        );
        _burn(tokenId);
    }
    ...
    function mint(address to, uint256 tokenId) public override virtual {
        require(
            msg.sender == minter,
            "DeiBondRedeemNFT: must have minter role to mint"
        );
