...
contract MetaTreasury is Ownable {
    ...
    constructor (
        ...
        // isLiquidityToken[ _METAMIM ] = true;
        //liquidityTokens.push( _METAMIM );
    ...
    function withdraw( uint _amount, address _token ) external {
        ...
        uint value = valueOf( _token, _amount );
        IOHMERC20( Meta ).burnFrom( msg.sender, value );
    ...
    function incurDebt( uint _amount, address _token ) external {
        ...
        uint maximumDebt = IERC20( sMeta ).balanceOf( msg.sender ); // Can only borrow against sOHM held
    ...
    function repayDebtWithOHM( uint _amount ) external {
        ...
        IOHMERC20( Meta ).burnFrom( msg.sender, _amount );
