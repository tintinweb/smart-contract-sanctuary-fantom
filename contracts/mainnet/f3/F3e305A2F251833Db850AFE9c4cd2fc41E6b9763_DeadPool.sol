...
contract DeadPool is Ownable, ReentrancyGuard {
    ...
    function getRewardPerSecond () public view returns (uint256) {
        return RewardToken.balanceOf(address(this)) / 365 / 24 / 60 / 60;
    }

    function setRewardPerSecond () public {
        rewardPerSecond =  RewardToken.balanceOf(address(this)) / 365 / 24 / 60 / 60;
    }
