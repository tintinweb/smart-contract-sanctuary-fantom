...
contract Zapper is Ownable, ReentrancyGuard, Pausable {
    ...
    function withdrawAllInNative(address _toToken) external {
        withdrawInNative(_toToken, IERC20(vault).balanceOf(msg.sender));
    }

    function withdrawInNative(address _toToken, uint256 _shares) public nonReentrant {
