...
contract ZapHelper {
    ...
    function zapETH(address _LP, uint256 _inputAmount) public payable returns (uint256 liquidity) {
        ...
        IERC20(WETH).transferFrom(msg.sender, address(this), _inputAmount);
        approveRouter(WETH, _inputAmount);
        if (token0 == WETH || token1 == WETH) {
            ...
            optiSwapExactTokensForTokens(WETH, tokenA, _inputAmount);
        }
