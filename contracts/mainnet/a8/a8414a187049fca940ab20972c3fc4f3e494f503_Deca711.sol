...
contract Deca711 is VRFConsumerBaseV2, Ownable, ReentrancyGuard {
    ...
    mapping(address => uint256) totalBetAmountByUser;
    ...
    /* ========== VIEW FUNCTIONS ========== */
    function getTotalBetAmountByUser(address _address) public view returns (uint256){
        return totalBetAmountByUser[_address];
    }
    ...
    function getTotalBetCount() public view returns (uint256){
        return betRequestSize;
    }
    ...
    function bet(uint256 _betAmount, uint256 _faceSide) external nonReentrant {
    ...
    function fulfillRandomWords(
        ...
        totalBetAmountByUser[player] += playerBetAmount;
