...
THE FIRST DUAL TOKEN WITH OWNER TREASURY.
...
Website : https://ftm.banksydao.finance/
Telegram: https://t.me/BanksyDAO
...
contract BanskyDAO is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2500 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'BanskyDAO';
    string private constant _symbol = 'BANSKY';

    uint256 private _taxFee = 200;
    uint256 private _burnFee = 0;
    uint public max_tx_size = 2500 ether;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x07536EB94aD97878fde531AE0AEE3b708C881753, 'We can not exclude router.');
