 ...
 */
contract TombMaiAutoCompoundTomb is IStrategy, Ownable, Pausable {
    ...
    address public mai = address(0xfB98B335551a418cD0737375a2ea0ded62Ea213b);
     ...
     * {liquidityProvider} - the liquidity for tomb
    ...
    constructor(
        ...
        rewardTokenToLp1Route = [rewardToken, wftm, usdc, lpToken1];
    ...
    function _addLiquidity() internal {
        ...
        IUniswapRouterETH(liquidityProvider).addLiquidity(
            lpToken0,
            lpToken1,
            lp0Bal,
            lp1Bal,
    ...
    function _giveAllowances() internal {
        ...
        IERC20(lpToken1).safeApprove(liquidityProvider, 0);
        IERC20(lpToken1).safeApprove(liquidityProvider, max);
    }
    ...
    function anualReward() external view returns (uint256) {
        return
            IMasterChef(masterChef).tSharePerSecond().mul(3600).mul(24).mul(
                365
            );
    }
}
