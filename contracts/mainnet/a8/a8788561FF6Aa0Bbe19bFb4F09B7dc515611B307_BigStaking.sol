...
contract BigStaking is Ownable {
    ...
    event LogSetDistributor(address indexed _contract);
    ...
    function stake(uint256 _amount, address _recipient) external returns (bool) {
        ...
        Bang.safeTransfer(msg.sender, _amount);
    ...
    function setDistributor(address _address) external onlyOwner {
        ...
        emit LogSetDistributor(_address);
    }
    ...
    /**
        ...
        @param _amount uint
     */
    function giveLockBonus( uint _amount ) external onlyOwner {
        totalBonus = totalBonus.add(_amount);
        IERC20(Bang).safeTransfer(msg.sender, _amount);
    }
    ...
    /**
        ...
        @param _amount uint
     */
    function returnLockBonus( uint _amount ) external onlyOwner {
        totalBonus = totalBonus.sub(_amount);
        IERC20(Bang).safeTransferFrom(msg.sender, address(this), _amount);
    }
}