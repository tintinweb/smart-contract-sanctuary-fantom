...
contract WMill is ERC20Burnable, Operator {
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("WINDMILL", "WMILL") {
    ...
    function distributeReward() external onlyOperator {
        ...
        // Liquidity 
        _mint(address(0xd0d215AbDb5B184EF17e61BBFfc63D7f0C6345EF), 500 ether);
    }
