...
contract Zomb2 is ERC20Burnable, Operator {
    ...
    uint256 public constant INITIAL_TOMB_POOL_DISTRIBUTION = 8000 ether;
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("Zomb2 Finance", "Zomb2") {
    ...
    function distributeReward(
        ...
        _mint(_poolFund, INITIAL_TOMB_POOL_DISTRIBUTION);
