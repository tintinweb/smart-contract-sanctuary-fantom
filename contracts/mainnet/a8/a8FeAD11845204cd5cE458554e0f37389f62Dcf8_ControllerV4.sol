...
contract ControllerV4 {
    ...
    constructor() public {
        ...
        timelock = msg.sender; // address of a contract that should be set
        devfund = msg.sender; // address of a deployed contract that should be set 
        treasury = msg.sender; // address of a contract that should be set
    }
