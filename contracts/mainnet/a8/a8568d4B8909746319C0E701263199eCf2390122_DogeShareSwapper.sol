...
contract DogeShareSwapper is Operator {
    ...
    constructor() public {
        tomb = IERC20(0x6051D7a15232B4E7C3B099Ec34E2119524cD3c9f);
        tbond = IERC20(0x906c2dfE2c853867E7CBe5689Ca279a6bE5580B0);
        tshare = IERC20(0xbe1e1Ab395F1D47897c894b61987E56326D2ed40);
        wftmAddress = address(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83);
        tombSpookyLpPair = address(0x6975aEb60bDd8EE21e30A9d6BED41EBf368d27fd);
        tshareSpookyLpPair = address(0xBB8Fc05b8D1708951b5E6D6955935d21Fd86f70D);
