...
contract Router02 is IRouter02, ITombCallee {
    ...
    modifier ensure(uint256 deadline) {
        require(deadline >= block.timestamp, "MortuaryRouter: EXPIRED");
        _;
    }
    ...
    function deleverage(
        ...
        require(redeemTokens > 0, "MortuaryRouter: REDEEM_ZERO");
    ...
    function _removeLiqAndRepay(
        ...
        .burn(address(this));
        require(amountAMax >= amountAMin, "MortuaryRouter: INSUFFICIENT_A_AMOUNT");
        require(amountBMax >= amountBMin, "MortuaryRouter: INSUFFICIENT_B_AMOUNT");
        // repay and refund
    ...
    function tombBorrow(
        ...
        require(sender == address(this), "MortuaryRouter: SENDER_NOT_ROUTER");
        require(
            msg.sender == declaredCaller,
            "MortuaryRouter: UNAUTHORIZED_CALLER"
        );
    ...
    function _optimalLiquidity(
        ...
        if (amountBOptimal <= amountBDesired) {
            require(
                ...
                "MortuaryRouter: INSUFFICIENT_B_AMOUNT"
            );
            ...
            require(
                ...
                "MortuaryRouter: INSUFFICIENT_A_AMOUNT"
            );
    ...
    function _quote(
        ...
        require(amountA > 0, "MortuaryRouter: INSUFFICIENT_AMOUNT");
        require(
            reserveA > 0 && reserveB > 0,
            "MortuaryRouter: INSUFFICIENT_LIQUIDITY"
        );
    ...
    function getBorrowable(address underlying, uint8 index)
        ...
        returns (address borrowable)
    {
        require(index < 2, "MortuaryRouter: INDEX_TOO_HIGH");
        borrowable = address(
            uint256(
                keccak256(
                    abi.encodePacked(
                        ...
                        hex"458d7c2ace3152245fcb50e0cc7631c82963f6a6c1a9ec9f54af60b529180b4b" // Borrowable bytecode keccak256
                    )
                )
            )
        );
            ...
            uint256(
                keccak256(
                    abi.encodePacked(
                        ...
                        hex"bf425f5720009a6982368e32a408228f25918df9cb5d8a337e839339cf4ce06d" // Collateral bytecode keccak256
                    )
                )
            )
        );
