...
contract FishFarmTrade {
    ...
    function fundDeposit() external payable onlyFundManager {
    ...
    uint256 interest= earnings + currentEarnings;
        ...
        uint256 compoundDeposit = interest / 2;
        hireFishermanInternal(compoundDeposit);

        emit FishSold(msg.sender, interest);
        emit FishermanHired(msg.sender, compoundDeposit);
    }
