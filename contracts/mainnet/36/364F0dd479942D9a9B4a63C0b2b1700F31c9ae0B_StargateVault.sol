 ...
 */
interface IERC20Metadata is ZeppelinIERC20 {
    /**
 ...
 */
contract ERC20 is Context, ZeppelinIERC20, IERC20Metadata {
 ...
 */
interface IERC4626 is ZeppelinIERC20, IERC20Metadata {
...
contract StargateVault is ERC4626, Ownable, Pausable {
    ...
    constructor(
        ...
        address admin
    ) ERC20(_vaultName(asset_), _vaultSymbol(asset_)) ERC4626(IERC20(address(asset_))) Ownable() Pausable() {
        want = asset_;
        stargatePool = pool_;
