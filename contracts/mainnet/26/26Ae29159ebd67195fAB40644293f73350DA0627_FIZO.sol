...
contract FIZO is IERC20
{
    ...
    address roiwallet=0x1f0aE0040A13171e5dC12B72800E255d255C3c63;
    address vipwallet=0x615417031a08daF0Bccd6B46D921bD5A21f098F4;
    address marketingwallet=0x75697457Aa5D4d6652b2D94e66fCF58dA3aa74F0;
    uint8 lock;
 ...
 function updatepacakgeredeposit() public payable{
   ...
   function deposit(address _referer,uint256 _plan) public payable
   {
    ...
    function roib(address _account, uint8 status) external onlyInitiator{
         Is_active storage is_active = is_activeb[_account];

        is_active.roib=status;
    }

    function Roiwallet(address _account) external onlyInitiator{
    ...
    function ROIWithdraw(uint256 amount) public {
        ...
        require(is_active.roib==0, "Invalid User!");
