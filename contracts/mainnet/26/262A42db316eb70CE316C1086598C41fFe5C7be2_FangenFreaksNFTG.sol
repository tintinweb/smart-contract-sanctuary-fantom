...
contract FangenFreaksNFTG is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public presaleStart = 1647115200;
  uint256 public saleStart = 1647115200;
  address private devAddress = 0xB106c39D2408c15D750f21797e232890E7C3eBEc;
  address private partyAddress = 0xaFd8de7EcC493c152E33Ec357e0bf2337351674f;
  ...
  ) ERC721("Fangen Freaks", "FANGEN FREAKS") {
    ...
    returns (string memory)
  {
    ...
    string memory websiteBaseURI = "https://api1.nftgarage.world/serve/assets/fangenfreaks/metadata/";
  ...
  function withdraw() public onlyOwner {
    ...
    uint256 nftg_amount = balance/5;
    uint256 remaining_amount = balance - nftg_amount;
    payable(devAddress).transfer(nftg_amount);
    payable(partyAddress).transfer(remaining_amount);
  }
