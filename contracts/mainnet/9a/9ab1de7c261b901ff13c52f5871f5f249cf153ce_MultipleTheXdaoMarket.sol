...
contract MultipleTheXdaoNFT is ERC1155, AccessControl {
	 ...
	 */
    function addMultiItem( uint256 supply, uint256 royalty, string memory _uri ) public returns (uint256) {
...
contract MultipleTheXdaoMarket is Ownable, ERC1155Holder {
    ...
    function multipleList(address _collection, uint256 _tokenId, uint256 _amount, uint256 _price) public {
