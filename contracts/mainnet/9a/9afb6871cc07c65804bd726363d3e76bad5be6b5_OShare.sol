...
contract OShare is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _devFund, address _communityFund) public ERC20("OSHARE Token", "O-SHARE") {
        _mint(msg.sender, 1 ether); // mint 1 OShare for initial pools deployment
