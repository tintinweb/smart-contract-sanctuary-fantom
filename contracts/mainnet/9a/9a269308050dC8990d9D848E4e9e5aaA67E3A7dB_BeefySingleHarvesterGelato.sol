...
abstract contract BeefySingleHarvesterBase is ManageableUpgradeable, PausableUpgradeable {
    ...
    address public constant RECEIVER = 0xc7206e8E036BfE8DD052E4b2b62cB8339D73655B; // address that registers the resolver.
        ...
        )
    {
        ...
        (bool shouldHarvestVault, uint256 estimatedTxCost, bool isDailyHarvest) = _shouldHarvestVault(gasPrice_, vault_, callReward, gasOverhead);
