...
contract Zapper is Ownable, IZapperV2 {
    ...
    function zapInTokens(address _token0, address _token1,uint256 _token0Amount,
    ...
    function zapOutToTokenEth(address _in, uint256 _amount,
    ...
    function zapOutToTokens(address _in, uint256 _amount,
        address _routerAddr, address _recipient) external whitelist(_routerAddr)  {
