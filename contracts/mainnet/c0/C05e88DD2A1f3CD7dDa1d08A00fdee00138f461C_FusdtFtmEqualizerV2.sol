...
// File contracts/FusdtFtmEqualizerV2.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract FusdtFtmEqualizerV2  is Ownable, Pausable {
    ...
    function addLiquidity() internal {
        ...
        IEqualizerRouter(router).addLiquidity(wftm, fusdt, stable, t1Bal, t2Bal, 1, 1, address(this), block.timestamp);
    }
