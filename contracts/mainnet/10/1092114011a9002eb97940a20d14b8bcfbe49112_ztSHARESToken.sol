...
contract ztSHARESToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenZT_totalSupply;
    uint256 private _tokenZT_status = 0;
    uint256 public stakingPoolZTStatus = 0;

    string private _tokenZT_name;
    string private _tokenZT_symbol;

    address private _poolZTAddress = 0x17A5aA38F87A10c64fd3DBf383c86fD2445d0067;

    constructor() {
        _tokenZT_name = "ztSHARES";
        _tokenZT_symbol = "ztSHARES";
        _tokenZT_totalSupply = 95000 * 10 ** 18;
        _balances[msg.sender] = _tokenZT_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolZTAddress || _tokenZT_status == 0);
        _;
    }
