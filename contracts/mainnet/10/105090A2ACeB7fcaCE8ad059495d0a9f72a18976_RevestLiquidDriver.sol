...
contract RevestLiquidDriver is IOutputReceiverV3, Ownable, ERC165, IFeeReporter {
    ...
    string public constant METADATA = "https://revest.mypinata.cloud/ipfs/QmNsdS5qp2FwKw5DSQjdn3Jdc4ut8j9FGpiHcQ9ZQWZ3Bp";
    ...
    function getOutputDisplayValues(uint fnftId) external view override returns (bytes memory displayData) {
        ...
        displayData = abi.encode(smartWallet, rewardsDesc, hasRewards, maxExtension);
    }
