...
contract BoardroomFTM is ContractGuard {
    ...
    function getC7ftmPrice() external view returns (uint256) {
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            C7ftm.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        C7ftm.safeTransferFrom(msg.sender, address(this), amount);
