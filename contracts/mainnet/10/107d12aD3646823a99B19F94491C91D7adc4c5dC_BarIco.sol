...
contract BarIco is Ownable {
    ...
    uint256 private _startDate = 1680728400; // When to start ICO 
    uint256 private _endDate = 1681246800; // When to end ICO 
    uint256 private _claimDate = 1681247400; // When to claim ICO 
