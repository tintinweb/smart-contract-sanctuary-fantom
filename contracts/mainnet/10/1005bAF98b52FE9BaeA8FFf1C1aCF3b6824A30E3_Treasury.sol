...
uint256 public _sendToMasonry_amount = 0;
uint256 public _sendToMasonry_amount_2 = 0;
    function _sendToMasonry(uint256 _amount) internal {
        _sendToMasonry_amount = _amount;
        IBasisAsset(mry).mint(address(this), _amount);
        _sendToMasonry_amount_2 = _amount;
        ...
        IERC20(mry).approve(masonry, _amount);
...
function _setTreasuryToMasonry(address _treasury_) external {
    IMasonry(masonry).setTreasury(_treasury_);
}
