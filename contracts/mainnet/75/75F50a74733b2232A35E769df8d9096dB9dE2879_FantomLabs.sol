...
contract FantomLabs is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Fantom Labs';
    string private constant _symbol = 'LABS';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x26F6544d16255057944C97F425Db0119daEE1E1d, 'We can not exclude router.');
