    ...
    Pausable
{
    ...
    uint256 public totalTokenBoostedSupply = 15882951702401071;
    ...
    uint256 public lockedStakeMinTime = 5 minutes; // 1 week
    ...
    function setTotalTokenBoostedSupply(uint256 _totalTokenBoostedSupply)
        external
        onlyOwner
    {
        totalTokenBoostedSupply = _totalTokenBoostedSupply;
    }
