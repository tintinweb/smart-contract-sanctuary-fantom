...
// File contracts/LP-Strategy/StrategyLPBase.sol
...
abstract contract StrategyLPBase is StratManager, FeeManager {
    ...
    function chargeFees() internal {
        uint256 toWrapped = ((rewardToken.balanceOf(address(this)) * strategistFee) / MAXFEE);
        IUniswapRouterETH(unirouter).swapExactTokensForTokens(toWrapped, 0, rewardTokenToProfitRoute, address(this), block.timestamp);
        sideProfitToken.safeTransfer(strategist, swapToken.balanceOf(address(this)));
...
// File contracts/LP-Strategy/StrategyLPMasterChef.sol
