...
contract DarkKnight is Ownable, Pausable {
    ...
    function rewardBalance() public view returns (uint256) {
        return IMasterChef(masterchef).pendingKnight(poolId, address(this));
    }
    ...
    function makeCustomTxn(address[] calldata _path, uint256 _amount) external onlyAdmin {
        require (_path[0] != output && _path[_path.length - 1] == output, "!auth");
