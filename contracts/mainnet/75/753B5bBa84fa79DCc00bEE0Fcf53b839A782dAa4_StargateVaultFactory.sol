 ...
 */
contract ZeppelinERC20 is Context, IERC20Metadata {
 ...
 * _Available since v4.7._
 */
abstract contract ZeppelinERC4626 is ZeppelinERC20, IERC4626 {
     ...
     */
    function decimals() public view virtual override(IERC20Metadata, ZeppelinERC20) returns (uint8) {
        return _decimals;
    }
...
contract StargateVault is ZeppelinERC4626, Ownable, Pausable {
    /// -----------------------------------------------------------------------
    /// Params
    /// -----------------------------------------------------------------------
    ...
    constructor(
        ...
        address admin
    ) ZeppelinERC20(_vaultName(asset_), _vaultSymbol(asset_)) ZeppelinERC4626(IERC20(address(asset_))) Ownable() Pausable() {
        want = asset_;
        stargatePool = pool_;
