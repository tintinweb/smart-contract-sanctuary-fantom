...
import "../../interfaces/fbomb/IBombMasterChef.sol";

contract StrategyBomb is StratManager, FeeManager {
    ...
    function deposit() public whenNotPaused {
        ...
        if (pairBal > 0) {
            IBombMasterChef(masterChef).deposit(poolId, pairBal);
    ...
    function withdraw(uint256 _amount) external {
        ...
        if (pairBal < _amount) {
            IBombMasterChef(masterChef).withdraw(poolId, _amount);
    ...
    function _harvest(address callFeeRecipient) internal whenNotPaused {
        IBombMasterChef(masterChef).deposit(poolId, 0);
    ...
    function balanceOfPool() public view returns (uint256) {
        (uint256 _amount, ) = IBombMasterChef(masterChef).userInfo(
            poolId,
            address(this)
        );
        return _amount;
    ...
    function rewardsAvailable() public view returns (uint256) {
        return IBombMasterChef(masterChef).pendingSHRAP(poolId, address(this));
    }
    ...
    function retireStrat() external {
        ...
        IBombMasterChef(masterChef).emergencyWithdraw(poolId);
    ...
    function panic() public onlyOwner {
        pause();
        IBombMasterChef(masterChef).withdraw(poolId, balanceOfPool());
    }
...
interface IBombMasterChef {
    ...
    function pendingSHRAP(uint256 _pid, address _user)
        external
        view
        returns (uint256);
    ...
    function shrapnelPerSecond() external view returns (uint256);
}
