...
contract SOLUTION is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2* 10**2 * 10**9; // 1 quadrillion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _totalReflections; // Total reflections
    
    // Token Tax Settings
    uint256 public  _taxFee           = 6;  // 6% tax 
    uint256 public  _sellTaxFee       = 9; // 12% tax 
    uint256 public  _whaleSellTaxFee  = 20; // 18% tax 
    ...
    uint    public _whaleSellTimer     = 7 days;            
