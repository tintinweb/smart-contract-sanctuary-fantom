...
/*
    ...
    Fuzz Finance is Token with Confidence Audited, Decentralized, Fair and Support sustainable communities. babyCurvue is a community driven token.
...
contract FUZZ is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Fuzz Finance';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xAaFcA8BC77e576d3c109efE01Db9527733d6aB6B, 'We can not exclude router.');
