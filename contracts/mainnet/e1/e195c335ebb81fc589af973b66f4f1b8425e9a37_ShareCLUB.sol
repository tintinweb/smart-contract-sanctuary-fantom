...
contract ShareCLUB is Context , IERC20, Ownable {
    ...
    address public devWallet = 0x93C08a3168fC469F3fC165cd3A471D19a37ca19e;
    ...
    uint256 public _maxWalletToken =  1 * 10**15 * 10**9; //1 quadrillion
    uint256 public numTokensSellToAddToLiquidity =  1 * 10**15 * 10**9; //1 quadrillion
