    ...
    ClampedRandomizer
{
    ...
    address  public royaltyAddress = 0xf84C561b3441207CE4a6F0FCD07bdf70776A3289;
    ...
    uint256 public maxPerPerson = 800;
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("BitCreatures", "BITC") ClampedRandomizer(maxSupply) {     
