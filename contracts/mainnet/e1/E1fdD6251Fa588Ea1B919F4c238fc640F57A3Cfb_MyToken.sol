 ...
 *     ╚══╝╚══╝ ╚═╝╚══════╝╚═════╝ ╚══════╝                                        
 * @title QueenZen.sol
 * @dev 1/1 NFT minter, with ERC2981 support
 * @author MaxFlowO2 (GitHub/Twitter)
 */
...
contract MyToken is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, ERC2981Collection, MaxAccess {
  ...
  constructor() ERC721("QueenZen 1/1 NFT's", "QZ") {}
  ...
  function adminBurn(uint _tokenID) public virtual onlyAdmin() {
  ...
  function setRoyaltiesEOA(address eoa, uint permille) external onlyOwner() {
  ...
  function getBalanceToken(address _token) external view returns (uint) {
