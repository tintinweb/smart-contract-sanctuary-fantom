...
contract DogeCronje is Context, IERC20, Ownable {
    ...
    string private constant _name = 'DogeCronje';
    string private constant _symbol = 'DONJE';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xf481a7444c6116a1635c1aBD6E80e2c3480a10f4, 'We can not exclude router.');
