...
/* 
  _______  _____________________  ___  __  ___  ___  __  _      ____ 
 / ___/ / / /_  __/_  __/ __/ _ \/ _ \/ / / / |/ / |/_/ | | /| / / / 
/ (_ / /_/ / / /   / / / _// , _/ ___/ /_/ /    />  <   | |/ |/ / /__
\___/\____/ /_/   /_/ /___/_/|_/_/   \____/_/|_/_/|_|   |__/|__/____/
           WHITELIST TICKETS FOR SPEARHEADS GUTTERPUNX
*/
...
contract GUTTERPUNXWhitelist is AccessControlEnumerable, ERC721Enumerable, ERC721URIStorage {
  ...
  function setDevWallet(address devWallet) external onlyAdmin {
    _devWallet = devWallet;
  }
  ...
  function setMaxSupply(uint maxSupply) external onlyAdmin {
    max_supply = maxSupply;
  }
