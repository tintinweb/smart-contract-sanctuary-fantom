...
contract EasyDCA is Ownable {
    ...
    /* DEBUG START */
    function viewLastPurchase() public view returns (uint256) {
        return dcaList[dcaHeap[1]].lastPurchase;
    }

    function viewFrequency() public view returns (uint256) {
        return dcaList[dcaHeap[1]].frequency;
    }
    ...
    function viewUpkeep() public view returns (bool) {
        return (dcaList[dcaHeap[1]].lastPurchase + dcaList[dcaHeap[1]].frequency) > block.timestamp;
    }
    /* DEBUG END */
