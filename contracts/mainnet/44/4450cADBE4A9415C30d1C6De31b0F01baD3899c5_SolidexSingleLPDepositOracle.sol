...
// File contracts/Misc_AMOs/solidly/IDepositToken.sol
...
// File contracts/Oracle/SolidexSingleLPDepositOracle.sol
...
// |                                                                  |
// ====================================================================
// =================== SolidexSingleLPDepositOracle ===================
// ====================================================================
// Used to price a single Solidex LP Deposit Token
...
contract SolidexSingleLPDepositOracle is Owned {
    using SafeMath for uint256;
    ...
    constructor (
        ...
        the_pair = IBaseV1Pair(_lp_token_address);
    ...
    function uniV2LPBasicInfo() public view returns (UniV2LPBasicInfo memory) {
        // Get the reserves
        (uint256 _reserve0, uint256 _reserve1, ) = (the_pair.getReserves());
