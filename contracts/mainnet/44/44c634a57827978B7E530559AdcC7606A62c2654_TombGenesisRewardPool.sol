...
// 1) runningTime 1 day -> 3 day and the corresponding amount of rewards
// 2) fixed 0.5% deposit fee on all deposits 
// tldr: No rug here.
...
contract TombGenesisRewardPool {
    ...
    // TESTNET
    uint256 public tombPerSecond =  0.127314 ether; // 33000 TOMB / (24h * 60min * 60s)
