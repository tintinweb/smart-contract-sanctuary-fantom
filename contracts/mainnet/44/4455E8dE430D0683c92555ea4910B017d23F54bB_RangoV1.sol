...
contract RangoV1 is BaseContract, RangoCBridgeProxy, RangoAnyswap {
    ...
    // [DONE] TODO: separate cbridge contract into another one
    // [DONE] TODO: update formula -> uint totalInputAmount = request.feeIn + request.affiliateIn + request.amountIn;
    // [DONE] TODO: make destination swap optional
    ...
    // TODO: learn storage structure for inherited classes
    // TODO: must support 1-step simple swap with toToken = ETH in onChainSwaps
