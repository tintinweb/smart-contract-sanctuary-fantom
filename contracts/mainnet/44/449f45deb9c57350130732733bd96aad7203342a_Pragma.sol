...
contract Pragma is ERC20Detailed, Ownable, DiscounterRole {
    ...
    uint256 public constant riskFreeValue = 5;
    ...
    address public constant autoLiquidityAddress =
        0x13564CE8a42F2D43eE93fBeDc4f4c5398A1E7390;
    address public constant treasuryAddress =
        0x131b78F3961c90C364a7970B98988C219D56d62A;
    address public constant riskFreeValueAddress =
        0x186D5B8C9E6c6265071aAc228B145C32bEc1A0C6;
    ...
    uint256 private rebaseRate = 2229;
    ...
    constructor() ERC20Detailed("Pragma", "PRAGMA", uint8(DECIMALS)) {
