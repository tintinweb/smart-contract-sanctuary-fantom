...
contract PARIS is PARISDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private PARISTeam;
    address private CharityPARIS;
    ...
    string public override name = "PARIS";
    string public override symbol = "PARIS";
    ...
    constructor(uint totalSupplyValue, address PARISTeamAddress, address CharityPARISAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        PARISTeam = PARISTeamAddress;
        CharityPARIS = CharityPARISAddress;
        
        // split the tokens according to agreed upon percentages
        balances[PARISTeam] =  totalSupply * 4 / 100;
        balances[CharityPARIS] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's PARISTeam pot
