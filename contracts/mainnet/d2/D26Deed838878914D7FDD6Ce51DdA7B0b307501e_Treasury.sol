...
contract Treasury is ContractGuard {
    ...
    function _sendToMasonry(uint256 _amount) internal {
        ...
        if (devFundSharedPercent > 0) {
            ...
            IERC20(token).transfer(devFund1, _devFundSharedAmount.div(4));
            IERC20(token).transfer(devFund2, _devFundSharedAmount.div(4));
            IERC20(token).transfer(devFund3, _devFundSharedAmount.div(4));
            IERC20(token).transfer(devFund4, _devFundSharedAmount.div(4));
