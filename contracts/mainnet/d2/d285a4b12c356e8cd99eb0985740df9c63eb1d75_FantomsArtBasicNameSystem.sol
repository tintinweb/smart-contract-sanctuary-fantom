...
contract FantomsArtBasicNameSystem is ERC721Enumerable, ERC165Storage, Ownable {
  ...
  */
  ...
  // TODO: CHECK WHY NAMES THAT ARE TRANSFERRED DO NOT EXIST
  // TODO: CHECK WHY TRANSFERRING A NAME DOES NOT REMOVE YOU FROM NOT BEING ABLE TO REGISTER A NAME
  ...
  function setIPFSAttrLink(string memory _name, string memory _lnk) public {
    require(invertBool(_nameExists[_name]),"FNS: You cant set a link for a non-existing name");
