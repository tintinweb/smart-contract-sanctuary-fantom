...
contract TestShareERC20 is ERC20Burnable, Operator {

    constructor() ERC20("TestShareERC20", "TESTSHAREERC20") {
    }
    ...
    function faucet(uint256 amt) public onlyOperator returns (bool) {
