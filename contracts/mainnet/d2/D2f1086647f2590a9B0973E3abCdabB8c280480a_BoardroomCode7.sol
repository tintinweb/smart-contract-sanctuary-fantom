...
contract BoardroomCode7 is ContractGuard {
    ...
    function getCode77Price() external view returns (uint256) {
    ...
    function withdraw(uint256 amount) public onlyOneBlock masonExists updateReward(msg.sender) {
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            Code77.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        Code77.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function governanceRecoverUnsupported(IERC20 _token, uint256 _amount, address _to) external onlyOperator {
        ...
        require(address(_token) != address(share), "C7share");
