...
contract StrategySolidexVolatileOathWftmLp is StrategySolidexFarmLPBase {
    // Token addresses
    address public oath_wftm_lp = 0x6B987e02Ca5eAE26D8B2bCAc724D4e03b3B0c295;
    address public oath = 0x21Ada0D2aC28C3A5Fa3cD2eE30882dA8812279B6;
    ...
    {
        swapRoutes[oath].push(route(wftm, oath, false));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategySolidexVolatileOathWftmLp";
    }
}
