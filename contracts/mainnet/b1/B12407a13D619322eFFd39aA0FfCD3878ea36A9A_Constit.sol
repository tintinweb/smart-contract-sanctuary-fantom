...
contract Constit is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 100,600 CONSTIT
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund1, address _devFund2, address _devFund3, address _devFund4) public ERC20("CONSTIT", "CONSTIT") {
        _mint(msg.sender, 600 ether); // mint 600 CONSTIT for initial pools deployment
