...
contract FantomHouseDai is VRFConsumerBaseV2, Ownable, ReentrancyGuard {
    ...
    uint256 minHouseDeposit = 1000000000000000000000; // default $1000
    ...
    function returnDepositAndRemoveDepositor(uint256 _length, bool _shouldRemoveDepositor) internal {
        for (uint i = 0; i < _length; i++) {
            ...
            dai.safeTransfer(_depositor, _depositAmount);
