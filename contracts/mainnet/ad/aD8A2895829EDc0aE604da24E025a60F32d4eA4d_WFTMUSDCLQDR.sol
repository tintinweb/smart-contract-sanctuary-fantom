...
// File: WFTMUSDCLQDR.sol

contract WFTMUSDCLQDR is CoreStrategyGeist {
    using SafeERC20 for IERC20;
    ...
    constructor(address _vault)
        ...
        CoreStrategyGeist(
            ...
            CoreStrategyAaveConfig(
                0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83, // want -> WFTM
                0x04068DA6C83AFCFA0e13ba15A6696662335D5B75, // short -> USDC
                0x2b4C76d0dc16BE1C31D4C1DC53bF9B45987Fc75c, // wantShortLP -> USDC/FTM
                0x10b620b2dbAC4Faa7D7FFD71Da486f5D44cd86f9, // farmToken -> LQDR
                0x4Fe6f19031239F105F753D1DF8A0d24857D0cAA2, // farmTokenLp -> LQDR/WFTM
                0x6e2ad6527901c9664f016466b8DA1357a004db0f, // farmMasterChef
                11, // farmPid
                0x39B3bd37208CBaDE74D0fcBDBb12D606295b430a, // aToken
                0x3EeF981640064d63BB7eaD4c6E3C0457E5c2934D, // variableDebtTOken
    ...
    function balancePendingHarvest() public view override returns (uint256) {
        uint256 pending =
            LqdrFarm(farmMasterChef).pendingLqdr(farmPid, address(this)).add(
        ...
        uint256 harvestLp_B = want.balanceOf(address(farmTokenLP));
        uint256 totalWantPending = pending.mul(harvestLp_B).div(harvestLp_A);
        return totalWantPending;
    }
    ...
    function _depositLp() internal override {
        ...
        LqdrFarm(address(farmMasterChef)).deposit(
            farmPid,
            lpBalance,
            address(this)
        );
    ...
    function _withdrawFarm(uint256 _amount) internal override {
        LqdrFarm(address(farmMasterChef)).withdraw(
            farmPid,
            _amount,
            address(this)
        );
