...
contract EarnMore is OwnableUpgradeable {
    ...
    function withdraw2(
        ...
        (
            uint256 excludedValue, // 0
            uint256 newTokenUnderlying, // 0
            uint256 finalAmount, // 1000
            uint256 choRewardAmount // 0
        ...
        )
    {
        ...
        { // Fantom only. No earnMore
            uint256 amount = (portion * info.amountDeposited) / PRECISION;
            newTokenUnderlying =
                info.depositUnderlyingValue - (portion * info.depositUnderlyingValue) /
                PRECISION;
