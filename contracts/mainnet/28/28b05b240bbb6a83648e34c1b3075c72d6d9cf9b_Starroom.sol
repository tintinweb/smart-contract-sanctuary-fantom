...
interface ITreasury {
    ...
    function getCETUSPrice() external view returns (uint256);
...
*/
contract Starroom is ShareWrapper, ContractGuard {
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            CETUS.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        CETUS.safeTransferFrom(msg.sender, address(this), amount);
