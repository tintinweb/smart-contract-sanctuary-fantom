...
contract FantomSHARE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Fantom SHARES", "FSHARES") {
        ...
        marketingWallet = address(0xCe6020F01Dae71382a4198Ba5A421D9F3e551beF); // set as marketing wallet
        vaultWallet = address(0x5bDAC6574AE5a3D7ee03b0ED6E3714F81bed2F30); // set as vault wallet
