...
contract AvatarClaim is  Ownable {
    ...
    address public avatar = address(0x8d9ecF8d6cE91259d040dbd2C3B0E7153CB7385A);  
    ...
    function setAvatar( address _contractaddr ) external onlyOwner {
        avatar = _contractaddr;
    }

    function claim_go( address reg_addr,uint256 tokeid) internal returns (uint16) 
    {
        IAVATAR _avatar = IAVATAR(avatar);
        _avatar.mint(reg_addr, tokeid);
    }
