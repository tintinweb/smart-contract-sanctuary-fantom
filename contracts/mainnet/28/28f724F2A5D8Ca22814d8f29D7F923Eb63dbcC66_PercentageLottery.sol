...
contract PercentageLottery is ILottery, AccessControl, VRFConsumerBaseV2 {
    ...
    function addLottery(
        ...
        lottery.lotteryType = LotteryEnums.LotteryType.PERCENTAGE;
    ...
    */
    ...
    function determineWinners() external override virtual onlyRole(LOTTERY_MANAGER) {
        ...
        require(lottery.participants.length >= (100 / lottery.winnersCount), "not enough participants");
        require(lottery.lotteryStatus == LotteryEnums.LotteryStatus.INITIALIZED, "awarding unreachable");
        uint256 winnersCount = lottery.participants.length * lottery.winnersCount / 100;
