...
contract DividendDistributor  {
    ...
    // Tshare Token; 
    IERC20 EP = IERC20(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83); // FTM
...
contract Void is Auth {
  ...
  // 1% Goes to the reflections for token holders; 
  uint256 reflectionFee = 100;
  // 10% Goes to the marketing team;
