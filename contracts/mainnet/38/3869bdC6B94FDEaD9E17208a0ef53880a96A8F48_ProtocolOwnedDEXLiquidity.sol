...
contract ProtocolOwnedDEXLiquidity is Ownable {
    ...
    IUniswapLPToken constant public lpToken = IUniswapLPToken(0xab3732e3486e7667A57e8C70dA8A1512CffebD43);
    IERC20 constant public gFTM = IERC20(0x589CBb44a55EC66019dfc379832C27B12daAC06f);
    IMultiFeeDistribution constant public treasury = IMultiFeeDistribution(0xCAAa935E9AB8cecbD39BA468065299336f405A98);
    ...
    constructor(
        ...
        IChefIncentivesController chef = IChefIncentivesController(0x1551d634825AB5c8E2A39fd0c49AF28c5F50608e);
