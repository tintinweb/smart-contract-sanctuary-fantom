...
contract FantomOmega is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Fantom Omega';
    string private constant _symbol = 'FTMO';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x0b2f193D2312A3015b34C1264DC315B1D05A380b, 'We can not exclude router.');
