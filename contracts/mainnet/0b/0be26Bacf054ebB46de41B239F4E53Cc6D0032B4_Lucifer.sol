...
contract Lucifer is ERC20Burnable, Operator {
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("LUCIFER", "LUCI") {
     ...
     */
    function distributeReward(address _liquidityBegin) external onlyOperator {
        require(!rewardPoolDistributed, "only can distribute once");
        require(_liquidityBegin != address(0), "!_airdropWallet");
        rewardPoolDistributed = true;
        _mint(_liquidityBegin, 500 ether); // 500 for add liquidity by owner
    }
