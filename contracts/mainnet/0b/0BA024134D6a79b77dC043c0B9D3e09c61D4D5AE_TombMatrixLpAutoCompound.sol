...
contract TombMatrixLpAutoCompound is MatrixLpAutoCompound {
    ...
    address internal constant TBOND = 0x24248CD1747348bDC971a5395f4b3cd7feE94ea0;
    address internal constant L3USD = 0x5f0456F728E2D59028b4f5B8Ad8C604100724C6A;
    ...
    function _setWhitelistedAddresses() internal override {
        ...
        whitelistedAddresses.add(TBOND);
        whitelistedAddresses.add(L3USD);
    }
    ...
    function _setDefaultSwapPaths() internal override {
        ...
        // LSHARE -> TBOND
        address[] memory _lshareTbond = new address[](3);
        _lshareTbond[0] = LSHARE;
        _lshareTbond[1] = TOMB;
        _lshareTbond[2] = TBOND;
        _setSwapPath(LSHARE, TBOND, TOMBSWAP_ROUTER, _lshareTbond);

        // LSHARE -> TBOND
        address[] memory _lshareL3USD = new address[](3);
        _lshareL3USD[0] = LSHARE;
        _lshareL3USD[1] = USDC;
        _lshareL3USD[2] = L3USD;
        _setSwapPath(LSHARE, L3USD, TOMBSWAP_ROUTER, _lshareL3USD);
