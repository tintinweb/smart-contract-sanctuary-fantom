...
contract StrategyOxdSolidexVolatileUsdcWeveLp is StrategyOxdFarmLPBase {
    // Token addresses
    address public usdc_weve_lp = 0xbF1c168fd5cb65C6A3c31d3d48b222104258ba70;
    address public usdc = 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75;
    address public weve = 0x911da02C1232A3c3E1418B834A311921143B04d7;
    ...
    {
        swapRoutes[usdc].push(route(wftm, usdc, false));
        swapRoutes[weve].push(route(wftm, usdc, false));
        swapRoutes[weve].push(route(usdc, weve, false));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategyOxdSolidexVolatileUsdcWeveLp";
    }
}
