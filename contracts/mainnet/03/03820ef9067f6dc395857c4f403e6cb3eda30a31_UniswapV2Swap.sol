...
contract UniswapV2Swap {
    ...
    address private constant ROUTER_SPK = 0xF491e7B69E4244ad4002BC14e878a34207E38c29; // Spookyswap router
    ...
    IUniswapV2Router private router_spk = IUniswapV2Router(ROUTER_SPK);
        ...
        external onlyOwner returns (uint _a2ou)
    {
        ...
        fusd.approve(address(router_spk), _a0in);
        ...
        uint[] memory amounts = router_spk.swapExactTokensForTokens(
