...
contract BaseV1Pair {
    ...
    constructor() {
        ...
        (token0, token1, stable, fee) = (_token0, _token1, _stable, _stable ? 10000 : 333);//0.01% for stable / 0.3% for unstable
    ...
    function setFee(uint _fee) external {
        require(BaseV1Factory(factory).pauser() == msg.sender, "not allowed");
        require(fee > 100, "fee < 1%");
        fee = _fee;
    }
