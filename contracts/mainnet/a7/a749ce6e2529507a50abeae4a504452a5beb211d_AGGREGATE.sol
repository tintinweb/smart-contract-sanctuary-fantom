...
contract AGGREGATE is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Aggregate Finance';
    string private constant _symbol = 'AG8';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xF3b8b8D2494C280D238B89914167c5d139F7D1dB, 'We can not exclude router.');
