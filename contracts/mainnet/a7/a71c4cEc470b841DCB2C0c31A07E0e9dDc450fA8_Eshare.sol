...
contract Eshare is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _devFund) public ERC20("Esse Shares", "ESHARE") {
        _mint(msg.sender, 1 ether); // mint 1 ESHARE Share for initial pools deployment
