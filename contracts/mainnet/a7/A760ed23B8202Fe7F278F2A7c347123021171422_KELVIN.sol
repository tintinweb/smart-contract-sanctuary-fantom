...
contract KELVIN is Context, IERC20, Ownable {
    ...
    string private constant _symbol = 'KELVIN';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x1D149C5479089975ad7CAe29F2c9627E059E7a92, 'We can not exclude router.');
