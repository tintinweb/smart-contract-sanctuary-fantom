...
abstract contract FeeManager is StratManager {
    ...
    uint public fee = MAX_FEE - STRATEGIST_FEE - callFee;

    function setCallFee(uint256 _fee) public onlyManager {
        require(_fee <= MAX_CALL_FEE, "!cap");
        
        callFee = _fee;
        fee = MAX_FEE - STRATEGIST_FEE - callFee;
    }
...
contract Strat is StratManager, FeeManager {
    ...
    constructor(
        ...
        address _feeConfig,
        address _yeller
    ) StratManager(_keeper, _unirouter, _vault, _feeConfig) {
        want = _want;
    ...
    function chargeFees() internal {
        ...
        uint256 ownerFeeAmount = yelBal * fees.owner / 1e18;
    ...
    function callReward() public view returns (uint256) {
        ...
        uint256[] memory amountOut = IUniswapRouterETH(unirouter).getAmountsOut(outputBal, crvToNativeToYelRoute);
