...
// File contracts/EqualFtmConkvAMM.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract EqualFtmConkvAMM is Ownable, Pausable {
   ...
   //Withdraws funds from masterchef
    ...
    function addLiquidity() internal {
        ...
        IEqualizerRouter(router).addLiquidity(wrapped, conk, stable, lp0Bal, lp1Bal, 1, 1, address(this), block.timestamp);   
    }
