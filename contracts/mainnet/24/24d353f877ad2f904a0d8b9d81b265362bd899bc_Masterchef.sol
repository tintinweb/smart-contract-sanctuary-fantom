...
contract Masterchef is Ownable, ReentrancyGuard {
    ...
    function addInitialPools(IBEP20 _SUNwFTMPair, IBEP20 _SUNUSDCPair) external onlyOwner{
        ...
        add(3000, IBEP20(_SUNUSDCPair), 0, 28800, false); // SUN-USDC 0
        add(3000, IBEP20(_SUNwFTMPair), 0, 28800, false); // SUN-wFTM 1    
        add(2000, sun, 0, 28800, false); // SUN solo staking 2
