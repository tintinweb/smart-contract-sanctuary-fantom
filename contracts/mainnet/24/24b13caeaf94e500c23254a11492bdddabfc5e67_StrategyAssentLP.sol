...
contract StrategyAssentLP is StratManager, FeeManager {
    ...
    address constant public output = address(0x5B3C1F260E09e653290f24F75abC5e466fD42310);
    address public want;
    address public lpToken0;
    address public lpToken1;

    // Third party contracts
    address constant public masterchef = address(0x2Df0d214239E20535060220aE54ef361606e346b);
     ...
     */
    event StratHarvest(address indexed harvester, uint256 lastHarvestTime);
    ...
    function harvest() external whenNotPaused onlyEOA {
        ...
        emit StratHarvest(msg.sender,lastHarvestTime);
    }
