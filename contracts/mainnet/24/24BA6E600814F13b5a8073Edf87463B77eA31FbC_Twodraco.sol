...
contract Twodraco is BEP20('2DRACO Token', '2DRACOS') {
...
contract Xdraco is Ownable {
    ...
    constructor(
        Twodraco _rewardtoken
    ) public {
        rewardtoken = _rewardtoken;
        devaddr = address(0xea1D8fA5baE6C0a4FB781f59643d0Bd7dC978323);
        feeAddress = address(0xea1D8fA5baE6C0a4FB781f59643d0Bd7dC978323);
