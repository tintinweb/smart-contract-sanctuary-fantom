...
// File src/strategies/fantom/strategy-base-v2.sol
// License-Identifier: MIT
...
abstract contract StrategyBase {
    ...
    address public constant native = wftm;
...
// File src/strategies/fantom/equalizer/strategy-equalizer-base.sol
// License-Identifier: MIT
pragma solidity >=0.8.6;



abstract contract StrategyEqualizerBase is StrategyBase {
    // Addresses
    address public constant solidRouter = 0x1A05EB736873485655F29a37DEf8a0AA87F5a447;
    ...
    constructor(
        ...
        ISolidlyRouter.route[] memory _equalRoute = new ISolidlyRouter.route[](1);
        _equalRoute[0] = ISolidlyRouter.route(equal, wftm, false);
        _addToNativeRoute(_equalRoute);
        ...
        IERC20(equal).approve(solidRouter, type(uint256).max);
...
// File src/strategies/fantom/equalizer/strategy-equalizer-wftm-weth.sol
// License-Identifier: MIT
pragma solidity >=0.8.6;

contract StrategyEqualizerWftmWethVlp is StrategyEqualizerBase {
    // Addresses
    address private _lp = 0xE3bD349BDb8203C15426b2d273f57568E658F843;
    address private _gauge = 0x47e901fD66aD41173AEc8896201260B45DcEe682;
    ...
    constructor(
        ...
        address _controller,
        address _timelock
    ) public StrategyEqualizerBase(_lp, _gauge, _governance, _strategist, _controller, _timelock) {
        isStablePool = false;

        // token0 route
        nativeToTokenRoutes[weth].push(ISolidlyRouter.route(native, weth, false));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategyEqualizerWftmWethVlp";
    }
}