...
contract GlotV2 is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 GLOTs
    ...
    constructor(uint256 _startTime, address _devFund, address _communityFund) public ERC20("Gas Station Lot", "GLOT") {
        _mint(msg.sender, 1 ether); // mint 1 Gas Station Lot for initial pools deployment
