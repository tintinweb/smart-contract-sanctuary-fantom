...
contract Rare is ERC20Burnable, Operator {
    ...
    uint256 public constant INITIAL_RARE_POOL_DISTRIBUTION = 27500 ether;

    // DAO FUND INITIAL ALLOCATION IS 1000 RARE
    ...
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("RARE", "RARE") {
        // Mints 3,000 RARE to contract creator for initial pool setup & LP
