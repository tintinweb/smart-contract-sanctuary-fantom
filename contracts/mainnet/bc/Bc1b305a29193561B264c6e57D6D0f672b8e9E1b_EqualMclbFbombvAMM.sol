/**
 *Submitted for verification at FtmScan.com on 2023-02-13
*/
...
// File @openzeppelin/contracts/security/[email protected].7.3
...
contract EqualMclbFbombvAMM is Ownable, Pausable {
    ...
    address public constant pathToken = address(0xF24Bcf4d1e507740041C9cFd2DddB29585aDCe1e); //beets
    address public want;
    ...
    bytes32 public wrappedToBeetsId;
    bytes32 public beetsToMclbId;
    ...
    constructor(
        ...
        bytes32 _wrappedToBeetsId,
        bytes32 _beetsToMclbId,
        ...
        sentinel = _sentinel;
        wrappedToBeetsId = _wrappedToBeetsId;
        beetsToMclbId = _beetsToMclbId;
    ...
    function addLiquidity() internal {
        ...
        _beethovenSwap(wrappedToBeetsId, wrapped, pathToken, wrappedHalf);

        uint256 pathTokenBal = IERC20(pathToken).balanceOf(address(this));
        _beethovenSwap(beetsToMclbId, pathToken, mclb, pathTokenBal);
