...
contract AllinFinance is ERC20, Ownable, SafeToken {
    ...
    uint256 public maxSellTransactionAmount = 200000000000000000000000000000000 * (10**18);
    uint256 public maxBuyTransactionAmount = 200000000000000000000000000000000 * (10**18);
    ...
    constructor() ERC20("Allin Finance", "AFI ") {
        liquidityFee = 3;
        charityFee = 4;
        charityWallet = payable(0xd91426c27D0c81715bF623A9412214D4B2EF54e6);
