/**
 *Submitted for verification at FtmScan.com on 2022-12-27
*/
    ...
    ClampedRandomizer
{
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("COTC Reimagined", "COTCR") ClampedRandomizer(maxSupply) {     
