...
contract StableGaugeProxy is ProtocolGovernance, ReentrancyGuard {
    ...
    mapping(address => bool) verifiedTokens; // verified tokens
    mapping(address => bool) baseTokens; // Base tokens 
    ...
    function preDistribute() external nonReentrant hasDistribute {
        ...
        if (ve) {
            ...
            uint256 _inSpiritRewards = _balance * _lockedSpirit / _spiritSupply;
