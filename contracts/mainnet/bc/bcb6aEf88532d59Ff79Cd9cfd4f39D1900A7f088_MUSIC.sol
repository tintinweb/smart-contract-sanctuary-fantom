...
contract MUSIC is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Music Token';
    string private constant _symbol = 'MUSIC';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xAFCEB51615A1126cDB6B95c0C7285C5E1167B22c, 'We can not exclude router.');
