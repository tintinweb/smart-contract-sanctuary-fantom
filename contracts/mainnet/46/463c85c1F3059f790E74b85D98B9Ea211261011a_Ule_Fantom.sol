...
address  payable public owner;
 ...
 IPancakePair public bnbbusdlp;
    ...
    constructor ( IPancakePair _bnbbusdlp)  
    {
  ...
  function paused() public view virtual returns (bool) {
    ...
    function sendMultiFTM(address payable[]  memory  _contributors, uint256[] memory __balances) public  payable whenNotPaused
    {
    ...
    function ClaimFTM (uint256 _amount) onlyOwner public whenNotPaused
    {
    ...
    {
       return  BUSDtobnb()*amount;
    }
    


//   BUSD LP   0xA48869049e36f8Bfe0Cc5cf655632626988c0140
