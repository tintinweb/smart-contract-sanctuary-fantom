...
contract PositionRouter is BasePositionManager, IPositionRouter, IExecutionFee {
    ...
    function _callRequestCallback(
        ...
        bool success;
        try IPositionRouterCallbackReceiver(_callbackTarget).bfxPositionCallback{ gas: _gasLimit }(_key, _wasExecuted, _isIncrease) {
            success = true;
        } catch {}
...
interface IPositionRouterCallbackReceiver {
    function bfxPositionCallback(bytes32 positionKey, bool isExecuted, bool isIncrease) external;
}
