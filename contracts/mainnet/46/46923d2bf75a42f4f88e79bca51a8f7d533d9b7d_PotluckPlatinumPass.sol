...
contract PotluckPlatinumPass is
    ERC721,
    ERC721Enumerable,
    ERC721URIStorage,
    Ownable,
    Pausable
{
    ...
    address public primaryDevAddress =
        0xd8936E602E38dfEe5d6466865068b94b1943DEBF;
    ...
    uint256 public quaternaryDevFee = 1500;
    uint256 public quinaryDevFee = 1000;
    ...
    constructor() ERC721("Potluck Platinum Pass", "PLPP") {
        baseURI = "https://potluck-server.vercel.app/api/nft/";
        _pause();
    }
    ...
    function mint(uint256 amount) public payable whenNotPaused {
        ...
        require(balanceOf(msg.sender) < 10, "You have exceeded the limit of tokens per wallet");
    ...
    function internalMint(address to) internal {
        require(totalSupply() < maxSupply, "All PLPP have been minted!");
