...
contract ERC721Staking is ReentrancyGuard {
    ...
    function withdraw(uint256 _tokenId) external nonReentrant {
        ...
        require(
            ...
            "Kamu tidak memiliki token yang di stake"
        );
        
        // Wallet must own the token they are trying to withdraw
        require(stakerAddress[_tokenId] == msg.sender, "Kamu tidak memiliki token ini!");
    ...
    function claimRewards() external {
        ...
        require(rewards > 0, "Kamu tidak memiliki imbalan untuk diklaim");
        stakers[msg.sender].timeOfLastUpdate = block.timestamp;
