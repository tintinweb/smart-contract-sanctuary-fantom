...
contract Treasury is ContractGuard {
    ...
    function initialize(
        ...
        maxExpansionTiers = [150, 100, 75, 50, 25];

        maxSupplyExpansionPercent = 150; // Upto 4.0% supply for expansion
        ...
        bondSupplyExpansionPercent = 150; // maximum 5% emissions per epoch for POL bonds
    ...
    function setMaxSupplyExpansionPercents(uint256 _maxSupplyExpansionPercent) external onlyOperator {
        require(_maxSupplyExpansionPercent >= 10 && _maxSupplyExpansionPercent <= 150, "_maxSupplyExpansionPercent: out of range"); // [0.1%, 10%]
    ...
    function setBondDepletionFloorPercent(uint256 _bondDepletionFloorPercent) external onlyOperator {
        require(_bondDepletionFloorPercent >= 0 && _bondDepletionFloorPercent <= 10000, "out of range"); // [5%, 100%]
