...
contract LiquidCZapCurve {
    ...
    function LiquidCOutAndSwap2(address liquidCVault, uint256 withdrawAmount, address pool, address lpToken, address desiredToken, int128 desiredIndex) external {
        ILiquidCVaultV6 vault = ILiquidCVaultV6(liquidCVault);
    ...
    function LiquidCOutAndSwap3(address liquidCVault, uint256 withdrawAmount, address pool, address lpToken, address desiredToken, int128 desiredIndex) external {
        _approveTokenIfNeeded(lpToken, pool);
        uint256 amountLiquidity = IERC20(lpToken).balanceOf(address(this));
        ICurveSwap(pool).remove_liquidity_one_coin(amountLiquidity, desiredIndex, uint256(0));
    }

    function LiquidCOutAndSwap4(address liquidCVault, uint256 withdrawAmount, address pool, address lpToken, address desiredToken, int128 desiredIndex) external {
        address[] memory tokens = new address[](1);
        tokens[0] = desiredToken;
