...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xe20B9e246db5a0d21BF9209E4858Bc9A3ff7A034); //WBANANO
...
contract DOMO is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "DOMO";
    ...
    address routerAddress = 0xF491e7B69E4244ad4002BC14e878a34207E38c29;
    address RewardToken = 0xe20B9e246db5a0d21BF9209E4858Bc9A3ff7A034;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x10541749E66CCa63E4A11468C859c99c459F95c8;  // teamwallet
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 amountFTMReflection = amountFTM.mul(rewardsFee).div(totalFTMFee);
        ...
        try dividendDistributor.deposit{value: amountFTMReflection}() {} catch {}

        (bool tmpSuccess,) = payable(marketingWallet).call{value: amountFTMMarketing, gas: 30000}("");
        (bool tmpSuccess1,) = payable(lotteryWallet).call{value: amountFTMLottery, gas: 30000}("");
