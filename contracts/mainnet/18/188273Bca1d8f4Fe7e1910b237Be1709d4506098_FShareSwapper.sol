...
contract FShareSwapper is Operator {
    ...
    constructor(
        ...
        tomb = IERC20(0x0f5b2B7602b1DE3E368093e142143768Fc4efe5a); 
        tbond = IERC20(0xd87D2f67Abe9bA230148f2C2d4af86730EA4ddD3);
        tshare = IERC20(0xa2D2d73402651E806c9eef9De81cff6521811Ce8);
        wftmAddress = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;  // 
        tombSpookyLpPair = 0xb11b67047e34bFDDc3582f4C739Cef1e4b3C9A2A;
        tshareSpookyLpPair = 0x8674B49ab1fE5c9Cf3a20aFFB2B7d945d137DC65; 
        daoAddress = 0x2105D82828fb638B67D7B9A340Fe8168B5036Eeb;
    }

    function set(address _tomb,
            address _tbond,
            address _tshare,
            address _wftmAddress,
            address _tombSpookyLpPair,
            address _tshareSpookyLpPair,
            address _daoAddress) external onlyOperator {
        tomb = IERC20(_tomb);
        tbond = IERC20(_tbond);
