...
contract JackpotLottery is ReentrancyGuard, Ownable {
    ...
    uint256 private maxLimitofSendDividendTracker = 100 ether; //cost * 1 / 10;

//    address constant FTM = address(0xf1277d1Ed8AD466beddF92ef448A132661956621);
  address constant FTM = address(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83 );        // FTM mainnet
    ...
    function procPrizeofRewardToken(uint8 _index) internal {
        require(prizeRewardToken[_index-1] > 0, "Prize not settled");
