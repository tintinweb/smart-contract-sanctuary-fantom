...
interface IMasterChef {
    function deposit(uint256 poolId, uint256 _amount, address _sponsor) external;
    function withdraw(uint256 poolId, uint256 _amount, address _sponsor) external;
    function harvest(uint256 poolId, address _to) external;
...
contract FantasmStrat is Ownable, Pausable {
    ...
    function callReward() public view returns (uint256) {
        uint256 outputBal = IMasterChef(masterchef).pendingReward(poolId, address(this));
        uint256 nativeOut;
