...
contract FantomGames is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("FantomGames", "FG") {
        ...
        marketingWallet = address(0x055de0c47eB079f10a55Ad6e984532C15a2e866E); // set as marketing wallet
        vaultWallet = address(0x1c38098860a0f73dC54966b4e39bC4B087daDd13); // set as vault wallet
