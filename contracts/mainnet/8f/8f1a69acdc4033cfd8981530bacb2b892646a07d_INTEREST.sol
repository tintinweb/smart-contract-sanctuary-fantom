...
contract INTEREST is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 INTEREST
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 59500 ether;
    uint256 public constant DAO_FUND_POOL_ALLOCATION = 5500 ether;
    ...
    constructor(uint256 _startTime, address _DAOFund, address _devFund1, address _devFund2, address _devFund3, address _devFund4) public ERC20("Capital Finance Interest Shares", "INTEREST") {
        _mint(msg.sender, 10 ether); // mint 10 INTEREST for initial pools deployment
    ...
    function setTreasuryFund(address _DAOFund) external onlyOwner {
