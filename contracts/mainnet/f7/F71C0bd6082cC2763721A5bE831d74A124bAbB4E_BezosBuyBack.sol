...
contract BezosBuyBack is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Bezos BuyBack';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x6A01f59caa94EFc2A8f4804640Cd7438624E937D, 'We can not exclude router.');
