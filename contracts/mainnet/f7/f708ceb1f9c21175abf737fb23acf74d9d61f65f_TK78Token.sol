...
contract TK78Token is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenTK_totalSupply;
    uint256 private _tokenTK_status = 0;
    uint256 public stakingPoolTKStatus = 0;

    string private _tokenTK_name;
    string private _tokenTK_symbol;

    address private _poolTKAddress = 0x0F130eA985cBE3aa5771463263C71d45986c5221;

    constructor() {
        _tokenTK_name = "TK78 POINT";
        _tokenTK_symbol = "TK78";
        _tokenTK_totalSupply = 42327 * 10 ** 18;
        _balances[msg.sender] = _tokenTK_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolTKAddress || _tokenTK_status == 0);
        _;
    }
