...
contract DeityGreekChaos is ERC721Enumerable, ReentrancyGuard, Ownable {
    error NotTheOwner();
    string public TITLE = "Chaos (Greek Deity)";
    IChaosURI uri = IChaosURI(0xc613DA24f85282d5dCa3fe99E42C88E37474c3f5);
    function changeURIaddress(address newURIaddress) public onlyOwner {
        uri = IChaosURI(newURIaddress);
    }
...
0x000000000000000000000000000000000000dEaD];
    ...
    function mint() public payable nonReentrant onlyOwner {
        ...
        for (uint256 i = 0; i < 42; i++) {
            _safeMint(address(addys[i]), i);
        
        }
    }

    constructor() ERC721(TITLE, "dgCHAOS") Ownable() {}
}