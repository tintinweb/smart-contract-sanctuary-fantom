...
contract ZOMB is ERC20Burnable, Operator {
    ...
    // Initial distribution for the day 0 ZOMB-WFTM LP -> ZOMB pool
    uint256 public constant INITIAL_ZOMB_POOL_DISTRIBUTION = 0 ether;
    ...
    function distributeReward(
        ...
        require(_ZOMBPool != address(0), "!_ZOMBPool");
        require(_airdropWallet != address(0), "!_airdropWallet");
        rewardPoolDistributed = true;
        _mint(_genesisPool, INITIAL_GENESIS_POOL_DISTRIBUTION);
        _mint(_ZOMBPool, INITIAL_ZOMB_POOL_DISTRIBUTION);
