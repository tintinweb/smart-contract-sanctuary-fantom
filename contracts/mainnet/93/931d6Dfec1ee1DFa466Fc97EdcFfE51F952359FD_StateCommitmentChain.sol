...
contract StateCommitmentChain is IStateCommitmentChain, Lib_AddressResolver {
    ...
    constructor(
        ...
        tombAdmin = _tombAdmin;
    }

    modifier onlyTombAdmin() {
        require(msg.sender == tombAdmin, "Not allowed");
        _;
    }
    ...
    function changeTombAdmin(address newTombAdmin) public onlyTombAdmin {
        tombAdmin = newTombAdmin;
    }

    function changeFraudProof(uint256 newFraudProofWindow) public onlyTombAdmin {
	FRAUD_PROOF_WINDOW = newFraudProofWindow;
    }

    function changePublishWindow(uint256 newPublishWindow) public onlyTombAdmin {
        SEQUENCER_PUBLISH_WINDOW = newPublishWindow;
    }
...
library Lib_PredeployAddresses {
    ...
    address internal constant OVM_LIFE = 0x4200000000000000000000000000000000000108;
    address internal constant OVM_LSHARE = 0x4200000000000000000000000000000000000109;
}
