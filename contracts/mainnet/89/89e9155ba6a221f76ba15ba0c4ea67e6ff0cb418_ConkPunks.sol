...
contract ConkPunks is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  address private _tokenAddress = 0x7a99593118AE9DbA43657182B6500A4C8FAe8e1c;                
  ...
  address public royaltyAddress = 0xDf79b943EBcbBEDa8483d5ab6bE976D6F1D4DF14;    
  uint public royalty = 800; 

  constructor(
    ) 
    ERC721("CONK Punks", "CPUNK") 
    {
    _scopeCap = maxSupply;
  }
  ...
  function mint(uint256 _mintAmount) public {
    ...
    require(userData[msg.sender].minted + _mintAmount <= maxMintAmount,  "100 Mintable per tx.");

    IERC20(_tokenAddress).transferFrom(msg.sender, address(this), tokenCost * _mintAmount);
  ...
  function setTokenCost(uint256 _newTokenCost) public onlyOwner {
    tokenCost = _newTokenCost;
  }
  ...
  function withdraw() public payable onlyOwner {
    ...
    function withdrawTokens(address _tokenContract) external onlyOwner {
        ...
        emit WithdrawTokens(msg.sender, _tokenContract, _amount);
    }
