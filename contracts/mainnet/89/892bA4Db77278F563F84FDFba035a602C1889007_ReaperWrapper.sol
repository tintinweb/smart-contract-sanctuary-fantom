...
abstract contract YearnV1_4626 is ERC20, IVaultWrapper, IERC4626, ReentrancyGuard {
  ...
  //////////////////////////////////////////////////////////////*/
        ...
        returns (uint256 assets)
    {
        ...
        // Use of Math.min here acceptable to prevent reversion
  ...
  //////////////////////////////////////////////////////////////*/
    ...
    function _redeem(
        ...
        // Transfer whatever we received to receiver
        _token.safeTransfer(receiver, assets);
        // Handle dust that was in the contract prior to call
...
interface ReaperAPI is IVaultV1 {
    ...
    // NB: This only exists on SOME ReaperFarms vaults
