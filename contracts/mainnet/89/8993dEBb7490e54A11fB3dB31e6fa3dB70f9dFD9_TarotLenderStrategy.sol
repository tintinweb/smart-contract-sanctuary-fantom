...
contract TarotLenderStrategy is BaseStrategy {
    ...
    /// @notice Lending pools allocations.
    BorrowableAllocation[] allocations;
    ...
    function redeemBorrowable(address borrowable, uint256 amount)
        internal
