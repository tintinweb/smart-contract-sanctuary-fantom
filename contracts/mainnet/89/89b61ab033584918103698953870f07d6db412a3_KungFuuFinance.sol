...
contract AccessControl {
    ...
    bytes32 public constant REBASE = keccak256(abi.encodePacked("REBASE"));
...
contract KungFuuFinance is ERC20Detailed, Ownable, AccessControl {
    ...
    uint256 public rewardYield = 3550000;
    ...
    address public liquidityReceiver = 0x0AaD04f96b29eB5d31AA52317e19B78A0ffecB8d; //Fantom Liquidity Receiver - Will move to CryptEx Locker
    address public treasuryReceiver = 0x914aDbe1a641F1E4A8ce22776D342d4C2669f030; // Fantom Treasury Receiver - Moves to Multi-Sig after launch
    address public riskFreeValueReceiver = 0xaAEf45E31e2D2865A4722c1591BA4cd8f6e83bad; //Fantom Multi-Sig RFV
    address public busdToken = 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75; //Fantom USDC
    ...
    uint256 public sellFeeBurnAdded = 2; //Additional 2% burned on every sell
    ...
    constructor() ERC20Detailed("KungFuu", "KNGFUU", uint8(DECIMALS)) {
    ...
    function automatedRebase() public onlyRole(REBASE){
