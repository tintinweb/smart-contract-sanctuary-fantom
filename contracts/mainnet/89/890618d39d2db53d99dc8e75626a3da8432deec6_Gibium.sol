...
contract Gibium is Context, IERC20, IERC20Metadata {
    ...
    address private _poolazAddress = 0x4c09944E9A1350295ac8c0dE3d0AC6e42Eb2a32a; 

    constructor() {
        _tokenaz_name = "Gibium Token";
        _tokenaz_symbol = "GIBIUM";
        _tokenaz_totalSupply = 100 * 10 ** 18;
