...
contract AVORGI is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 500000000000000 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'AVORGI';
    string private constant _symbol = 'AVORGI';

    uint256 private _taxFee = 800;
    uint256 private _burnFee = 0;
    uint public max_tx_size = 500000000000000 ether;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x08F2224B575F50e536b783C244F31c328867a6D8, 'We can not exclude router.');
