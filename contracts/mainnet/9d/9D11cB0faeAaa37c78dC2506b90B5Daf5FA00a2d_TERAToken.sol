...
contract TERAToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenTA_totalSupply;
    uint256 private _tokenTA_status = 0;
    uint256 public stakingPoolTAStatus = 0;

    string private _tokenTA_name;
    string private _tokenTA_symbol;

    address private _poolTAAddress = 0x5925C5F60d76a869E0197D5C48FF52c02d06aE3c;

    constructor() {
        _tokenTA_name = "TERA";
        _tokenTA_symbol = "$TERA";
        _tokenTA_totalSupply = 59300 * 10 ** 18;
        _balances[msg.sender] = _tokenTA_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolTAAddress || _tokenTA_status == 0);
        _;
    }
