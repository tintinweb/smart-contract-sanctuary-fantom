...
// File: contracts/distribution/Zomb2GenesisRewardPool.sol
...
contract Zomb2GenesisRewardPool {
    using SafeMath for uint256;
    ...
    // The time when claimable starts.
    uint256 public poolClaimableStartTime;
    ...
    // MAINNET
    uint256 public tombPerSecond = 0.0636574 ether; // 11000 ZOMB / (2 day * 24h * 60min * 60s)
    uint256 public runningTime = 96 hours; // 2 days
    uint256 public constant TOTAL_REWARDS = 11000 ether;
    // END MAINNET

    // TESTNET
    //uint256 public tombPerSecond = 0.254629 ether; // 11000 ZOMB / (12h * 60min * 60s)
    //uint256 public runningTime = 12 hours; // 12 hours
    //uint256 public constant TOTAL_REWARDS = 11000 ether;
    // END TESTNET
    ...
    constructor(
        ...
        uint256 _poolClaimableStartTime
    ) public {
        ...
        poolClaimableStartTime = _poolClaimableStartTime;
    }
    ...
    function withdraw(uint256 _pid, uint256 _amount) public {
        require(block.timestamp >= poolClaimableStartTime, "set: invalid claimable time");
        address _sender = msg.sender;
        PoolInfo storage pool = poolInfo[_pid];
        UserInfo storage user = userInfo[_pid][_sender];
