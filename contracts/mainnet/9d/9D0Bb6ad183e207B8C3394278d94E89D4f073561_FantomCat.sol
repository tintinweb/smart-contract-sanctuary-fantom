...
contract FantomCat is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Fantom Cat';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xe2a3b9E58fBc06ca80b2691F34Ef3Cb679c2961b, 'We can not exclude router.');
