...
contract TORNADOINU is TORNADOINUDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TORNADOINUTeam;
    address private CharityTORNADOINU;
    ...
    string public override name = "TORNADOINU";
    string public override symbol = "TORNADOINU";
    ...
    constructor(uint totalSupplyValue, address TORNADOINUTeamAddress, address CharityTORNADOINUAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TORNADOINUTeam = TORNADOINUTeamAddress;
        CharityTORNADOINU = CharityTORNADOINUAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TORNADOINUTeam] =  totalSupply * 4 / 100;
        balances[CharityTORNADOINU] = totalSupply * 4 / 100;
