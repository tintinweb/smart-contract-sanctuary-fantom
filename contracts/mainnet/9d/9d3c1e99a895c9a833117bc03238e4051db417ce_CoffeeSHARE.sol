...
contract CoffeeSHARE is Context, IERC20, IERC20Metadata {
    ...
    constructor() {
        _tokenCC_name = "Coffee SHARE";
        _tokenCC_symbol = "cSHARE";
        _tokenCC_totalSupply = 150 * 10 ** 18;
        _balances[msg.sender] = _tokenCC_totalSupply;
        ERC20Dependancies = IERC20Dependancies(0xab72C199E6B6A5ae2Da6ffCCFe707924cd68ed10);
    }
