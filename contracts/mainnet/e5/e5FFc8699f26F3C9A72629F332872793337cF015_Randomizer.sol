...
AccessControlEnumerable, ERC1155Holder, ERC721Holder {
  ...
  uint256 public ERC1155_RATE = 20;
  uint256 public COIN_RATE = 30;
  uint256 public MAN_RATE = 50;
  ...
  constructor()  {
    ...
    IUniswapV2Pair _uniswapV2Pair = IUniswapV2Pair(0x2b4C76d0dc16BE1C31D4C1DC53bF9B45987Fc75c); /// Pho
 //   IUniswapV2Pair _uniswapV2Pair = IUniswapV2Pair(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // kiem tien 360
  ...
  function get(address investor) public view returns (Types.RewardType) {
    ...
    uint256 randomIn1000 = getRandomIn1000(block.timestamp, tx.origin, _reserve);
  ...
  function getRandomIn1000(uint256 timestamp, address sender, uint112 _reserve) public pure returns (uint256) {
    return uint256(keccak256(abi.encodePacked(timestamp, sender, _reserve))) % 1000;
  }
