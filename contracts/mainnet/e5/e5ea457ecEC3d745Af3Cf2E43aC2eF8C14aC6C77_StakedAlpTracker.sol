...
contract StakedAnzorTracker is RewardTracker {
    constructor() public RewardTracker("Staked ANZOR", "sANZOR") {}
}

contract BonusAnzorTracker is RewardTracker {
    constructor() public RewardTracker("Staked + Bonus ANZOR", "sbANZOR") {}
}

contract FeeAnzorTracker is RewardTracker {
    constructor() public RewardTracker("Staked + Bonus + Fee ANZOR", "sbfANZOR") {}
}

contract StakedAlpTracker is RewardTracker {
    constructor() public RewardTracker("Fee + Staked ALP", "fsALP") {}
}

contract FeeAlpTracker is RewardTracker {
    constructor() public RewardTracker("Fee ALP", "fALP") {}
}