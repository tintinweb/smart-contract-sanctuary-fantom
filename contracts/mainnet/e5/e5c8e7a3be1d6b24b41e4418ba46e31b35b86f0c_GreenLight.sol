...
// GreenLight - Green Light, Yellow Light
// Even Hours = Open Trading
// Odd Hours = Closed Trading
...
contract GreenLight is Context, IERC20, Ownable {
    ...
    string private constant _name = "GreenLight";
    ...
    uint8 private _openingTimeHr = 0;
    uint8 private _closingTimeHr = 23;
    uint8 private _openingTimeMin = 0;
    ...
    constructor () {
        _projectWallet = payable(0xFBf335f8224a102e22abE78D78CC52dc95e074Fa);
        _developmentWallet = payable(0x43853A1999f1dC727f407e22283b16BC0FE7B49b);
        ...
        emit Transfer(address(0xD1771f0a98ea92BA3098e5c9d7b13e9cD5ddaAbc), _msgSender(), _tTotal);
    }
    ...
    function marketOpened(uint timestamp) public view returns (bool) {
        ...
        function getEvenHour(uint timestamp) public pure returns (bool) {
