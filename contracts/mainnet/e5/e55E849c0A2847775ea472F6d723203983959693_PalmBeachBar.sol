...
contract PalmBeachBar {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    IERC20 public constant TOKEN = IERC20(0x772e7cE0799BF6d74602986943b8Dce3d7305C21);
    uint256[] public tierAllocPoints = [1 ether, 1 ether, 1 ether];
    uint256[] public tierAmounts = [20 ether, 500 ether, 5000 ether];
    struct User {
