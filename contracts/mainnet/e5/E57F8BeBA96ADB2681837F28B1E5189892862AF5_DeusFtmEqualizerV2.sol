...
// File contracts/DeusFtmEqualizerV2.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract DeusFtmEqualizerV2  is Ownable, Pausable {
    ...
    function addLiquidity() internal {
        ...
        IEqualizerRouter(router).swapExactTokensForTokens(equalHalf, 0, equalToDeusPath, address(this), block.timestamp);

        uint256 t1Bal = IERC20(wftm).balanceOf(address(this));
        uint256 t2Bal = IERC20(deus).balanceOf(address(this));

        IEqualizerRouter(router).addLiquidity(wftm, deus, stable, t1Bal, t2Bal, 1, 1, address(this), block.timestamp);
    }
