...
// Dependency file: contracts/baby/DEUSPRINTERDividendTracker.sol
    ...
    DividendPayingTokenOptionalInterface
{
    ...
    function distributeDEUSDividends(uint256 amount) public onlyOwner {
...
contract DEUSPRINTERDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main DEUSPRINTER contract."
        );
    }
...
// Root file: contracts/baby/DEUSPRINTER.sol
...
// import "contracts/interfaces/IPancakeFactory.sol";
// import "contracts/interfaces/IPancakeRouter02.sol";
// import "contracts/baby/DEUSPRINTERDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract DEUSPRINTER is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    DEUSPRINTERDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = DEUSPRINTERDividendTracker(
        ...
        IPancakeRouter _PancakeRouter = IPancakeRouter(addrs[1]);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "DEUSPRINTER: The dividend tracker already has that address"
        );

        DEUSPRINTERDividendTracker newDividendTracker = DEUSPRINTERDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "DEUSPRINTER: The new dividend tracker must be owned by the DEUSPRINTER token contract"
        );
    ...
    function updatePancakeRouter(address newAddress) public onlyOwner {
        require(
            ...
            "DEUSPRINTER: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "DEUSPRINTER: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != PancakePair,
            "DEUSPRINTER: The Pancake pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "DEUSPRINTER: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "DEUSPRINTER: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "DEUSPRINTER: Cannot update gasForProcessing to same value"
        );
    ...
    function swapAndSendToFee(uint256 tokens) private {
        uint256 initialDEUSBalance = IERC20(rewardToken).balanceOf(
            address(this)
        );

        swapTokensForDEUS(tokens);
    ...
    function swapTokensForDEUS(uint256 tokenAmount) private {
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        if (success) {
            dividendTracker.distributeDEUSDividends(dividends);
