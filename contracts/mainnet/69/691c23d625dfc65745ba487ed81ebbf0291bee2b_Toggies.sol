...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    bool public salesPossible = false;
    ...
    function setApprovalForAll(address operator, bool approved) public override {
        require(salesPossible, "Not yet sellable");
...
contract Toggies is Ownable, DefaultOperatorFilterer, ERC721A {
    ...
    constructor() ERC721A("Toggies", "TOGGY"){}
    ...
    function toggleSalesPossible() public onlyOwner() {
        salesPossible = !salesPossible;
    }

    function getSalesPossible() public view onlyOwner() returns (bool) {
        return salesPossible;
    }
   ...
   function sendGiftsToWallet(address _wallet, uint256 _num) external onlyOwner{
    ...
    function setmaxSupply(uint256 _supply) public onlyOwner() {
        require(_supply <= 4444, "Error: New max supply cant be higher than original max.");
        maxSupply = _supply;
    }
