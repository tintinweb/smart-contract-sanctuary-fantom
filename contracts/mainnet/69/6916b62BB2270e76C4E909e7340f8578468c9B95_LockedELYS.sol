...
contract LockedELYS is ERC721 {
    ...
    constructor(IERC20 token, string memory name, string memory CID, address mintTo, uint256 lockDays, uint256 amount, uint256 reward) ERC721(name, "ELYSLOCK"){
       _token = token;
       _CID = CID;
       _mint(mintTo,1,lockDays,amount,reward);
    }
    ...
    function _mint(address to, uint256 tokenId, uint256 lockDays, uint256 amount, uint256 reward) private {
        _safeMint(to, tokenId);
    ...
    //0x6916b62BB2270e76C4E909e7340f8578468c9B95
