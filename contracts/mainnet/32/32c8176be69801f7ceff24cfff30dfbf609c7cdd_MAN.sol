...
contract MAN is ERC20  {
    ...
    address payable public MarketingWallet = 0x8bae660D372C3587DdfC6239651C3e3a1EDB9d9F;
    uint256 public swapTokensAtAmount = 100 * (10**18); 


    uint256 public  liquidityFee;
    uint256 public  totalFees;
    uint256 public  MarketetingWalletFee;
    ...
    constructor() public ERC20("Man of Crypto", "MAN") {
        uint256 _liquidityFee = 1;
        uint256 _MarketetingWalletFee = 9;

        liquidityFee = _liquidityFee;
        MarketetingWalletFee = _MarketetingWalletFee;
        totalFees = (_liquidityFee).add(_MarketetingWalletFee);
    ...
    function changeMarketingWalletTax(uint256 newpercent) external onlyOwner {
        MarketetingWalletFee = newpercent;
    }
    ...
    function _transfer(
      ...
      override {
        ...
        if(
            ...
            uint256 lotteryWalletTokens = contractTokenBalance.mul(MarketetingWalletFee).div(totalFees);
