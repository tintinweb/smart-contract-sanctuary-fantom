...
contract DistributionPool is OwnableUpgradeable {
    ...
    uint256 public constant INIT_CLAIM = 100_175_000_000_000 * 1e6;
...
library SignatureChecker {
    ...
    */
    function validSignature(EnumerableSet.AddressSet storage signers, bytes32 message, bytes calldata signature) internal view returns (bool) {
    ...
    */
    function requireValidSignature(EnumerableSet.AddressSet storage signers, bytes32 message, bytes calldata signature) internal view {
