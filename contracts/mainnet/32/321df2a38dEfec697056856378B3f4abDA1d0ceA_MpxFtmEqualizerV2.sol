...
// File contracts/MpxFtmEqualizerV2.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract MpxFtmEqualizerV2  is Ownable, Pausable {
    ...
    function addLiquidity() internal {
        ...
        IEqualizerRouter(router).swapExactTokensForTokens(wrappedHalf, 0, equalToWftmPath, address(this), block.timestamp);
        IEqualizerRouter(router).swapExactTokensForTokens(wrappedHalf, 0, equalToMpxPath, address(this), block.timestamp);

        uint256 t1Bal = IERC20(wftm).balanceOf(address(this));
        uint256 t2Bal = IERC20(mpx).balanceOf(address(this));
    ...
    function _subAllowance() internal {
        ...
        IERC20(mpx).safeApprove(router, 0);
    }
    ...
    function _addAllowance() internal {
        ...
        IERC20(mpx).safeApprove(router, type(uint).max);
    }
