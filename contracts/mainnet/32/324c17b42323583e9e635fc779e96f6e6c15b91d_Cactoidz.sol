...
// File: contracts/Fantomized/cactoidz.sol
...
abstract contract ERC721Tradable is ERC721Enumerable, Ownable {
    ...
    uint public constant MAX_SUPPLY = 1445;
    ...
    function claim(
        ...
        require(_currentTokenId < _maxClaim, "Minting is over");
    ...
    function claim(address _to, uint _amount) public payable {
        require(_amount <= 10, "10 max at once");
        require(totalSupply() + _amount <= _maxClaim, "Not enough mints left");
        require(msg.value >= _amountClaim * _amount, "Incorrect price");
        while (_amount != 0) {
          _currentTokenId++;
          _mint(_to, _currentTokenId);
          _amount--;
 ...
 * Cactoidz
 */
contract Cactoidz is ERC721Tradable {

    string private _baseUrl;
    string private _contractUrl = "https://cactoidz.fantomized.art/cactoidz.json";

    constructor()
        ERC721Tradable("Cactoidz", "CCTZ")
    {}
