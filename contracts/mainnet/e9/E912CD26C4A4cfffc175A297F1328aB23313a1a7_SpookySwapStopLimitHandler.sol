...
contract SpookySwapStopLimitHandler is UniswapV2Router02StopLimitHandler {
    constructor(address _spookyRouter, address _wrappedNative)
        UniswapV2Router02StopLimitHandler(_spookyRouter, _wrappedNative)
