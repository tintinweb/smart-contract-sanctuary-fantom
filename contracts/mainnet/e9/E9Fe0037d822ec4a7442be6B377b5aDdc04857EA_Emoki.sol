...
contract Emoki is ERC721Enumerable, Ownable {
    ...
    bool public isSaleStoped = true;

    uint256 public constant MAX_ENTRIES = 1285;
    uint256 public constant maxPurchaseCount = 10;
    uint public price = 40 ether;

    address public admin = 0xd755085F7cC22920b327A5d7Ad9234073dc89379;
    ...
    address[10] public airdropAddresses = [
        0x4AabC919010828b0FDA9BdaCe15C9b2220bD4906, 
        ...
        0x6916aF343804050F4675dfd337ec58DE71F0F97e,
        0xBc622C6bcc9200c68d525AdF5c8b1B9C3d1C6DE3,
        0x53Cfb3A77eFC4088b48Ed7B94E8D8EeA0d002AEB,
    ...
    uint8[10] public counts = [ 7, 1, 4, 1, 5, 1, 1, 2, 4, 2 ];
    ...
    function mint(uint256 _amount) external payable
    {
        ...
        require(_amount <= maxPurchaseCount, "MAX PURCHASE AMOUNT EXCEED");
        uint256 totalMinted = totalSupply();
        require(_amount + totalMinted <= MAX_ENTRIES, "Amount exceed");
        require(msg.value >= price * _amount, "Emoki: not enough price");
    ...
    returns (string memory)
  {
    ...
    function airdropShroomies() external onlyOwner {
        uint256 totalMinted = totalSupply();
        for (uint8 i = 0; i < airdropAddresses.length; i++) {
            for (uint8 j = 1; j <= counts[i]; j++) {
                _mint(airdropAddresses[i], _getNewId(totalMinted));
                totalMinted++;
            }
        }
    }
