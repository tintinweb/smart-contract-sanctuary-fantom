...
contract DOME is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Everdome';
    string private constant _symbol = 'DOME';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xf1b924FCEF300368C48b759d919ad886a03A33ad, 'We can not exclude router.');
