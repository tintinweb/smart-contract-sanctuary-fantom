...
contract BabyShibaPoConk is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Baby ShibaPoConk';
    string private constant _symbol = 'BabyCONK';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x0A66694C88029F9aCa4D52ec61D6B98D96031dA6, 'We can not exclude router.');
