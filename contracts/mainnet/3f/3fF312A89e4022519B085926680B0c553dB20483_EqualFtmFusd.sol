...
// File: contracts/EqualFtmFusd.sol
...
contract EqualFtmFusd is Ownable, Pausable {
    ...
    function addLiquidity() internal {
        ...
        uint256 lp1Bal = IERC20(fusd).balanceOf(address(this));

        IEqualizerRouter(unirouter).addLiquidity(wrapped, fusd, stable, lp0Bal, lp1Bal, 1, 1, address(this), block.timestamp);
    }
