...
interface IMasterChef {
    ...
    function bSharePerSecond() external view returns (uint256);
 ...
 */
contract FTMBShareAutoCompoundBased is IStrategy, Ownable, Pausable {
    ...
    address public masterChef =
        address(0xAc0fa95058616D7539b6Eecb6418A68e7c18A746);
    uint8 public poolId;
    ...
    function anualReward() external view returns (uint256) {
        return
            IMasterChef(masterChef).bSharePerSecond().mul(3600).mul(24).mul(
                365
            );
    }
}
