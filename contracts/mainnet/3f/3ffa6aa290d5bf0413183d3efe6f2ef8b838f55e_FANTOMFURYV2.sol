...
contract FANTOMFURYV2 {
	...
	uint constant public			INVEST_MIN_AMOUNT				= 5 ether;			    // 5 FANTOM
	uint[] public					REFERRAL_PERCENTS				= [70, 30, 20, 10, 5];	// 7% 3% 2% 1% 0.5%
	uint constant public			PROJECT_FEE						= 60;					// project fee 5% of deposit
	uint constant public			DEV_FEE							= 40;					// dev fee 5% of deposit
	uint constant public			MAX_WITHDRAW_AMOUNT				= 2000 ether;			// claim 2000 FANTOM max
