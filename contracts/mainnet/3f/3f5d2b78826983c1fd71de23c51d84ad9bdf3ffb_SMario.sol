...
contract SMario is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 SMarios
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("SMARIO", "SMARIO") {
        _mint(msg.sender, 1 ether); // mint 1 COIN Share for initial pools deployment
