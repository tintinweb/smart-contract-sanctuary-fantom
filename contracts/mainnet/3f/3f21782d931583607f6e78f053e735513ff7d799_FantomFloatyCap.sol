...
// You buy FFC on Fantom network, we farm on multiple chains and return the profits. 100% community driven and fast development. 

    // Telegram:
    // https://t.me/ffloatycap

    // Website:
    // https://ffloaty.capital

    // Twitter:
    // https://twitter.com/fantomfloatycap

    // Medium:
    // https://fantomfloatycap.medium.com
...
contract FantomFloatyCap is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Fantom Floaty Capital", "FFC") {
        ...
        marketingWallet = address(0xb38555BbB2E48d44BEcD4c87811ad54cBC16231C); // set as marketing wallet
        treasuryWallet = address(0x6Eca50744652c4dF495F6a240df9299004351300); // set as treasury wallet
