    ...
    IFeeManagerUpgradeable
{
    ...
    */
    ...
    /**
        ...
        @return [baseFeeInUSD, swapFeeInUSD, maxFeeInUSD], [baseFeeInToken, swapFeeInToken, maxFeeInToken], totalFees, totalBpsFee
     */
        ...
        )
    {
        ...
        // Assuming transaction volume to be $1000
        (uint256 totalFee, ) = this.getFee(destChainId, srcToken, destToken, feeToken, widgetID, 1000000, msg.sender);
        ...
        uint256 tokenToPriceX10e9 = _feeTokenToPriceX10e9[feeToken];
        require(tokenToPriceX10e9 != 0, "Fee Manager: Fees not set for this token");

        uint256 baseFeeInToken = ((fees.baseFeeInUSD * (10**9) * (10**fees.feeTokenDecimals)) / tokenToPriceX10e9);
        uint256 swapFeeInToken = ((fees.swapFeeInUSD * (10**9) * (10**fees.feeTokenDecimals)) / tokenToPriceX10e9);
        uint256 maxFeeInToken = ((fees.maxFeeInUSD * (10**9) * (10**fees.feeTokenDecimals)) / tokenToPriceX10e9);

        return (
            [fees.baseFeeInUSD, fees.swapFeeInUSD, fees.maxFeeInUSD],
            [baseFeeInToken / 10**3, swapFeeInToken / 10**3, maxFeeInToken / 10**3], 
            totalFee,
            totalBpsFee
            );
    }
    ...
    */
    function setFee(
        ...
        _fees[feeConfigID] = Fees(
            ...
            destToken,
            feeToken,
            IERC20MetadataUpgradeable(feeToken).decimals(),
