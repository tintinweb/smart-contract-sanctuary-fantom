...
contract Cfshare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 20,000 CFSHARE
    ...
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 1250 ether;
    ...
    constructor(address _communityFund, address _devFund1, address _devFund2, address _devFund3, address _devFund4) public ERC20("CFSHARE", "CFSHARE") {
        _mint(msg.sender, 100 ether); // mint 100 CFSHARE for initial pools deployment
    ...
    function setDevFund(uint parameter, address _devFund) external onlyOperator {
