...
/// @title OneInchAdaptor is to help exchange assets based on swap description struct
/// @notice Users can call `swap` method to swap assets
/// OneInchAdaptor will forward the swap description to `caller` contract to perform multi-swap of assets
contract OneInchAdaptor is IDexAggregatorAdaptor, AccessControl, ReentrancyGuard {
        ...
        returns (uint256)
    {
        ...
        Address.functionCallWithValue(address(aggregator), data, msg.value, "call to Aggregator failed");
