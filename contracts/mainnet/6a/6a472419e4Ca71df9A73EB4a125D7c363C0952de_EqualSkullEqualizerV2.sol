...
// File contracts/EqualSkullEqualizerV2.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract EqualSkullEqualizerV2  is Ownable, Pausable {
    ...
    function addLiquidity() internal {
        ...
        IEqualizerRouter(router).addLiquidity(equal, skull, stable, t1Bal, t2Bal, 1, 1, address(this), block.timestamp);
    }
