...
contract BABY is ERC20, Ownable, RewardsTracker {
    ...
    ) ERC20('BABY', 'bBABY') RewardsTracker(_router, _rewardToken) {
    ...
    function _transfer(
        ...
        if (whitelistOnly) {
            require(whitelist[from] || whitelist[to], 'Address is not in whitelist');
        }
