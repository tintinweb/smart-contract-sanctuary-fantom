...
contract Synaptic is Context, IERC20, Ownable {
    ...
    string private _name = "Synaptic";
    string private _symbol = "APTIC";
    ...
    function balanceOf(address account) public view override returns (uint256) {
        ...
        return tokenFromReward(_rOwned[account]);
    }
    ...
    function tokenFromReward(uint256 rAmount) public view returns(uint256) {
        require(rAmount <= _rTotal, "Amount must be less than total rewards");
    ...
    function excludeFromReward(address account) public onlyOwner() {
        ...
        if(_rOwned[account] > 0) {
            _tOwned[account] = tokenFromReward(_rOwned[account]);
        }
