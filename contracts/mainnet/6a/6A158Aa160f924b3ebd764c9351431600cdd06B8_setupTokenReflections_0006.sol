...
contract setupTokenReflections_0006 {
    function migrate(
        address treasury,
        address growthFund,
        ...
        LibTokenReflections.setRewardsDuration(1 hours);
        LibTokenReflections.setEnforceDuration(true);
        LibTokenReflections.setRewardsToken(stableCoin);
        LibTokenReflections.setRewardsTokenVault(stakingRewardReceiver);

        LibTokenReflections.setExemptFromReflections(address(this), true);
        LibTokenReflections.setExemptFromReflections(
            LibDiamond.contractOwner(),
            true
        );
        LibTokenReflections.setExemptFromReflections(pair, true);
        LibTokenReflections.setExemptFromReflections(treasury, true);
        LibTokenReflections.setExemptFromReflections(growthFund, true);
        LibTokenReflections.setExemptFromReflections(
            stakingRewardReceiver,
            true
        );
        LibTokenReflections.setExemptFromReflections(presaleContract, true);
        LibTokenReflections.setExemptFromReflections(intermediateWallet, true);
    }
}