...
contract FantomHousexBoo is VRFConsumerBaseV2, Ownable, ReentrancyGuard {
    ...
    bytes32 keyHash = 0x64ae04e5dba58bc08ba2d53eb33fe95bf71f5002789692fe78fb3778f16121c9; // 20000 Gwei Limit
    ...
    uint256 minBet = 500000000000000000; // default 0.5 xBoo, around $1.80 atm.
    ...
    uint256 minHouseDeposit = 2000000000000000000000; // default 2000 xBoo, which is around $7500 atm
    ...
    address private constant XBOO_ADDRESS = 0xa48d959AE2E88f1dAA7D5F611E01908106dE7598;
    IERC20 private xBoo = IERC20(XBOO_ADDRESS);
    ...
    function depositHouse(uint256 _amount, address _referral) external {
        ...
        xBoo.safeTransferFrom(_sender, address(this), _amount);
    }
    ...
    function withdrawHouse(uint256 _amount) external nonReentrant {
        ...
        xBoo.safeTransfer(msg.sender, _amount);
    }
    ...
    function refund() external nonReentrant {
        ...
        for (uint256 i = startBetIdIndex; i < _length; i++) {
			...
			// 333 Block is about 5 minutes in Fantom
            if (block.number >= _bet.block + 333) {
                if (_bet.pending == 1) {
    ...
    function bet(uint256 _betAmount, uint256 _faceSide, address _referral) external nonReentrant {
        ...
        xBoo.safeTransferFrom(_sender, address(this), _betAmount);
    ...
    function returnDepositAndRemoveDepositor(uint256 _length, bool _shouldRemoveDepositor) internal {
        for (uint i = 0; i < _length; i++) {
            ...
            xBoo.safeTransfer(_depositor, _depositAmount);
