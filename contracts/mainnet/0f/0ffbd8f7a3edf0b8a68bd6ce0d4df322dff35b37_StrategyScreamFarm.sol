...
import "../interfaces/StrategyGeneralMasterChefBase.sol";
import "../interfaces/IScreamChef.sol";
import "@openzeppelin/contracts/token/ERC20/ERC20.sol";

contract StrategyScreamFarm is StrategyGeneralMasterChefBase {
    using SafeERC20 for IERC20;

    // Token addresses
    address public scream = 0xe0654C8e6fd4D733349ac7E09f6f23DA256bF475;
    address public masterChef = 0x5bC37CAAA3b490b65F5A50E2553f4312126A8b7e;
    ...
    function getHarvestable() external view override returns (uint256) {
        uint256 _pendingReward = IScreamChef(masterchef).pendingRewards(
            poolId,
            address(this)
        );
    ...
    function balanceOfPool() public view virtual override returns (uint256) {
        IScreamChef.UserInfo memory info = IScreamChef(masterchef).getUserInfo(
            poolId,
            address(this)
        );
        return info.amount;
...
abstract contract StrategyGeneralMasterChefBase is StrategyBase {
    ...
    function emergencyWithdraw() public virtual onlyBenevolent {
        IMasterChef(masterchef).emergencyWithdraw(poolId);
    }

    function inCaseTokensGetStuck(address _token) external onlyBenevolent {
