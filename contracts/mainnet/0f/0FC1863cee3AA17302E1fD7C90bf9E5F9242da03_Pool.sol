...
contract Pool is Ownable, ReentrancyGuard {
    ...
    bool public collateralRatioPaused = true;
    ...
    function setTreasury(address _treasury, address _sig) external {
    ...
    function transferToTreasury(uint256 _amount) internal {
        ...
        if (_amount > 0) {
            WethUtils.weth.safeTransfer(treasury, _amount / 2);
            WethUtils.weth.safeTransfer(sig, _amount / 2);
        }
    }
