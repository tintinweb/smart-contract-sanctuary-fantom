...
contract GShareRewardPool {
    ...
    struct PoolInfo {
        ...
        uint256 accGSharePerShare; // Accumulated mSHAREs per share, times 1e18. See below.
    ...
    uint256 public tSharePerSecond = 0.00186122 ether; // 59500 gshare / (370 days * 24h * 60min * 60s)
    ...
    // Safe gshare transfer function, just in case if rounding error causes pool to not have enough mSHAREs.
