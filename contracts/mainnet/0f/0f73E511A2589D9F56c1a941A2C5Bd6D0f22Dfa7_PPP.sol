...
contract PPP is IERC20Extended, Auth, BaseToken {
    ...
    uint256 public _maxWallet = 105 * 10**6;
    ...
    function _transferFrom(
        ...
        bool isBuy = sender == pair || sender == address(router) || sender == _owner;
        ...
        if (!isBuy) {
            require(_balances[sender] + amount <= _maxWallet, 'Max tx amount & hold 0.5% of totalSupply');
        }
