...
contract VaultUtils is IVaultUtils, Governable {
    ...
    constructor(IVault _vault, IFastPriceFeed _fastPriceFeed, IPositionRouter _positionRouter) public {
        vault = _vault;
    ...
    function validateIncreasePosition(address /* _account */, address /* _collateralToken */, address /* _indexToken */, uint256 /* _sizeDelta */, bool /* _isLong */) external override view {
        ...
        require(fastPriceFeed.isUpdater(tx.origin) || positionRouter.isPositionKeeper(tx.origin) || vault.isLiquidator(tx.origin), "Not authorized");
    }
