...
// File contracts/abstract/ReaperBaseStrategyv1_1.sol
...
// File contracts/interfaces/IDeusRewarder.sol
...
// File contracts/ReaperStrategySpookysFTMX.sol
...
contract ReaperStrategySpookysFTMX is ReaperBaseStrategyv1_1 {
    ...
    function _swap(uint256 _amount, address[] memory _path) internal {
        if (_path.length < 2 || _amount == 0 || IUniswapV2Router02(SPOOKY_ROUTER).getAmountsOut(_amount, _path)[_path.length - 1] == 0) {
            return;
        }
