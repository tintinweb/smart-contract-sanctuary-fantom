...
contract RAVEN is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 650000 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'Raven.fi';
    string private constant _symbol = 'DOOM';

    uint256 private _taxFee = 400;
    uint256 private _burnFee = 200;
    uint public max_tx_size = 650000 ether;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x2B05d45ef560efD1803612Fe8C14042d93a67a2c, 'We can not exclude router.');
