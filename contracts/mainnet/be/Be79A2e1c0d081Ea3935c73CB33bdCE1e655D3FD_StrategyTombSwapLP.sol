...
contract StrategyTombSwapLP is StratManager, FeeManager, GasThrottler {
    ...
    function callReward() public view returns (uint256) {
        ...
        uint256 nativeOut;
        if (outputBal > 0) {
            uint256[] memory amountOut = IUniswapRouterETH(spookyRouter).getAmountsOut(outputBal, outputToNativeRoute);
