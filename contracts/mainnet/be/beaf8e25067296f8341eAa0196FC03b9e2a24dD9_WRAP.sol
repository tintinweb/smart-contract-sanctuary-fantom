...
/**
 * 
 * Welcome to Wrap Game.
 * 
 * 
 * 
 * https://www.warp.game/
 * https://discord.gg/warpbond
 * https://twitter.com/WarpBond
 *
 * 
 * PLEASE READ: 3% Liquidity Fee / 4% Marketing Fee - SLIPPAGE > 7
 * 
 * Join the Telegram for more information and engagement with the WrapGang.
 * 
*/
...
contract WRAP is ERC20, Ownable, SafeToken {
    ...
    constructor() ERC20("Wrap Game", "STARSHIP") {
        liquidityFee = 1;
        charityFee = 4;
        charityWallet = payable(0xB8dBB463a11134bFb1a375722c54b12b483bae06);
