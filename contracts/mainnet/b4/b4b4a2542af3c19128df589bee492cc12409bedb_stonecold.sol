...
contract stonecold is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    constructor(string memory _initBaseURI) ERC721("stoneCold", "STNS") {
    ...
    function addTokenMapping(uint256 _tokenID, string memory _ipfsHash) public onlyOwner{
