...
contract NosferatuFinance is ERC20Detailed, Ownable {
    ...
    uint256 public rewardYield = 4200000;
    ...
    address public liquidityReceiver = 0x2bC0fB5AE12B34F5cF85242Ac6e2250ebEa092d2;
    address public treasuryReceiver = 0x2Cc6C2EE923122861C64c5a75cAEbf64D111dB59; //TREASURY WALLET
    address public riskFreeValueReceiver = 0x867232fa66152074CD4277Dc2886c45b6f50f083; //RFV WALLET
    address public busdToken = 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75; // USDC
    ...
    constructor() ERC20Detailed("NOSFERATU FINANCE", "NOS", uint8(DECIMALS)) {
        router = IDEXRouter(0xF491e7B69E4244ad4002BC14e878a34207E38c29); //spookyswap
