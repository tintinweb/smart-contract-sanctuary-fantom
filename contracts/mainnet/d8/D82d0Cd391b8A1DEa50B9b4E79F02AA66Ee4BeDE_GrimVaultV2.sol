...
// File: contracts/interfaces/IStargateSingleStrat.sol

pragma solidity ^0.8.4;


interface IStargateSingleStrat { 
...
contract GrimVaultV2 is ERC20, Ownable, ReentrancyGuard {
    ...
    IStargateSingleStrat public strategy;
     ...
     */
    constructor (
        IStargateSingleStrat _strategy,
        string memory _name,
    ...
    function balance() public view returns (uint) {
        return want().balanceOf(address(this)) + IStargateSingleStrat(strategy).balanceOf();
    }
    ...
    function proposeStrat(address _implementation) public onlyOwner {
        require(address(this) == IStargateSingleStrat(_implementation).vault(), "!Valid proposal");
    ...
    function upgradeStrat() public onlyOwner {
        ...
        strategy = IStargateSingleStrat(stratCandidate.implementation);
