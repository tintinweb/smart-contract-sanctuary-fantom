...
contract TShare is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 700000 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'TShare';
    string private constant _symbol = 'TSHARE';

    uint256 private _taxFee = 0;
    uint256 private _burnFee = 0;
    uint public max_tx_size = 700000 ether;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xE050C4b31cc70dbcF6eFac54D760CDE426aB4174, 'We can not exclude router.');
