...
error FarmingIncentiveFundCantBeAddressZero();
...
contract TShare is ERC20Burnable, Operator {
    ...
    constructor(
        ...
        uint256 _initialPreMinted
    ) payable ERC20(_name, _symbol) {
        _mint(msg.sender, _initialPreMinted * 1 ether); // mint {_initialPreMinted} tokens for initial pools deployment
    }
        ...
        onlyOperator
    {
        ...
        if (_farmingIncentiveFund == address(0))
            revert FarmingIncentiveFundCantBeAddressZero();
