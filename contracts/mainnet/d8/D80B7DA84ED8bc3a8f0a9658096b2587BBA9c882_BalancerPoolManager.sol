...
contract BalancerPoolManager is ReentrancyGuard {
    ...
    event SwapFeePercentageChanged(address poolAddress, uint256 newSwapFeePercentage);
    event AmpUpdateStarted(address poolAddress, uint256 endValue, uint256 endTime);
    event AmpUpdateStopped(address poolAddress);
    event TokenRateCacheDurationChanged(address poolAddress, IERC20 token, uint256 duration);
    event SwapFeeAuthenticationChanged(address poolAddress, address user, bool authorized);
    ...
    function setSwapFeePercentage(address poolAddress, uint256 swapFeePercentage) external nonReentrant {
        ...
        emit SwapFeePercentageChanged(poolAddress, swapFeePercentage);
    }
        ...
        nonReentrant
    {
        ...
        emit AmpUpdateStarted(poolAddress, rawEndValue, endTime);
    }
    ...
    function stopAmplificationParameterUpdate(address poolAddress) external nonReentrant {
        ...
        emit AmpUpdateStopped(poolAddress);
    }
    ...
    function setTokenRateCacheDuration(address poolAddress, IERC20 token, uint256 duration) external nonReentrant {
        ...
        emit TokenRateCacheDurationChanged(poolAddress, token, duration);
    }
    ...
    function setSwapFeeAuthentication(address poolAddress, address user, bool authorized) external nonReentrant {
        ...
        emit SwapFeeAuthenticationChanged(poolAddress, user, authorized);
    }
