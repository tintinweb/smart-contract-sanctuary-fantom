...
contract ZESTPROTC is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Zest Protocol';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x445e155816D87a8c9fa7a3985eE5a5a6CC653CBf, 'We can not exclude router.');
