...
// File: contracts/EqualFtmRavevAMM.sol
...
contract EqualFtmRavevAMM is Ownable, Pausable {
    ...
    function addLiquidity() internal {
        ...
        IEqualizerRouter(unirouter).swapExactTokensForTokens(wrappedHalf, 0, wrappedToRavePath, address(this), block.timestamp);
        
        uint256 lp0Bal = IERC20(wrapped).balanceOf(address(this));
        uint256 lp1Bal = IERC20(rave).balanceOf(address(this));

        IEqualizerRouter(unirouter).addLiquidity(wrapped, rave, stable, lp0Bal, lp1Bal, 1, 1, address(this), block.timestamp);
    }
    ...
    function _removeAllowances() internal {
        ...
        IERC20(rave).safeApprove(unirouter, 0);
    }
    ...
    function _giveAllowances() internal {
        ...
        IERC20(rave).safeApprove(unirouter, type(uint).max);
    }
