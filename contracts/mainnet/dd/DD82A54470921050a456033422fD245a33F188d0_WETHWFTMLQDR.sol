...
abstract contract CoreStrategyGeist is BaseStrategy {
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;
        ...
        BaseStrategy(_vault)
    {
        ...
        pool = IPool(provider.getLendingPool());
    ...
    function name() external view override returns (string memory) {
        return "StrategyHedgedFarmingGeistV2.1";
    }
...
// File: WETHWFTMLQDR.sol

contract WETHWFTMLQDR is CoreStrategyGeist {
    using SafeERC20 for IERC20;
    ...
    constructor(address _vault)
        ...
        CoreStrategyGeist(
            ...
            CoreStrategyAaveConfig(
                0x74b23882a30290451A17c44f4F05243b6b58C76d, // want -> WETH
                0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83, // short -> WFTM
                0xf0702249F4D3A25cD3DED7859a165693685Ab577, // wantShortLP -> WETH/WFTM 
                0x10b620b2dbAC4Faa7D7FFD71Da486f5D44cd86f9, // farmToken -> SUSHI
                0x4Fe6f19031239F105F753D1DF8A0d24857D0cAA2, // farmTokenLp -> SUSHI/WETH
                0x6e2ad6527901c9664f016466b8DA1357a004db0f, // farmMasterChef -> IStakingDualRewards
                15, // farmPid
                0x25c130B2624CF12A4Ea30143eF50c5D68cEFA22f, // aToken
                0x53d01d351Fa001DB3c893388E43e3C630A8764F5, // variableDebtTOken  
                0x6c793c628Fe2b480c5e6FB7957dDa4b9291F9c9b, // PoolAddressesProvider
    ...
    function balancePendingHarvest() public view override returns (uint256) {
        uint256 pending = LqdrFarm(farmMasterChef).pendingLqdr(farmPid, address(this)).add(farmToken.balanceOf(address(this)));
    ...
    function _depositLp() internal override {
        ...
        LqdrFarm(address(farmMasterChef)).deposit(farmPid, lpBalance, address(this));
    }

    function _withdrawFarm(uint256 _amount) internal override {
        LqdrFarm(address(farmMasterChef)).withdraw(farmPid, _amount, address(this));
    }

    function claimHarvest() internal override {
        LqdrFarm(address(farmMasterChef)).harvest(farmPid, address(this));
    }
