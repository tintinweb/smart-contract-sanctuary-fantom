...
contract VisusFinance is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 7500000000 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'Visus Finance';
    string private constant _symbol = 'VISUS';

    uint256 private _taxFee = 400;
    uint256 private _burnFee = 200;
    uint public max_tx_size = 7500000000 ether;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x872f11F39Baa91d590838e7D36Bc98D8AB2fA115, 'We can not exclude router.');
