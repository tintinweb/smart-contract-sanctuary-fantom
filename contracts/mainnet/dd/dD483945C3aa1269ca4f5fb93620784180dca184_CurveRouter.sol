...
// MAI 0xfB98B335551a418cD0737375a2ea0ded62Ea213b
  ...
  function deposit(address asset, uint256 amount, address[] calldata pools, address[] calldata _froms, address[] calldata _tos) external {
    IERC20(asset).transferFrom(msg.sender, address(this), amount);
    router(pools, _froms, _tos, amount);
  }
