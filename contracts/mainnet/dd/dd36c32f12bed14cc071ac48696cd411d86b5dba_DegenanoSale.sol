...
contract DegenanoSale is Ownable {
    ...
    uint256 public whitelistPrice = 10000000000000000000;
    uint256 public publicPrice = 8000000000000000000;
    ...
    constructor() {
        investToken = 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75; // AVAX: 0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E FTM: 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75 BSC: 0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d;
        treasury = 0x965ccd8843Ff4446d571798108a89Db5a4A9dC38; 
        nrt = new NRT("NRT", 18); 
        startTime = 1651676400; 
    }
    ...
    function invest(uint256 investAmount) public {
        ...
        if (whitelistSale) {
            require(investAmount <= maxinvestPrivate, "above single cap - whitelist");
