...
contract creditprodddistributor {
...
contract creditprodd is IBEP20 {
    ...
    string constant _name = "CreditProdd";
    string constant _symbol = "creditprodd";
    ...
    address public marketingFeeReceiver = 0x16D41e8f37b8D7125fcb277106b4307b11f0BA5A; // marketing address 
    ...
    bool isBuyFeeEnabled;

    creditprodddistributor distributor;
    ...
    constructor (address distributorAddress) {
        ...
        distributor = creditprodddistributor(distributorAddress);
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (launched()) {
            ...
            else if (isBuyTransfer && !isFeeExempt[recipient] && isBuyFeeEnabled) {
    ...
    function setIsBuyFeeEnabled(bool enabled) external onlyApproved {
        isBuyFeeEnabled = enabled;
    }

    function checkIsDividendExempt(address holder) external view returns(bool) {
        return isDividendExempt[holder];
    }

    function checkIsDividendProcessorExempt(address holder) external view returns(bool) {
        return isDividendProcessorExempt[holder];
    }
    ...
    function checkIsTxLimitExempt(address holder) external view returns(bool) {
