...
contract World is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund, address _daoFund) public ERC20("WORLD", "ASTROWORLD Share Token") {
        ...
        devFundRewardRate = DEV_FUND_POOL_ALLOCATION.div(VESTING_DURATION_FOR_DAO);
