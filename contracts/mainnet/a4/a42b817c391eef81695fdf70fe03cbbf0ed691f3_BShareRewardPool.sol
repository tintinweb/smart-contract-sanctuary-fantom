...
contract BShareRewardPool {
    ...
    //Mainnet
    //BEAST-FTM = 50.000 alloc points // BSHARE-FTM = 35.000 alloc points // BEAST-BSHARE = 15.000 alloc points
    uint256 public bSharePerSecond = 0.0031281281 ether; // 100000 bshare / (370 days * 24h * 60min * 60s)
