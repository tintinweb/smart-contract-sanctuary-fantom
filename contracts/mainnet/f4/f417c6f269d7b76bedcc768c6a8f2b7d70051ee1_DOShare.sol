...
contract DOShare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 60,000 DOshare
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Doshare", "DoShare") {
