...
contract Zone is ERC20Burnable, Operator {
    using SafeMath for uint256;
    ...
    constructor(address _communityFund, address _devFund1, address _devFund2) public ERC20("VibeZone", "ZONE") {
        _mint(msg.sender, 1 ether); // mint 1 Zone for initial pools deployment
