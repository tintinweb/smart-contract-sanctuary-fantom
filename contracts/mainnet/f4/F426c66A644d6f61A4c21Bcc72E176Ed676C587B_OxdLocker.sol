 ...
 */
contract OxdLocker is ReentrancyGuard, Governable, ProxyImplementation {
    ...
    constructor(address _rewardsDistributor, IERC20 _oxd) public {
        initializeProxyStorage(_rewardsDistributor, _oxd);
    }
