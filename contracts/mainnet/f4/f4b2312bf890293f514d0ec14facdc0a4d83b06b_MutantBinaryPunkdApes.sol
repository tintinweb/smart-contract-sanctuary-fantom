...
contract MutantBinaryPunkdApes is ERC721,
  ERC721Enumerable,
  ERC721URIStorage,
  Ownable,
  ERC165Storage,
  ...
  constructor(uint256 _price) ERC721("Mutant Binary Punk'd Apes", "MBPA") {
    price = _price * 10**18;
    supply = 100;
    royaltyFee = 75; // 7.5%
    royaltyAddress = 0x8528C6ED39dc8149212F2260B39780493Ffa3B3D;
