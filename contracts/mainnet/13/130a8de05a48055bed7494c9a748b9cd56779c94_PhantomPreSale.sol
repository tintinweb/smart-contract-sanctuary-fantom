...
library SafeMath {
    ...
    uint256 private PRICE = 0.008e18; // PTM token price is 0.008 DAI
    ...
    uint256 private MIN_BUY = 90e18; // Min Amount of Dai user can use for buy
    uint256 private constant BUY_PRICE = 1e18; //  1 PTM is equal to 1 FTM
    uint256 private MAX_SUPPLY = 18750000; //  Max supply
    uint256 public COUNT_SALE; //  Max supply

    uint256 public PRE_SALE_START = 1648746000; // Presale start date
    uint256 public PRE_SALE_END = 1711650013; // Presale end date

    address public treasuryWallet = 0x8775B7173b446b4e25d5236214C24Dd18dBb5369; //Treasury Wallet Address
    ...
    function updateMinBuy(uint256 _newBuy) public onlyOwner{
	    MIN_BUY = _newBuy;
	}
    ...
    function updateStartTime(uint256 _newStartTime) public onlyOwner{
	    PRE_SALE_START = _newStartTime;
	}

    function updateEndTime(uint256 _newEndTime) public onlyOwner{
	    PRE_SALE_END = _newEndTime;
	}

    function updatePtmAddress(IERC20 _PTM) public onlyOwner{
	    PTM = _PTM;
	}

    function updateDaiAddress(IERC20 _DAI) public onlyOwner{
	    DAI = _DAI;
	}
    ...
    function depositAmount(uint256 amount) public {
        ...
        COUNT_SALE += ptmAmount;
        require(COUNT_SALE <=MAX_SUPPLY, "All token are sold" );
