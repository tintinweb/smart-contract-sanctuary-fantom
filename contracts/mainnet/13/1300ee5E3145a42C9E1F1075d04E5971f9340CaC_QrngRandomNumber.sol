...
contract QrngRandomNumber is RrpRequesterV0, Ownable {
    ...
    function makeRequestUint256() external onlyOwner {
    ...
    function makeRequestUint256Array(uint256 size) external onlyOwner {
        bytes32 requestId = airnodeRrp.makeFullRequest(
            airnode,
