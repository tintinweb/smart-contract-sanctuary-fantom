    ...
    ClampedRandomizer
{
    ...
    address  public royaltyAddress = 0x5b5A59BdDdC3747Fae3030e6e52f6065a7f3A69e;
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("EvilBeardZ", "EVBDZ") ClampedRandomizer(maxSupply) {     
