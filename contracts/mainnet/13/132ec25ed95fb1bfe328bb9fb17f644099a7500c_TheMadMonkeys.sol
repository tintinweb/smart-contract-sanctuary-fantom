...
/*
Beasty Bits on Fantom                                                              
*/

contract TheMadMonkeys is ERC721Enumerable, Ownable, ReentrancyGuard {
    using Strings for uint256;

    // Private
    uint16[200] public nftIds;
    ...
    uint256 public price = 700 ether; // 10**18
    ...
    constructor() ERC721("The Mad Monkeys", "MM") {
