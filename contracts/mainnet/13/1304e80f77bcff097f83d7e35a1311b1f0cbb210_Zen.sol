...
contract Zen is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 59,500 tSHAREs
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 42800 ether;
    uint256 public constant COMMUNITY_FUND_POOL_ALLOCATION = 3600 ether;
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 3600 ether;
    ...
    constructor(
        ...
        uint256 _taxRate
    ) public ERC20("Stability Share", "ZEN") {
    ...
    function _transferWithTax(
        ...
        // Transfer tax to community fund
        _transfer(sender, communityFund, taxAmount);
