...
// File contracts/EqualizerFtmSkullvAMM.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract EqualizerFtmSkullvAMM is Ownable, Pausable {
    using SafeERC20 for IERC20;

    // Tokens
    address public constant wftm = address(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83);
    address public constant equal = address(0x3Fd3A0c85B70754eFc07aC9Ac0cbBDCe664865A6);
    address public constant skull = address(0xfa5992A8A47aF7029e04eC6a95203AD3f301460b);
    address public want;
    ...
    IEqualizerRouter.Routes[] public equalToSkullPath;
    ...
    constructor(
        ...
        IEqualizerRouter.Routes[] memory _equalToSkullPath
    ) {
        ...
        for (uint i; i < _equalToSkullPath.length; ++i) {
           equalToSkullPath.push(_equalToSkullPath[i]);
        }
   ...
   //Withdraws funds from masterchef
    ...
    function addLiquidity() internal {
        ...
        IEqualizerRouter(router).swapExactTokensForTokens(equalHalf, 0, equalToSkullPath, address(this), block.timestamp);

        uint256 t1Bal = IERC20(wftm).balanceOf(address(this));
        uint256 t2Bal = IERC20(skull).balanceOf(address(this));

        IEqualizerRouter(router).addLiquidity(wftm, skull, stable, t1Bal, t2Bal, 1, 1, address(this), block.timestamp);
    }
    ...
    function _subAllowance() internal {
        ...
        IERC20(skull).safeApprove(router, 0);
    }
    ...
    function _addAllowance() internal {
        ...
        IERC20(skull).safeApprove(router, type(uint).max);
    }
