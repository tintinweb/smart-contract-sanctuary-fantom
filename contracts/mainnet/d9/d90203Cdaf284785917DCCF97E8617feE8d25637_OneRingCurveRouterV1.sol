...
contract OneRingCurveRouterV1 is IOneRingCurveRouter, Ownable {
  ...
  uint256 private constant MIM_DECIMALS = 18;
  uint256 private constant MAI_DECIMALS = 18;
  ...
  constructor() {
    ...
    tokensDecimals[MIM] = 18;
    tokensDecimals[MAI] = 18;
    ...
    address[9] memory tokens = [FRAX,DAI,USDC,USDC,USDC,fUSDT,fUSDT,MIM,MAI];
    address[9] memory pools = [FRAX_DAI_USDC,FRAX_DAI_USDC,FRAX_DAI_USDC,MIM_fUSDT_USDC,MAI_fUSDT_USDC,MIM_fUSDT_USDC,
                              MAI_fUSDT_USDC, MIM_fUSDT_USDC, MAI_fUSDT_USDC];
  ...
  function _swap(address from, address to, address poolToUse, uint256 amount) internal returns(uint256) {
    ...
    if(isMetaPool[poolToUse]) {
      ...
      uint256 amountExpectedToReceive = convertFromDecimalsToDecimals(amount, fromDecimals,toDecimals);
      uint256 minimumToReceive = (amountExpectedToReceive*995)/1000;
  ...
  function convertFromDecimalsToDecimals(uint256 amount, uint256 fromDecimals, uint256 toDecimals)
