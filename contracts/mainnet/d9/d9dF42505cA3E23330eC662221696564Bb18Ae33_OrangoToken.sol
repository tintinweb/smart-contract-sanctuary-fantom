...
contract OrangoToken is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Orango Token';
    string private constant _symbol = 'ORANGO';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x8C099ccBC50F2bF01A6Fefd5795714E3a36602c2, 'We can not exclude router.');
