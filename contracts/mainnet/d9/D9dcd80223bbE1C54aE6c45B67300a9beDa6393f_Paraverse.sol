...
contract Paraverse is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 8000000000 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'Paraverse';
    string private constant _symbol = 'PARA';

    uint256 private _taxFee = 400;
    uint256 private _burnFee = 200;
    uint public max_tx_size = 8000000000 ether;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x04d1Ec23fC01fc3E0856080b92ee1bB1E9d5157a, 'We can not exclude router.');
