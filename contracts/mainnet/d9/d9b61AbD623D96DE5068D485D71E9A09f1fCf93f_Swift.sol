...
contract Swift is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 Swifts
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("SWIFT", "SWIFT") {
        _mint(msg.sender, 1 ether); // mint 1 MARUNO Share for initial pools deployment
