...
contract Ape is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1200000 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'Ape Fantom';
    string private constant _symbol = 'APE';

    uint256 private _taxFee = 800;
    uint256 private _burnFee = 0;
    uint public max_tx_size = 1200000 ether;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xaD47E73403864B857Ae0278d53C5c9DdbFeEa062, 'We can not exclude router.');
