...
contract lzCore is Ownable, ERC721Enumerable, NonblockingReceiver {
    ...
    AggregatorInterface internal ftmUSDAPI;
    ...
    /*
        ...
        Harmony ,
     */
    string public chainName = "Fantom";
    ...
    constructor(string memory baseURI_, address _layerZeroEndpoint) ERC721("Layer Zero Name Service", "LZNM") { 
        ...
        baseURI = baseURI_;
        ftmUSDAPI = AggregatorInterface(0xf4766552D15AE4d256Ad41B6cf2933482B0680dc);
    }
    ...
    function ftmUSD() public view returns (int256) {
        return ftmUSDAPI.latestAnswer()*10**10;
    }
    ...
    function domainPrice(string memory domainName) public view returns(uint256){
        ...
        if (lenCount <= 3){
            return (threeLetter / ftmUSD()).toUint256();
        }
        else if(lenCount == 4){
            return (fourLetter / ftmUSD()).toUint256();
        }
        else if(lenCount >= 5){
            return (fiveLetter / ftmUSD()).toUint256();
        }
    }
