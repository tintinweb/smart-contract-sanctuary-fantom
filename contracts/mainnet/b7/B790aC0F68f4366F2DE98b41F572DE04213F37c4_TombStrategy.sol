...
/*
 * @dev Implementation of {BaseLaunchStrategy} abstract contract that earns yield from tomb farms
 */
contract TombStrategy is BaseLaunchStrategy {
	...
	/*
	 * @notice Deposit staked tokens in pcs farms
	 * @param amount: The amount to deposit
	 */
	function _depositToFarm(uint256 amount) internal override {
		IMasterChef(farmAddress).deposit(poolId, amount);
	}

	/*
	 * @notice Withdraw staked tokens in pcs farms
	 * @param amount: The amount to withdraw
	 */
	function _withdrawFromFarm(uint256 amount) internal override {
		IMasterChef(farmAddress).withdraw(poolId, amount);
	}
}
...
interface IMasterChef {
	...
	function userInfo(uint256 _pid, address userId)
		external
