...
contract ACE is ERC20Burnable, Operator {
    using SafeMath8 for uint8;
    using SafeMath for uint256;

    // Initial distribution for Liquidity
    uint256 public constant INITIAL_LAUNCH_DISTRIBUTION = 50000 ether;
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("ACE", "ACE") {
