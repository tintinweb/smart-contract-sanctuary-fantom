...
contract DevFundPae is Ownable, IDistributor {
  ...
  constructor(IERC20 _pae, address[] memory accounts, uint256[] memory points) public {
    pae = _pae;
  ...
  function distribute() override external {
    require(!failDistribute, "fail");
  }

  function setFail(bool _fail) external onlyOwner {
    failDistribute = _fail;
  }
