...
contract StrategyOxdVolatileWftmMultiLp is StrategyOxdFarmLPBase {
    // Token addresses
    address public wftm_multi_lp = 0x94bE7e51efE2A0C06c2281b6b385FCD12C84d6F9;
    address public multi = 0x9Fb9a33956351cf4fa040f65A13b835A3C8764E3;
    ...
    {
        swapRoutes[multi].push(route(wftm, multi, false));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategyOxdVolatileWftmMultiLp";
    }
}
