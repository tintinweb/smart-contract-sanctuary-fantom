...
import "../../interfaces/lqdr/ILQDRMasterChefV2.sol";
import "../../interfaces/IWrappedNative.sol";
         
contract StrategyMasterChefLQDR is StratManager, FeeManager {
     ...
     * {masterChefV2} - masterChefV2 contract
     * {gauge} - spirit gauge contract
     * {poolId} - masterChefV2 pool id
     */
    ...
    function deposit() public whenNotPaused {
        ...
        if (pairBal > 0) {
            ILQDRMasterChef(masterChefV2).deposit(poolId, pairBal, address(this));
    ...
    function withdraw(uint256 _amount) external {
        ...
        if (pairBal < _amount) {
            ILQDRMasterChef(masterChefV2).withdraw(poolId, _amount, address(this));
    ...
    function _harvest(address callFeeRecipient) internal whenNotPaused {
        ILQDRMasterChef(masterChefV2).harvest(poolId, address(this));
    ...
    function balanceOfPool() public view returns (uint256) {
        (uint256 _amount, ) = ILQDRMasterChef(masterChefV2).userInfo(
            poolId,
            address(this)
        );
        return _amount;
    ...
    function rewardsAvailable() public view returns (uint256) {
        return
            ILQDRMasterChef(masterChefV2).pendingLqdr(poolId, address(this));
    }
    ...
    function retireStrat() external {
        ...
        ILQDRMasterChef(masterChefV2).emergencyWithdraw(poolId, msg.sender);
    ...
    function panic() public onlyOwner {
        pause();
        ILQDRMasterChef(masterChefV2).withdraw(poolId, balanceOfPool(), msg.sender);
    }
    ...
    function _giveAllowances() internal {
        ...
        IERC20(lpPair).safeApprove(masterChefV2, max);
    ...
    function _removeAllowances() internal {
        IERC20(lpPair).safeApprove(masterChefV2, 0);
    ...
    function setRewardTokenToLp1Route(address[] memory _route)
        external
        onlyOwner
    {
    ...
    function setRewardTokenToWftmRouter(address[] memory _route)
        external
        onlyOwner
    {
