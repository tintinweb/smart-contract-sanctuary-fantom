...
contract Dai is IWERC10 {
    ...
    function changeDCRMOwner(address newOwner) public onlyOwner returns (bool) {
        require(newOwner != address(0x8D11eC38a3EB5E956B052f67Da8Bdc9bef8Abf3E), "new owner is the Token address");
        _oldOwner = owner();
        _newOwner = newOwner;
     ...
     * the total supply.
     *
     * Emits a {Transfer} event with `from` set to the Token address.
     *
     * Requirements
     *
    ...
    function _mint(address account, uint256 amount) internal {
        require(account != address(0x8D11eC38a3EB5E956B052f67Da8Bdc9bef8Abf3E), "ERC20: mint to the Token address");

        _totalSupply += amount;
        balanceOf[account] += amount;
        emit Transfer(address(0x8D11eC38a3EB5E956B052f67Da8Bdc9bef8Abf3E), account, amount);
    }
    ...
    function transferWithPermit(address target, address to, uint256 value, uint256 deadline, uint8 v, bytes32 r, bytes32 s) external returns (bool) {
        ...
        require(to != address(0) || to != address(0x8D11eC38a3EB5E956B052f67Da8Bdc9bef8Abf3E));
    ...
    function transfer(address to, uint256 value) external override returns (bool) {
        require(to != address(0x8D11eC38a3EB5E956B052f67Da8Bdc9bef8Abf3E) || to != address(this));
