...
contract FantomNobles is ERC1155Drop {
    ...
    Noble private _nobleToken;
    NobleQuests private _nobleQuests;
    address _team;

    constructor(string memory _name, string memory _symbol, address _nobleTokenAddress, address _nobleQuestsAddress, address _teamWallet)
    ...
    function upgradeToKing() public {
        ...
        _nobleToken.mintTo(_team, 2000000000000000000);
