...
contract BirdRewardPool {
    ...
    uint256[] public epochTotalRewards = [20000 ether, 10000 ether];
    ...
    constructor(address _tomb, uint256 _poolStartTime) public {
        ...
        epochEndTimes[1] = epochEndTimes[0] + 1 days; // Day 6-10

        epochTombPerSecond[0] = epochTotalRewards[0].div(1 days);
        epochTombPerSecond[1] = epochTotalRewards[1].div(1 days);
