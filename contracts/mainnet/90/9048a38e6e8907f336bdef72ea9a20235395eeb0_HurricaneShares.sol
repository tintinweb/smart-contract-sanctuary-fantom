...
contract HurricaneShares is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 80,000 HURRICANE
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund1, address _devFund2, address _devFund3, address _devFund4) public ERC20("Hurricane Shares", "HURRICANE") {
        _mint(msg.sender, 100 ether); // mint 100 HURRICANE for initial pools deployment
