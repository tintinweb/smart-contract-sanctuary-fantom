...
contract TheEndlessFactoryNFT is ERC721Presets {
    ...
    event RequestNewRandomCharacter(address indexed userAddress, uint256 nftID);
    ...
    constructor() ERC721("The Endless Factory NFT", "TheEndlessFactoryNFT")
    {   
    ...
    function requestNewRandomCharacter(
        ...
        uint256 strength  = randomNumber(_userAddress, newId);
        uint256 agility  = randomNumber(_userAddress, newId);
        uint256 endurance  = randomNumber(_userAddress, newId);
        uint256 intelligence  = randomNumber(_userAddress, newId);
        uint256 magic  = randomNumber(_userAddress, newId);
        uint256 wisdom  = randomNumber(_userAddress, newId);
        ...
        emit RequestNewRandomCharacter(_userAddress, newId);
    }
    ...
    function setExperience(uint256 _tokenId, uint256 _newExperience) onlyRole(OPERATOR_ROLE) external {
        characters[_tokenId].experience = _newExperience;
    ...
    //     characters[_tokenId].power = _power;
    ...
    function setGeneration(uint256 _tokenId, uint256 _generation) onlyRole(OPERATOR_ROLE) external {
        characters[_tokenId].generation = _generation;
    ...
    //     characters[_tokenId].mergeCount = _newCount;
    ...
    //     characters[_tokenId].power = _values[0];
    //     characters[_tokenId].experience = _values[1];
    //     characters[_tokenId].generation = _values[2];
    //     characters[_tokenId].mergeCount = _values[3];
