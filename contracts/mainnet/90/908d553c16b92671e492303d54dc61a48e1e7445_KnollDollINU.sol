...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 EP = IERC20(0xf16e81dce15B08F326220742020379B855B87DF9);
...
contract KnollDollINU is IERC20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xf16e81dce15B08F326220742020379B855B87DF9;
    address public WETH = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Knoll Doll INU";
    string constant _symbol = "Knoll";
