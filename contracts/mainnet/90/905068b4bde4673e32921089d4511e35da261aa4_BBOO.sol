...
contract BBOO is BBOODeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private BBOOTeam;
    address private CharityBBOO;
    ...
    string public override name = "BABY BOO";
    string public override symbol = "BBOO";
    ...
    constructor(uint totalSupplyValue, address BBOOTeamAddress, address CharityBBOOAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        BBOOTeam = BBOOTeamAddress;
        CharityBBOO = CharityBBOOAddress;
       
        // split the tokens according to agreed upon percentages
        balances[BBOOTeam] =  totalSupply * 4 / 100;
        balances[CharityBBOO] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's BBOOTeam pot
