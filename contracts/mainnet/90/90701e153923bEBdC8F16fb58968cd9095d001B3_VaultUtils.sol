...
contract VaultUtils is IVaultUtils, Governable {
    ...
    function getBuyUsdbFeeBasisPoints(address _token, uint256 _usdbAmount) public override view returns (uint256) {
        return getFeeBasisPoints(_token, _usdbAmount, vault.mintBurnFeeBasisPoints(), vault.taxBasisPoints(), true);
    }

    function getSellUsdbFeeBasisPoints(address _token, uint256 _usdbAmount) public override view returns (uint256) {
        return getFeeBasisPoints(_token, _usdbAmount, vault.mintBurnFeeBasisPoints(), vault.taxBasisPoints(), false);
    }

    function getSwapFeeBasisPoints(address _tokenIn, address _tokenOut, uint256 _usdbAmount) public override view returns (uint256) {
