...
contract CHERRY is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 150,000, 37500 per protocol
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 37500 ether;
    uint256 public constant DAO_FUND_POOL_ALLOCATION = 7500 ether;
    ...
    constructor(address _daoFund, address _devFund) public 
    ERC20("Cherry", "CHERRY") {
    ...
    /**
     * @dev Claim pending rewards to dao and dev fund
     */
     ...
     */
    function distributeReward(uint256 _epochStartTime, address _sharesRewardPool) external onlyOperator {
        require(!rewardPoolDistributed, "only can distribute once");
        require(_sharesRewardPool != address(0), "!_sharesRewardPool");
        ...
        _mint(_sharesRewardPool, FARMING_POOL_REWARD_ALLOCATION);
    }
