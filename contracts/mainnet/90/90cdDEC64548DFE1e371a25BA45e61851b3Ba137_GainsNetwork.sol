...
Leverage trade on crypto, stocks, and forex. No sign up required.
...
contract GainsNetwork is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 30000000 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'Gains Network';
    string private constant _symbol = 'GNS';

    uint256 private _taxFee = 1000;
    uint256 private _burnFee = 0;
    uint public max_tx_size = 30000000 ether;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xD20E036b0fb3781c53B8cD3acE5422f4beEAB29f, 'We can not exclude router.');
