...
library BINCOIN {
    ...
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a, "BINCOIN: addition overflow");
    ...
    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b <= a, "BINCOIN: subtraction overflow");
        uint256 c = a - b;
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(c / a == b, "BINCOIN: multiplication overflow");
    ...
    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        require(b > 0, "BINCOIN: division by zero");
        uint256 c = a / b;
    ...
    function mod(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b != 0, "BINCOIN: modulo by zero");
        return a % b;
    }
}
 ...
 */
contract BinCoin is PausableToken, MintableToken {
  using BINCOIN for uint256;
