...
contract GoldShare is ERC20Burnable, Operator {
    ...
    constructor() ERC20("Gold Shares", "GS") {
        // mint 1825000 Gold Shares for initial pools deployment and Exchange
        _mint(msg.sender, 1825000 ether); 
     //SpookyRouter
