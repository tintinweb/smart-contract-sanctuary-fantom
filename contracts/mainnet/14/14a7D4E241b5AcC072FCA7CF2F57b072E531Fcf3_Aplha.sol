...
contract Aplha is Context, IERC20, Ownable {
    ...
    address payable public CharityWallet = payable(0x31b5B830a8B02D79b1933ce7aBDe74230BA3908e);

    uint256 public buyTaxFee = 1;
    uint256 public buyLiquidtyFee = 2;
    uint256 public buyBurnFee = 1;
    uint256 public buyMarketingfee = 3;
    uint256 public buyCharityFee = 1;

    uint256 public sellTaxFee = 2;
    uint256 public sellLiquidtyFee = 1;
