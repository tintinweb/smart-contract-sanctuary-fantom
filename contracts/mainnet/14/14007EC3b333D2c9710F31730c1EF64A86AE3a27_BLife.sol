...
contract BLife is ERC20Burnable, Operator {
    ...
    address public boilerRoomAddress; //Burner and recompunder
     ...
     */
    constructor(address _boilerRoomAddress) ERC20("ZALUPA", "ZALUPA") {
    ...
    function setMarketLpPairs(address pair, bool value) public onlyOwner {
        marketLpPairs[pair] = value;
    }
