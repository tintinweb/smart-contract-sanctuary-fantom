...
contract REShare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 60,000 REshare
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("REshare", "REShare") {
        _mint(msg.sender, 0.5 ether); // mint 1 Rshare for initial pools deployment
