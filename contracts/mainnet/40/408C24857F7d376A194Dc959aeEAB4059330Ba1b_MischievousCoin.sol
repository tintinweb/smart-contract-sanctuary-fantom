...
contract MischievousCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Mischievous Coin';
    string private constant _symbol = 'MISC';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x225eD13C64e0C4AfE56129033Ac079c425A3EA88, 'We can not exclude router.');
