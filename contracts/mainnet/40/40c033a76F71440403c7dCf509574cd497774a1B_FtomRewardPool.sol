...
contract FtomRewardPool {
    ...
    uint256[] public epochTotalRewards = [500 ether, 500 ether];
    ...
    constructor(address _tomb, uint256 _poolStartTime) public {
        ...
        epochEndTimes[0] = poolStartTime + 30 minutes; // 4 days; // Day 2-5
        epochEndTimes[1] = epochEndTimes[0] + 30 minutes; //5 days; // Day 6-10

        epochTombPerSecond[0] = epochTotalRewards[0].div(30 minutes); //4 days);
        epochTombPerSecond[1] = epochTotalRewards[1].div(30 minutes); //5 days);
