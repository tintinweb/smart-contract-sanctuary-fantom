...
contract BShareP is IBEP20 {
    ...
    string constant _name = "BSharePrint";
    string constant _symbol = "bsharep";
    ...
    constructor (address distributorAddress) {
        ...
        distributor = BShareDistributor(distributorAddress);
