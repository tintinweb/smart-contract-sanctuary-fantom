...
contract MARIN is Context, IERC20, Ownable {
    ...
    string private constant _name = 'MARIN DAO';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xDEaD6FEcd1F81faC1B9B540d7F51D9a1a7f6C542, 'We can not exclude router.');
