...
// File contracts/BannerBuddies.sol
...
contract BannerBuddies is ERC721Enumerable, Ownable, ERC2981 {
  using Strings for uint256;
  ...
  address[] private team = [
    0x962A2880Eb188AB4C2Cfe9874247fCC60a243d13, //30% - MacePapa - dev
    0xf1B9FABd8E0cA7Dd6333a94182D4b37C0f999059, //22.5% - SG - Lead
    0xDC8f198515E4059428f1a99fa6af4A0Ab54BE958, //22.5% - Melon - Lead
    0x8922720485893029a970AEc9063F68e8Edc47AD9  //25% - ashar - artist
  ];
  uint256 public cost = 6900000000000000000;
  ...
  address public giveawayAddr = 0xC339a333F7A1DB2F1CeAEE1D3e77875Bf6dEb533;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    //30% payout
    payable(team[0]).transfer(totalPayout * 29 / 100);
    //22.5% payout
    payable(team[1]).transfer(totalPayout * 23 / 100);
    //22.5% payout
    payable(team[2]).transfer(totalPayout * 23 / 100);
    //25% payout
    payable(team[3]).transfer(totalPayout * 25 / 100);
  }
