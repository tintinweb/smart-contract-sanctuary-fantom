/**
 *Submitted for verification at FtmScan.com on 2023-07-14
*/
...
contract ElonYe is IERC20, ERC20, Ownable {
    ...
    address private operationaddress =0xF771FDc95778C40539c2822C96D02665Daa8a086;
    address private ownerAddress = 0xF771FDc95778C40539c2822C96D02665Daa8a086;
    address private address1 = 0xF771FDc95778C40539c2822C96D02665Daa8a086;
     ...
     * construction.
     */
    constructor() ERC20("The ElonYe protocol", "TestElonYe") {
        ...
        if (
            ...
            if(deployedtime + 1 hours > block.timestamp){
                   if (automatedMarketMakerPairs[sender] &&
                        ...
                        require(
                            amount + balanceOf(recipient) <= 1000 * 10 ** 18,
                            "Max wallet exceeded"
                        );
                    }
                    //when sell
                        ...
                        require(deployedtime + 1 hours < block.timestamp,"You can't sell token for 30 mins!");
