...
contract Masonry is ShareWrapper, ContractGuard {
    ...
    function getDracoPrice() external view returns (uint256) {
        return treasury.getDracoPrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            draco.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        draco.safeTransferFrom(msg.sender, address(this), amount);
