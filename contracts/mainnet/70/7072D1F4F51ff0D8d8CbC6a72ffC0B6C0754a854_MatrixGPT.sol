...
contract MatrixGPT is Context, IERC20, Ownable {
    ...
    string private constant _name = 'MatrixGPT';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x455dd6691b09068C9AE2d40452aBCC305934a7C1, 'We can not exclude router.');
