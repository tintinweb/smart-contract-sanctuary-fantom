...
/**
 * @title AutoCompound MasterChef with curve stake token
 * @notice strategy for auto-compounding on pools using a standard MasterChef contract
 * @author YieldWolf
 */
contract ACMasterChefCurve is AutoCompoundStrategy {
    using SafeERC20 for IERC20;

    ICurveLiquidityPool public liquidityPool = ICurveLiquidityPool(0x0fa949783947Bf6c1b171DB13AEACBB488845B3f);
    IERC20 public liquidityReceipt = IERC20(0xD02a30d33153877BC20e5721ee53DeDEE0422B2F);
    IERC20 public liquidityToken = IERC20(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75);
    uint256 public liquidityIndex = 1;
    ...
    function _totalStaked() internal view override returns (uint256 amount) {
     ...
     function earn(address _bountyHunter) external override onlyOwner returns (uint256 bountyReward) {
        ...
        liquidityPool.add_liquidity(amounts, 0, true);
    ...
    function setLiquidityInfo(IERC20 _liquidityToken, uint256 _liquidityIndex) external onlyOperator {
