...
import "./SpookyV2VaultToken.sol";
import "./interfaces/IMasterChef.sol";
import "./interfaces/ISpookyV2VaultTokenFactory.sol";
import "./interfaces/IUniswapV2Pair.sol";
import "./interfaces/IUniswapV2Router01.sol";

contract SpookyV2VaultTokenFactory is Ownable, ISpookyV2VaultTokenFactory {
        ...
        returns (address vaultToken)
    {
        ...
        bytes memory bytecode = type(SpookyV2VaultToken).creationCode;
        assembly {
            vaultToken := create2(0, add(bytecode, 32), mload(bytecode), pid)
        }
        SpookyV2VaultToken(vaultToken)._initialize(
            optiSwap,
            rewarderHelper,
...
import "./interfaces/IMasterChef.sol";
import "./interfaces/ISpookyV2VaultToken.sol";
...
contract SpookyV2VaultToken is ISpookyV2VaultToken, IUniswapV2Pair, PoolToken {
...
interface ISpookyV2VaultTokenFactory {
    event VaultTokenCreated(
        uint256 indexed pid,
        address vaultToken,
        uint256 vaultTokenIndex
