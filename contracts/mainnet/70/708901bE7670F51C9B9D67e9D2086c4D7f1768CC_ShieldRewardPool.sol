...
contract ShieldRewardPool {
    ...
    struct PoolInfo {
        ...
        uint256 accShieldPerShare; // Accumulated METEORs per share, times 1e18. See below.
    ...
    // Safe shield transfer function, just in case if rounding error causes pool to not have enough METEORs.
