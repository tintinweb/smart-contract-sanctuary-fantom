...
//    bool hasRandomWord = world.hasRandomWord(streakStart);
    bool hasRandomWordLastWeek = world.lastRandomWordsUpdatedTime() >= streakStart;
    console.log(world.lastRandomWordsUpdatedTime(), streakStart);
    if (hasRandomWordLastWeek) {
      ...
      console.log("No random word last week");
    }
  }
