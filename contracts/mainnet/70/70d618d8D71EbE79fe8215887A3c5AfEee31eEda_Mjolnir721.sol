...
contract ERC721 is MjolnirRBAC, ERC165, IERC721, IERC721Metadata {
...
contract Mjolnir721 is ERC721Enumerable {
  using Strings for uint256;
  ...
  function mint(address value, uint256 _mintAmount) public onlyThor{
