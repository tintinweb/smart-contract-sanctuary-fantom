...
// File src/strategies/fantom/solidly/strategy-solidex-stable-usdc-mim-lp.sol

// SPDX-License-Identifier: MIT
pragma solidity ^0.8.11;


contract StrategySolidexStableUsdcMimLp is StrategySolidexFarmLPBase {
    // Token addresses
    ...
    function getName() external pure override returns (string memory) {
        return "StrategySolidexStableUsdcMimLp";
    }
}