...
contract FloweyCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = 'FloweyCoin';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xE222898C093B046b07b7220eB7C2906dbA3dcd9D, 'We can not exclude router.');
