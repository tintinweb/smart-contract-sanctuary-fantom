...
/*
ஜ۩۞۩ஜ M̿͟͞a̿͟͞g̿͟͞i̿͟͞c̿͟͞ Special ஜ۩۞۩ஜ
*/
...
contract FAMSpecial is ERC721, Ownable {
    ...
    constructor() ERC721( "FAM Special", "FAMS" ) {}
        ...
        function mint(string memory tokenURI_) external onlyOwner() {
            require(_tokenIds.current()<maxSupply, "Max NFTs already minted");
