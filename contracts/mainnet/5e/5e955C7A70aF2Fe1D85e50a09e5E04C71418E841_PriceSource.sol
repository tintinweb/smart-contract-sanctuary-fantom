...
contract PriceSource is IPriceSource, AccessControl {
    ...
    event SetRoundData(uint80 roundId,
        int256 answer,
        uint256 startedAt,
        uint256 updatedAt,
    ...
    constructor() {
        ...
        _setupRole(BROADCASTER, msg.sender);
    }
    ...
    onlyRole(BROADCASTER)
    {
        ...
        emit SetRoundData(roundId, answer, startedAt, updatedAt, answeredInRound);
    }
