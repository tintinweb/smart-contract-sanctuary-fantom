...
contract Betacoin is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Betacoin";
    ...
    uint256 public _maxTaxSwap=476100000 * 10**_decimals;
    ...
    constructor () {
        ...
        _taxWallet = payable(0x9A71b3D86c982b68fE5c0df3c78F60fa7a8Ed33c);
