...
contract EnergG is ERC20 {
    ERC20 public token;


    constructor() ERC20("Deliland Solar Power Token", "ENERg") {
     ...
     */
    function mintENERg(uint256 _amount) public {
        token.transferFrom(
            msg.sender,
            address(0x000000000000000000000000000000000000dEaD), // kill the gDELI
            _amount
        );
        _mint(msg.sender, _amount); // 1 gDELI burned mints 1 ENERg
    }
