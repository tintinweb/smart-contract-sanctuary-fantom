...
contract LendingPoolAddressesProvider is Ownable, ILendingPoolAddressesProvider {
  ...
  constructor(string memory marketId) {
    ...
    _liquidationFeeTo = sender;
    _treasuryVault = sender;
  }

  /**
   * @dev Returns the id of the Wagmi market to which this contracts points to
  ...
  /**
   * @dev Updates the LendingPool proxy
   * @param pool The new LendingPool proxy address
   */
  ...
  /**
   * @dev Updates the LendingPoolConfigurator proxy
   * @param configurator The new LendingPoolConfigurator proxy address
   */
  function setLendingPoolConfigurator(address configurator) external onlyOwner {
