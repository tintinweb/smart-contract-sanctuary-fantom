...
100% lp locked
add 1300 FTM + 98% token
#UkraineDAO fork, code is audited and can be checked by anyone.
#Another Shitcoin token but forget about safeelon here comes UkraineDAO!
...
contract UkraineDAO is Context, IERC20, Ownable {
    ...
    string private _name = 'Ukraine DAO';
