...
contract FdogeRewardPool {
    ...
    uint256[] public epochTotalRewards = [600 ether, 400 ether];
    ...
    constructor(address _tomb, uint256 _poolStartTime) public {
        ...
        epochEndTimes[0] = poolStartTime + 30 minutes; 
        epochEndTimes[1] = epochEndTimes[0] + 30 minutes;

        epochTombPerSecond[0] = epochTotalRewards[0].div(30 minutes); 
        epochTombPerSecond[1] = epochTotalRewards[1].div(30 minutes); 
