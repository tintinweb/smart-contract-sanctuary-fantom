...
import "./SwitchFantom.sol";
import "../interfaces/IStargateReceiver.sol";
import "../lib/DataTypes.sol";

contract SwitchStargateReceiverFantom is SwitchFantom, IStargateReceiver {
    ...
    ) SwitchFantom(_switchViewAddress, _switchEventAddress, _paraswapProxy, _augustusSwapper)
        public
    {
...
import "./SwitchRootFantom.sol";
import "../interfaces/ISwitchEvent.sol";
import "@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol";
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";

contract SwitchFantom is SwitchRootFantom {
...
abstract contract SwitchRootFantom is ISwitchView {
    ...
    IWETH constant internal weth = IWETH(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83);
    IERC20 constant internal realWeth = IERC20(0x74b23882a30290451A17c44f4F05243b6b58C76d);

    IUniswapFactory[DEXES_COUNT] public factories = [
        IUniswapFactory(0x152eE697f2E276fA89E96742e9bB9aB1F2E61bE3), // spookyswap,
        IUniswapFactory(0xc35DADB65012eC5796536bD9864eD8773aBc74C4), // sushiswap,
        IUniswapFactory(0xEF45d134b73241eDa7703fa787148D9C9F4950b0) // spiritswap,
    ];
