...
// File: contracts/BIFI/strategies/Common/StrategyCommonRewardPool.sol
...
contract StrategyCommonRewardPool is StratFeeManager, GasFeeThrottler {
    ...
    function chargeFees(address callFeeRecipient) internal {
        ...
        uint256 nativeBal = IERC20(output).balanceOf(address(this)) * fees.total / DIVISOR;
        if (output != native) {
            IUniswapRouterETH(unirouter).swapExactTokensForTokens(nativeBal, 0, outputToNativeRoute, address(this), block.timestamp);
