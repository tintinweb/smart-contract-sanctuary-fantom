...
contract StrategySolidexStableUsdcDaiLp is StrategySolidexFarmLPBase {
    // Token addresses
    address public usdc_dai_lp = 0xC0240Ee4405f11EFb87A00B432A8be7b7Afc97CC;
        ...
        )
    {
        ...
        swapRoutes[dai].push(route(usdc, dai, true));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategySolidexStableUsdcDaiLp";
    }
}
