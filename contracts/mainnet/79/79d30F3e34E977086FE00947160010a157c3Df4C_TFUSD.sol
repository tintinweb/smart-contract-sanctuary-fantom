...
contract TFUSD is IERC20Metadata, Ownable {
  ...
  /******************                    PEGGING                    ****************************/
  /*********************************************************************************************/
  function addLiquidity(uint256 pegAmount) public view returns(uint256) {
  ...
  function addLiquidity2(uint256 tfusdAmount, uint256 pegAmount) public {
  ...
  function addLiquidity3(uint256 tfusdAmount, uint256 pegAmount) public {
    IERC20(peggedToken).safeTransferFrom(msg.sender, address(this), pegAmount);
  }

  function addLiquidity4(uint256 tfusdAmount, uint256 pegAmount) public {
