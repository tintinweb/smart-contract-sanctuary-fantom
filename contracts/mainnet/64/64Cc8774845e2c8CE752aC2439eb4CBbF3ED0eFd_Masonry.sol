...
contract Masonry is TombWrapper, ContractGuard {
    ...
    function governanceRecoverUnsupported(
        ...
        require(address(_token) != address(_chili), "OZONE");
        require(address(_token) != address(_cshare), "OSHARE");
