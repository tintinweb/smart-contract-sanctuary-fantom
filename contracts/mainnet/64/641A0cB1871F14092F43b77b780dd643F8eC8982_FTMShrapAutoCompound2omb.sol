 ...
 */
contract FTMShrapAutoCompound2omb is IStrategy, Ownable, Pausable {
    ...
    address public uniRouter =
        address(0xb9799De71100e20aC1cdbCc63C69ddA2D0D81710);
    address public masterChef =
        address(0x650D853FA19b1A8a3908B85c9b7f9c10F732dFdE);
    uint8 public poolId;
    ...
    function anualReward() external view returns (uint256) {
        return
            IMasterChef(masterChef).shrapnelPerSecond().mul(3600).mul(24).mul(
                365
            );
    }
}
