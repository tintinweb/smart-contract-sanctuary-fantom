/**
 *Submitted for verification at FtmScan.com on 2023-01-16
*/
...
contract StakingRewards {
    ...
    constructor() {
        owner = msg.sender;
        stakingToken = IERC20(0x1E8e53b03684a8b21f3035456a195676F762f9EC);
        rewardsToken = IERC20(0xAD522217E64Ec347601015797Dd39050A2a69694);
        ...
        txCost = 10e18; // The amount of wei someone would have to pay to use a function, leave 0 if none.

        // If txCost > 0, the below has to be set, if not leave as 0x00...00

        treasury = 0xCf2BeeDeE13Be9A35cda503d21266840b7ED36AA; // where this contract should send the tokens it swaps.
        router = 0xAd362c30b2991a154651b05181FE6BED795a9792; // the DEX router this contract should use when swapping.
        ...
        path.push(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83); // First token
        path.push(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75); // Second Token
    }
