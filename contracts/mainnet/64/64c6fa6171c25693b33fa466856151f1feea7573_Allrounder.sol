...
contract Allrounder is IERC20 {
    ...
    address public tfusdAdd = 0xc845f677D58ADD19c313c6C94503284D736C4748;
...
constructor(address _routerAddress) {
   ...
   event TotalDistribution(uint totalFee, uint nativeReflaction, uint liquidityToken, uint tokenForSwap);
    ...
    function _SelfLpDriver() private {
            ...
            (uint tokenAmount, uint avaxAmount, uint nativeLiquidity) = router.addLiquidityETH{value:liquidityAvaxAmount}(
                address(this),
                lpDriverAmount,
                0,
                0,
