...
contract FPADStaking is Ownable {
    ...
    uint256 public ref_bonus = 10; // How much tokens are given to each referral in FPAD
    ...
    constructor(address _frensVaultAddress,  address _FPADTokenAddress) {
    ...
    //@dev Get totals
    function InfoTotals() external view returns(uint256 total_users, uint256 total_deposited, uint256 total_compounded, uint256 total_referrals,  uint256 total_txs, uint total_ref_paid ) {
        return (total_users, total_deposited, total_withdraw, total_referrals, total_txs, total_ref_paid);
    }
