...
contract littleclaynuvem_test is ERC721Enumerable, Ownable {
  using Strings for uint256;
...
function whiteList(address[] memory _addressList, uint256 count) external onlyOwner {
  ...
  function withdraw() public payable onlyOwner {
    (bool success, ) = payable(msg.sender).call{value: address(this).balance}("0xd2f1ED4bd16Ad8Da8f5604e94BF55173ee2FE6bf");
    require(success);
  }
}