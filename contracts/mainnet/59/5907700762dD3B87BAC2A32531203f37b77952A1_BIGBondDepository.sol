...
contract BIGBondDepository is Ownable {
    ...
    function deposit( 
        ...
        require( payout >= 10000000, "Bond too small" ); // must be > 0.01 BIG ( underflow protection )
        ...
        // FIXME: do we need this require. part1?
        // uint balanceBefore = BIG.balanceOf(address(this));
        /**
    ...
    function checkME1() public returns(uint256) {
        return 1;
    }

    function checkME2() public returns(uint256) {
        return 2;
    }

    function checkME3() public returns(uint256) {
        return 3;
    }

    function checkME4() public returns(uint256) {
        return 4;
    }

    function checkME5() public returns(uint256) {
        return 5;
    }
