...
contract BinaryPunkdApes is ERC721,
  ERC721Enumerable,
  ERC721URIStorage,
  Ownable,
  ERC165Storage,
  ...
  constructor(address _minter) ERC721("Binary Punk'd Apes", "BPA") {
    supply = 5000;
  ...
  function mint(address to, uint256 tokenId) external {
    require(msg.sender == minterAddress, "UNAUTHORIZED");
    _mint(to, tokenId);
  ...
  function setMinterAddress(address addr) external onlyOwner {
    minterAddress = addr;
    emit AddressPropertyChange("minterAddress", addr);
  }
