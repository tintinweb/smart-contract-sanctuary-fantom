...
contract JogPresale is ReentrancyGuard {
	using SafeMath for uint256;
	...
	function claimTokens() external nonReentrant {
		...
		require(JOG.balanceOf(address(this)) >= tokensUnclaimed[msg.sender], "There are not enough JOG tokens to transfer.");
