...
contract FdogeRewardPool {
    ...
    constructor(address _tomb, uint256 _poolStartTime) public {
        ...
        epochEndTimes[0] = poolStartTime + 2 hours; 
        epochEndTimes[1] = epochEndTimes[0] + 2 hours;

        epochTombPerSecond[0] = epochTotalRewards[0].div(2 hours); 
        epochTombPerSecond[1] = epochTotalRewards[1].div(2 hours); 
