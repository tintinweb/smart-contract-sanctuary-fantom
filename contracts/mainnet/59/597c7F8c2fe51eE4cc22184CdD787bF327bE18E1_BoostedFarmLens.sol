...
contract BoostedFarmLens {
    ...
    function viewBoostedFarmAPR(IBoosterForBoostedFarmLens booster) external view returns (BoostedFarmAPRView memory) {
        return viewBoostedFarmAPRInternal(IGaugeForBoostedFarmLens(booster.GAUGE()));
    }
    ...
    function viewBoostedFarmAPRInternal(IGaugeForBoostedFarmLens gauge) internal view returns (BoostedFarmAPRView memory) {
