...
import "./implementations/ForestImplementationPointer.sol";

contract LiquidityPoolManager is
    Ownable,
    OwnerRecovery,
    ForestImplementationPointer
{
    ...
    address[] public feeAddresses = [
        address(0x2f883B5A4e5aa96875D60b445ecD31a41A4cF204), // Treasury investments (40%)
        address(0x2f883B5A4e5aa96875D60b445ecD31a41A4cF204), // Dev (30%)
        address(0x2f883B5A4e5aa96875D60b445ecD31a41A4cF204) // Marketing (30%)
    ];
    ...
    constructor(
        ...
        changeForestImplementation(address(leftSide));
...
abstract contract ForestImplementationPointer is Ownable {
