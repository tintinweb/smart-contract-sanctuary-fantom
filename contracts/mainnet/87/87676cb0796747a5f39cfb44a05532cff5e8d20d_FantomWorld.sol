...
contract FantomWorld {
    ...
    address public id1=0x75cBB36Dd86D2E1A559a52b32E1913548764D44D;
    address public id2=0xA432B812411Aee0B1a784b00eD3bD0E588a1f91f;
    address public id3=0x369F23316a9FFa3c86d324253A0e786f61796E25;
    address public owner;
    address creatorWallet=0x3Bc09AE3110830C9cbaE6D3EC7957FB780558476;
    address public stakeWallet=0x3455Fe5F54111cbBe7564dc134fb23dD91a312b7;
    ...
    constructor() public {    
        owner=0xA9570735c2290f3055b4068836370BC1355F19D5;
        pooldirectCond[1]=10;
        pooldirectCond[2]=20;
        pooldirectCond[3]=30;
        pooldirectCond[4]=0;
        ...
        users[2].levelMatrix[1].currentReferrer = 1;
        users[3].levelMatrix[1].currentReferrer = 1;
        x2CurrentvId[1]=2;
        poolUsers[1].push(1);
        poolUsers[2].push(1);
        poolUsers[3].push(1);
    ...
    function _distributePoolIncome(uint8 _level) private {
        uint256 poolCount=0;
        for(uint256 i = 0; i < poolUsers[_level].length; i++){
    ...
    function usersLevelPool(uint _userid, uint8 level) public view returns(uint, uint[] memory) {
        return (users[_userid].levelMatrix[level].currentReferrer,
                users[_userid].levelMatrix[level].referrals);
    } 
