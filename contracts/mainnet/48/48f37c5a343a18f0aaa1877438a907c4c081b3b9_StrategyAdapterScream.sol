...
contract AlphaStrategyScream is AlphaStrategyBase {
    ...
    function lpBalance() public view override returns (uint256) {
        ...
        uint256 result = (multiplier / (10**(decimals)) - 100000);

        return (result > 0 ? result : 0) / (10**4);
    }

    // 10000076500 = 9034508151 * 1.10687558878965
    // 10000076529 06301714943715  1. * 10^15
    // 1000001

    // 62318923500   = 5630159346 * 1.10687672739040
    // 6231792351
    // 523189
