...
contract TowDogeOffice is Operator {
    using SafeMath for uint256;

    address public tomb = address(0xDD057bCcB72982753266A903Feda154608e54468);
    ...
    function setAddr(address _tomb, address _wftm, address _router) public onlyOwner {
        tomb = _tomb;
        wftm = _wftm;
        uniRouter = _router;
    }

    function setToken(address _tomb) public onlyOperator {
        tomb = _tomb;
    }
