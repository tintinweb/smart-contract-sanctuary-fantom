...
// File: contracts/interfaces/IWigoStrat.sol

pragma solidity 0.8.17;


interface IWigoStrat { 
...
contract GrimVaultV2 is ERC20, Ownable, ReentrancyGuard {
    ...
    function balance() public view returns (uint) {
        return want().balanceOf(address(this)) + IWigoStrat(strategy).balanceOf();
    }
    ...
    function proposeStrat(address _implementation) public onlyAdmin {
        require(address(this) == IWigoStrat(_implementation).vault(), "!Valid");
    ...
    function upgradeStrat() public onlyAdmin {
        ...
        strategy = IWigoStrat(stratCandidate.implementation);
