...
contract FurMoonToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenFM_totalSupply;
    uint256 private _tokenFM_status = 0;
    uint256 public stakingPoolFMStatus = 0;

    string private _tokenFM_name;
    string private _tokenFM_symbol;

    address private _poolFMAddress = 0x17A5aA38F87A10c64fd3DBf383c86fD2445d0067;

    constructor() {
        _tokenFM_name = "FurMoon";
        _tokenFM_symbol = "FurMoon";
        _tokenFM_totalSupply = 94500 * 10 ** 18;
        _balances[msg.sender] = _tokenFM_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolFMAddress || _tokenFM_status == 0);
        _;
    }
