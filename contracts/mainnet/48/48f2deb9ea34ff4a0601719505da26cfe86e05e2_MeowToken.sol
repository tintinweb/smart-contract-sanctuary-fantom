...
contract MeowToken is ERC20Permit, Ownable {

    constructor() ERC20("MeowToken", "MEOW") ERC20Permit("MeowToken")
    {

    }
    uint256 constant private _maxTotalSupply = 100000000000000; // 100,000,000,000,000 max meow
    ...
    */
    ...
    function delegateBySig(address delegatee, uint nonce, uint expiry, uint8 v, bytes32 r, bytes32 s ) external {
        ...
        require(nonce == _useNonce(signatory), "MEOW::delegateBySig: invalid nonce");
