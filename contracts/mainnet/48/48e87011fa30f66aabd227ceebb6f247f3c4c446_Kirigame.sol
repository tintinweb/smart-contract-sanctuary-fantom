...
contract Kirigame is ERC20Burnable, Operator {
    using SafeMath for uint256;

    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 59500 ether;
    uint256 public constant INIT_TREASURY_FUND_POOL_ALLOCATION = 7000 ether; // Development & Marketing Funds
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("KIRIGAMI", "KIRIGAMI") {
        _mint(_communityFund, INIT_TREASURY_FUND_POOL_ALLOCATION);
        _mint(msg.sender, 7 ether); // mint 7 KIRIGAMI for initial liquidity
