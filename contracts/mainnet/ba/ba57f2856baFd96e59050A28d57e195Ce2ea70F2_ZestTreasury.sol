...
/*  ZestTreasury.sol ============================================
    The contract is to store the reserve of Zest Protocol
...
==================================================================== */
contract ZestTreasury is Ownable {
    ...
    /// @notice Return ERC-20 balance of ZestTreasury
    /// @param _token Address of the ERC-20 token
    /// @return Balance of the ZestTreasury
    ...
    function requestFund(address _token, uint256 _amount) external {
        require(
            ...
            "ZestTreasury::requestFund: Only strategies can request fund"
        );
        require(
            _amount <= balanceOf(_token),
            "ZestTreasury::requestFund: Request more fund than balance"
        );
    ...
    function addStrategy(address _strategy) external onlyOwner {
        require(_strategy != address(0), "ZestTreasury::addStrategy: invalid address");
        require(!strategies[_strategy], "ZestTreasury::addStrategy: strategy was previously added");
    ...
    function removeStrategy(address _strategy) external onlyOwner {
        require(strategies[_strategy], "ZestTreasury::removeStrategy: strategy not found");
