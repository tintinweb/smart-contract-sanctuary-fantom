...
contract BarIco is Ownable {
    ...
    uint256 private _startDate = 1681290000; // When to start ICO 
    uint256 private _endDate = 1682154000; // When to end ICO 
    uint256 private _claimDate = 1682155800; // When to claim ICO 
