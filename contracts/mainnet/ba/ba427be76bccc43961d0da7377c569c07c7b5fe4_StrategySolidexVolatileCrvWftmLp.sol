...
// File src/strategies/fantom/solidly/strategy-solidex-volatile-crv-wftm-lp.sol
// License-Identifier: MIT
pragma solidity ^0.8.11;


contract StrategySolidexVolatileCrvWftmLp is StrategySolidexFarmLPBase {
    // Token addresses
    ...
    function getName() external pure override returns (string memory) {
        return "StrategySolidexVolatileCrvWftmLp";
    }
}