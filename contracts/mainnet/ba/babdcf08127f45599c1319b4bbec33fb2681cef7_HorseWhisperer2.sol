...
contract HorseWhisperer2 is Epoch {
    ...
    function update() external checkEpoch {
        ...
        price0CumulativeLast = price0CumulativeLast > 100000000 ? price0CumulativeLast: price0CumulativeLast.mul(1e12);
        price1CumulativeLast = price1CumulativeLast > 100000000 ? price1CumulativeLast: price1CumulativeLast.mul(1e12);
        
        price0Cumulative = price0Cumulative > 100000000 ? price0Cumulative: price0Cumulative.mul(1e12);
        price1Cumulative = price1Cumulative > 100000000 ? price1Cumulative: price1Cumulative.mul(1e12);
