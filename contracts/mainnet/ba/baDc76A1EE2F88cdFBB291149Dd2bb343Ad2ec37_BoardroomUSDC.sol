...
contract BoardroomUSDC is ContractGuard {
    ...
    function getC7usdcPrice() external view returns (uint256) {
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            C7usdc.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        C7usdc.safeTransferFrom(msg.sender, address(this), amount);
