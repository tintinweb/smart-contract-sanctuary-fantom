...
contract HauntedCemetery {
    ...
    uint private startTime = 1656684000; //1667311200; // Fri Oct 28 2022 14:00:00 GMT+0000
    ...
    function addCrystals(address ref) external payable {
        ...
        uint256 crystals = msg.value / 1e18; 
