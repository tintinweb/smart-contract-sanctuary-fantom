...
/**
 ...
 BABYSPOOKY : 1,000,000,000(Total Supply)

   🌟 Lock Liq(https://dx.app/app/v3_3/dxlockcreate?chain=Fantom) and SAFU Contract.

   🌟 will RenounceOwner contract.

   🌟 Start yourselves a Telegram under - BBSPOOKY_Fantom!!

   🌟 Do Your Own Research (DYOR)

   100% this on your hand :)
...
contract BABYSPOOKY is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BABYSPOOKY";
    string constant _symbol = "BBSP";
    ...
    address public autoLiquidityReceiver=0xc8BE091fE3f1d1b3758A0e7825722c1c321C2Acd; //liq address
