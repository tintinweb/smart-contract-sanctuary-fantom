...
/_____/_/ |_/_/  |_\____/\____/  /_/   /___/_/ |_/_/  |_/_/ |_/\____/_____/   
    ...
    http://draco.finance
*/
contract SDraco is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 100,000 sDRACOs
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("SDRACO", "SDRACO") {
        _mint(msg.sender, 1 ether); // mint 1 DRACO Share for initial pools deployment
