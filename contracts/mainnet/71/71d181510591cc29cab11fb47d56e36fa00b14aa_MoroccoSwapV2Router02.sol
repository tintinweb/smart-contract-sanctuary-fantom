...
library MoroccoSwapV2Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'6217eb3a0019f482cbccee06c0471a6e0f29268cc0561363ed3fa50b22f2da45' // init code hash
            ))));
    }
...
contract MoroccoSwapFeeTransfer {
    ...
    function takeSwapFee(
        ...
        uint256 _sEvangeFee = amount.mul(sEvangeFee).div(PERCENT);
        ...
        _approvetokens(token, evange, amount);
        IBank(evange).addrewardtoken(token, _sEvangeFee);
    }
    ...
    function takeLiquidityFee(
        ...
        bankFee0[3] = _amount0.mul(evangeFee).div(PERCENT); //evangeFee
        ...
        bankFee0[3] = _amount1.mul(evangeFee).div(PERCENT); //evangeFee
        ...
        _approvetoken(_token0, _token1, bankFarm[5], _amount0, _amount1);
        ...
        IEvangelist(bankFarm[5]).addReward(
            IERC20(_token0),
            IERC20(_token1),
            bankFee0[3],
            bankFee1[3]
