...
contract ImpStaking is Ownable {
  ...
  constructor(
    ...
    epoch = Epoch({length: _epochLength, number: _firstEpochNumber, endTime: _firstEpochTime, distribute: 15000000});//0.03 ça, nous on veut 15 au lancement donc 15000000000
  }
  ...
  /**
        @notice stake IMP to enter warmup
        @param _amount uint
        @return bool
     */
  ...
  /**
        @notice retrieve sIMP from warmup
  ...
  /**
        @notice forfeit sIMP in warmup and retrieve IMP
     */
  ...
  /**
        @notice returns contract IMP holdings, including bonuses provided
        @return uint
     */
