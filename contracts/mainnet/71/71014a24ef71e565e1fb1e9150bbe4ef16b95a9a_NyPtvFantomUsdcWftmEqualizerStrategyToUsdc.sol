 ...
 * out quoting reference 'NyPtvFantomUsdcWftmEqualizerStrategyToUsdc'
 *
...
error NyPtvFantomUsdcWftmEqualizerStrategyToUsdc__MaxSlippageOutOfBounds(uint256 maxSlippage);

contract NyPtvFantomUsdcWftmEqualizerStrategyToUsdc is NYBaseProfitTakingStrategyV3 {
  ...
  function updateMaxSlippage(uint256 _maxSlippage) external {
    if (_maxSlippage > 10000) {
      revert NyPtvFantomUsdcWftmEqualizerStrategyToUsdc__MaxSlippageOutOfBounds(_maxSlippage);
    }
    _atLeastRole(ADMIN);
