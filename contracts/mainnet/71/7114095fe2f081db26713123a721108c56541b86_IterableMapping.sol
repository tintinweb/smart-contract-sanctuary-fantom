...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public CoinAddress; //CoinAddress
 ...
 function _withdrawDividendOfUser(address payable user) internal returns (uint256) {
    ...
    if (_withdrawableDividend > 0) {
      ...
      bool success = IERC20(CoinAddress).transfer(user, _withdrawableDividend);
...
contract SHIVA is ERC20, Ownable {
    ...
    /****************** set coin ***************************** */
    function setReflectCoin(address coin) external onlyOwner{
    ...
    function swapAndSendDividends(uint256 tokens) private{
        ...
        uint256 dividends = IERC20(CoinAddress).balanceOf(address(this));
        try IERC20(CoinAddress).transfer(address(dividendTracker), dividends){
            dividendTracker.distributeBTCBDividends(dividends);
            emit SendDividends(tokens, dividends);
        }
        catch {
            revert("SHIVA::CoinAddress transfer reverted because of insufficient CoinAddress balance");
        }
    }
