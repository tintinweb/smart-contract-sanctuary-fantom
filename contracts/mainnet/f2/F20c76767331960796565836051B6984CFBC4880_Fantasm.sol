...
contract Fantasm is ERC20Burnable {
    ...
    uint256 public constant GENESIS_SUPPLY = 50 ether; // to provide liquidity at the beginning

    uint256 public constant DEV_ALLOCATION = 2_000_000 ether;
    uint256 public constant DEV_VESTING_DURATION = 3 * 365 * 24 * 3600; // 3 years
    uint256 public constant DEV_VESTING_START = 1645333200;

    uint256 public constant TREASURY_ALLOCATION = 1_000_000 ether;
