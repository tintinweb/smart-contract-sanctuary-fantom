...
contract farmerfiToken is Ownable, IBEP20 {
    ...
    address private _farmerfiInvestmentFund = payable(0x8D47Ad4BBEA63cA70d38513d2Ed4BAC50684891d);

    // Address of marketing and dev
    address private _marketingDev = payable(0x8D47Ad4BBEA63cA70d38513d2Ed4BAC50684891d);

    // Address of farmerfi AR Game
    address private _farmerfiArGame = payable(0x8D47Ad4BBEA63cA70d38513d2Ed4BAC50684891d);

    // Address of Service for sale
    address private _service = payable(0x8D47Ad4BBEA63cA70d38513d2Ed4BAC50684891d);
