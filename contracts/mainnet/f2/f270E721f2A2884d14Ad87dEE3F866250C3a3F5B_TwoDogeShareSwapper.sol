...
contract TwoDogeShareSwapper is Operator {
    ...
    constructor() public {
        tomb = IERC20(0xDD057bCcB72982753266A903Feda154608e54468);
        tbond = IERC20(0x70A151D449C9FaCee02eDceF971735fd16c1DDBB);
        tshare = IERC20(0x0C55339a139AcD3a8bA07a9abad345B05C4bF804);
        wftmAddress = address(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83);
        tombSpookyLpPair = address(0x8DFcA21813df0f0d04157779D489bD30843c6D73);
        tshareSpookyLpPair = address(0xB254973e067AF44eB4D506e7117A33C4F3F77783);
