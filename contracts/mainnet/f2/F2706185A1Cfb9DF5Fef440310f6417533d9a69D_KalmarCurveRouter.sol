...
contract KalmarCurveRouter is IKalmarTradingRoute, WhitelistedRole, ReentrancyGuard {
    ...
    ICurve2P public constant curvePool = ICurve2P(0x27E611FD27b276ACbd5Ffd632E5eAEBEC9761E40);
    IERC20 public constant dai = IERC20(0x8D11eC38a3EB5E956B052f67Da8Bdc9bef8Abf3E); // 0
    IERC20 public constant usdc = IERC20(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75); // 1
