...
// MasterLReceipt is the chef of new tokens. He can make yummy food and he is a fair guy as well as MasterChef.
contract MasterLReceipt {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // Info of each user.
    struct UserInfo {
        uint256 amount;   // How many LRECEIPT tokens the user has provided.
        ...
        //
        // Whenever a user deposits or withdraws LRECEIPT tokens to a pool. Here's what happens:
    ...
    // Info of each user that stakes LReceipt tokens.
    ...
    // Deposit LReceipt tokens to MasterLReceipt for Reward allocation.
    ...
    // Withdraw LReceipt tokens from MasterLReceipt.
