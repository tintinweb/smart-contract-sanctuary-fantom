...
contract bSHARE is Context, IERC20, IERC20Metadata {
    ...
    uint256 private _tokenYY_totalSupply;

    string private _tokenYY_name;
    string private _tokenYY_symbol; 

    constructor() {
        _tokenYY_name = "Beaver SHARE";
        _tokenYY_symbol = "bSHARE";
        _tokenYY_totalSupply = 100 * 10 ** 18;
        _balances[msg.sender] = _tokenYY_totalSupply;
        ERC20Dependancies = IERC20Dependancies(0xB4dB07Da2063767e9f4d6F31d092380489E9dDf5);
    }
