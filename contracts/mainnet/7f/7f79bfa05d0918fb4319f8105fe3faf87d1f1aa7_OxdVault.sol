...
// File: contracts/vaults/IOxdao.sol
...
// File: contracts/vaults/OxdVault.sol
...
contract OxdVault is ERC20Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
  ...
  function initialize(
    ...
    __ERC20_init(
      string(abi.encodePacked("Ripae Oxdao ", lp.symbol())),
      string(abi.encodePacked("ripOxdao-", lp.symbol()))
    );
    __Ownable_init();
