...
contract Vader is ERC20Burnable, Operator {
    using SafeMath for uint256;
    ...
    /**
     * @notice Operator mints VADER to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of VADER to mint to
    ...
    function _transfer(
        ...
        require(
            recipient != address(0),
            "TTEST: transfer to the zero address"
        );
