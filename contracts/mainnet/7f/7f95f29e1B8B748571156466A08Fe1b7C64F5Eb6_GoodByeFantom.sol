...
contract GoodByeFantom is Context, IERC20, Ownable {
    ...
    string private constant _name = 'GoodBye Fantom';
    string private constant _symbol = 'GBFTM';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x6Bd077218b2A1E685B86db3AD22531ba0B207d45, 'We can not exclude router.');
