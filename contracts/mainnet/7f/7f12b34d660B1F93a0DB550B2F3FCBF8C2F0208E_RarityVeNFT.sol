...
contract RarityVeNFT is ERC721, Ownable {
  ...
  */
    ...
    constructor(address _wool, address _dateTime)
        ERC721("TestHardcore2 veNFT", "TveNFT")
    {
        wool = IERC20(_wool);
   ...
   */
        ...
        returns (string memory)
    {
        ...
        return
            string(
                abi.encodePacked(
                    '<svg id="testhardcore2venft" width="100%" height="100%" version="1.1" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">'
                    '<image x="0" y="0" width="64" height="64" image-rendering="pixelated" preserveAspectRatio="xMidYMid" xlink:href="data:image/gif;base64,',
                    gif,
                    '"/><text font-family="monospace"><tspan x="13" y="4" font-size="0.25em">Locked WRGGOLD:</tspan><tspan id="g" x="38" y="4" font-size="0.25em">',
                    ...
                    ' Days</tspan></text><text font-family="monospace"><tspan x="4" y="13" font-size="0.15em">Before transfer, remember to claim unlocked WRGGOLD</tspan></text>',
                    "</svg>"
                )
            );
    }
