...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    address public constant geistAddr = 0xd8321AA83Fb0a4ECd6348D4577431310A6E0814d;
    address public constant usdcAddr = 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75;
    // Fee token
    ...
    address public constant feeTokenRouterAddr =
        0xF491e7B69E4244ad4002BC14e878a34207E38c29; // SpookySwap router
    address public constant pool = 0x0fa949783947Bf6c1b171DB13AEACBB488845B3f; // Curve pool
    ...
    uint256 public geistCutoffBps = 10**17;
        ...
        )
    {
        ...
        geistToFtmPath = new address[](2);
        geistToFtmPath[0] = geistAddr;
        geistToFtmPath[1] = rewardTokenAddr;

        rewardToFarmTokenPath1 = new address[](2);
        rewardToFarmTokenPath1[0] = rewardTokenAddr;
        rewardToFarmTokenPath1[1] = usdcAddr;
    }
    ...
    function set_geistCutoff(uint256 newCutoff) external onlyOwner {
        geistCutoffBps = newCutoff;
        emit SetHarvestCutoff(geistCutoffBps);
    }
    ...
    function harvest() public override nonReentrant {
        ...
        // Swap Geist to wFTM
        swapAmount = calculateSwapAmount(geistAddr, 10000);
        if (swapAmount > geistCutoffBps) {
          _swapUniswapWithPathForFeeOnTransferTokens(
              geistToFtmPath,
              swapAmount,
              farmTokenRouterAddr
        ...
        if (_rewardBalance > harvestCutoffBps) {
            ...
            // Add liquidity
            uint256 _usdc = IERC20(usdcAddr).balanceOf(address(this));
            IERC20(usdcAddr).safeApprove(pool, _usdc);
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    // Token addresses
    address public FARM_MASTER_CHEF = 0xF7b9c402c4D6c2eDbA04a7a515b53D11B1E9b2cc;
    address public LP_TOKEN = 0xD02a30d33153877BC20e5721ee53DeDEE0422B2F;
