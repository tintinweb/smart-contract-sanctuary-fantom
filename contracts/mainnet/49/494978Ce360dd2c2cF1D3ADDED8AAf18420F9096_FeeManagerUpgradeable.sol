    ...
    IFeeManagerUpgradeable
{
    ...
    */
    function getFee(
        ...
        if (_whitelistedAddresses[tx.origin]) {
        ...
        if (_feeTokenToOracle[fees.feeToken] != address(0)) {
        ...
        } else if (_twapAddress != address(0)) {
            ...
            if (pool != address(0)) {
                ...
                if (_whitelistedAddresses[sender]) {
                    return (feeInToken / 1000, abi.encode(0, 0, 0, lpValidatorProtocolWidgetFee[3] / 1000));
                }
        ...
        if (_whitelistedAddresses[sender]) {
            return (feeInToken / 10**12, abi.encode(0, 0, 0, lpValidatorProtocolWidgetFee[3] / 10**12));
        }
