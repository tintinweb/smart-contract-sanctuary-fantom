...
contract StrategyOxdSolidexStableUsdcMimLp is StrategyOxdFarmLPBase {
    // Token addresses
    address public usdc_mim_lp = 0xbcab7d083Cf6a01e0DdA9ed7F8a02b47d125e682;
        ...
        )
    {
        ...
        swapRoutes[mim].push(route(wftm, usdc, false));
        swapRoutes[mim].push(route(usdc, mim, true));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategyOxdSolidexStableUsdcMimLp";
    }
}
