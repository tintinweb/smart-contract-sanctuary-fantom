...
contract ApexOrcas is ERC721Enumerable, Ownable {
    using Strings for uint256;

    string baseURI;
    string public baseExtension = ".json";
    uint256 public cost = 48000000000000000000; // 48 FTM
    uint256 public maxSupply = 1500; // setter to be changed
    ...
    bytes32 public merkleRoot =
        0xb650fdb59d0b87b7165ec963909a41464330c3f153414ca50e304ec96956acb0; //will be changed as we change whitelist
