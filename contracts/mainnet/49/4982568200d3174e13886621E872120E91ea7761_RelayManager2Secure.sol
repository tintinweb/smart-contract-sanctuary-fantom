...
contract RelayManager2Secure is Operatorable, ReentrancyGuard {
    ...
    constructor(
        ...
        require(
            _bridgeWallet != address(0),
            "RelayManager2Secure: BRIDGE_WALLET_ADDRESS_INVALID"
        );
        ...
        require(
            signerLength >= _threshold,
            "RelayManager2Secure: SIGNERS_NOT_ENOUGH"
        );
  ...
  |__________________________*/
    ...
    function deposit(
        ...
        require(
            amount >= adminFee,
            "RelayManager2Secure: DEPOSIT_AMOUNT_INVALID"
        );
        require(
            receiver != address(0),
            "RelayManager2Secure: RECEIVER_ZERO_ADDRESS"
        );
        // Burn tokens
    ...
    function _send(
        ...
        require(
            _verify(
                keccak256(abi.encodePacked(from, receiver, amount, nonce)),
                _signatures
            ),
            "RelayManager2Secure: INVALID_SIGNATURE"
        );
