...
contract Roulette is Ownable, CasinoGame {
    ...
    function playRound(uint256 _betAmount, uint8 _betType, uint8[] memory _betNums, uint256 _tokenId) external {
        ...
        // Handle initial spin
        spin(msg.sender, _betAmount, _betType, _betNums, _tokenId);
    }
    ...
    function spin(address _playerAddress, uint256 _bet, uint8 _betType, uint8[] memory _betNums, uint256 _tokenId) private {
        ...
        endRound(_playerAddress, rnd, _tokenId);       
    }
    ...
    function endRound(address _playerAddress, uint8 spinNum, uint256 _tokenId) private {
        require(roundInProgress[_playerAddress] == true, "Not playing round.");
