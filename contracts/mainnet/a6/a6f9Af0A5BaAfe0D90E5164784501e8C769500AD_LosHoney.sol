...
contract LosHoney is ERC721Enumerable, ERC721Burnable, ERC721Pausable, Ownable, ReentrancyGuard {
    ...
    constructor(address to, string memory baseURI) ERC721("Los Honey", "LSHNY") {
