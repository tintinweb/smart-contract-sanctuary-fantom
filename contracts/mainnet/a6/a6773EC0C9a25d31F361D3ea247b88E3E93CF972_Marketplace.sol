...
import "./utils/AuthorizableNoOperator.sol";
...
contract Marketplace is AuthorizableNoOperator, ReentrancyGuard, ContractGuard {
    ...
    uint256 private fee = 0; // 25 market fee in percent 2.5%, this should be integer in declare
        ...
        nonReentrant
    {
        ...
        uint256 amountToSeller = price.mul(fullPrice.sub(fee)).div(1000);
        uint256 amountToFund = price.mul(fee).div(1000);
...
contract NFT is ERC721, AuthorizableNoOperator, ContractGuard {
    using Counters for Counters.Counter;
    ...
    constructor(address _marketplaceAddress) ERC721("Dog Card", "DogCard") public {
        marketplaceAddress = _marketplaceAddress;
    }

    function setMarketAddress(address _marketplaceAddress) public onlyAuthorized {
        marketplaceAddress = _marketplaceAddress;
    }
