...
contract SigmaNodesNodePool is Context, Ownable {
    ...
    address public teamWallet = 0x308A2b6e0E661E1e21768e990D9f64D7d2656ACF;

    uint256 public teamFee = 150;
    uint256 public burnFee = 50;
    uint256 public feeDenomiator = 1000;

    IERC20 public SIGMANODES = IERC20(0xc609929327DA7bE65D501E442207E0CaFCC04364);
    ...
    function createNode(string memory nodeName, uint256 count) external {
        ...
        SIGMANODES.transferFrom(account, address(this), price);
        SIGMANODES.transfer(burnAddress, price*burnFee/feeDenomiator);
        SIGMANODES.transfer(teamWallet, price*teamFee/feeDenomiator);
    ...
    function claimNodeReward(uint256 _creationTime) external {
        ...
        SIGMANODES.transfer(account, rewardNode);
    }
    ...
    function claimAllNodesReward() external {
        ...
        SIGMANODES.transfer(account, rewardsTotal);
    }
    ...
    function withdrawReward(uint256 amount) external onlyOwner {
        SIGMANODES.transfer(msg.sender, amount);
    }
