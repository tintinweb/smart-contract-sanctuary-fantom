...
contract StrategyOxdStableSpiritBinspiritLp is StrategyOxdFarmLPBase {
    // Token addresses
    address public spirit_binspirit_lp =
        0xa7Ea870dc93ffB712ca74b43eFCA9B07556d1303;
    address public spirit = 0x5Cc61A78F164885776AA610fb0FE1257df78E59B;
    address public binspirit = 0x44e314190D9E4cE6d4C0903459204F8E21ff940A;
        ...
        )
    {
        ...
        swapRoutes[binspirit].push(route(wftm, spirit, false));
        swapRoutes[binspirit].push(route(spirit, binspirit, true));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategyOxdStableSpiritBinspiritLp";
    }
}
