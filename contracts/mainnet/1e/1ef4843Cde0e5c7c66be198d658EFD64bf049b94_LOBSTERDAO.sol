...
contract LOBSTERDAO is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 33000 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'Lobster DAO';
    string private constant _symbol = 'LOBST3R';

    uint256 private _taxFee = 700;
    uint256 private _burnFee = 0;
    uint public max_tx_size = 33000 ether;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xCf7b2A5Fb331de8d61f553283Ad955178cE2c77c, 'We can not exclude router.');
