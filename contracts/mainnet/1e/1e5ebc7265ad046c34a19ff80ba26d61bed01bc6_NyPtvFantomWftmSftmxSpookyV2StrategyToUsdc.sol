 ...
 *
 * We are committed to working with Black/White hats. If you find an issue then please reach
 * out quoting reference 'NyPtvFantomWftmSftmxSpookyV2StrategyToUsdc'
 *
 * Twitter: https://twitter.com/NinjaYielder
 */
...
contract NyPtvFantomWftmSftmxSpookyV2StrategyToUsdc is NYBaseProfitTakingStrategyV1 {
  ...
  /**
   * @dev Tokens used
   * {BOO}        Farm emission token sold to {USDC}
   * {USDC}       Vault reward token, also used for fees.
   * {LP_TOKEN}   Address of the LP token to farm.
   * {LP_TOKEN_0} WFTM  - First token of the LP
   * {LP_TOKEN_1} SFTMX - Second token of the LP
   */
  ...
  address public constant LP_TOKEN = address(0xE67980fc955FECfDA8A92BbbFBCc9f0C4bE60A9A);
  address public constant LP_TOKEN_0 = address(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83);
  address public constant LP_TOKEN_1 = address(0xd7028092c830b5C8FcE061Af2E593413EbbC1fc1);
   ...
   *      Swaps farm emission token to {USDC}.
   */
  ...
  /**
   * @dev Core harvest function.
   *      Sends {USDC} to the vault (with accounting)
   */
