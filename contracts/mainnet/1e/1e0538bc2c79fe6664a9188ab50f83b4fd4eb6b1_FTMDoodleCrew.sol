    ...
    ClampedRandomizer
{
    ...
    uint256 public maxPerTx = 75;
    uint256 public maxPerPerson = 75;
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("FTM Doodle Crew", "FDC") ClampedRandomizer(maxSupply) {     
