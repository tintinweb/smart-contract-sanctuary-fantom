...
contract Boardroom is Initializable, ShareWrapper, ContractGuard {
    ...
    function getfirePrice() external view returns (uint256) {
        return treasury.getFirePrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            fire.safeTransfer(msg.sender, reward);
...
contract ShareWrapper {
    ...
    function withdraw(uint256 amount) public virtual {
        ...
        water.safeTransfer(msg.sender, amount);
    }
}