...
// File: contracts/EqualEthElitevAMM.sol
...
contract EqualEthElitevAMM is Ownable, Pausable {
    ...
    function addLiquidity() internal {
        ...
        IEqualizerRouter(unirouter).swapExactTokensForTokens(wrappedHalf, 0, wrappedToEthPath, address(this), block.timestamp);
        IEqualizerRouter(unirouter).swapExactTokensForTokens(wrappedHalf, 0, wrappedToElitePath, address(this), block.timestamp);
        
        uint256 lp0Bal = IERC20(eth).balanceOf(address(this));
        uint256 lp1Bal = IERC20(elite).balanceOf(address(this));

        IEqualizerRouter(unirouter).addLiquidity(eth, elite, stable, lp0Bal, lp1Bal, 1, 1, address(this), block.timestamp);
    }
    ...
    function _removeAllowances() internal {
        ...
        IERC20(elite).safeApprove(unirouter, 0);
    }
    ...
    function _giveAllowances() internal {
        ...
        IERC20(elite).safeApprove(unirouter, type(uint).max);
    }
