...
contract GovernorBravoDelegate is Initializable,UUPSUpgradeable,GovernorBravoDelegateStorageV2, GovernorBravoEvents {
    ...
    string public constant name = "Sect Governor Bravo";
    ...
    uint public constant MAX_VOTING_PERIOD = 1209600; // About 2 weeks, in FTM (ETH x15)

    /// @notice The min setable voting delay
    uint public constant MIN_VOTING_DELAY = 1;

    /// @notice The max setable voting delay
    uint public constant MAX_VOTING_DELAY = 604800; // About 1 week, in FTM (ETH x15)
