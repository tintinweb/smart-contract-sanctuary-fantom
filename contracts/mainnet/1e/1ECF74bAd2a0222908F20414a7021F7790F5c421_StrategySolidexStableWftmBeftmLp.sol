...
contract StrategySolidexStableWftmBeftmLp is StrategySolidexFarmLPBase {
    // Token addresses
    address public wftm_beftm_lp = 0x387a11D161f6855Bd3c801bA6C79Fe9b824Ce1f3;
    address public beftm = 0x7381eD41F6dE418DdE5e84B55590422a57917886;
    ...
    {
        swapRoutes[beftm].push(route(wftm, beftm, true));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategySolidexStableWftmBeftmLp";
    }
}
