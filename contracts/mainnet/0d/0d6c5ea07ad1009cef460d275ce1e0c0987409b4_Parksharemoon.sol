...
// Hold ParkShareMoon To Get pShare,Dai,pDollar
// The Gift Holder will be automatically entered into the Wallet Holder every 6 hours
// Join: t.me/parkmoonshare
// website soon
...
contract Parksharemoon is Context, IERC20, Ownable {
    ...
    string private _name = "Park Share Moon";
    string private _symbol = "sParkmoon";
    uint8 private _decimals = 9;
    
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x72d368138226bC9598F5dF7fb50081524449F271;
    ...
    uint256 public minimumTokensBeforeSwap = 100 * 10**9;
    uint256 public _maxBuyTxAmount = 100 * 10**9;
    uint256 public _maxSellTxAmount = 100 * 10**9;
    uint256 public maxWalletToken = 100 * (10**9);
    ...
    function _transfer(address from, address to, uint256 amount) private 
    {
     ...
     function swapTokensForUsdt(uint256 tokenAmount) private {
        ...
        path[2] = 0x8D11eC38a3EB5E956B052f67Da8Bdc9bef8Abf3E; // USDT cotract address
