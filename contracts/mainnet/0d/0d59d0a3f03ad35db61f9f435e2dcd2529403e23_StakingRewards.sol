/**
 *Submitted for verification at FtmScan.com on 2022-12-14
*/
...
contract Vault is SemiFungibleVault, ReentrancyGuard {
    ...
    /**
        ...
        @param  _name   token name for the ERC1155 mints. Insert the name of your token; Example: DEPEG_USDC_1.2$
        @param  _symbol token symbol for the ERC1155 mints. insert here if risk or hedge + Symbol. Example: HedgeDEPEG or riskDEPEG;
...
contract VaultFactory is Ownable {
    ...
    function createNewMarket(
        ...
        //depegUSDC_99*RISK or depegUSDC_99*HEDGE
