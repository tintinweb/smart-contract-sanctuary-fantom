...
*/
contract TPiggy is ERC20Burnable, Operator {
    ...
    uint256 public constant INITIAL_AIRDROP_WALLET_DISTRIBUTION = 10500 ether;

    // Have the rewards been distributed to the pools
    bool public rewardPoolDistributed = false;

    /**
     * @notice Constructs the TPIGGY ERC-20 contract.
     */
    constructor() public ERC20("TPIGGY", "TPIGGY") {
    ...
    function distributeReward(
        ...
        _mint(_daoFund, INITIAL_AIRDROP_WALLET_DISTRIBUTION);
    }
