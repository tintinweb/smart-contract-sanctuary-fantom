...
contract Hermes is ERC20Burnable, Operator {
    ...
    // Initial distribution for the day 2-5 HERMES-WETH LP -> HERMES pool
    // uint256 public constant INITIAL_HERMES_POOL_DISTRIBUTION = 140000 ether;
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("THERMES", "THERMES") {
    ...
    function distributeReward(
        ...
        // require(_hermesPool != address(0), "!_hermesPool");
        require(_airdropWallet != address(0), "!_airdropWallet");
        rewardPoolDistributed = true;
        _mint(_genesisPool, INITIAL_GENESIS_POOL_DISTRIBUTION);
        // _mint(_hermesPool, INITIAL_HERMES_POOL_DISTRIBUTION);
