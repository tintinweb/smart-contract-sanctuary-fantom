...
// File contracts/EqualFtmTarotvAMM.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract EqualFtmTarotvAMM is Ownable, Pausable {
    ...
    address public constant tarot = address(0xC5e2B037D30a390e62180970B3aa4E91868764cD);
    address public want;
    ...
    IEqualizerRouter.Routes[] public wrappedToTarotPath;
    ...
    constructor(
        ...
        IEqualizerRouter.Routes[] memory _wrappedToTarotPath
    ) {
        ...
        for (uint i; i < _wrappedToTarotPath.length; ++i) {
            wrappedToTarotPath.push(_wrappedToTarotPath[i]);
        }
    ...
    function addLiquidity() internal {
        ...
        IEqualizerRouter(unirouter).swapExactTokensForTokens(wrappedHalf, 0, wrappedToTarotPath, address(this), block.timestamp); 

        uint256 lp0Bal = IERC20(wrapped).balanceOf(address(this));
        uint256 lp1Bal = IERC20(tarot).balanceOf(address(this));

        IEqualizerRouter(unirouter).addLiquidity(wrapped, tarot, stable, lp0Bal, lp1Bal, 1, 1, address(this), block.timestamp);   
    }
    ...
    function _removeAllowances() internal {
        ...
        IERC20(tarot).safeApprove(unirouter, 0);
    }
    ...
    function _giveAllowances() internal {
        ...
        IERC20(tarot).safeApprove(unirouter, type(uint).max);
    }
