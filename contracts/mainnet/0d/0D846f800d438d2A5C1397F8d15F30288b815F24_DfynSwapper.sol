...
contract DfynSwapper is AccessControl, ReentrancyGuard {
  ...
  IERC20 public constant anyswap_dfyn =
    IERC20(0x7a4b1aBC1409C69c2ed71Ab34daE43E2Ff6f9928);
  ...
  function deposit(uint256 amount) external nonReentrant {
    anyswap_dfyn.transferFrom(msg.sender, address(this), amount);
  ...
  function anyswapDfynBalance() external view returns (uint256) {
    return anyswap_dfyn.balanceOf(address(this));
  }
  ...
  function withdrawOtherDfyn(uint256 amount, address recipient)
    ...
    onlyRole(DEFAULT_ADMIN_ROLE)
  {
    _withdraw(anyswap_dfyn, amount, recipient);
  }
