...
// SolidlyStaker
contract SolidlyStaker is Ownable, Pausable {
    ...
    constructor(address _voter, address _treasury, address _keeper) public {
        voter = IVoter(_voter);
    ...
    function claimOwnerRewards(uint256[] memory _pids, address[][] memory _tokens) external onlyManager {
    ...
    function vote(uint256 _veTokenId, address[] calldata _tokenVote, int256[] calldata _weights) external onlyManager {
