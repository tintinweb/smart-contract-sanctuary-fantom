...
contract EggEmporiumTraditionalLiving is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function mint(uint256 tokenID) public payable {
    require(!paused);
    require(tokenID <= maxSupply, "Token ID cannot be minted");
    require(tokenID > 0, "Token ID cannot be minted");
