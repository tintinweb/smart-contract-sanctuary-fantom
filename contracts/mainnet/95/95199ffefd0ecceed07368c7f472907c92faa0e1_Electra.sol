...
// File: contracts/Electra.sol



pragma solidity 0.6.12;

contract Electra is ERC20Burnable, Operator {
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("ELECTRA", "ELECTRA") {
