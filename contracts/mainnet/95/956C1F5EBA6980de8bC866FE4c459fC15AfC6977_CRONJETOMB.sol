...
contract CRONJETOMB is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Cronjetomb';
    string private constant _symbol = 'CTOMB';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x2f7dd32d3c7C709583dF7268bba537Cbfa1A36cB, 'We can not exclude router.');
