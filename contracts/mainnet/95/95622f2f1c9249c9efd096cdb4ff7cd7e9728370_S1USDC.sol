...
contract S1USDC is ERC20Permit, Ownable, SafeMath {

    constructor() ERC20("S1USDC", "S1USDC") ERC20Permit("S1USDC")
    {
    }

    uint256 constant private _maxTotalSupply = 10e36;
    address public usdc;
    ...
    function set_address(address _usdc) public onlyOwner{
        usdc = _usdc;
    }

    function wrap(uint256 amount) public{
        require(ERC20(usdc).balanceOf(msg.sender)>=amount);
        ERC20(usdc).transferFrom(msg.sender, address(this), amount);
        ERC20(address(this)).transfer(msg.sender, 1000000000000*amount);
    }
    ...
    function unwrap(uint256 amount) public{
        ...
        ERC20(usdc).transfer(msg.sender, div(amount, 1000000000000));
    }
}