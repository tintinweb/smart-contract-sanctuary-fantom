...
contract Main is ERC20Burnable, Operator {
    ...
    uint256 public constant INITIAL_MAIN_POOL_DISTRIBUTION = 20000 ether;
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("PINK", "PINK") {
