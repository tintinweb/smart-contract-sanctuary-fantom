...
contract VaultStrategy is Ownable, ReentrancyGuard, Pausable {
    ...
    IERC20 public token0 = IERC20(0x953Cd009a490176FcEB3a26b9753e6F01645ff28); // VDEUS
    IERC20 public token1 = IERC20(0xDE5ed76E7c05eC5e4572CfC88d1ACEA165109E44);  // DEUS

    address public taxCollector = 0x5816BD4eBa5E1674b830fAf9E3857bDaDEA75646; // collector of performance fees 
    ...
    function _distributeFees(
        ...
        if (bountyReward > 0) {
            earnToken.safeTransfer(taxCollector, platformFee);
        }
