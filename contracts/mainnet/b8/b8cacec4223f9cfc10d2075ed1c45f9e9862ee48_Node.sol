...
contract Node {
    ...
    IERC20 public constant TOKEN = IERC20(0xbEF13A4C2b0543B66fa365f318efA3e4aedde2B6); // [ToDo] Change to Grave contract address
    ...
    constructor(uint256 _startTime) public {
        ...
        dripRate = 1400000;  // [ToDo] 1400000 is better?
        treasuryFeePercent = 10;  // [ToDo] 10% is better?
