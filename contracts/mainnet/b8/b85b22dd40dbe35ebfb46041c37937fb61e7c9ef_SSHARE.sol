...
contract SSHARE is ERC20Burnable, Operator 
{
    ...
    uint256 public constant supply = 10000 ether;
   
    // Initial distribution for the first 24h genesis pools
    uint256 public constant INITIAL_GENESIS_POOL_DISTRIBUTION = 3000 ether;
    // Initial distribution for the day 2-5 COSMO-WFTM LP -> COSMO pool
    uint256 public constant INITIAL_POOL_DISTRIBUTION = 0 ether;
    ...
    bytes32 public constant BOND_TREASURY_OPERATOR = keccak256("BOND_TREASURY_OPERATOR");

    constructor() public ERC20("S SHARES - superfinance.farm", "SSHARES") {
