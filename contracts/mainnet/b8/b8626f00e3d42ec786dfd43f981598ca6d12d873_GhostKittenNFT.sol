...
contract GhostKittenNFT is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://QmPJykMcWgCVqXZFsZEaKRWqypw8vLKojapaLcxQvNr3ry/", Strings.toString(tokenId), ".json")
            );
    }
