...
contract SomeBadProxy {
    // testing whether the slot's name needs to be "IMPLEMENTATION_SOURCE_SLOT" for etherscan to pick up it's a proxy
    ...
    // Tested, this still shows "is this a proxy" prompt for etherscan
    ...
    fallback() external virtual {
        assembly {
            let contractLogic := sload(IMPLEMENTATION_SOURCE_SLOT)
