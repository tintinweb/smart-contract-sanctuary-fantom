...
contract ZestVampLottery is Ownable, Pausable, AccessControl {
    ...
    // address public zspAddress = 0x2C26617034C840C9412CD67aE0Fc68A6755D00BF;
    // address public vampAddress = 0xA91ADe2730bF6041ce9DE1Ba9cB22eE7Fea2B009;
    // IERC20 token;
    ...
    function drawLottery(uint256 reqestId, uint256[] memory _randomWords) public {
        ...
        if (players.length > 0) {
            ...
            //Send tokens to the winner and burn the remainder
