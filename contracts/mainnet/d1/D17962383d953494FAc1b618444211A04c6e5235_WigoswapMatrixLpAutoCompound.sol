...
contract WigoswapMatrixLpAutoCompound is MatrixLpAutoCompoundV2 {
    using EnumerableSet for EnumerableSet.AddressSet;

    address internal constant SPOOKYSWAP_ROUTER = 0xF491e7B69E4244ad4002BC14e878a34207E38c29;
    address internal constant WIGOSWAP_ROUTER = 0x5023882f4D1EC10544FCB2066abE9C1645E95AA0;

    address internal constant WIGO = 0xE992bEAb6659BFF447893641A378FbbF031C5bD6;
    ...
    function _initialize(
        ...
        unirouter = WIGOSWAP_ROUTER;

        routers.push(SPOOKYSWAP_ROUTER);
        routers.push(WIGOSWAP_ROUTER);
