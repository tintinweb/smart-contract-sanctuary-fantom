...
contract EncryptShare is ERC20Burnable, Operator {
    ...
    constructor(
        ...
        address _devFund
    ) public ERC20("Encrypt Share", "ECSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 Encrypt Share Share for initial pools deployment
