...
contract DividendPayingToken is ERC20, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  IUniswapV2Router02 public uniswapV2Router = IUniswapV2Router02(0xF491e7B69E4244ad4002BC14e878a34207E38c29); //mainnet
...
contract PtmTOKEN is ERC20, Ownable {
    ...
    uint256 public liquidityFee = 5; // This fee must be a TOTAL of LP, Marketings Fee AND Buyback fee (Note, Buyback has been disabled)
    ...
    function updateMarketingWallet(address newMarketingWallet) external onlyOwner {
        require(newMarketingWallet != marketingsWallet, "");
    ...
    function buyBackTokensWithNoFees() external payable returns (bool) {
        ...
        require(userRawFTMDividends >= holderFTMUsedForBuyBacks[msg.sender].add(msg.value), "");
    ...
    function _transfer(
        ...
        if(automatedMarketMakerPairs[to] && !isTradingEnabled && _isAllowedDuringDisabled[from]) {
            require((from == owner() || to == owner()) || _isAllowedDuringDisabled[from], "");
        }     
