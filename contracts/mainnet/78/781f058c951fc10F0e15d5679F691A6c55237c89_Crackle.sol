...
contract Crackle is BEP20 {
    ...
    string public constant name = "Crackle";
    string public constant symbol = "CRACKLE";
    uint public constant decimals = 18;
    uint public deadline = now + 90 * 1 days;
    uint public round2 = now + 30 * 1 days;
    uint public round1 = now + 60 * 1 days;
    
    uint256 public totalSupply = 3782038961497000000000000;
    uint256 public totalDistributed;
    uint256 public constant requestMinimum = 0.003 ether / 10;
    ...
    constructor() public {
        uint256 teamFund = 378203896149700000000000;
        owner = msg.sender;
    ...
    function getTokens() payable canDistr  public {
        ...
        uint256 bonusCond2 = 1 ether / 5000;
