...
// File contracts/distribution/EightballRewardPool.sol
...
contract EightballRewardPool {
    ...
    // MAINNET
    uint256 public tombPerSecond = 0.1041666666 ether; // 18000 tomb / (48h * 60min * 60s) 0.3472222222
    ...
    modifier onlyOperator() {
        require(
            operator == msg.sender,
            "EightballRewardPool: caller is not the operator"
        );
        _;
    }
    ...
    function checkPoolDuplicate(IERC20 _token) internal view {
        ...
        for (uint256 pid = 0; pid < length; ++pid) {
            require(
                ...
                "EightballRewardPool: existing pool?"
            );
        }
    }
