...
// File: contracts/distribution/GshareRewardPoolV2.sol
...
contract GshareRewardPool {
    ...
    uint256 public tSharePerSecond = 0.002572218 ether; // 40000 tshare / (180 days * 24h * 60min * 60s)
    ...
    modifier onlyOperator() {
        require(operator == msg.sender, "GshareRewardPoolV2: caller is not the operator");
        _;
    }
