...
contract MPXBonderUSDC is Context, Ownable, ReentrancyGuard {
    ...
    uint256 constant public vestingPeriod = 426 days;
    ...
    constructor(
        address _bondingToken, // token to accept for bonding (USDC)
    ...
    function _bond(uint256 amount) internal {
        ...
        uint256 usdcAmount = amount.mul(10**12); // convert to be with 18 decimal precision for calculating mpxAmount
        uint256 mpxAmount = usdcAmount.mul(ratio).div(1000);
