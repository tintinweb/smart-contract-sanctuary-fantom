...
contract XShareLocker is Operator, IXShareLocker {
    ...
    function info() public view returns (uint256, uint256, uint256, uint256, bool) {
        return (
            totalXShareLocked,
            totalYShareMinted,
            averageLockDuration,
    ...
    //Update 2: Done all functions, working well
    ...
    function ceil(uint256 _amount) internal returns (uint256){
        return (_amount.add(1e16).sub(1)).div(1e16).mul(1e16);
    }
