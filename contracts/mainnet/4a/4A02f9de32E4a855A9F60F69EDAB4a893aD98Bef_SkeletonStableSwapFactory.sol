...
import "./interfaces/ISkeletonStableSwap.sol";
import "./interfaces/ISkeletonStableSwapLP.sol";
import "./interfaces/ISkeletonStableSwapDeployer.sol";
import "./interfaces/ISkeletonStableSwapLPFactory.sol";

contract SkeletonStableSwapFactory is Ownable {
    ...
    ISkeletonStableSwapLPFactory public immutable LPFactory;
    ISkeletonStableSwapDeployer public immutable SwapTwoPoolDeployer;
    ISkeletonStableSwapDeployer public immutable SwapThreePoolDeployer;
     ...
     */
    constructor(
        ISkeletonStableSwapLPFactory _LPFactory,
        ISkeletonStableSwapDeployer _SwapTwoPoolDeployer,
        ISkeletonStableSwapDeployer _SwapThreePoolDeployer
    ) {
    ...
    function createSwapPair(
        ...
        ISkeletonStableSwapLP(LP).setMinter(swapContract);
    ...
    function addPairInfo(address _swapContract) external onlyOwner {
        ISkeletonStableSwap swap = ISkeletonStableSwap(_swapContract);
...
interface ISkeletonStableSwapDeployer {
    function createSwapPair(
        address _tokenA,
        address _tokenB,
        uint256 _A,
...
interface ISkeletonStableSwapLP {
    /**
...
interface ISkeletonStableSwapLPFactory {
