...
contract babychill is Context, IERC20, Ownable {
    ...
    string private constant _name = 'BABYCHILL';
    string private constant _symbol = 'BABYCHILL';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x428d52AF0cd25b37Bcb83971C583Ac4c1FEa5eCC, 'We can not exclude router.');
