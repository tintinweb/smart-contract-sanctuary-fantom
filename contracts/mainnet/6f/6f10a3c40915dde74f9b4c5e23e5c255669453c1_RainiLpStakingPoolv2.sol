...
// File: contracts/RainiLpStakingPool.sol
...
contract RainiLpStakingPoolv2 is AccessControl, ReentrancyGuard {
  ...
  function setUnicornToFTM(uint256 _unicornToFTM)
    external onlyOwner {
  ...
  function buyUnicorn(uint256 _amount) 
    external payable {
      ...
      require(msg.value * unicornToFTM >= _amount, "RainiLpv3StakingPool: not enougth eth");
