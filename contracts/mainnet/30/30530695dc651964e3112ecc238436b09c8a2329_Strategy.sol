...
contract Strategy is IStrategy, Ownable, ReentrancyGuard, Pausable {
    ...
    address public buyBackAddress = address(0x5f9e970c4399fB595e7ab4bb249589A8A77C2D4A); // insurance
    address public buyBackTokenAddress = address(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83); // spirit to insurance
