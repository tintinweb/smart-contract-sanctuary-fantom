...
contract StrategyOxdVolatileUsdcSynLp is StrategyOxdFarmLPBase {
    // Token addresses
    address public usdc_syn_lp = 0xB1b3B96cf35435b2518093acD50E02fe03A0131f;
    address public usdc = 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75;
    address public syn = 0xE55e19Fb4F2D85af758950957714292DAC1e25B2;
        ...
        )
    {
        ...
        swapRoutes[syn].push(route(wftm, syn, false));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategyOxdVolatileUsdcSynLp";
    }
}
