...
//Test 0.01 Reflective Error - Don't ape in
// Deploying on few hours the true new contract
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x00cD9937cac40Ced12E00728B104961d59add366); // FEAR
...
contract FearPrinterbeta is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x00cD9937cac40Ced12E00728B104961d59add366; // FEAR
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "SpookyVerse Printer V2";
    ...
    address public autoLiquidityReceiver=0x0852c666d60C8433acd42895ced8B03369aB2B49; //liq address
    address public marketingFeeReceiver=0x0852c666d60C8433acd42895ced8B03369aB2B49; // marketing address
