 ...
 */
contract PanicVaultV1 is ERC20, Ownable, ReentrancyGuard {
    ...
    */
    ...
    function pricePerShare() public view returns (uint256) {
        return totalSupply() == 0 ? 1e18 : totalAssets().mul(1e18).div(totalSupply());
    }
     ...
     * by the strategy's harvest() function.
     */
    ...
    function withdraw(uint256 _shares) public nonReentrant returns(uint r){
      require(_shares > 0, "please provide amount");
        r = (totalAssets().mul(_shares)).div(totalSupply());
