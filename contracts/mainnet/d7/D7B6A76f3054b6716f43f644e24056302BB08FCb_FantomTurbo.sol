...
contract FantomTurbo {
	using SafeMath for uint256;

	uint256 constant public INVEST_MIN_AMOUNT = 5e18; // 0.001 Matic  
	...
	uint256 constant public PLANPER_DIVIDER = 200;
	...
	constructor(address payable wallet) public {
		...
		plans.push(Plan(150, 135));
		plans.push(Plan(120, 180));
