...
contract StarDollars is ERC20, ERC20Burnable, Ownable,ReentrancyGuard {
    ...
    constructor() ERC20("Star Dollar", "STARD") {
        _mint(0xF60De76791c2F09995df52Aa1c6e2E7DcF1E75d7, 100000 * 10 ** decimals());
    ...
    function swapIn(address to, uint256 amount)external nonReentrant{
        ...
        require(mai.transferFrom(to,address(this),amount),"Mai Transfer failed");
