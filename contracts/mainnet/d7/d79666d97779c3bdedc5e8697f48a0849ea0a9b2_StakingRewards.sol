...
contract StakingRewards {
    ...
    constructor() {
        owner = msg.sender;
        stakingToken = IERC20(0xF24Bcf4d1e507740041C9cFd2DddB29585aDCe1e);
        rewardsToken = IERC20(0xF24Bcf4d1e507740041C9cFd2DddB29585aDCe1e);
        ...
        txCost = 1e18; // The amount of wei someone would have to pay to use a function, leave 0 if none.
        ...
        path.push(0xAD522217E64Ec347601015797Dd39050A2a69694); // Second Token
    }
