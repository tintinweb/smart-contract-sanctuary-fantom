...
// File contracts/EqualFusdtEqualizerV2.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract EqualFusdtEqualizerV2  is Ownable, Pausable {
    ...
    function addLiquidity() internal {
        ...
        IEqualizerRouter(router).swapExactTokensForTokens(equalHalf, 0, equalToFusdtPath, address(this), block.timestamp);

        uint256 t1Bal = IERC20(equal).balanceOf(address(this));
        uint256 t2Bal = IERC20(fusdt).balanceOf(address(this));

        IEqualizerRouter(router).addLiquidity(equal, fusdt, stable, t1Bal, t2Bal, 1, 1, address(this), block.timestamp);
    }
