...
contract Casino is Ownable {
    ...
    // Remove address of CasinoGame
    function removeCasinoGameContractAddress(uint index) public{
        casinoGameAddresses[index] = casinoGameAddresses[casinoGameAddresses.length - 1];
        casinoGameAddresses.pop();
    }
