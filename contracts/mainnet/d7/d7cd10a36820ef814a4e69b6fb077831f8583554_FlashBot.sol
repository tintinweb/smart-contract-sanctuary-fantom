...
contract FlashBot is Ownable {
    ...
    // WFTM on ETH or WBNB on BSC
    address immutable WFTM;
    ...
    /// @dev Newtons method for caculating square root of n
...
// File contracts/test/InternalFuncTest.sol
