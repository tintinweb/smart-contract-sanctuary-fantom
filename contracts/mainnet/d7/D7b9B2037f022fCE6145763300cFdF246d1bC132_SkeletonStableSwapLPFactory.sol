...
contract SkeletonStableSwapLP is ERC20 {
    address public minter;

    constructor() ERC20("Skeleton StableSwap LPs", "Stable-LP") {
        minter = msg.sender;
    }
...
import "./SkeletonStableSwapLP.sol";

contract SkeletonStableSwapLPFactory is Ownable {
    ...
    function createSwapLP(
        ...
        // create LP token
        bytes memory bytecode = type(SkeletonStableSwapLP).creationCode;
        ...
        SkeletonStableSwapLP(lpToken).setMinter(_minter);
