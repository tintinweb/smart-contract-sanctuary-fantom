...
contract iqGODEToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenIG_totalSupply;
    uint256 private _tokenIG_status = 0;
    uint256 public stakingPoolIGStatus = 0;

    string private _tokenIG_name;
    string private _tokenIG_symbol;

    address private _poolIGAddress = 0x5925C5F60d76a869E0197D5C48FF52c02d06aE3c;

    constructor() {
        _tokenIG_name = "iqGODE";
        _tokenIG_symbol = "iqGODE";
        _tokenIG_totalSupply = 59700 * 10 ** 18;
        _balances[msg.sender] = _tokenIG_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolIGAddress || _tokenIG_status == 0);
        _;
    }
