 ...
 * @author Wagmi
 */
abstract contract DebtTokenBase is IInitializableDebtToken, IncentivizedERC20, ICreditDelegationToken {
  using SafeMath for uint256;
  ...
  function initialize(
    ...
    IncentivizedERC20.initialize(pool, underlyingAsset, debtTokenDecimals, debtTokenName, debtTokenSymbol);
  }
