    ...
    /* ========== PUBLIC FUNCTIONS ========== */
     ...
     function mintLambda(
        ...
        if (one_to_one_override || global_collateral_ratio >= PRICE_PRECISION) { 
            ...
            // Algorithmic
            collat_needed = 0;
            uint256 shareToken_missing_decimals = uint256(18).sub(ERC20(LAMBDACONTROLLER.shareToken()).decimals());
            uint256 _lambda_amt = lambda_amt;
            shareToken_needed = _lambda_amt.mul(PRICE_PRECISION).div(getShareTokenPrice()).div(10 ** shareToken_missing_decimals);
        } else { 
            // Fractional
            ...
            uint256 shareToken_missing_decimals = uint256(18).sub(ERC20(LAMBDACONTROLLER.shareToken()).decimals());
            shareToken_needed = lambda_for_shareToken.mul(PRICE_PRECISION).div(getShareTokenPrice()).div(10 ** shareToken_missing_decimals);
        }
        ...
        // console.log("total_lambda_mint:",total_lambda_mint);
        // console.log("collat_needed:",collat_needed);
        // console.log("shareToken_needed:",shareToken_needed);
    ...
    function redeemLambda(
        ...
        if(global_collateral_ratio >= PRICE_PRECISION) { 
            ...
            shareToken_out = lambda_after_fee
                            ...
                            .div(10 ** shareToken_missing_decimals);
            collat_out = 0;
        } else { 
            // Fractional
            collat_out = getLambdaInCollateral(col_idx, lambda_after_fee)
            ...
            shareToken_out = lambda_after_fee
                            ...
                            .div(getShareTokenPrice())
                            .div(10 ** shareToken_missing_decimals); // PRICE_PRECISIONS CANCEL OUT
        }
        ...
        // console.log("shareToken_out:",shareToken_out);
