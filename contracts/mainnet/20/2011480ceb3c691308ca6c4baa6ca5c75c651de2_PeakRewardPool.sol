...
// File: contracts/distribution/PeakRewardPool.sol
...
contract PeakRewardPool {
    ...
    constructor(address _peak, uint256 _poolStartTime) public {
        ...
        epochPeakPerSecond[0] = epochTotalRewards[0].div(4 days);
        epochPeakPerSecond[1] = epochTotalRewards[1].div(5 days);
    ...
    modifier onlyOperator() {
        require(operator == msg.sender, "PeakRewardPool: caller is not the operator");
        _;
    }
