...
contract PixelBOOhoos is ERC721URIStorage, Ownable {
  ...
  modifier isWhitelisted(address _address) {
    if(_privateSale && Counters.current(_tokenIds) < _maxPrivatesale){require(whitelistedAddresses[_address], "You need to be whitelisted");}
  _;
  }
