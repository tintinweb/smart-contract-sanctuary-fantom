...
contract DividendDistributor is IDividendDistributor {
    ...
    address _token;
    IBEP20 POWER = IBEP20(0x131c7afb4E5f5c94A27611f7210dfEc2215E85Ae);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = POWER.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WFTM;
        path[1] = address(POWER);
        ...
        uint256 amount = POWER.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            POWER.transfer(shareholder, amount);
...
contract FluxxFinancial is IBEP20, Auth {
    using SafeMath for uint256;

    address public POWER = 0x131c7afb4E5f5c94A27611f7210dfEc2215E85Ae;
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "FluxxFinancial";
    string constant _symbol = "$FLUXX";
    uint8 constant _decimals = 9;

    uint256 public _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(1);
    uint256 public _maxWallet = _totalSupply.div(3);
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountFTMTreasury = amountFTM.mul(treasuryFee).div(totalFTMFee);
    ...
    function manualSwapBack(uint256 amountToSwap, uint256 base) external payable authorized {
        setSwapBackSettings(true, amountToSwap);
