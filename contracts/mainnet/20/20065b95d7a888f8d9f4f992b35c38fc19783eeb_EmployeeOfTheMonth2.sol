...
// Strive to be the best Employee of the Month... 2 - Hegel

contract EmployeeOfTheMonth2 is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    uint256 private _preMinted = 25;                  // Numbers of tokens that need to be preminted
    mapping(address => UserData) private userData;   // Mapping to save how many tokens each address mints
    uint256 public maxPerWallet = 10000;              // Max amount of tokenIDs allowed to be minted by single wallet
    mapping(address => uint256) public whiteListed;
    mapping (uint256 => string) private _tokenURIs;

    constructor() ERC721("EmployeeOfTheMonth2", "EOTM2") {
