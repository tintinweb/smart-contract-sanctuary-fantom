...
// File: contracts/Nocho.sol



pragma solidity 0.6.12;

contract Nocho is ERC20Burnable, Operator {
    ...
    uint256 public constant INITIAL_TREASURY_WALLET_DISTRIBUTION = 100 ether;
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("NOCHO", "NOCHO") {
