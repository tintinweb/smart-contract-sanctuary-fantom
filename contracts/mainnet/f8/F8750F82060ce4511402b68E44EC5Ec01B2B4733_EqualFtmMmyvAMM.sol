...
// File: contracts/EqualFtmMmyvAMM.sol
...
contract EqualFtmMmyvAMM is Ownable, Pausable {
    ...
    address public constant mmy = address(0x01e77288b38b416F972428d562454fb329350bAc);
    address public want;
    ...
    IEqualizerRouter.Routes[] public wrappedToMmyPath;
    ...
    constructor(
        ...
        IEqualizerRouter.Routes[] memory _wrappedToMmyPath
    ) {
        ...
        for (uint i; i < _wrappedToMmyPath.length; ++i) {
            wrappedToMmyPath.push(_wrappedToMmyPath[i]);
        }
    ...
    function addLiquidity() internal {
        ...
        IEqualizerRouter(unirouter).swapExactTokensForTokens(wrappedHalf, 0, wrappedToMmyPath, address(this), block.timestamp);
        
        uint256 lp0Bal = IERC20(wrapped).balanceOf(address(this));
        uint256 lp1Bal = IERC20(mmy).balanceOf(address(this));

        IEqualizerRouter(unirouter).addLiquidity(wrapped, mmy, stable, lp0Bal, lp1Bal, 1, 1, address(this), block.timestamp);
    }
    ...
    function _removeAllowances() internal {
        ...
        IERC20(mmy).safeApprove(unirouter, 0);
    }
    ...
    function _giveAllowances() internal {
        ...
        IERC20(mmy).safeApprove(unirouter, type(uint).max);
    }
