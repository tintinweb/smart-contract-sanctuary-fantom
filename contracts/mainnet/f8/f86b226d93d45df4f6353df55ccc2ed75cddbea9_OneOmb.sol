...
//  8 `Y8P' 8   8   8 88P' 
//
// 1omb.finance | @1ombfinance | [email protected]
...
contract OneOmb is ERC20Burnable, Operator {
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("1OMB Token", "1OMB") {
