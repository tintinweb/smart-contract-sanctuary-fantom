...
contract BotSquadChickens is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, NonblockingReceiver, ClampedRandomizer {
    modifier onlyDevs() {
    ...
    uint public maxPerPerson = 800;
    uint public price = 30 ether;
    ...
    constructor(
        ...
        uint[] memory _fees,
        address _lzEndpoint
    ) ERC721("Bot Squad Chickens", "BSCS") ClampedRandomizer(maxSupply) {
