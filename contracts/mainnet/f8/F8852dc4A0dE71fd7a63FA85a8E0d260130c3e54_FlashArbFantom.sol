...
contract FlashArbFantom {
    ...
    function dumpOnCurveUnderlying(address curve, int128 i, int128 j) internal returns(uint) {
        address underlying = CurveLike(curve).coins(uint(i));
        uint swapAmount = IERC20(underlying).balanceOf(address(this));
        IERC20(underlying).approve(curve, swapAmount);
    ...
    function dumpRenBTCToWBTC() public returns(uint) {
        return dumpOnCurve(0x3eF6A01A0f81D6046290f3e2A8c5b843e738E604, 0, 1);
    }
    ...
    function dumpUSDCToFrax() public returns(uint) {
        return dumpOnCurveUnderlying(0x7a656B342E14F745e2B164890E88017e27AE7320, 2, 0);
    }

    function dumpUSDCToDai() public returns(uint) {
        return dumpOnCurveUnderlying(0x7a656B342E14F745e2B164890E88017e27AE7320, 2, 1);
    }
