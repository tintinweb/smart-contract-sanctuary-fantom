...
// File: contracts/EqualFtmMagikvAMM.sol
...
contract EqualFtmMagikvAMM is Ownable, Pausable {
    ...
    address public constant magik = address(0x87a5C9B60A3aaf1064006FE64285018e50e0d020);
    address public want;
    ...
    IEqualizerRouter.Routes[] public wrappedToMagikPath;
    ...
    constructor(
        ...
        IEqualizerRouter.Routes[] memory _wrappedToMagikPath
    ) {
        ...
        for (uint i; i < _wrappedToMagikPath.length; ++i) {
            wrappedToMagikPath.push(_wrappedToMagikPath[i]);
        }
    ...
    function addLiquidity() internal {
        ...
        IEqualizerRouter(unirouter).swapExactTokensForTokens(wrappedHalf, 0, wrappedToMagikPath, address(this), block.timestamp);
        
        uint256 lp0Bal = IERC20(wrapped).balanceOf(address(this));
        uint256 lp1Bal = IERC20(magik).balanceOf(address(this));

        IEqualizerRouter(unirouter).addLiquidity(wrapped, magik, stable, lp0Bal, lp1Bal, 1, 1, address(this), block.timestamp);
    }
    ...
    function _removeAllowances() internal {
        ...
        IERC20(magik).safeApprove(unirouter, 0);
    }
    ...
    function _giveAllowances() internal {
        ...
        IERC20(magik).safeApprove(unirouter, type(uint).max);
    }
