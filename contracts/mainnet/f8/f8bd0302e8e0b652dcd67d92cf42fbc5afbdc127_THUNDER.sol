...
contract THUNDER is IERC20, Auth {
	...
	address payable private _ethTaxWallet1 = payable(0x773A9614Ce626B4596E96658143c06ec2D886d6b); 
	address payable private _ethTaxWallet2 = payable(0x773A9614Ce626B4596E96658143c06ec2D886d6b); 
	address payable private _ethTaxWallet3 = payable(0x773A9614Ce626B4596E96658143c06ec2D886d6b); 
	address private _tokenTaxWallet = address(0x3Bf63C225FF03ceA403306B58fe6107a800e1eA6); 
	bool private _inTaxSwap = false;
	address private constant _uniswapV2RouterAddress = address(0x045312C737a6b7a115906Be0aD0ef53A6AA38106); // UniswapV2 for ETH
