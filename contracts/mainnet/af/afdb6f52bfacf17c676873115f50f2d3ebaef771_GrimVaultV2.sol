...
// File: contracts/interfaces/IBeethovenXStrat.sol

pragma solidity 0.8.4;


interface IBeethovenXStrat { 
...
contract GrimVaultV2 is ERC20, Ownable, ReentrancyGuard {
    ...
    IBeethovenXStrat public strategy;
    ...
    function balance() public view returns (uint) {
        return want().balanceOf(address(this)) + IBeethovenXStrat(strategy).balanceOf();
    }
    ...
    function proposeStrat(address _implementation) public onlyAdmin {
        require(address(this) == IBeethovenXStrat(_implementation).vault(), "!Valid proposal");
    ...
    function upgradeStrat() public onlyAdmin {
        ...
        strategy = IBeethovenXStrat(stratCandidate.implementation);
