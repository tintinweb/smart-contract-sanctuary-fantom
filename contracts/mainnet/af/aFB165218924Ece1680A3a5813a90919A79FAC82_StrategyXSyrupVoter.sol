...
interface IXChef {
    ...
    function userInfo(uint256 pid, address user) external view returns (uint256, uint256, uint256, uint256);
    function poolInfo(uint256 pid) external view returns (
        address RewardToken,
        uint256 userLimitEndTime,
        uint256 TokenPrecision,
        uint256 xBooStakedAmount,
        uint256 mpStakedAmount,
        uint256 RewardPerSecond,
        uint256 accRewardPerShare,
        uint256 accRewardPerShareMagicat,
