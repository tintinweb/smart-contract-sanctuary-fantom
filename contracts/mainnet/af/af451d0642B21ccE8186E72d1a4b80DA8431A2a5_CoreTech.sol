...
contract CoreTech is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Core Tech';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x63a01ef3F73ACc894644D7bA933Edf5A015F38Bf, 'We can not exclude router.');
