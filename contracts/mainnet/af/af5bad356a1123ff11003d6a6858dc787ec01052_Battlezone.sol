    ...
    */
    function callWinner(
        ...
        if (_winner) {
            ...
            attacker.exp += 8; //8 points exp for winner
            ...
            defender.exp += 2; //2 points exp for loser
            ...
            defender.exp += 8; //8 points exp for winner
            ...
            attacker.exp += 2; //2 points exp for loser
