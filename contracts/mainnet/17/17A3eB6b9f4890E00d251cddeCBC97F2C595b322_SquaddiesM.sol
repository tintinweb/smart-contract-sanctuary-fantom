...
contract SquaddiesM is ERC721Enumerable, ERC721Royalty, Ownable {
    using Strings for uint256;
    using Address for address;
    ...
    constructor() ERC721("Squaddies - Male", "SQUADM") {
        // set up the royalty payment splitter
        royaltyReceiver = IPaymentSplitter(0xd1c3Be3EA847c5B74aE1f91AaBDe8e227611CCcD.clone());
        royaltyReceiver.initialize(); // initialize
        royaltyReceiver.addPayee(0x7308373D971eb4f328905893FEE68BDc6227a020, 95); // 95%
        royaltyReceiver.addPayee(_msgSender(), 5); // 5%
    ...
    /**
     * @dev Performs an airdrop to the specified address for the specified count
     */
    ...
    function takeSnapshot() public onlyOwner onlySnapshotNotCompleted {
        ...
        SNAPSHOT = IERC721Snapshot(0xe3c14031168C490c6f3757c992F71AbE110bC0F1.clone());
