...
import "./SolidexVaultToken.sol";
import "./interfaces/ISolidexVaultTokenFactory.sol";

contract SolidexVaultTokenFactory is Ownable, ISolidexVaultTokenFactory {
        ...
        returns (address vaultToken)
    {
        ...
        bytes memory bytecode = type(SolidexVaultToken).creationCode;
        assembly {
            vaultToken := create2(0, add(bytecode, 32), mload(bytecode), _underlying)
        }
        SolidexVaultToken(vaultToken)._initialize(
            _underlying,
            optiSwap,
            router,
            lpDepositor,
...
import "./interfaces/IBaseV1Pair.sol";
import "./interfaces/ISolidexVaultToken.sol";
...
contract SolidexVaultToken is ISolidexVaultToken, PoolToken {
...
interface ISolidexVaultTokenFactory {
