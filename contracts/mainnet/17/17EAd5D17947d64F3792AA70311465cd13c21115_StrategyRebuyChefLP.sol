...
contract StrategyRebuyChefLP is StratManager, FeeManager, GasThrottler {
    ...
    address[] public outputToBuybackRoute;
    ...
    constructor(
        ...
        address[] memory _outputToBuybackRoute,
        address _rebuyToken
        ...
        outputToBuybackRoute = _outputToBuybackRoute;
    ...
    function chargeFees(address callFeeRecipient) internal {
        ...
        IUniswapRouterETH(unirouter).swapExactTokensForTokens(rebuyAmount, 0, outputToBuybackRoute, BURN_ADDR, now);
