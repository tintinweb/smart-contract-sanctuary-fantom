...
interface WIGOFactory {
    function createPair(address tokenA, address tokenB) external returns (address pair);
}

interface WIGORouter {
...
contract It1 is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        router = WIGORouter(_router);
        pair = WIGOFactory(router.factory()).createPair(WFTM, address(this));
...
//        emit Transfer(sender, recipient, amount);
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityFTM{value: amountFTMLiquidity}(
                address(this),
                amountToLiquify,
                0,
                0,
