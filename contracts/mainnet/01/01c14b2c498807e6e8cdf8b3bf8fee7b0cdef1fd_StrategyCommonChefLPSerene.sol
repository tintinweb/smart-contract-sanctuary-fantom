...
contract StrategyCommonChefLP is StratManager, FeeManager {
    ...
    address public dao = 0x4B4E90970c7603ecAF6cdd5223ac12b4375Bed98;
    ...
    function chargeFees(address callFeeRecipient) internal {
        uint256 feeAmount = IERC20(output).balanceOf(address(this)).mul(fee).div(1000).div(2);
        IUniswapRouterETH(unirouter).swapExactTokensForTokens(feeAmount, 0, outputToSereneRoute, address(this), now);
