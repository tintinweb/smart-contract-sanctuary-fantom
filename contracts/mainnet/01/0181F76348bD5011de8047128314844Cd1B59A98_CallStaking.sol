...
contract CallStaking is Ownable, ReentrancyGuard {
  ...
  function withdraw(uint256 amount) external nonReentrant {
    ...
    uint256 amountToWithdraw = amount + rewards > balance ? balance : amount + rewards;
    uint256 feeAmount = amountToWithdraw * serviceFee / 10000;
  ...
  function withdrawAll() external nonReentrant {
    ...
    uint256 amountToWithdraw = stakeItem.amount + rewards > balance ? balance : stakeItem.amount + rewards;
    uint256 feeAmount = amountToWithdraw * serviceFee / 10000;
    amountToWithdraw = amountToWithdraw - feeAmount;
