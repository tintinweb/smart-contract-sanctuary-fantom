...
contract BAY is Context, IERC20, Ownable {
    ...
    string private constant _name = 'BAY';
    string private constant _symbol = 'MoonMaster';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x5F6bE67FcA4d4e0BedA1d308F61f4dF7A4745A33, 'We can not exclude router.');
