...
// File contracts/BIFI/strategies/Beethovenx/StrategyBeethovenxSpookyRouter.sol
...
contract StrategyBeethovenxSpookyRouter is StratFeeManager, GasFeeThrottler {
    ...
    function callReward() public view returns (uint256) {
        ...
        uint256 nativeOut;
        if (outputBal > 0) {
            uint256[] memory amountOut = IUniswapRouterETH(spookyRouter).getAmountsOut(outputBal, inputToNativeRoute);
    ...
    function _giveAllowances() internal {
        ...
        IERC20(input).safeApprove(spookyRouter, type(uint256).max);
    ...
    function _removeAllowances() internal {
        ...
        IERC20(input).safeApprove(spookyRouter, 0);
        IERC20(output).safeApprove(unirouter, 0);
    }
