...
import "../BeetxStrategyWithBeluga.sol";

contract StrategyBeetx_BPT_CORAL is BeetXStrategy {
    ...
    function initializeStrategy(
        ...
        address coral_lp = address(0xC7f084bCB91F779617B41602f85102849098D6a2);
        ...
        bytes32 bpt_pool_id = 0xc7f084bcb91f779617b41602f85102849098d6a2000200000000000000000023;
        __Strategy_init(
            _store,
            coral_lp,
            _vault,
...
/// @notice A strategy for BeethovenX LP farm pools.s

contract BeetXStrategy is BaseUpgradeableStrategy {
    using SafeERC20 for IERC20;

    address public constant wftm = address(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83);
    bytes32 public constant beetsFtmPoolId = 0xcde5a11a4acb4ee4c805352cec57e236bdbc3837000200000000000000000019;
    ...
    public initializer {
        ...
        (IERC20[] memory tokens,, ) = IBalancerVault(_bVault).getPoolTokens(_rewardToDepositPoolID);
    ...
    */ 
    ...
    function _swapRewardToDeposit() internal {
        _swap(beetsFtmPoolId, rewardToken(), wftm);
    }

    function _swap(bytes32 _poolId, address _tokenIn, address _tokenOut) internal {
        uint256 inBalance = IERC20(rewardToken()).balanceOf(address(this));
        ...
        if(inBalance > 0) {
            ...
            IERC20(_tokenIn).safeApprove(bVault(), 0);
            IERC20(_tokenIn).safeApprove(bVault(), inBalance);
    ...
    */
    function _liquidateReward() internal {
        ...
        // Notify fees.
        _notifyProfitInToken(rewardToken(), rewardBalance);
    ...
    function _notifyProfitInToken(address _token, uint256 _rewardBalance) internal {
        if( _rewardBalance > 0 ){
            ...
            IERC20(_token).safeApprove(controller(), 0);
            IERC20(_token).safeApprove(controller(), feeAmount);
