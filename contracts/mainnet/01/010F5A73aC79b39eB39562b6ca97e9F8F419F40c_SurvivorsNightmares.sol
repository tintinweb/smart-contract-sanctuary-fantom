/**
 *Submitted for verification at FtmScan.com on 2023-01-06
*/
...
contract SurvivorsNightmares is ERC721  {
    ...
    constructor()
        ERC721("Survivors: Nightmares FTM", "SUNTF")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeib5kuujb4i5mclagmkztzfegyn5sedpwlvuwqgig22qfrugp5ga7e/", Strings.toString(tokenId), ".json")
            );
    }
