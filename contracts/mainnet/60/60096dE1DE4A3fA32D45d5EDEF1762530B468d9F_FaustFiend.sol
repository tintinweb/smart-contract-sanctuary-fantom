...
contract FaustFiend is ERC721, Ownable {
    event Minted(address indexed _from, address to, uint256 tokenId);
    ...
    constructor(string memory _initialBaseURI) ERC721("FAUST Fiend", "FIEND") {
    ...
    /**
         ...
         */
    function mintTokenFor(address to, uint256 tokenId)
    external
    onlyOwner
    callerNotAContract
    {
        _mintTokenFor(to, tokenId);
    }

    function _mintTokenFor(address to, uint256 tokenId)
    internal
    virtual
    {
        require(to != address(0), "ERC721: mint to the zero address");
        require(tokenId > 0, "Token ID must be greater than 0");
        require(tokenId <= maxTokens, "Token ID must be less than or equal to max supply");
    ...
    function getAvailableTokens() external view returns (uint256) {
        return maxTokens - totalMintedTokens;
    }
