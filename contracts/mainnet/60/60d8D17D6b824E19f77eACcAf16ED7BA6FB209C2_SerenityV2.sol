...
contract SerenityV2 is ERC20, ERC20Burnable, Pausable, Ownable, Operator {
    ...
    constructor(uint256 _upgradeRatio, address _tokenToUpgrade) ERC20("Serenity V2", "SERENE") {
