...
// 8BALL FINANCE
contract EightBall is ERC20Burnable, Operator {
    using SafeMath8 for uint8;
    using SafeMath for uint256;

    // Supply used to launch in Genesis
    uint256 public constant INITIAL_LAUNCH_DISTRIBUTION = 40000 ether;
    // Distribution for Treasury wallet
    uint256 public constant INITIAL_TREASURY_FUND = 10000 ether;

    // Have the rewards been distributed to the pools
    bool public rewardPoolDistributed = false;

    /**
     * @notice Constructs the 8BALL ERC-20 contract.
     */
    constructor() public ERC20("8BALL Token", "8BALL") {
        _mint(msg.sender, 1 ether);
    }

    /**
     * @notice Operator mints 8BALL to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of 8BALL to mint to
    ...
    function distributeReward(
        ...
        _mint(_airdropAddress, INITIAL_TREASURY_FUND);
    }
