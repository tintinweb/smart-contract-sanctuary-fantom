...
contract StrategySolidexVolatileCre8rBombLp is StrategySolidexFarmLPBase {
    // Token addresses
    address public cre8r_bomb_lp = 0x1535f51b5EC4B74Bd4D403118937F7fb638aE5b1;
    ...
    {
        swapRoutes[cre8r].push(route(wftm, cre8r, false));
    ...
    function getName() external pure override returns (string memory) {
        return "StrategySolidexVolatileCre8rBombLp";
    }
}
