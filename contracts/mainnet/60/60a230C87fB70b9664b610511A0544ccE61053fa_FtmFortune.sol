...
contract FtmFortune {
    ...
    uint256 public constant MIN_AMOUNT = 20 ether;
    ...
    constructor(
        ...
        plans.push(Plan(10, 1258));
        plans.push(Plan(16, 1143));
        plans.push(Plan(21, 1236));
        plans.push(Plan(26, 1274));
        plans.push(Plan(10, 2418));
        plans.push(Plan(16, 2056));
        plans.push(Plan(21, 1808));
        plans.push(Plan(26, 1586));
    }
