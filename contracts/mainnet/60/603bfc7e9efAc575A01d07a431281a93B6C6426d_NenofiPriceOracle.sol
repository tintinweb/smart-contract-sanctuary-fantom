...
// File: contracts/NenofiPriceOracle.sol
...
contract NenofiPriceOracle {
    ...
    // NOTE: IUniswapV2Pair
    constructor(address _pair, string memory _name) public {
        name = _name;
    ...
    function update() external {
        ...
        if(timeElapsed >= PERIOD){
            ...
            exchangeRate = consult(0x7381eD41F6dE418DdE5e84B55590422a57917886, 1e18);
        }
