...
import "../MasonryContracts/IERC20.sol";
import "../MasonryContracts/SafeERC20.sol";
import "../MasonryContracts/ContractGuard.sol";
import "../MasonryContracts/IBasisAsset.sol";
import "../MasonryContracts/ITreasury.sol";
import "../MasonryContracts/SafeMath.sol";
...
contract Masonry is DaoWrapper, ContractGuard {
    using SafeERC20 for IERC20;
    ...
    function getDaoPrice() external view returns (uint256) {
        return treasury.getDaoPrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            _dao.safeTransfer(msg.sender, reward);
        ...
        onlyOperator
    {
        ...
        _dao.safeTransferFrom(msg.sender, address(this), amount);
