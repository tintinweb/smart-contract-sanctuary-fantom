...
/*
    FantomCat represents the revival of the FTM blockchain in 2023. 
    https://fantomcat.co/
    https://t.me/FantomCatFTM
    https://twitter.com/FantomCatFTM
*/
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
    ...
    constructor(){
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xF491e7B69E4244ad4002BC14e878a34207E38c29);// IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); 
...
contract FCAT is ERC20, Ownable {
    ...
    constructor() ERC20("FantomCat", "FCAT") {

        uint256 totalSupply = 1000000000000000 * 1e18;
        
        maxTransactionAmount = totalSupply * 125 / 10000; // 1.25% maxTransactionAmount
        swapTokensAtAmount = totalSupply * 10 / 10000; // 0.1% swap tokens amount
        maxWallet = totalSupply * 125 / 10000; // 1.25% Max wallet
        ...
        marketingRatio = 5;
        liquidityRatio = 0;
        totalRatio = rewardsRatio + marketingRatio + liquidityRatio; 

    	dividendTracker = new DividendTracker();
        marketingWallet = address(0xA8DdB870980eF7B5Ede32E8c13cdD1C87fa624CC);
        liquidityWallet = address(0xA8DdB870980eF7B5Ede32E8c13cdD1C87fa624CC);
    ...
    function updateRatios(uint256 _rewardsRatio, uint256 _marketingRatio, uint256 _liquidityRatio) external onlyOwner {
    ...
    function updateFees(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        buyFee = _buyFee;
        sellFee = _sellFee;
        require(buyFee + sellFee < 400, "40% rountrip max");
    }
    ...
    function updateGasForProcessing(uint256 newValue) external onlyOwner {
        require(newValue <= 500000, " gasForProcessing must be less than 500,000");
    ...
    function swapBack() private {
        ...
        uint256 liquidityTokens = (contractBalance * liquidityRatio) / totalRatio / 2;
        ...
        uint256 ethForLiquidity = ethBalance.sub(ethForRewards).sub(ethForMarketing);
    ...
    function setSwapThreshold(uint256 newamt) external onlyOwner {
