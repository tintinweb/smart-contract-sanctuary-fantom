...
contract FLDPresaleContract is Ownable, Pausable {

    IERC20 public prFLDToken;
    IERC20 public usdcToken;

    address public immutable devWallet = 0x5DD7F79f5fF016fE438C4495861596BD3e3C2fd3;
    uint256 public totalSold;
    uint256 public tokenPriceInUSD = 4 * 10**18; // $4 per token
    uint256 public maxPurchase = 250 * 10**18; // 250 prFLD per Wallet
    uint256 public minPurchase = 250 * 10**18; // 250 prFLD 
    bool public isClaimRefundEnabled = false; 

    uint256 public totalAllocation = 15000 * 10**18; // 15k prFLD tokens
    ...
    */    
    ...
    function whitelist(address _wallet, bool _status) external onlyOwner { 
