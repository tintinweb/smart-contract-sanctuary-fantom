...
interface ITreasury {
    ...
    function getleprechaunPrice() external view returns (uint256);
...
*/
contract mint is ShareWrapper, ContractGuard {
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;
    ...
    function getleprechaunPrice() external view returns (uint256) {
        return treasury.getleprechaunPrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            leprechaun.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        leprechaun.safeTransferFrom(msg.sender, address(this), amount);
