...
contract NFTGContagionsByAspenth is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string public baseURI;
  uint256 public cost = 27 ether;
  uint256 public maxSupply = 2040;
  uint256 public maxMintAmount = 5;
  uint256 public presaleStart = 1646938800;
  uint256 public saleStart = 1646938800;
  address private devAddress = 0xB106c39D2408c15D750f21797e232890E7C3eBEc;
  address private partyAddress = 0xB11eacc17bd735854D9d89BEE9EFE1D6b7e0B9Bf;
  ...
  function reserveForGiveaway(address giveawayAddress, uint256 amount) public onlyOwner {
    ...
    for (uint256 i = 1; i <= amount; i++) {
      _safeMint(giveawayAddress, supply + i - 1);
    }
  }
    ...
    returns (string memory)
  {
    ...
    string memory websiteBaseURI = "https://api1.nftgarage.world/serve/assets/contagions/metadata/";
