...
contract test is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("test", "WC") {
    _customBaseURI = 'https://gateway.pinata.cloud/ipfs//';
    _price = 1 ether; // 1 FTM mint price 
