...
contract TestFluid is ERC20Permit, AccessControl {

	/* ========== STATE VARIABLES ========== */

	string public constant symbol = "TFLUID";
    string public constant name = "TestFluid";
	...
	constructor(address governance) ERC20Permit(name) {
		_mint(msg.sender, 0);
