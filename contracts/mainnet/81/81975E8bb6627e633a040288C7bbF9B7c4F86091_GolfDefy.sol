...
contract GolfDefy is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 95000 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'Golf Defy';
    string private constant _symbol = 'GOLF';

    uint256 private _taxFee = 700;
    uint256 private _burnFee = 0;
    uint public max_tx_size = 95000 ether;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xd81fd0F13951E45864b8A67A25A620c5a31428A2, 'We can not exclude router.');
