...
contract FOPA is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "FOPA";
    string private _symbol = "FOPA";
    ...
    address payable public marketingWallet = payable(0x118D6A4f12608a88b5b69cF0579c75D479697917);
