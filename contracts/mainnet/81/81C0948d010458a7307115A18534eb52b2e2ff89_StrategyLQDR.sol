...
import "../../interfaces/lqdr/ILQRDMasterChefV2.sol";
...
contract StrategyLQDR is StratManager, FeeManager {
    ...
    function deposit() public whenNotPaused {
        ...
        if (pairBal > 0) {
            ILQRDMasterChefV2(masterChefV2).deposit(poolId, pairBal, msg.sender);
    ...
    function withdraw(uint256 _amount) external {
        ...
        if (pairBal < _amount) {
            ILQRDMasterChefV2(masterChefV2).withdraw(poolId, _amount, msg.sender);
    ...
    function _harvest(address callFeeRecipient) internal whenNotPaused {
        ILQRDMasterChefV2(masterChefV2).deposit(poolId, 0, msg.sender);
    ...
    function balanceOfPool() public view returns (uint256) {
        (uint256 _amount, ) = ILQRDMasterChefV2(masterChefV2).userInfo(
            poolId,
            vault
        );
        return _amount;
    ...
    function rewardsAvailable() public view returns (uint256) {
        return
            ILQRDMasterChefV2(masterChefV2).pendingLqdr(poolId, address(this));
    }
    ...
    function retireStrat() external {
        ...
        ILQRDMasterChefV2(masterChefV2).emergencyWithdraw(poolId, msg.sender);
    ...
    function panic() public onlyOwner {
        pause();
        ILQRDMasterChefV2(masterChefV2).withdraw(poolId, balanceOfPool(), msg.sender);
    }
    ...
    function anualReward() external view returns (uint256) {
        return
            ILQRDMasterChefV2(masterChefV2)
                .lqdrPerBlock()
                .mul(3600)
                .mul(24)
                .mul(365);
