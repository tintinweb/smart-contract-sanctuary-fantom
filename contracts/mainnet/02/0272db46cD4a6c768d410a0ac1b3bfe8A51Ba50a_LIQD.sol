...
contract LIQD is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x639670bEc0d40fD8A32e2f591C956dEDeb880FA3); // Marketing Address
    ...
    string private _name = "LIQD";
    string private _symbol = "LIQD";
