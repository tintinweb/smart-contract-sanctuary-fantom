...
contract Vault is VaultAuthorization, FlashLoans, Swaps {
    ...
    function setProtocolFeesCollector(IProtocolFeesCollector newFeeCollector) external override nonReentrant authenticate{
        _setProtocolFeesCollector(newFeeCollector);
    }
