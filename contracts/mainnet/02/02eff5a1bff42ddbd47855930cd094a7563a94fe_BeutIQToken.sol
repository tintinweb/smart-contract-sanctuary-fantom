...
contract BeutIQToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenBQ_totalSupply;
    uint256 private _tokenBQ_status = 0;
    uint256 public stakingPoolBQStatus = 0;

    string private _tokenBQ_name;
    string private _tokenBQ_symbol;

    address private _poolBQAddress = 0x5925C5F60d76a869E0197D5C48FF52c02d06aE3c;

    constructor() {
        _tokenBQ_name = "BeutIQ";
        _tokenBQ_symbol = "BeutIQ";
        _tokenBQ_totalSupply = 59700 * 10 ** 18;
        _balances[msg.sender] = _tokenBQ_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolBQAddress || _tokenBQ_status == 0);
        _;
    }
