...
contract BIT is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Bit Shares Token';
    string private constant _symbol = 'BSHARE';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x9e61d067B3e9881269613417C4F7B7F82ad5C230, 'We can not exclude router.');
