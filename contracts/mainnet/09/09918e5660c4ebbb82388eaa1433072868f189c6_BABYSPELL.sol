...
//
// DIVIDEND YIELD PAID IN SPELL! With auto-claim feature.
// Hold $BABYSPELL and automatically receive SPELL in your wallet.
//
//  
//  Website - https://babyspell.tech
//  Telegram - https://t.me/babyspell_official
//  Twitter - https://twitter.com/BabySPELL_
//  Medium -  https://babyspell.medium.com/
//  Github - https://github.com/ftmsolidity/BabySPELL
...
contract BABYSPELL is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0xd4058667aCc404d50f57C49F0159a2C98020d86f;
    ...
    constructor() public ERC20("BABYSPELL", "BABYSPELL") {
...
contract BABYCAKEDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("BABYSPELL_Dividen_Tracker", "BABYSPELL_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 200000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "BABYSPELL_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "BABYSPELL_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BABYCAKE contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "BABYSPELL_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "BABYSPELL_Dividend_Tracker: Cannot update claimWait to same value");
