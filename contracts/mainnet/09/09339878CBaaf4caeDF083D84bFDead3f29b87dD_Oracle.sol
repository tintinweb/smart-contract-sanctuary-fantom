...
contract Oracle is AccessControl, IOracle {
    ...
    function setPriceSource(address collateral, address priceSource) external onlyRole(SETTER_ROLE) {
        ...
        returns (uint256)
    {
        ...
        require(priceSources[collateral] != address(0), "Oracle: PRICE_SOURCE_NOT_FOUND");
        ...
        require(
            IMuonV02(muon).verify(signature.reqId, uint256(hash), signature.sigs),
