...
contract FBonk is Context, IERC20, Ownable {
    ...
    // Spooky Swap UniswapV2 ROUTER for FANTOM OPERA network
    ...
    uint256 private _maxTxAmount = 500_000_000e18;
    ...
    error ERC20_transfer_amount_exceeds_allowance();
    error ERC20_decreased_allowance_below_zero();
    ...
    function transferFrom(
        ...
        if (_allowances[sender][_msgSender()] < amount)
            revert ERC20_transfer_amount_exceeds_allowance();
    ...
    function decreaseAllowance(
        ...
        if (_allowances[_msgSender()][spender] < subtractedValue)
            revert ERC20_decreased_allowance_below_zero();
        _approve(
            _msgSender(),
            spender,
    ...
    function excludeAccount(address account) external onlyOwner {
        require(
            account != uniswapV2RouterAddress,
    ...
    function _getTValues(
        ...
        uint256 tCharity = (tAmount * charityFee) / 100;
        uint256 tTransferAmount = tAmount - tFee - tCharity;
    ...
    function _setFBonkFee(uint256 charityFee) external onlyOwner {
        require(
    ...
    function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner {
        require(maxTxAmount >= 5e18, "maxTxAmount should be greater than 5e18");
