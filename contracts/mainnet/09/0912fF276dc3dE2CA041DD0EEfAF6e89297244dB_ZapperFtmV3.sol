...
contract ZapperFtmV3 is MatrixSwapHelperV2, Ownable {
    using SafeERC20 for IERC20;
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    address internal constant SPOOKY_ROUTER = 0xF491e7B69E4244ad4002BC14e878a34207E38c29;
    address internal constant WIGO_ROUTER = 0x5023882f4D1EC10544FCB2066abE9C1645E95AA0;
    address internal constant EQUALIZER_ROUTER = 0x1A05EB736873485655F29a37DEf8a0AA87F5a447;
    address internal constant BASED_ROUTER = 0xaf2098E3AF3AC27a3a9362ACa2D883eFC36c7FAC;
    ...
    constructor() MatrixSwapHelperV2(SPOOKY_ROUTER) {
        // Factory to Router
        // spookyswap
        factoryToRouter[0x152eE697f2E276fA89E96742e9bB9aB1F2E61bE3] = SPOOKY_ROUTER;
        routerToType[SPOOKY_ROUTER] = MatrixSwapHelperV2.RouterType.UniV2;

        // wigoswap
        factoryToRouter[0xC831A5cBfb4aC2Da5ed5B194385DFD9bF5bFcBa7] = WIGO_ROUTER;
        routerToType[WIGO_ROUTER] = MatrixSwapHelperV2.RouterType.UniV2;

        // based
        factoryToRouter[0x407C47E3FDB7952Ee53aa232B5f28566A024A759] = BASED_ROUTER;
        routerToType[BASED_ROUTER] = MatrixSwapHelperV2.RouterType.UniV2;

        // equalizer
        factoryToRouter[0xc6366EFD0AF1d09171fe0EBF32c7943BB310832a] = EQUALIZER_ROUTER;
        routerToType[EQUALIZER_ROUTER] = MatrixSwapHelperV2.RouterType.Solidly;

        // pushing routers
        routers.push(SPOOKY_ROUTER);
        routers.push(WIGO_ROUTER);
        routers.push(EQUALIZER_ROUTER);
        routers.push(BASED_ROUTER);

        // setup already known ones
        customRouter[0x8418BAb773ABF430907b39B7dB6A6F8318A9210e] = EQUALIZER_ROUTER;
        customRouter[0x11a0779eA92176298b7A2760AE29fC9Ce1aD47b4] = EQUALIZER_ROUTER;
        customRouter[0x3d6c56f6855b7Cc746fb80848755B0a9c3770122] = EQUALIZER_ROUTER;
        customRouter[0x76fa7935a5AFEf7fefF1C88bA858808133058908] = EQUALIZER_ROUTER;
        customRouter[0xD3c3E365d84Fc4e7e66244E00e5E2271176FF61E] = EQUALIZER_ROUTER;
        customRouter[0x783A3Fb9F88dF5A89fB3a5e595254Fa8f7b97b48] = EQUALIZER_ROUTER;
        customRouter[0xDc935Ffe9f9C972B7b304E0b7E61Eb774037E394] = EQUALIZER_ROUTER;
        customRouter[0xFfE9C27F0a12dABe5c5Bd46D144a5c0140725566] = EQUALIZER_ROUTER;
        customRouter[0x7547d05dFf1DA6B4A2eBB3f0833aFE3C62ABD9a1] = EQUALIZER_ROUTER;
        customRouter[0xE3bD349BDb8203C15426b2d273f57568E658F843] = EQUALIZER_ROUTER;
        customRouter[0x558DCA97c224851Cf428cbF244bEC0b897642efC] = EQUALIZER_ROUTER;
        customRouter[0x0272A69b9f7D12489E0E0C756cD645E538A00DDE] = EQUALIZER_ROUTER;
        customRouter[0xDA3E21477F872F30794551D908DE244b8839F723] = EQUALIZER_ROUTER;
        customRouter[0x0f03efdce7A8cE08c238b1a0B5425Fb63Bd44b38] = EQUALIZER_ROUTER;
        customRouter[0x6eB4Eb157C3e6f0576b8ba3C88e8C5D2e6E81D17] = EQUALIZER_ROUTER;
        customRouter[0xe00D5e6535fb48E83C8cabe602242Cc1Bd253cEA] = EQUALIZER_ROUTER;
        customRouter[0x0995F3932B4Aca1ED18eE08D4B0DCf5f74B3c5D3] = EQUALIZER_ROUTER;
    }
