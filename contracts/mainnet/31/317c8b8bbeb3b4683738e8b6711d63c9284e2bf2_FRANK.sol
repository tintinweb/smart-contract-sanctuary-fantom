...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x234A4D8A251787a3B5f57558e2339e85965b6e0a); // Ghost
...
contract FRANK is IBEP20, Auth {
    ...
    address EP = 0x234A4D8A251787a3B5f57558e2339e85965b6e0a; // Ghost
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "GhostPrinter";
    string constant _symbol = "GHOSTp";
