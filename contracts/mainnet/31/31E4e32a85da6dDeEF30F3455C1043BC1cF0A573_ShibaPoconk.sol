...
contract ShibaPoconk is Context, IERC20, Ownable {
    ...
    string private constant _name = 'ShibaPoconk';
    string private constant _symbol = 'SCONK';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xa5f7f7109a5368c0F9Ed44F7b25EBD805F2d9aB9, 'We can not exclude router.');
