    ...
    SpookyVerseImplementationPointer
{
    ...
    address[] public feeAddresses = [
        address(0x60499b24887298D10Da2b7d55c8eCDAF1eDCbB04), // Treasury investments (65%)
        // 35% / 4 :
        address(0x57d26B22b8A1d64eB165a2847AAe17D5aEF1F44d), // Dev 1 (8.75%)
        address(0x79f34Ef96a8c7b5cF52a42E8d16dC3c3288D3931), // Dev 2 (8.75%)
        address(0x62A71A916C7405409668ad416beD8264871A8DB0), // Dev 3 (8.75%)
        address(0x99151AFFd14A6dCAB7967e7a5600cd1102b12e8c) // Dev 4 (8.75%)
    ];
    ...
    function createPairWith(address path1, address path2) private returns (IPair) {
