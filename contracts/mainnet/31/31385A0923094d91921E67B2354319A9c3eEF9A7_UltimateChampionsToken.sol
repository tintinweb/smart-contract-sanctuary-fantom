...
contract UltimateChampionsToken is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Ultimate Champions Token';
    string private constant _symbol = 'CHAMP';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xA5fa96e0302b851955a45ade5547099A3E2eed28, 'We can not exclude router.');
