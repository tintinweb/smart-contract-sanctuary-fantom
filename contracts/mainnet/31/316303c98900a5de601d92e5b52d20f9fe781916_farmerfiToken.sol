...
/**
  ...
  @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ...
    3% fee auto add to the liquidity pool to lock forever when selling
    2% fee auto distribute to all holders
    3% fee auto swaped with BNB and move to farmerfi Investment fund

    When sell token:
    2% fee auto burn

    When buy token:
    3% fee auto swaped with BNB and move to donation wallet.
...
contract farmerfiToken is Ownable, IBEP20 {
    ...
    address private _ownerAddress = payable(0xf3D9657f9D1f50f290f605e3cCB6C3C51F1B385B);

    // Address of farmerfi Investment Fund
    address private _farmerfiInvestmentFund = payable(0xcA6311fF30C9f87d2B4288f838F4870F5A26F201);

    // Address of marketing and dev
    address private _marketingDev = payable(0xcA6311fF30C9f87d2B4288f838F4870F5A26F201);

    // Address of farmerfi AR Game
    address private _farmerfiArGame = payable(0xcA6311fF30C9f87d2B4288f838F4870F5A26F201);

    // Address of Service for sale
    address private _service = payable(0xcA6311fF30C9f87d2B4288f838F4870F5A26F201);
    ...
    string public _name = "Rocky";
    string public _symbol = "Rky";
    uint8 private _decimals = 10;

    uint256 private _distributeFee = 2;
    uint256 private _fundOrBurnFee = 2;
   ...
   constructor () {
    ...
    // (Fantom mainnet) 0xF491e7B69E4244ad4002BC14e878a34207E38c29
    IPancakeRouter02 _pancakeRouter = IPancakeRouter02(0xF491e7B69E4244ad4002BC14e878a34207E38c29);
    ...
    address _pancakeFactory = payable(0xc35DADB65012eC5796536bD9864eD8773aBc74C4);
    ...
    _isExcludedFromFee[_farmerfiInvestmentFund] = true;
    _isExcludedFromFee[_marketingDev] = true;
    _isExcludedFromFee[_farmerfiArGame] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(from != owner() && to != owner()) {
            ...
            require(_tokenOwned[to] + amount <= _maxTokenHold, "Recipient's wallet will exceed max token hold 500,000,000 farmerfi with your amount");
        }
    ...
    function swapAndLiquify(uint256 contractTokenBalance, uint256 donateFund, uint256 donateDev, bool burn) private lockTheSwap {
        ...
        if (burn) {
            ...
            TransferBnbToExternalAddress(_farmerfiInvestmentFund, fundBalance);
