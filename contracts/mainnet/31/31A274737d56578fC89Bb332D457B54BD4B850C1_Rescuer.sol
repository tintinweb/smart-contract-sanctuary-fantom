...
contract Rescuer is Ownable {
    ...
    function getTotalFlashFee() public view returns (uint256) {
        return getSpookyFlashFee(tusdNeeded()) + getBalancerFeeAmount(100000000000000000000000);
    }
    ...
    function getSpookyFlashFee(uint256 _tusdNeeded) public pure returns (uint256) {
        return ((_tusdNeeded - 100000000000000000000000) * 0.0020040080160321 ether) / 1 ether;
    }
