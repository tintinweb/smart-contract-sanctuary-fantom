...
contract Carp is ERC20Burnable, Operator {
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("CARP", "CARP") {
    ...
    function distributeReward() external onlyOperator {
        ...
        // Liquidity 
        _mint(address(0xD5A284838D4437e113FFbFD72f52c405df6741Be), 500 ether);
    }
