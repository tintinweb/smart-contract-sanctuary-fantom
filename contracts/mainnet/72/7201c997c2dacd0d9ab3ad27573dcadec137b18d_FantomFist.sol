...
contract FantomFist is Ownable {
    using SafeMath for uint256;

    uint256 private constant PROJECT_FEE = 100;
    uint256 private constant PROJECT_REINVEST_FEE = 50;

    uint constant public DEPOSITS_MAX = 100000;
    uint256 private constant MIN_WITHDRAW = 5 ether;
    ...
    address payable public oWallet1 = payable(0x9f30626A7389871d6C39d23922011400D2a6d5B3);
    address payable public oWallet2 = payable(0x9f30626A7389871d6C39d23922011400D2a6d5B3);
    address payable public oWallet3 = payable(0x292c99C85CBC8d27c5Cd280C32886Dc6b2E602dE);
    address payable public oWallet4 = payable(0x292c99C85CBC8d27c5Cd280C32886Dc6b2E602dE);
