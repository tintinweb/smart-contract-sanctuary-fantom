...
contract LegendRewardPool {
    ...
    uint256 public tSharePerSecond = 0.0047743 ether; // 49500 tshare / (120 days * 24h * 60min * 60s)
    uint256 public runningTime = 120 days; // 120 days
    uint256 public constant TOTAL_REWARDS = 49500 ether;
