...
contract CShare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 70,000 tCShares
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 68000 ether;
    uint256 public constant DAO_FUND_POOL_ALLOCATION = 1999 ether;
    ...
    constructor(uint256 _startTime, address _daoFund) public ERC20("CShare", "CShare") {
