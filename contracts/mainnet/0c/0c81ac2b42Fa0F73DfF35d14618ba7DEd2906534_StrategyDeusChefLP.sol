...
contract StrategyDeusChefLP is StratManager, FeeManager, GasThrottler {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    // Tokens used
    address constant public wrapped = address(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83);
    address constant public output = address(0xDE5ed76E7c05eC5e4572CfC88d1ACEA165109E44);
    address constant public USDC = address(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75);
    address constant public DEI = address(0xDE1E704dae0B4051e80DAbB26ab6ad6c12262DA0);
    address public want;
    ...
    constructor(
        ...
        if (lpToken1 == wrapped) {
            ...
            outputToLp1Route = [output, wrapped, lpToken0, lpToken1];
        }
