...
contract EShare is Context, IERC20, Ownable {
    ...
    string private constant _name = 'EMP Shares';
    string private constant _symbol = 'ESHARE';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x1813c230456A554081d700dF9770dA189676Ad7d, 'We can not exclude router.');
