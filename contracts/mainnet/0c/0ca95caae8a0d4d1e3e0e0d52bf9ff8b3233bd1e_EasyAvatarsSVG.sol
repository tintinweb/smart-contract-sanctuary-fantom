...
contract EasyAvatarsSVG {
    ...
    string[10] private glassesLayers = [
        '',
    ...
    string[4] private mouthPieceLayers = [
        '',
    ...
    function getSVG(EasyAvatarObject memory easyAvatar) public view returns (string memory) {
        ...
        if(easyAvatar.skinTone > 15) {
            parts[1] = skinToneLayers[easyAvatar.skinTone];
        }
        else {
            parts[1] = '<path d="M4 4h22v22H4z" fill="';
            parts[2] = skinToneLayers[easyAvatar.skinTone];
            parts[3] = '"/>';
        }
        // Outline
        ...
        parts[6] = eyeColorLayers[easyAvatar.eyeColor];
        parts[7] = '"/>';
        // Pupil
        parts[8] = '<path fill="#000" d="M9 11h1v1H9zm11 0h1v1h-1z"/>';
        parts[9] = glassesLayers[easyAvatar.glasses];
        parts[10] = mouthLayers[easyAvatar.mouth];
        parts[11] = mouthPieceLayers[easyAvatar.mouthPiece];
