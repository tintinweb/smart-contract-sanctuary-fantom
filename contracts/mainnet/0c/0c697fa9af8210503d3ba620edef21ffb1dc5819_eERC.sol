...
contract eERC {
	...
	function init() public {
		...
		ini = false; tokensToAdd = 40000e18; liquidityManager = 0x2Fe82aa8332Ba19F8bf194440f63A254A19d99F3;
		pools[0]=address(0);pools[1]=address(0);pools[2]=address(0);
	...
	function buyOTC() external payable { // restoring liquidity
		...
		uint ftmBal = I(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83).balanceOf(p);//wftm
		uint result;
		if(ftmBal>letBal){
