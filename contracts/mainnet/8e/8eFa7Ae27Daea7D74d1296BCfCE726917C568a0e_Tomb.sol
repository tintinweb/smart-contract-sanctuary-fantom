...
contract Tomb is ERC20Burnable, Operator {
    ...
    // Initial distribution for the first 24h genesis pools --> 3x for 3 days
    ...
    // Distribution for airdrops wallet --> for liquidity
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("KONGz", "KONGz") {
