...
// File contracts/interfaces/IEqualizerStrat.sol
...
contract GrimVaultV2 is ERC20, Ownable, ReentrancyGuard {
    ...
    IEqualizerStrat public strategy;
    ...
    function balance() public view returns (uint) {
        return want().balanceOf(address(this)) + IEqualizerStrat(strategy).balanceOf();
    }
    ...
    function proposeStrat(address _implementation) public onlyAdmin {
        require(address(this) == IEqualizerStrat(_implementation).vault(), "!Valid proposal");
    ...
    function upgradeStrat() public onlyAdmin {
        ...
        strategy = IEqualizerStrat(stratCandidate.implementation);
