...
contract GBOND is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Gas Station.fi';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x6f5008AAEb5Fad8bEe83dB3a913083375658FA9A, 'We can not exclude router.');
