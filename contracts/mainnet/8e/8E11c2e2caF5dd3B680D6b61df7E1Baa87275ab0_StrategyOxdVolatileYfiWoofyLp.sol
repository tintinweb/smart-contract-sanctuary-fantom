...
contract StrategyOxdVolatileYfiWoofyLp is StrategyOxdFarmLPBase {
    // Token addresses
    address public yfi_woofy_lp = 0x4b3a172283ecB7d07AB881a9443d38cB1c98F4d0;
    address public yfi = 0x29b0Da86e484E1C0029B56e817912d778aC0EC69;
    address public woofy = 0xD0660cD418a64a1d44E9214ad8e459324D8157f1;
    ...
    {
        swapRoutes[yfi].push(route(wftm, yfi, false));
        swapRoutes[woofy].push(route(wftm, yfi, false));
        swapRoutes[woofy].push(route(yfi, woofy, false));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategyOxdVolatileYfiWoofyLp";
    }
}
