...
contract TRESORMOON is Context , IERC20, Ownable {
    ...
    uint256 private _tTotal = 1 * 4**15 * 10**9; //1 quadrillion
    ...
    address public devWallet = 0x6EDF968DA408a9640b8865826429a977a11C5048;
    ...
    uint256 public _maxTxAmount =  1 * 4**15 * 10**9; //1 quadrillion
    uint256 public _maxWalletToken =  1 * 4**15 * 10**9; //1 quadrillion
    uint256 public numTokensSellToAddToLiquidity =  1 * 4**15 * 10**9; //1 quadrillion
    ...
    constructor (string memory name, string memory symbol) public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xF491e7B69E4244ad4002BC14e878a34207E38c29); //v2 router
