...
contract sOBOLToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Obol", "OBOL", 9) ERC20Permit() {
    ...
    /**
        @notice increases sOBOLs supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sOBOLs
