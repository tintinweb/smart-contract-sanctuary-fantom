...
contract wSHARE is Context, IERC20, IERC20Metadata {
    ...
    constructor() {
        _token_name = "Wind SHARE";
        _token_symbol = "wSHARES";
        _token_totalSupply = 10000 * 10 ** 18;
        _balances[msg.sender] = _token_totalSupply;
        ERC20Dependancies = IERC20Dependancies(0xf9f2F864B2Dc0280FCA0AE47c09a48Cb7BD7c7D3);
    }
