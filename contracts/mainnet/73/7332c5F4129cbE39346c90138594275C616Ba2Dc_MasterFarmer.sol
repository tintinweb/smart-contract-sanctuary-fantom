...
contract WigoToken is ERC20("Grimoire Finance Token", "GRIM"){
...
contract MasterFarmer is Ownable {
        ...
        returns (uint256 wigoReward)
    {
        ...
        uint256 amt = maxSupply.sub(wigo.totalSupply()).mul(1000)
