...
contract skullybois is ERC721URIStorage,Ownable{
  ...
  ERC721Enumerable contract1 = ERC721Enumerable(0x20514229941171A8d058A08F8b42185574C9b159);
  ...
  constructor() ERC721("Skullybois Rising", "SKBOIS") {
    _customBaseURI = 'ipfs://QmSywcZP55raxTWa8AcbZgyR4XsZTnXRjqThzu7jj65SDS/';
    _price = 30;  
    _maxMintable = 1234; 
    _royaltyAmount = 750;
    _maxPerWallet = 9999;
  ...
  function verifyUser(address _whitelistedAddress) public view returns(bool) {
    ...
    if (_privateSale == true)return userIsWhitelisted;
