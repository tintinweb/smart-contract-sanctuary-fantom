...
// File: contracts/Copy_FortunateNFT.sol
...
contract FortunateNFT is Ownable, ERC721URIStorage, ERC721Enumerable, ERC721Pausable {
    using EnumerableSet for EnumerableSet.AddressSet;
    using Strings for uint256;EnumerableSet.AddressSet private whitelist;
    ...
    constructor(string memory _initBaseURI) ERC721("FortunateNFT", "GOOD") {
