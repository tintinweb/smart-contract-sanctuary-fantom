...
*/
contract MoverTransferProxyV4FTM is AccessControlUpgradeable, SafeAllowanceResetUpgradeable, ITransferProxyV2 {
    using SafeMathUpgradeable for uint256;
    using SafeERC20Upgradeable for IERC20Upgradeable;
    ...
    function bridgeAssetDirect(address _token, uint256 _amount, bytes memory _bridgeTxData, address _relayTarget) internal {
        ...
        require(targetAddress == 0xB003e75f7E0B5365e814302192E99b4EE08c0DEd, "unknown bridge");
