...
contract MatrixLpAutoCompound is Ownable, Pausable {
    ...
    constructor(
        ...
        // lp0 = epic
        // route = legend -> ftm -> tomb -> degen -> epic
        outputToLp0Route = [output, wrapped, tomb, lpToken1, lpToken0];

        // lp1 = degen
        // route = legend -> ftm -> tomb -> degen 
        outputToLp1Route = [output, wrapped, tomb, lpToken1];
