...
using SafeMathMoroccoSwap for uint256;
    ...
    //Inout fee
    uint256 public LockFee = 2500;
    uint256 public bankFee = 0;
    uint256 public rouletteFee = 0;
    uint256 public blockRewardFee = 0;
    uint256 public metaverseFee = 0;
    uint256 public storageFee = 0;
    uint256 public computationFee = 0;
    uint256 public totalFee = 2500;

    // Swap fee
    uint256 public sfarmFee = 900;
    uint256 public sLockFee = 0;
    uint256 public sblockRewardFee = 300;
    uint256 public sUSDTxFee = 0;
    uint256 public srouletteFee = 100;
    uint256 public sstorageFee = 0;
    uint256 public scomputationFee = 0;
    uint256 public smetaverseFee = 0;
    uint256 public shotspotFee = 0;
    uint256 public sLigaMatchFee = 0;

    uint256 public swaptotalFee = 1300;
    ...
    function takeSwapFee(
        ...
        fees[1] = amount.mul(LockFee).div(PERCENT); //_sLockFee
...
contract MoroccoSwapV2Factory is IMoroccoSwapV2Factory {
    ...
    address public override constant DEADADDRESS = 0x0000000000000000000000000000000000000000;
    ...
    uint256 public override InoutTax = 2500 ; // Inout tax fee 
    uint256 public override swapTax = 1300; // swap tax fee 
    uint256 public override InOutTotalFee = 5000;
    // Up to 4 decimal
    uint256 public override lockFee = 0; 
