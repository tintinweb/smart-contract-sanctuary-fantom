...
contract FTMO is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Fantom Opera';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x3756b57FC42c5957627697A97Bc1Cd91B59Bc271, 'We can not exclude router.');
