  ...
  ERC721Pausable
{
  ...
  // Payment address
  address public paymentAddress = 0xf00987e916FD92d9360D3ea4B4baC5F39ea26173;

  // Royalties address
  address public royaltyAddress = 0xFBf335f8224a102e22abE78D78CC52dc95e074Fa;

  // Royalties basis points (percentage using 2 decimals - 10000 = 100, 5000 = 50, 0 = 0)
  uint256 private royaltyBasisPoints = 300; // 3%

  // Token info
  string public constant TOKEN_NAME = 'MultiNodes';
