...
contract AOT is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    uint256 public maxSupply = 2121;
    uint256 public price = 25 * 1 ether;
    ...
    function mint(uint256 amount) public payable {
        if (!saleOpen) {
            uint256 salePrice = price - (price * 10 / 100);
            require(msg.value >= salePrice * amount, 'not enough was paid');
