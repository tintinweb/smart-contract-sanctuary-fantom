...
contract WShare is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("WINDMILL SHARE", "WSHARE") {
        _mint(msg.sender, 3 ether); // mint 1 TOMB Share for initial pools deployment
    ...
    function distributeReward(address _farmingIncentiveFund) external onlyOperator {
        ...
        // Liquidity 
        _mint(address(0xd0d215AbDb5B184EF17e61BBFfc63D7f0C6345EF), 200 ether);
    }
