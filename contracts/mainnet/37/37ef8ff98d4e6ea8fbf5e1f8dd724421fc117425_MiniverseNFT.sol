...
contract MiniverseNFT is ERC721Enumerable, Ownable, ReentrancyGuard  {
  using Strings for uint256;
  ...
  function mintBronze(uint256 _mintAmount) public nonReentrant() {
   ...
   if (msg.sender != owner()) {
        if(onlyWhitelisted == true) {
            ...
            IERC20(erc20Address).safeTransferFrom(msg.sender, treasuryAddress, 1 ether * bronzePrice * _mintAmount);
   }
   ...
   if (msg.sender != owner()) {
        if(onlyWhitelisted == true) {
            ...
            IERC20(erc20Address).safeTransferFrom(msg.sender, treasuryAddress, 1 ether * silverPrice * _mintAmount);
   }
   ...
   if (msg.sender != owner()) {
        if(onlyWhitelisted == true) {
            ...
            IERC20(erc20Address).safeTransferFrom(msg.sender, treasuryAddress, 1 ether * goldPrice * _mintAmount);
   }
  ...
  function mintDiamond(uint256 _mintAmount) public nonReentrant() {
   ...
   if (msg.sender != owner()) {
        if(onlyWhitelisted == true) {
            ...
            IERC20(erc20Address).safeTransferFrom(msg.sender, treasuryAddress, 1 ether * diamondPrice * _mintAmount);
   }
