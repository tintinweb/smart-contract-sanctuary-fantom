...
contract Fidency1 is IERC20
{
	...
	uint256[] public LEVEL_UNLOCK=[0e18, 1000e18, 1000e18, 2500e18, 2500e18, 2500e18, 2500e18, 2500e18, 2500e18, 2500e18];
     ...
     function deposit(address _referer) public payable
   {
    ...
    function _distributePOI(address depositor, uint256 _poi,uint256 _divident) internal{
        uint256 poiShare;
        uint256 f_div=(_divident/investors.length)*1e18;
        
        uint256 f_club=(club/msg.value.mul(5).div(100))*1e18;
