...
contract XShareLocker is Operator, IXShareLocker {
    ...
    function adminLockedAmount() public view returns (uint256) {
        return userInfo[address(0xa59cEeba17597dEDadF77b34B8a877f4DeD1C1C1)].lockedAmount;
    }

    function adminLockEndTime() public view returns (uint256) {
        return userInfo[address(0xa59cEeba17597dEDadF77b34B8a877f4DeD1C1C1)].lockEndTime;
    }
    ...
    function addMoreXShare(uint256 _amount) public override {
        ...
        require(_amount > 0, "Invalid Amount");
        require(user.lockEndTime < block.timestamp, "Lock ended");
...
//        require(user.lockedAmount >= _amount, "Exceed locked amount");
