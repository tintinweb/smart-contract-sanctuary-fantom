...
contract TShareRewardPool {
    ...
    struct PoolInfo {
        ...
        uint256 allocPoint; // How many allocation points assigned to this pool. tshare to distribute per block.

        uint256 lastRewardTime; // Last time that tshare distribution occurs.

        uint256 accTsharePerShare; // Accumulated tshare per share, times 1e18. See below.
    ...
    uint256 public tsharePerSecond = 0.001564 ether; // 50000 tshare / (370 days * 24h * 60min * 60s)
    ...
    // View function to see pending tshare on frontend.
