...
// TicketReceipt with Governance.
contract TicketReceipt is BEP20('TicketReceipt Token', 'RECEIPT') {
...
// MasterTicket is the master of Ticket. He can make Ticket and he is a fair guy.
//
// Note that it's ownable and the owner wields tremendous power. The ownership
// will be transferred to a governance smart contract once TICKET is sufficiently
// distributed and the community can show to govern itself.
//
// Have fun reading it. Hopefully it's bug-free. God bless.
contract MasterTicket is Ownable {
    using SafeMath for uint256;
    ...
    TicketToken public oldticket;    // Info of each pool.
    ...
    // Deposit LP tokens to MasterTicket for TICKET allocation.
    ...
    // Withdraw LP tokens from MasterTicket.
    ...
    // Stake TICKET tokens to MasterTicket
