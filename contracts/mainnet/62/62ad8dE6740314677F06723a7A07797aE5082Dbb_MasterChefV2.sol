...
contract MasterChefV2 is AccessControl {
    ...
    /// Also known as the amount of rewardToken to ditro per block.
    struct PoolInfo {
    ...
    modifier onlyRole(bytes32 role) {
        require(
            ...
            "AccessControl: account is mising role"
        );
        _;
    }
    ...
    function deposit(
        ...
        totalDepositedAmount[pid] += amount;
    ...
    function withdraw(
        ...
        amount < totalDepositedAmount[pid]
            ? totalDepositedAmount[pid] -= amount
            : totalDepositedAmount[pid] = 0;
    ...
    function harvest(uint256 pid, address to) public {
        ...
        // Interactions
        if (_pendingTokens != 0) {
            rewardToken.safeTransfer(to, _pendingTokens);
        }
    ...
    function withdrawAndHarvest(
        ...
        // Interactions
        rewardToken.safeTransfer(msg.sender, _pendingTokens);
