...
contract TheGorps is ERC721 , DefaultOperatorFilterer {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeibzmhm4lln4wcpjijnpf3itpjidzkzsmh4xdt7cjr5ekcwse6mhvi/", Strings.toString(tokenId), ".json")
            );
    }
