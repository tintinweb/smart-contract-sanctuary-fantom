...
// File contracts/EqualTusdEqualizerV2.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract EqualTusdEqualizerV2  is Ownable, Pausable {
    using SafeERC20 for IERC20;

    // Tokens
    address public constant wftm = address(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83);
    address public constant equal = address(0x3Fd3A0c85B70754eFc07aC9Ac0cbBDCe664865A6);
    address public constant tusd = address(0x9879aBDea01a879644185341F7aF7d8343556B7a);
    address public want;
    ...
    IEqualizerRouter.Routes[] public equalToTusdPath;
    ...
    constructor(
        ...
        IEqualizerRouter.Routes[] memory _equalToTusdPath,
        ...
        for (uint i; i < _equalToTusdPath.length; ++i) {
            equalToTusdPath.push(_equalToTusdPath[i]);
        }
    ...
    function addLiquidity() internal {
        ...
        IEqualizerRouter(router).swapExactTokensForTokens(equalHalf, 0, equalToTusdPath, address(this), block.timestamp);

        uint256 t1Bal = IERC20(equal).balanceOf(address(this));
        uint256 t2Bal = IERC20(tusd).balanceOf(address(this));

        IEqualizerRouter(router).addLiquidity(equal, tusd, stable, t1Bal, t2Bal, 1, 1, address(this), block.timestamp);
    }
    ...
    function _subAllowance() internal {
        ...
        IERC20(tusd).safeApprove(router, 0);
    }
    ...
    function _addAllowance() internal {
        ...
        IERC20(tusd).safeApprove(router, type(uint).max);
    }
