...
contract Marketplace is Ownable, Pausable, FeeManager, IMarketplace {
    ...
    function setRoyalty(address _nftAddress, uint fee) external {
    ...
    function ExecuteOrder(
        ...
        // royalty
        uint royaltyAmount = _priceInWei
...
contract FeeManager is Ownable {
    ...
    uint256 public constant maxRoyaltyPerMillion = 100000; // 10% cut

    mapping(address => uint) public royaltyPerMillions;
