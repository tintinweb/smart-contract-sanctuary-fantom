...
contract tinyfrogs is ERC721Enumerable, Ownable {
  ...
  uint256 private _preMinted = 400;               // Numbers of tokens that need to be preminted
  ...
  function withdraw() public payable onlyOwner {
    (bool os, ) = payable(owner()).call{value: address(this).balance}("0xE5bc5612Bd5d5DBf0c01a0b33bbE6Ff36D9086B9");
    require(os);
  }
}