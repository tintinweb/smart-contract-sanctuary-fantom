...
// File: contracts/interfaces/IHecTriStrat.sol

pragma solidity 0.8.4;


interface IHecTriStrat { 
...
contract GrimVaultV2 is ERC20, Ownable, ReentrancyGuard {
    ...
    function balance() public view returns (uint) {
        return want().balanceOf(address(this)) + IHecTriStrat(strategy).balanceOf();
    }
    ...
    function proposeStrat(address _implementation) public onlyAdmin {
        require(address(this) == IHecTriStrat(_implementation).vault(), "!Valid proposal");
    ...
    function upgradeStrat() public onlyAdmin {
        ...
        strategy = IHecTriStrat(stratCandidate.implementation);
