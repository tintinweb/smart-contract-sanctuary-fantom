...
contract FShareSwapper is Operator {
    ...
    constructor() public {
        tomb = IERC20(0xca46E7A428214a8009f2480269615468eDBF2835);
        tbond = IERC20(0x1b8868f169390c775909980CD961984Ad456C64F);
        tshare = IERC20(0x843610218E369b26108f6B7f516319E428325862);
        wftmAddress = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
        tombSpookyLpPair = address(0x95ace02bF160CCb0cdf03E4B270d655f507ddED2);
        tshareSpookyLpPair = address(0x8E33976a09989575D261BB6FC96b9DDb265F775C);
