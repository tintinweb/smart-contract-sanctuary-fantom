...
contract WARP is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Warp.Game';
    string private constant _symbol = 'STARSHIP';

    uint256 private _taxFee = 400;
    uint256 private _burnFee = 0;
    uint public max_tx_size = 12000 ether;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xEA3a355416162D57d2015BC8559f35372A376ad6, 'We can not exclude router.');
