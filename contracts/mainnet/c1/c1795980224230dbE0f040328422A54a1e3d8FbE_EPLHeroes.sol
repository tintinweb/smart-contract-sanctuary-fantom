...
contract EPLHeroes is ERC721Enumerable {
	...
	bool public locked;			//	disable breed()
    ...
    */
	function setLock() external onlyAdmin {
		locked = true;
	}
    ...
    */
	function breed(address _to, uint256 _fromID, uint256 _amount) external onlyMinter isActive {
