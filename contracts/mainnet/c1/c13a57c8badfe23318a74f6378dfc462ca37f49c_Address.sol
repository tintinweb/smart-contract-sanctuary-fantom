/**
 *Submitted for verification at FtmScan.com on 2022-10-02
*/

/**
    
 
   Welcome to SHIBAINU ULTRA
   
   This is a community token. If you want to create a telegram I suggest to name it to @SHIBAINU ULTRA
   ...
   I will renounce the ownership to burn addresses to transfer #UNIQCORCOIN to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #SHIBA INU ULTRA 10000X? 
   ...
   it's the best part of the #UNIQCORCOIN idea, increasing the liquidity pool automatically, 
...
contract SHIBAINUULTRA is Context, IERC20, Ownable {
    ...
    string private _name = "SHIBA INU ULTRA";
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x3Baf551eC3AB69476732297303FFD75667824427);
