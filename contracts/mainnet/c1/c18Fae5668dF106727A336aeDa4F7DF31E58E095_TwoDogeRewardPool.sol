...
contract TwoDogeRewardPool {
    ...
    uint256[] public epochTotalRewards = [1 ether, 1 ether];
    ...
    constructor(address _tomb, uint256 _poolStartTime) public {
        ...
        epochEndTimes[0] = poolStartTime + 1 minutes; 
        epochEndTimes[1] = epochEndTimes[0] + 1 minutes;

        epochTombPerSecond[0] = epochTotalRewards[0].div(1 minutes); 
        epochTombPerSecond[1] = epochTotalRewards[1].div(1 minutes); 
