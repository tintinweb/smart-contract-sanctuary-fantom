...
contract FShare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 70,000 fshares
    ...
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 349 ether;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("FSHARE", "FSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 FUCKU Share for initial pools deployment
