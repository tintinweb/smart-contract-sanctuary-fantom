...
contract PhantomWerewolf is ERC721Enumerable, Pausable, Ownable {
    ...
    uint public constant PRICE = 200 ether;
    ...
    constructor(
    string memory baseURI) ERC721("Phantom Werewolf", "PHTM") {
        setBaseURI(baseURI);
    }
...
function allowlistAddresses(address[] calldata wAddresses) public onlyOwner {
    ...
    function reserveNFTs() public onlyOwner {
        ...
        require(totalMinted.add(15) < MAX_SUPPLY, "Not enough NFTs left to reserve");
...
function preSale(uint _count) public payable {
    ...
    function mintNFTs(uint _count) public payable {
        ...
        require(msg.value >= PRICE.mul(_count), "Not enough FTM to purchase NFTs.");
