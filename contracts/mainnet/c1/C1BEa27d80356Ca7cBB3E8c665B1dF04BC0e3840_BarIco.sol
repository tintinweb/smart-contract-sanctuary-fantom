/**
 *Submitted for verification at FtmScan.com on 2023-05-07
*/
...
// File contracts/bar/BarIco.sol

pragma solidity ^0.8.0;


contract BarIco is Ownable {
    using SafeERC20 for IERC20;
    ...
    uint256 private _startDate = 1684011599; // When to start ICO 
    uint256 private _endDate = 1684097999; // When to end ICO 
    uint256 private _claimDate = 1684097999; // When to claim ICO 

    uint256 private _hardcap = 500000 ether; // hard cap
    uint256 private _softcap = 100000 ether; // softcap
    uint256 private _icoPrice = 4 ether; // token price
    uint256 private _minPerUser = 30 ether; // min amount per user
    uint256 private _maxPerUser = 50000 ether; // max amount per user
