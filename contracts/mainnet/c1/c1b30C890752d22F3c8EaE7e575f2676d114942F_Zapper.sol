...
contract Zapper is Ownable, IZapper {
    ...
    function zapInToken(address _in, uint256 amount, address out, address routerAddr, address recipient, uint256 minAmountLp) 
    external override whitelist(routerAddr) onlyOperator {
    ...
    function _swap(address _in, uint256 amount, address out, address recipient, address routerAddr) private whitelist (routerAddr) returns (uint256) {
