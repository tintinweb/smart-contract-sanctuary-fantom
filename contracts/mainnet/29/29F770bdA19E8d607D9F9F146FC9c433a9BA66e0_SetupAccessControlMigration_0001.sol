...
import {LibAccessControl} from "@solarprotocol/solar-diamond/contracts/modules/access/LibAccessControl.sol";
import {LibRoles} from "@solarprotocol/solar-diamond/contracts/modules/access/LibRoles.sol";
import {LibDiamond} from "contracts-starter/contracts/libraries/LibDiamond.sol";
import {IAccessControl} from "@openzeppelin/contracts/access/IAccessControl.sol";
import {LibPausable} from "@solarprotocol/solar-diamond/contracts/modules/pausable/LibPausable.sol";

// solhint-disable-next-line contract-name-camelcase
contract SetupAccessControlMigration_0001 {
    function migrate(address treasury) external {
        LibAccessControl.grantRole(
            LibRoles.DEFAULT_ADMIN_ROLE,
            LibDiamond.contractOwner()
        );
        LibAccessControl.grantRole(LibRoles.TESTER_ROLE, treasury);
