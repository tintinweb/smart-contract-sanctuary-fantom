...
contract DogeShareSwapper is Operator {
    ...
    constructor() public {
        tomb = IERC20(0x105816b9F225b01213dA49B9313BD8417558cE81);
        tbond = IERC20(0x185261b650BEf20DB570f67C404eC3665Fea1D3e);
        tshare = IERC20(0x71927629C5578604a957Eeb7f7599cc01B320fC1);
        wftmAddress = address(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83);
        tombSpookyLpPair = address(0x552423abd7D68c5a9f54ddd93437FeD0554350EB);
        tshareSpookyLpPair = address(0x430198d807b5b70bFC3a5BfCC682F6118b706737);
