...
// File contracts/SlmFtmEqualizerV2.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract SlmFtmEqualizerV2  is Ownable, Pausable {
    using SafeERC20 for IERC20;

    // Tokens
    address public constant wftm = address(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83);
    address public constant equal = address(0x3Fd3A0c85B70754eFc07aC9Ac0cbBDCe664865A6);
    address public constant slm = address(0x39263A476aADF768BE43a99b24C4e461098524a4);
    address public want;
    ...
    IEqualizerRouter.Routes[] public equalToSlmPath;
    ...
    constructor(
        ...
        IEqualizerRouter.Routes[] memory _equalToSlmPath,
        ...
        for (uint i; i < _equalToSlmPath.length; ++i) {
            equalToSlmPath.push(_equalToSlmPath[i]);
        }
    ...
    function addLiquidity() internal {
        ...
        IEqualizerRouter(router).swapExactTokensForTokens(equalHalf, 0, equalToSlmPath, address(this), block.timestamp);

        uint256 t1Bal = IERC20(wftm).balanceOf(address(this));
        uint256 t2Bal = IERC20(slm).balanceOf(address(this));

        IEqualizerRouter(router).addLiquidity(wftm, slm, stable, t1Bal, t2Bal, 1, 1, address(this), block.timestamp);
    }
    ...
    function _subAllowance() internal {
        ...
        IERC20(slm).safeApprove(router, 0);
    }
    ...
    function _addAllowance() internal {
        ...
        IERC20(slm).safeApprove(router, type(uint).max);
    }
