 ...
 */
contract Stablecoin is Initializable, ReentrancyGuardUpgradeable, VaultNFTv3 {
    ...
    function checkValid( uint256 _vaultId ) public view returns(bool, uint256, uint256, uint256) {
        ...
        uint256 extract = halfDebt * 11 / (10 * getEthPriceSource());
    ...
    function liquidateVault(uint256 _vaultId) public nonReentrant {
        ...
        (uint256 collateralValueTimes100, uint256 debtValue) = calculateCollateralProperties(vaultCollateral[_vaultId], vaultDebt[_vaultId]);
