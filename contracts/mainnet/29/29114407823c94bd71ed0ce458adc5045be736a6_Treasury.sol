...
contract Treasury is ContractGuard {
    ...
    address[] public excludedFromTotalSupply = [
        address(0x7Ae9B8cCF597483BF1d63c105FC70F81a0ACC305), // Genesis
    ...
    function initialize(
        ...
        supplyTiers = [0 ether, 50000 ether, 100000 ether, 200000 ether, 400000 ether, 800000 ether, 1600000 ether, 3200000 ether, 6400000 ether];
        maxExpansionTiers = [300, 275, 250, 225, 200, 175, 150, 125, 100];

        maxSupplyExpansionPercent = 250; // Upto 4.0% supply for expansion
