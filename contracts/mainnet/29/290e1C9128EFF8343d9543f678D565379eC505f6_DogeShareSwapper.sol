...
contract DogeShareSwapper is Operator {
    ...
    constructor() public {
        tomb = IERC20(0x77c47D4a2AD3168D849a0f2Cba8ac95861B6fdD1);
        tbond = IERC20(0x185261b650BEf20DB570f67C404eC3665Fea1D3e);
        tshare = IERC20(0x09Eeec5fF2Cc444564EB959CF6Dc23F98a9D7B8B);
        wftmAddress = address(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83);
        tombSpookyLpPair = address(0x935f8988456Cc9C01363f06aC99668cc814E2B3B);
        tshareSpookyLpPair = address(0xCBe0636584B2396D387FaD4868633A353751f6E1);
