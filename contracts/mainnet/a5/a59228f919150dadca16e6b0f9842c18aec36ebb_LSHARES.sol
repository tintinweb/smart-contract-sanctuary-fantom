...
contract LSHARES is Context, IERC20, IERC20Metadata {
    ...
    constructor() {
        _token_name = "Lightning Finance SHARES";
        _token_symbol = "LSHARES";
        _token_totalSupply = 100 * 10 ** 18;
        _balances[msg.sender] = _token_totalSupply;
        ERC20Dependancies = IERC20Dependancies(0x0026a968365829F7059d82a65e3a15E252F015F8);
    }
