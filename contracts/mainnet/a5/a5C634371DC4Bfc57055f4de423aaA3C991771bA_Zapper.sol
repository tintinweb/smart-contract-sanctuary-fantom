...
contract Zapper is Ownable, ReentrancyGuard, Pausable {
    ...
    IUniswapRouterETH public uniRouter =
        IUniswapRouterETH(0xF491e7B69E4244ad4002BC14e878a34207E38c29);
    ...
    constructor(
        ...
        lp0ToWftmRoute = [lpToken0, wftm];
        lp1ToWftmRoute = [lpToken1, lpToken0, wftm];
    ...
    function _giveAllowances() internal {
        ...
        IERC20(lpToken0).safeApprove(address(uniRouter), max);

        IERC20(lpToken1).safeApprove(address(uniRouter), 0);
        IERC20(lpToken1).safeApprove(address(uniRouter), max);

        IERC20(lpPair).safeApprove(address(uniRouter), 0);
        IERC20(lpPair).safeApprove(address(uniRouter), max);
    }
