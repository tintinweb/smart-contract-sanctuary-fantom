...
contract IonizerCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Ionizer Coin';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xbdfa31704dD601CB2d1EbBeCcC933536E12C8A28, 'We can not exclude router.');
