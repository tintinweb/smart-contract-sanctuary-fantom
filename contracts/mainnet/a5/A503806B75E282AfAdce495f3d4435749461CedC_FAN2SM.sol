...
contract FAN2SM is Context, IERC20, Ownable {
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xF27ee1fdaF772234FE7B37eaC15309aDE3dfFe46, 'We can not exclude router.');
