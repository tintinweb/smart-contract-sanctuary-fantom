...
// File contracts/SingleSidedVaultStrategyWithMultiRoute/StrategySSBase.sol
...
abstract contract StrategySSBase is StratManager, FeeManager {
    ...
    function chargeFees() internal {
        ...
        IUniswapRouterETH(unirouter).swapExactTokensForTokens(toWrapped, 0, rewardToProfitRoute, address(this), block.timestamp);
        swapToken.safeTransfer(strategist, swapToken.balanceOf(address(this)));
...
// File contracts/SingleSidedVaultStrategyWithMultiRoute/StrategySSMasterChef.sol
