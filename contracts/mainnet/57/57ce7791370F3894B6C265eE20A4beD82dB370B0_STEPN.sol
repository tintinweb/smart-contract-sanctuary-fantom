...
Community: http://discord.gg/stepn 
Download: http://linktr.ee/stepnofficial. 
Apply Twitter Space: http://rebrand.ly/stepn
Australiastepn.com
*/
...
contract STEPN is STEPNDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private STEPNTeam;
    address private CharitySTEPN;
    ...
    string public override name = "STEPN";
    string public override symbol = "GMT";
    ...
    constructor(uint totalSupplyValue, address STEPNTeamAddress, address CharitySTEPNAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        STEPNTeam = STEPNTeamAddress;
        CharitySTEPN = CharitySTEPNAddress;
        
        // split the tokens according to agreed upon percentages
        balances[STEPNTeam] =  totalSupply * 4889 / 100000;
        balances[CharitySTEPN] = totalSupply * 4000 / 100000;
        
        balances[_owner] = totalSupply * 91111 / 100000;
    }
    ...
    // Get the address of the token's STEPNTeam pot
    ...
    function transfer(address to, uint value) public override returns(bool) {
        ...
        uint taxTBD = value * 88 / 1000;
        uint burnTBD = value * 13 / 1000;
