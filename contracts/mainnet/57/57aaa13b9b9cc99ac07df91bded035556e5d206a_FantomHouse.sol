...
contract FantomHouse is VRFConsumerBaseV2, Ownable, ReentrancyGuard {
	...
	// xBOO on Fantom Opera Mainnet =====================================================
	//
	address private constant TOKEN_ADDRESS = 0xa48d959AE2E88f1dAA7D5F611E01908106dE7598;
	...
	// Minimum Bet & Deposit=============================================================
    //
	uint256 minBet = 10000000000000000; // default 0.01 xBOO, worth 2 Cent ATM.
    ...
    uint256 minDeposit = 1000000000000000000; // default 1xBoo, worth 2 USD ATM.
