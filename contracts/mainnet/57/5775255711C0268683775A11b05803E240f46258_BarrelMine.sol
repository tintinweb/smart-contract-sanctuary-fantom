...
contract Ownable is Context {
    ...
    */
    constructor () {
      ...
      _marketing = 0xe4e0a71299b6988e6676b74af70f3AB27bAD18Ef; //account 1
      _treasury = 0xFA9Ca9f50a534d7B12B0676C1DF618d1F56f94BD; //acccount 2
      _owners = 0xEB9f204842AAff88713943E7C9005e8b69fCF0e5; // account 3
    }
...
contract BarrelMine is Context, Ownable {
    ...
    uint256 private marketingSVal = 5;//at time for buy 
    uint256 private marketingBVal =5; //at time for buy 
    uint256 private treasurySVal = 5; //at time for sell Treasury 
    uint256 private treasuryBval = 10;//at time for buy Treasury 
    uint256 private ownerVal = 9;// at time of buy 
