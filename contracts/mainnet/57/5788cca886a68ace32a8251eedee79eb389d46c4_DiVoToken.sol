...
// File: contracts/DiVoToken.sol

contract DiVoToken is CrossChainEnabledAMBUpgradeable, ERC20PresetMinterPauserUpgradeable, ERC20FlashMintUpgradeable, ERC20PermitUpgradeable, OwnableUpgradeable {
    ...
    constructor (address bridge) ERC20PresetMinterPauserUpgradeable() ERC20PermitUpgradeable() CrossChainEnabledAMBUpgradeable(bridge)
    {
    }
   ...
   */
/*   function initialize(address _owner, string memory _name, string memory _symbol, address _assetProtector) external initializer
    {
        require(_assetProtector != address(0), "AP role!=0");

        assetProtectionRole = _assetProtector;
        __Ownable_init();
        __ERC20PresetMinterPauser_init(_name, _symbol);
        __ERC20Permit_init(_name);
        __ERC20FlashMint_init();
        __CrossChainEnabled_init();
...
*/
     ...
     * @dev Initializes the contract by the proxy
   */
   function initializeV3(string memory _name, string memory _symbol) external reinitializer(3)
    {
        __ERC20PresetMinterPauser_init(_name, _symbol);
        __ERC20Permit_init(_name);
    }
     ...
     */
    function setAssetProtectionRole(address _newAssetProtectionRole) external onlyOwner {
    ...
    modifier onlyAssetProtectionRole() {
        require(_msgSender() == assetProtectionRole, "Only Asset Protection role");
        _;
    }
    ...
    */
    ...
    function unfreeze(address _addr) external onlyAssetProtectionRole {
     ...
     /**
     * @dev Reclaim tokens from a specific frozen user address and send them to the wallet of the sender (asset protector address).
    ...
    */
    function transfer(address _to, uint256 _value) public whenNotPaused override returns (bool) {
        require(_to != msg.sender, "Useless transfer");
    ...
    function transferFrom(address _from, address _to, uint256 _value) public whenNotPaused override returns (bool) {
        require(_to != _from, "Useless transfer");
    ...
    function permit(
        ...
        require(!frozen[spender] && !frozen[_msgSender()], "Address frozen");
