    ...
    ClampedRandomizer
{
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("FTM Potluck Realm Necromancers", "PRNC") ClampedRandomizer(maxSupply) {     
