...
contract MintManager is Ownable {
    ...
    function calculatePrice(uint8 tokenIndex) public view returns (uint) {
        ...
        require (tokenConversion >= supportedToken[tokenIndex].minimumSaleAmount,"Token price is too low");
    ...
    function setSupportedToken(
        ...
        require(minimumSaleAmount > 0, "Invalid minumum sale amount" );
        ...
        supportedToken[tokenId].minimumSaleAmount = minimumSaleAmount;
    }
