...
contract Jade is ERC20Burnable, AccessControlEnumerable, IERC20Burnable, IERC20Mintable {
    ...
    EnumerableSet.AddressSet private _pendingMinters;
    mapping(address => uint256) public pendingMintersDelay; // time allowed to apply the pending minter
    uint256 public constant ADD_MINTER_DELAY = 24 hours; // time delay adding minters
     ...
     */
    function mint(address recipient_, uint256 amount_) public override returns (bool) {
