...
contract KlardaAggregator_Fantom is KlardaAuth {
    ...
    constructor() KlardaAuth(msg.sender) {
        ...
        initHash: hex'cdf2deca40a0bd56de8e3ce5c7df6727e5b1bf2ac96f283fa9c4b3e6b42ea9d2',
        fee: 9980,
        enabled: true
        });
        ...
        initHash: hex'7ae6954210575e79ea2402d23bc6a59c4146a6e6296118aa8b99c747afec8acf',
        fee: 9980,
        enabled: true
        });
        ...
        initHash: hex'c93158cffa5b575e32566e81e847754ce517f8fa988d3e25cf346d916216e06f',
        fee: 9980,
        enabled: true
        });
    }
    ...
    function getETHPrice() public view returns (uint256 reserveETH, uint256 reserveUSDT) {
        // get reserves 
        (reserveETH, reserveUSDT) = getReserves(0, wftm, usdt);
        ...
        for(uint256 i=0; i<dexCount; i++){
            ...
            for(uint256 n=0; n<baseTokens.length; n++) {
                ...
                if(nextPair != address(0)) {
                    if (n == 0) {
                        uint256 bnbAmount = IBEP20(wftm).balanceOf(nextPair);
