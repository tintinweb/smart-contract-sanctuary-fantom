...
contract FANTOMUSK is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public charityAddress =
    payable(0x29f126Ddaf05349D9f1Aa0c26e7a005bEf4AC0F4); // Charity Address
    ...
    string private _name = 'FANTOMUSK';
    string private _symbol = 'FANTOMUSK';
