...
// File contracts/RegenaToken.sol
// License-Identifier: MIT
...
// REGEN FINANCE
contract Regena is ERC20Burnable, Operator {
    using SafeMath8 for uint8;
    using SafeMath for uint256;

    // Supply used to launch in LP
    uint256 public constant INITIAL_LAUNCH_DISTRIBUTION = 2000 ether;
    // Distribution for airdrops wallet
    uint256 public constant INITIAL_AIRDROP_WALLET_DISTRIBUTION = 100 ether;

    // Have the rewards been distributed to the pools
    bool public rewardPoolDistributed = false;

    /**
     * @notice Constructs the REGENA ERC-20 contract.
     */
    constructor() public ERC20("REGENA", "REGENA") {
        _mint(msg.sender, 1 ether);
    }

    /**
     * @notice Operator mints REGENA to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of REGENA to mint to
