...
contract PSHARE is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 47,002 PSHARE
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("PixlVerse Share", "PSHARE") {
        _mint(msg.sender, 2 ether); // mint 2 PixlVerse Shares for initial pools deployment
