...
contract TreasuryUtil is ReentrancyGuard, AccessControl {
    ...
    function _swapTokensForTokens(address _from, address _to, uint256 _amount) internal {
        address[] memory path = new address[](_from == WETH || _to == WETH ? 2 : 3);
        ...
        require(IERC20(_from).approve(address(sandManSwapRouter), _amount), "ERR3");
