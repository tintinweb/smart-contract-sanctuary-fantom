...
contract OmniBears is Ownable, ERC721, NonblockingReceiver {
    ...
    // first 100 NFTs for free then for 100 FTM ( MAX 3 NFT PER WALLET)
    function mint(uint8 numTokens) external payable {
        ...
        require(nextTokenId + numTokens <= MAX_MINT_FTM, "Mint exceeds supply");
        if (nextTokenId + numTokens > 2500) {
            require(
