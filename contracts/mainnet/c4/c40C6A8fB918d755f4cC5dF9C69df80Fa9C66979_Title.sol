...
\______   \_____     ______  ____    __| _/   \_   _____/|__|  ____  _____     ____    ____   ____
 ...
 |______  /(____  //____  > \___  >\____ |     \___  /   |__||___|  /(____  /|___|  / \___  >\___  >
        \/      \/      \/      \/      \/         \/             \/      \/      \/      \/     \/
*/
contract Title is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 50,000 titles
    ...
    constructor(
        ...
        _mint(msg.sender, 10 ether); // mint 10 Title for initial pools deployment
    }

    /**
     * @notice Operator mints TITLE to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of TITLE to mint to
