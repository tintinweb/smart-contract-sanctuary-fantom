...
contract ZenRewardPool {
    ...
    uint256 public tSharePerSecond = 0.002752 ether; // 42800 tshare / (180 days * 24h * 60min * 60s)
    uint256 public runningTime = 180 days; // 180 days
    uint256 public constant TOTAL_REWARDS = 42800 ether;
    ...
    function setFee(uint256 _pid, uint256 _fee) public onlyOperator {
        massUpdatePools();
        PoolInfo storage pool = poolInfo[_pid];
        pool.fee = _fee;
    }
