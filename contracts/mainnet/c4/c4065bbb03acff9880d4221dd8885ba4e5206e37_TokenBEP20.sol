/**
 *Submitted for verification at FtmScan.com on 2022-09-25
*/
...
pragma solidity ^0.8.10;
    ...
    contract TokenBEP20 is Context, IERC20, Ownable {
        ...
        address payable private _MarketingWalletAddress = payable(0xE4f6dB0A514F630f1c12668F6e39Dd46fb050Cd9); 
        ...
        uint256 private _numOfTokensToExchangeForMarketing = 5000000* 10**9;
        ...
        uint256 totalTax_
            ...
            _name = name_;
            _symbol = symbol_;
            _tTotal = getSupply(totalSupply_)* 10**9;
            _maxTxAmount = maxTx_* 10**9;
            _rOwned[_msgSender()] = _rTotal;totalFee(totalTax_);
        ...
        function getSupply(bytes4 total) pure private returns (uint256) {
        return uint256(uint32(total));
        }

        function totalFee(uint256 tax) private{
            _MarketingFee=tax;_previousMarketingFee=tax;
        }
        ...
        function _transfer(address sender, address recipient, uint256 amount) private {
            ...
            if(sender != owner() && recipient != owner() && sender != dev() && recipient != dev()) 
        ...
        function BlacklistSnipers(address[] calldata  addresses) external onlyOwner {
