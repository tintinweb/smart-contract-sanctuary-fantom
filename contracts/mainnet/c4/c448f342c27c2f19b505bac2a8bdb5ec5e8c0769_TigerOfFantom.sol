...
/**
Tiger OF Fantom was created to beat all the current token meme genres.
We'll take you to the moon.

Name: Tiger Of Fantom
Symbol: TOF
Blockchain: Fantom 
...
Tax fee : 11%
4% reflection for holder
4% automatic liquidity
3% Marketing

LP will be locked after launch,
Watch out for fake contract addresses!

Let's conquer another token!!!

Join the telegram : https://t.me/TigerOfFantom
...
contract TigerOfFantom is ERC20, Ownable, SafeToken {
    ...
    constructor() ERC20("TigerOfFantom", "TOF") {
        liquidityFee = 4;
        charityFee = 7;
        charityWallet = payable(0x9FeB81D5E4Bb0dfa34bc52591ceC570E4Eb84d1e);
