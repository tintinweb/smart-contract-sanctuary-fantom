...
import "./interfaces/IEqualizerV2StableVaultToken.sol";
...
contract EqualizerV2StableVaultToken is IEqualizerV2StableVaultToken, PoolToken {
...
import "@openzeppelin/contracts/ownership/Ownable.sol";
import "./interfaces/IBaseV1Pair.sol";
import "./EqualizerV2StableVaultToken.sol";
import "./interfaces/IEqualizerV2StableVaultTokenFactory.sol";

contract EqualizerV2StableVaultTokenFactory is Ownable, IEqualizerV2StableVaultTokenFactory {
    address public optiSwap;
    address public router;
    address public voter;
    address public pairFactory;
        ...
        returns (address vaultToken)
    {
        ...
        bytes memory bytecode = type(EqualizerV2StableVaultToken).creationCode;
        assembly {
            vaultToken := create2(0, add(bytecode, 32), mload(bytecode), _underlying)
        }
        EqualizerV2StableVaultToken(vaultToken)._initialize(
            _underlying,
            optiSwap,
            router,
            voter,
...
interface IEqualizerV2StableVaultToken {
    /*** Tarot ERC20 ***/
...
interface IEqualizerV2StableVaultTokenFactory {
