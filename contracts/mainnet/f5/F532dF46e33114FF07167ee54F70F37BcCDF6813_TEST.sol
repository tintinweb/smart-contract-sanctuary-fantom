...
contract TEST is IERC20, Auth {
    ...
    function setFees(
        ...
        devFee = _devFee;
        totalFee = buybackFee.add(marketingFee).add(devFee);
    ...
    event FeesUpdated(bool enabled, uint256 liquidityFee, uint256 buybackFee, uint256 marketingFee, uint256 devFee, uint256 feeDenominator);
