...
contract BabyCurve is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 100,000
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 0 ether;
    uint256 public constant DAO_FUND_POOL_ALLOCATION = 0 ether;
     ...
     */
    function distributeReward(uint256 _poolStartTime, address _sharesRewardPool) external onlyOperator {
