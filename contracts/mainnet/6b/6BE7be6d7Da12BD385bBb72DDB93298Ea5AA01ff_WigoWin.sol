 ...
 * @title WigoWin
 */
contract WigoWin is Ownable, Pausable, ReentrancyGuard {
    ...
    modifier onlyAdminOrExecutorOrKeeper() {
        require(
            msg.sender == adminAddress ||
                msg.sender == executorAddress ||
                msg.sender == keeperAddress,
            "Not executor/admin/keeper"
        );
        _;
    }
    ...
    modifier onlyExecutor() {
        require(msg.sender == executorAddress, "Not executor");
        _;
    }
        ...
        notContract
    {
        require(
            ...
            "You need to have a profile on WigoGalaxy to claim your rewards."
        );
     ...
     * @dev Callable by executor
     */
    function genesisLockRound() external whenNotPaused onlyKeeperOrExecutor {
        require(
            genesisStartOnce,
     ...
     * @dev Callable by admin or executor
     */
    function genesisStartRound() external whenNotPaused onlyKeeperOrExecutor {
     ...
     * @dev Callable by admin or executor
     */
    function pause() external whenNotPaused onlyAdminOrExecutorOrKeeper {
        _pause();
     ...
     * @dev Callable by admin or executor or keeper
     */
    function unpause() external whenPaused onlyAdminOrExecutorOrKeeper {
