 ...
 */
contract OOCrossChainAndSwap is MessageSenderApp, MessageReceiverApp {
    ...
    function _transferWithSwap(
        ...
        if (_srcSwap.path.length > 1) {
            ...
            uint256 srcAmtOut = abi.decode(result, (uint256));
        }
    ...
    function executeMessageWithTransfer(
        ...
        if (m.swap.path.length > 1) {
            ...
            uint256 dstAmount = abi.decode(result, (uint256));
            if (ok) {
