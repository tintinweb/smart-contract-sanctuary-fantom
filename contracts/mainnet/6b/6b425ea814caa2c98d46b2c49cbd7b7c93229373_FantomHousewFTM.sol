...
contract FantomHousewFTM is VRFConsumerBaseV2, Ownable, ReentrancyGuard {
    VRFCoordinatorV2Interface COORDINATOR;
    using SafeERC20 for IERC20;

    // ChainLink VRF configs
    uint64 private s_subscriptionId = 38;
    ...
    uint256 minBet = 5000000000000000000; // default 5 wFTM, around $1.10 atm.
    ...
    uint256 minHouseDeposit = 25000000000000000000000; // default 25000 wFTN, which is around $5000 atm
    ...
    address private constant wFTM_ADDRESS = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    IERC20 private wFTM = IERC20(wFTM_ADDRESS);
    ...
    function depositHouse(uint256 _amount, address _referral) external {
        ...
        wFTM.safeTransferFrom(_sender, address(this), _amount);
    }
    ...
    function withdrawHouse(uint256 _amount) external nonReentrant {
        ...
        wFTM.safeTransfer(msg.sender, _amount);
    }
    ...
    function bet(uint256 _betAmount, uint256 _faceSide, address _referral) external nonReentrant {
        ...
        wFTM.safeTransferFrom(_sender, address(this), _betAmount);
    ...
    function returnDepositAndRemoveDepositor(uint256 _length, bool _shouldRemoveDepositor) internal {
        for (uint i = 0; i < _length; i++) {
            ...
            wFTM.safeTransfer(_depositor, _depositAmount);
