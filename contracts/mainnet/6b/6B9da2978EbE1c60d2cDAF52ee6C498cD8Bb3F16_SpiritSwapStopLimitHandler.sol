...
contract SpiritSwapStopLimitHandler is UniswapV2Router02Handler {
    constructor(IUniswapV2Router02 _spiritRouter, address _weth)
        UniswapV2Router02Handler(_spiritRouter, _weth)
