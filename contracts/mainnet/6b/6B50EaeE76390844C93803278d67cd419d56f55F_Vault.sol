...
contract Vault is ERC20, Ownable {
  ...
  constructor() ERC20("testOneUSD","oUSD") {
    ...
    address[6] memory _underlyings = [0xdc301622e621166BD8E82f2cA0A26c13Ad0BE355,0x8D11eC38a3EB5E956B052f67Da8Bdc9bef8Abf3E,
    ...
    returns(uint256) 
  {
    ...
    if(_newLiquidityInUSD*(10**(tokenDecimals-3)) > amountToDeposit) {
      _newLiquidityInUSD = (amountToDeposit*(10**3))/(10**tokenDecimals);
    }
