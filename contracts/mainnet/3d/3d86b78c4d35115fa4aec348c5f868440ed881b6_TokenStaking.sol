...
//////////////////////                                                              /////////////////////////////
    ...
    function deposit(uint amount) public {
        ...
        Token.transferFrom(msg.sender, address(this), CalcFee(amount));
...
//////////////////////                                                              /////////////////////////////
    ...
    function CalcFee(uint HowMuch) internal view returns(uint){

        uint fee = FeeToken(address(Token)).FeePercent()*(HowMuch/100);
