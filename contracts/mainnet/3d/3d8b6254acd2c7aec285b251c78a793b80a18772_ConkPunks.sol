    ...
    ClampedRandomizer
{
    ...
    uint256 public maxPerPerson = 555;
    uint256 public price = 400000000000000000000000000000;
    ...
    ) ERC721("CONKPunks", "CPUNKS") ClampedRandomizer(maxSupply) {
