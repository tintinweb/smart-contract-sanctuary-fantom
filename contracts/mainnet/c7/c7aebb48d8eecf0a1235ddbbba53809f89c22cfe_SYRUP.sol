...
contract SYRUP is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("SYRUP", "SYRUP") {
        _mint(msg.sender, 1 ether); // mint 1 SYRUP for initial pools deployment
