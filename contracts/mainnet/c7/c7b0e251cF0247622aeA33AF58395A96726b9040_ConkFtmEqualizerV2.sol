...
// File contracts/ConkFtmEqualizerV2.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract ConkFtmEqualizerV2  is Ownable, Pausable {
    ...
    function addLiquidity() internal {
        ...
        uint256 t2Bal = IERC20(conk).balanceOf(address(this));

        IEqualizerRouter(router).addLiquidity(wftm, conk, stable, t1Bal, t2Bal, 1, 1, address(this), block.timestamp);
    }
