  ...
  \:: __  \ \  /::/___     \:\\:\\:\ \\:\ \ \ \\: __ `\ \\:\ \____\:\ \ \ \  
   \:.\ \  \ \/_:/____/\    \:\\:\\:\ \\:\_\ \ \\ \ `\ \ \\:\/___/\\:\/.:| | 
    \__\/\__\/\_______\/     \_______\/ \_____\/ \_\/ \_\/ \_____\/ \____/_/ 
                            ...
                            AZ WORLD - The First "SocialFi " To Earn on Cronos Chain
...
contract AZWorld is IBEP20, Auth {
    ...
    string constant _name = "AZ World";
    string constant _symbol = "AZW";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x61e65E7B48cba6ADFb06Feb4c34b359CCC571B52;
        AZRewardPoolFeeReceiver = 0x4b769DD6ee3b6522A6B709008edcc24dcFbeC6Ac;
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _marketingFee, uint256 _AZRewardPool, uint256 _feeDenominator, uint256 _totalSellFee) external authorized() {
        liquidityFee = _liquidityFee;
        buybackFee = _buybackFee;
        marketingFee = _marketingFee;
        AZRewardPool = _AZRewardPool;
        totalBuyFee = _liquidityFee.add(_buybackFee).add(_marketingFee).add(_AZRewardPool);
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _AZRewardPoolFeeReceiver) external authorized(){
