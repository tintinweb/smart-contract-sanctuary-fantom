...
contract TombSwapHandler is UniswapV2Router02Handler {
    constructor(address _tombRouter, address _wrappedNative)
        UniswapV2Router02Handler(_tombRouter, _wrappedNative)
