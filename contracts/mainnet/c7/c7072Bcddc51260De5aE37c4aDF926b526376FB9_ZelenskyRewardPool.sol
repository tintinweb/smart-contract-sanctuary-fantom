...
contract ZelenskyRewardPool {
    ...
    uint256 public tSharePerSecond = 0.00187783 ether;
    ...
    modifier onlyOperator() {
        require(operator == msg.sender, "ZelenskyRewardPool: caller is not the operator");
        _;
    }
    ...
    function checkPoolDuplicate(IERC20 _token) internal view {
        ...
        for (uint256 pid = 0; pid < length; ++pid) {
            require(poolInfo[pid].token != _token, "ZelenskyRewardPool: existing pool?");
        }
    }
