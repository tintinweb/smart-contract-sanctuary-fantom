...
// File src/strategies/fantom/solidly/strategy-solidex-volatile-wftm-tomb-lp.sol
// License-Identifier: MIT
pragma solidity ^0.8.11;


contract StrategySolidexVolatileWftmTombLp is StrategySolidexFarmLPBase {
    // Token addresses
    address public wftm_tomb_lp = 0x60a861Cd30778678E3d613db96139440Bd333143;
    ...
    {
        swapRoutes[tomb].push(route(wftm, tomb, false));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategySolidexVolatileWftmTombLp";
    }
}