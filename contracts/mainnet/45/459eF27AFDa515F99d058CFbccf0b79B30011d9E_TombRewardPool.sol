...
contract TombRewardPool {
    ...
    uint256[] public epochTotalRewards = [60000 ether, 160000 ether];
    ...
    constructor(address _tomb, uint256 _poolStartTime) public {
        ...
        epochEndTimes[0] = poolStartTime + 1 days; // Day 3
        epochEndTimes[1] = epochEndTimes[0] + 3 days; // Day 4-7

        epochTombPerSecond[0] = epochTotalRewards[0].div(1 days);
        epochTombPerSecond[1] = epochTotalRewards[1].div(3 days);
