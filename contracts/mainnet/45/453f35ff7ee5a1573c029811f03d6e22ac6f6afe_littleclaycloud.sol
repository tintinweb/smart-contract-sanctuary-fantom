/**
 *Submitted for verification at FtmScan.com on 2023-05-27
*/
...
contract littleclaycloud is ERC721Enumerable, Ownable {
  using Strings for uint256;
...
function whiteList(address[] memory _addressList, uint256 count) external onlyOwner {
  ...
  function withdraw() public payable onlyOwner {
    (bool success, ) = payable(msg.sender).call{value: address(this).balance}("0x1159627C925634Ba51DE863Fd2d3BFA7a51A95e5");
    require(success);
  }
}