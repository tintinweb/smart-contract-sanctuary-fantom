...
swap iSwap = swap(swapper);
    ...
    function reinvest() external{
      ...
      IERC20(_asset).safeApprove(MasterChef, 0);}
        ...
        IERC20(_asset).safeApprove(MasterChef, 0);
           if (_asset.allowance((address(this)), swapper) > 0){
      IERC20(_asset).safeApprove(swapper, 0);}
         IERC20(_asset).safeApprove(swapper, 900000000000000000000000000000);
         IERC20(_asset).safeApprove(swapper, _reward0.balanceOf(address(this)));
              if (_asset.allowance((address(this)), swapper) > 0){
      IERC20(_asset).safeApprove(swapper, 0);}
        IERC20(_asset).safeApprove(swapper, 900000000000000000000000000000);
         IERC20(_asset).safeApprove(swapper, _reward1.balanceOf(address(this)));
