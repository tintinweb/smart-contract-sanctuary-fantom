...
contract YShare is ERC20WhitelistTransferable, IYShare {
    ...
    modifier onlyLocker() {
        require(msg.sender == locker || msg.sender == operator(), "!locker");
        _;
    }
    ...
    function setLocker(address _locker) external onlyOperator {
