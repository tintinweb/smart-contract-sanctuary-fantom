...
contract xBegoToken is ERC20('xBego Farm', 'xBego') {
    ...
    constructor() {
        _mint(_msgSender(), uint256(100000000000000000)); // pre-mint for initial liquidity, 0.1 xBego
...
contract Masterchef is Ownable, ReentrancyGuard {
    ...
    uint256 public xbegoPerSec = 0.0005 ether;
