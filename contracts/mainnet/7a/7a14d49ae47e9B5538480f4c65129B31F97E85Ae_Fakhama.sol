...
contract Fakhama is IERC20
{
    ...
    address constant public owner=0xc495888eccC0A728E1411fd2B4fD25BD7EE9F2fd;
    address constant public marketingAddress=0xc495888eccC0A728E1411fd2B4fD25BD7EE9F2fd;
    address constant public vipCommunity=0xc495888eccC0A728E1411fd2B4fD25BD7EE9F2fd;
    ...
    function getCoinRatec(uint memberId) public view returns(uint,uint,uint,uint)
    {
        uint TotalHoldingss = TotalHoldings;
        uint investment=map_Users[memberId].Investment;
    ...
    return(TotalHoldingss,investment,_initialCoinRates,fina1l);
