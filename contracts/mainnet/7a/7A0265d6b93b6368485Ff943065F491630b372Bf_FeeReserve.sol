...
contract FeeReserve is Ownable {
    ...
    /// @notice Set MultiFeeDistribution contract (only set once)
    /// @param _feeDistribution Address of MultiFeeDistribution contract
    function setFeeDistribution(IMultiFeeDistribution _feeDistribution) external onlyOwner {
        require(address(feeDistributor) == address(0), "FeeReserve::setFeeDistribution: Cannot redefine");
