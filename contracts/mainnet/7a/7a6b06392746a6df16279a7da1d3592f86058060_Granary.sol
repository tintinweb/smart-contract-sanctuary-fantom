...
contract Granary
{
	...
	constructor ()
	{
		...
		//Panic to swap wftm
		IERC20(alladdr[5]).approve(alladdr[10],uint256(-1));
		//Vault to take wftm
	...
	*/
	...
	address[11] public alladdr = [
		...
		0xc99988da4D962eB0f59324858908a4eAeD33FA2E //10	bb-yv-ftm
	];
	...
	function work(address ben) internal
	{
		...
		//Buy PANIC with 50% of FTM at PanicSwap: $0.005
        {

			IRouter(alladdr[10])
				.swapExactTokensForTokensSimple(
					(IERC20(alladdr[5]).balanceOf(address(this))).div(2),
					1,
					alladdr[5],
					alladdr[4],
					false,
		...
		//Buy bb-yv-FTM with 100% of remaining WFTM (25%) at B-x: $0.125
        {
