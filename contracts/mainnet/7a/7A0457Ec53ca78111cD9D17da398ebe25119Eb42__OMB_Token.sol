...
contract _OMB_Token is BEP20('omb Token', 'OMB') {
...
contract _xOMB_Token is Ownable {
    using SafeMath for uint256;
    ...
    constructor(
        _OMB_Token _rewardtoken
    ) public {
        rewardtoken = _rewardtoken;
        devaddr = address(0x34FDBbe3311414dA230EAcdE4A4E9F1B92566676);
        feeAddress = address(0x34FDBbe3311414dA230EAcdE4A4E9F1B92566676);
