...
contract DanteFinance is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 150000 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'Dante Finance';
    string private constant _symbol = 'DANTE';

    uint256 private _taxFee = 500;
    uint256 private _burnFee = 0;
    uint public max_tx_size = 150000 ether;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x872cC25A170456f09d413a120451cDc70851C0c3, 'We can not exclude router.');
