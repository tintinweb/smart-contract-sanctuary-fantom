/**
 *Submitted for verification at FtmScan.com on 2023-04-01
*/
...
// File: contracts/PotionswapV3Pool.sol
...
contract PotionswapV3Pool is IUniswapV3Pool, NoDelegateCall {
    using LowGasSafeMath for uint256;
    using LowGasSafeMath for int256;
    using SafeCast for uint256;
    using SafeCast for int256;
...
// File: contracts/PotionswapV3PoolDeployer.sol
...
contract PotionswapV3PoolDeployer is IUniswapV3PoolDeployer {
    struct Parameters {
        address factory;
        address token0;
        address token1;
    ...
    function deploy(
        ...
        pool = address(new PotionswapV3Pool{salt: keccak256(abi.encode(token0, token1, fee))}());
        delete parameters;
    }
}

// File: contracts/PotionswapV3Factory.sol
...
/// @title Canonical Potionswap V3 factory
/// @notice Deploys Potionswap V3 pools and manages ownership and control over pool protocol fees
contract PotionswapV3Factory is IUniswapV3Factory, PotionswapV3PoolDeployer, NoDelegateCall {
