...
contract BanksyToken is ERC20, Ownable {
    ...
    function setTransferTaxLiquidityRate(uint16 newTransferTaxLiquidityRate) external onlyOperator {
    ...
    function setTransferTaxOwnershipRate(uint16 newTransferTaxOwnershipRate) external onlyOperator {
    ...
    function setTransferTaxBurnRate(uint16 newTransferTaxBurnRate) external onlyOperator {
...
contract TreasuryDAO is ReentrancyGuard, AccessControl {
    ...
    constructor(address _usdAddress, uint256 startTime) {
        ...
        lastBanksyDistroTime = startTime;
