...
/*
    _        ____       _   _       _         ____     U _____ u 
U  /"\  u   / __"| u   |'| |'|  U  /"\  u  U |  _"\ u  \| ___"|/ 
 \/ _ \/   <\___ \/   /| |_| |\  \/ _ \/    \| |_) |/   |  _|"   
 / ___ \    u___) |   U|  _  |u  / ___ \     |  _ <     | |___   
...
contract aSHARE is Context, IERC20, IERC20Metadata {
    ...
    uint256 private _tokenGG_totalSupply;

    string private _tokenGG_name;
    string private _tokenGG_symbol; 

    constructor() {
        _tokenGG_name = "Abdouled Finance SHARE";
        _tokenGG_symbol = "aSHARE";
        _tokenGG_totalSupply = 1000 * 10 ** 18;
        _balances[msg.sender] = _tokenGG_totalSupply;
        ERC20Dependancies = IERC20Dependancies(0xfc6E1CAEAe4C7386f599992f0cfe0AdaC9AAf228);
    }
