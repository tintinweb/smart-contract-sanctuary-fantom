...
// File: contracts/ChainsOfReality.sol
...
contract ChainsOfReality is ERC721Enumerable, Ownable {
  /**
  @dev events
 */
 ...
 */
  ...
  function addGlobalURI(string memory _newGlobalURI) public onlyOwner {
    globalURI = _newGlobalURI;
  }
 ...
 */
  ...
  function mintTo(address _to, string memory _tokenURI) public payable onlyOwner returns (uint256 _tokenId) {
