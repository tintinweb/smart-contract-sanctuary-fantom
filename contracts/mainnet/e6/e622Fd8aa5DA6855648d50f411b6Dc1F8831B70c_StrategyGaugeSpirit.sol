...
import "../../interfaces/spirit/ISpiritGauge.sol";

contract StrategyGaugeSpirit is StratManager, FeeManager {
    ...
    function deposit() public whenNotPaused {
        ...
        if (pairBal > 0) {
            ISpiritGauge(gauge).deposit(pairBal);
    ...
    function panic() public onlyOwner {
        pause();
        ISpiritGauge(gauge).withdraw(balanceOfPool());
    }
    ...
    function _giveAllowances() internal {
        ...
        IERC20(lpPair).safeApprove(gauge, max);
    ...
    function _removeAllowances() internal {
        IERC20(lpPair).safeApprove(gauge, 0);
    ...
    function anualReward() external view returns (uint256) {
        return ISpiritGauge(gauge).rewardRate().mul(3600).mul(24).mul(365);
    }
