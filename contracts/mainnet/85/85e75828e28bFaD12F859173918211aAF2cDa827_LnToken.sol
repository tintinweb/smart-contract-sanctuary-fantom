...
contract LnToken is ERC20 {
    ...
    /**
     * @dev
     * Keep record of old bank and new bank.
     * banks[0] == old bank, banks[1] == new bank.
     */
    ...
    /**
     * @dev
     * Override the decimals. lnUsdc has 6 decimals.
     */
     ...
     */
    function sendToBank(address _from, address _to, uint256 _amount) external onlyValidBanks(_from) onlyValidBanks(_to) {
