...
// File: contracts/Tomb/IOracle.sol
...
// File: contracts/Tomb/SafeMath8.sol
...
// File: contracts/Tomb/Operator.sol
...
contract Tomb is ERC20Burnable, Operator {
    ...
    address public taxCollectorAddress = address(0);
     ...
     */
    constructor() public ERC20("CORPSE", "CORPSE") {
    ...
    function addToBlackList(address blacklistAddress) external onlyOperator {
        _isBlacklisted[blacklistAddress] = true;
