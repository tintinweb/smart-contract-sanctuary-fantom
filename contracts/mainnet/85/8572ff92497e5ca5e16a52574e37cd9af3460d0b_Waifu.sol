...
contract Waifu is BEP20 {
    ...
    // The operator can call all functions except of minting
    ...
    constructor() public BEP20("WaifuSwap", "WAIFU") {
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    struct UserInfo {
        ...
        //
        //   pending reward = (user.amount * pool.WAIFU) - user.rewardDebt
        //
        // Whenever a user deposits or withdraws LP tokens to a pool. Here's what happens:
        //   1. The pool's `WAIFU` (and `lastRewardBlock`) gets updated.
