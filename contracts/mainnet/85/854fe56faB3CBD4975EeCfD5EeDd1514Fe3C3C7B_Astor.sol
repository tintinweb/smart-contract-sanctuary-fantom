...
// File: contracts/Astor.sol



pragma solidity 0.6.12;

contract Astor is ERC20Burnable, Operator {
    using SafeMath8 for uint8;
    using SafeMath for uint256;

    // Initial distribution for Liquidity
    uint256 public constant INITIAL_LAUNCH_DISTRIBUTION = 200 ether;
    // Distribution for Treasury wallet
    uint256 public constant INITIAL_TREASURY_WALLET_DISTRIBUTION = 200 ether;
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("ASTOR", "ASTOR") {
