...
contract TreasuryBalance is Policy {
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    function addAsset(address _asset) external onlyPolicy {
        require(!assets.contains(_asset), "Asset already added");
        assets.add(_asset);
    }    
    
    function removeAsset(address _asset) external onlyPolicy{
