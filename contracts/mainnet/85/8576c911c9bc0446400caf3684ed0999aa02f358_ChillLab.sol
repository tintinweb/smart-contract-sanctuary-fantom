...
contract ChillLab is ChillPillRarity, ReentrancyGuard {
    ...
    uint256 public poolMaxTVL=10000000000000000000000000000;// Maximum allowed TVL in a pool
    ...
    constructor() {
        schill = IERC20(0xFFC756A93C258291970169ca33FEA7EbDD612424);
    ...
    function _deposit(uint _pid, uint _amount, address to, uint[] memory tokenIDs) internal {
        ...
        if(poolMaxTVL> 0){
            require(_amount+pool.sChillStakedAmount<=poolMaxTVL,"deposit:pool has hit deposit cap");
        }
    ...
    function setMaxTvl(uint256 tvl) external onlyAdmin {
        poolMaxTVL = tvl;
    }
