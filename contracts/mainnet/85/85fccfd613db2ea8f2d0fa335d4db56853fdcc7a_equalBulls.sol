...
contract equalBulls is ERC721A, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721A("EqualBulls", "EQBULL") {
  }
  ...
  // not really needed but if someone wants to donate to the contract...
