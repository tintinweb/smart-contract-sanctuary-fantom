...
// File: contracts/Fantomized/shrines.sol
...
abstract contract ERC721Tradable is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function mintNTo(address _to, uint256 number) public onlyOwner {
        require(_currentTokenId <= 666 - 25, "Not allowed");  // Stop before max supply
 ...
 * Shrines
 */
contract Shrines is ERC721Tradable {


    string _baseUrl="";

    constructor()
        ERC721Tradable("Shrines", "SHRINES")
    {}
