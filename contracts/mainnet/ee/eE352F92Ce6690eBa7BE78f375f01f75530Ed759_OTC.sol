...
contract OTC is Ownable, ContractGuard {
    ...
    function initialize() public onlyOwner {
        addAsset(WFTM, tombSwapRouter);
        addAsset(USDC, tombSwapRouter);
        addAsset(MAI, tombSwapRouter);
        addAsset(BASED, tombSwapRouter);
        addAsset(BSHARE, tombSwapRouter);
        setTokenBridgeForRouter(WFTM, tombSwapRouter, TOMB);
    }
