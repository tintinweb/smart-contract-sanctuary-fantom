...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75); // ETHP
    ...
    constructor(address _router) {
        router = _router != address(0) ? IDEXRouter(_router) : IDEXRouter(0xF491e7B69E4244ad4002BC14e878a34207E38c29);
        _token = msg.sender;
    }
...
contract TestToken is IBEP20, Auth {
    ...
    address EP = 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75; // ETHP
    ...
    address public marketingFeeReceiver = 0xFfF8B43e25164CAFf29c5775F14CB69f764EFC05; // marketing address
