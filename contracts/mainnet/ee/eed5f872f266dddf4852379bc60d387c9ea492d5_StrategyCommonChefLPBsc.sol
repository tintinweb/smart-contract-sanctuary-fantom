...
interface IMasterChef {
    function deposit(uint256 _pid, uint256 _amount, address sponsor) external;
...
contract StrategyCommonChefLP is StratManager, FeeManager {
    ...
    function deposit() public whenNotPaused {
        ...
        if (wantBal > 0) {
            IMasterChef(chef).deposit(poolId, wantBal, sponsor);
    ...
    function _harvest(address callFeeRecipient) internal whenNotPaused {
        IMasterChef(chef).deposit(poolId, 0, sponsor);
