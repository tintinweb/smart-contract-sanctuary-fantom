 ...
 */
contract Horse2 is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 Horses 
    ...
    uint256 public constant VESTING_DURATION = 135 days;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("HORSE2", "HORSE2") {
        _mint(msg.sender, 1 ether); // mint 1 Horse for initial pools deployment
