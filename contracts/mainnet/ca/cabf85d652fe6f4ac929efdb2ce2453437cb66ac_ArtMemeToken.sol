...
contract ArtMemeToken is ERC20Permit, Ownable {

    constructor() ERC20("ARTMemeToken", "ART") ERC20Permit("ARTMemeToken")
    {

    }

    uint256 constant private _maxTotalSupply = 100000000000000000000000; // 13,666,000 max boos
