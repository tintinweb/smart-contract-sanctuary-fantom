...
contract MugiwaraPirate is ERC20 {
    ...
    constructor(
        ...
        GrandLineExpedition = _pirateShip;
        ...
        excludeFromMaxWallet(GrandLineExpedition, true);
        ...
        excludeFromFees(GrandLineExpedition, true);

        _mint(GrandLineExpedition, tokenSupply - presaleAmount);
    ...
    function _transfer(
        ...
        if (DroppingCrewMateOverboard) {
            require(
                _isExcludedMaxWalletAmount[from] || _isExcludedMaxWalletAmount[to],
    ...
    function InspectTreasureHaul() private {
        ...
        (success, ) = address(TreasureChestAddress).call{value: address(this).balance}(
            ""
        );
    }
