...
contract Yeller is Ownable {
    ...
    function getSimpleApr(address _gauge, uint _nativeUsdtPrice) private view returns (uint) {
        ...
        uint aprClean = (usdtRewardPerYear / stakedValue) * 1e18;
    ...
    function periodCrvRewards(address _gauge) private view returns (uint) {
        ...
        uint workingBalance = gauge.working_balances(address(strategy));
    ...
    function getLpValue() private view returns (uint, uint) {
        ...
        address lpToken = 0x3a1659Ddcf2339Be3aeA159cA010979FB49155FF;
        ...
        uint lpSupply = IERC20(want).totalSupply();
        uint lpTokenPriceUsdt = (((usdtInLps / 10**decimalsStable) * 1e36 * 3)) / lpSupply;
