...
contract Ftom is ERC20Burnable, Operator {
    using SafeMath8 for uint8;
    using SafeMath for uint256;

    // Initial distribution for the first 24h genesis pools
    uint256 public constant INITIAL_GENESIS_POOL_DISTRIBUTION = 11000 ether;
    // Initial distribution for the 60 minues TOMB-WFTM LP -> TOMB pool
    uint256 public constant INITIAL_TOMB_POOL_DISTRIBUTION = 1000 ether;
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("FTOM", "FTOM") {
    ...
    function distributeReward(
        ...
        address _tombPool,      //
        address _airdropWallet  //0x7Eb00949Ff2286BF2f517a07d70A1dae187bD143
