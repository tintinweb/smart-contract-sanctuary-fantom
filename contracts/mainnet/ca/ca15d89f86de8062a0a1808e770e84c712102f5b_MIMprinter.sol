...
/**
 *Submitted for verification at FtmScan.com on 3-4-2022
*/
...
contract MIMprinter is IBEP20, Auth {
    ...
    uint256 public _maxTxAmount = _totalSupply.div(4); // 1%
    uint256 public _maxWallet = _totalSupply.div(4); // 2.5%
    ...
    uint256 public swapThreshold = _totalSupply / 10; // 0.1%
    bool inSwap;
