...
contract StrategySolidexVolatileBifiMaiLp is StrategySolidexFarmLPBase {
    // Token addresses
    ...
    {
        // swapRoutes[bifi].push(route(wftm, mai, false));
        // swapRoutes[bifi].push(route(mai, bifi, false));
        // swapRoutes[mai].push(route(wftm, mai, false));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategySolidexVolatileBifiMaiLp";
    }
}
