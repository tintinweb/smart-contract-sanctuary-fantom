...
██╗    ██╗███████╗███╗   ██╗███████╗██╗███████╗██╗  ██╗
██║    ██║██╔════╝████╗  ██║██╔════╝██║██╔════╝██║  ██║
██║ █╗ ██║█████╗  ██╔██╗ ██║█████╗  ██║███████╗███████║       RIGHT NOW .BUY RETIRE FISH
██║███╗██║██╔══╝  ██║╚██╗██║██╔══╝  ██║╚════██║██╔══██║
╚███╔███╔╝███████╗██║ ╚████║██║     ██║███████║██║  ██║
 ╚══╝╚══╝ ╚══════╝╚═╝  ╚═══╝╚═╝     ╚═╝╚══════╝╚═╝  ╚═╝


Wenfish Token FTM Monsterfish buy it save it eat it
Tokenomics as follows
burn = 0 Why Burn something that does nothing instead we will lock LP in Exchange under no ownership a forever lock of
6% per TX to LP
4% marketing and fish auctions prizes for biggest fish (1% to wages 3% to Marketing)
for more information checkout degenhaus at www.degen.haus/Wenfish and dex at https://app.degen.degenhaus
whitepaper will be available shortly
HAPPY FISHING AT WENFISH we also have nft Giveaways and fishfarms and single staking
...
contract WENFISH is Context, IERC20, Ownable {
    ...
    string private _name = "WENFISH";
    string private _symbol = "WENFISH";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000 * 10**9 * 10**_decimals;

    address payable public marketingAddress = payable(0x500EB8dACC41224853aBb8153f29d576FACc96C3);
    address public marketingWalletToken = 0xe36b2472A51d0c71720f88F68C1360fF6bCA6323;
    ...
    constructor () {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xcdA8f0fB4132D977AD427d18555E0cb1b1dfA363);
