...
contract Inscryptogram is ERC721 {
    ...
    event Inscribed(uint indexed tokenId,bytes32 hash);
    ...
    function mint(bytes32[] memory hashes,bytes32 merkleRoot) private {
        ...
        emit Inscribed(tokenId,merkleRoot);
    }
    ...
    function reShare(uint256 tokenId) public {
        //index offchain to save gas
    }

    function react(uint256 tokenId, string calldata reaction) public {
        //index offchain to save gas
    }
    ...
    function commentImage(uint256 tokenId, uint256 imageTokenId) public {
        //index offchain to save gas
    }

    function follow(address following) public {
        //index offchain to save gas
    }

    function unFollow(address following) public {
        //index offchain to save gas
    }

    function message(address recipient) public {
        //index offchain to save gas
    }
