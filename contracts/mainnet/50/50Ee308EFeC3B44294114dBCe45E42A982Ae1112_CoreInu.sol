...
contract CoreInu is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Core Inu';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xB2758DF11ea44b25cd8ED6bfD5a1DEB42570b4f4, 'We can not exclude router.');
