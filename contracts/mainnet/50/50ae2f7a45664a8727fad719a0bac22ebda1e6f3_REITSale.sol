...
contract REITSale is Ownable {
    ...
    uint256 constant DAIdecimals = 10**18;
    uint256 constant REITdecimals = 10**9;

    uint256 public MAX_SOLD = 195000 * REITdecimals;
    uint256 public privateSalePrice = (20 * DAIdecimals) / REITdecimals; 
    uint256 public publicSalePrice = (30 * DAIdecimals) / REITdecimals;
    ...
    constructor(address _dev, address dai_address) {
        dev = _dev;
    ...
    function setPrivateSalePrice(uint256 _price) public {
        require(msg.sender == dev, "!dev");
        privateSalePrice = (_price * DAIdecimals) / (REITdecimals * 10);
    }

    function setPublicSalePrice(uint256 _price) public {
        require(msg.sender == dev, "!dev");
        publicSalePrice = (_price * DAIdecimals) / (REITdecimals * 10);
    }
