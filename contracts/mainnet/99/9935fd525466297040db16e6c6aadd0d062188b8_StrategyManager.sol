...
contract StrategyManager is Ownable, ReentrancyGuard {
    ...
    address public taxCollector = 0x5816BD4eBa5E1674b830fAf9E3857bDaDEA75646;
    ...
    function _deposit(
        ...
        uint256 fee = _depositAmount.div(400);
        _depositAmount = _depositAmount.sub(fee);
        pool.stakeToken.safeTransferFrom(address(msg.sender), taxCollector, fee);
