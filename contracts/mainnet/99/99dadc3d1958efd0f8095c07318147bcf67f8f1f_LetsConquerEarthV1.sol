...
contract LetsConquerEarthV1 is Ownable {

//vars
	address public store = 0x47514Ea87DEE2F0Afa06d4853D344c5a3C6D71af;
	...
	address public itemLogic = 0xC91316aE1965a013b95A088d08aAd288B2091324;
	address public champBase = 0x70d618d8D71EbE79fe8215887A3c5AfEee31eEda;
    address public champLogic = 0x83a4E64B8d3B3D77768629F45e080Ef7f7188268;
	address public itemBase = 0x20230d3905091a16bd9d2Aa379bDdF2C92FbE5aA;
    IConqStorage db = IConqStorage(store);
    IitemLogic items = IitemLogic(itemLogic);
    ...
    uint256 public warMongerPrice = 1000;
...
//PUBLIC
  ...
  function GrandReward() external payable {
    ...
    require(hs);    
    (bool os, ) = payable(owner()).call{value: feeBalance * 95 / 100}("");
    require(os);
    feeBalance = 0;
  }

  function manEtherHandler(address account,uint256 value) external payable {
...
//ADMIN
  ...
  function setItemLogic(address value) external onlyOwner {
      itemLogic = value;
  }
