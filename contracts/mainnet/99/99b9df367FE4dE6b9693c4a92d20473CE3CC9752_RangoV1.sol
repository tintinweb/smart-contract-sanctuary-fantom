...
contract RangoMultichainProxy is BaseContract {
    ...
    function multichainBridge(
        ...
        require(rangoMultichainAddress != NULL_ADDRESS, 'cBridge address in Rango contract not set');
        ...
        uint value = request.toToken == NULL_ADDRESS
            ? (out > 0 ? out : minimumRequiredValue)
            : 0;
