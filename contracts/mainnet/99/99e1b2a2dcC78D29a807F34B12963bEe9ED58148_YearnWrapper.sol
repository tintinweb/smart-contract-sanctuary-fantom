...
contract YearnWrapper is ERC20, IVaultWrapper, IERC4626 {
  ...
  //////////////////////////////////////////////////////////////*/
    ...
    function convertToAssets(uint256 shares)
        ...
        returns (uint assets)
    {
        return (shares * getFreeFunds()) / yVault.totalSupply();
    }
  ...
  //////////////////////////////////////////////////////////////*/
    ...
    function maxRedeem(address owner) external view override returns (uint256) {
     ...
     function _deposit(
        ...
        uint allowance = _token.allowance(address(this), address(_vault));
        if (allowance < amount) {
            if (allowance > 0) {
                SafeERC20.safeApprove(_token, address(_vault), 0);
            }
            SafeERC20.safeApprove(_token, address(_vault), type(uint256).max);
        }
    ...
    function _withdraw(
        ...
        withdrawn = _vault.withdraw(estimatedMaxShares, receiver, 0);
        ...
        if (unusedShares > 0)
            SafeERC20.safeTransfer(IERC20(address(_vault)), sender, unusedShares);
    }
