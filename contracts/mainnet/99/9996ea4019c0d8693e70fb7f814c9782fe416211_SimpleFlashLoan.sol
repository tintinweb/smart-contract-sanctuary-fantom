...
// File: contracts/upwork/SimpleFlashLoan.sol
...
contract SimpleFlashLoan is FlashLoanSimpleReceiverBase, Ownable {
    ...
    function executeSimpleFlashLoan(
        ...
        bytes memory encodedParams = abi.encode(dexAddresses , buyingPath, buyingPath, sellingPath);
    ...
    function tripleSwap(
        ...
        uint intermediateTokenAmount = IERC20(intermediatePath[0]).balanceOf(address(this));
        IERC20(intermediatePath[0]).approve(dexAddresses[1], intermediateTokenAmount);
