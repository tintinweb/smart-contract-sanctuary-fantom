...
/***
 */
// Good luck trying to find any hard rug code here lmfao
...
contract TombGenesisRewardPool {
    ...
    uint256 public tombPerSecond = 0.11574 ether; // 24000 Tomb / (48h * 60min * 60s)
    uint256 public runningTime = 1 days; // 2 days
    ...
    modifier onlyOperator() {
        require(operator == msg.sender, "TombGenesisRewardPool: caller is not the operator!");
        _;
    }
    ...
    function checkPoolDuplicate(IERC20 _token) internal view {
        ...
        for (uint256 pid = 0; pid < length; ++pid) {
            require(poolInfo[pid].token != _token, "TombGenesisRewardPool: existing pool?");
        }
    }
