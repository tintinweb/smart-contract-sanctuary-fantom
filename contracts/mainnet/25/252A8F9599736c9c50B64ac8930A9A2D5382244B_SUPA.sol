...
contract SUPA is Context, IERC20, Ownable {
    ...
    string private constant _name = 'SUPA CHARGE';
    string private constant _symbol = 'SUPA';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x9B4f9Dc9cB73e658D82C6a4411FA5640b0406dCa, 'We can not exclude router.');
