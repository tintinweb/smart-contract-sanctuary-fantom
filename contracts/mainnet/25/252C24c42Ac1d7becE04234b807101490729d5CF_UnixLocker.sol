...
contract UnixLocker is Ownable {
     ...
     */
    constructor(uint256 unixTime) public {
        require(block.timestamp + 600 < unixTime, "Unix time must be reasonably far in the future");
        UNLOCK_UNIXTIME = unixTime;
    }
