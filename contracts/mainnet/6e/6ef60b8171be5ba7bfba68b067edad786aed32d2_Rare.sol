...
// File: Rare Finance/lib/SafeMath8.sol
...
// File: Rare Finance/ERC20/ERC20.sol
...
// File: Rare Finance/ERC20/ERC20Burnable.sol
...
contract Rare is ERC20Burnable, Operator {
    using SafeMath8 for uint8;
    using SafeMath for uint256;

    // Initial distribution for the first 120h genesis pools
    uint256 public constant INITIAL_RARE_POOL_DISTRIBUTION = 68750 ether;
    ...
    /**
     * @notice Constructs the RARE ERC-20 contract.
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("RARE", "RARE") {
        // Mints 2,500 RARE to contract creator for initial pool setup & LP
    ...
    function _getRarePrice() internal view returns (uint256 _rarePrice) {
        try IOracle(rareOracle).consult(address(this), 1e18) returns (uint144 _price) {
            ...
            revert("Rare: failed to fetch RARE price from Oracle");
        }
    }
    ...
    /**
     * @notice Operator mints RARE to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of RARE to mint to
