...
// File: contracts/distribution/DoomRewardPool.sol
...
contract DoomRewardPool {
    ...
    uint256 public tSharePerSecond = 0.00175488 ether; // 56100 tshare / (370 days * 24h * 60min * 60s)
    uint256 public runningTime = 370 days; // 370 days
    uint256 public constant TOTAL_REWARDS = 56100 ether;
    ...
    modifier onlyOperator() {
        require(operator == msg.sender, "DoomRewardPool: caller is not the operator");
        _;
    }
    ...
    function checkPoolDuplicate(IERC20 _token) internal view {
        ...
        for (uint256 pid = 0; pid < length; ++pid) {
            require(poolInfo[pid].token != _token, "DOomRewardPool: existing pool?");
        }
    }
