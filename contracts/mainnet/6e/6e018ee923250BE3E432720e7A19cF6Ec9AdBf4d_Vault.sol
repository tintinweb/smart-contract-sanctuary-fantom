...
contract Vault is ReentrancyGuard, IVault {
    ...
    uint256 public override maxLeverage = 15 * 10000; // 15x
    ...
    event IncreaseGlobalShortSize(address token, uint256 amount);
    event DecreaseGlobalShortSize(address token, uint256 amount);
