...
contract SpiritSwapStopLimitHandler is UniswapV2Router02StopLimitHandler {
    constructor(address _spiritRouter, address _wrappedNative)
        UniswapV2Router02StopLimitHandler(_spiritRouter, _wrappedNative)
