 ...
 */
contract TP is ERC20Burnable, Operator {
    ...
    /**
     * @notice Constructs the TP ERC-20 contract.
     */
    constructor() public ERC20("TP", "TP") {
        // Mints 1 TP to contract creator for initial pool setup
        _mint(msg.sender, 1 ether);
    }

    /**
     * @notice Operator mints TP to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of TP to mint to
