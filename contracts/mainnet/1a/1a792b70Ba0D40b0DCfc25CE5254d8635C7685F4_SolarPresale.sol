...
import {RedeemController} from "./redeem/RedeemController.sol";
import {RedeemGettersController} from "./redeem/RedeemGettersController.sol";
import {RedeemAdminController} from "./redeem/RedeemAdminController.sol";
...
library LibPresale {
    ...
    function invest(address investorAddress, uint256 amount) internal {
        ...
        s.issuedAmounts[currentEpoch.id] += amount;
        investor.issuedAmounts[currentEpoch.id] += amount;
    ...
    function setNameAndSymbol(string memory name, string memory symbol)
        internal
    {
        _storage().name = name;
...
contract PresaleAdminController is Initializable {
    ...
    function setBalancesAndTimestamps(
        ...
        LibPresale.setNameAndSymbol("nK", "nK");
