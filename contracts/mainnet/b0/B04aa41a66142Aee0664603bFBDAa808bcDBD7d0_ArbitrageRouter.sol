...
interface IArbitrageRouter {
    ...
    function getAmountsOut(
        ...
        address[] memory path,
        address pairAdd,
        uint256 fee) external view returns (uint256[] memory amounts);     
}

contract ArbitrageRouter is IArbitrageRouter {
    ...
    function swapTokens(
        ...
        address to,
        uint256 fee
    ) external virtual override ensure(block.timestamp + 60) {
    ...
    function swapETHForTokens(
        ...
        address to,
        uint256 fee
    ) external payable virtual override ensure(block.timestamp + 60) {
