...
contract flyboyz is ERC721Enumerable, Ownable { // contract name to yours
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  uint256 public cost = 52 ether; // change price per unit
  uint256 public maxSupply = 169; // max supply, contract will stop minting after this amount is reach in your open sea colection
