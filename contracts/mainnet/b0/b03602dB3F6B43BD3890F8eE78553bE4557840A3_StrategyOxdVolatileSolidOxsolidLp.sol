...
contract StrategyOxdVolatileSolidOxsolidLp is StrategyOxdFarmLPBase {
    // Token addresses
    address public constant solid_oxsolid_lp =
        0xa3bf7336FDbCe054c4B5Bad4FF8d79539dB2a2b3;
    address public constant oxsolid =
    ...
    {
        swapRoutes[solid].push(route(wftm, solid, false));
        swapRoutes[oxsolid].push(route(wftm, solid, false));
        swapRoutes[oxsolid].push(route(solid, oxsolid, false));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategyOxdVolatileSolidOxsolidLp";
    }
}
