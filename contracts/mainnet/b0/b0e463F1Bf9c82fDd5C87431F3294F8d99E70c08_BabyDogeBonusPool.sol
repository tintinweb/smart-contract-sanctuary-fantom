...
contract BabyDogeBonusPool is OwnableUpgradeable {
    ...
    struct PoolInfo {
        ...
        uint256 totalDeposit; // total token deposit
    ...
    uint256 public standardRewardInterval;
    ...
    // constructor(IERC20 _rewardToken, uint256 _rewardPerSecond, uint256 _startTime, uint256 _bonusEndTime, uint256 _maxStakingPerUser) {
