...
contract EasyAvatars is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string[19] private skinToneLayers = [
        ...
        '<path fill="#698362" d="M4 4h22v22H4z"/><path stroke="#b61d1d" d="M14 4.5h1m0 1h1m4 0h1m2 1h1m-1 1h1m-7 1h1m-1 1h1m5 3h1m-13 8h1m2 0h1m2 3h1m-1 2h1m-3-21h1m1 0h1m0 1h1m5 1h1m-1 1h1m-1 2h1m-2 1h1m-1 1h1m-1 2h1m-6 7h1m-3-16h1m1 0h8m-9 1h1m3 0h1m1 0h2m-9 1h2m1 0h3m3 0h1m-9 1h1m1 0h1m1 0h1m1 1h2m-15 12h1m1 0h1m2 0h1m1 0h1m-3 3h1m1 1h1m-2-19h1m2 0h1m2 0h1m2 0h1m-4 1h1m-7 1h1m8 0h1m-13 13h1m2 0h1m2 0h1m-11 1h2m6 0h1m-2 2h1m-1 1h1m6-15h1m-14 10h1m5 0h1m2 0h1m-7 2h1m5 0h1m-4 1h1m-8-3h1m8 0h1m-10 1h1m2 1h1m5 1h1m-8-3h3m1 0h1m-2 2h3m1 0h1m-2 1h1m-1 4h1m-4-7h1m2 0h1m2 0h1m-1 1h1m-10 1h1m8 0h1m-6 1h1"/>'
    ];
    ...
    function getTraits(LarvaObject memory larvaLad, uint256 tokenId) internal view returns (string memory) {
        ...
        parts[2] = skinToneNames[larvaLad.skinTone];
        parts[3] = '"}, {"trait_type": "Eye Color","value": "';
        parts[4] = eyeColorNames[larvaLad.eyeColor];
        parts[5] = '"}, {"trait_type": "Glasses","value": "';
        parts[6] = glassesNames[larvaLad.glasses];
        parts[7] = '"}, {"trait_type": "Mouth","value": "';
        parts[8] = mouthNames[larvaLad.mouth];
        // TYPES
        parts[9] = '"}, {"trait_type": "Type","value": "';
        ...
        // GENERATIONS
        parts[14] = '"}, {"trait_type": "Generation","value": "';
        if (tokenId < 101) {
            parts[15] = "0";
        } else {
            parts[15] = toString(tokenId / 1001 + 1);
        }
        parts[16] = '"}], ';
    ...
    function getSVG(LarvaObject memory larvaLad) internal view returns (string memory) {
        ...
        // Outline
        parts[1] = '<path d="M3 3.5h1m1 0h4m2 0h1m3 0h3m1 0h3m1 0h1m2 0h1m-24 1h1m22 0h1m-24 1h1m22 0h1m-1 2h1m-24 1h1m22 0h1m-24 1h1m22 0h1m-24 4h1m-1 1h1m22 0h1m-24 1h1m22 1h1m-24 1h1m22 0h1m-24 1h1m22 0h1m-24 3h1m22 0h1m-24 1h1m22 1h1m-24 1h1m-1 1h1m22 0h1m-24 1h2m1 0h2m1 0h1m1 0h3m2 0h1m2 0h1m2 0h2M4 3.5h1m5 0h1m2 0h1m8 0h1m2 0h1m-16 23h1m14 0h1M9 3.5h1m-7 9h1m22 1h1m-1 2h1m-24 1h1m22 3h1m-24 1h1m22 0h1m-1 2h1m-1 2h1m-13 2h1m2 0h1m2 0h2m2 0h1m-13-23h1m5 0h1m-16 3h1m22 4h1m-1 1h1m-1 1h1m-24 7h1m-1 4h1m4 3h1m6 0h1m2 0h1m7 0h1m-13-23h1m9 0h1m1 3h1m-24 1h1m-1 3h1m-1 1h1m1 15h1" stroke="#000"/>';
        // Skin Tone
        if(larvaLad.skinTone > 15) {
            parts[2] = skinToneLayers[larvaLad.skinTone];
        }
        else {
            parts[2] = '<path d="M4 4h22v22H4z" fill="';
            parts[3] = skinToneLayers[larvaLad.skinTone];
            parts[4] = '"/>';
        }
        // Eye Color
        parts[5] = '<path d="M8 10h3v3H8zm11 0h3v3h-3z" fill="';
        parts[6] = eyeColorLayers[larvaLad.eyeColor];
        parts[7] = '"/>';
        // Pupil
        parts[8] = '<path fill="#000" d="M9 11h1v1H9zm11 0h1v1h-1z"/>';

        parts[9] = glassesLayers[larvaLad.glasses];
        parts[10] = mouthLayers[larvaLad.mouth];
        parts[11] = '<style>#x{shape-rendering: crispedges;}</style></svg>';
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Easy Avatar #', toString(tokenId), '", "description": "Larva Lads are a play on the CryptoPunks and their creators, Larva Labs. The artwork and metadata are fully on-chain and were randomly generated at mint."', getTraits(larvaLad, tokenId), '"image": "data:image/svg+xml;base64,', Base64.encode(bytes(getSVG(larvaLad))), '"}'))));
