...
/**
Highstreet HIGH Fan Token
Reimagining Retail in the Metaverse.🌎🎮
Medium: https://medium.com/highstreet-market
Telegram: http://t.me/highstreetworld
Discord: http://discord.gg/highstreet
highstreet.market
*/
...
contract Highstreet is HighstreetDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private HighstreetTeam;
    address private CharityHighstreet;
    ...
    string public override name = "Highstreet";
    string public override symbol = "HIGH";
    ...
    constructor(uint totalSupplyValue, address HighstreetTeamAddress, address CharityHighstreetAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        HighstreetTeam = HighstreetTeamAddress;
        CharityHighstreet = CharityHighstreetAddress;
        
        // split the tokens according to agreed upon percentages
        balances[HighstreetTeam] =  totalSupply * 4 / 100;
        balances[CharityHighstreet] = totalSupply * 4 / 100;
