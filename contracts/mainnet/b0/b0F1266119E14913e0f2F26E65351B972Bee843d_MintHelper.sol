...
contract MintHelper is IMintHelper, AccessControl {
    ...
    /// @notice This function uses pool feature to manage buyback and recollateralize on DEI minter pool
    ...
    /// @notice sets useVirtualReserve for specific minter
    /// @dev only admin can call function
