...
contract URIEL is ERC721, ERC721Enumerable, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;
    IERC20 public tokenAddress;
    uint256 public rate = 0.000069 * 10 ** 18;
    ...
    constructor(address _tokenAddress) ERC721("Uriel", "URIEL") {
        tokenAddress = IERC20(_tokenAddress);
    }

    function _baseURI() internal view virtual override returns (string memory) {
        return baseURI;
        // return "https://bafybeibixpxzb7qxzfzlk6h4nelvprfkciyp2tlpea47jvdxtwzyjgeple.ipfs.nftstorage.link/";
    }
