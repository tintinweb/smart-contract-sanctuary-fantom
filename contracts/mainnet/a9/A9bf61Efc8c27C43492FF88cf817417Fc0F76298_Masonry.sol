...
import "../contracts-library/ITreasury.sol";
import "../contracts-library/IBasisAsset.sol";
import "../contracts-library/ContractGuard.sol";
import "../contracts-library/TombWrapper.sol";
import "../contracts-library/Operator.sol";

contract Masonry is TombWrapper, ContractGuard, Operator {
    ...
    function __initialize__(
        IERC20Upgradeable _chiliToken,
        IERC20Upgradeable __cShare,
        ITreasury _treasury
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            _chili.safeTransfer(msg.sender, reward);
        ...
        onlyOperator
    {
        ...
        _chili.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function governanceRecoverUnsupported(
        ...
        require(address(_token) != address(_cShare), "CSHARE");
...
contract TombWrapper {
    using SafeMathUpgradeable for uint256;
    using SafeERC20Upgradeable for IERC20Upgradeable;

    IERC20Upgradeable public _cShare;
    ...
    function stake(uint256 amount) public virtual {
        ...
        _cShare.safeTransferFrom(msg.sender, address(this), amount);
    }
    ...
    function withdraw(uint256 amount) public virtual {
        ...
        _cShare.safeTransfer(msg.sender, amount);
    }
}
