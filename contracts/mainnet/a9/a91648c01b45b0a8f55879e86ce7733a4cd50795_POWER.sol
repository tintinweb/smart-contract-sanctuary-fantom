...
contract POWER is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("POWER", "POWER") {
        _mint(msg.sender, 1 ether); // mint 1 POWER Share for initial pools deployment
