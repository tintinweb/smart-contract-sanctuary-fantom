...
contract CronoApeNFT is ERC721Enumerable, Ownable, Pausable  {
    using Strings for uint256;
    ...
    constructor() ERC721("CronoApeNFT", "CronoApeNFT") {
        _baseURIextended = "https://api.cronoape.com/meta/";

        // 5 CRO
        _price1extended = 5000000000000000000;
    ...
    function claimNFT() public onlyOwner {
        require(totalSupply() < MAX_NFT_SUPPLY, "Sale has already ended");
        require(totalSupply() < NB_TEAM_NFT, "200 CronoApeNFT for the team");
    ...
    function claim10NFT() public onlyOwner {
        ...
        require(totalSupply().add(numberOfNfts) <= NB_TEAM_NFT, "200 CronoApeNFT for the team");
    ...
    function mintNFT() public payable whenNotPaused {
        require(totalSupply() < MAX_NFT_SUPPLY, "Sale has already ended");
        require(getNFTPrice() == msg.value, "CRO value sent is not correct");
    ...
    /**
     * @dev Withdraw CRO from this contract (Callable by owner)
    */
