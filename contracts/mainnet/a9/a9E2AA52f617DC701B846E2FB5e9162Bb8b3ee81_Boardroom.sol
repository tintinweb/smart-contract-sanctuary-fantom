...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    /* ========== GOVERNANCE ========== */
    // fucku2 token, fshare2 token, treasury address
    function initialize(
        IERC20 _fucku2,
        IERC20 _share,
        ITreasury _treasury
        ...
        withdrawLockupEpochs = 4; // Lock for 3 epochs (6h) before release withdraw
        rewardLockupEpochs = 2; // Lock for 1 epochs (3h) before release claimReward
    ...
    function getFucku2Price() external view returns (uint256) {
        return treasury.getFucku2Price();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            fucku2.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        fucku2.safeTransferFrom(msg.sender, address(this), amount);
