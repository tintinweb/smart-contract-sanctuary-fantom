...
contract CRAMER is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, ERC20Permit, ERC20FlashMint {
    constructor() ERC20("CRAMER", "CRAMER") ERC20Permit("CRAMER") {
        _mint(0x65a77cB0f99E86e7e6b93bCC0f59D4CaCe40F6f1, 420699699 * 10 ** decimals());
    }
