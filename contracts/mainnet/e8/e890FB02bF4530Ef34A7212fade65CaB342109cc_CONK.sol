...
contract CONK is Context, IERC20, Ownable {
    ...
    string private constant _name = 'SHIBA POCONK TOKEN';
    string private constant _symbol = 'CONK';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xeE4160f7795C7FFECc53c9168fC4f83e12587705, 'We can not exclude router.');
