...
contract Fantoge is IERC20, Ownable {
    ...
    function swapBack() internal swapping {
        ...
        uint256 totalFTMFee = _totalFee.sub(liquidityFee.div(2));
        ...
        uint256 amountFTMGiveaway = amountFTM.mul(giveawayFee).div(totalFTMFee);

        (bool success,) = payable(marketingFeeReceiver).call{value: amountFTMMarketing.add(amountFTMGiveaway), gas: 30000}("");
        require(success, "receiver rejected FTM transfer");
