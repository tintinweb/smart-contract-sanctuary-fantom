...
// File: contracts/Gus.sol


//** No team, no Website, no Socials **
...
/*🔥🔥 Gus Mino 🔥🔥
       ...
       6% BUY/SELL TAX
       1% MAX PER WALLET
       $MINO is a fast-burning hyper-deflationary token that gains value with every buy and sell 
       transaction. The burns will be a true burn and actually 
       remove the tokens from the total supply with every buy/sell transaction. 
       Since the initial supply of $MINO is limited the floor price will continue to rise 
       as more and more $MINO tokens are removed from circulation.
...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("Gus Mino", "Mino") {
        ...
        devWallet = 0x1D344605b47cb5c69329128272149923C419c32f;
