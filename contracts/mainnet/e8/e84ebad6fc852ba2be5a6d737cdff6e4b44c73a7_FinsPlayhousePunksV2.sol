...
// File contracts/Punks2/Punks2.sol

contract FinsPlayhousePunksV2 is ERC721Enumerable, ERC721Royalty, ERC721Pausable, ClampedRandomizer, Ownable {
    using Strings for uint256;

    uint256 public constant MAX_SUPPLY = 97;
    ...
    constructor() ERC721("Fins Playhouse Punks: Vol 2", "PHP2") ClampedRandomizer(95) {
        ROYALTIES_RECEIVER = new PaymentSplitter();
        ROYALTIES_RECEIVER.initialize();
        ROYALTIES_RECEIVER.addPayee(0xb1a9a840E7ED5b97e559aFCA416C566A6a0ad06F, 85);
        ROYALTIES_RECEIVER.addPayee(_msgSender(), 15);
        ROYALTIES_RECEIVER.transferOwnership(address(0));

        _setDefaultRoyalty(address(ROYALTIES_RECEIVER), 750);

        _safeMint(0xb1a9a840E7ED5b97e559aFCA416C566A6a0ad06F, 96);
    ...
    function mint(uint256 count) public payable whenNotPaused {
        ...
        (bool sent, ) = address(ROYALTIES_RECEIVER).call{ value: msg.value }("");
