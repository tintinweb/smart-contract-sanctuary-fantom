 ...
 */
contract UserProxyFactoryReInit is ProxyImplementation {
    /*******************************************************
     *                     Configuration
     *******************************************************/
    ...
    function reInit() external {
        implementationsAddresses = [
            address(0x95C605eF51f57D11312C5AA56b4ee7Aa59224cf0),
            address(0x2bd2ec7be20C33C7862aBeae0e37a532bF26dc32),
            address(0xA58856FC5e28A55863CB26008Feb935a4642B7f9)
        ];
    }
