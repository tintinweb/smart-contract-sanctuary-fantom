...
contract RedemptionPair is RedemptionERC20 {
    ...
    address public controllerFeeAddress = 0x7eE8c4DAc9EB3c67d7Ed66A6173fe7102984B6C2;
    ...
    modifier whenNotPaused() {
        require(!IRedemptionFactory(factory).isPaused(), 'RedemptionV2: PAUSED');
        _;
    }
     ...
     */
    modifier whenPaused() {
        require(IRedemptionFactory(factory).isPaused(), 'RedemptionV2: NOT PAUSED');
        _;
    }
