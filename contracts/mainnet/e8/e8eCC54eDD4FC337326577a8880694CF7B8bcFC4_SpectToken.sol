...
contract SpectToken is BEP20 {
     ...
     */
    constructor() public BEP20("SpectToken", "SPECT") {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override antiWhale(sender, recipient, amount) blackList(sender, recipient) {
        ...
        transferTaxRate == 0 ) {
            ...
            require(taxAmount == burnAmount + liqAmount, "SPECT::transfer: Burn value invalid");
    ...
    function updateBurnFee(uint16 _burnFee) public onlyOperator {
        require(_burnFee <= 100, "SPECT::updateBurnRate: Burn Fee must not exceed the maximum rate.");
