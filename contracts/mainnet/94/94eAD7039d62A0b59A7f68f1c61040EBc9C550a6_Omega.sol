...
/* 
  Twitter: dont buy token test
  Telegram: dont buy token test
  Documentation: dont buy token test
 */
...
contract Omega is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor() ERC20("Omega Finance", "OMEGA", 9) {
    }
