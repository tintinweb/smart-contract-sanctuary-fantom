...
contract ASHARE is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Andre Shares Token';
    string private constant _symbol = 'ASHARE';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x283aD8Fa5DAaC71275A50eB7C856baF27a6d7A39, 'We can not exclude router.');
