...
contract IsolatedLendingV01 is ERC4626{
    ...
    AggregatorV3Interface public priceFeedAsset;
    AggregatorV3Interface public priceFeedbeFTM;
    ...
    constructor(address _asset, address _collateral, string memory _name, string memory _symbol)ERC4626(ERC20(_asset), _name, _symbol){
        ...
        priceFeedAsset = AggregatorV3Interface(0xf4766552D15AE4d256Ad41B6cf2933482B0680dc); //FTM/USD
        priceFeedbeFTM = AggregatorV3Interface(0x603bfc7e9efAc575A01d07a431281a93B6C6426d); //beFTM/FTM
        exchangeRate = moobeFTMVault.getPricePerFullShare()*priceFeedbeFTM.latestAnswer()*(priceFeedAsset.latestAnswer()*1e10)/1e46; //mooboftm/ftm * beftm/ftm
        feeTo = msg.sender;
        admin = msg.sender;
    }
    ...
    function updateExchangeRate() public{
        priceFeedbeFTM.update();
        exchangeRate = moobeFTMVault.getPricePerFullShare()*priceFeedbeFTM.latestAnswer()*(priceFeedAsset.latestAnswer()*1e10)/1e46; //moobeftm/usdc in 1e8
