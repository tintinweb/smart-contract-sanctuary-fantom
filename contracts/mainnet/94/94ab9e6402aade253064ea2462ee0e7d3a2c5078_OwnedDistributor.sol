...
contract OwnedDistributor is Ownable{
    ...
    uint public vestingAmount = 12_500 * 10 ** 18;      // Initial vesting amount for users who deposit FTM

    uint public vestingBegin;
    uint public vestingEnd;
    uint public vestingPeriod = 60 days;
    ...
    constructor(address diamond_, uint vestingBegin_) {
        diamond = diamond_;
    ...
    function claimInternal(address account) internal virtual returns (uint amount) {
        ...
        if (amount > 0) {
            ...
            IERC20(diamond).transfer(account, amount);
