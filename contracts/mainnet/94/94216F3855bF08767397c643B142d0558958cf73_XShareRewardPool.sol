...
contract XShareRewardPool {
    ...
    uint256 public xSharePerSecond = 0.00643004 ether; // 100000 xshare / (180 days * 24h * 60min * 60s)
    ...
    function governanceRecoverUnsupported(IERC20 _token, uint256 amount, address to) external onlyOperator {
        if (block.timestamp < poolEndTime + 180 days) {
            // do not allow to drain core token (xSHARE or lps) if less than 180 days after pool ends
