...
contract ChillLab is ChillPillRarity, ReentrancyGuard {
    ...
    constructor() {
        schill = IERC20(0x2261aA121e75cf2492250e4d719cE9F85A4E43fd);
    ...
    function _deposit(uint _pid, uint _amount, address to, uint[] memory tokenIDs) internal {
        ...
        require(totalPills <= MAX_CHILLPILL_STAKE, string(abi.encodePacked("deposit: Boosting with too many chill pills")));
