...
contract SPB {
    ...
    constructor() {
        multisig = 0xdE43befFe986Ca48EA88c3F6359e81Aa7af6008E;
    ...
    /// @param token - ERC20 token which you want to deposit.
    ...
    function proxyswap(
        ...
        uint256 result = ValutSwapFactory(beetsVault).swap(
            singleswap,
            funds,
            limit,
            deadline
    ...
    function allowance(address token) public view returns (uint256) {
        ...
        //  Check allowance
        uint256 allowed = USDCToken.allowance(
            address(this),
            0x20dd72Ed959b6147912C2e529F0a0C651c33c9ce
        );
        return allowed;
