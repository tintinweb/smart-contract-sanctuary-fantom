...
contract TheMeld is Ownable, ERC721, NonblockingReceiver {
    ...
    uint256 nextTokenId = 475;
    uint256 MAX_MINT_FANTOM = 700;
    ...
    function mint(uint8 numTokens) external payable {
        ...
        require(nextTokenId + numTokens <= MAX_MINT_FANTOM, "Mint exceeds supply");
    ...
    function traverseChains(uint16 _chainId, uint tokenId) public payable {
        ...
        require(msg.value >= messageFee, string(abi.encodePacked("You have to send some/more FTM to cover traversal gas fee estimate. You will be refunded the difference. Estimate: ", Strings.toString(messageFee))));
