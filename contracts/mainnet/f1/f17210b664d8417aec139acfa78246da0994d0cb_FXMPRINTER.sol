...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x132b56763C0e73F95BeCA9C452BadF89802ba05e); // FXM
...
contract FXMPRINTER is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x132b56763C0e73F95BeCA9C452BadF89802ba05e; // FXM
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "FXM PRINTER";
    string constant _symbol = "FXM PRINT";
    ...
    address public autoLiquidityReceiver=0xfe7d51ed9AF2AcaA532D1a627516649eDe3597A0; //liq address
    address public marketingFeeReceiver=0xfe7d51ed9AF2AcaA532D1a627516649eDe3597A0; // marketing address
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xfe7d51ed9AF2AcaA532D1a627516649eDe3597A0;
