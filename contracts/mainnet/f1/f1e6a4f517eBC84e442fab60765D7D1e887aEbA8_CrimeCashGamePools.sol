...
contract CrimeCashGamePools is GovernableUpgradable {
  ...
  function initialize(Storage store, CrimeCashGame crimeCashGame) public initializer {
    ...
    _defaultLpPoolApyRates = [
          500_000_00,     600_000_00,     700_000_00,       800_000_00,       900_000_00, 
        1_000_000_00,   2_000_000_00,   5_000_000_00,     6_000_000_00,     6_000_000_00, 
        7_000_000_00,   8_000_000_00,   9_000_000_00,    10_000_000_00,    50_000_000_00, 
       55_000_000_00,  60_000_000_00,  70_000_000_00,    75_000_000_00,    80_000_000_00, 
       90_000_000_00, 100_000_000_00, 250_000_000_00,   350_000_000_00,   400_000_000_00,
      500_000_000_00, 650_000_000_00, 800_000_000_00, 1_000_000_000_00, 1_000_000_000_00 
    ];
  }
  ...
  function getClaimAmount(uint256 poolIndex, address staker) public view returns(uint256) {
    ...
    uint256 actualStaked = _pools[_roundNumber][poolIndex].stakers[staker].balance; // 1 260 220_18
    ...
    if (_pools[_roundNumber][poolIndex].infoData.isCrimeCash) {
      ...
      uint256 actualTotalStaked = _pools[_roundNumber][poolIndex].infoData.totalStaked; // 6 000 000_00
      uint256 actualStakers = _pools[_roundNumber][poolIndex].infoData.stakers; // 12
      ...
      uint256 apy = _pools[_roundNumber][poolIndex].infoData.apyRates[_roundDay - 1]; // 15

      uint256 liquid_share_rate = actualStaked * 100_0000 / actualTotalStaked; // 1 260 220_18 * 100_0000 / 6 000 000_00

      uint256 reward = apy * liquid_share_rate / 100_0000; // 15 * 210,036 / 100_0000
