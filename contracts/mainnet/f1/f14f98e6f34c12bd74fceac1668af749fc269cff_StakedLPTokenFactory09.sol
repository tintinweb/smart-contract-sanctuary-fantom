...
contract StakedLPToken09 is PoolToken {
	...
	function swapExactTokensForTokensStable(address tokenIn, address tokenOut, uint256 amount) internal {
		approveRouter(tokenIn, amount);
	...
	function reinvest() external nonReentrant update {
		...
		swapExactTokensForTokens(WETH, USDC, WETH.myBalance());
		swapExactTokensForTokensStable(USDC, token0, USDC.myBalance());
