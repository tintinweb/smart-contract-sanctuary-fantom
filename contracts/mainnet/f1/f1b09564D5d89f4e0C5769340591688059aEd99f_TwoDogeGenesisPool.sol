...
contract TwoDogeGenesisPool {
    ...
    // MAINNET
    uint256 public tombPerSecond = 0.03259 ether; // 11000 TOMB / (3 days 21 hours 15 minutes)
    uint256 public runningTime = 337500; // 3 days 21 hours 15 minutes
    ...
    function governanceRecoverUnsupported(IERC20 _token, uint256 amount, address to) external onlyOperator {
        if (block.timestamp > poolEndTime + 90 days) {
            // Please unstake and collect your rewards within 90 days from pool ends
