...
contract MysticsFinance is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 50000 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'Mystics Bonds';
    string private constant _symbol = 'GHOST';

    uint256 private _taxFee = 500;
    uint256 private _burnFee = 100;
    uint public max_tx_size = 50000 ether;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x63B2b299EC54C6FCc35DdD9239B06F58C2832f3D, 'We can not exclude router.');
