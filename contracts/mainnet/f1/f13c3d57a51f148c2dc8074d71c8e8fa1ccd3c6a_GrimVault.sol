...
// File: contracts/interfaces/ISushiStrat.sol

pragma solidity ^0.8.4;


interface ISushiStrat { 
    function setVault() external view returns (address);
...
contract GrimVault is ERC20, Ownable, ReentrancyGuard {
    ...
    function balance() public view returns (uint) {
        return want().balanceOf(address(this)) + ISushiStrat(strategy).balanceOf();
    }
    ...
    function proposeStrat(address _implementation) public onlyOwner {
        require(address(this) == ISushiStrat(_implementation).setVault(), "!Valid proposal");
    ...
    function upgradeStrat() public onlyOwner {
        ...
        strategy = ISushiStrat(stratCandidate.implementation);
