...
/*
   __    _  _   ___  ____  ____  _  _  ____      __    ___  ____  ____    __    __       ___  ____  ____  ____   ____  ____  ___ 
  /__\  ( \( ) / __)(_  _)( ___)( \( )(_  _)    /__\  / __)(_  _)(  _ \  /__\  (  )     / __)(  _ \( ___)(  _ \ (_  _)(_  _)/ __)
 /(__)\  )  ( ( (__  _)(_  )__)  )  (   )(     /(__)\ \__ \  )(   )   / /(__)\  )(__   ( (__  )   / )__)  )(_) ) _)(_   )(  \__ \
(__)(__)(_)\_) \___)(____)(____)(_)\_) (__)   (__)(__)(___/ (__) (_)\_)(__)(__)(____)   \___)(_)\_)(____)(____/ (____) (__) (___/
...
contract Ancient_Astral_Credits is AccessControlEnumerable, ERC721Enumerable, ClampedRandomizer {
    ...
    constructor (
        ...
        ERC721 (name, symbol) ClampedRandomizer(max_supply)
    {
    ...
    function setBaseURI(string memory normalURI) private onlyAdmin {
        _normalURI = normalURI;
    }
    ...
    function setPublicPrice(uint price) external onlyAdmin {
        _price = price;
    }

    function setMaxSupply(uint256 max_supply) external onlyAdmin {
        _maxSupply = max_supply;
    }
    ...
    function publicMint(uint _mintAmount) public payable {
        ...
        require(msg.value == _price * _mintAmount, "Amount sent is incorrect");
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        require(_exists(tokenId), "ERC721Metadata: URI query for nonexistent token");
        string storage normalURI = _normalURI;
        return normalURI;
    }
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view
        virtual override(AccessControlEnumerable, ERC721Enumerable)
        returns (bool)
    {
    ...
    function _beforeTokenTransfer(address from, address to, uint tokenId)
        internal
        virtual override(ERC721Enumerable)
    {
        super._beforeTokenTransfer(from, to, tokenId);
    }

    function withdrawProceeds(address payable to) external onlyAdmin {
