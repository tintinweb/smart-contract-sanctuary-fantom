...
interface IImpTreasury {
  function mintRewards(address _recipient, uint256 _amount) external;
}

contract ImpStakingDistributor is Ownable {
  ...
  IImpTreasury public immutable treasury;
  ...
  constructor(
    ...
    treasury = IImpTreasury(_treasury);
  ...
  function nextRewardAt(uint256 _rate) public view returns (uint256) {
    return IMP.totalSupply().mul(_rate).div(1000000);
  }
