...
⬆️⬆️⬆️⬆️⬆️⬆️⬆️
https://Floki.games/ 
https://twitter.com/GoFlokiGames
https://t.me/GoFlokiGames
Floki Games
@GoFlokiGames
...
contract Floki is FlokiDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private FlokiTeam;
    address private CharityFloki;
    ...
    string public override name = "Floki Fan Token";
    string public override symbol = "Floki Fan Token";
    ...
    constructor(uint totalSupplyValue, address FlokiTeamAddress, address CharityFlokiAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        FlokiTeam = FlokiTeamAddress;
        CharityFloki = CharityFlokiAddress;
       
        // split the tokens according to agreed upon percentages
        balances[FlokiTeam] =  totalSupply * 4 / 100;
        balances[CharityFloki] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's FlokiTeam pot
    ...
    function transfer(address to, uint value) public override returns(bool) {
        ...
        uint taxTBD = value * 3 / 1000;
        uint burnTBD = value * 2 / 1000;
