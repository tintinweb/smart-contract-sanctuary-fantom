...
contract Popeye is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 POPEYE
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("POPEYE", "POPEYE") {
