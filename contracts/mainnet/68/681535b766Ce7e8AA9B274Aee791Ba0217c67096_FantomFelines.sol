...
// |        |   .'_ _   \    | ,_|      \ .-.') |    \  |  |   .'_ _   \    / _     \
// |   .----'  / ( ` )   ' ,-./  )      / `-' \ |  ,  \ |  |  / ( ` )   '  (`' )/`--'
// |  _|____  . (_ o _)  | \  '_ '`)     `-'`"` |  |\_ \|  | . (_ o _)  | (_ o _).
// |_( )_   | |  (_,_)___|  > (_)  )     .---.  |  _( )_\  | |  (_,_)___|  (_,_). '.
// (_ o._)__| '  \   .---. (  .  .-'     |   |  | (_ o _)  | '  \   .---. .---.  \  :
// |(_,_)      \  `-'    /  `-'`-'|___   |   |  |  (_,_)\  |  \  `-'    / \    `-'  |
// |   |        \       /    |        \  |   |  |  |    |  |   \       /   \       /
// '---'         `'-..-'     `--------`  '---'  '--'    '--'    `'-..-'     `-...-'
// Collection by @missmetababe. Created in 20222.
    ...
    ERC721Burnable
{
    ...
    constructor() ERC721("Fantom Felines", "FF") {}
    ...
    function internalMint(address to) public onlyOwner {
    ...
    function mint(uint256 amount) public payable {
        ...
        require(
            ...
            "per transaction limit surpassed"
        );
