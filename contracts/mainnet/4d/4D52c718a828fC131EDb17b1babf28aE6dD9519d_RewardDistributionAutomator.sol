...
contract RewardDistributionAutomator is Ownable {
    ...
    address vip = 0x770963D52Ab46B8CCB85028B97ceD5E02820c1cF;
    // Contracts
    ...
    function distributeEasy() internal {
        ...
        uint256 vipAmount = easyBalance / 10;
        IERC20(easyContract).approve(xEasy, vipAmount);
        NFTStaking(vip).depositRewards(vipAmount);
        easyContract.transfer(xEasy, easyBalance - vipAmount);
    }
