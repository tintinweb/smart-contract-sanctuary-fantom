...
// Dependency file: contracts/interfaces/IUniswapRouter02.sol
...
// Dependency file: contracts/baby/SolidPrinterDividendTracker.sol
    ...
    DividendPayingTokenOptionalInterface
{
    ...
    function distributeSolidDividends(uint256 amount) public onlyOwner {
...
contract SolidPrinterDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SolidPrinter contract."
        );
    }
...
// Root file: contracts/baby/SolidPrinter.sol
...
// import "contracts/interfaces/IUniswapFactory.sol";
// import "contracts/interfaces/IUniswapRouter02.sol";
// import "contracts/baby/SolidPrinterDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract SolidPrinter is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    SolidPrinterDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = SolidPrinterDividendTracker(
        ...
        IUniswapRouter02 _UniswapRouter = IUniswapRouter02(addrs[1]);
        // Create a uniswap pair for this new token
        address _UniswapPair = IUniswapFactory(_UniswapRouter.factory())
            .createPair(address(this), _UniswapRouter.WETH());
        UniswapRouter = _UniswapRouter;
        UniswapPair = _UniswapPair;
        _setAutomatedMarketMakerPair(_UniswapPair, true);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require (
            ...
            "SolidPrinter: The dividend tracker already has that address"
        );

        SolidPrinterDividendTracker newDividendTracker = SolidPrinterDividendTracker(
            payable(newAddress)
        );

        require (
            newDividendTracker.owner() == address(this),
            "SolidPrinter: The new dividend tracker must be owned by the SolidPrinter token contract"
        );
    ...
    function updateUniswapRouter(address newAddress) public onlyOwner {
        require(
            ...
            "SolidPrinter: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "SolidPrinter: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != UniswapPair,
            "SolidPrinter: The PanSolidSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "SolidPrinter: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "SolidPrinter: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "SolidPrinter: Cannot update gasForProcessing to same value"
        );
    ...
    function swapAndSendToFee(uint256 tokens) private {
        uint256 initialSolidBalance = IERC20(rewardToken).balanceOf(
            address(this)
        );

        swapTokensForSolid(tokens);
    ...
    function swapTokensForSolid(uint256 tokenAmount) private {
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        if (success) {
            dividendTracker.distributeSolidDividends(dividends);
