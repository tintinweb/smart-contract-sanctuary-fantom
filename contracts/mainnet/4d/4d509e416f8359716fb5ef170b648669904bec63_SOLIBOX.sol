...
// File contracts/SOLIBOX.sol

pragma solidity 0.6.12;

// SOLIBOX
contract SOLIBOX is ERC20("SOLIBOX", "SOLIBOX") {
    ...
    constructor(address _treasuryAddr) public {
        ...
        // Mints 1,000,000 SOLIBOX (8%) for Airdrop, IDO and Seed Funders.
        _mint(treasuryAddr, 1000000e18);
        _totalMinted = _totalMinted.add(1000000e18);
        emit Mint(msg.sender, treasuryAddr, 1000000e18);
    }
