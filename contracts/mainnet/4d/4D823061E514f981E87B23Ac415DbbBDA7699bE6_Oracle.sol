...
contract Oracle is AccessControl {
    ...
    function getOnChainPrice() external view returns (uint256) {
        ...
        uint256 deusPrice = (deiBalance * 1e18) / deusBalance;

        return ((deiBalance * 1e18) + (deusBalance * deusPrice)) / pair.totalSupply();
    }
    ...
    function getPrice(
        ...
        bytes32 hash = keccak256(
            abi.encodePacked(appId, address(pair), price, timestamp)
        );
