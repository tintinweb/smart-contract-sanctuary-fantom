...
contract HelloWorld is Ownable, ERC721, NonblockingReceiver {
    ...
    uint256 nextTokenId = 2560;
    uint256 MAX_MINT_FTM = 3072;
    ...
    constructor(string memory hiddenuri_, address _layerZeroEndpoint) ERC721("Hello", "HW") {
        _owner = msg.sender;
    ...
    function mint(uint8 _mintAmount) external payable {
        ...
        require(nextTokenId + _mintAmount <= MAX_MINT_FTM, "Mint exceeds supply");
...
/*
uint256 nextTokenId = 2561;
    uint256 MAX_MINT_ETHEREUM = 3072;
    uint256 cost = 20 ether;
*/