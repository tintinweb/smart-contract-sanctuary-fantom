...
contract AlphaStrategyScream is AlphaStrategyBase {
    ...
    function pendingXTokenOfUser(address user) public view returns (uint256) {
        return pendingTokenOfUser(user, pendingXToken(), xBaseToken);
    }
    ...
    function exitFirstPool() internal virtual override {
    ...
    function enterLpTokens() external virtual override {
    ...
    function lpBalance() internal view override returns (uint256) {
        uint256 bal;
        uint256 mantissa;
        ...
        uint256 decimals = ERC20Upgradeable(underlying).decimals();
...
abstract contract AlphaStrategyBase is OwnableUpgradeable {
    ...
    function lpBalance() internal view virtual returns (uint256 bal);

    function enterLpTokens() external virtual;

    function exitFirstPool() internal virtual;
