...
contract MShare2 is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("MEDUSA2 SHARE", "MSHARE2") {
    ...
    function distributeReward(address _farmingIncentiveFund) external onlyOperator {
        ...
        // Liquidity 
        _mint(address(0xFD36A788fea039c28F7d0DDD485B2dBc5df6122F), 150 ether);
    }
