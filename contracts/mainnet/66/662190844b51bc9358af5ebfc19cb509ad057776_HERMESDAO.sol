...
/**
 * website : ready to go dapps farming staking ready TG : https://t.me/HERMESDAOFTM       
*/ 
...
abstract contract Delegator is ERC20Permit, Ownable {
...
abstract contract Mintable is Context {
    ...
    modifier onlyMinter {
        require(isMinter(_msgSender()), "Mintable: caller is not a minter");
        _;
    }
    ...
    function _addMinters(address[] calldata minters) internal {
    ...
    function _removeMinters(address[] calldata minters) internal {
        for (uint256 i = 0; i < minters.length; i++) {
...
contract HERMESDAO is Delegator, Mintable {

    uint256 constant public maxSupply = 100_000_000 ether;

    constructor() ERC20("HERMESDAO", "HERMES") ERC20Permit("HERMESDAO") {}
    ...
    function mint(address to, uint256 amount) external onlyMinter {
        ...
        _mint(to, amount);
        _moveDelegates(address(0), to, amount);
    }
