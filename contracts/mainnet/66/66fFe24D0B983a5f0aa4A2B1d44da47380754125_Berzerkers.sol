...
// File @openzeppelin/contracts/security/[email protected].1.0
    ...
    ClampedRandomizer
{
    ...
    address  public royaltyAddress = 0xFDaFb98c259c33594F08762345591F5aE7c7BE0f;
    ...
    uint256 public price = 9999 ether;
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("Berzerkers", "BRZK") ClampedRandomizer(maxSupply) {     
