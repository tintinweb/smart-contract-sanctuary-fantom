...
contract Oracle is Epoch {
    ...
    /* ========== STATE VARIABLES ========== */
    uint public PERIOD = 300; // 5 min TWAP (time-weighted average price)
    ...
    function update() external checkEpoch {
      ...
      uint32 timeElapsed;
       unchecked{
        ...
        unchecked {
            price0Average = FixedPoint.uq112x112(uint224(((price0Cumulative - price0CumulativeLast) / timeElapsed).mul(10**12)));
            price1Average = FixedPoint.uq112x112(uint224(((price1Cumulative - price1CumulativeLast) / timeElapsed).mul(10**12)));
        }
