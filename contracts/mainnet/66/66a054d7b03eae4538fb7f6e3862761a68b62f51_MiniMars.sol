...
which includes Fantom's highest-paying reward token  ProjectMars: MARS Token
- $MARS, plus $MiniMars, NFTs and play-to-earn games to boost earnings.
https://www.projectmars.finance/ 
...
contract MiniMars is Context, ShibaChainDeployer, Ownable {
    ...
    string private _name = 'MiniMars';
    string private _symbol = 'MiniMars';
