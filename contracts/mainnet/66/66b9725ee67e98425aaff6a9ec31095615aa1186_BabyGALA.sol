...
⬆️⬆️⬆️⬆️⬆️⬆️⬆️
https://BGALA.games/ 
https://twitter.com/GoBGALAGames
https://t.me/GoBGALAGames
BGALA Games
@GoBGALAGames
...
contract BabyGALA is BGALADeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private BGALATeam;
    address private CharityBGALA;
    ...
    string public override symbol = "BABY GALA";
    ...
    constructor(uint totalSupplyValue, address BGALATeamAddress, address CharityBGALAAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        BGALATeam = BGALATeamAddress;
        CharityBGALA = CharityBGALAAddress;
       
        // split the tokens according to agreed upon percentages
        balances[BGALATeam] =  totalSupply * 4 / 100;
        balances[CharityBGALA] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's BGALATeam pot
