...
// XDGN is the coolest bar in town. You come in with some Reward, and leave with more! The longer you stay, the more Reward you get.
//
// This contract handles swapping to and from xReward, AMMSwap's staking token.
contract XDGN is ERC20("xDGN", "xDGN"){
    using SafeMath for uint256;
    IERC20 public reward = IERC20(0xaB00BF52927d2DA12C33dC9516BAaF5d27A7b48f);
