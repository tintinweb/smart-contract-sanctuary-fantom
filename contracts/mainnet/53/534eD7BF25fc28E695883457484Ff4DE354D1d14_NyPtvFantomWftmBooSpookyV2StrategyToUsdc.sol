 ...
 * out quoting reference 'NyPtvFantomWftmBooSpookyV2StrategyToUsdc'
 *
...
contract NyPtvFantomWftmBooSpookyV2StrategyToUsdc is NYBaseProfitTakingStrategyV1 {
  ...
  /**
   * @dev Estimates the amount of profit that can be earned by harvesting the strategy including the call fee.
   *      This enables externals to deicde if it's worth it to call harvest.
   */
