...
contract StrategyOxdVolatileFxsFraxLp is StrategyOxdFarmLPBase {
    // Token addresses
    address public fxs_frax_lp = 0x4bBd8467ccd49D5360648CE14830f43a7fEB6e45;
    address public frax = 0xdc301622e621166BD8E82f2cA0A26c13Ad0BE355;
    address public fxs = 0x7d016eec9c25232b01F23EF992D98ca97fc2AF5a;
    ...
    {
        swapRoutes[fxs].push(route(wftm, frax, false));
        swapRoutes[fxs].push(route(frax, fxs, false));
        swapRoutes[frax].push(route(wftm, frax, false));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategyOxdVolatileFxsFraxLp";
    }
}
