...
contract LiquidCZapStargate {
    ...
    function LiquidCOut (address liquidCVault, uint256 withdrawAmount, uint256 poolID, address lpToken) external {
        ILiquidCVaultV6 vault = ILiquidCVaultV6(liquidCVault);
    ...
    function LiquidCOut2 (address liquidCVault, address token, uint256 withdrawAmount, uint256 poolID, address pool, address lpToken) external {
        _approveTokenIfNeeded(lpToken, stargateRouter);
...
interface IStargateRouter {
    ...
    function instantRedeemLocal(uint256 _srcPoolId, uint256 _amountLD, address to) external payable;
}
