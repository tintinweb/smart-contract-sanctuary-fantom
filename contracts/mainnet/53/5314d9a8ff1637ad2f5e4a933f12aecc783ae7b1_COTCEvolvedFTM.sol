    ...
    ClampedRandomizer
{
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("COTC Evolved FTM", "CEVL") ClampedRandomizer(maxSupply) {     
