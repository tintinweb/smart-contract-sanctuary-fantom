...
// File src/interfaces/solidex-farm.sol
...
// File src/interfaces/solid-router.sol
...
// File src/strategies/fantom/strategy-solidex-farm-base.sol
...
// File src/strategies/fantom/solidly/strategy-solidex-stable-wbtc-renbtc-lp.sol

pragma solidity ^0.8.11;


contract StrategySolidexStableWbtcRenbtcLp is StrategySolidexFarmLPBase {
    // Token addresses
    address public wbtc_renbtc_lp = 0x6058345A4D8B89Ddac7042Be08091F91a404B80b;
    address public wbtc = 0x321162Cd933E2Be498Cd2267a90534A804051b11;
    ...
    {
        swapRoutes[wbtc].push(route(wftm, renbtc, false));
        swapRoutes[wbtc].push(route(renbtc, wbtc, true));
        swapRoutes[renbtc].push(route(wftm, renbtc, false));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategySolidexStableWbtcRenbtcLp";
    }
}