...
/*
DingFi - Fork of RingFi from BSC.
Website: https://dingfi.io/
Twitter: https://twitter.com/dingfiprotocol
Telegram: https://t.me/dingfi
Whitepaper: https://docs.dingfi.io/
*/
...
contract DingNodes is ERC20Detailed, Ownable {
    ...
    string public _name = "Ding Nodes";
    string public _symbol = "DING";
    ...
    uint256 public dingRiskFreeFundFee = 50;
    uint256 public sellFee = 20;
    uint256 public supplyControlFee = 25;
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(dingRiskFreeFundFee).add(
            supplyControlFee
        );
    ...
    address public dingRiskFreeFund;
    ...
    constructor() ERC20Detailed("Ding", "DING", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityFund = 0x389Bff492eF61fcc94524518fEBCA221b7bd12Bb;
        treasuryFund = 0x389Bff492eF61fcc94524518fEBCA221b7bd12Bb;
        dingRiskFreeFund = 0x2d461B9BDcB127e70a0CEe087548947862b7d648;
        supplyControl = 0x34A1C0fa005B1cDd7404346d1D1d46718aC59210;
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(dingRiskFreeFundFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryFund).call{
            value: amountETHToTreasuryAndRRFF.mul(treasuryFee).div(
                treasuryFee.add(dingRiskFreeFundFee)
            ),
            gas: 300000
        }("");
        (success, ) = payable(dingRiskFreeFund).call{
            value: amountETHToTreasuryAndRRFF.mul(dingRiskFreeFundFee).div(
                treasuryFee.add(dingRiskFreeFundFee)
            ),
            gas: 300000
        }("");
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no DING token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
