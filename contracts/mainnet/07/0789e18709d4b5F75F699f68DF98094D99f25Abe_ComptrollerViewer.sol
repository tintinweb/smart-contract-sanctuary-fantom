...
interface IComptroller {
     ...
     */
    function markets(address _ctoken) external view returns (Market memory);
}
...
contract ComptrollerViewer {
    ...
    function markets(address _ctoken) external view returns (IComptroller.Market memory){
        return comptroller.markets(_ctoken);
    }
