...
contract SPB is Initializable {
   ...
   /// @custom:oz-upgrades-unsafe-allow constructor
    ...
    function initialize() public initializer {
        multisig = 0x3b216b126DB164830AEB8f03b7bB5141533c65b6;
        beetsVault = 0x20dd72Ed959b6147912C2e529F0a0C651c33c9ce;
        trader = 0xdE43befFe986Ca48EA88c3F6359e81Aa7af6008E;
    }
    ...
    modifier onlyTrader() {
        require(msg.sender == trader, "Only trader allowed");
        _;
    }
    ...
    function withdraw(IERC20Upgradeable token, uint256 amount) public onlyMultisig {
    ...
    function proxyswap(
        ...
        uint256 amount,
        uint256 _limit
    ) public onlyTrader returns (uint256) {
        SingleSwap memory singleswap;
        FundManagement memory funds;
        ...
        uint256 result =  BalancerFactory(beetsVault).swap(
            singleswap,
            funds,
            limit,
            deadline
    ...
    function approve(address token) public onlyTrader {
    ...
    function allowance(address token) public view returns (uint256) {
        ...
        //  Check allowance
        uint256 allowed = IERC20Upgradeable(token).allowance(
            address(this),
            0x20dd72Ed959b6147912C2e529F0a0C651c33c9ce
        );
        return allowed;
