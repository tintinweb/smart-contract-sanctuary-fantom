    ...
    Proxiable
{
    ...
    string private constant TOKEN_NAME = "boxed Cat";
    string private constant TOKEN_SYMBOL = "bCAT";
    ...
    function upgradeTo(address newCode) onlyRole(DEFAULT_ADMIN_ROLE) public {
