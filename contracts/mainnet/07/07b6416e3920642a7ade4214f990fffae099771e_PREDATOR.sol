...
contract PREDATOR is PREDATORDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private PREDATORTeam;
    address private CharityPREDATOR;
    ...
    string public override name = "Inu Predator";
    string public override symbol = "PREDATOR";
    ...
    constructor(uint totalSupplyValue, address PREDATORTeamAddress, address CharityPREDATORAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        PREDATORTeam = PREDATORTeamAddress;
        CharityPREDATOR = CharityPREDATORAddress;
        
        // split the tokens according to agreed upon percentages
        balances[PREDATORTeam] =  totalSupply * 4 / 100;
        balances[CharityPREDATOR] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's PREDATORTeam pot
