...
contract Strategy is BaseStrategy {
    ...
    IERC20 public rewardToken = IERC20(0x2F6F07CDcf3588944Bf4C42aC74ff24bF56e7590); // Stargate Token
    ILpPool public lpToken = ILpPool(0x12edeA9cd262006cC3C4E77c90d2CD2DD4b1eb97); // USD Coin-LP (S*USDC)
    ...
    IUni internal router; // 0xF491e7B69E4244ad4002BC14e878a34207E38c29
    ...
    function wantToLPToken(uint256 _wantAmount) public view returns (uint256) {
        return _wantAmount.mul(lpToken.totalSupply()).div(lpToken.totalLiquidity());
    }
    ...
    function _withdrawFromMasterChefAndTransfer(address _to) internal {
        ...
        if (_lpTokens > 0) {
            lpToken.transfer(_to, _lpTokens);
        }
    }
