...
contract BIGBondDepositoryTest is Ownable {
    ...
    function payoutFor( uint _value ) public view returns ( uint ) { // bondPayout
        ...
        // 10000000000 / 950000 = 10526
        // 10000000000 / 950000 / 10^7 = 0.00000010526
        return FixedPoint.fraction(_value, bondPrice()).decode112with18() / (1e16 * mulParam);

    }

    function setmulParam(uint256 _param) public onlyOwner {
        mulParam = _param;
    }
