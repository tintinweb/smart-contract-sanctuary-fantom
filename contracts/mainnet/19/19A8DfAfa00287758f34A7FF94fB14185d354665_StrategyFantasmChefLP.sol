...
contract StrategyFantasmChefLP is StratManager, FeeManager, GasThrottler {
    ...
    ISimpleStaking public constant staking = ISimpleStaking(0x2BCeAB76feB10F167C8B50c1E4b2676fce27F434);
    ...
    function harvest() public gasThrottle virtual {
        _harvest(tx.origin);
    }
    ...
    function burn() internal {
        ...
        lpToken1.call(abi.encodeWithSignature("burn(uint256)", toBurn));
        emit Burn(toBurn);
    }
