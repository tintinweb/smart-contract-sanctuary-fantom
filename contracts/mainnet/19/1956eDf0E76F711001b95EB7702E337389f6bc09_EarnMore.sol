...
contract EarnMore is OwnableUpgradeable {
    ...
    function deposit(
        ...
        DepositInfo storage info = depositInfo[vault][msg.sender];
        ...
        )
    {
        ...
        excludedValue =
            (profit * amount * exludePercent) /
            PRESICION /
            currentUnderlyingValue;
        uint256 excludedBaseValue = (profit * exludePercent) / PRESICION;
        ...
        choRewardAmount = _getChoReward(
            (excludedPrice * (earnMorePercent + PRESICION)) / PRESICION
        );
    }
