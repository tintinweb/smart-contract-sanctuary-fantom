...
contract MainToken {
    ...
    address public immutable underlying = address(0); // ERC20 standard
    ...
    function mint(address _to, uint256 _amount) external returns (bool) {
        ...
        bool condition = msg.sender == owner || msg.sender == multichainRouter;
    ...
    function burn(address _from, uint256 _amount) external returns (bool) {
        ...
        bool condition = _from == msg.sender || msg.sender == multichainRouter;
