...
//  Stealth Launch
//  V3G4tokenprinter - $V3G4tokenp 
//  Telegram: https://t.me/V3G4tokenprinter
//  Initial Liquidity: 560 FTM
//  Reward: $V3G4token
...
contract V3G4tokenprinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x511D35c52a3C244E7b8bd92c0C297755FbD89212; // V3G4token
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "V3G4tokenprinter";
    string constant _symbol = "V3G4P";
