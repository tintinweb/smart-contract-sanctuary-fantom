...
contract Plague_DAO is IERC20, Auth {
    ...
    string constant _name = "Plague DAO";
    ...
    address private marketingFeeReceiver = 0x417076d443280694c47c153e3EBDb7c5798d5a0C;
    address private devFeeReceiver = 0x3772156E97fDeDfEFA17CD657233cc941F56e99C;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountFTMMarketing = amountFTM - amountFTMLiquidity - amountFTMDev;

        (bool MarketingSuccess, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountFTMMarketing, gas: 30000}("");
        require(MarketingSuccess, "receiver rejected ETH transfer");
        (bool DevSuccess, /* bytes memory data */) = payable(devFeeReceiver).call{value: amountFTMDev, gas: 30000}("");
        require(DevSuccess, "receiver rejected ETH transfer");
        addLiquidity(amountToLiquify, amountFTMLiquidity);
    }
    ...
    function addLiquidity(uint256 tokenAmount, uint256 FTMAmount) private {
        if(tokenAmount > 0){
                ...
                emit AutoLiquify(FTMAmount, tokenAmount);
            }
    }
