...
contract SCloak is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 100000 SCLOAKs
    ...
    constructor(
        ...
        address _devFund
    ) public ERC20("Cloak Share", "SCLOAK") {
        _mint(msg.sender, 1 ether); // mint 1 CLOAK Share for initial pools deployment
