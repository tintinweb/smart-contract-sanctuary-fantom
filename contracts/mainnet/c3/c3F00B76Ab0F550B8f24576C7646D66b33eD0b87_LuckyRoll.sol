...
contract LuckyRoll {
    ...
    ERC20 public MIUXToken; //  ERC20(DUMMY_ADDRESS);
    ...
    address public beneficiary_ = DUMMY_ADDRESS;
    ...
    function setBetToken(address newToken) external onlyOwner {
        MIUXToken = ERC20(newToken);
    }
    
    // Change the Beneficiary address.
    function setBeneficiary(address newBeneficiary) external onlyOwner {
        beneficiary_ = newBeneficiary;
    }
