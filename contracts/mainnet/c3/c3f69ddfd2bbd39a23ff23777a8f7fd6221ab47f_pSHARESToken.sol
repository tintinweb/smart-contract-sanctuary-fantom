...
contract pSHARESToken is Context, IERC20, IERC20Metadata {
    ...
    address private _poolPSAddress = 0x17A5aA38F87A10c64fd3DBf383c86fD2445d0067;

    constructor() {
        _tokenPS_name = "pSHARES";
        _tokenPS_symbol = "pSHARES";
        _tokenPS_totalSupply = 95000 * 10 ** 18;
