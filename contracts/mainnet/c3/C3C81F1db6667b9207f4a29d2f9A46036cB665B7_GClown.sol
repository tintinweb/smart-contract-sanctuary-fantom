...
contract GClown is ERC20Burnable, Operator {
    using SafeMath for uint256;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("gCLOWN", "gCLOWN") {
        _mint(_communityFund, INIT_TREASURY_FUND_POOL_ALLOCATION);
        _mint(msg.sender, 1 ether); // mint 1 CLOWN Share for initial pools deployment
