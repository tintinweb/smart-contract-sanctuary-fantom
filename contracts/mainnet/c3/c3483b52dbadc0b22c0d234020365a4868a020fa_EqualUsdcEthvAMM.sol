...
// File contracts/EqualUsdcEthvAMM.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract EqualUsdcEthvAMM is Ownable, Pausable {
    ...
    function addLiquidity() internal {
        ...
        IEqualizerRouter(unirouter).addLiquidity(eth, usdc, stable, lp0Bal, lp1Bal, 1, 1, address(this), block.timestamp);        
    }
    ...
    function setFees(uint256 newCallFee, uint256 newStratFee, uint256 newWithdrawFee, uint256 newTreasuryFee) external onlyOwner {        require(newWithdrawFee <= 10, "> Max Fee");
