...
contract Fakhama is IERC20
{
    ...
    address constant public owner=0x1724c4aeED7238280729cE955CE4f0579505D852;
    address constant public marketingAddress=0x1724c4aeED7238280729cE955CE4f0579505D852;
    address constant public vipCommunity=0x1724c4aeED7238280729cE955CE4f0579505D852;
     ...
     function getCoinRatec(uint memberId) public view returns(uint,uint,uint,uint)
    {
        ...
        uint256 invesment = map_Users[memberId].Investment;
