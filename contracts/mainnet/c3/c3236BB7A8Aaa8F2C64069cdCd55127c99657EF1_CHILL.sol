...
contract CHILL is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Chilling';
    string private constant _symbol = 'BPT-CHILL';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x55A7EEBF2e09a0998ba7750FfEfFB7b53C4D799a, 'We can not exclude router.');
