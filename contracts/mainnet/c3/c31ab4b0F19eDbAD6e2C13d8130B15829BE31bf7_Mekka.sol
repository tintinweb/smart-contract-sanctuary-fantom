...
/*
    Mekka Finance
*/
contract Mekka is ERC20Burnable, Operator {
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("MEKKA", "MEKKA") {
        // Mints 250 TOMB to contract creator for initial pool setup
        require(_taxRate < 1000, "tax equal or bigger to 100%");
        require(_taxCollectorAddress != address(0), "tax collector address must be non-zero address");

        excludeAddress(address(this));

        _mint(msg.sender, 250 ether);
        taxRate = _taxRate;
