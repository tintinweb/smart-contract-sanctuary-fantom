...
contract Pool is ReentrancyGuard, IPool {
    ...
    //TODO check add fee line 238 and 275
    //Finished fixing, ready deploy => result
    ...
    function mint(
        ...
        if (_collateral_amount > 0) {
            ...
            uncollectedFee = uncollectedFee.add(_collateral_amount.mul(_minting_fee).div(PRICE_PRECISION));
        }
    ...
    function redeem(
        ...
        uncollectedFee = uncollectedFee.add(_alpha_fee.mul(_effective_collateral_ratio).div(10 ** missing_decimals).div(PRICE_PRECISION));
