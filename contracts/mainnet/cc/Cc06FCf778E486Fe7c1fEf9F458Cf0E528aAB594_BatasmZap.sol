...
contract BatasmZap is Ownable, ReentrancyGuard {
    ...
    function zap(
        ...
        address _lp = address(BatChef.lpToken(_info.pid));
        ...
        approveToken(_lp, address(BatChef), _liquidity);
        BatChef.deposit(_info.pid, _liquidity, msg.sender);
