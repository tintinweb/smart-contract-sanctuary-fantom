...
// No permissions granted before Wednesday, 7 Aug 2024, then GPL-3.0 after this date.
 ...
 * out quoting reference 'NyPtvFantomWftmBifiEqualizerStrategyToUsdc'
 *
...
error NyPtvFantomWftmBifiEqualizerStrategyToUsdc__MaxSlippageOutOfBounds(uint256 maxSlippage);

contract NyPtvFantomWftmBifiEqualizerStrategyToUsdc is NYBaseProfitTakingStrategyV3 {
  ...
  address public constant GAUGE = address(0x1821Aa4C624F646d0826Fb9823E20ff63132BE4f);
  address public constant LP_TOKEN = address(0x0b4b1e0325a7150468f724BCa3de2Deb92519846);
  ...
  function updateMaxSlippage(uint256 _maxSlippage) external {
    if (_maxSlippage > 10000) {
      revert NyPtvFantomWftmBifiEqualizerStrategyToUsdc__MaxSlippageOutOfBounds(_maxSlippage);
    }
    _atLeastRole(ADMIN);
