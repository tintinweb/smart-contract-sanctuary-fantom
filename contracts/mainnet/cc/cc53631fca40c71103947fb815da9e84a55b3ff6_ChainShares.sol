...
contract ChainShares is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Chain Shares", "CSHARES") {
        ...
        marketingWallet = address(0x37DdedCb8FaC4eE415cAf68BA7ef1e62A031657a); // set as marketing wallet
        vaultWallet = address(0x616E145A3D4bAEaD3b6eFE06DC60093adbBc31Bf); // set as vault wallet
