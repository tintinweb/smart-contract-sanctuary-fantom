    ...
    RrpRequesterV0
{
    ...
    mapping(bytes32 => RandomStatus) public _requestIdToRandomStatus;
    ...
    function requestNft() public returns (bytes32 requestId) {
        ...
        _requestIdToRandomStatus[requestId].isExist = true;
