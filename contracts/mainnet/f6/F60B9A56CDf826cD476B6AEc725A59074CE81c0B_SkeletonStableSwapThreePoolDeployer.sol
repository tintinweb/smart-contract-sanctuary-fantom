...
contract SkeletonStableSwapThreePool is Ownable, ReentrancyGuard {
    ...
    ISkeletonStableSwapLP public token;
    ...
    function initialize(
        ...
        token = ISkeletonStableSwapLP(_LP);
...
import "@openzeppelin-4.5.0/contracts/access/Ownable.sol";
import "./SkeletonStableSwapThreePool.sol";

contract SkeletonStableSwapThreePoolDeployer is Ownable {
    uint256 public constant N_COINS = 3;
    ...
    function createSwapPair(
        ...
        bytes memory bytecode = type(SkeletonStableSwapThreePool).creationCode;
        ...
        SkeletonStableSwapThreePool(swapContract).initialize(coins, _A, _fee, _admin_fee, _admin, _LP);
