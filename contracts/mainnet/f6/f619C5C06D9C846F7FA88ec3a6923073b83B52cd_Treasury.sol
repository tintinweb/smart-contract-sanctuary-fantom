...
contract Treasury is ContractGuard {
    ...
    function initialize(
        ...
        // more tokens versions of stuido exapansion... following the playbook of most other forks
        supplyTiers = [
            0 ether,
            250000 ether,
            500000 ether,
        ...
        // bondDepletionFloorPercent = 9900; // 99% of Bond supply for depletion floor
        ...
        bootstrapEpochs = 28; // NOTE bootstrap epochs blocks the treasury from minting tokens to itself in case under peg
        ...
        for (uint256 i = 0; i < excludedFromTotalSupply_.length; i++) {
            ...
            // TombGenesisPool && TombRewardPool
        }
    ...
    function redeemBonds(uint256 _bondAmount, uint256 targetPrice) external onlyOneBlock checkCondition checkOperator {
        ...
        require(
            ...
            "Treasury: tombPrice not eligible for bond redemption"
        );
