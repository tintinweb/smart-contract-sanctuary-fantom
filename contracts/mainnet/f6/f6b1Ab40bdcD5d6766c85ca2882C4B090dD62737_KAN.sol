...
// File contracts/tokens/KAN.sol


pragma solidity 0.8.4;


contract KAN is ERC20Burnable {
    ...
    uint256 public constant DEV_VESTING_START = 1653523200;
    ...
    uint256 public constant TREASURY_VESTING_START = 1653523200;
    ...
    constructor() ERC20("Shikigami KAN Token", "KAN") {
    ...
    modifier onlyMinters() {
        require(rewarder == msg.sender || treasuryFund == msg.sender || devFund == msg.sender || pool == msg.sender, "Shikigami::onlyMinters: Only minters allowed");
        _;
    }
    ...
    function setRewarder(address _rewarder) external returns (bool) {
        require(rewarder == address(0), "Shikigami::setRewarder: NOT_ALLOWED");
        rewarder = _rewarder;
        return true;
    }
    ...
    {
        require(treasuryFund == address(0), "Shikigami::setTreasuryFund: NOT_ALLOWED");
    ...
    {
        require(devFund == address(0), "Shikigami::setDevFund: NOT_ALLOWED");
        devFund = _devFund;
    ...
    function setPool(address _pool) external returns (bool) {
        require(pool == address(0), "Shikigami::setPool: NOT_ALLOWED");
        pool = _pool;
        return true;
    }

    function mint(address _to, uint256 _value) external onlyMinters {
        require(MAX_TOTAL_SUPPLY >= totalSupply() + _value, "Shikigami::mint: > MAX_TOTAL_SUPPLY");
        _mint(_to, _value);
    }
}