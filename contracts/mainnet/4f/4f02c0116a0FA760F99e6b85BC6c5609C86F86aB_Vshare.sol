...
contract Vshare is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund) public ERC20("VSHARE", "VSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 VADER Share for initial pools deployment
