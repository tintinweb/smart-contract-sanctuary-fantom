...
/**
 * @title Cream's TWrappedNativeDelegate Contract
 * @notice TTokens which wrap an EIP-20 underlying and are delegated to
 * @author Cream
 */
contract TWrappedNativeDelegate is TWrappedNative {
    /**
    ...
    function _becomeImplementation(bytes memory data) public {
        ...
        // Set TToken version in tombtroller and convert native token to wrapped token.
        TombtrollerInterfaceExtension(address(tombtroller)).updateTTokenVersion(
            address(this),
            TombtrollerV1Storage.Version.WRAPPEDNATIVE
        );
