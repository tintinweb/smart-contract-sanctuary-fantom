...
contract jSHARE is Context, IERC20, IERC20Metadata {
    ...
    constructor() {
        _tokenJJ_name = "jSHARE";
        _tokenJJ_symbol = "jSHARE";
        _tokenJJ_totalSupply = 1000 * 10 ** 18;
        _balances[msg.sender] = _tokenJJ_totalSupply;
        ERC20Dependancies = IERC20Dependancies(0x91302b94503b448BB1dfA653e7894A34c845b53e);
    }
