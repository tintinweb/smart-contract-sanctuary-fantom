...
contract BaseToken is IERC20, IBaseToken {
    ...
    uint256 public MAX_Supply = 100000*1e18;
...
// File: contracts/Meteor/Meteor.sol
...
contract Meteor is MintableBaseToken {
    constructor() public MintableBaseToken("Meteor", "MTR", MAX_Supply) {
    }
