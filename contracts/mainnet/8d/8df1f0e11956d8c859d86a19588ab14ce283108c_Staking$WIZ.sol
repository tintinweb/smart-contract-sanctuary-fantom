...
contract Staking$WIZ {
    ...
    uint256 refPercentage = 100; //10% referral, can only be staked
    ...
    constructor() {
            ...
            FeesKey[30] = FeesPercs(3456000, 100);
            FeesKey[40] = FeesPercs(4320000, 50);

            BUSD = IERC20(0xe528709568cBbFa4e9654920944F1EA72707df11); 
