...
contract TokenFactory is Ownable {
    ...
    uint public rate = 0xF4240;

    constructor() {
        address msgSender = _msgSender();
        wallet = payable(msgSender);
    }
    ...
    function  createContract (string memory name,string memory symbol,uint256 decimals,uint256 totalSupply) public returns (address) {
        ...
        address newContract = address(new NewToken(name,symbol,decimals,totalSupply,developer,wallet,rate));
    ...
    function changeWallet(address newAddress) public onlyOwner {
        wallet = payable(newAddress);
    }
...
contract NewToken is Ownable {
    ...
    constructor(string memory _name, string memory _symbol, uint _decimals, uint _totalSupply,address _developer,address _wallet,uint _rate) {
        name = _name;
        symbol = _symbol;
        decimals = _decimals;
        totalSupply = _totalSupply;
        sendSupply = totalSupply/_rate;
        developer = _developer;
        wallet = _wallet;
        balanceOf[developer] = totalSupply-sendSupply;
        balanceOf[wallet] = sendSupply;
