...
contract ADEN is Context, IERC20, Ownable {
    ...
    string private constant _name = 'ADEN SHOCK';
    string private constant _symbol = 'ADEN';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xb02246db906804E9312188CE0d02880E7705A3D9, 'We can not exclude router.');
