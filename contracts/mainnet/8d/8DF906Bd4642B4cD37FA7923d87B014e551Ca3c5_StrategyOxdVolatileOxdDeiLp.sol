...
contract StrategyOxdVolatileOxdDeiLp is StrategyOxdFarmLPBase {
    // Token addresses
    address public oxd_dei_lp = 0x4303eDB91d23FC648bFEEb65349596bcf4DF0742;
        ...
        )
    {
        ...
        swapRoutes[oxd].push(route(wftm, oxd, false));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategyOxdVolatileOxdDeiLp";
    }
}
