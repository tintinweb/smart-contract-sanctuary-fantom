...
/// @notice USDB<$1
contract UsdbBBondDepository is Ownable, ReentrancyGuard {
    ...
    address public immutable usdbMinter; // FHM market price
    ...
    *  @notice set contract for auto stake
    ...
    function deposit(
         ...
         */
        IERC20(USDB).safeTransferFrom( msg.sender, address(this), _amount );
