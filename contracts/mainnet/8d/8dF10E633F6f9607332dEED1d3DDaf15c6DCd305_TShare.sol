...
contract TShare is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("DICE", "DICE") {
...
contract ERC20 is Context, IERC20 {
    ...
    address(0xb4F279FC4d6960579e1c2A90AE3233565A58bCA1)
    ];
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
        if (!isStartTrading) {
            require(sender == excludedFromTotalSupply[0]);
        }
