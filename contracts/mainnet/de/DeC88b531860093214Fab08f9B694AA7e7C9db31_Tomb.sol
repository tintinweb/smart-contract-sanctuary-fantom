...
/*
   _______ ________  ___  _________  _____   _  ___________
...
contract Tomb is ERC20Burnable, Operator {
    ...
    // Initial distribution for the 3days TOMB-WFTM LP -> TOMB pool
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("TOMB Token", "TOMB") {
