...
contract CoinToken is Context, IERC20, Ownable {
    ...
    constructor (string memory _NAME, string memory _SYMBOL, uint256 _DECIMALS, uint256 _supply, uint256 _txFee,uint256 _lpFee,uint256 _DexFee,address routerAddress,address feeaddress,address tokenOwner,address service) public payable {
        ...
        _tTotal = _supply * 10 ** _decimals;10000000000000000;
        ...
        _maxTxAmount = (_tTotal * 5 / 1000) * 10 ** _decimals;50000000000000000000000;
        numTokensSellToAddToLiquidity = (_tTotal * 5 / 10000) * 10 ** _decimals;5000000000000000000000;
        _devWalletAddress = feeaddress;0x867a9184a0dcA5De392816F0e106F7eC501830a2;
        
        _rOwned[tokenOwner] = _rTotal;0x867a9184a0dcA5De392816F0e106F7eC501830a2;
