...
contract PaymentFacet {
    ...
    function subscribe(
        ...
        require(_subscriptionId != subscriptionId && subscriptionStatus == true, "Already subscribed !");
...
library LibSubscriptionTypes {
    ...
    function subscriptions(uint256 subscriptionManagerId, uint256 subscriptionId) internal view returns (SubscriptionStruct memory) {
