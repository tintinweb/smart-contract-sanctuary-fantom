...
contract StrategyOxdVolatileIbWftmLp is StrategyOxdFarmLPBase {
    // Token addresses
    address public ib_wftm_lp = 0x304B61f3481C977Ffbe630B55f2aBeEe74792664;
    address public ib = 0x00a35FD824c717879BF370E70AC6868b95870Dfb;
    ...
    {
        swapRoutes[ib].push(route(wftm, ib, false));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategyOxdVolatileIbWftmLp";
    }
}
