...
contract FlashShare is ERC20Burnable, Operator {
    using SafeMath for uint256;
    ...
    constructor(uint256 _startTime, address _devFund, address _communityFund) public ERC20("XSHARE", "XSHARE") {
        _mint(msg.sender, 50 ether); // mint 1 BOMB Share for initial pools deployment
