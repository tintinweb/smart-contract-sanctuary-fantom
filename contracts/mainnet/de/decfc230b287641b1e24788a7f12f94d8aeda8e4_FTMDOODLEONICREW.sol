/**
 *Submitted for verification at FtmScan.com on 2022-09-26
*/
    ...
    ClampedRandomizer
{
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("FTM Doodle Oni Crew", "FDOC") ClampedRandomizer(maxSupply) {     
