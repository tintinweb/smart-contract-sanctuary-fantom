...
contract FrensPad is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Frens Pad", "FPAD") {
        ...
        marketingWallet = address(0x730B88af47fcFA897aC9aee8EA665cEA903736CB); // set as marketing wallet
        treasuryWallet = address(0x775798c8B84A44495bD81114f4a154B9ee37B374); // set as treasury wallet
