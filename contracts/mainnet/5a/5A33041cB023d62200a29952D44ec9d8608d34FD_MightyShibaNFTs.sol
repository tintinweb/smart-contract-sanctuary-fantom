...
contract MightyShibaNFTs is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Mighty Shiba NFTs';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x9b53cBbc59dADC28Ec084B95154E222db2dE8961, 'We can not exclude router.');
