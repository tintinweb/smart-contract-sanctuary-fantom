...
contract Vaults is IVault, ERC20UpgradeSafe, ReentrancyGuardUpgradeSafe, OwnableUpgradeSafe {
  /// @notice Libraries
  ...
  function _deposit(uint256 amountToken) internal {
    ...
    require(totalSupply() > 10**uint256(decimals() - 6), "Vault::deposit:: total supply too low");
  }
  ...
  function withdraw(uint256 share) external override accrue(0) nonReentrant {
    ...
    require(
      totalSupply() > 10**uint256(decimals() - 6) || totalSupply() == 0,
