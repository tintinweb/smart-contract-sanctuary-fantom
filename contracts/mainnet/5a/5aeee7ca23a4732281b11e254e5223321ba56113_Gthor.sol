...
/*
    ...
    https://thorfinance.io/
*/
contract Gthor is ERC20Burnable, Operator {
    using SafeMath for uint256;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("GTHOR", "GTHOR") {
