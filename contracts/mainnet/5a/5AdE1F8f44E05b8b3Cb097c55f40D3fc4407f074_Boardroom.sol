...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    /* ========== GOVERNANCE ========== */
    // scar2 token, sshare2 token, treasury address
    function initialize(
        IERC20 _scar2,
        IERC20 _share,
        ITreasury _treasury
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            scar2.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        scar2.safeTransferFrom(msg.sender, address(this), amount);
