...
contract GenomicDAO is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Genomic DAO';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x67ED1A363EFA0dBF6fcc52aFF74D5bF3C564E011, 'We can not exclude router.');
