...
contract Treasury is ContractGuard {
    ...
    address[] public excludedFromTotalSupply = [
        address(0xF2572ddB84eA9887AB3F671C5830d73958A19518),
        address(0x7013816B7cD7e7222fF17F264a3cfF1aF8030b0e)
    ];
    ...
    function initialize(
        ...
        maxSupplyContractionPercent = 300; // Upto 3.0% supply for contraction (to burn MRY and mint tBOND)
