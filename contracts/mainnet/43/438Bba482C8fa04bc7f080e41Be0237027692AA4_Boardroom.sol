...
contract ShareWrapper {
    ...
    function stake(uint256 amount) public virtual {
        ...
        vampshare.safeTransferFrom(msg.sender, address(this), amount);
    }
    ...
    function withdraw(uint256 amount) public virtual {
        ...
        vampshare.safeTransfer(msg.sender, amount);
    }
}
...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    address public Dao = 0xf4Fb0ab2419815C3145D4a07fc753F8d8FE30FcD;
    address public team = 0xA0634CE9996715bFB4442DC3E28cB6AeB41C339f;
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            vamp.safeTransfer(msg.sender, reward.mul(90).div(100));
            vamp.safeTransfer(Dao, reward.mul(7).div(100));
            vamp.safeTransfer(team, reward.mul(3).div(100));
