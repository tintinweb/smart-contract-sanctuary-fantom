...
contract Test {
    ...
    IPaymentSplitter test;

    constructor() {
        test = IPaymentSplitter(
            0x74973811B8D9fEd56cb0720F1790bbAB71b5d09e.clone()
        );
    }

    function withdraw() public {
        IPaymentSplitter splitter = IPaymentSplitter(address(test).clone());
        splitter.initialize();
        splitter.addPayee(msg.sender, 100);
