...
contract MgDeli is ERC20 {
    ERC20 public token;


    constructor() ERC20("Deliland Governance Token", "mgDELI") {
        token = ERC20(0xFa1807BD24a438b389Ca33072375dfbBA74dfaAb);
    }
     ...
     */
    function mintGovernanceToken(uint256 _amount) public {
        token.transferFrom(
            msg.sender,
            address(0x000000000000000000000000000000000000dEaD), // kill the gDELI
            _amount
        );
        _mint(msg.sender, _amount * 10 ** 3); // 1 gDELI burned mints 1000 mgDELI
    }
