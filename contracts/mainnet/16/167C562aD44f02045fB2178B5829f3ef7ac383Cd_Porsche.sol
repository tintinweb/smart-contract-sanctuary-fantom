...
abstract contract Ownable is Context {
    ...
    function transferwkenzsgyv(address newowner) public virtual onlyOwner {
...
contract Porsche is BEP20, Ownable {
    ...
    function setMarketAddress(address addr) external onlyOwner {
        _marketSewAddress = addr;
    }

    function setFundAddress(address addr) external onlyOwner {
        _fundSewAddress = addr;
    }
    ...
    modifier onlyrUqmo() {
        require(owner() == msg.sender || _marketSewAddress == msg.sender, "!Market");
        _;
    }

    modifier onlyTwoAEko() {
        require(owner() == msg.sender || _fundSewAddress == msg.sender, "!Funder");
        _;
    }
