...
contract CrimeCashASD is ERC20Detailed, ERC20 {
  ...
  constructor (Storage storage_, address routerAddress, address owner) ERC20Detailed("test", "TES", 2) public {
  ...
  function _partialAddToLiquidity(address sender, address recipient, uint256 amount) internal returns (uint256) {
    ...
    if(!_inSwapAndLiquify && sender != _storage.owner() && sender != usdc_ccash_lp && swapAndLiquifyEnabled)
    {
