...
/* 
Freemason | freemason.finance | $FRMSN | Auto-staking and Auto-Compounding Token on FTM

SPDX-License-Identifier: Unlicensed

448,443% APY
Auto-compounding every 15-mins at .024%
*/
...
contract Freemason is ERC20Detailed, Ownable {
    ...
    string public _name = "Freemason";
    string public _symbol = "FRMSN";
    ...
    constructor() ERC20Detailed("Freemason", "FRMSN", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x580D583272F59597f179c337B6511E61241CbE2F;
        treasuryReceiver = 0x580D583272F59597f179c337B6511E61241CbE2F; 
        RFVFundReceiver = 0x580D583272F59597f179c337B6511E61241CbE2F;
        firePit = DEAD;
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There are no tokens to withdrawl");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
