...
contract FantomMonkey is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Fantom Monkey';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x5ED097f5e49a8A4F3131300294adD96CBbE65bf9, 'We can not exclude router.');
