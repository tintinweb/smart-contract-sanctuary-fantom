...
import "../contracts-library/Babylonian.sol";
import "../contracts-library/Epoch.sol";
import "../contracts-library/FixedPoint.sol";
import "../contracts-library/IUniswapV2Pair.sol";
...
contract Oracle is Epoch {
    ...
    function __initialize__(uint256 _startTime) public initializer {
        uint256 _period = 21600;
        init(_period, _startTime, 0);
        __initializeOperator__();
    }

    function setPairAddress(IUniswapV2Pair _pair) external onlyOperator {
        pair = _pair;
        token0 = pair.token0();
        token1 = pair.token1();
