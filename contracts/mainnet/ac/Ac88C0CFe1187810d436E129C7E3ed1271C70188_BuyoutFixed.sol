...
contract BuyoutFixed is ISaleModel, InitOwnable {
    ...
    ISaleFactory constant public SALE_FACTORY = ISaleFactory(0xfBCBD104d1e2Ccb0a64a6a9ED1f5293612f1699f);
    IERC20 constant public WETH = IERC20(0xfBCBD104d1e2Ccb0a64a6a9ED1f5293612f1699f);
