...
contract IZenGarden {
  ...
  struct PoolInfo {
    ...
    uint256 lastRewardBlock; // Last block number that HNR distribution has occurred up to endBlock.
    uint256 accumulatedHNRPerShare; // Per LP token staked, how much HNR earned in pool that users will get
...
// 
/*
  Disclaimer: This is a testing contract, not meant for production use
*/
contract ZenGarden is Ownable, ReentrancyGuard, IZenGarden {
  ...
  constructor(
    ...
    // start at the moment of the deploy
