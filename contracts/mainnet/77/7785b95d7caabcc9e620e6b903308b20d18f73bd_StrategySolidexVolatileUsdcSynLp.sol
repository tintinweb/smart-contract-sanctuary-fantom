...
// File src/strategies/fantom/solidly/strategy-solidex-volatile-usdc-syn-lp.sol
// License-Identifier: MIT
pragma solidity ^0.8.11;


contract StrategySolidexVolatileUsdcSynLp is StrategySolidexFarmLPBase {
    // Token addresses
    ...
    function getName() external pure override returns (string memory) {
        return "StrategySolidexVolatileUsdcSynLp";
    }
}