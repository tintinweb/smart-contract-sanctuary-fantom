...
contract StrategyOxdVolatileLqdrWftmLp is StrategyOxdFarmLPBase {
    // Token addresses
    address public lqdr_wftm_lp = 0x9861B8a9Acc9B4f249981164bFe7f84202068bfE;
    ...
    {
        swapRoutes[lqdr].push(route(wftm, lqdr, false));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategyOxdVolatileLqdrWftmLp";
    }
}
