...
contract GShareV2 is ERC20Burnable, Operator {
    using SafeMath for uint256;


    // TOTAL MAX SUPPLY = 50,000 tSHAREs
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 40000 ether; // 40,000
    uint256 public constant COMMUNITY_FUND_POOL_ALLOCATION = 5500 ether;
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 4499 ether;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("GSHAREV2", "GSHAREV2") {
