...
contract YolaToken is ERC20Permit, Ownable {

    constructor() ERC20("YolaToken", "YOLA") ERC20Permit("YolaToken")
    {

    }

    uint256 constant private _maxTotalSupply = 33000000e18; // 33,000,000 max andas
    ...
    */
    ...
    function delegateBySig(address delegatee, uint nonce, uint expiry, uint8 v, bytes32 r, bytes32 s ) external {
        ...
        require(signatory != address(0), "YOLA::delegateBySig: invalid signature");
        require(nonce == _useNonce(signatory), "YOLA::delegateBySig: invalid nonce");
        require(block.timestamp <= expiry, "YOLA::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "YOLA::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying YOLAs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "YOLA::_writeCheckpoint: block number exceeds 32 bits");
