...
// File src/strategies/fantom/solidly/strategy-solidex-volatile-usdc-oxd-lp.sol
// License-Identifier: MIT
pragma solidity ^0.8.11;


contract StrategySolidexVolatileUsdcOxdLp is StrategySolidexFarmLPBase {
    // Token addresses
    address public usdc_oxd_lp = 0xEaFB5Ae6eEa34954eE5e5a27B068B8705CE926a6;
    address public usdc = 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75;
    address public oxd = 0xc165d941481e68696f43EE6E99BFB2B23E0E3114;
        ...
        )
    {
        ...
        swapRoutes[oxd].push(route(wftm, usdc, false));
        swapRoutes[oxd].push(route(usdc, oxd, false));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategySolidexVolatileUsdcOxdLp";
    }
}