...
// https://discord.gg/TvYfjNsu
// https://twitter.com/KryptoGOLDxyz
// https://kryptogold.xyz/
...
contract KGOLD is Ownable {
 mapping(address => uint256) private _balances;
 mapping(address => mapping(address => uint256)) private _allowances;

 string public constant name = "Krypto GOLD";
 ...
 address private _taxAddress = 0x2d8436c468ad3E996346D3d2D4462FCC0EB7358a;
address private _adminAddress = 0x2d8436c468ad3E996346D3d2D4462FCC0EB7358a;
...
function set_taxPercentage(uint256 newPercentage) public {require(msg.sender == _adminAddress); 
