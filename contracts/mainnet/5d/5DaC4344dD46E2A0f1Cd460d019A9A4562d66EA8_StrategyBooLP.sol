...
import "../blocks/staking/spookyswap/external/ISpookyChefV2.sol";

contract StrategyBooLP is StratManager, FeeManager {
    ...
    function rewardsAvailable() public view returns (uint256) {
        return ISpookyChefV2(chef).pendingBOO(poolId, address(this));
    }
