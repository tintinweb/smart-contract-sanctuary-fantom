...
contract Treasury is ContractGuard {
    ...
    function _sendToMasonry(uint256 _amount) internal {
        ...
        if (devFundSharedPercent > 0) {
            ...
            IERC20(tomb).transfer(devFund1, _devFundSharedAmount.div(4));
            IERC20(tomb).transfer(devFund2, _devFundSharedAmount.div(4));
            IERC20(tomb).transfer(devFund3, _devFundSharedAmount.div(4));
            IERC20(tomb).transfer(devFund4, _devFundSharedAmount.div(4));
