...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MUMMY = IBEP20(0x01e77288b38b416F972428d562454fb329350bAc); // Mummy
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = MUMMY.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WFTM;
        path[1] = address(MUMMY);
        ...
        uint256 amount = MUMMY.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            MUMMY.transfer(shareholder, amount);
...
contract MummyPrintrr is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address MUMMY = 0x01e77288b38b416F972428d562454fb329350bAc; // Mummy 
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "MummyPrintrr";
    string constant _symbol = "MMYRR";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(100); // 2%
    ...
    address public autoLiquidityReceiver=0xA25d3213a7d678d2f96DeCB7700750f1D351B289; //liq address
    address public marketingFeeReceiver=0xA25d3213a7d678d2f96DeCB7700750f1D351B289; // marketing address
