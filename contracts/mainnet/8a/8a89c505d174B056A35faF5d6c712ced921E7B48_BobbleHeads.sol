...
/**
 *Submitted for verification at FtmScan.com on 04/02/2022
*/
...
// Bobble Mintable Token

interface BobbleMintable {
 ...
 */
contract BobbleHeads is ERC721, Ownable {
    using SafeMath for uint256;
    uint256 public constant MAX_Supply = 10000;
    uint256 private scopeIndex = 0;
    uint256 public price = 20 ether; // 20 FTM
   ...
   uint256 public allowListMaxMint = 5;
    ...
    constructor(string memory baseURI) ERC721("BobbleHeads","BH")  {
        setBaseURI(baseURI);
    }
  ...
  */
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // Mint with Bobble Token
    function mintWithToken(uint256 numberOfTokens,uint256 id) public  {
        require(hasPresaleStarted == true, "Presale hasn't started");
        require(totalSupply().add(numberOfTokens) <= MAX_Supply, "Exceeds MAX_Supply");

        BobbleMintable bobbleMintable = BobbleMintable(0x25511cbb2443AaC2D9C2484553d48061a55a3CCe);
        require(bobbleMintable.balanceOf(msg.sender,id) >= numberOfTokens, "Not enough NFTs to claim.");
            
        bobbleMintable.burn(msg.sender, id, numberOfTokens);
    ...
    function adminMint(address user, uint256 quantity) external  onlyOwner  {
