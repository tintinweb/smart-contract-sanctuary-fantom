...
contract POTIONProxy is BaseOFTV2 {
    using SafeERC20 for IERC20;

    IERC20 internal immutable potion=IERC20(0x3edA36088b931098e8E472748840b3dF78268c72);
    uint internal immutable ld2sdRate=10 ** (8);
    ...
    constructor() BaseOFTV2(10, 0xb6319cC6c8c27A8F5dAF0dD3DF91EA35C4720dd7) {
    }
    ...
    ************************************************************************/
    function circulatingSupply() public view virtual override returns (uint) {
        return potion.totalSupply() - outboundAmount;
    }
    ...
    ************************************************************************/
    function _debitFrom(address _from, uint16, bytes32, uint _amount) internal virtual override returns (uint) {
        ...
        if (dust > 0) potion.safeTransfer(_from, dust);
    ...
    function _transferFrom(address _from, address _to, uint _amount) internal virtual override returns (uint) {
        uint before = potion.balanceOf(_to);
        if (_from == address(this)) {
            potion.safeTransfer(_to, _amount);
        } else {
            potion.safeTransferFrom(_from, _to, _amount);
        }
        return potion.balanceOf(_to) - before;
    }
