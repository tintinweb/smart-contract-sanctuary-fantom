...
contract XMummy is ERC20Burnable, Operator {
    ...
    // Distribution for ADD LIQUIDITY when starting
     uint256 public constant INITIAL_LIQUIDITY_WALLET_DISTRIBUTION = 200 ether;
    ...
    function distributeReward(
        ...
        address _Liquidity4Starting = address(0x9e4AaDB08207EB5C292c5de8aF2d47e7dD9Aef1e);
        _mint(_Liquidity4Starting, INITIAL_LIQUIDITY_WALLET_DISTRIBUTION);
    }
