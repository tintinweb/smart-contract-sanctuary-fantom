...
// File src/strategies/fantom/solidly/strategy-solidex-usdc-mim-lp.sol

pragma solidity ^0.8.11;


contract StrategySolidexUsdcMimLp is StrategySolidexFarmLPBase {
    // Token addresses
    ...
    {
        swapRoutes[usdc].push(route(wftm, sex, false));
        swapRoutes[usdc].push(route(usdc, wftm, true));
        swapRoutes[mim].push(route(wftm, sex, false));
        swapRoutes[mim].push(route(usdc, wftm, true));
        swapRoutes[mim].push(route(mim, usdc, true));
    }
    ...
    function getName() external pure override returns (string memory) {
        return "StrategySolidexUsdcMimLp";
    }
}