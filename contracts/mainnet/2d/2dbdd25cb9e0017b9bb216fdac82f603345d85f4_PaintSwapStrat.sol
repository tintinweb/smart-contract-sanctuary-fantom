...
contract PaintSwapStrat is Ownable, Pausable {
    ...
    address[] public wrappedToBeetsRoute;
    ...
    constructor(
        ...
        wrappedToBeetsRoute = [wrapped, beets];
    ...
    function addLiquidity() internal {
        ...
        IUniSwapRouter(unirouter).swapExactTokensForTokensSupportingFeeOnTransferTokens(wrappedHalf, 0, wrappedToBeetsRoute, address(this), block.timestamp);
   
        uint256 lp0Bal = IERC20(wrapped).balanceOf(address(this));
        uint256 lp1Bal = IERC20(beets).balanceOf(address(this));

        IUniSwapRouter(unirouter).addLiquidity(wrapped, beets, lp0Bal, lp1Bal, 1, 1, address(this), block.timestamp);
    }
