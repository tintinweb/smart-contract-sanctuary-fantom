...
contract FakeOracle {
    ...
    function setAnswer(uint256 _answer) public returns (uint256) {
        require(msg.sender == admin, "only the admin may set the new answer");
        answer = _answer;
    }

    function latestAnswer() public view returns (int256) {
        return SafeCast.toInt256(answer);
    }
