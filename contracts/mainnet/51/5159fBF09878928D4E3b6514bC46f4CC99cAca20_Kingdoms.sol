...
// File: contracts/Fantomized/kingdoms.sol
...
abstract contract ERC721Tradable is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function mintNTo(address _to, uint256 number) public onlyOwner {
        require(_currentTokenId <= 999 - 25, "Not allowed");  // Stop before max supply
    ...
    function claim(
        ...
        require(msg.value >= _amountClaim, "Too few ftm, check price");
        uint256 newTokenId = _currentTokenId.add(1);
        _mint(_to, newTokenId);
        _currentTokenId++;
    }
    ...
    function claimDiscount(
        ...
        require(_currentTokenId < _maxClaim, "Minting is over for this batch");
        require(msg.value >= _amountClaimDiscount, "Too few ftm, check price");
        // check balance
...
/**
 * @title Kingdoms of Eidolon
 * Kingdoms
 */
contract Kingdoms is ERC721Tradable {

    string _baseUrl;

    constructor()
        ERC721Tradable("Kingdoms", "KNGDM")
    {}
