...
contract SpiritFantomMimUsdcStrategy is MasterChefBaseStrategy {
    ...
    function initialize(address _vault, address _parentStrategy)
        ...
        initializer
    {
        __NAME = "SpiritSwap MimUsdc Strategy";
        address underlying = address(
            0xc19C7615237f770179ed93d89126478c60742664
        ); //MimUsdc Spirit LP
        uint256 poolId = 67; // MimUsdc Pool id
        ...
        address mim = address(0x82f0B8B456c1A451378467398982d4834b6829c1);

        rewardRoutes[mim] = [spirit, wftm, mim];
        rewardRoutes[usdc] = [spirit, wftm, usdc];

        fromVaultAssetRoutes[dai][usdc] = [dai, usdc];
        fromVaultAssetRoutes[dai][mim] = [dai, usdc, mim];
        fromVaultAssetRoutes[usdt][mim] = [usdt, wftm, mim];
        fromVaultAssetRoutes[usdt][usdc] = [usdt, wftm, usdc];
        fromVaultAssetRoutes[usdc][mim] = [usdc, mim];

        toVaultAssetRoutes[dai][usdc] = [usdc, dai];
        toVaultAssetRoutes[dai][mim] = [mim, usdc, dai];
        toVaultAssetRoutes[usdt][mim] = [mim, wftm, usdt];
        toVaultAssetRoutes[usdt][usdc] = [usdc, wftm, usdt];
        toVaultAssetRoutes[usdc][mim] = [mim, usdc];
