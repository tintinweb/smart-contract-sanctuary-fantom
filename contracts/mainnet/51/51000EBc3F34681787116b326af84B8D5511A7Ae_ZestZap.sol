...
/*
    ...
    3. add into farm
*/
contract ZestZap is Ownable, ReentrancyGuard {
    ...
    function zapToken(
        ...
        console.log("_ethAmtToSwap: ", _ethAmtToSwap);
        console.log("_token0AmtToAddLP: ", _token0AmtToAddLP);

        // STEP 2: Swap into token1
        (uint256 _remaining, uint256 _token1AmtToAddLP) = swapToken(_lp, _ethAmtToSwap, _token1);

        console.log("_remaining: ", _remaining);
        console.log("_token1AmtToAddLP: ", _token1AmtToAddLP);
