/**
 *Submitted for verification at FtmScan.com on 2022-12-30
*/

// SPDX-License-Identifier: No License (None)
// No permissions granted before Saturday, 29 Jun 2024, then GPL-3.0 after this date.
...
contract NyPtvFantomUsdcOathSpookyV3StrategyToOath is NYBaseProfitTakingStrategyV3 {
  ...
  function estimateHarvest() external view override returns (uint256 profit, uint256 callFeeToUser) {
    ...
    if (totalRewards != 0) {
      profit += IUniswapV2Router02(SPOOKY_ROUTER).getAmountsOut(totalRewards, booToOathPath)[1];
    }
