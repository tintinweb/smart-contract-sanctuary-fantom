...
contract OShare is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("O-SHARE", "O-SHARE") {
        _mint(_communityFund, INIT_TREASURY_FUND_POOL_ALLOCATION);
        _mint(msg.sender, 1 ether); // mint 1 OMEGA Share for initial pools deployment
