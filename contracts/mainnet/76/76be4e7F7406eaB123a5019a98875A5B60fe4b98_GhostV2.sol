...
// File: contracts/GhostV2.sol


pragma solidity 0.6.12;


contract GhostV2 is ERC20Burnable, Operator {
    using SafeMath8 for uint8;
    using SafeMath for uint256;


    // Initial distribution for Liquidity
    uint256 public constant INITIAL_LAUNCH_DISTRIBUTION = 10000 ether;
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("GHOSTV2", "GHOSTV2") {
