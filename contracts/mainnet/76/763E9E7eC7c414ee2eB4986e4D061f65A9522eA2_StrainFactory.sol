...
contract StrainFactory is StrainContract {
    ...
    constructor(
        ...
        rewardPerNFT = 250*(10**18);
        rewardPerStage = 300*(10**18);
        price = (1 * (10**16));
        strnToken = IERC20(_strToken);
    ...
    function calculateRarityScore(uint128 _dna) private pure returns (uint128) {
