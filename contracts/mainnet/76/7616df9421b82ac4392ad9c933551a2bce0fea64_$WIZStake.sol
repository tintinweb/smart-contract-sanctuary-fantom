...
contract $WIZStake {
    ...
    IERC20 public token = IERC20(0xFEA32E1f0572EBFAFCaC7CA556400BfE8D8847f5); //** Main
	uint256 constant public INVEST_MIN_AMOUNT = 50e18; // 50 $WIZ
	...
	constructor(address payable wallet) public {
        ...
        plans.push(Plan(100, 150)); // 1.4% for 100 days = 140%
		plans.push(Plan(200, 95)); // 0.95% for 200 days = 190%
		plans.push(Plan(300, 80)); // 0.8% for 300 days = 240%
