...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/docs-v3.x/contracts/math/Math.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/docs-v3.x/contracts/math/SafeMath.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/docs-v3.x/contracts/token/ERC20/IERC20.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/docs-v3.x/contracts/utils/Context.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/docs-v3.x/contracts/access/Ownable.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/docs-v3.x/contracts/GSN/Context.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/docs-v3.x/contracts/token/ERC20/ERC20.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/docs-v3.x/contracts/token/ERC20/ERC20Burnable.sol
...
contract Tomb is ERC20Burnable, Operator {
    ...
    uint256 public constant INITIAL_TOMB_POOL_DISTRIBUTION = 130000 ether;
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("MOON", "MOON Token") {
    ...
    function _getTombPrice() internal view returns (uint256 _tombPrice) {
        try IOracle(tombOracle).consult(address(this), 1e18) returns (uint144 _price) {
            ...
            revert("Moon: failed to fetch TOMB price from Oracle");
        }
    }
