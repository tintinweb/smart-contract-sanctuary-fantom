    ...
    GovernorTimelockControl
{
    ...
    mapping(uint256 => uint256) public _proposalIdLists;
    ...
    function votingDelay() public pure override returns (uint256) {
        // return 100; // 1 day , 1 block / 1.35 second
    ...
    {
        proposalCount++;
        _proposalIdLists[proposalCount] = super.propose(
            targets,
            values,
            calldatas,
            description
        );
        return _proposalIdLists[proposalCount];
    }
