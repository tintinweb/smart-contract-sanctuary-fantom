...
contract RADIANT is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 18000 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'Radiant DeFi';
    string private constant _symbol = 'RAYS';

    uint256 private _taxFee = 800;
    uint256 private _burnFee = 0;
    uint public max_tx_size = 18000 ether;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xfCe27d73e52a793eb06d3041cfB1345B07BcC86F, 'We can not exclude router.');
