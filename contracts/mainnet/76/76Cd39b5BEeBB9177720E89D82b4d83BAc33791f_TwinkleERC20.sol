...
/**
 * @title Starbank Reward Token
 * @author Starbank
 */
contract TwinkleERC20 is ERC20VotesComp {
    /// @notice Initializes Starbank token and mints entire supply (1,000,000,000) to deployer
    /// @dev No more tokens can be minted after initialization
    constructor() ERC20("STARBANK", "TWINKLE") ERC20Permit("STARBANK") {
