...
// File: contracts/USDCPaycheck.sol
...
contract USDCPaycheck is Context, Ownable {
    address usdc = 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75;
    address private feeAddress = 0x9Fc8c583e81bFe45049d018Da6668f107BC27F3D;
    ...
    function withdraw() public {
        ...
        ERC20(usdc).transfer(address(msg.sender), amount - fee - treasuryFee);
    }
    ...
    function withdrawRef() public {
        ...
        ERC20(usdc).transfer(address(msg.sender), users[msg.sender].bonus);
        users[msg.sender].bonus = 0;
    }
