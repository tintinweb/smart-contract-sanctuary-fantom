...
contract FRAX is Context, IERC20, Ownable {
    ...
    string private constant _name = 'FRAX';
    string private constant _symbol = 'FRAX';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xD46069AbBe8A41F2d8AdFD8e8440E601a6Ef5FA2, 'We can not exclude router.');
