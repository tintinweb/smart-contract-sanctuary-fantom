...
contract KANPEKIFTM is Context, IERC20, Ownable {
    ...
    string private constant _name = 'KANPEKI FANTOM';
    string private constant _symbol = 'KAEFTM';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x51d9d19af2fD47a0130cfB9F0a43EF8DeE5E2cd3, 'We can not exclude router.');
