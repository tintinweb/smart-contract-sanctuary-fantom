/**
 *Submitted for verification at FtmScan.com on 2022-11-25
*/

// SPDX-License-Identifier: No License (None)
// No permissions granted before Saturday, 25 May 2024, then GPL-3.0 after this date.
 ...
 * out quoting reference 'NyPtvFantomLqdrWftmWigoStrategyToUsdc'
 *
...
contract NyPtvFantomLqdrWftmWigoStrategyToUsdc is NYBaseProfitTakingStrategyV2 {
  ...
  function _swapFarmEmissionTokens() internal {
    ...
    wigo.safeIncreaseAllowance(WIGO_ROUTER, wigoBalance);

    uint256[] memory amounts = IUniswapV2Router02(WIGO_ROUTER).getAmountsOut(wigoBalance, wigoToUsdcPath);
  ...
  function estimateHarvest() external view override returns (uint256 profit, uint256 callFeeToUser) {
    ...
    if (totalRewards != 0) {
      profit += IUniswapV2Router02(WIGO_ROUTER).getAmountsOut(totalRewards, wigoToUsdcPath)[1];
    }
