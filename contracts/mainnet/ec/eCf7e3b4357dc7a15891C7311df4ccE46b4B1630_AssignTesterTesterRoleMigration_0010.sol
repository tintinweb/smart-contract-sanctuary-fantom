...
contract AssignTesterTesterRoleMigration_0010 {
    function migrate() external {
        ...
        LibAccessControl.grantRole(
            LibRoles.TESTER_ROLE,
            0xEc79bA2261D3120cd41277Cb725817eB5D9C4A69
        );
        LibAccessControl.grantRole(
            LibRoles.TESTER_ROLE,
            0x8D4B2b5e38694C2D7A2763244a3C593Af932c3be
        );
        LibAccessControl.grantRole(
            LibRoles.TESTER_ROLE,
            0x309931257DF8Bd309e12A6fe9F3ac699E9Ac4e62
        );
        LibAccessControl.grantRole(
            LibRoles.TESTER_ROLE,
            0x93a60a4F15430D139885a5cE4a2539a96051fC4D
        );
        LibAccessControl.grantRole(
            LibRoles.TESTER_ROLE,
            0x2E4FE79a0D8418F1012EE9f174019d6C78A912d1
        );
        LibAccessControl.grantRole(
            LibRoles.TESTER_ROLE,
            0xE00D7D7c1D3aF558eFeDf77511ce121e65220311
        );
        LibAccessControl.grantRole(
            LibRoles.TESTER_ROLE,
            0xE41023C151001d87223249da8D79F6cE8A1DdB11
        );
        LibAccessControl.grantRole(
            LibRoles.TESTER_ROLE,
            0x9Ec35E398727C29B8424599362efA781F93C5c14
        );
    }
}
