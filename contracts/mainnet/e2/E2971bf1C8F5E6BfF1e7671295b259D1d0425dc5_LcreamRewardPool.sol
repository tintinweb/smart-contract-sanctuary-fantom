...
contract LcreamRewardPool {
    ...
    struct PoolInfo {
        ...
        uint256 allocPoint; // How many allocation points assigned to this pool. LCREAM s to distribute per block.
        uint256 lastRewardTime; // Last time that LCREAM s distribution occurs.
        uint256 accLcreamPerShare; // Accumulated LCREAM s per share, times 1e18. See below.
    ...
    // View function to see pending LCREAM s on frontend.
    ...
    // Safe lcream transfer function, just in case if rounding error causes pool to not have enough LCREAM s.
