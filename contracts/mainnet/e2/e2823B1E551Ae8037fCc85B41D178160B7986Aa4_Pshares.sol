...
contract Pshares is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 50,000 Psharess
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("PSHARES", "PSHARES") {
        _mint(msg.sender, 10 ether); // mint 10 PESTO Share for initial pools deployment
