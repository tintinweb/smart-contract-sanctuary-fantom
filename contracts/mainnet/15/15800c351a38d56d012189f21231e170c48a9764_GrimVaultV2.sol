...
// File: contracts/interfaces/ISpookyStratV2.sol

pragma solidity 0.8.4;


interface ISpookyStratV2 { 
...
contract GrimVaultV2 is ERC20, Ownable, ReentrancyGuard {
    ...
    ISpookyStratV2 public strategy;
    ...
    function balance() public view returns (uint) {
        return want().balanceOf(address(this)) + ISpookyStratV2(strategy).balanceOf();
    }
    ...
    function proposeStrat(address _implementation) public onlyAdmin {
        require(address(this) == ISpookyStratV2(_implementation).vault(), "!Valid proposal");
    ...
    function upgradeStrat() public onlyAdmin {
        ...
        strategy = ISpookyStratV2(stratCandidate.implementation);
