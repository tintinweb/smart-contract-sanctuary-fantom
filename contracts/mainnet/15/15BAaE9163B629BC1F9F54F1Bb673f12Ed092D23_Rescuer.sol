...
contract Rescuer is Ownable {
    ...
    IBeefyVault public beefyVault = IBeefyVault(0x39d3A615fa43fA0Ea25af7d46d049cBe873E6105);
    ...
    function getTotalFlashFee(uint256 _tusdNeeded) public pure returns (uint256) {
    ...
    function upgrade() external onlyOwner {
        ...
        tusd.safeTransferFrom(msg.sender, address(this), getTotalFlashFee(tusdNeeded()));
        // Start Flash Loan
        tusdPair.swap(0, tusdNeeded(), address(this), "BeefyRescue");
    }
    ...
    function uniswapV2Call(address, uint, uint amount1, bytes calldata) external {
        ...
        tusd.transfer(address(tusdPair), debt);
