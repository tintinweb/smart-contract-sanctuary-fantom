...
contract EqualFbombBeetsvAMM is Ownable, Pausable {
    ...
    IEqualizerRouter.Routes[] public wrappedToBeetsPath;
    ...
    constructor(
        ...
        IEqualizerRouter.Routes[] memory _wrappedToBeetsPath
        ...
        for (uint i; i < _wrappedToBeetsPath.length; ++i) {
            wrappedToBeetsPath.push(_wrappedToBeetsPath[i]);
        }
    ...
    function addLiquidity() internal {
        ...
        IEqualizerRouter(unirouter).swapExactTokensForTokens(wrappedHalf, 0, wrappedToFbombPath, address(this), block.timestamp);
        IEqualizerRouter(unirouter).swapExactTokensForTokens(wrappedHalf, 0, wrappedToBeetsPath, address(this), block.timestamp);
    ...
    function _giveAllowances() internal {
        ...
        IERC20(beets).safeApprove(unirouter, type(uint).max);
    }
