...
contract AzmoPystToken is Context, IERC20, IERC20Metadata {
    ...
    address private _poolAPAddress = 0x5925C5F60d76a869E0197D5C48FF52c02d06aE3c;

    constructor() {
        _tokenAP_name = "AzmoPyst";
        _tokenAP_symbol = "AzmoPyst";
        _tokenAP_totalSupply = 59700 * 10 ** 18;
