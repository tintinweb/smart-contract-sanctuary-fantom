...
contract ProfitDistribution is Operator {
    ...
    constructor(IERC20 _rewardAddress1, IERC20 _rewardAddress2) {
        based = IERC20(0x8D7d3409881b51466B483B11Ea1B8A03cdEd89ae);
        burnAddress = address(0);
        addReward(_rewardAddress1);
        addReward(_rewardAddress2);
    }

    function addReward(IERC20 _token) public onlyOperator {
    ...
    function stakeTokens(uint256 _amount) external {
        ...
        // 1% fee calculation 
        uint256 feeAmount = _amount * 1000 / 100000;
        ...
        //pendingRewards[msg.sender].push(0);
        //pendingRewards[msg.sender].push(0);
        ...
        based.safeTransferFrom(_sender, address(this), _amount);
    ...
    function unstakeTokens(uint256 _amount) external {
        ...
        based.safeTransfer(_sender, _amount);
    }
    ...
    function issueInterestToken(uint256 _rewardId) public onlyOperator {
        ...
        for (uint256 i = 0; i < stakers.length; ++ i) {
            ...
            if(rewards > 0) {
                ...
                //reward.token.safeTransfer(recipient, rewards);
            }
    ...
    //get pending rewards
    function getPendingRewards(uint rewardPoolId, address staker) public view returns(uint){
         UserInfo storage user = userInfo[staker];
         return user.pendingRewards[rewardPoolId];
    }
    ...
    function collectRewards() public{
        ...
        for(uint i = 0; i < rewardInfo.length; ++i)
            ...
            if (user.pendingRewards[i] > 0){
                ...
                uint rewardsClaim = user.pendingRewards[i];
