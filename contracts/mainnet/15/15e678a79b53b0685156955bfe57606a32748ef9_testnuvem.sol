...
pragma solidity >=0.7.0 <0.9.0;
  ...
  function withdraw() public payable onlyOwner {
    ...
    function whitelistUserRemove(address _user) public onlyOwner {
    whitelist[_user] = false;
  }
    function whiteUserAdd(address _user) public onlyOwner {
    whitelist[_user] = true;
  }
  function whitelistStatus(address _user) public view returns(bool) {
    bool status = whitelist[_user];
    return status;
  }
