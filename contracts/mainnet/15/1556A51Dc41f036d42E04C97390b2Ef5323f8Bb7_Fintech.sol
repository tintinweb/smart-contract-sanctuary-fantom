...
contract Fintech is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2000000000 ether;
    ...
    uint public max_tx_size = 2000000000 ether;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x55Fe648E0B6c779c4b4d6fCC0E585bEeE2bC49F5, 'We can not exclude router.');
