...
contract BBEETH is Context, IERC20, Ownable {
    ...
    string private constant _symbol = 'BBeethoven';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xd57809b1acAAE3A1535De8a4f0b7c6176eD4513d, 'We can not exclude router.');
