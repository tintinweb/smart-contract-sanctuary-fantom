...
contract Boardroom is Initializable, ShareWrapper, ContractGuard {
    ...
    function initializeOperator() public initializer {
        operator = msg.sender;
    }
    ...
    function getumbrellaPrice() external view returns (uint256) {
        return treasury.getumbrellaPrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            umbrella.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        umbrella.safeTransferFrom(msg.sender, address(this), amount);
...
contract ShareWrapper {
    ...
    function stake(uint256 amount) public virtual {
        ...
        ashare.safeTransferFrom(msg.sender, address(this), amount);
    }
    ...
    function withdraw(uint256 amount) public virtual {
        ...
        ashare.safeTransfer(msg.sender, amount);
    }
}