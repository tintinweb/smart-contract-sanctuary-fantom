...
contract SHARK is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 80,000 SHARK
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 69450 ether;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund1, address _devFund2, address _devFund3, address _devFund4) public ERC20("SHARK", "SHARK") {
        _mint(msg.sender, 50 ether); // mint 50 SHARK for initial pools deployment
