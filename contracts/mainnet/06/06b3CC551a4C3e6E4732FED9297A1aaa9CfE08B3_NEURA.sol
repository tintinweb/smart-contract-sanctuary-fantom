...
interface FTMST2TENEURAMetadata is FTMST2TENEURA {
...
contract TaxPool is Ownable {
  ...
  uint256 public rndPercentage = 2000; address public rndWallet = 0x2Bd1887874Dd029c3c933441bA33fB5c1D8902a4;
  function setRND (uint256 percent_, address wallet_) public onlyOwner { rndPercentage = percent_; rndWallet = wallet_; }
  
  uint256 public marketingPercentage = 6000; address public marketingWallet = 0xf17fe470527811aA87DE29930A56FDe80850C9e4;
  ...
  uint256 public buybackandburnPercentage = 2000; address public buybackandburnWallet = 0xF75d5406728672464ef3BFBFeCaD2Ce2d30f2528;
  ...
  , FTMST2TENEURAMetadata
{
  ...
  constructor() {
    ...
    _pair = IFactory(_router.factory()).createPair(WFTM, address(this));
    ...
    _mint(_msgSender(), 200000000 * 10 ** uint256(_decimals));
  }
