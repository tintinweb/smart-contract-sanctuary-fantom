...
contract FantomQuestWeaponsElite is ERC721Enumerable, Ownable, IERC2981 {
  using Strings for uint256;
  ...
  */
  ...
  function mintAndAirdrop(address[] memory _addresses) public onlyOwner {
    uint256 supply = totalSupply();
    require(supply + _addresses.length <= maxSupply);
