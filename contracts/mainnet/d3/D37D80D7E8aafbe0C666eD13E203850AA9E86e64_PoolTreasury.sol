...
contract PoolTreasury is IPoolTreasury, Operator, ReentrancyGuard {
    ...
    constructor() public {
        ...
        target_collateral_ratio = 980000; // = 99% - fully collateralized at start
        effective_collateral_ratio = 980000; // = 99% - fully collateralized at start
    ...
    function globalCollateralValue() public view returns (uint256) {
        ...
        for (uint256 i = 0; i < pools_array.length; i++) {
            ...
            if (pools_array[i] != address(0)) {
                total_collateral_value = total_collateral_value.add(IPool(pools_array[i]).collateralalphaBalance());
            }
        }
