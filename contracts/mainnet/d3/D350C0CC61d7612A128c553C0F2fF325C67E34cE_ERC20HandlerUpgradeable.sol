    ...
    ILiquidityPool
{
    ...
    */
    ...
    function deposit(
        ...
        uint8 decimals = IERC20Upgradeable(address(swapDetails.srcStableTokenAddress)).decimals();
...
contract HandlerHelpersUpgradeable is Initializable, ContextUpgradeable, AccessControlUpgradeable, IERCHandler {
    ...
    */
    function setBridgeFee(
        ...
        feeManager.setFee(destinationChainID, srcTokenAddress, destTokenAddress, feeTokenAddress, data, isDefault);
    }
