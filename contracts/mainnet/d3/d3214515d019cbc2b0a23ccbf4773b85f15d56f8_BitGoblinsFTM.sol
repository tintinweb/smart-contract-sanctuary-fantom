...
// File: contracts/bitGoblinsFTM.sol

pragma solidity ^0.8.0;

contract BitGoblinsFTM is AccessControlEnumerable, ERC721Enumerable, ERC721URIStorage {
    ...
    function adminMint(uint _mintAmount) public payable onlyAdmin {
