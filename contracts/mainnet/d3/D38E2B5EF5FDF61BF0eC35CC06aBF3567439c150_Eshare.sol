...
contract Eshare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 100,001 ESHARE
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund1, address _devFund2) public ERC20("Esse Share", "ESHARE") {
        _mint(msg.sender, 1 ether); // mint 1 ESHARE for initial pools deployment
