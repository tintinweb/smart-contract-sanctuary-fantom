...
contract LobsterFinance is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Lobster Finance';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x0f9A05FFA1AE08B43bB982cFd5EaF85ce4F0a978, 'We can not exclude router.');
