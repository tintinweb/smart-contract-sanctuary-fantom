...
contract Arb is Operator {
    ...
    function estimateDualDexTrade2(
        address _router1,
        address _router2,
        address _token1,
        address _token2,
        ...
        )
    {
        ...
        if ((amtBack2 - _amount) < amtBack2) {
            return (amtBack2.sub(_amount), true, amtBack2, _amount);
        } else {
            return (0, false, 0, 0);
        }
    }
...
library BigNumber {
    ...
    function returnNumber(uint256 num) external pure returns (uint256) {
        return num;
    }

    function returnMultiplyPercent(uint256 num, uint256 nom)
        external
        pure
        returns (uint256)
    {
        return num.mul(nom) / 10000;
    }
}
