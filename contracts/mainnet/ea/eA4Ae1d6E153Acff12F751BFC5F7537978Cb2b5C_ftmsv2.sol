...
Tokenomics:
5% reflections paid in USDC
5% allocated to treasury wallet, used to farm and invest, all profits are used to buyback and burn $FTMS
3% allocated to liquidity
3% allocated to marketing wallet

Website: http://ftmstable.finance/

Discord: discord.gg/fDDrJzAJuV

Telegram: https://t.me/FTM_Stable
...
contract ftmsv2 is IBEP20, Auth {
  using SafeMath for uint256;
  ...
  // FTM mainnet WFTM: 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83
  // Testnet :
  ...
  string constant _name = 'FTMStable v2';
  ...
  address public autoLiquidityReceiver =
    0x9d1383c2c6AfE2D2B74743C8396990770B08035e;
  address public marketingFeeReceiver =
    0xE576e6cfc454D01dC731b39b07E552b9b076cC4a;
  address public treasuryFeeReceiver =
    0xDC2A06F057EF6727B8e3917994e61ADdAc732df8;
  ...
  constructor() Auth(msg.sender) {
    ...
    WFTM = router.WETH();
    distributor = new DividendDistributor(address(router), WFTM, EP);
  ...
  function setFees(
    ...
    totalFee = _liquidityFee.add(_buybackFee).add(_reflectionFee).add(
      _marketingFee).add(_treasuryFee
    );
