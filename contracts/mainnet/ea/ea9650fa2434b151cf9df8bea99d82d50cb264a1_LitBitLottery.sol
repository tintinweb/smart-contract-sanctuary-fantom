...
contract LitBitLottery {
    ...
    address public constant CEO = 0x7c4ad2B72bA1bDB68387E0AE3496F49561b45625;
    ...
    uint256 tokensRequiredPerTicket = 2500 * 10**18;
    ...
    function addTicketsFromOtherChain(address player, uint256 additionalTickets) external onlyCEO {
        updateTickets(player, tickets[player] + additionalTickets);
    }
