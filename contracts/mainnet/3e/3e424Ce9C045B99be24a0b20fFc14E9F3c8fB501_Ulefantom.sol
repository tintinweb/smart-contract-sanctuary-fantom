...
contract Ulefantom is Ownable, SignVerify, Pausable, ReentrancyGuard{
    ...
    uint256 public ulePrice = 70449600000000000000;
    uint256 public ftmPrice =  4306920000000000000;
    ...
    constructor()
    {
        ...
        feeReceivers = [0x7B1bA1234645838e7cdF55e4D3D14Ab58EDed273,0x3A41D33eEb42d76E6f221B3c0095CaAb7c1752a0];
        startTime = block.timestamp;
        lastDistribute = block.timestamp;
        defaultRefer = 0x8761c75A4e0a0ff49C728A8738c130eb4F4Eb090;
        signerAddress = 0xC8D810237eA7af26b0639b3569A5C3c3a776C5CA;
    }
    ...
    function deposit
    (uint256 _tokenAmount,uint256 _packageAmount, uint256 _nonce, bytes memory _signature)  
    external
    payable
    nonReentrant
    whenNotPaused
    {
        ...
        ULE.transferFrom(msg.sender, address(this), _tokenAmount);
    ...
    function getRewards(address _user) public view returns(uint256 splitAmt,uint256 uleAmt,uint256 FTMamt){
        ...
        uleAmt = (withdrawAmt.mul(ulePrice)).div(1e18);
        FTMamt = (withdrawAmt.mul(ftmPrice)).div(1e18);
    ...
    function updateFTMValue(uint256 _ulePrice)
    public
    onlyOwner
    {       ulePrice = _ulePrice;       }   

    function updateULEValue(uint256 _ftmPrice)
    public
    onlyOwner
    {       ftmPrice = _ftmPrice;       }
