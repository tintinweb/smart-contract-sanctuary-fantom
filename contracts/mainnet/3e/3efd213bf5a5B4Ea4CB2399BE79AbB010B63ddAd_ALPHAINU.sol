/**
 *Submitted for verification at FtmScan.com on 2023-06-11
*/
...
contract ALPHAINU is Context, IERC20, Ownable {
    ...
    string private _name = "ALPHAINUSA";
    string private _symbol = "ALPHAINUSA";
    ...
    address payable public marketingWallet = payable(0xBa41b0C7cb104A6DF9920Da06dd639f1b360457d);

    uint256 private _charityFee;
    uint256 private _previousCharityFee = _charityFee;
    address public charityWallet = 0xE4f28743bA98c2B659B559c7fb91d276ed471443;
    ...
    function setSellFeePercent(uint256 liquidityFee, uint256 marketingFee, uint256 charityFee, uint256 taxFee, uint256 burnFee) external onlyOwner() {
    ...
    function setBuyFeePercent(uint256 liquidityFee, uint256 marketingFee, uint256 charityFee, uint256 taxFee, uint256 burnFee) external onlyOwner() {
        require(liquidityFee.add(marketingFee).add(charityFee).add(taxFee).add(burnFee) <= 25, "tax too high");
