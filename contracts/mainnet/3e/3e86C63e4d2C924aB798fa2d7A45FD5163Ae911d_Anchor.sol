...
contract Anchor is ReentrancyGuard, Ownable {
    ...
    // this returns the contract`s reserves
    ...
    function swapFrom(uint256 amount) external nonReentrant {
        ...
        // for every 1.01 xToken we get 1.00 usdv
    ...
    function swapTo(uint256 amount) external nonReentrant {
        ...
        require(xToken.balanceOf(address(this))!=0, "swapTo: Not enough xToken in reserves");
        ...
        require(xToken.balanceOf(address(this)) >= amountToSend, "swapTo: Not enough xToken in reserves");
