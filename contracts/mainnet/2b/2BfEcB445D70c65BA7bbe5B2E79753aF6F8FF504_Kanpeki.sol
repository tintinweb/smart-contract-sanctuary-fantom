...
contract Kanpeki is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Kanpeki';
    string private constant _symbol = 'KAE';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xc33a1876436380AE6B7ec7dFCf97f7bc4106D18F, 'We can not exclude router.');
