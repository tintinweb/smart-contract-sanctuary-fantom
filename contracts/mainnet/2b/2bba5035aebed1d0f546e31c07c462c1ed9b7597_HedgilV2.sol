...
contract HedgilV2 is IHedgilV2, HedgilPool {
    ...
    function getHedgilPrice(
        ...
        return
            (getHedgilAmount(q, maxPriceChange) *
                getIVRate(otherToken) *
                sqrt(period, 1)) / PRICE_MODIFIER_DECIMALS * 
                getCurrentPrice(otherToken) / (10** IERC20Extended(otherToken).decimals())
                ;
    }
