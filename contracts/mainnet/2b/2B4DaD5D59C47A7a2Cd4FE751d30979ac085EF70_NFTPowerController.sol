 ...
 */
contract NFTPowerController is AccessControlEnumerable, Pausable, ReentrancyGuard {
    using EnumerableSet for EnumerableSet.AddressSet;
    using SafeERC20 for IERC20;
    EnumerableSet.AddressSet private _nftContracts;  // supported nft contracts
    EnumerableSet.AddressSet private _erc20Currency; // supported erc20 currency
    ...
    constructor(address nftContract_, uint256 price_, address erc20Currency_,  uint256 erc20Price_) {
