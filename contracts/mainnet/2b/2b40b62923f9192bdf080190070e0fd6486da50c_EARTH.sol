...
contract EARTH is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 5000 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'Save Earth';
    string private constant _symbol = 'EARTH';

    uint256 private _taxFee = 400;
    uint256 private _burnFee = 0;
    uint public max_tx_size = 5000 ether;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x477Fa8ccC1013C0973A76a12B0633562Ce55Ccd7, 'We can not exclude router.');
