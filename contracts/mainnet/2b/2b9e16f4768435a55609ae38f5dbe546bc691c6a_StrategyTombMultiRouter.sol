...
// File contracts/BIFI/strategies/Tomb/StrategyTombMultiRouter.sol
...
contract StrategyTombMultiRouter is StratManager, FeeManager, GasThrottler {
    ...
    function addLiquidity() internal {
        ...
        if (lpToken1 != output) {
            IUniswapRouterETH(tombSwapRouter).swapExactTokensForTokens(outputHalf, 0, lp0ToLp1Route, address(this), now);
        }
