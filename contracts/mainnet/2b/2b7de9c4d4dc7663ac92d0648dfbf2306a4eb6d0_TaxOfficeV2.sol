...
contract TaxOfficeV2 is Operator {
        ...
        )
    {
        ...
        uint256 liquidity;
        (resultAmtMagic, resultAmtToken, liquidity) = IUniswapV2Router(uniRouter).addLiquidity(
            magic,
            token,
            amtMagic,
            amtToken,
        ...
        )
    {
        ...
        uint256 liquidity;
        (resultAmtMagic, resultAmtFtm, liquidity) = IUniswapV2Router(uniRouter).addLiquidityETH{value: msg.value}(
            magic,
            amtMagic,
            amtMagicMin,
            amtFtmMin,
