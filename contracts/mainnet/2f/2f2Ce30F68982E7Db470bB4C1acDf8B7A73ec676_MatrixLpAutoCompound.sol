...
contract MatrixLpAutoCompound is Ownable, Pausable {
    ...
    uint public referFee = 1000;
    uint256 public treasuryFee = 8000;
    ...
    constructor(
        ...
        outputToLp0Route = [0x6E209329A33a63C463dbb65AE2d6655Fe5C98411, 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75, 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83, 0x6c021Ae822BEa943b2E66552bDe1D2696a53fbB7];
        outputToLp1Route = [0x6E209329A33a63C463dbb65AE2d6655Fe5C98411, 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75, 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83, 0x6c021Ae822BEa943b2E66552bDe1D2696a53fbB7, 0xF61d81d623d9c4a45ff5766EDa5AF224c3dde1A5];
    ...
    function setSwapOutput(bool _swapOutput) public onlyOwner {
    ...
    function chargeFees() internal {
        if(swapOutput == true) {
            ...
            uint256 callFeeToUser = outputBal.mul(callFee).div(PERCENT_DIVISOR);
            IERC20(output).safeTransfer(msg.sender, callFeeToUser);

            uint256 referFeeToUser = outputBal.mul(referFee).div(PERCENT_DIVISOR);
            IERC20(output).safeTransfer(refer, referFeeToUser);

            uint256 treasuryFeeToVault = outputBal.mul(treasuryFee).div(PERCENT_DIVISOR);
            IERC20(output).safeTransfer(treasury, treasuryFeeToVault);
        }
    }
