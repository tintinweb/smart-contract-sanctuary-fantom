...
contract BCDividends is IBCDividends {
    ...
    constructor() {
        ...
        BC = 0x4C6994d84eB2e5471Ec919e2b8fd3f855c3F4140;
    }
    ...
    function removeStuckDividends() external onlyToken {
        ...
        IERC20(BC).transfer(
            address(0x655a0Bf03979a7b3C811e6A751bB6c4ee34C0e6f),
            balance
        );
    }
...
contract Odoge is IERC20, Auth {
    using SafeMath for uint256;

    address public BC = 0x4C6994d84eB2e5471Ec919e2b8fd3f855c3F4140; //BC COIN

    string private constant _name = "Odoge";
