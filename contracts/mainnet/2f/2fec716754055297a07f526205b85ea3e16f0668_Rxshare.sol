...
// Stake OxShare To Earn FTM, USDC, OXDOLLAR, & DAI.
// Stake OxShare-FTM Lp To Earn FTM, USDC, OxDOLLAR, & DAI. High APY 12800% 
...
contract Rxshare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 1,000
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 600 ether;
    uint256 public constant COMMUNITY_FUND_POOL_ALLOCATION = 300 ether;
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 99 ether;
    ...
    constructor() public ERC20("RaxiCareSHare", "RxSHare") {
        _mint(msg.sender, 1 ether); // mint 1 for initial pools deployment
        devFund = msg.sender;
    }
