...
abstract contract ClampedRandomizer {
    ...
    function _generateClampedNonce() internal virtual returns (uint256) {
...
contract ERC721Template is ERC721Enumerable, ERC721Royalty, ClampedRandomizer, Ownable {
    using Strings for uint256;
    using Address for address;

    // supply settings
    uint256 public immutable MAX_SUPPLY = 53;
    uint256 public TOKEN_TO_BURN = 2;

    // URI settings
    string public BASE_URI = "ipfs://QmaCHP7JdALQ69pkKxXwkZhMNjZfSpn9NmUb2LSXC8dQhc/";
    string public URI_EXTENSION = ".json";

    IERC721Enumerable TOKEN = IERC721Enumerable(0xBf73c78d6df63941d29593916DDf11a62B7B02f3);

    // Royalty settings
    IPaymentSplitter private immutable PAYMENT_SPLITTER;

    constructor() ERC721("Cyber Skellies", "CYBERSKEL") ClampedRandomizer(MAX_SUPPLY) {
        ...
        _mintERC721(0xb1a9a840E7ED5b97e559aFCA416C566A6a0ad06F);
    }
     ...
     */
    function mint(uint256[] memory tokensToBurn) public returns (uint256) {
