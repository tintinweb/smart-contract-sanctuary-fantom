...
contract Rewarder is ReentrancyGuard{
    ...
    function notifyRewardAmount(address _rewardsToken, uint256 reward) external nonReentrant updateReward(address(0)) {
        require(reward >= DURATION, "Stake: <DURATION");
...
contract VTOKEN is ERC20, ERC20Burnable, ERC20Permit, ERC20Votes, Ownable {
    using SafeERC20 for IERC20;
    ...
    event BurnedFor(address indexed burner, address indexed account, uint256 amount);
