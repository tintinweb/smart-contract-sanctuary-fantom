...
contract CBI_Treasury is Ownable, Rescue {
    ...
    */
    constructor(
        ...
        require(Address.isContract(_jukuToken), "CBI_Treasury: Not contract");
        ...
        Token storage jukuTokenInfo = allowedTokensInfo[_jukuToken];
        ...
        jukuTokenInfo.allowed = true;
        jukuTokenInfo.swapLimit = 0;
        jukuTokenInfo.withdrawLimit = 0;
        jukuTokenInfo.tokenAddress = jukuToken;
        ...
        IERC20(_jukuToken).safeApprove(_swapRouter, type(uint256).max);
    ...
    function swapTokensBySign(
        ...
        require(
            recoveredAddress != address(0) &&
                (recoveredAddress == admin || recoveredAddress == owner()),
    ...
    */
    function _withdraw(
        ...
        require(
            balanceToken - amount >= tokenInfo.withdrawLimit,
            "CBI_Treasury: Token withdraw limit exceeded"
        );
