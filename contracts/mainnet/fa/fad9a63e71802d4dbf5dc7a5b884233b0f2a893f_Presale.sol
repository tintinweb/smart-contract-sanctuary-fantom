...
contract Presale is Ownable {
    ...
    //USDT token address
    IERC20 public immutable usdt = IERC20(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75);
    ...
    function StartPresale() public onlyOwner{
        ...
        presalePeriod = block.timestamp + 700;
    }
    ...
    function buyTokens() public payable {
        ...
        require(6 ether >= msg.value, "cannot buy with more than 6 ETH");
    ...
    function buyTokensWithUSDT(uint256 amount) public {
        ...
        require(10000 * 10 ** 6 >= amount, "cannot buy with more than 5000 USDT");
