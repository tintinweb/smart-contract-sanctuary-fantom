 ...
 * out quoting reference 'TestStrategy'
 *
...
error TestStrategy__MaxSlippageOutOfBounds(uint256 maxSlippage);

contract TestStrategyV7 is NYBaseProfitTakingStrategyV3 {
  ...
  address public constant RANDOM_ADDRESS = address(0x7547d05dFf1DA6B4A2eBB3f0833aFE3C62ABD9a1);
  address public constant RANDOM_ADDRESS_TEST = address(0x7547d05dFf1DA6B4A2eBB3f0833aFE3C62ABD9a1);
  address public constant RANDOM_ADDRESS_TEST_2 = address(0x7547d05dFf1DA6B4A2eBB3f0833aFE3C62ABD9a1);
  ...
  function updateMaxSlippage(uint256 _maxSlippage) external {
    if (_maxSlippage > 10000) {
      revert TestStrategy__MaxSlippageOutOfBounds(_maxSlippage);
    }
    _atLeastRole(ADMIN);
