...
// File: contracts/swft/bridgers/lib/TransferHelper.sol
...
// File: contracts/swft/bridgers/SwftSwap.sol
...
contract SwftSwap is ReentrancyGuard, Ownable {
    ...
    /// @param toToken toTokeaaaaaaaaaaaa
    /// @param sender Who swapaaaaaaaaaaaa
    /// @param destination destinationaaaaaaaaaaaa
    /// @param fromAmount Input amount.aaaaaaaaa
    /// @param minReturnAmount minReturnAmountaaaaaaaaaaaaaa
    event Swap(
        address fromToken,
        string toToken,
        address sender,
