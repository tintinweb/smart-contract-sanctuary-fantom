...
contract FantomHouseSerene is VRFConsumerBaseV2, Ownable, ReentrancyGuard {
    ...
    uint256 minBet = 1000000000000000; // default 0.001 Serene (When Serene was $1000)
    ...
    uint256 minHouseDeposit = 5000000000000000000; // default 5 Serene (Which was around $5000)
    ...
    address private constant SERENE_ADDRESS = 0x60d8D17D6b824E19f77eACcAf16ED7BA6FB209C2;
    IERC20 private serene = IERC20(SERENE_ADDRESS);
    ...
    function depositHouse(uint256 _amount, address _referral) external {
        ...
        serene.safeTransferFrom(_sender, address(this), _amount);
    }
    ...
    function withdrawHouse(uint256 _amount) external nonReentrant {
        ...
        serene.safeTransfer(msg.sender, _amount);
    }
    ...
    function bet(uint256 _betAmount, uint256 _faceSide, address _referral) external nonReentrant {
        ...
        serene.safeTransferFrom(_sender, address(this), _betAmount);
    ...
    function returnDepositAndRemoveDepositor(uint256 _length, bool _shouldRemoveDepositor) internal {
        for (uint i = 0; i < _length; i++) {
            ...
            serene.safeTransfer(_depositor, _depositAmount);
