...
// File interfaces/badger/ISettV4h.sol
...
// File interfaces/solidex/ILpDepositor.sol
...
// File interfaces/curve/ICurveRouter.sol
...
// File interfaces/solidly/IBaseV1Pair.sol
...
// File contracts/StrategyGenericSolidexHelper.sol
...
contract StrategyGenericSolidexHelper is BaseStrategy {
        ...
        returns (address[] memory)
    {
        ...
        protectedTokens[0] = want; // token0/token1 Solid LP
        protectedTokens[1] = address(SEX); // Reward1
        protectedTokens[2] = address(SOLID); // Reward2
        protectedTokens[3] = address(wFTM); // Native Token
        protectedTokens[4] = address(token0); // token0
        protectedTokens[5] = address(token1); // token1
