...
contract Surveyors is BoilerplateERC721{
...
abstract contract BoilerplateERC721 is ERC721Enumerable, ERC2981, ProfitSplitter {
  ...
  mapping(address => uint) public walletMax;
  ...
  */
  ...
  function _validateMint(address _token, uint _amount) internal view {
    ...
    //Make sure not minting more than maximum allowed
    require(walletMax[msg.sender] + _amount <= 4, "Cannot mint more than 4 per wallet");
  }
