...
contract Oracle is AccessControl, IOracle {
    ...
    uint256 public minDeiPrice;
    uint256 public validMeanDeiPrice;
    ...
    constructor(
        ...
        address admin,
        address setter,
        uint256 minDeiPrice_,
        uint256 validMeanDeiPrice_
    ) {
        require(
            muon_ != address(0) && admin != address(0) && setter != address(0),
        ...
        minDeiPrice = minDeiPrice_;
        validMeanDeiPrice = validMeanDeiPrice_;
    ...
    /// @notice sets min dei price
    /// @param minDeiPrice_ amount of min dei price
    function setMinDeiPrice(uint256 minDeiPrice_)
        external
    ...
    /// @notice sets valid mean dei price
    /// @param validMeanDeiPrice_ amount of valid mean dei price
    function setValidMeanDeiPrice(uint256 validMeanDeiPrice_)
        external
        onlyRole(SETTER_ROLE)
    {
        validMeanDeiPrice = validMeanDeiPrice_;
    ...
    function getPrice(Signature calldata signature) external returns (uint256) {
        ...
        require(
            (signature.marketPrice >= minDeiPrice) ||
                (signature.marketPrice < minDeiPrice &&
                    signature.meanPrice >= validMeanDeiPrice),
            "Oracle: LOW_DEI_PRICE"
        );
