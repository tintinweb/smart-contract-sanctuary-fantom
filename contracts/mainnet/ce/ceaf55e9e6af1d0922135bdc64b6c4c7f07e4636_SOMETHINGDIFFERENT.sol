...
contract SOMETHINGDIFFERENT is
    ERC721,
    ERC721Enumerable,
    ERC721URIStorage,
    IERC2981,
    ...
    ClampedRandomizer
{
    ...
    address  public royaltyAddress = 0xBE86eA1aF73a626178825D005505D00738e28C87;
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("SomethingDifferent", "ABITZ") ClampedRandomizer(maxSupply) {     
    ...
    function safeMintByTokenId(address to, uint256 tokenId) public onlyOwner {
        internalMintByTokenId(to, tokenId);
    }
    
    function internalMintByTokenId(address to, uint256 tokenId) internal {
        _safeMint(to, tokenId);
    }
