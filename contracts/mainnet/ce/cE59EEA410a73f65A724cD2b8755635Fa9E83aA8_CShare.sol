...
// File contracts/Cryptosy Shares.sol
...
contract CShare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 70,000 CSHARE
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Cryptosy Shares", "CSHARE") {
        _mint(msg.sender, 2 ether); // mint 2 CSHARE Share for initial pools deployment
