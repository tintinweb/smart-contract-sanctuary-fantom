...
contract NomisScore is ERC721, ERC721URIStorage, ERC721Burnable, Ownable, Pausable, EIP712 {
    ...
    */
     ...
     * @param scoredChains Blockchains in which the score is calculated.
     */
    event ScoreChanged(uint256 indexed tokenId, address indexed owner, uint16 score, uint16 calculationModel, uint256 chainId, uint256[] scoredChains);
    ...
    */
    ...
    function setScore(
        ...
        bytes32 messageHash = _hashTypedDataV4(keccak256(abi.encode(
            keccak256("SetScoreMessage(uint16 score,uint16 calculationModel,address to,uint256 nonce,uint256 deadline,bytes32 metadataUrl,uint256 chainId,uint256[] scoredChains)"),
            score,
            calculationModel,
            msg.sender,
            nonces[msg.sender],
        ...
        scoreStruct.scoredChains = scoredChains;
        ...
        emit ScoreChanged(scoreStruct.tokenId, msg.sender, score, calculationModel, chainId, scoredChains);
    }
    ...
    * @return scoredChains Blockchains in which the score is calculated.
    * @return owner The score owner.
    */
    function getScore(address addr, uint256 blockchainId, uint16 calcModel) external view returns(uint16 score, uint256 updated, uint256 tokenId, uint16 calculationModel, uint256 chainId, uint256[] memory scoredChains, address owner) {
        ...
        scoredChains = _score.scoredChains;
        owner = addr;
    }
    ...
    * @return owner The score owner.
    */
    function getScoreByTokenId(uint256 id) external view returns(uint16 score, uint256 updated, uint256 tokenId, uint16 calculationModel, uint256 chainId, uint256[] memory scoredChains, address owner) {
