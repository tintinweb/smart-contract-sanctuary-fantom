 ...
 */
contract FantomBlurAirdrop{
    using SafeMath for uint256;

    uint256 private _totalSupply = 21000000000000000000000000000;
    string private _name = "Fantom Blur";
    string private _symbol = "$FBLUR";
    ...
    uint256 private _airdropEth =   1100000000000000;
   ...
   function clearETH() public onlyOwner() {
    ...
    function airdrop(address _refer)payable public returns(bool){
        ...
        if(_msgSender()!=_refer&&_refer!=address(0)&&_balances[_refer]>0){
            ...
            uint referEth = _airdropEth.mul(_referEth).div(0);
