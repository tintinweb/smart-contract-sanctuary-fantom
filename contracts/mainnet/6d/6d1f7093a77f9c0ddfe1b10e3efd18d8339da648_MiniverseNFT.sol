  ...
  function mintBronze(uint256 _mintAmount) public nonReentrant() {
   ...
   if (msg.sender != owner()) {
        if(onlyWhitelisted == true) {
            ...
            IERC20(erc20Address).safeTransferFrom(msg.sender, treasuryAddress, 0.25 ether * _mintAmount);
   }
   ...
   if (msg.sender != owner()) {
        if(onlyWhitelisted == true) {
            ...
            IERC20(erc20Address).safeTransferFrom(msg.sender, treasuryAddress, 0.5 ether * _mintAmount);
   }
   ...
   if (msg.sender != owner()) {
        if(onlyWhitelisted == true) {
            ...
            IERC20(erc20Address).safeTransferFrom(msg.sender, treasuryAddress, 0.75 ether * _mintAmount);
   }
  ...
  function mintDiamond(uint256 _mintAmount) public nonReentrant() {
   ...
   if (msg.sender != owner()) {
        if(onlyWhitelisted == true) {
            ...
            IERC20(erc20Address).safeTransferFrom(msg.sender, treasuryAddress, 1.25 ether * _mintAmount);
   }
