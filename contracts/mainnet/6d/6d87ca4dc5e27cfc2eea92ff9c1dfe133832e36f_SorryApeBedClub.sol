...
contract SorryApeBedClub is ERC721, ERC721Enumerable, Pausable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    uint256 public MINT_PRICE = 6.5 ether;
    uint256 public MAX_SUPPLY = 100;


    constructor() ERC721("SorryApeBedClub", "SABC") {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmSJMJCvFKm5JCCL1b3Z3oMDw2r2vy4FoJpCeZZjre7m4C/";
    }
