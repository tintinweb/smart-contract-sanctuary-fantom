...
contract Tracks is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 50,000 TRACKS
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Tracks Shares", "TRACKS") {
        _mint(msg.sender, 1 ether); // mint 1 TRACK Share for initial pools deployment
