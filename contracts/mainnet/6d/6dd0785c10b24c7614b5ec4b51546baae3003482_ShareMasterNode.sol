...
contract ShareMasterNode {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    IERC20 public constant CODE7 = IERC20(0xB215014176720EdA5334df07f827c3f11ec0f1bD);
    uint256[] public tierAllocPoints = [1 ether, 2.1 ether, 4.41 ether, 9.261 ether, 19.4481 ether];
    uint256[] public tierAmounts = [3 ether, 6 ether, 12 ether, 24 ether, 48 ether];
    struct User {
    ...
    constructor(uint256 _startTime) public {
        ...
        treasuryFeePercent = 0; // treasury allocation
        burnRatio = 0; // burn baby burn
    ...
    function claimTreasuryRewards() external {
        if (treasury_rewards > 0) {
            CODE7.safeTransfer(dev, treasury_rewards);
            treasury_rewards = 0;
        }   
    }
