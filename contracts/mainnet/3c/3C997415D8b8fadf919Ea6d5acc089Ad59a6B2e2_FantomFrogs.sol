...
contract FantomFrogs is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties {
    using Strings for uint256;
  ...
  */
    ...
    */
    function send_to_vault() public payable onlyOwner {
    ...
    */
    function selectWinners(uint256 noOfWinners) external onlyOwner {
    ...
    */
    function setLotteryState(bool state) external onlyOwner {
        lotteryActive = state;
    }
    ...
    */
    function setLotteryIntervalDays(uint256 noDays) external onlyOwner {
    ...
    */
    function castVote(string memory option) external {
        require(!paused, "ERROR: Contract paused");
    ...
    */
    function addPollOption(string memory option) external onlyOwner {
    ...
    */
    function clearPollOptions() external onlyOwner {
    ...
    */
    function setPollName(string memory name) external onlyOwner {
        pollName = name;
    }
    ...
    */
    function setPollState(bool state) external onlyOwner {
        pollState = state;
    }
    ...
    */
    function clearWinnersForDraw(uint256 drawNo) external onlyOwner {
    ...
    */
    function noPollOptions() external view returns (uint256) {
