...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    /* ========== GOVERNANCE ========== */
    // fucku token, fshare token, treasury address
    function initialize(
        IERC20 _fucku,
        IERC20 _share,
        ITreasury _treasury
        ...
        withdrawLockupEpochs = 2; // Lock for 3 epochs (6h) before release withdraw
        rewardLockupEpochs = 1; // Lock for 1 epochs (3h) before release claimReward
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            fucku.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        fucku.safeTransferFrom(msg.sender, address(this), amount);
