...
// File: contracts/distribution/DftmGenesisRewardPool.sol
...
contract DftmGenesisRewardPool {
    using SafeMath for uint256;
    ...
    // MAINNET
    uint256 public tombPerSecond = 0.02700 ether; // 7000 TOMB / (3 day * 24h * 60min * 60s)
