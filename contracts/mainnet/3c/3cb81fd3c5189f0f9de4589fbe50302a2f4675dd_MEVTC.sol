...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xF04A45b429eB5930a85884141C530147Db0f609E); // ODIN
...
contract MEVTC is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xF04A45b429eB5930a85884141C530147Db0f609E; // ODIN
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "MEV_Teriyaki_Chicken";
    string constant _symbol = "MEV_TC";
    ...
    address public autoLiquidityReceiver=0xC5417aAc115f49c7dB7F835E5b4f352647c0A862; //liq address
    address public marketingFeeReceiver=0xC5417aAc115f49c7dB7F835E5b4f352647c0A862; // marketing address
...
//        emit Transfer(sender, recipient, amount);
    ...
    event AutoLiquify(uint256 amountFTM, uint256 amountEP);
