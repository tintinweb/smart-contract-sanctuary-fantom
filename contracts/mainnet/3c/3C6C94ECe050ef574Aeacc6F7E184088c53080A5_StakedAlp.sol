...
contract StakedAlp {
    ...
    function _transfer(address _sender, address _recipient, uint256 _amount) private {
        ...
        IRewardTracker(feeAlpTracker).unstakeForAccount(_sender, glp, _amount, _sender);

        IRewardTracker(feeAlpTracker).stakeForAccount(_sender, _recipient, glp, _amount);
