...
contract StrategyRebuyChefLP is StratManager, FeeManager {
    ...
    address[] public outputToRebuyRoute;
    ...
    constructor(
        ...
        address[] memory _outputToRebuyRoute
        ...
        outputToRebuyRoute = _outputToRebuyRoute;
    ...
    function chargeFees(address callFeeRecipient) internal {
        ...
        IUniswapRouterETH(unirouter).swapExactTokensForTokens(nativeBal, 0, outputToRebuyRoute, nullAddress, now);
    }
    ...
    function outputToRebuy() external view returns (address[] memory) {
        return outputToRebuyRoute;
    }
}
