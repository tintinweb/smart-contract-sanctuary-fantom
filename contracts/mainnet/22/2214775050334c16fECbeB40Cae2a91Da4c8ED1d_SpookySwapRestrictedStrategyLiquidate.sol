...
contract SpookySwapRestrictedStrategyLiquidate is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IStrategy {
  ...
  modifier onlyWhitelistedWorkers() {
    require(okWorkers[msg.sender], "SpookySwapRestrictedStrategyLiquidate::onlyWhitelistedWorkers:: bad worker");
    _;
  }
  ...
  function execute(
    ...
    require(
      ...
      "SpookySwapRestrictedStrategyLiquidate::execute:: insufficient baseToken received"
    );
