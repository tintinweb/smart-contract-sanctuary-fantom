...
contract AgiaWhitelist is ERC721, ERC721Enumerable, Pausable, ReentrancyGuard, Ownable {
    using Address for address;
    using EnumerableSet for EnumerableSet.AddressSet;

    string private constant NAME = "AgiaWhitelist";
    string private constant SYMBOL = "AGIAW";
