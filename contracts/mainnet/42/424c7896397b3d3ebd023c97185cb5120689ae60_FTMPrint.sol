/**
 *Submitted for verification at FtmScan.com on 2023-01-25
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 FTMP = IBEP20(0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = FTMP.balanceOf(address(this));
        ...
        uint256 amount = FTMP.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            FTMP.transfer(shareholder, amount);
...
contract FTMPrint is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address FTMP = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83; // WFTM
    address public WETH = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "FTMPrint";
    ...
    address public autoLiquidityReceiver=0x11510Bd1E572A0798c573add967d3722D6C63874;
    address public marketingFeeReceiver=0x11510Bd1E572A0798c573add967d3722D6C63874;
