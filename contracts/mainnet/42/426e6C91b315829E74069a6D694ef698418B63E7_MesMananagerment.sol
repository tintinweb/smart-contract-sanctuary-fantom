...
ERC721HolderUpgradeable
{
    ...
    function initialize(Config memory _config) public initializer {
        ...
        setConfig(_config);
        numTokensSellToAddToLiquidity = 1 * 10 ** 18;
        maxTxAmount = numTokensSellToAddToLiquidity * 10;
    ...
    event SwapTokensForEth(uint256 tokenAmount);
    ...
    function setConfig(Config memory _config) public onlyRole(ADMIN_ROLE) {
        ...
        uniswapV2Router = _config.uniswapV2Router;
    }

    function setNumTokensSellToAddToLiquidity(uint256 _numTokensSellToAddToLiquidity) public onlyRole(ADMIN_ROLE) {
        numTokensSellToAddToLiquidity = _numTokensSellToAddToLiquidity;
    }

    function autoAddLiquid() external {
        uint256 contractTokenBalance = mesToken.balanceOf(address(this));
    ...
    function checkSwapAndAddLiquidCondition() public view returns (bool) {
        uint256 contractTokenBalance = mesToken.balanceOf(address(this));
        if (contractTokenBalance >= maxTxAmount)
        {
            contractTokenBalance = maxTxAmount;
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        mesToken.approve(address(uniswapV2Router), tokenAmount);
        // make the swap
