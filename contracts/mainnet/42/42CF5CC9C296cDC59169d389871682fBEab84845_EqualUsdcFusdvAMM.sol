...
// File contracts/EqualUsdcFusdvAMM.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract EqualUsdcFusdvAMM is Ownable, Pausable {
    ...
    function addLiquidity() internal {
        ...
        IEqualizerRouter(unirouter).swapExactTokensForTokens(wrappedHalf, 0, wrappedToUsdcPath, address(this), block.timestamp);  


        uint256 lp0Bal = IERC20(fusd).balanceOf(address(this));
        uint256 lp1Bal = IERC20(usdc).balanceOf(address(this));

        IEqualizerRouter(unirouter).addLiquidity(fusd, usdc, stable, lp0Bal, lp1Bal, 1, 1, address(this), block.timestamp);       
    }
