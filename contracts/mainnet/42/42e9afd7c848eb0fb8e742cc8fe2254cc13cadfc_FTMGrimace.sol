...
contract FTMGrimace is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    //change "name1" and "symbol"
    string private _name = "FTMGrimace";
    string private _symbol = "FTMGrimace";
    ...
    uint256 internal _tokenTotal = 1000000000e15;
    ...
    constructor() public {
        marketingWallet = 0x133CBBA9Cf64Bd75cDDe25af695524a4eDa0f53f;

        charityWallet = 0x068A1a43e23fbc0A101b0AE8bC52D9674C60ff78;
    ...
    function init() external onlyOwner {
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xF491e7B69E4244ad4002BC14e878a34207E38c29); // for BSC
