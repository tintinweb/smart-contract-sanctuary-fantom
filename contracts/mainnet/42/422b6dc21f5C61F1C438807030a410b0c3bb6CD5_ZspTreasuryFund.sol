...
contract ZspTreasuryFund is Fund {
    uint256 public constant ALLOCATION = 4_000_000 ether; // 8%
    uint256 public constant VESTING_DURATION = 1 * 365 * 24 * 3600; // 1 years
    uint256 public constant VESTING_START = 1655321967; // No cliff: Wednesday, 15 June 2022 19:39:27
