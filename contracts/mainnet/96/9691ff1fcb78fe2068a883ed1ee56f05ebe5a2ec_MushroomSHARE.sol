...
contract MushroomSHARE is Context, IERC20, IERC20Metadata {
    ...
    constructor() {
        _tokenMM_name = "Mushroom SHARE";
        _tokenMM_symbol = "mSHARE";
        _tokenMM_totalSupply = 150 * 10 ** 18;
        _balances[msg.sender] = _tokenMM_totalSupply;
        ERC20Dependancies = IERC20Dependancies(0xa92f17527F63F439F7297e27601E02B6eB18F701);
    }
