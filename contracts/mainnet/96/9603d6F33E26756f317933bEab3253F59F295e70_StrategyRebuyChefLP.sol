...
contract StrategyRebuyChefLP is StratManager, FeeManager, GasThrottler {
    ...
    event ChargedFees(uint256 callFees, uint256 rebuyAmount);
    ...
    function chargeFees(address callFeeRecipient) internal {
        ...
        IUniswapRouterETH(unirouter).swapExactTokensForTokens(rebuyAmount, 0, nativeToBuybackRoute, BURN_ADDR, now);

        emit ChargedFees(callFeeAmount, rebuyAmount);
    }
    ...
    function _giveAllowances() internal {
        ...
        IERC20(rebuyToken).safeApprove(unirouter, 0);
        IERC20(rebuyToken).safeApprove(unirouter, uint256(-1));
    }
