...
contract VaultUtils is IVaultUtils, Governable {
    ...
    function getBuyUsdaFeeBasisPoints(address _token, uint256 _usdaAmount) public view override returns (uint256) {
        return getFeeBasisPoints(_token, _usdaAmount, vault.mintBurnFeeBasisPoints(), vault.taxBasisPoints(), true);
    }

    function getSellUsdaFeeBasisPoints(address _token, uint256 _usdaAmount) public view override returns (uint256) {
