...
contract Univ3zap {
  ...
  event MintPool(uint256 tokenId, uint128 liquidity, uint256 amnt0, uint256 amnt1);
  ...
  function createPool(address poolAddr, bool isToken0, uint256 amount) public {
    ...
    int256 swapQty = int256(amount / 2);
  ...
  function createPool2(address poolAddr, uint256 amount0, uint256 amount1) public {
    ...
    (uint256 tokenId, uint128 liquidity, uint256 amnt0, uint256 amnt1)
    ...
    emit MintPool(tokenId, liquidity, amnt0, amnt1);
  }
