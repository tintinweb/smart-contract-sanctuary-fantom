...
contract Land is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("LAND", "LAND") {
        _mint(msg.sender, 1 ether); // mint 1 KANDY Share for initial pools deployment
