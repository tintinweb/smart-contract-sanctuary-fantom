...
contract Treasury is Initializable, ContractGuard, Operator {
    ...
    function getUpdatedPrice() public view returns (uint256 _chiliPrice) {
        ...
        checkOperator
    {
        require(
            _chiliAmount > 0,
            "Treasury: cannot purchase bonds with zero amount chili"
        );
        ...
        checkOperator
    {
        ...
        uint256 ChiliPrice = getChiliPrice();
        require(ChiliPrice == targetPrice, "Treasury: DAO price moved");
        require(
    ...
    function _sendToBoardroom(uint256 _amount) internal {
        ...
        if (_chiliFundSharedPercent > 0) {
            ...
            IERC20Upgradeable(_chili).transfer(daoFund, _chiliFundSharedAmount);
        ...
        if (epoch < bootstrapEpochs) {
            ...
            if (previousEpochChiliPrice > _chiliPriceCeiling) {
                ...
                if (
                    ...
                    // have not saved enough to pay debt, mint more chili
