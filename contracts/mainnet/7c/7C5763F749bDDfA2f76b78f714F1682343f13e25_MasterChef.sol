...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    function initializePools(address _nativeLP) external onlyOwner {
        ...
        add(240, IERC20(_nativeLP), 0, true, false);                                        // Native LP
        add(160, IERC20(native), 0, true, false);                                           // Native
        add(30, IERC20(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83), 400, false, false);     // wFTM pool
        add(20, IERC20(0x74b23882a30290451A17c44f4F05243b6b58C76d), 300, false, false);     // wETH pool
        add(20, IERC20(0x321162Cd933E2Be498Cd2267a90534A804051b11), 300, false, false);     // wBTC pool
        add(20, IERC20(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75), 300, false, false);     // USDC pool
        add(20, IERC20(0x049d68029688eAbF473097a2fC38ef61633A3C7A), 300, false, false);     // fUSDT pool
        add(20, IERC20(0x8D11eC38a3EB5E956B052f67Da8Bdc9bef8Abf3E), 300, false, false);     // DAI pool
        add(20, IERC20(0xDDc0385169797937066bBd8EF409b5B3c0dFEB52), 400, false, false);     // wMEMO pool
        add(20, IERC20(0x82f0B8B456c1A451378467398982d4834b6829c1), 400, false, false);     // MIM pool
        add(10, IERC20(0x841FAD6EAe12c286d1Fd18d1d525DFfA75C7EFFE), 400, false, false);     // BOO pool
