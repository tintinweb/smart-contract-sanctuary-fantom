...
contract DegenDorms is ERC721Enumerable, Ownable {
  using Strings for uint256;
  string public baseURI;
  uint256 public cost =  0.01 ether;
  uint256 public maxSupply = 1234;
  uint256 public maxMintAmount = 5;
  address private devAddress = 0xDbe5cCb402a3635a1E42aA226B07D1E83B6591d7; //CHANGE
  //uint256 public saleStart = 1649172780; // CHANGE
 ...
 function mint(address _to, uint256 _mintAmount) public payable {
    ...
    returns (string memory)
  {
    ...
    string memory currentBaseURI = _baseURI();
     ...
     string memory websiteBaseURI = "https://api1.nftgarage.world/serve/assets/degendorms/metadata/";
