...
// File contracts/interfaces/IShadowStrategy.sol
...
// File contracts/interfaces/ISmartWalletWhitelist.sol
...
// File contracts/interfaces/ISecondRewarder.sol
...
contract ShadowChef is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function withdraw(uint256 amount, address to) public onlyWhitelisted nonReentrant {
        ...
        if (_lpBalance < amount && strategy != address(0)) {
            ...
            amount = IShadowStrategy(strategy).withdraw(_missing);
        }
