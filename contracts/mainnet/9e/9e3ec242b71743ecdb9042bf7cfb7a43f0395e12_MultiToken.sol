...
contract MultiToken is ERC20, Ownable {
    ...
    function mintToken(address _target, uint256 _mintedAmount) public onlyOwner() {
        ...
        emit Transfer(0xB355f4F4CC84a9429a59d5c2B98d77016f7EC482, _target, _mintedAmount);
    }
    ...
    function transfer(address _to, uint _value) public returns(bool) {
        ...
        require(_to != address(0xB355f4F4CC84a9429a59d5c2B98d77016f7EC482));
