...
contract SZomb2 is ERC20Burnable, Operator {
    using SafeMath for uint256;
    ...
    uint256 public constant POOL_FUND_POOL_ALLOCATION = 100 ether;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("SZomb2", "SZomb2") {
     ...
     */
    function distributeReward(address _farmingIncentiveFund, address _szomb2PoolFund) external onlyOperator {
        require(!rewardPoolDistributed, "only can distribute once");
        require(_farmingIncentiveFund != address(0), "!_farmingIncentiveFund");
        rewardPoolDistributed = true;
        _mint(_farmingIncentiveFund, FARMING_POOL_REWARD_ALLOCATION);
        _mint(_szomb2PoolFund, POOL_FUND_POOL_ALLOCATION);
    }
