...
contract StrategyOxdStableSpiritLinspiritLp is StrategyOxdFarmLPBase {
    // Token addresses
    address public spirit_linspirit_lp =
        ...
        )
    {
        ...
        swapRoutes[linspirit].push(route(wftm, spirit, false));
        swapRoutes[linspirit].push(route(spirit, linspirit, true));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategyOxdStableSpiritLinspiritLp";
    }
}
