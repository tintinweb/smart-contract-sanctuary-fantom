...
contract BabyThreeShare is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Baby3SHARES Token';
    string private constant _symbol = 'Baby3SHARES';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x94B2e8F61949556A903b195E21C6479dF4953ed1, 'We can not exclude router.');
