...
contract KillerQueen is ReentrancyGuard {
    ...
    address private immutable _adminsContract;
    ...
    constructor(address _oracle, address _admContract) {
        _ORACLE = AggregatorV3Interface(_oracle);
        _ADMIN = msg.sender;
        _operator = msg.sender;
        _adminsContract = _admContract;
    }
    ...
    function getUserBets(address _user) public view returns (uint256[] memory, uint256) {
