...
contract EqualfBomb is Ownable, Pausable {
    ...
    function addLiquidity() internal {
        ...
        IEqualizerRouter(unirouter).swapExactTokensForTokens(equalHalf, 0, equalToFbombPath, address(this), block.timestamp);
        
        uint256 lp0Bal = IERC20(equal).balanceOf(address(this));
        uint256 lp1Bal = IERC20(fbomb).balanceOf(address(this));

        IEqualizerRouter(unirouter).addLiquidity(equal, fbomb, stable, lp0Bal, lp1Bal, 1, 1, address(this), block.timestamp);
    }
