...
contract StakedImpERC20Token is ERC20Permit, Ownable {
  using LowGasSafeMath for uint256;
  ...
  constructor() ERC20('Staked Imp', 'sIMP', 9) ERC20Permit() {
  ...
  /**
        @notice increases sIMP supply to increase staking balances relative to profit_
  ...
  // Staking contract holds excess sIMP
