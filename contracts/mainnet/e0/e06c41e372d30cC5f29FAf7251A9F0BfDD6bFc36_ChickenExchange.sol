...
contract ChickenExchange {
    ...
    uint256 public start_time = 1644761845; //Tuesday, February 15, 2022 4:00:00 PM UTC (1644940800)
    ...
    function exchange(uint256 amount) public{
        ...
        //require (IERC20(synthetic_airdrop_token).balanceOf(msg.sender)>=amount, "Balance too low");//checked
