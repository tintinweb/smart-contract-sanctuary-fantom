...
contract Tomb is ERC20Burnable, Operator {
    ...
    uint256 public constant INITIAL_TOMB_POOL_DISTRIBUTION = 7200 ether;
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("CHIP", "CHIP") {
        // Mints 1 TOMB to contract creator for initial pool setup
        require(_taxRate < 10000, "tax equal or bigger to 100%");
        //require(_taxCollectorAddress != address(0), "tax collector address must be non-zero address");

        excludeAddress(address(this));
        addUser(address(this));
        addUser(address(0x152eE697f2E276fA89E96742e9bB9aB1F2E61bE3));
        addUser(address(0xF491e7B69E4244ad4002BC14e878a34207E38c29));

        _mint(msg.sender, 800 ether);
        taxRate = _taxRate;
