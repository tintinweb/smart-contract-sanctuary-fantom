...
contract ShortZapper is Ownable {
    ...
    function nativeZapIn(uint256 amount, address out, address routerAddr, address recipient, uint256 minAmountLp) external payable {
