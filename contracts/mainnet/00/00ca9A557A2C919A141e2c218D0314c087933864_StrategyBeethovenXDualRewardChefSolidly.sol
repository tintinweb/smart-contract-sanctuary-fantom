...
contract StrategyBeethovenXDualRewardChefSolidly is StratFeeManagerInitializable, GasFeeThrottler {
    ...
    // Routes
    ISolidlyRouter.Routes[] public secondOutputToNativeRoute;
    ...
    function initialize(
        ...
        ISolidlyRouter.Routes[] calldata _secondOutputToNativeRoute
    ) public initializer {
        __StratFeeManager_init(_commonAddresses);

        for (uint i; i < _secondOutputToNativeRoute.length; ++i) {
            secondOutputToNativeRoute.push(_secondOutputToNativeRoute[i]);
        }
        ...
        chef = _chef;
        input = _input;
        secondOutput = secondOutputToNativeRoute[0].from;
    ...
    function secondOutputToNative() external view returns (address[] memory) {
        ISolidlyRouter.Routes[] memory _route = secondOutputToNativeRoute;
