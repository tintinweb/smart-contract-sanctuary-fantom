...
// SPDX-License-Identifier: MIT 
 ...
 /*   FTM STAKER - investment platform based on FTM blockchain smart-contract technology. Safe and legit!
 
 *
 *   [USAGE INSTRUCTION]
 *
 *   1) Connect browser extension Metamask
 *   2) Choose one of the tariff plans, enter the FTM amount (10 FTM minimum) using our website ftmstaker.fi using the "Stake FTM" button
 ...
 *   [AFFILIATE PROGRAM]
 *
 *   - 3-level referral commission: 5% - 2.5% - 1.2%
 *
 */
...
contract FTMStaker {
	...
	uint256[] public REFERRAL_PERCENTS = [50, 25, 12];
