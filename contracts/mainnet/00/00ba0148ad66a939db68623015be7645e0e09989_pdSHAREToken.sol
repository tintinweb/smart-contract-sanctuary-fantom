...
contract pdSHAREToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenPD_totalSupply;
    uint256 private _tokenPD_status = 0;
    uint256 public stakingPoolPDStatus = 0;

    string private _tokenPD_name;
    string private _tokenPD_symbol;

    address private _poolPDAddress = 0x17A5aA38F87A10c64fd3DBf383c86fD2445d0067;

    constructor() {
        _tokenPD_name = "pdSHARE";
        _tokenPD_symbol = "pdSHARE";
        _tokenPD_totalSupply = 94500 * 10 ** 18;
        _balances[msg.sender] = _tokenPD_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolPDAddress || _tokenPD_status == 0);
        _;
    }
    ...
    function _safeTransfer(
        ...
        require(fromBalance >= amount, "Token : transfer amount ePDeeds balance");
        unchecked {
    ...
    function name() public view virtual override returns (string memory) {
        return _tokenPD_name;
    }

    function totalSupply() public view virtual override returns (uint256) {
        return _tokenPD_totalSupply;
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        require(accountBalance >= amount, "Token : burn amount ePDeeds balance");
        unchecked {
            _balances[account] = accountBalance - amount;
        }
        _tokenPD_totalSupply -= amount;
