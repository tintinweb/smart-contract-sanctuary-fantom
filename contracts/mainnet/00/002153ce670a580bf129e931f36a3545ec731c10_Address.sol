...
contract FantomHouse is VRFConsumerBaseV2, Ownable, ReentrancyGuard {
	...
	// DAI on FTM =======================================================================
	//
	address private constant DAI_ADDRESS = 0x8D11eC38a3EB5E956B052f67Da8Bdc9bef8Abf3E;
    ...
    // Owner Wallet =====================================================================
    //
    // Contract Owner's Wallet Address

    address public OwnerWallet = owner();
	//===================================================================================


    // Team Wallet ======================================================================
	//
	// Team Wallet Can Claim Fees Collected for Team Portion
	...
	uint256 ownerPortion = 7500; // Send Fee x treasuryPortion / 10000 for example.
	uint256 teamPortion = 2500; //
    ...
    uint16 requestConfirmations = 3; // Minimum is 1 on FTM. Default 3
    uint32 numWords = 1;
	...
	uint256 public bankBalance; //New Variable. Need work.
	...
	// Minimum Bet ======================================================================
    //
	uint256 minBet = 10000000000000000; // default 0.01 (Dollar Unit)
    ...
    uint256 totalShare; // Total Amount of Shares Created
    ...
    function depositBank(uint256 _amount) external {
        require(_amount > 1000000000000000000, "Min Deposit Amount = $1");
    ...
    function withdrawBank() external nonReentrant {
        ...
        dai.safeTransfer(msg.sender, claim);
    }
    ...
    function refund(uint256 _betId) external nonReentrant {
        Bet memory _bet = bets[ids[_betId]];
    ...
    function bet(uint256 _betAmount, uint256 _odd) external payable nonReentrant {
        ...
        dai.safeTransferFrom(_sender, address(this), _betAmount);
    ...
    function fulfillRandomWords(
        ...
        if (userWon == 1) {
            ...
            bankBalance -= (payoutAppliedAmount - playerBetAmount + calculatedBetTax);
        } else {
