...
contract FantomDAO is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Fantom Dao';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x6A249C60751FAF2FBc18A024A557b076988B09C0, 'We can not exclude router.');
