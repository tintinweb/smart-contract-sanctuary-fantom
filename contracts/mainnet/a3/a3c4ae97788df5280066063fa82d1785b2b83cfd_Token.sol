...
contract Token is BEP20 {
    ...
    // Fee address
    address payable public feeAddr = 0x6ca3A69ACC94e66E72a25f2d9507c9e1c7974638;
    ...
    // will distribute Token-ETH LP token to Stakers!
     ...
     */
    constructor() public BEP20("MoonSpring", "MSP") {
    ...
    function mint(address _to, uint256 _amount) public onlyOwner {
        require(totalSupply() <= maxSupply, "TOKEN::mint: no more minting");
        _mint(_to, _amount);
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override antiWhale(sender, recipient, amount) {
        ...
        if (_isNonTaxedSender || _isNonTaxedReceipient || transferTaxRate == 0 ) {
            ...
            super._transfer(sender, brunAddr, burnAmount - 5);
    ...
    // Update the max transfer amount rate, between 1 and 10%
    ...
    // Update the swap router, can only be set once!
    function updateSwapRouter(address _router) public onlyOperator {
        require(address(swapRouter) == address(0), "TOKEN::updateSwapRouter: Router already set.");
