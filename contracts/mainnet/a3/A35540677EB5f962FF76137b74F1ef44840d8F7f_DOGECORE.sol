...
contract DOGECORE is Context, IERC20, Ownable {
    ...
    string private constant _name = 'DOGECORE';
    string private constant _symbol = 'DCORE';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xFebc7dab511229Edc1Bc90D61ce07B79aD890056, 'We can not exclude router.');
