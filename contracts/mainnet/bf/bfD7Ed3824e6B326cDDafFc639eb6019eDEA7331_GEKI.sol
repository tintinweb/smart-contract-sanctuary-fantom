...
contract GEKI is IERC20
{
	...
	uint256[] public LEVEL_UNLOCK=[0e18, 1000e18, 2500e18, 5000e18, 10000e18, 15000e18, 20000e18, 30000e18, 50000e18, 100000e18];
    
    address public marketingAddress=0xbdDBe5AAE0F49DB5C65Aa5B7b955418cBBE8bec2;
    ...
    function contractInfo() public view returns(uint256 ftm, uint256 totalDeposits, uint256 totalPayouts, uint256 totalInvestors, uint256 totalHolding, uint256 balance,uint256 totalHold){
        ...
        return(ftm,totalDeposits,totalPayouts,totalInvestors,totalHolding,balance,totalHold);
    }
     ...
     function _checkClub() internal{
        for(uint256 i = 0; i < investors.length; i++){
            ...
            User storage user = users[investors[i]];
                ...
                if(user.totalInvestment >=5000e18 && userc.totalBusiness >= 10000e18 && userc.totalDirect >= 2){
                ...
                if(user.totalInvestment >=15000e18 && userc.totalBusiness >= 40000e18 && userc.totalDirect >= 4){
     ...
     function _distributeClub(address depositor, uint256 _amount) internal{
        ...
        for(uint256 i = 0; i < silverclub.length; i++){
            ...
            poiShare = tokens.mul(100).div(silverclub_holding);
                    ...
                    userc.silverclub+=(poi.mul(poiShare).div(100))/1e18;
            ...
            poiShare = tokens.mul(100).div(goldclub_holding);
                    ...
                    userc.goldclub+=(poi.mul(poiShare).div(100))/1e18;
                    emit ClubDistribution(depositor,poi);        
