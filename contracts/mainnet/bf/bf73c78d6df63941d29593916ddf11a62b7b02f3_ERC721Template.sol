...
contract ERC721Template is ERC721Enumerable, ERC721Royalty, ClampedRandomizer, Ownable {
    ...
    // supply settings
    uint256 public immutable MAX_SUPPLY = 105;
    uint256 public TOKEN_TO_BURN = 2;

    // URI settings
    string public BASE_URI = "ipfs://QmWZ9SbfyTJPDnrqBgKFgX3oBVcn84HjbNVjKkGWHnsf2Q/";
    string public URI_EXTENSION = ".json";

    IERC721Enumerable TOKEN = IERC721Enumerable(0x5fFA60EF5790dC4c01113D24449fF445D97f22db);

    // Royalty settings
    IPaymentSplitter private immutable PAYMENT_SPLITTER;

    constructor() ERC721("Champion Skellies", "CSKEL") ClampedRandomizer(MAX_SUPPLY) {
