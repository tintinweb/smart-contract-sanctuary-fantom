...
contract Drip is ERC20Burnable, Operator {
    ...
    // Initial distribution for the day 2-5 DRIP-WFTM LP -> DRIP pool
    ...
    constructor() public ERC20("DRIP", "DRIP") {
        // Mints 1 DRIP to contract creator for initial pool setup
    ...
    function distributeReward(
        ...
        require(!rewardPoolDistributed, "rewards were already distributed");
