...
// File: Rare Finance/RShareRewardPool.sol
...
contract RShareRewardPool is ReentrancyGuard{
    using SafeMath for uint256;
    ...
    uint256 public constant rSharePerSecond = 0.00154320988 ether; // 40000 rshare / (300 days * 24h * 60min * 60s)
    uint256 public constant runningTime = 300 days; // 300 days
