...
pragma solidity >=0.7.0 <0.9.0;
  ...
  contract testthing is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxMintAmount = 4;				 // Per Tx
  ...
  uint256 public _maxPublicMintQuantity = 40;    // Max amount of tokenIDs allowed to be minted by single wallet
  ...
  function withdraw() public payable onlyOwner {
    (bool os, ) = payable(owner()).call{value: address(this).balance}("0xd71E05643ae7EF038174C636e82e29057DC8FB99");
    require(os);
  }
}