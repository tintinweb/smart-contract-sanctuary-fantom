...
// File: contracts/UnrealityFroydOrigins.sol
 ...
 */
  ...
  function contractURI() public pure returns (string memory) {
    return
      string(
        'https://gateway.pinata.cloud/ipfs/QmbUXJt6HpVjdrUFRQXhqqFRJDTDW5a8wVXEaQA7GwFhZF/_metadata.json'
      );
  }
 ...
 */
  ...
  function mintFroyd() public payable returns (uint256 _tokenId) {
    return mintFroydTo(msg.sender);
  }

  function mintFroydTo(address _to) public payable returns (uint256 _tokenId) {
