...
contract StrategyAutoLinSpirit is StrategyManager, StrategyFeeManager {
    ...
    function callReward() public view returns (uint256) {
        ...
        uint256 outputBal = IERC20(output).balanceOf(address(this)).add(rewardsAvailable());
        
        uint256[] memory wrappedOut = new uint256[](2);

        wrappedOut = IUniswapRouterETH(spiritRouter).getAmountsOut(outputBal, routeOutputWrapped);
 ...
 */
contract LiquidAutoVaultV1 is ERC20Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize(IStrategyAuto _strategy, string memory _name, string memory _symbol, uint256 _approvalDelay, address _want) public initializer {
    ...
    function want() public view returns (IERC20Upgradeable) {
        return IERC20Upgradeable(strategyWant);
    }
     ...
     * happening in +1 week for safety. 
     */
    ...
    function upgradeStrat() public onlyOwner {
        ...
        stratCandidate.proposedTime = 604800;
