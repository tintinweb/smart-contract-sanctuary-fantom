...
contract ReaperStrategyGranaryCrossAsset is ReaperBaseStrategyv3 {
    ...
    function _repayToPool(uint256 _borrowAssetToRepay) internal {
        ILendingPool pool = ILendingPool(ADDRESSES_PROVIDER.getLendingPool());
        _borrowAssetToRepay = MathUpgradeable.min(_borrowAssetToRepay, borrowAsset.balanceOf(address(this)));
