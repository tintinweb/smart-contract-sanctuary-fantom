...
interface IMasterChef {
    ...
    function pendingSHADE(address _user) external view returns (uint256);
    function emergencyWithdraw() external;
}

pragma solidity 0.6.2;

contract ShadeLPFarm is Ownable, Pausable {
    ...
    function callReward() public view returns (uint256) {
        uint256 outputBal = IMasterChef(masterchef).pendingSHADE(address(this));
        uint256 nativeOut;
