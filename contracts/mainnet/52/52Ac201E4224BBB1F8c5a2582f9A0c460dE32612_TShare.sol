...
contract TShare is ERC20Burnable, Operator {
    ...
    bool public rewardPoolDistributed = false;
    	...
    	constructor(uint256 _startTime, address _communityFund, address _devFund1, address _devFund2, address _devFund3, address _devFund4) public ERC20("GEM", "Pirate Finance") {
        _mint(msg.sender, 300 ether); // mint 1 SHARE for initial pools deployment
