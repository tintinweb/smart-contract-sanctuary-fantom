...
contract SpaceBoost is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Space Boost';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x980956B1a281Bdc490561398ccf245E05d0353ae, 'We can not exclude router.');
