...
contract AlpBalance {
    ...
    constructor(IAlpManager _alpManager, address _stakedAlpTracker) public {
    ...
    function _transfer(
        ...
        require(alpManager.lastAddedAt(_sender).add(alpManager.cooldownDuration()) <= block.timestamp, "AlpBalance: cooldown duration not yet passed");
