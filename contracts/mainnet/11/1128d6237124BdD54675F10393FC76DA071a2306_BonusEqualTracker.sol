...
contract StakedEqualTracker is RewardTracker {
    constructor() public RewardTracker("Staked EQUAL", "sEQUAL") {}
}

contract BonusEqualTracker is RewardTracker {
    constructor() public RewardTracker("Staked + Bonus EQUAL", "sbEQUAL") {}
}

contract FeeEqualTracker is RewardTracker {
    constructor() public RewardTracker("Staked + Bonus + Fee EQUAL", "sbfEQUAL") {}
}

contract StakedEquityTracker is RewardTracker {
    constructor() public RewardTracker("Fee + Staked EQUITY", "fsEQUITY") {}
}

contract FeeEquityTracker is RewardTracker {
    constructor() public RewardTracker("Fee EQUITY", "fEQUITY") {}
}