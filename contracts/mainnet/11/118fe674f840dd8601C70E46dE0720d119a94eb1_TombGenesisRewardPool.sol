...
contract TombGenesisRewardPool {
    ...
    // TESTNET
    uint256 public tombPerSecond =  0.127314 ether; // 33000 TOMB / (3d * 24h * 60min * 60s)
    ...
    // uint256 public runningTime = 1 days; // 1 dayse
    ...
    modifier onlyOperator() {
        require(operator1 == msg.sender || operator2 == msg.sender, "TombGenesisPool: caller is not the operator");
        _;
    }
    ...
    function deposit(uint256 _pid, uint256 _amount) public {
        ...
        if (_amount > 0) {
            ...
            uint256 depositDebt = _amount.mul(75).div(10000);
