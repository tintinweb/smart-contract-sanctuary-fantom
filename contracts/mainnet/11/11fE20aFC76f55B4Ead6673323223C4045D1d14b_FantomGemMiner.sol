...
contract FantomGemMiner {
	using SafeMath for uint256;

	uint256 constant public INVEST_MIN_AMOUNT = 5e18; // 5 Fantom  
	uint256[] public REFERRAL_PERCENTS 	= [500, 300, 200, 200, 100, 100, 100, 100, 100, 200];
	uint256[] public SEED_PERCENTS 		= [200, 200, 200, 200, 100, 100, 100, 100, 100, 100];
    ...
    function calculate_rewards (uint256 _amount) public ownerOnly {
