...
contract Donation is UUPSUpgradeable, OwnableUpgradeable, IOracleRewardCB {
  ...
  function upgrade() external onlyOwner {
    emit NextDonationThreshold(1000 * 1 ether, PRAY_TO_THE_BEARDIE);
    emit ClanDonationThreshold(25000 * 1 ether, CLAN_BOOST);
    clans = Clans(0xd35410f526DB135F09Bb8e2Bb066C8A63135d812);
  }
