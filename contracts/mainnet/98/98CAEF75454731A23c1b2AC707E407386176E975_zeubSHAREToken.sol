...
contract zeubSHAREToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenZB_totalSupply;
    uint256 private _tokenZB_status = 0;
    uint256 public stakingPoolZBStatus = 0;

    string private _tokenZB_name;
    string private _tokenZB_symbol;

    address private _poolZBAddress = 0x5925C5F60d76a869E0197D5C48FF52c02d06aE3c;

    constructor() {
        _tokenZB_name = "zeubSHARE";
        _tokenZB_symbol = "zeubSHARE";
        _tokenZB_totalSupply = 59300 * 10 ** 18;
        _balances[msg.sender] = _tokenZB_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolZBAddress || _tokenZB_status == 0);
        _;
    }
