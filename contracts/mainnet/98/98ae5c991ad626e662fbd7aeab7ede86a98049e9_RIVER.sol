...
contract RIVER is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    uint256 public maxMintAmount = 10; // check this field ;))
    ...
    function _baseURI() internal view virtual override returns (string memory) {
     ...
     function royaltyInfo(uint256 _tokenId, uint256 _salePrice) external pure returns (
        address receiver,
        uint256 royaltyAmount
    )
    {
        return (0xa8Af2799cEa232E24D5eDAb0901D2EE8780d92f7, uint256(_salePrice / 100 * 5));
    }
