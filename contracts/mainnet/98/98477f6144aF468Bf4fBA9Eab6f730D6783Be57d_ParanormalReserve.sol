...
// File @boringcrypto/boring-solidity/contracts/interfaces/[email protected]2.0
...
// File contracts/ParanormalReserve.sol
// License-Identifier: UNLICENSED

/// @notice Rebasing tokens ARE NOT supported and WILL cause loss of funds.
/// Any funds transfered directly onto the BentoBox will be lost, use the deposit function instead.
contract ParanormalReserve is MasterContractManager, BoringBatchable {
    using BoringMath for uint256;
    using BoringMath128 for uint128;
    ...
    function setStrategy(IERC20 token, IStrategy newStrategy) public onlyOwner {
        ...
        if (data.strategyStartDate == 0 || pending != newStrategy) {
            ...
            data.strategyStartDate = (block.timestamp).to64();
