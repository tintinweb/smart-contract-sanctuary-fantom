...
contract POLONIUM is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'Polonium';
    string private constant _symbol = 'Polonium';

    uint256 private _taxFee = 400;
    uint256 private _burnFee = 0;
    uint public max_tx_size = 100 ether;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xB99DBd4083E750c419B2309cE0A8f4Eb7f616602, 'We can not exclude router.');
