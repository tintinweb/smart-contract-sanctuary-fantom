...
contract CSHARE is ERC20BurnableUpgradeable, Operator {
    ...
    function setTime(uint256 _timeToStart) external onlyOperator {
        require(!poolStarted, "only can set once");
        startTime = _timeToStart;
