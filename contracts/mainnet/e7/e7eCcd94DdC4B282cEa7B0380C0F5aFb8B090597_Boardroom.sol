...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    function getGoblinPrice() external view returns (uint256) {
        return treasury.getGoblinPrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            goblin.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        goblin.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function governanceRecoverUnsupported(
        ...
        require(address(_token) != address(share), "hobgoblin");
