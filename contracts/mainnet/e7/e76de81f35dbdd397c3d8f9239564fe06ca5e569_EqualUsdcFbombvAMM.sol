...
// File contracts/EqualUsdcFbombvAMM.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract EqualUsdcFbombvAMM is Ownable, Pausable {
    ...
    function addLiquidity() internal {
        ...
        IEqualizerRouter(unirouter).addLiquidity(fbomb, usdc, stable, lp0Bal, lp1Bal, 1, 1, address(this), block.timestamp);
    }
