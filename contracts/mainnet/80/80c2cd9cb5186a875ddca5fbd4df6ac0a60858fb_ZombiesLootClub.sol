...
contract ZombiesLootClub is ERC721, ERC721Enumerable, Pausable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    uint256 public MINT_PRICE = 5 ether;
    uint256 public MAX_SUPPLY = 10518;

    constructor() ERC721(" Zombies Loot Club", "ZLC") {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmbVuaFZTHAxoxVuVNyfErvdsESwugiC5ExpCR7rbofo3T/";
    }
