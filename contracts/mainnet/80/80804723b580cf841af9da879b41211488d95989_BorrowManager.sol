...
// File: interfaces/IBorrowManager.sol
...
// File: interfaces/ICoordinator.sol
...
// File: interfaces/ICollateralizationManager.sol
...
// File: managers/BorrowManager.sol
...
contract BorrowManager is IBorrowManager, AccessControlEnumerable, ReentrancyGuard, Pausable
{
  ...
  function _getLiquidationMetadata (Debt memory debt, uint256 amount, uint256 collateral, bool isPartial) private view returns (Liquidation memory)
  {
    ...
    uint256 fee = (collateral - defaultFee - compensation) > 0 ? (defaultFee + (collateral - compensation)) : defaultFee;
