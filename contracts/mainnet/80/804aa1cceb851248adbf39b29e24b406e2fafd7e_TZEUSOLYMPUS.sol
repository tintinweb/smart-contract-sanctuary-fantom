...
contract TZEUSOLYMPUS is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Olympus finance';
    string private constant _symbol = 'TZEUS';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xFABc8E83612FAe1ACEF6002Db1Aa2598d851b248, 'We can not exclude router.');
