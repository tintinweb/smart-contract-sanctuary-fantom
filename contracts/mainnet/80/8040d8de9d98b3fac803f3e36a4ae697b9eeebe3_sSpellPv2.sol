...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xbB29D2A58d880Af8AA5859e30470134dEAf84F2B); // SPELL
...
contract sSpellPv2 is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xbB29D2A58d880Af8AA5859e30470134dEAf84F2B; // ETH
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "FANTOM sSpellPrinter";
    string constant _symbol = "sSpellPv2";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(100); // 1%
    uint256 public _maxWallet = _totalSupply.div(5); // 2.5%
    ...
    address public autoLiquidityReceiver=0x9800700AAE7027e74Ba1502BfBFF1086F72670b3; //liq address
    address public marketingFeeReceiver=0x9800700AAE7027e74Ba1502BfBFF1086F72670b3; // marketing address
