...
contract FoxieShare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 55,000 FSHAREs
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Foxie Share", "FSHARE") {
