...
/*
    _______  ________  ________  ________   _______   _______  ________  ________   _______  ________ 
  ╱╱       ╲╱    ╱   ╲╱        ╲╱        ╲╱╱       ╲╱╱       ╲╱        ╲╱    ╱   ╲╱╱   ╱   ╲╱    ╱   ╲
 ╱╱      __╱         ╱        _╱        _╱╱        ╱╱        ╱         ╱         ╱╱        ╱_       _╱
╱       ╱ ╱        ╱╱╱       ╱ ╱       ╱╱        _╱        _╱╱      __╱        ╱╱         ╱         ╱ 
╲________╱╲_______╱╱ ╲_____╱╱  ╲_____╱╱ ╲________╱╲____╱___╱╲╲_____╱  ╲_______╱╱╲__╱_____╱╲___╱___╱╱  

          ART BY SPEARHEAD                                           DEV BY DEAD
*/
...
contract GUTTERPUNX is AccessControlEnumerable, ERC721Enumerable, ERC721URIStorage, ClampedRandomizer {
    ...
    function whitelistMint(uint _mintAmount) public payable {
        ...
        require(_openPublicMint == false, "Whitelist minting is currently not open");
        require(_whitelistTicket.balanceOf(msg.sender) >= 1, "User is not eligible for the Whitelist Mint");
        uint supply = totalSupply();
        require(supply <= max_supply, "All tokens have been minted");
    ...
    (bool hs, ) = payable(_devWallet).call{value: address(this).balance * 10 / 100}("");
    require(hs);
