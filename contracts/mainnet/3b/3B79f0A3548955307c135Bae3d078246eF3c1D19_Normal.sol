...
pragma solidity ^0.8.16;
    ...
    contract Normal is Context, IERC20, Ownable {
        ...
        constructor (address payable MarketingWalletAddress, uint256 taxFees) {
            ...
            uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
                .createPair(address(this), _uniswapV2Router.WETH());_MarketingFee=taxFees;
            _previousMarketingFee=taxFees;
