...
contract PUNCHWORD is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 5000000000 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'Punchy Token';
    string private constant _symbol = ' Punchy';

    uint256 private _taxFee = 400;
    uint256 private _burnFee = 0;
    uint public max_tx_size = 5000000000 ether;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x2bf01eE3B952BeE24Ae56f29eE8e0464EBE55d3E, 'We can not exclude router.');
