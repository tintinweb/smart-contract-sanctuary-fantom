...
// File contracts/FghstFtmEqualizerV2.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract FghstFtmEqualizerV2  is Ownable, Pausable {
    using SafeERC20 for IERC20;

    // Tokens
    address public constant wftm = address(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83);
    address public constant equal = address(0x3Fd3A0c85B70754eFc07aC9Ac0cbBDCe664865A6);
    address public constant fghst = address(0x8b7007E1D02d8387B7B4BC8C6172598780ae59B2);
    address public want;
    ...
    IEqualizerRouter.Routes[] public equalToFghstPath;
    ...
    constructor(
        ...
        IEqualizerRouter.Routes[] memory _equalToFghstPath,
        ...
        for (uint i; i < _equalToFghstPath.length; ++i) {
            equalToFghstPath.push(_equalToFghstPath[i]);
        }
    ...
    function addLiquidity() internal {
        ...
        IEqualizerRouter(router).swapExactTokensForTokens(equalHalf, 0, equalToFghstPath, address(this), block.timestamp);

        uint256 t1Bal = IERC20(wftm).balanceOf(address(this));
        uint256 t2Bal = IERC20(fghst).balanceOf(address(this));

        IEqualizerRouter(router).addLiquidity(wftm, fghst, stable, t1Bal, t2Bal, 1, 1, address(this), block.timestamp);
    }
    ...
    function _subAllowance() internal {
        ...
        IERC20(fghst).safeApprove(router, 0);
    }
    ...
    function _addAllowance() internal {
        ...
        IERC20(fghst).safeApprove(router, type(uint).max);
    }
