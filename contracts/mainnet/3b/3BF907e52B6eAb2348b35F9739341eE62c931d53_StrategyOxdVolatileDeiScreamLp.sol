...
contract StrategyOxdVolatileDeiScreamLp is StrategyOxdFarmLPBase {
    // Token addresses
    address public dei_scream_lp = 0xd11e940c42e03d927cfd7426718bb4cA21d6015f;
    ...
    {
        swapRoutes[scream].push(route(wftm, scream, false));
    ...
    function getName() external pure override returns (string memory) {
        return "StrategyOxdVolatileDeiScreamLp";
    }
}
