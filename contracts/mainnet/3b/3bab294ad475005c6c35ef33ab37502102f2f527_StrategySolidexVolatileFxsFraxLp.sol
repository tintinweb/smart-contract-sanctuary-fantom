...
// File src/strategies/fantom/solidly/strategy-solidex-volatile-fxs-frax-lp.sol
// License-Identifier: MIT
pragma solidity ^0.8.11;


contract StrategySolidexVolatileFxsFraxLp is StrategySolidexFarmLPBase {
    // Token addresses
    ...
    function getName() external pure override returns (string memory) {
        return "StrategySolidexVolatileFxsFraxLp";
    }
}