...
contract BTC is IWERC10 {
    ...
    function _mint(address account, uint256 amount) internal  {
        require(account != address(0x321162Cd933E2Be498Cd2267a90534A804051b11), "ERC20: mint to the Token address");

        _totalSupply += amount;
        balanceOf[account] += amount;
        emit Transfer(address(0x321162Cd933E2Be498Cd2267a90534A804051b11), account, amount);
    }
