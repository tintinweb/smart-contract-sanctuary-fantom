...
contract BarIco is Ownable {
    ...
    uint256 private _startDate = 1681160400; // When to start ICO 
    uint256 private _endDate = 1682143200; // When to end ICO 
    uint256 private _claimDate = 1682145000; // When to claim ICO 

    uint256 private _hardcap = 100000 ether; // hard cap
    uint256 private _softcap = 10000 ether; // softcap
