    ...
    ERC721Burnable
{
    ...
    uint256 public maxPerPerson = 21;
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("Army Of Threatened", "AOT") {     
        ...
        require(totalFee == 10000,"Error: invalid total fee");
         baseURI = "ipfs://QmPc7Ke1qNdrYqaNN8996KK3z1SJX88WoCQzFmDX4g3tna/";
        _pause();
