/**
 *Submitted for verification at FtmScan.com on 2023-02-01
*/
...
contract VaultNFTv3 is Initializable, ERC721Upgradeable {
    ...
    function __VaultNFTv3_init(string memory name, string memory symbol, address _meta, string memory baseURI)
    onlyInitializing
    internal
    {
...
contract Stablecoin is Initializable, ReentrancyGuardUpgradeable, VaultNFTv3, ILiquidator {
    ...
    function __Stablecoin_init(
        ...
        __VaultNFTv3_init(name, symbol, meta, baseURI);
...
// File: contracts/StablecoinEnhanced.sol
...
contract StablecoinEnhanced is Initializable, Stablecoin, OwnableUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() {
        _disableInitializers();
    }
