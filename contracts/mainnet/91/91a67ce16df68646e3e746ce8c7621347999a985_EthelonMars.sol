...
//            :!v21ttFsJliTcrr**!;*~__             
//         ^Tj33f1SSEEtJ3ECTrr**!;;^^^;^-          
//      -rSeSXDD%#%[email protected]@@g%[email protected]*__^_        
//     !SEjvtG&B808&B%Ng&[email protected]@[email protected]&$KiT*;;__-      
//   _eSSEir -*&@%M%B%%%%%%0g%%g%Bg&!- TcrT^_--    
//  ~SySG8F_   [email protected]&&&g%888%x   ;cgbDDu*'   
// ^PPyS8gl:    -e2VXA#8RbPSeCFicT     [email protected]%g&*---  
//[email protected]*    !52VXA#8Rb4S5CFicT_    ;[email protected]@v-     
//[email protected]  ^ixjEkXA#8Rb4S5CFvT*r*,  [email protected]@@^-     
//[email protected]&tvLrTxxT*^!28Rb4S3;_^*r***rS%@@g;--     
//[email protected]@8crrlH32VXr emb4y, viccGe**[email protected]&gH---     
// [email protected]@[email protected]@8U2XAD8Rb4Sexs3PT%@Brr&&@r---     
// [email protected]___,*[email protected]@O#[email protected]@Gcv;___;@@^---     
// [email protected]     _J2SU8H8Rb42EuFic;-     @gr---   - 
//  SPPySXgG       +VXAR4CFFC5CFi,       gs^---     
//  _yPySSrr        _;^rrb8g8*,,-        _;'--- --  
//   ;SySSS^           &@@@@@%           ;__----_   
//   'jSSESc-          i#@b*          -;___--_-    
//     !SE2ej;       _eXU%PPyL       ^;______      
//       !je5jj*_      ^cLr:      _;;^,__^_        
//         ^ie333F*:          -,;*;^^^!^_          
//             ,*ijutusTr**!*rTr*!!r;^_             
//                  _:~!;;Lr^;!^,_                  
...
// File: sol-defifactory-token/interfaces/IEthelonMarsBotDetection.sol
...
interface IEthelonMarsBotDetection {
...
// File: sol-defifactory-token/interfaces/IEthelonMarsToken.sol
...
// File: sol-defifactory-token/EthelonMarsBasedToken.sol
...
contract EthelonMarsBasedToken is Context, AccessControlEnumerable, ERC20Mod, ERC20Permit {
    ...
    uint internal constant ETHELONMARS_BOT_DETECTION_CONTRACT_ID = 3;
    address constant ETHELONMARS_TOKEN_CONTRACT_ADDRESS = 0xFc5DFaEA79c57936a13f6E63C8a916Cb8110126F;    
    ...
    {
        IEthelonMarsBotDetection iEthelonMarsBotDetection = IEthelonMarsBotDetection(
            getUtilsContractAtPos(ETHELONMARS_BOT_DETECTION_CONTRACT_ID)
        );
        iEthelonMarsBotDetection.checkTransactionInfo(
            ETHELONMARS_TOKEN_CONTRACT_ADDRESS, 
            sender, 
            recipient, 
    ...
    function getUtilsContractAtPos(uint pos)
        ...
        returns (address)
    {
        return IEthelonMarsToken(ETHELONMARS_TOKEN_CONTRACT_ADDRESS).getUtilsContractAtPos(pos);
    }
...
// File: sol-defifactory-token/EthelonMars.sol
...
contract EthelonMars is EthelonMarsBasedToken {
    ...
    constructor()
        EthelonMarsBasedToken("Ethelon Mars", "EMARS")
    {
