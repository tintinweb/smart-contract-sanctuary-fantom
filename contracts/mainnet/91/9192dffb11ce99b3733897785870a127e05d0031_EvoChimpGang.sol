...
contract EvoChimpGang is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    uint256 public constant MINT_PRICE = 25 ether; //set
    uint256 public constant MUTATION_PRICE = 55 ether; //set
    ...
    //set
    constructor() ERC721("EvoChimpGang", "BCGE") {}
