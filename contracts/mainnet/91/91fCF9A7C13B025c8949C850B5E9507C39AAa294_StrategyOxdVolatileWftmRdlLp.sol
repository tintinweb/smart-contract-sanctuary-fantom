...
contract StrategyOxdVolatileWftmRdlLp is StrategyOxdFarmLPBase {
    // Token addresses
    address public wftm_rdl_lp = 0x5ef8f0bd4F071B0199603a28ec9343F3651999c0;
    address public rdl = 0x79360aF49edd44F3000303ae212671ac94bB8ba7;
    ...
    {
        swapRoutes[rdl].push(route(wftm, rdl, false));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategyOxdVolatileWftmRdlLp";
    }
}
