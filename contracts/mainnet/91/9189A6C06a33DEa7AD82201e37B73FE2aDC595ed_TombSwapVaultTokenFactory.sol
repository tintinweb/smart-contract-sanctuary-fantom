...
import "./TombSwapVaultToken.sol";
import "./interfaces/IMasterChef.sol";
import "./interfaces/IVaultTokenFactory.sol";
import "./interfaces/IUniswapV2Pair.sol";
import "./interfaces/IUniswapV2Router01.sol";
import "./interfaces/ITombSwapUniswapV2Factory.sol";
import "./libraries/SafeMath.sol";

contract TombSwapVaultTokenFactory is Ownable, IVaultTokenFactory {
    using SafeMath for uint256;

    address public optiSwap;
    address public router;
    address public tombSwapFactory;
    ...
    constructor(
        ...
        optiSwap = _optiSwap;
        router = _router;
        tombSwapFactory = IUniswapV2Router01(router).factory();
        ...
        returns (address vaultToken)
    {
        ...
        bytes memory bytecode = type(TombSwapVaultToken).creationCode;
        assembly {
            vaultToken := create2(0, add(bytecode, 32), mload(bytecode), pid)
        }
        TombSwapVaultToken(vaultToken)._initialize(
            optiSwap,
    ...
    function swapFeeFactor() public view returns (uint256) {
        return uint256(1000).sub(ITombSwapUniswapV2Factory(tombSwapFactory).swapFee());
    }
}
...
import "./interfaces/IMasterChef.sol";
import "./interfaces/ITombSwapVaultToken.sol";
...
contract TombSwapVaultToken is ITombSwapVaultToken, IUniswapV2Pair, PoolToken {
    ...
    ITombSwapUniswapV2Factory public tombSwapFactory;
    ...
    function _initialize(
        ...
        WETH = _router.WETH();
        router = _router;
        tombSwapFactory = ITombSwapUniswapV2Factory(router.factory());
        masterChef = _masterChef;
        pid = _pid;
        ...
        require(tombSwapFactory.getPair(token0, token1) == underlying, "VaultToken: INVLD_PAIR");
        rewardsToken = _rewardsToken;
    ...
    function swapFeeFactor() public view returns (uint256) {
        return uint256(1000).sub(tombSwapFactory.swapFee());
    }
...
interface ITombSwapUniswapV2Factory {
