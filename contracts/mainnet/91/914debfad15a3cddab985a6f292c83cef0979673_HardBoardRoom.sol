...
// File: Mario/utils/ContractGuard.sol
...
// File: Mario/interfaces/ITreasury.sol
interface ITreasury {
...
contract HardBoardRoom is ShareWrapper, ContractGuard {
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;
    ...
    function setLockUp(uint256 _withdrawLockupEpochs, uint256 _rewardLockupEpochs) external onlyOperator {
        require(_withdrawLockupEpochs >= _rewardLockupEpochs && _withdrawLockupEpochs <= 60, "_withdrawLockupEpochs: out of range"); // <= 2 week
