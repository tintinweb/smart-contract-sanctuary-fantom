...
// TELEGRAM: https://t.me/salamandertensei
// WEBSITE: TBA
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83);
...
contract SalamanderTensei is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Salamander Tensei";
    string constant _symbol = "$TENSEI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 5000000 * (10 ** _decimals); // 1m 
    ...
    uint256 public swapThreshold = _totalSupply * 60 / 50000;
    bool inSwap;
