...
// File: contracts/distribution/PeakGenesisRewardPool.sol
...
contract PeakGenesisRewardPool {
    using SafeMath for uint256;
    ...
    // MAINNET
    uint256 public peakPerSecond = 0.0011574 ether; // 10000 PEAK / (24h * 60min * 60s)
