...
contract JCollateralCapErc20 is JToken, JCollateralCapErc20Interface, JProtocolSeizeShareStorage {
    ...
    function registerCollateral(address account) external returns (uint256) {
        ...
        require(msg.sender == address(joetroller), "only tombtroller may register collateral for user");
    ...
    function unregisterCollateral(address account) external {
        ...
        require(msg.sender == address(joetroller), "only tombtroller may unregister collateral for user");
    ...
    function decreaseUserCollateralInternal(address account, uint256 amount) internal {
        require(joetroller.redeemAllowed(address(this), account, amount) == 0, "tombtroller rejection");
