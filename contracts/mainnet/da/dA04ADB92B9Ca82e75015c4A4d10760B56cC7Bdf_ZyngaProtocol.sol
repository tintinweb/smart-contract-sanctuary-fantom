...
contract ZyngaProtocol is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Zynga Protocol';
    string private constant _symbol = 'ZYN';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x0654eFEb9f271721e176f321dEad0f73DE46b907, 'We can not exclude router.');
