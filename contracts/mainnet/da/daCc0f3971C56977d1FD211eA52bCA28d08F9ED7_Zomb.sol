...
contract Zomb is ERC20Burnable, Operator {
    ...
    // Initial distribution for the day 2-5 ZOMB-WETH LP -> ZOMB pool
    uint256 public constant INITIAL_ZOMB_POOL_DISTRIBUTION = 140000 ether;
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("zomb.money", "ZOMB") {
