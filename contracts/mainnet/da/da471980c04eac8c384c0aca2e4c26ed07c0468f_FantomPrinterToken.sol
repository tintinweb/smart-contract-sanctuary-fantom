...
contract FantomPrinterToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address public autoLiquidityReceiver=0x8bFc959F89Bc252A6c71133b79c130476f4cDA93; //liq address
    address public marketingFeeReceiver=payable(0x1AD7126D09f6e5FD3a50087abe5753f6755Ae524); // marketing address
...
//        emit Transfer(sender, recipient, amount);
    ...
    function swapBack() internal swapping {
        ...
        swapTokeToWFTM(amountFTMMarketing, marketingFeeReceiver);
    ...
    function swapTokeToWFTM(uint256 amount, address to) internal {
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = WFTM;
