...
// File: contracts/distribution/ZombGenesisRewardPool.sol
...
contract ZombGenesisRewardPool {
    ...
    // MAINNET
    uint256 public tombPerSecond = 0.031829 ether; // 11000 ZOMB / (4 day * 24h * 60min * 60s)
    uint256 public runningTime = 96 hours; // 4 days
