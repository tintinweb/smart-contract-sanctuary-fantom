...
// File contracts/ReaperStrategyBeethovenSpotieOatie.sol
...
contract ReaperStrategyBeethovenSpotieOatie is ReaperBaseStrategyv3{
    ...
    function _deposit() internal override {
        ...
        if (wantBalance != 0) {
            want.safeIncreaseAllowance(address(MASTER_CHEF), wantBalance);
    ...
    function _swapBeetsToWeth() internal {
        ...
        BEETS.safeIncreaseAllowance(BEET_VAULT, beetsBal);
