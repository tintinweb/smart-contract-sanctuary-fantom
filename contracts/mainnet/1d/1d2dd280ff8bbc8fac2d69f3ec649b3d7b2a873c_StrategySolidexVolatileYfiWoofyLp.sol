...
// File src/strategies/fantom/solidly/strategy-solidex-volatile-yfi-woofy-lp.sol
// License-Identifier: MIT
pragma solidity ^0.8.11;


contract StrategySolidexVolatileYfiWoofyLp is StrategySolidexFarmLPBase {
    // Token addresses
    ...
    function getName() external pure override returns (string memory) {
        return "StrategySolidexVolatileYfiWoofyLp";
    }
}