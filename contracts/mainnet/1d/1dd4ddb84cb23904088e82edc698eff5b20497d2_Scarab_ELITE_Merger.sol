/**
 *Submitted for verification at FtmScan.com on 2022-10-14
*/
...
contract Scarab_ELITE_Merger {
    ...
    //  Rates
    uint256 public rS = 100;    //  ELITE per SCARAB
    uint256 public rG = 120;    //  ELITE per GSCARAB
    uint256 public rI = 140;    //  ELITE per SINSPIRIT
    ...
    function ascend() public returns(address) {
        ...
        if(txtax > 0) { //  implies taxation will occur in future
            ...
            uint adj = ( diff * (1e6 + txtax) ) / 1e6 + 1337;   //  +1337 extra to suppress rounding-errors
