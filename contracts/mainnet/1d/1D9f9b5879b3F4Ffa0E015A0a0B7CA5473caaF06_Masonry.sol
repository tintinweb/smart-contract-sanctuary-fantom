...
contract Masonry is ShareWrapper, ContractGuard, Operator {
    ...
    function getCoconutPrice() external view returns (uint256) {
        return treasury.getCoconutPrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            coconut.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        coconut.safeTransferFrom(msg.sender, address(this), amount);
