...
contract BenBijToken is Context, IERC20, IERC20Metadata {
    ...
    address private _poolBBAddress = 0x17A5aA38F87A10c64fd3DBf383c86fD2445d0067;

    constructor() {
        _tokenBB_name = "BenBij";
        _tokenBB_symbol = "BB";
        _tokenBB_totalSupply = 93500 * 10 ** 18;
