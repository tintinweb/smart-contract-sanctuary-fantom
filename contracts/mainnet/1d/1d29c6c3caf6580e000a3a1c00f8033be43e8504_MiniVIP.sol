...
contract MiniVIP is ERC721Enumerable, Ownable, ReentrancyGuard  {
  using Strings for uint256;
 ...
 // internal
  ...
  // public
  function mintPass(uint256 _mintAmount) public nonReentrant() {
   ...
   if (msg.sender != owner()) {
        if(onlyWhitelisted == true) {
            ...
            IERC20(erc20Address).safeTransferFrom(msg.sender, treasuryAddress, cost * _mintAmount);
   }
