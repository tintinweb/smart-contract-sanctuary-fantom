...
contract Code7MasterNode {
    ...
    IERC20 public constant CODE7 = IERC20(0x4fFbB4F7c335AbD33e6E2C45b6F2d3b19d9C8421);
    ...
    function create(uint256 nodeTier, uint256 numNodes) external {
        ...
        CODE7.safeTransferFrom(_sender, address(this), tierPrice);
        ...
        //);
        uint256 burnedAmount = tierPrice.mul(burnRatio).div(100);
        uint256 daoFundCut = tierPrice.mul(treasuryFeePercent).div(100);
        CODE7.safeTransferFrom(address(this), deadAdd, burnedAmount);
        CODE7.safeTransferFrom(address(this), daoFund, daoFundCut);
