...
// No permissions granted before Tuesday, 28 May 2024, then GPL-3.0 after this date.
 ...
 * out quoting reference 'NyPtvFantomLqdrWftmWigoSwapStrategyToUsdc'
 *
...
contract NyPtvFantomLqdrWftmWigoSwapStrategyToUsdc is NYBaseProfitTakingStrategyV2 {
  using SafeERC20Upgradeable for IERC20Upgradeable;

  uint256 public constant MAX_SLIPPAGE = 9700;

  uint256 public constant POOL_ID = 14;
  ...
  address public constant LP_TOKEN = address(0xeeBfC8d5BafC2815968Cb267409a4Ed1B6E956F5);
  address public constant LP_TOKEN_0 = address(0x10b620b2dbAC4Faa7D7FFD71Da486f5D44cd86f9);
  ...
  function estimateHarvest() external view override returns (uint256 profit, uint256 callFeeToUser) {
    ...
    if (totalRewards != 0) {
      profit += IUniswapV2Router02(WIGO_SWAP_ROUTER).getAmountsOut(totalRewards, wigoToUsdcPath)[1];
    }
