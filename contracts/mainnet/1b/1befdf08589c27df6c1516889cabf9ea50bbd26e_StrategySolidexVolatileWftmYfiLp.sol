...
// File src/strategies/fantom/solidly/strategy-solidex-volatile-wftm-yfi-lp.sol
// License-Identifier: MIT
pragma solidity ^0.8.11;


contract StrategySolidexVolatileWftmYfiLp is StrategySolidexFarmLPBase {
    // Token addresses
    ...
    function getName() external pure override returns (string memory) {
        return "StrategySolidexVolatileWftmYfiLp";
    }
}