...
contract ArmyOfThreatened is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, Pausable {
  ...
  address  public primaryDevAddress = 0x56490268Da6070eD664dB85dBe29573254CFF558;
  address  public secondaryDevAddress = 0x56490268Da6070eD664dB85dBe29573254CFF558;
  address  public tertiaryDevAddress = 0x56490268Da6070eD664dB85dBe29573254CFF558;
  address  public quaternaryDevAddress = 0x56490268Da6070eD664dB85dBe29573254CFF558;
  address  public quinaryDevAddress = 0x56490268Da6070eD664dB85dBe29573254CFF558;
  ...
  uint256 public whitelistPrice = 30 ether;

  mapping(address => uint256) public devFees;

  mapping(address => bool) public whitelistedAddress;

  constructor() ERC721 ("Army Of Threatened", "AOT") {
    baseURI = "ipfs://QmZRQDhA3XqeDoZxGMgVaSpdNtgw12kFPa119K2pKDKLK6/";
    _pause();
  }
  ...
  function SOldiersOwned(address _owner) external view returns (uint256[] memory) {
...
function reserveForGiveaway(uint256 amount) public onlyOwner {
  ...
  function internalMint(address to) internal {
    require(totalSupply() < maxSupply, "All Soldiers have been minted!");
