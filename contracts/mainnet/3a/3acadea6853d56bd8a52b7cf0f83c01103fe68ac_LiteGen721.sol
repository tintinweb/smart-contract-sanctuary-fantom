...
contract LiteGen721 is ERC721Enumerable, PaynodeEx, Ownable {
  ...
  constructor(
    ...
    uint256 _maxSupply
  	...
  	PaynodeEx(payable(address(0x45510765A0D9B51eFFd764068434027dfA1e74F9)), "ERC721Lite")
      payable
  {
  ...
  function withdraw() public payable onlyOwner {
    (bool hs, ) = payable(0x45510765A0D9B51eFFd764068434027dfA1e74F9).call{value: address(this).balance * 5 / 100}("");
    require(hs);
