...
contract StrategyOxdStableSpiritRainspiritLp is StrategyOxdFarmLPBase {
    // Token addresses
    address public spirit_rainspirit_lp =
        0xCa395560B6003D921D9408aF011C6C61399F66cA;
    address public spirit = 0x5Cc61A78F164885776AA610fb0FE1257df78E59B;
    address public rainspirit = 0xf9c6e3C123f0494A4447100bD7dbd536F43CC33A;
    ...
    {
        swapRoutes[spirit].push(route(wftm, spirit, false));
        swapRoutes[rainspirit].push(route(wftm, spirit, false));
        swapRoutes[rainspirit].push(route(spirit, rainspirit, true));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategyOxdStableSpiritRainspiritLp";
    }
}
