...
contract KalmarCurveRouter is IKalmarTradingRoute, WhitelistedRole, ReentrancyGuard {
    ...
    // curve-mim-usdt-usdc
    ICurve2P public constant curvePool = ICurve2P(0x2dd7C9371965472E5A5fD28fbE165007c61439E1);
    IERC20 public constant mim = IERC20(0x82f0B8B456c1A451378467398982d4834b6829c1); // 0
    IERC20 public constant fusdt = IERC20(0x049d68029688eAbF473097a2fC38ef61633A3C7A); // 1
