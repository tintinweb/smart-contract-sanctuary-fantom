...
contract preSeleniumToken is ERC20('preSeleniumToken', 'PRESELENIUM'), ReentrancyGuard, Ownable {
    ...
    uint256 public constant preseleniumMaximumSupply = 20000 * (10 ** 18); //20k

    uint256 public preseleniumRemaining = preseleniumMaximumSupply;

    uint256 public maxHardCap = 20000 * (10 ** 18); // 20k usdc

    uint256 public constant maxpreSeleniumPurchase = 2000 * (10 ** 18); // 2000 preselenium
