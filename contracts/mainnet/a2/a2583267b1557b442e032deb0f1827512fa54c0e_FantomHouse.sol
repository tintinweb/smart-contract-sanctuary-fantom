...
contract FantomHouse is VRFConsumerBaseV2, Ownable, ReentrancyGuard {
	...
	// wFTM on Fantom Opera Mainnet =====================================================
	//
	address private constant TOKEN_ADDRESS = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
	...
	// Minimum Bet & Deposit=============================================================
    //
	uint256 minBet = 50000000000000000; // default 0.05 wFTM, worth 1 Cent ATM.
    ...
    uint256 minDeposit = 5000000000000000000; // default 5 wFTM, worth 1 USD ATM.
