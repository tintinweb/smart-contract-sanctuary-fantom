...
contract ShareWrapper {
    ...
    function stake(uint256 amount) public virtual {
        ...
        fshare.safeTransferFrom(msg.sender, address(this), amount);
    }
    ...
    function withdraw(uint256 amount) public virtual {
        ...
        fshare.safeTransfer(msg.sender, amount);
    }
}


contract FShareBoardroom is ShareWrapper, ContractGuard {
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            faith.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        faith.safeTransferFrom(msg.sender, address(this), amount);
