...
interface ITreasury {
    ...
    function getFlowerPrice() external view returns (uint256);
...
*/
contract Hive is ShareWrapper, ContractGuard {
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;
    ...
    function getFlowerPrice() external view returns (uint256) {
        return treasury.getFlowerPrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            Flower.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        Flower.safeTransferFrom(msg.sender, address(this), amount);
