...
contract FantomRawbonedSociety is
    ERC721,
    ERC721Enumerable,
    ERC721URIStorage,
    IERC2981,
    ...
    ClampedRandomizer
{
    ...
    address  public royaltyAddress = 0x001BceD55b913705623e44057aB5F1437ebB2B71;
    ...
    uint256 public maxPerPerson = 222;
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("Fantom Rawboned Society", "FRBS") ClampedRandomizer(maxSupply) {     
