 ...
 */
contract TPShare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 tpSHAREs
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("TPSHARE", "TPSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 TP Share for initial pools deployment
