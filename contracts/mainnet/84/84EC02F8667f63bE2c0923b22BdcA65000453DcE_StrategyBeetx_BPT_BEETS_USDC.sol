...
import "../BeetxStrategy.sol";

contract StrategyBeetx_BPT_BEETS_USDC is BeetXStrategy {

    address bpt_beets_usdc_diff;
    ...
    function initializeStrategy(
        ...
        address beets_usdc_lp = address(0x03c6B3f09D2504606936b1A4DeCeFaD204687890);
        ...
        bytes32 bpt_pool_id = 0x03c6b3f09d2504606936b1a4decefad204687890000200000000000000000015;
        __Strategy_init(
            _store,
            beets_usdc_lp,
            _vault,
