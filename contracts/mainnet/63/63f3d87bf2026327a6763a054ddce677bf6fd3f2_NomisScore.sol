...
contract NomisScore is ERC721, ERC721Burnable, Ownable, Pausable, EIP712 {
    ...
    */
    ...
    function setScore(
        ...
        require(score > 0 && score <= 10000, "setScore: Score must be between 1 and 10000");
    ...
    */
    ...
    /**
    * @dev Allows the contract owner to withdraw all the native balance held by the contract.
