...
contract BooHooGhosts is ERC721URIStorage,Ownable{
  ...
  ERC721Enumerable contract1 = ERC721Enumerable(0x3B181992CA90Cc00865345384120b6Fc4E0aE1Ca);
  ERC721Enumerable contract2 = ERC721Enumerable(0x20514229941171A8d058A08F8b42185574C9b159);
  constructor() ERC721("BOOhoo Ghosts", "BOO") {
    _customBaseURI = 'ipfs://bafybeiabh6fbqhm72rag563qen3xgal4w7d5h4hvv5cfjyd34pdlbignoy/';
    _price = 35000 * 1000000000000000;  //price in wei 
    _maxMintable = 201; 
    _royaltyAmount = 500;
    _maxPerWallet = 9999;
    _maxMintPerTx = 10; 
