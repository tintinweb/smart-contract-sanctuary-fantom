...
contract EpochTick is
	Epoch,
	AccessControlEnumerable,
	ReentrancyGuard,
	Pausable
{
	bytes32 public constant tickerRole = keccak256('ticker');
	...
	constructor(
		...
		_setupRole(tickerRole, msg.sender);
	}
	...
	function tick()
		...
		whenNotPaused
		checkEpoch
		onlyRoleOrOpenRole(tickerRole)
	{
		for (uint8 i = 0; i < listeners.length; i++) {
