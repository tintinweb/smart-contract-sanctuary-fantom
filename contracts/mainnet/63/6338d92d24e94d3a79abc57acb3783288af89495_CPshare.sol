...
contract CPshare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 50,000 CPshare
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("CP Shares", "CPshare") {
        _mint(msg.sender, 1 ether); // mint 1 CPShare for initial pools deployment
