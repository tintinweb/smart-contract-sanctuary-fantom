...
contract Squaddies is ERC721Enumerable, ERC721Royalty, ERC721Pausable, Ownable {
    ...
    bool public snapshotCompleted = false;
    modifier onlySnapshotCompleted() {
        require(snapshotCompleted == true, "Snapshot has not been completed");
        _;
    }
    ...
    address private service = 0xe60E6506d73C15C10DF4fA90380BBc6291152c41;
    modifier onlyService() {
        require(_msgSender() == service, "Not service account");
        _;
    }

    constructor() ERC721("Squaddies", "SQDS") {
        deployer = _msgSender();
    ...
    function takeSnapshot() public onlyOwner {
        require(!snapshotCompleted, "Snapshot has already been completed");
        ...
        snapshotCompleted = true; // set the value to true, we're done
    }
    ...
    function unpause() public onlyOwner {
        _unpause(); // once unpaused, cannot be unpaused
    }
