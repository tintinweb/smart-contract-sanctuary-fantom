...
interface IBEP20 {
  ...
  /**
   * @dev CCC Moves `amount` tokens from the caller's account to `recipient`.
   *
...
contract HADEToken is BEP20, MinterRole {
    ...
    uint256 public minSwapAmount = 100000000000;   //10 HADE tokens
    // Trading bool
    ...
    // USDC address
    address public constant USDC = address(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75); // USDC
    address public constant V2ROUTER = 0xF491e7B69E4244ad4002BC14e878a34207E38c29; //spooky
    ...
    /**z
     * @notice Constructs the HADE token contract.
     */
    constructor(address _feeWallet) public BEP20("HADES", "HADE") {
        operator = _msgSender();
    ...
    /// @dev overrides transfer function to meet tokenomics of HADE
    ...
    function transferOperator(address newOperator) public onlyOperator {
        require(newOperator != address(0), "HADE::transferOperator: new operator is the zero address");
