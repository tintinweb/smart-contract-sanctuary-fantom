...
//    address private ROUTER = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    ...
    uint256 public lpHolderUsdtRewardCondition = 0.02 * 1e6;
    ...
    constructor() public ERC20('A8 Token', 'A8'){
    ...
    function transferBase(address from,address to,uint256 value) internal returns (uint){
        ...
        if(lpShareAutoFlag){
            ...
            if(nowUsdtBalance >= lpHolderUsdtRewardCondition){
//                && block.number > lpProgressRewardBlock + 20
