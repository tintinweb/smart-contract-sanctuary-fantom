...
contract IceBearSociety is ERC721Enumerable, Ownable {
  ...
  // uint256 public saleStart = 1647266570;
  address private devAddress = 0xDbe5cCb402a3635a1E42aA226B07D1E83B6591d7; //ICE Bear Dev WALLET
  ...
  function mint(address _to, uint256 _mintAmount) public payable {
    ...
    require(supply + _mintAmount <= maxSupply,"Minting Completed");
    ...
    returns (string memory)
  {
   ...
   string memory currentBaseURI = _baseURI();
    /* string memory websiteBaseURI = "SERVER LINK";
