...
abstract contract Fund is Ownable, Initializable {
    ...
    function initialize(address _zsp) external initializer {
        require(_zsp != address(0), "Fund::constructor: Invalid address");
        zsp = IERC20(_zsp);
    }
    ...
    function currentBalance() public view returns (uint256) {
        return zsp.balanceOf(address(this));
    }
    ...
    function transfer(address receiver, uint256 amount) external onlyOwner {
        ...
        zsp.safeTransfer(receiver, amount);
    }
}
...
contract VestToUser is Fund {
    uint256 public constant ALLOCATION = 147500 ether;
    uint256 public constant VESTING_DURATION = 2 * 30 * 24 * 3600; // 2 months
    uint256 public constant VESTING_START = 1658692801; // No cliff
