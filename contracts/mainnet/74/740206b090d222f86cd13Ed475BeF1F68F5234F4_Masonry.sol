...
contract ShareWrapper {
    ...
    function stake(uint256 amount) public virtual {
        ...
        glot.safeTransferFrom(msg.sender, address(this), amount);
    }
    ...
    function withdraw(uint256 amount) public virtual {
        ...
        glot.safeTransfer(msg.sender, amount);
    }
}
...
contract Masonry is ShareWrapper, ContractGuard {
    ...
    function initialize(
        ...
        rewardLockupEpochs = 1; // Lock for 3 epochs (18h) before release claimReward GAS ON STEROIDS
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            gas.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        gas.safeTransferFrom(msg.sender, address(this), amount);
