...
contract IsolatedLendingV01 is ERC4626{
    ...
    uint256 private constant OPEN_COLLATERIZATION_RATE = 65000; // 65%
    ...
    constructor(address _asset, address _collateral, string memory _name, string memory _symbol)ERC4626(ERC20(_asset), _name, _symbol){
        ...
        moobooBOO = IBeefyVault(0x15DD4398721733D8273FD4Ed9ac5eadC6c018866);
        priceFeedCollateral = AggregatorV3Interface(0xc8C80c17f05930876Ba7c1DD50D9186213496376); //BOO/USD
        exchangeRate = moobooBOO.getPricePerFullShare()*(priceFeedCollateral.latestAnswer()*1e10)/1e28; //1e8 exchange rate
        feeTo = msg.sender;
        admin = msg.sender;
    }
    ...
    function updateExchangeRate() public{
        exchangeRate = moobooBOO.getPricePerFullShare()*(priceFeedCollateral.latestAnswer()*1e10)/1e28;
