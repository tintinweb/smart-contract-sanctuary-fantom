...
contract ROCKET is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 70,000 ROCKET
    ...
    uint256 public constant INSURANCE_FUND_POOL_ALLOCATION = 8000 ether;
    ...
    ) public ERC20("FUZZ Share", "ROCKET") {
        _mint(msg.sender, 1 ether); // mint 1 ROCKET for initial liquidity deployment
