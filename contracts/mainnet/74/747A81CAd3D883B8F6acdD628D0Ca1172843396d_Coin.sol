...
contract Coin is ReentrancyGuard, ERC20, AccessControl, Taxable {
    ...
    constructor(
        ...
        Taxable(true, 400, 1500, 0, 0xce15A2B08544cdDf639Dc58E1300f6c690FCf5F5)
    {
        _grantRole(DEFAULT_ADMIN_ROLE, 0xce15A2B08544cdDf639Dc58E1300f6c690FCf5F5);
        _grantRole(NOT_TAXED_FROM, 0xce15A2B08544cdDf639Dc58E1300f6c690FCf5F5);
        _grantRole(NOT_TAXED_TO, 0xce15A2B08544cdDf639Dc58E1300f6c690FCf5F5);
        _grantRole(NOT_TAXED_FROM, address(this));
        _grantRole(NOT_TAXED_TO, address(this));
        _mint(0xce15A2B08544cdDf639Dc58E1300f6c690FCf5F5, 1_000_000_000 * 10 ** decimals());
