/**
 *Submitted for verification at FtmScan.com on 2022-11-12
*/
...
// ____|#BEgg$gQ#[email protected]#dTr<^r*^^:_``[email protected]#@@@@@@@@@@@@@@@@@@@@#BBDX<<____________x[email protected]*~~=!T6
...
// @@@@@@@@@@@@@@@@Qk=.^kR#@@@@@@@@@B5^`*[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@#.  [email protected]#(`h[email protected][email protected]@B. `#@Qx`[email protected]@B_^@@@_ `[email protected] [email protected]@@@@h`(@@@@@= *@@
...
contract Uriel5 is ERC721, ERC721Enumerable, Pausable, Ownable, ERC721Burnable {
    ...
    constructor(address _tokenAddress) ERC721("Uriel5", "URIEL5") {
