...
contract PanicLocker is ERC20Upgradeable, IUpgradeSource, ControllableInit, EternalStorage {
    ...
    /// @notice Beluga's pod delegate.
    address public constant POD_DELEGATE = 0xE1bC96F811Ec784072dfc2f13a159bBAa16392dB;
    ...
    function __Vault_init(
        ...
        // Delegate lock voting power to Beluga.
        SNAPSHOT_DELEGATION.setDelegate("panicswap.eth", POD_DELEGATE);
    }
    ...
    /// @notice Delegates voting power from locked PANIC to Beluga.
    function delegateVotingPower() public onlyGovernance {
        SNAPSHOT_DELEGATION.setDelegate("panicswap.eth", POD_DELEGATE);
    }
    ...
    /// @notice Pure function for backwards-compatability.
    /// @return Address zero, this function is unused.
