...
Dev greeting:
Hi folks, we love you <3 -- Good that you are doing research to our contracts to stay safe!
...
contract BShare is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("BShare", "BShare") {
        _mint(msg.sender, 1 ether); // mint 1 BOGDA Share for initial pools deployment
