...
contract BeShare is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("BeShare", "BeShare") {
        _mint(msg.sender, 500 ether); // mint 1 tShare for initial pools deployment
