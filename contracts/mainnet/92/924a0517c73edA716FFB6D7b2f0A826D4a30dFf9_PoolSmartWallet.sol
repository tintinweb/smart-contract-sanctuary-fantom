...
contract PoolSmartWallet is IPoolWallet, ReentrancyGuard {
    ...
    function withdraw(
        ...
        console.log("Balance of this: %s", IERC20(token).balanceOf(address(this)));
        console.log("Attempting to transfer: %s", value - fee);
    ...
    /// @dev Allows for deposit of tokens from this contract to ERC-4626 vault
    /// Used by non-farming consumer positions
