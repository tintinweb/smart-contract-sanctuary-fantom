...
contract UShare is ERC20Burnable, Operator {
    ...
    function initializUshareToken(address _devFund) public  initializer {
        __ERC20_init("USHARE", "USHARE", 18);
    ...
    function initializStartTimeRewards(uint256 _startTime) external onlyOperator {
