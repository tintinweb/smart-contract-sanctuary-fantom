...
contract FantasmFinance is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Fantasm Finance';
    string private constant _symbol = 'FXM';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x0043d7c94154b16c96A0698dEcDdd547cC6Bc1c5, 'We can not exclude router.');
