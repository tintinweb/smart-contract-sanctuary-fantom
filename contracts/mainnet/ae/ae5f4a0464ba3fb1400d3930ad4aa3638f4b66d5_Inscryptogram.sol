...
contract Inscryptogram is ERC721 {
    ...
    event Follow(address indexed from,address to,bool following);
    event Message(address indexed from,address to,string message);
    ...
    function message(address to,string calldata text) public {
