...
contract AnarchoCapital is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Anarcho Capital';
    string private constant _symbol = 'ANCAP';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x33608f42fc4F592828BB12E94b5226638bddE20b, 'We can not exclude router.');
