...
contract Granary
{
	...
	*/
	...
	bytes32 public BPT_SHRA = 0x2ba4953c75860e70cd70f15a2d5fe07de832bcd1000200000000000000000210;
	bytes32 public BPT_FIDO = 0xcde5a11a4acb4ee4c805352cec57e236bdbc3837000200000000000000000019;// = [
	...
	address[9] public alladdr = [
		0x8166994d9ebBe5829EC86Bd81258149B87faCfd3,//0	BMC			.mc
		0x20dd72Ed959b6147912C2e529F0a0C651c33c9ce,//1	B-x
		0xb9799De71100e20aC1cdbCc63C69ddA2D0D81710,//2	bombdex		.router
		0xF24Bcf4d1e507740041C9cFd2DddB29585aDCe1e,//3	BEETS
		0xbf4906762C38F50bC7Be0A11BB452C944f6C72E1,//4	Shrap
		0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83,//5	wftm
		0x2Ba4953C75860e70Cd70f15a2D5Fe07DE832Bcd1,//6	BPT-shrap	.
		0xcdE5a11a4ACB4eE4c805352Cec57E236bdBC3837,//7	BPT-fidelio  .
		0x0786c3a78f5133F08C1c70953B8B10376bC6dCad //8  TvlGuru
	];

	/*
	0xe69b45be6260634de4e432f66179ce47ee846800	ftm-shrap bLp
	0xbf4906762c38f50bc7be0a11bb452c944f6c72e1	shrap
	0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83	wftm
	0xb9799De71100e20aC1cdbCc63C69ddA2D0D81710	bomb router
	*/
	...
	function work(address ben) internal
	{
        ...
        {
			//Sell 100% BEETS for WFTM at Beethoven-x
			...
			SingleSwap memory B2F = SingleSwap({
				poolid: 	BPT_FIDO,
			...
			IBX(alladdr[1]).swap(B2F, FM, 1, block.timestamp);

			//Buy SHRAP with 80% of USDC at BombSwap
		...
		IBX(alladdr[1]).joinPool(BPT_SHRA, address(this), address(this), R);
