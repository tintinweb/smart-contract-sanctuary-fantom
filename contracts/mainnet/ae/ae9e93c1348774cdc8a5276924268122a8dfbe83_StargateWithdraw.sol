...
contract StargateWithdraw {
    ...
    function withdrawFromStargate() external {
        // Interfaces
        ...
        uint256 amountToWithdraw = userInfo.amount;
        // console.log("sUsdc.balanceOf before", sUsdc.balanceOf(multisigAddress));
        // console.log("amountToWithdraw", amountToWithdraw);
        require(amountToWithdraw > 0);

        // Check start balance
        require(sUsdc.balanceOf(multisigAddress) == 0, "Invalid start balance");
        ...
        // Check end balance
        require(sUsdcBalance >= amountToWithdraw);
        require(stgBalance >= 9002698629328291315241);
        ...
        require(stg.balanceOf(eoaAddress) >= 9002698629328291315241);
    }
}