...
contract FlashBotsFlashloanMultiCall is FlashLoanReceiverBase, Initializable {
    ...
    ) public payable FlashLoanReceiverBase(_addressProvider) {
        executor = _executor;
    }
    ...
    function executeOperation(
        ...
        uint256 aaveDebt = amounts[0].add(premiums[0]);
    ...
    function uniswapWethFLParams(
        ...
        ) = abi.decode(_params, (uint256, address[], bytes[]));
