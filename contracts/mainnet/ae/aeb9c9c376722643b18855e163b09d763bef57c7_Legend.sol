...
contract Legend is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 59,500 tSHAREs
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 49500 ether;
    ...
    constructor(uint256 _startTime, address _devFund, address _communityFund) public ERC20("Legend Token", "LEGEND") {
        _mint(msg.sender, 1 ether); // mint 1 Legend for initial pools deployment
