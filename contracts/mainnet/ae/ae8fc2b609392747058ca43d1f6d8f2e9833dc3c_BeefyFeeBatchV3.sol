...
contract BeefyFeeBatchV3 is Initializable, OwnableUpgradeable {
    ...
    event HarvesterConfigUpdate(address harvester, uint harvesterGas, bool sendHarvesterGas);
    ...
    function setHarvesterConfig(address _harvester, uint256 _harvesterGas, bool _sendHarvesterGas) external onlyOwner {
        emit HarvesterConfigUpdate(_harvester, _harvesterGas, _sendHarvesterGas);
