...
contract FShares is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 100,000 FSHARES
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("FSHARES", "FSHARES") {
        _mint(msg.sender, 1 ether); // mint 1 FIREFLY Share for initial pools deployment
