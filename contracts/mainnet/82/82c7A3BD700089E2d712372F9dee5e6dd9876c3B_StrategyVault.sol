...
contract StrategyVault is Initializable, ERC20StablecoinEnhanced {
    ...
    function _calculateStrategyFeeForVault(uint256 vaultID) internal view returns (uint256) {
        ...
        uint256 vaultStrategyProfitYV = vaultStrategyProfit * 10**YFVault.decimals() / YFVault.pricePerShare();
        uint256 _strategyFee = vaultStrategyProfitYV * strategyProfitFee / 10000;
        return _strategyFee;
    }
