...
contract Goblin is ERC20Burnable, Operator {
    ...
    /**
     * @notice Constructs the GOBLIN ERC-20 contract.
     */
    constructor() public ERC20("GOBLIN", "GOBLIN") {
        _mint(msg.sender, 1 ether);
    }

    /**
     * @notice Operator mints GOBLIN to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of GOBLIN to mint to
