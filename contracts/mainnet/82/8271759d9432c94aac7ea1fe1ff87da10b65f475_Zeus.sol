...
contract Zeus is ERC20Burnable, Operator {
    using SafeMath8 for uint8;
    using SafeMath for uint256;

    // Initial distribution for the first 24h genesis pools
    uint256 public constant INITIAL_GENESIS_POOL_DISTRIBUTION = 34999 ether;
    uint256 public constant INITIAL_ZEUS_REWARD_POOL_DISTRIBUTION = 140000 ether;
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("ZEUS", "ZEUS") {
        // Mints 1 ZEUS to contract creator for initial pool setup
     ...
     */
    function distributeReward(address _genesisPool, address _rewardPool) external onlyOperator {
        require(!rewardPoolDistributed, "only can distribute once");
        require(_genesisPool != address(0), "!_genesisPool");
        require(_rewardPool != address(0), "!_rewardPool");
        rewardPoolDistributed = true;
        _mint(_genesisPool, INITIAL_GENESIS_POOL_DISTRIBUTION);
        _mint(_rewardPool, INITIAL_ZEUS_REWARD_POOL_DISTRIBUTION);
    }
