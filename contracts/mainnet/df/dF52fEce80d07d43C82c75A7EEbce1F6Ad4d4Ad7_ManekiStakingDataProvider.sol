...
contract ManekiStakingDataProvider {
    ...
    function getStakingAPR() public view returns (uint256) {
        ...
        //     if (rewardTokens[i] != protocolToken) {
        ...
        (, uint256 ratePerSecond, , , ) = multiFeeDistribution.rewardData(
        ...
        return allRewardsAnnualizedUsdValue.mul(10000).div(totalPawSupplyValue);
    }
