...
contract Strategy is BaseStrategy {
    ...
    address public router = address(0x16327E3FbDaCA3bcF7E38F5Af2599D2DDc33aE52); // LiquidDriver router
    ...
    function name() external view override returns (string memory) {
        return string(abi.encodePacked('LQDR USDC-DEI Strategy'));
    }
    ...
    function _sellPairTokenAux(uint256 _lpToken1Balance) internal {
        ...
        lp1TokenToLp0Route[0] = pairToken1;
    ...
    function sellAllLpPairToken() internal {
