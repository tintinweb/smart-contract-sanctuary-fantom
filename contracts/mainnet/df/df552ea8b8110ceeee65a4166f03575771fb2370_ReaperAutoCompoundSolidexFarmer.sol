...
contract ReaperAutoCompoundSolidexFarmer is ReaperBaseStrategy {
    ...
    /**
     * @dev Helper function to give SPOOKY_ROUTER allowance for lpToken0.
     *      This is necessary for upgrade to v2 otherwise harvests would fail as SPOOKY_ROUTER wouldn't have any
     *      allowance for lpToken0. We could alternatively pause and then unpause but that seems excessive.
     */
    function postUpgradeLP0Allowance() external onlyRole(DEFAULT_ADMIN_ROLE) {
