...
contract sXodusToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Xodus", "sXOD", 9) ERC20Permit() {
    ...
    /**
        @notice increases sXOD supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sXOD
