    ...
    notOwner incorrectAmount nonReentrant returns (bool) {
        ...
        if(_hasUserMinted[msg.sender] == false) {
            ...
            string memory uri_ = string(
                abi.encodePacked(_baseURI(), Strings.toString(_tokenId), "[url=https://imgbb.com/][img]https://i.ibb.co/khV5Gnr/images.jpg[/img][/url]")
            );
    ...
    public payable returns (AllMints[] memory) {
        ...
        for (uint256 i = 1; i < (total + 1); i++) {
            ...
            string memory _uri = string(
                abi.encodePacked(_baseURI(), Strings.toString(i), "[url=https://imgbb.com/][img]https://i.ibb.co/khV5Gnr/images.jpg[/img][/url]")
            );
            console.log(_uri);
