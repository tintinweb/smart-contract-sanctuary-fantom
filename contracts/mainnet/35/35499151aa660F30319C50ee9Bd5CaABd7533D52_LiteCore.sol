...
contract LiteCore is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Lite Core';
    string private constant _symbol = 'LCORE';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x39c52a1e604e9146743a2185b9c866349FdE1678, 'We can not exclude router.');
