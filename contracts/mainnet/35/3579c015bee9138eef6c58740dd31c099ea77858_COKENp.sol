...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xAbe0271723FA5e89dDbb7172a96564F84a776fBf); // BTC
...
contract COKENp is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xAbe0271723FA5e89dDbb7172a96564F84a776fBf; // COKEN
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "COKEN Printer";
    string constant _symbol = "COKENp";
    ...
    address public autoLiquidityReceiver=0xfFD6f983C10E19BE21881a0D420F5E0d8ceb756E; //liq address
    address public marketingFeeReceiver=0xfFD6f983C10E19BE21881a0D420F5E0d8ceb756E; // marketing address
