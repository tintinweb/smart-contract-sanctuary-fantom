...
contract NativeToken is ERC20 {
     ...
     */
    constructor(address _to, uint256 _initialSupply, uint256 _maxSupply, string memory _fullName, string memory _ticker) ERC20(_fullName, _ticker) {
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    function initializePools(address _nativeLP) external onlyOwner {
        ...
        add(250, IERC20(_nativeLP), 0, true, false);                                        // Native LP
        add(200, IERC20(native), 0, true, false);                                           // Native
        ...
        add(25, IERC20(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75), 400, false, false);     // USDC pool
        add(25, IERC20(0x049d68029688eAbF473097a2fC38ef61633A3C7A), 400, false, false);     // fUSDT pool
        add(25, IERC20(0x8D11eC38a3EB5E956B052f67Da8Bdc9bef8Abf3E), 400, false, false);     // DAI pool
        add(5, IERC20(0x841FAD6EAe12c286d1Fd18d1d525DFfA75C7EFFE), 400, false, false);      // BOO pool
        add(15, IERC20(0x82f0B8B456c1A451378467398982d4834b6829c1), 400, false, false);     // MIM pool
        add(5, IERC20(0x6c021Ae822BEa943b2E66552bDe1D2696a53fbB7), 400, false, false);      // TOMB pool
        add(10, IERC20(0xfB98B335551a418cD0737375a2ea0ded62Ea213b), 400, false, false);     // MAI pool
