...
contract SpiritFantomFraxUsdcStrategy is MasterChefBaseStrategy {
    ...
    function initialize(address _vault, address _parentStrategy)
        ...
        initializer
    {
        __NAME = "SpiritSwap FraxUsdc Strategy";
        address underlying = address(
            0x1478AEC7896e40aE5fB858C77D389F0B3e6CbC5d
        ); //FraxUsdc Spirit LP
        uint256 poolId = 66; // FraxUsdc Pool id
        ...
        address frax = address(0xdc301622e621166BD8E82f2cA0A26c13Ad0BE355);

        rewardRoutes[frax] = [spirit, wftm, frax];
        rewardRoutes[usdc] = [spirit, wftm, usdc];

        fromVaultAssetRoutes[dai][usdc] = [dai, usdc];
        fromVaultAssetRoutes[dai][frax] = [dai, usdc, frax];
        fromVaultAssetRoutes[usdt][frax] = [usdt, wftm, frax];
        ...
        toVaultAssetRoutes[dai][frax] = [frax, usdc, dai];
        toVaultAssetRoutes[usdt][frax] = [frax, wftm, usdt];
