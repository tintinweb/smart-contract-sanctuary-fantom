...
contract RedemptionRouter02 is IRedemptionRouter02 {
    ...
    function _swapSupportingFeeOnTransferTokens(address[] memory path, address _to) internal virtual {
        for (uint i; i < path.length - 1; i++) {
            ...
            amountOutput = RedemptionLibrary.getAmountOut(amountInput, reserveInput, reserveOutput);
            }
    ...
    {
        return RedemptionLibrary.getAmountOut(amountIn, reserveIn, reserveOut);
    }
...
library RedemptionLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'904896aebc4966d96d7e04cf1c1dc232c99a90a8bd73668aae8f97c1ea15200a' // init code hash
            ))));
    }
