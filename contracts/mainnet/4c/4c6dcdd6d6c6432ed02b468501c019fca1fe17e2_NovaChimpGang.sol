...
contract NovaChimpGang is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    uint256 public constant MAX_CHIMPS = 445;   //set (exclusive)
    uint256 public constant MINT_PRICE = 35 ether; //set

    mapping(address => uint8) private _whiteList;

    //set
    constructor() ERC721("NovaChimpGang", "NCG") {}

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmeQkvWZw97Q6Ja9M2ZXJuiCZBZqTWdkr5y1mtWXE3utNA/";
    }
    ...
    function MintAmountChimps(uint256 amount) public payable {
