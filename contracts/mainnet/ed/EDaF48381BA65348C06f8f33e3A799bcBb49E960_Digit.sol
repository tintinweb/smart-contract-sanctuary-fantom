...
contract Digit is ERC20Burnable, Operator {
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("Digital Finance", "digit") {
    ...
    function _getDigitPrice() internal view returns (uint256 _digitPrice) {
        try IOracle(digitOracle).consult(address(this), 1e18) returns (uint144 _price) {
            ...
            revert("Digit: failed to fetch DIGIT price from Oracle");
        }
    }
