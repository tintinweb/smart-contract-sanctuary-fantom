...
// File contracts/EqualizerFtmFghostvAMM.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract EqualizerFtmFghostvAMM is Ownable, Pausable {
    using SafeERC20 for IERC20;

    // Tokens
    address public constant wftm = address(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83);
    address public constant equal = address(0x3Fd3A0c85B70754eFc07aC9Ac0cbBDCe664865A6);
    address public constant fghost = address(0x8b7007E1D02d8387B7B4BC8C6172598780ae59B2);
    address public want;
    ...
    IEqualizerRouter.Routes[] public equalToFghostPath;
    ...
    constructor(
        ...
        IEqualizerRouter.Routes[] memory _equalToFghostPath
    ) {
        ...
        for (uint i; i < _equalToFghostPath.length; ++i) {
           equalToFghostPath.push(_equalToFghostPath[i]);
        }
   ...
   //Withdraws funds from masterchef
    ...
    function addLiquidity() internal {
        ...
        IEqualizerRouter(router).swapExactTokensForTokens(equalHalf, 0, equalToFghostPath, address(this), block.timestamp);

        uint256 t1Bal = IERC20(wftm).balanceOf(address(this));
        uint256 t2Bal = IERC20(fghost).balanceOf(address(this));

        IEqualizerRouter(router).addLiquidity(wftm, fghost, stable, t1Bal, t2Bal, 1, 1, address(this), block.timestamp);
    }
    ...
    function _subAllowance() internal {
        ...
        IERC20(fghost).safeApprove(router, 0);
    }
    ...
    function _addAllowance() internal {
        ...
        IERC20(fghost).safeApprove(router, type(uint).max);
    }
