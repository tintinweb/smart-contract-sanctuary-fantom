...
contract StrategyOxdSolidlyVolatileSexG3crvLp is StrategyOxdFarmLPBase {
    // Token addresses
    address public sex_g3crv_lp = 0x966F6dfDfdC7FEF3271287a88cb53C77d8901C19;
    ...
    {
        swapRoutes[sex].push(route(wftm, sex, false));
        swapRoutes[g3crv].push(route(wftm, crv, false));
        swapRoutes[g3crv].push(route(crv, g3crv, false));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategyOxdSolidlyVolatileSexG3crvLp";
    }
}
