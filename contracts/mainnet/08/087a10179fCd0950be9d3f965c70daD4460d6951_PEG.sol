...
contract PEG is ERC20Burnable, Operator {
    ...
    function _transfer(
        ...
        if (currentTaxRate == 0 || sender == owner() || recipient == owner() || excludedAddresses[sender] || excludedAddresses[sender] ) {
    ...
    function _transferWithTax(
        ...
        uint256 liquidityAmount = taxAmount.mul(80).div(100);
        swapAndLiquify(liquidityAmount);
        uint256 marketingAmount = taxAmount.mul(20).div(100);
        ...
        if (burnTax) {
            ...
            super._transfer(sender, taxCollectorAddress, marketingAmount);
        }
