...
contract Raffle is Ownable {
    ...
    uint256 ticketPrice = 5000000000000000000;
    ...
    function buyTicket(uint256 amount) public payable{
        ...
        require(msg.value >= totalAmount, "Not enough payment for the the amount of tickets desired.");

            split = totalAmount.div(10);
            uint256 devFeeSplit = split.div(2);
        ...
        IERC20(utilityToken).transferFrom(msg.sender, address(this), finalDiscountPrice);
            ...
            split = finalDiscountPrice.div(10);
            uint256 devFeeSplit = split.div(2);
            uint256 protocolFeeSplit = split.sub(devFeeSplit);
