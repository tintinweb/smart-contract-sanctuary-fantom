...
contract SoulAutoStake is Ownable, Pausable, ReentrancyGuard {
    ...
    ISoulSummoner public immutable soulSummoner = ISoulSummoner(0xce6ccbB1EdAD497B4d53d829DF491aF70065AB5B);
    ...
    uint internal constant MAX_PERFORMANCE_FEE = 500;
    uint internal constant MAX_CALL_FEE = 100;
    uint internal constant MAX_WITHDRAW_FEE = 100;
    uint internal constant MAX_WITHDRAW_FEE_PERIOD = 72 hours;
