...
contract jointLPHolderUniV2 is Ownable {
    ...
    function _sellRewardTokens(IERC20 rewardToken, uint256 farmAmount) internal {
        ...
        for (uint256 i = 0; i < numTokens; i++){
            ...
            uint256 saleAmount = farmAmount.mul(getDebtProportion()).div(BASIS_PRECISION);
            router.swapExactTokensForTokens(
    ...
    function getDebtProportion() public view returns(uint256) {
