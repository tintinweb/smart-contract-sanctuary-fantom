...
contract Moon is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 80,500 MOON
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 64000 ether;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund1, address _devFund2, address _devFund3, address _devFund4) public ERC20("MOON", "MOON") {
        _mint(msg.sender, 500 ether); // mint 500 MOON for initial pools deployment
