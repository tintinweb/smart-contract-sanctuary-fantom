...
contract Pepetoken is ERC20, Ownable {
    ...
    constructor() ERC20("Pepe", "PEPE", DECIMALS) {

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0xF491e7B69E4244ad4002BC14e878a34207E38c29
        );

        feeReceiver = address(0xd02FE2fE67343d35456f28F941742C4FD1D23798); 
        ...
        uint256 totalSupply = 420690 * 1e9 * 10**DECIMALS;

        maxTransactionAmount = 84138 * 1e8 * 10**DECIMALS;
        maxWallet = 84138 * 1e8 * 10**DECIMALS;
