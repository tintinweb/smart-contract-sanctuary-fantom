...
contract ShareWrapper {
    ...
    function stake(uint256 amount) public virtual {
        ...
        cherry.safeTransferFrom(msg.sender, address(this), amount);
    }
    ...
    function withdraw(uint256 amount) public virtual {
        ...
        cherry.safeTransfer(msg.sender, amount);
    }
}
...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    function initialize(
        ...
        withdrawLockupEpochs = 4; // Lock up 4 epochs (24h) before release withdraw
        rewardLockupEpochs = 2; // Lock up 2 epochs (12h) before release claimReward
    ...
    function setWithdrawFeeBP(uint256 _withdrawFeeBP) public{
        require(msg.sender == feeAddress, "setWithdrawFeeBP: FORBIDDEN");
        require(_withdrawFeeBP > 0, "setWithdrawFeeBP: greater than 0");
        withdrawFeeBP = _withdrawFeeBP;
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            if(withdrawFeeBP > 0) {
                withdrawFee = reward.mul(withdrawFeeBP).div(10000);
                cftm.safeTransfer(feeAddress, withdrawFee);
            }
            userReward = reward.sub(withdrawFee);
            cftm.safeTransfer(msg.sender, userReward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        cftm.safeTransferFrom(msg.sender, address(this), amount);
