...
// File: USDCWFTMLQDR.sol


contract USDCWFTMLQDR is CoreStrategyGeist {
    using SafeERC20 for IERC20;
    ...
    constructor(address _vault)
        ...
        CoreStrategyGeist(
            ...
            CoreStrategyAaveConfig(
                0x04068DA6C83AFCFA0e13ba15A6696662335D5B75, // want -> USDC
                0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83, // short -> WFTM
                0x2b4C76d0dc16BE1C31D4C1DC53bF9B45987Fc75c, // wantShortLP -> USDC/FTM 
                0x10b620b2dbAC4Faa7D7FFD71Da486f5D44cd86f9, // farmToken -> LQDR
                0x4Fe6f19031239F105F753D1DF8A0d24857D0cAA2, // farmTokenLp -> LQDR/FTM
                0x6e2ad6527901c9664f016466b8DA1357a004db0f, // farmMasterChef -> IStakingDualRewards
                11, // farmPid
                0xe578C856933D8e1082740bf7661e379Aa2A30b26, // aToken
