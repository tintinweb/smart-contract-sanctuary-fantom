...
// File contracts/DaiFtmEqualizerV2.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract DaiFtmEqualizerV2  is Ownable, Pausable {
    ...
    function addLiquidity() internal {
        ...
        IEqualizerRouter(router).addLiquidity(wftm, dai, stable, t1Bal, t2Bal, 1, 1, address(this), block.timestamp);
    }
