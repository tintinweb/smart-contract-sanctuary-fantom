...
contract SHIBAPI  is IBEP20, Auth {
    ...
    string constant _name = "ShibaPi";
    string constant _symbol = "SHIBAPI";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x24d567339059C1B464D9ebc14FE1F1E69935b1Da;
        marketingFeeReceiver = 0xa3D98BB39c5bf222b242F1b77a6c8eDEa74cA728;
        teamFeeReceiver = 0x6c9B53187D9B7461708E91AF3A9032d4c8F402D4;
        devFeeReceiver = 0x3ee41d6C70eBFCa3070DcC4C2C3989D683F0EFfc;
        utilityFeeReceiver = 0xFf2119e8ba2C41F410FADD9933dDa0D2E91554b0; 
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountFTMteam = amountFTM.mul(teamFee).div(totalFTMFee);

        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountFTMMarketing, gas: 30000}("");
        (tmpSuccess,) = payable(teamFeeReceiver).call{value: amountFTMteam, gas: 30000}("");
