...
// File: FAMApprentice.sol
contract FAMApprentice is ERC721Enumerable, Ownable {
    using Strings for uint256;

    string public baseURI;
    uint256 public mintCost = 33 ether;
    ...
    uint8 public maxMintPerWallet = 10;
    bool public mintPaused = true;
    bool public secondPhase = false;

    constructor() ERC721("FAM Apprentice", "FAMA") {}
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        // Mint only 1098 NFTs in first phase
        require(
            secondPhase || supply + _mintAmount <= (maxSupply / 2),
            "Second phase not ready yet"
        );
