...
contract TowDoge is ERC20Burnable, Operator {
    ...
    uint256 public constant INITIAL_TOMB_POOL_DISTRIBUTION = 2 ether;
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("2DOGE", "2DOGE") {
