...
contract RIDDLER is RIDDLERDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private RIDDLERTeam;
    address private CharityRIDDLER;
    ...
    string public override name = "Riddler Inu";
    string public override symbol = "RIDDLER";
    ...
    constructor(uint totalSupplyValue, address RIDDLERTeamAddress, address CharityRIDDLERAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        RIDDLERTeam = RIDDLERTeamAddress;
        CharityRIDDLER = CharityRIDDLERAddress;
        
        // split the tokens according to agreed upon percentages
        balances[RIDDLERTeam] =  totalSupply * 4 / 100;
        balances[CharityRIDDLER] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's RIDDLERTeam pot
