...
contract Chelsea is ChelseaDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private ChelseaTeam;
    address private CharityChelsea;
    ...
    string public override name = "Chelsea Fan Token";
    string public override symbol = "Chelsea";
    ...
    constructor(uint totalSupplyValue, address ChelseaTeamAddress, address CharityChelseaAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        ChelseaTeam = ChelseaTeamAddress;
        CharityChelsea = CharityChelseaAddress;
       
        // split the tokens according to agreed upon percentages
        balances[ChelseaTeam] =  totalSupply * 4 / 100;
        balances[CharityChelsea] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's ChelseaTeam pot
