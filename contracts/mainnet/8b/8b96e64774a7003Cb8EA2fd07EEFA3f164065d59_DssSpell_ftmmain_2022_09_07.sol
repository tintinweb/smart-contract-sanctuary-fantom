...
// Copyright (C) 2019 David Terry <[email protected]wvvvvwx.com>
//
// This program is free software: you can redistribute it and/or modify
// it under the terms of the GNU Affero General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
...
contract DssSpellAction_ftmmain_2022_09_07 is DssAction
{
	...
	address constant MULTISIG = 0x934BF5461795B4a2aC5673c1fb3859E8fA48d9bb; // GrowthDeFi multisig on Fantom
	...
	function actions() public override
	{
		...
		DssExecLib.setIlkDebtCeiling("STKSPIFTMLQDR-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKSPIFTMFUSDT-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKSPIFTMWBTC-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKSPIFTMUSDC-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKSPIFTMWETH-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKSPIFTMMIM-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKSPIFTMSPIRIT-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKSPIFTMFRAX-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKSPIFTMMAI-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKSPOFTMBOO-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKSPOFTMUSDC-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKSPOFTMDAI-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKSPOFTMSUSHI-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKSPOFTMLINK-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKSPOFTMWETH-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKSPOFTMFUSDT-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKSPOFTMMIM-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKSPOFTMSCREAM-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKSPOFTMBOOV2-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKXBOO-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("CLQDR-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("SLINSPIRIT-A", 0); // line 0

		uint256 _500PERCENT_YEAR = 1000000056816321668209211589; // duty 500% per year
		DssExecLib.setIlkStabilityFee("STKSPIFTMLQDR-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKSPIFTMFUSDT-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKSPIFTMWBTC-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKSPIFTMUSDC-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKSPIFTMWETH-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKSPIFTMMIM-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKSPIFTMSPIRIT-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKSPIFTMFRAX-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKSPIFTMMAI-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKSPOFTMBOO-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKSPOFTMUSDC-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKSPOFTMDAI-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKSPOFTMSUSHI-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKSPOFTMLINK-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKSPOFTMWETH-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKSPOFTMFUSDT-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKSPOFTMMIM-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKSPOFTMSCREAM-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKSPOFTMBOOV2-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKXBOO-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("CLQDR-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("SLINSPIRIT-A", _500PERCENT_YEAR, true);

		DssExecLib.setIlkDebtCeiling("PSM-STKUSDLP-A", 250000); // line 250k

		address MCD_JOIN_DAI = DssExecLib.daiJoin();
		DssExecLib.delegateVat(MCD_JOIN_DAI);
		DssExecLib.sendPaymentFromSurplusBuffer(MULTISIG, 68854); // 68,854 MOR
		DssExecLib.undelegateVat(MCD_JOIN_DAI);
	}
}

// valid for 30 days
contract DssSpell_ftmmain_2022_09_07 is DssExec(block.timestamp + 30 days, address(new DssSpellAction_ftmmain_2022_09_07()))
{
}