...
contract Xcash is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 100,000 XCASH
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund1, address _devFund2) public ERC20("Cashium Shares", "XCASH") {
        _mint(msg.sender, 1 ether); // mint 1 XCASH for initial pools deployment
