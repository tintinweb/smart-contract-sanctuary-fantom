...
contract BeetXStrategy is BaseUpgradeableStrategy {
    ...
    address public constant POD_DELEGATE = 0xb1eAfc8C60f68646F4EFbd3806875fE468933749;
    ...
    public initializer {
        ...
        SNAPSHOT_DELEGATION.setDelegate("beets.eth", POD_DELEGATE);
    }
    ...
    */
    ...
    function _getRatio() internal view returns (uint256 ratio) {
        ratio = (IERC20(underlying()).balanceOf(fbeets()) * 1e18) / IBeetsBar(fbeets()).totalSupply();
    }
