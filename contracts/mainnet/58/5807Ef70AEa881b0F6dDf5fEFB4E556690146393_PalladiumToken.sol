...
contract PalladiumToken is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Palladium';
    string private constant _symbol = 'PALD';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x05628EDA4beFabfCc4C9f10A423bF7cF6Fe561Fe, 'We can not exclude router.');
