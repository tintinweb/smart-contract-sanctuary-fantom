...
contract TombFTMLevSwapper {
    ...
    // }
    function _calculateSwapInAmount(uint256 reserveIn, uint256 userIn) internal pure returns (uint256) {
        return (Babylonian.sqrt(reserveIn * ((userIn * 3980025) + (reserveIn * 3980000))) - (reserveIn * 1995)) / 1990;
    }
    ...
    function swap(
        ...
        uint256 tombAmount = _getAmountOut(wftmSwapInAmount, reserve0, reserve1);
