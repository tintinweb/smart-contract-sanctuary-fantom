...
contract StrategyOxdVolatileTarotXtarotLp is StrategyOxdFarmLPBase {
    // Token addresses
    address public tarot_xtarot_lp = 0x4FE782133af0f7604B9B89Bf95893ADDE265FEFD;
    ...
    {
        swapRoutes[tarot].push(route(wftm, tarot, false));
        swapRoutes[xtarot].push(route(wftm, tarot, false));
        swapRoutes[xtarot].push(route(tarot, xtarot, false));
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategyOxdVolatileTarotXtarotLp";
    }
}
