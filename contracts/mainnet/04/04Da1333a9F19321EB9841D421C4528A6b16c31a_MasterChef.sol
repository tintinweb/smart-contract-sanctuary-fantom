...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    // The FARM TOKEN!
    FarmToken immutable public farmToken;
    ...
    constructor(
        ...
        require(_startBlock > block.number, "Start block must be a future block."); 
        farmToken = _token;
    ...
    function add(uint256 _allocPoint, IERC20 _lpToken, uint16 _depositFeeBP, bool _withUpdate) external onlyOwner nonDuplicated(_lpToken) {
        ...
        // sanity check in case of non-ERC20 
    ...
    function setEmissionRate(uint256 _emissionRate , bool _withUpdate) external onlyOwner {
