...
/**
 * @title The first Avatars of LoFiTown
 *
 * @dev Avatar will be citizen and special key to walking  on metaverse world
 */
...
contract AlphaLofiAvatar is ERC721Metadata {
   
    using Strings for uint256;

    mapping(address => bool) public _minters;

    event AvatarMinted( address to, uint256 plotid );
    event AvatarBurn( uint256 plotid );

    constructor() ERC721("AlphaLofiAvatar", "ALFA") {
