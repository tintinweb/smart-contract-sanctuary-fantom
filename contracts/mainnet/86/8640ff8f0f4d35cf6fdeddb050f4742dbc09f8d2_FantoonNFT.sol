...
contract FantoonNFT is ERC721Enumerable, Ownable{
    ...
    uint256 private reservePrice = 0.02 ether;
    uint256 private reservedPeriod = 10 minutes; //24 hours;                 // 24 hours
    uint256 private mintReservedTokenPeriod = 10 minutes; //24 hours;        // 24 hours
