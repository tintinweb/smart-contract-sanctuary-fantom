...
contract GovEcho is ERC20 {
    ERC20 public token;


    constructor() ERC20("Farmgod DAO Governance", "govECHO") {
        token = ERC20(0x54477A1D1bb8C1139eEF754Fd2eFd4DDeE7933dd);
    }
     ...
     */
    function mintGovEcho(uint256 _amount) public {
        require(_amount >= 6942 * 10 ** 9, "minimum burn is 6942 ECHO");
        require(_amount <= 69420 * 10 ** 9, "max burn is 69420 ECHO");

        token.transferFrom(
            msg.sender,
            address(0x000000000000000000000000000000000000dEaD), // kill the ECHO
            _amount
        );
        _mint(msg.sender, _amount / 6942); // 69,420 ECHO burned mints 10 govECHO
    }
