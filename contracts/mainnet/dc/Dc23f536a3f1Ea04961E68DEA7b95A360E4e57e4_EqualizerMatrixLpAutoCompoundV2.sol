...
/// @title Equalizer Matrix Lp AutoCompound Strategy
contract EqualizerMatrixLpAutoCompoundV2 is MatrixLpAutoCompoundV2 {
    using SafeERC20 for IERC20;
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    function _deposit() internal virtual override {
        uint256 _wantBalance = IERC20(want).balanceOf(address(this));
        _harvest();
        if (_wantBalance > 0) IGauge(masterchef).deposit(_wantBalance);
    }
