...
contract SpaceLegends is ERC721Enumerable, Ownable, ERC2981 {
  ...
  address[] private team = [
    0x962A2880Eb188AB4C2Cfe9874247fCC60a243d13, //5%
    0x11584D6AaeBFdbF48Cd5A11599BF40b5bC386837, //5%
    0x3bb94651bFaaD1618Ed8CDaa4742BaabA24e739A, //35%
    0x0805634aA63B3152b8B1809D18B883f7c9059f92  //55%
  ];
  ...
  function withdraw(address token) external onlyOwner {
    ...
    if(token == address(0)) {
      ...
      IERC20(token).transfer(team[2], amount * 35 / 100);
      IERC20(token).transfer(team[3], amount * 55 / 100);
    }
  }
}
