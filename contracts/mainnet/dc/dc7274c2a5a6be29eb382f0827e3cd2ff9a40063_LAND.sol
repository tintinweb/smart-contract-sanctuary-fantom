...
contract LAND is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 55,000 LAND
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 55_000 ether;
    ...
    constructor(
        ...
        address _devFund
    ) public ERC20("LAND", "LAND") {
        _mint(msg.sender, 1 ether); // mint 1 LAND Share for initial pools deployment
