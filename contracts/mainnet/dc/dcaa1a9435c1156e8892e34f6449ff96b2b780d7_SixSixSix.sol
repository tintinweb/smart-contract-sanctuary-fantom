...
// File contracts/SixSixSix/SixSixSixCERUSOFTV2.sol
...
contract SixSixSix is OFTV2Burnable {
    uint private constant _initialSupply = 0 ether;
    uint8 private constant _sharedDecimals = 6;
    address private constant _layerZeroEndpoint = 0xb6319cC6c8c27A8F5dAF0dD3DF91EA35C4720dd7; // Fantom endpoint.

    constructor() OFTV2Burnable("...", "...", _sharedDecimals, _layerZeroEndpoint) {
