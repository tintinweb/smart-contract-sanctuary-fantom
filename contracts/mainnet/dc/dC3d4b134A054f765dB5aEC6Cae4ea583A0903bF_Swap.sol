...
contract Swap is Operator{
    ...
    constructor(address _router, address _wftm, address _usdc) public {
        router = _router;
        wftm = _wftm;
        usdc = _usdc;
    }

    function _swap(address inputToken, address outputToken, uint256 inputAmount, uint256 outPutAmountMin) public returns (uint256) {
