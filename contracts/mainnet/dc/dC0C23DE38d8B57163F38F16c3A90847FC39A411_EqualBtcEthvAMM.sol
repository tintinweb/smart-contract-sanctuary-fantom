...
// File: contracts/EqualBtcEthvAMM.sol
...
contract EqualBtcEthvAMM is Ownable, Pausable {
    ...
    function addLiquidity() internal {
        ...
        IEqualizerRouter(unirouter).swapExactTokensForTokens(wrappedHalf, 0, wrappedToBtcPath, address(this), block.timestamp);
        
        uint256 lp0Bal = IERC20(eth).balanceOf(address(this));
        uint256 lp1Bal = IERC20(btc).balanceOf(address(this));

        IEqualizerRouter(unirouter).addLiquidity(eth, btc, stable, lp0Bal, lp1Bal, 1, 1, address(this), block.timestamp);
    }
