...
contract Atlantica is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Atlantica Market';
    string private constant _symbol = 'Atlantica';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x311757B51cf90Ce5b774227951a19124516580EA, 'We can not exclude router.');
