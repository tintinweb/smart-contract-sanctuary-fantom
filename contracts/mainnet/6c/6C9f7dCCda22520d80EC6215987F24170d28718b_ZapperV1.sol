...
contract ZapperV1 is Ownable, IZapper {
    ...
    function zapInToken(address _in, uint256 amount, address out, address routerAddr, address recipient, uint256 minAmountLp) external whitelist(routerAddr) onlyOperator {
    ...
    function nativeZapIn(uint256 amount, address out, address routerAddr, address recipient, uint256 minAmountLp) external payable whitelist (routerAddr) onlyOperator {
    ...
    function zapOutToNative(address _in, uint256 amount, address routerAddr, address recipient, uint256 minAmountNative) external whitelist(routerAddr) onlyOperator {
        // take the LP token
        IERC20(_in).safeTransferFrom(msg.sender, address(this), amount);
        _approveTokenIfNeeded(_in, routerAddr);
    ...
    function zapOutToToken(address _in, uint256 amount, address out, address routerAddr, address recipient, uint256 minAmountToken) external whitelist(routerAddr) onlyOperator  {
    ...
    // @out - token we want to get
    function swapToken(address _in, uint256 amount, address out, address routerAddr, address _recipient, uint256 minAmount) external whitelist(routerAddr) onlyOperator {
        IERC20(_in).safeTransferFrom(msg.sender, address(this), amount);
        _approveTokenIfNeeded(_in, routerAddr);
    ...
    function swapToNative(address _in, uint256 amount, address routerAddr, address _recipient, uint256 minAmountNative ) external whitelist(routerAddr) onlyOperator {
        IERC20(_in).safeTransferFrom(msg.sender, address(this), amount);
        _approveTokenIfNeeded(_in, routerAddr);
    ...
    function _swap(address _in, uint256 amount, address out, address recipient, address routerAddr) public whitelist (routerAddr) onlyOperator returns (uint256) {
        IUniswapV2Router router = IUniswapV2Router(routerAddr);
    ...
    // @amount - amount of our _in
    // @out - token we want to get out
    function _estimateSwap(address _in, uint256 amount, address out, address routerAddr) public view whitelist (routerAddr) onlyOperator returns (uint256) {
        IUniswapV2Router router = IUniswapV2Router(routerAddr);
