 ...
 */
contract EarlySupportersRewarder is Ownable {
    ...
    uint256 public BLURPrice = 300;  // started price for BLUR Token 0.0003 USDC (10^6 decimals)
    bool public rewardDonation = true;
    /**
    ...
    receive() external payable {
        ...
        if (rewardDonation && contractBalance > 0){
    ...
    function setRewardDonation(bool _rewardDonation) public onlyOwner {
        rewardDonation = _rewardDonation;
    }
