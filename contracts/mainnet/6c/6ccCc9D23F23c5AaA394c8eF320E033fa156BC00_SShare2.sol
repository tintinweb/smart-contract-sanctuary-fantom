...
contract SShare2 is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 sshare2s
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("SSHARE2", "SSHARE2") {
        _mint(msg.sender, 1 ether); // mint 1 SCAR2 Share for initial pools deployment
