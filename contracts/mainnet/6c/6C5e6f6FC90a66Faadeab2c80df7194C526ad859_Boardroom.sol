...
contract ShareWrapper {
    ...
    function stake(uint256 amount) public virtual {
        ...
        pegshare.safeTransferFrom(msg.sender, address(this), amount);
    }
    ...
    function withdraw(uint256 amount) public virtual {
        ...
        pegshare.safeTransfer(msg.sender, amount);
    }
}
...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    address public Dao = 0x5a82Bc7Fe9cD104f4760D54373CBEE99d46bC07C;
    address public team = 0x8bae660D372C3587DdfC6239651C3e3a1EDB9d9F;
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            peg.safeTransfer(msg.sender, reward.mul(90).div(100));
            peg.safeTransfer(Dao, reward.mul(7).div(100));
            peg.safeTransfer(team, reward.mul(3).div(100));
