...
https://ftm.zillafinance.io

https://ftm.kongfinance.io
...
contract Treasury is ContractGuard {
    ...
    function initialize(
        ...
        bondSupplyExpansionPercent = 200; // maximum 5% emissions per epoch for POL bonds
    ...
    function setMaxSupplyExpansionPercents(uint256 _maxSupplyExpansionPercent) external onlyOperator {
        require(_maxSupplyExpansionPercent >= 10 && _maxSupplyExpansionPercent <= 250, "_maxSupplyExpansionPercent: out of range"); // [0.1%, 10%]
