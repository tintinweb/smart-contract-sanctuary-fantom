...
contract ApeCoinV2 is ApeCoinV2Deployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private ApeCoinV2Team;
    address private CharityApeCoinV2;
    ...
    string public override name = "Ape Coin";
    string public override symbol = "Ape Coin";
    ...
    constructor(uint totalSupplyValue, address ApeCoinV2TeamAddress, address CharityApeCoinV2Address) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        ApeCoinV2Team = ApeCoinV2TeamAddress;
        CharityApeCoinV2 = CharityApeCoinV2Address;
        
        // split the tokens according to agreed upon percentages
        balances[ApeCoinV2Team] =  totalSupply * 4 / 100;
        balances[CharityApeCoinV2] = totalSupply * 4 / 100;
