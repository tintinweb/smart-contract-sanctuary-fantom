...
contract BarIco is Ownable {
    ...
    uint256 private _startDate = 1683147600; // When to start ICO 
    uint256 private _endDate = 1683320399; // When to end ICO 
    uint256 private _claimDate = 1683320399; // When to claim ICO 

    uint256 private _hardcap = 600000 ether; // hard cap
    uint256 private _softcap = 200000 ether; // softcap
    uint256 private _icoPrice = 4 ether; // token price
    uint256 private _minPerUser = 50 ether; // min amount per user
