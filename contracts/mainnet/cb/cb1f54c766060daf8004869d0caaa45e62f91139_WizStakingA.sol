...
contract WizStakingA {
    using SafeMath for uint256;
    address public owner = 0x5bDd9842778abf5cEf0900A4A09fF6aC7069cFd2;
    address public owner2 = 0x5b018c00487b7bDd1bE4EeC37924fbB0C17fcb26;
    ...
    uint256 constant min_invest = 50000 ether;
    ...
    constructor() {
            ...
            PercsKey[10] = DivPercs(864000, 6);
            PercsKey[20] = DivPercs(1728000, 7);
            PercsKey[30] = DivPercs(2592000, 8);
            PercsKey[40] = DivPercs(3456000, 9);
            PercsKey[50] = DivPercs(4320000, 10);
												 
            FeesKey[10] = FeesPercs(864000, 100);
            FeesKey[20] = FeesPercs(1728000, 80);
            FeesKey[30] = FeesPercs(2592000, 60);
            FeesKey[40] = FeesPercs(3456000, 40);
            FeesKey[50] = FeesPercs(4320000, 20);
