...
contract KoalaTokenV2 is ERC20("KoalaToken", "KOA"), Ownable {
  ...
  constructor(uint256 _startReleaseBlock) public {
    ...
    endReleaseBlock = _startReleaseBlock + 1;
  }
  ...
  function resetReleaseBlock(uint256 _startReleaseBlock, uint256 _endReleaseBlock) public onlyOwner {
