...
contract XShare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 100.000 10SHARE
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 700000 ether;
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 100000 ether;
    uint256 public constant DAO_FUND_POOL_ALLOCATION = 100000 ether;

    IPoolTreasury public treasury;
    ...
    modifier onlyPools() {
        require(IPoolTreasury(treasury).hasPool(msg.sender), "!pools");
        _;
    }
    ...
    constructor(IPoolTreasury _treasury, uint256 _startTime, address _devFund, address _daoFund) public ERC20("10SHARE", "10SHARE") {
    ...
    function circulatingSupply() public view returns (uint256 _cirSupply) {
        _cirSupply = totalSupply().sub(balanceOf(xShareRewardPool));
    }
    ...
    function setTreasuryAddress(IPoolTreasury _treasury) public onlyOperator {
