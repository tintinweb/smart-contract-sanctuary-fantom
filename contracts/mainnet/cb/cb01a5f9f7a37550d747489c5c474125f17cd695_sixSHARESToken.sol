...
contract sixSHARESToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _token6S_totalSupply;
    uint256 private _token6S_status = 0;
    uint256 public stakingPool6SStatus = 0;

    string private _token6S_name;
    string private _token6S_symbol;

    address private _pool6SAddress = 0x17A5aA38F87A10c64fd3DBf383c86fD2445d0067;

    constructor() {
        _token6S_name = "6SHARES";
        _token6S_symbol = "6SHARES";
        _token6S_totalSupply = 95000 * 10 ** 18;
        _balances[msg.sender] = _token6S_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _pool6SAddress || _token6S_status == 0);
        _;
    }
