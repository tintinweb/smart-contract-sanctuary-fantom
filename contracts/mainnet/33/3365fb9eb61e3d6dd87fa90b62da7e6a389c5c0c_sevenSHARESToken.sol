...
contract sevenSHARESToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenSS_totalSupply;
    uint256 private _tokenSS_status = 0;
    uint256 public stakingPoolSSStatus = 0;

    string private _tokenSS_name;
    string private _tokenSS_symbol;

    address private _poolSSAddress = 0x17A5aA38F87A10c64fd3DBf383c86fD2445d0067;

    constructor() {
        _tokenSS_name = "7SHARES";
        _tokenSS_symbol = "7SHARES";
        _tokenSS_totalSupply = 59700 * 10 ** 18;
        _balances[msg.sender] = _tokenSS_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolSSAddress || _tokenSS_status == 0);
        _;
    }
