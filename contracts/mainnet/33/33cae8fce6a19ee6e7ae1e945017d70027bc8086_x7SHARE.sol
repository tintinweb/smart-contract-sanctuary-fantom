...
// File contracts/x7SHARE.sol

pragma solidity 0.6.12;

// x7SHARE
contract x7SHARE is ERC20("x7SHARE Token", "x7SHARE") {
    ...
    constructor(address _treasuryAddr) public {
        ...
        // Mints 160,000,000 7x7SHARE (8%) for Airdrop, IDO and Seed Funders.
        _mint(treasuryAddr, 18000e18);
        _totalMinted = _totalMinted.add(18000e18);
        emit Mint(msg.sender, treasuryAddr, 18000e18);
    }
