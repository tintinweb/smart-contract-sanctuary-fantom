...
// SPDX-License-Identifier: MIT 
 ...
 /*  FTMstake - investment platform based on Polygon network (AVAX) blockchain smart-contract technology. Safe and legit!
 *   The only official platform of original BNBStake team! All other platforms with the same contract code are FAKE!
 *
 * 
 *
 *     ___  _____           _        _        
 *    / __\/__   \/\/\  ___| |_ __ _| | _____ 
 *   / _\    / /\/    \/ __| __/ _` | |/ / _ \            FTMstake & AVAXstake & MATICstake & BNBstake
 *  / /     / / / /\/\ \__ \ || (_| |   <  __/                © 2022 by AV. All rights reserved.
 *  \/      \/  \/    \/___/\__\__,_|_|\_\___|
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://ftmstake.app                                       │
 *   │                                                                       │
 *   │   Telegram Public Group: https://t.me/ftmstake_en                     |
 *   |                                                                       |
 *   └───────────────────────────────────────────────────────────────────────┘
 *
 *   [USAGE INSTRUCTION]
 *
 *   1) Connect browser extension Metamask (see help: https://docs.fantom.foundation/tutorials/set-up-metamask )
 *   2) Choose one of the tariff plans, enter the FTM amount (10 FTM minimum) using our website "Stake FTM" button
 ...
 *   [AFFILIATE PROGRAM]
 *
 *   - 3-level referral commission: 5% (or 10%) - 2.5% - 0.5%
 *   - extra bonus 5% from 1 level for huge promoters
 *
 *   [FUNDS DISTRIBUTION]
 *
 *   - 82% Platform main balance, participants payouts
 *   - 8% Advertising and promotion expenses
 *   - 8-13% Affiliate program bonuses
...
contract FTMstake {
	...
	constructor(address payable wallet) public {
		...
		startUNIX = 1648224000; // Fri Mar 25 2022 16:00:00 GMT+0000
	...
	function invest(address referrer, uint8 plan) public payable {
		...
		require(msg.value >= INVEST_MIN_AMOUNT, "the min amount is 10 FTM");
	...
	function addExtraBonus(address userAddr) external{
		...
		require(extraBonuses[userAddr] != true );
	...
	function removeExtraBonus(address userAddr) external{
		require(commissionWallet == msg.sender, "only owner");
		require(extraBonuses[userAddr] != false );
...
/* © 2022 by FTMstake. All rights reserved. */