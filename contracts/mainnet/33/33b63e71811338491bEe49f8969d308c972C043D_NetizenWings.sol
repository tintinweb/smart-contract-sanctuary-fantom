...
contract NetizenWings is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, IERC2981, ERC165Storage {
    ...
    constructor(address _main) ERC721("Netizen Wings", "WINGS") {
        royaltyFee = 75;
        royaltyAddress = _main;
        baseURI = "https://ipfs.io/ipfs/QmbPNmzzJBgJ8bAohu55ZBZRqkrzpQELh4YSN8SmUtXtTH/";
    ...
    function ownerMintToHolders(uint amount, IERC721 token) public onlyOwner {
        uint nextTokenCounter = totalSupply() + amount;
        while (totalSupply() < nextTokenCounter) {
            _mint(token.ownerOf(totalSupply()), totalSupply());
        }
    }
