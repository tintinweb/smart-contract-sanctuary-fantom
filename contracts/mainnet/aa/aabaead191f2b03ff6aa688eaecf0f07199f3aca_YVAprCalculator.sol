...
contract YVAprCalculator{
    ...
    address public masterchef = 0x668675832FdD9601E8804c694B0E2073B676cEfF;
    ...
    function yvTokenPrice(address _token) public view returns(uint){
        bool isRen = _token == address(0xDBf31dF14B66535aF65AaC99C32e9eA844e14501);
        uint pps = isRen ? 1e18 : yvPpsStandarized(_token);
        address underlying = isRen ? address(0xDBf31dF14B66535aF65AaC99C32e9eA844e14501) : YvVault(_token).token();
