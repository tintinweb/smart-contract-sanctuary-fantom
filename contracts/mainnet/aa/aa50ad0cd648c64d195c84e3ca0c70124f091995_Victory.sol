...
contract Victory is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 100,000 VICTORY
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund1, address _devFund2, address _devFund3, address _devFund4) public ERC20("VICTORY", "VICTORY") {
        _mint(msg.sender, 500 ether); // mint 500 VICTORY for initial pools deployment
