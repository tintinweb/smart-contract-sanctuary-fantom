...
contract FantomHouseTomb is VRFConsumerBaseV2, Ownable, ReentrancyGuard {
    ...
    address private constant TOMB_ADDRESS = 0x6c021Ae822BEa943b2E66552bDe1D2696a53fbB7;
    IERC20 private tomb = IERC20(TOMB_ADDRESS);
    ...
    function depositHouse(uint256 _amount, address _referral) external {
        ...
        tomb.safeTransferFrom(_sender, address(this), _amount);
    }
    ...
    function withdrawHouse(uint256 _amount) external nonReentrant {
        ...
        tomb.safeTransfer(msg.sender, _amount);
    }
    ...
    function bet(uint256 _betAmount, uint256 _faceSide, address _referral) external nonReentrant {
        ...
        tomb.safeTransferFrom(_sender, address(this), _betAmount);
    ...
    function returnDepositAndRemoveDepositor(uint256 _length, bool _shouldRemoveDepositor) internal {
        for (uint i = 0; i < _length; i++) {
            ...
            tomb.safeTransfer(_depositor, _depositAmount);
