...
contract PopPussiesPopPop is ERC721Enumerable, Ownable, ERC2981 {
  using Strings for uint256;
  ...
  uint256 public costFTM = 40 ether;
  ...
  function mintGiveaways() public onlyOwner {
    ...
    for(uint256 i = 1; i < 11; i++) {
      ...
      _safeMint(giveawayAddr, _pickRandomUniqueId(_random) + 1);
      supply++;
    }
  }
