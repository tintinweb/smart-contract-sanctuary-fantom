...
// 0xaac31bd45f9a920ccf8e3a8bee4aff018c1752d9
...
contract AnyswapTokenAnycallClient is AnycallClientBase {
    ...
    function swapout(
        ...
        uint256 oldEthBalance;
        if (msg.value > 0) {
            oldEthBalance = address(this).balance - msg.value;
        }
        ...
        if (msg.value > 0) {
            ...
            if (newEthBalance > oldEthBalance) {
                // return remaining fees
                (bool success,) = msg.sender.call{value: newEthBalance - oldEthBalance}("");
                require(success);
            }
        }
