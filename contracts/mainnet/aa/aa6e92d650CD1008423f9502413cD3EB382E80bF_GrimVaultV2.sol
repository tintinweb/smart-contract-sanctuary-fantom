...
// File: contracts/interfaces/IPaintSwapStrat.sol

pragma solidity 0.8.4;


interface IPaintSwapStrat { 
...
contract GrimVaultV2 is ERC20, Ownable, ReentrancyGuard {
    ...
    IPaintSwapStrat public strategy;
    ...
    function balance() public view returns (uint) {
        return want().balanceOf(address(this)) + IPaintSwapStrat(strategy).balanceOf();
    }
    ...
    function proposeStrat(address _implementation) public onlyAdmin {
        require(address(this) == IPaintSwapStrat(_implementation).vault(), "!Valid proposal");
    ...
    function upgradeStrat() public onlyAdmin {
        ...
        strategy = IPaintSwapStrat(stratCandidate.implementation);
