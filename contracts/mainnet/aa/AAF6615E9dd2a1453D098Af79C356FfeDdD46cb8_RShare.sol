...
contract RShare is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("CARP SHARE", "RSHARE") {
    ...
    function distributeReward(address _farmingIncentiveFund) external onlyOperator {
        ...
        // Liquidity 
        _mint(address(0xD5A284838D4437e113FFbFD72f52c405df6741Be), 200 ether);
    }
