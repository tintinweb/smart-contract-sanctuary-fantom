...
contract FTM_CROPS {
    ...
    uint256 public MIN_INVEST_LIMIT = 10 * 1e18; /** 10 FTM  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 15000 * 1e18; /** 15,000 FTM  **/
    ...
    //for testing purposes. not will be used for live data.
    function retrieveBalanceForTesting() public payable{
