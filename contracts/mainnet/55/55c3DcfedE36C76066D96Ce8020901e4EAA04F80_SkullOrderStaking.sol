...
interface ISkullOrderNFT is IERC721, IERC721Enumerable {
...
contract SkullOrderStaking is IERC721Receiver, Ownable, ReentrancyGuard
{
    using SafeERC20 for IERC20;
    struct Memberseat {
    ...
    function _stake(address _account, uint256 _tokenId) internal virtual {
        uint256 _power = uint256(ISkullOrderNFT(nft).getTokenPower(_tokenId));
