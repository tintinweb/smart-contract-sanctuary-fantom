  ...
  Pausable
{
  ...
  function mintCost(uint256 tokenId) public view returns (uint256) {
    ...
    if (tokenId <= PAID_TOKENS + 5000) return 85 ether;
    if (tokenId <= PAID_TOKENS + 10000) return 127 ether;
    if (tokenId <= PAID_TOKENS + 15000) return 170 ether;
    if (tokenId <= PAID_TOKENS + 20000) return 212 ether;
    return 255 ether;
  }
