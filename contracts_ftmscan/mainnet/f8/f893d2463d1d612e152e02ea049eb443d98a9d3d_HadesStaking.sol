...
contract HadesStaking is Ownable {
    ...
    /**
        @notice stake HADE to enter warmup
        @param _amount uint
        @return bool
     */
    ...
    /**
        @notice retrieve sHADE from warmup
    ...
    /**
        @notice forfeit sHADE in warmup and retrieve HADE
     */
    ...
    /**
        @notice returns the sHADE index, which tracks rebase growth
        @return uint
     */
    ...
    /**
        @notice returns contract HADE holdings, including bonuses provided
        @return uint
     */
