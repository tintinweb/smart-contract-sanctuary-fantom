...
contract sTada is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked TaDa", "sTADA", 9) ERC20Permit() {
    ...
    /**
        @notice increases sTADA supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sTADA
