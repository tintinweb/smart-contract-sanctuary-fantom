...
contract SexPartners is Ownable {
    ...
    // timestamp after which new SEX partners receive
    // a reduced amount of SEX in perpetuity
    ...
    function onERC721Received(
        ...
        if (tokenID == 0) {
            ...
            tokenID = _tokenID;
            earlyPartnerDeadline = solidMinter.active_period() + 86400 * 7;
            ...
            require(u.weight == 0, "Already an early partner");
