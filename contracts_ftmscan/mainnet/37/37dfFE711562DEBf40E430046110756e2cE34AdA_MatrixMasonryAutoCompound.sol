...
contract MatrixMasonryAutoCompound is Ownable, Pausable {
    ...
    uint256 public withdrawEpoch = 7200; // 2 hours
    uint256 public epoch = 129600; // 36 hours

    // Tokens used
    address public want = address(0x4cdF39285D7Ca8eB3f090fDA0C069ba5F4145B37); // tshare
    address public output = address(0x6c021Ae822BEa943b2E66552bDe1D2696a53fbB7); // tomb
    ...
    constructor(
        ...
        // constructing external contracts
    ...
    // Swap tomb to tshare before staking it in the masonry
    ...
    function _giveAllowances() internal {
        ...
        IERC20(want).safeApprove(masonry, uint256(-1));
    }
    ...
    function _removeAllowances() internal {
        ...
        IERC20(want).safeApprove(masonry, 0);
    }
