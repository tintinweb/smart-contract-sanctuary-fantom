...
// Stealth Launched  info : hold Giraffetokenprinter and earn Giraffetoken rewards are 6% Giraffetoken rewards for holding every hour 2.5 max wallet 2.5 max trx
// 570ftm$ Initial Liquidity 
// https://t.me/Giraffetokenprinter
...
contract Giraffetokenprinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xE7a7216C50A65d53C0E81E212cDf8C6870C4a6A6; // Giraffe
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Giraffetokenprinter";
    string constant _symbol = "Giraffep";
