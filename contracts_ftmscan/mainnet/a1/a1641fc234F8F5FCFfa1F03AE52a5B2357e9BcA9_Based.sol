...
contract Based is ERC20Burnable, Operator {
    ...
    uint256 public constant INITIAL_GENESIS_POOL_DISTRIBUTION = 11400 ether;  // total of based we pay to users during genesis
    ...
    uint256 public constant INITIAL_BASED_POOL_DISTRIBUTION = 20600 ether; // native lp pool that pays in based to users
