...
contract BABYBOO is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x52767203D7367774F07e51f315e11F4b5100af49;
    ...
    constructor() public ERC20("BABYBOOV2", "BABYBOO") {
...
contract BABYCAKEDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("BABYBOOV2_Dividen_Tracker", "BABYBOOV2_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 200000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "BABYBOOV2_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "BABYBOOV2_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BABYCAKE contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "BABYBOOV2_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "BABYBOOV2_Dividend_Tracker: Cannot update claimWait to same value");
