...
interface IMasterchef {
	...
	struct PoolInfo {
        ...
        IERC20 stubToken;               // STUB / Receipt Token for farmers.
...
contract Granary
{
	...
	*/
	...
	address public utvl;
    address public tvl_lpbtu;
    address public tvl_u;
	/*
	uint8 public pid;
	...
	*/
	...
	function info() public view returns (uint256, uint256, uint256, IMasterchef.UserInfo memory, IMasterchef.PoolInfo memory, uint256, uint256)
	{
		...
		return(
			...
			mc.totalAllocPoint(),
			mc.pendingDefy(allnums[0],address(this))
		);
	}
	...
	function tvl() public view returns(uint256)
	{
		...
		uint256 aum = mc.userInfo(allnums[0],address(this)).amount + IERC20(want).balanceOf(address(this));
		return (
			(tc.p_lpt_tt_coin_usd(//bt, lp_tt, lp_bt_u, u
