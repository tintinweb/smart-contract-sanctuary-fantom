...
// File: contracts/YellowHearts.sol
...
contract YellowHearts is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, IERC2981 {
    ...
    function setWhitelistSaleStart(uint256 whitelistSaleStart) public onlyOwner {
        _whitelistSaleStart = whitelistSaleStart;
    }

    function setWhitelistSaleEnd(uint256 whitelistSaleEnd) public onlyOwner {
        _whitelistSaleEnd = whitelistSaleEnd;
    }

    function setPublicSaleStart(uint256 publicSaleStart) public onlyOwner {
