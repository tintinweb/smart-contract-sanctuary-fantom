...
contract HappyChocoFTM is ERC20, Ownable, SafeToken {
    ...
    constructor() ERC20("HappyChocoFTM", "CHOCO") {
        liquidityFee = 3;
        charityFee = 4;
        charityWallet = payable(0xFAA54c3433662FFF8e1CbFA1F6f9bc520f1b4F3f);
