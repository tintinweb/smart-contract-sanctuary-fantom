...
interface IMasterChefv2 {
    function harvestLPs(uint256 pid, address to) external;
    function withdrawLPs(uint256 pid, uint256 amount, address to) external;
    function depositLPs(uint256 pid, uint256 amount, address to) external;
 ...
 */
contract ScarabAutoCompoundLiquidv2_Spirit is Ownable, Pausable {
    ...
    address public rewardToken0 = address(0x749F2B95f950c4f175E17aa80aa029CC69a30f09); //LQDR
    ...
    address public masterChef = 0x7F53f9D4f09a2E2bCeACb3e2F1bC15ad942A430c;
    uint8 public poolId;
    ...
    function deposit() public whenNotPaused onActionHarvest{
        ...
        if (pairBal > 0) {
            IMasterChefv2(masterChef).depositLPs(poolId, pairBal, address(this));
        }
    }
    ...
    require(msg.sender == vault, "!vault");
      ...
      if (pairBal < _amount) {
        IMasterChefv2(masterChef).withdrawLPs(poolId, _amount.sub(pairBal), address(this));
    ...
    function harvest() public whenNotPaused {
        ...
        IMasterChefv2(masterChef).harvestLPs(poolId, address(this));
