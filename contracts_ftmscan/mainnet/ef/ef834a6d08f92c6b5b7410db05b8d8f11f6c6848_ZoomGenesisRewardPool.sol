...
// File contracts/distribution/ZoomGenesisRewardPool.sol

pragma solidity 0.6.12;

// Note that this pool has no minter key of ZOOM (rewards).
// Instead, the governance will call ZOOM distributeReward method and send reward to this pool at the beginning.
contract ZoomGenesisRewardPool {
    using SafeMath for uint256;
    ...
    modifier onlyOperator() {
        require(
            operator == msg.sender,
            "ZoomGenesisPool: caller is not the operator"
        );
        _;
    }
