...
// Instead, the governance will call sPLAT distributeReward method and send reward to this pool at the beginning.
contract SPlatRewardPool {
    using SafeMath for uint256;
    ...
    // Safe splat transfer function, just in case if rounding error causes pool to not have enough sPLATs.
