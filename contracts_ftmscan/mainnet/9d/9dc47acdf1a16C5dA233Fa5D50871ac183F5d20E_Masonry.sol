...
contract Masonry is StratManager {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    // Tokens used
    address public wrapped = address(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83);
    address public tomb = address(0x7a6e4E3CC2ac9924605DCa4bA31d1831c84b44aE);
    address public tshare = address(0xc54A1684fD1bef1f077a336E6be4Bd9a3096a6Ca);
    ...
    // uint256 epoch = 43200; // 12 hours
    uint256 withdrawEpoch = 120; // 2 hours
    uint256 epoch = 300; // 12 hours
