...
contract ThreeSOME is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 200000000 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'ThreeSOME';
    string private constant _symbol = 'SOME';

    uint256 private _taxFee = 500;
    uint256 private _burnFee = 0;
    uint public max_tx_size = 200000000 ether;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x70deC95E19d53916709113888D6A574F7A4F04A6, 'We can not exclude router.');
