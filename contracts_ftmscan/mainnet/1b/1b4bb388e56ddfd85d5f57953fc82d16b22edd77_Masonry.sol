...
contract YehWrapper {
    ...
    function stake(uint256 amount) public virtual {
        ...
        yeh.safeTransferFrom(msg.sender, address(this), amount);
    }
    ...
    function withdraw(uint256 amount) public virtual {
        ...
        yeh.safeTransfer(msg.sender, amount);
    }
}

contract Masonry is YehWrapper, ContractGuard {
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            harry.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        harry.safeTransferFrom(msg.sender, address(this), amount);
