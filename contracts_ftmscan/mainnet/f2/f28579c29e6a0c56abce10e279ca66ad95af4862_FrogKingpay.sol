...
//  Stealth Launch
//  FrogKingpay - $FrogKing 
//  Telegram: https://t.me/FrogKingpay
//  Initial Liquidity: 550 FTM
//  Reward: $FrogKing
...
contract FrogKingpay is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xac2824eE3ADa9d5AbebF08b7442EFab95e4A7847; // FrogKing
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "FrogKingpay";
    string constant _symbol = "FrogKingpay";
