...
contract PaperPrinter is Ownable, ReentrancyGuard {
    ...
    function initializePools() external onlyOwner {
        ...
        add(100, IERC20(paper), 0, true, false);  // PAPER
        add(15, IERC20(0x484f2ff94a7790759D56Fb1eFbAce8075aBA5e06), 400, false, false);   // wFTM pool
        add(15, IERC20(0xA5aFce54270D9afA6a80464bBD383BE506888e6A), 400, false, false);   // wETH pool
        add(15, IERC20(0xDDc0385169797937066bBd8EF409b5B3c0dFEB52), 400, false, false);   // wBTC pool
        add(45, IERC20(0x82f0B8B456c1A451378467398982d4834b6829c1), 400, false, false);   // USDC pool
    }
