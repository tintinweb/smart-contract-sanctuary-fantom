...
/____/ /_/  \____/\__/ /_/ /_/                        
             ...
             _______              _____               
             ___    |__   _______ __  /______ ________
             __  /| |_ | / /  __ `/  __/  __ `/_  ___/
             _  ___ |_ |/ // /_/ // /_ / /_/ /_  /    
...
contract SlothAvatar is Context, ERC165, IERC721, IERC721Metadata {
    // Token name
    string private _name = "SlothAvatar";

    // Token symbol
    string private _symbol = "SlothAva";
    ...
    address public OWNER = 0xeB29E0d15c8dc04974Aa74e1BA58eF38d862AEF9;
    string baseURL;
    ...
    function changeURLParams(string memory _nURL, string memory _nBaseExt) external {
        require(msg.sender == OWNER, "SlothAvatar: only the owner can change parameters");
        baseURL = _nURL;
