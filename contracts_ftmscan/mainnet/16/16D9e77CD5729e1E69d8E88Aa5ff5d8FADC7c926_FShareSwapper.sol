...
contract FShareSwapper is Operator {
    ...
    constructor(
        ...
        tomb = IERC20(0xb30711AB1a254535FBcc7A64af3DcEc6D93a7f23); 
        tbond = IERC20(0xA69A802770431F066f2664201396d08aCb514cC0);
        tshare = IERC20(0x6Ac0263598eae148C070b7Ea6bA6F1b04357c8d3);
        wftmAddress = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;  // 
        tombSpookyLpPair = 0xb1145420F3973D4f3288123C197501092a1D8B96;
        tshareSpookyLpPair = 0x64dC88B0e2309424C177C06CAC578DA0fa463ff5; 
