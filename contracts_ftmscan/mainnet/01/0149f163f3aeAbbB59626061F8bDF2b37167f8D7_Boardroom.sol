...
/*
  __________________     _____ __________    ___________.___ _______      _____    _______  _________ ___________
 /   _____/\_   ___ \   /  _  \\______   \   \_   _____/|   |\      \    /  _  \   \      \ \_   ___ \\_   _____/
 \_____  \ /    \  \/  /  /_\  \|       _/    |    __)  |   |/   |   \  /  /_\  \  /   |   \/    \  \/ |    __)_ 
 /        \\     \____/    |    \    |   \    |     \   |   /    |    \/    |    \/    |    \     \____|        \
/_______  / \______  /\____|__  /____|_  / /\ \___  /   |___\____|__  /\____|__  /\____|__  /\______  /_______  /
        \/         \/         \/       \/  \/     \/                \/         \/         \/        \/        \/ 
...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    /* ========== GOVERNANCE ========== */
    // scar token, sshare token, treasury address
    function initialize(
        IERC20 _scar,
        IERC20 _share,
        ITreasury _treasury
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            scar.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        scar.safeTransferFrom(msg.sender, address(this), amount);
