...
contract ZoomShare is ERC20Burnable, Operator {
    using SafeMath for uint256;
    ...
    constructor(uint256 _startTime, address _devFund) public ERC20("ZSHARE Token", "ZSHARE") {
        _mint(msg.sender, 10 ether); // mint 1 ZOOM Share for initial pools deployment
