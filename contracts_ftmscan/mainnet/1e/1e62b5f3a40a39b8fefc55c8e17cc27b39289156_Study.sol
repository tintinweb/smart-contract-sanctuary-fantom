...
contract Study is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 75,000 STUDY
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 62500 ether;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("STUDY", "STUDY") {
        _mint(msg.sender, 1 ether); // mint 1 STUDY Share for initial pools deployment
