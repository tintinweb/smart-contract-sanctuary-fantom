...
import "../../interfaces/tarot/IXTarot.sol";
import "../Common/StratManager2.sol";
import "../Common/FeeManager2.sol";
import "../../utils/StringUtils.sol";

contract StrategyOxDaoSingle is StratManager2, FeeManager2 {
    ...
    constructor(
        ...
        unstakedWant = _outputToWantRoute[_outputToWantRoute.length - 1];
    ...
    function swapRewards() internal {
        if (want != output) {
            ...
            if (balanceOfUnstakedWant > 0) {
                IXTarot(want).enter(balanceOfUnstakedWant);
            }
        }
    }
