...
contract StrategyDevil_DarkKnight is StrategyDevil {
    ...
    function _farm() internal override virtual {
        ...
        (wantLockedTotal, ) = IScareCrowFarm(farmContractAddress).userInfo(pid, address(this));
    }
