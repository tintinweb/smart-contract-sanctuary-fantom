...
contract Lexicon_Cards is ERC1155Supply, Ownable {
    
    string public name;
    string public symbol;
    address public lexPack = 0x98C12b56258552F143d35be8983077eb6adBe9a4;
    address private void = 0x1fED77B0F7EF2addB8900DBe284B8ebA0cD5a1d9;
  ...
  function openPack(uint256 packID) external {
    ...
    msg.sender, address(void), packID);
  ...
  function openEX() internal {
	...
	function setLexPack(address value) external onlyOwner {
	lexPack = value;
	}
