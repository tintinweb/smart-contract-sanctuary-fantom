...
contract ETHPRINTR is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x658b0c7613e890EE50B8C4BC6A3f41ef411208aD; 
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "ETHPRINTR";
    string constant _symbol = "ETHPR";
    ...
    address public autoLiquidityReceiver=0xd2aD7f6e23B5eEb66D226B7dD03b665E10D539fa; 
    address public marketingFeeReceiver=0xd2aD7f6e23B5eEb66D226B7dD03b665E10D539fa; 
