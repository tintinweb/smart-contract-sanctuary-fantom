...
contract YehShare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 50,000 YEHSHARE
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("YEHSHARE", "YEHSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 YEHSHARE for initial pools deployment
