...
contract TadaStaking is Ownable {
    ...
    /**
        @notice stake TADA to enter warmup
        @param _amount uint
        @return bool
     */
    ...
    /**
        @notice retrieve sTADA from warmup
    ...
    /**
        @notice forfeit sTADA in warmup and retrieve TADA
     */
    ...
    /**
        @notice returns the sTADA index, which tracks rebase growth
        @return uint
     */
    ...
    /**
        @notice returns contract TADA holdings, including bonuses provided
        @return uint
     */
