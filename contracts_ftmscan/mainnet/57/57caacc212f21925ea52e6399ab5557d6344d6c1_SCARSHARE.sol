...
contract SCARSHARE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name     = "scarshare";
    string private _symbol   = "SSCAR";
    ...
    uint256 private _tTotal = 1* 10**0 * 10**9; // 1 quadrillion
