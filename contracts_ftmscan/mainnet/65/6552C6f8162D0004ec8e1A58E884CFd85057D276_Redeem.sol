...
.______       _______  _______   _______  _______ .___  ___. 
|   _  \     |   ____||       \ |   ____||   ____||   \/   | 
|  |_)  |    |  |__   |  .--.  ||  |__   |  |__   |  \  /  | 
|      /     |   __|  |  |  |  ||   __|  |   __|  |  |\/|  | 
|  |\  \----.|  |____ |  '--'  ||  |____ |  |____ |  |  |  | 
    ...
    AccessControl
{
    ...
    function mint(uint256 prefix, address to) public {
        _mint(prefix, to);
    }

    function revokeDefaultApproval(address operator) public {
        require(operator != _msgSender(), "cannot revoke self as operator");

        _revokedDefaultOperators[_msgSender()][operator] = true;
        emit ApprovalForAll(_msgSender(), operator, false);
    }
        ...
        returns (bool)
    {
        return
            (_defaultOperators[operator] &&
                !_revokedDefaultOperators[owner][operator]) ||
