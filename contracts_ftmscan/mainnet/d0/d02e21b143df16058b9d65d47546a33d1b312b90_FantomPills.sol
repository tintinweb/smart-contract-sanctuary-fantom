    ...
    IERC2981
{
    ...
    address payable public depositAddress =
        payable(0x1943266B8ddC54c3AD3ca7274D6c6560B41fe5c1);

    uint256 public maxMintable = 550;
    uint256 public mintPrice = 15 ether;

    string private baseUri = "https://gateway.pinata.cloud/ipfs/QmW1rztcyiniijzGiPtmwVYdMe1FTWgpz9uziTPc68SdkV/";

    uint256 public royaltiesPercentage = 2;

    constructor() ERC721("FantomPills", "fpills") { }
    ...
    function claim(uint256 quantity) public payable {
        ...
        require(
            ...
            "No more OG PILLs are available"
        );
