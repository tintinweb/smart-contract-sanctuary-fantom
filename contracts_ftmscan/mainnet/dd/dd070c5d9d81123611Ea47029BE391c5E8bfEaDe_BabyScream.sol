...
/*
    ...
    t.me/BabyScreamFTM
    Hold BabyScream Gets SCREAM as reward!
...
contract BabyScream is Context, IERC20, Ownable {
    ...
    string private constant _name = 'BabyScream';
    string private constant _symbol = 'BabyScream';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x729B1b66d596A4ac5F663BAbDe2139083371A88e, 'We can not exclude router.');
