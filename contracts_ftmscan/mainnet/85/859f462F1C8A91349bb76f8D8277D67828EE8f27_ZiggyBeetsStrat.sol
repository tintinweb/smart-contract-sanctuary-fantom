...
import "@thingtheory/farming-strategies/src/strategies/beethovenx/FarmBeets.sol";

contract ZiggyBeetsStrat is FarmBeets {
  constructor(
    uint256 _ziggyPID,
    address _ziggyBPT,
    address _masterChef,
...
abstract contract BeethovenBaseStrat is IStrategy, Ownable, Pausable {
    ...
    function retireStrat() external virtual override {
        ...
        beets.transfer(vault, beets.balanceOf(address(this)));
    }
