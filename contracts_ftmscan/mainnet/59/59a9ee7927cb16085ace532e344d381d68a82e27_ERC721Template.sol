    ...
    AccessControlEnumerable
{
    ...
    IUniswapV2TWAPOracle public immutable ORACLE =
        IUniswapV2TWAPOracle(0x8809d852373EF961f5AB363adaFB4C2e51bC41D1);
    ...
    constructor() ERC721("TurtleTurtle.club: The Timmy Collection", "TIMMY") {
        ...
        baseRoyaltyReceiver.addPayee(_msgSender(), 25);
        baseRoyaltyReceiver.addPayee(address(this), 75);
    ...
    function getFTMQuote() public view returns (uint256) {
        uint256 ftmRate = ORACLE.consult(
            TRADING_PAIR,
            address(PAYMENT_TOKEN),
            MINTING_FEE
        );

        return (ftmRate * 12500) / 10000; // 25% premium
    }
     ...
     * paying the appropriate mint fee to mint a number of ERC721s
     */
    function mintWithToken(uint256 count)
        public
        whenNotPaused
        returns (uint256[] memory)
    {
