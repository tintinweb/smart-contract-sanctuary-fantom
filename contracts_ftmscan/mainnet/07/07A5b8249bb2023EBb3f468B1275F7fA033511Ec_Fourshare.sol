...
contract Fourshare is BEP20('4SHARE Token', '4SHARES') {
...
contract Xfourshare is Ownable {
    using SafeMath for uint256;
    ...
    constructor(
        Fourshare _rewardtoken
    ) public {
        rewardtoken = _rewardtoken;
        devaddr = address(0x4453eb2071Cabdd831DCB745af236cec7Cfc9d2A);
        feeAddress = address(0x4453eb2071Cabdd831DCB745af236cec7Cfc9d2A);
