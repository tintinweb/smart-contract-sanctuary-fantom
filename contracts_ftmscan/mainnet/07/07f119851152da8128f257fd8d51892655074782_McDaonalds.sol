...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    address routerAddress = 0x16327E3FbDaCA3bcF7E38F5Af2599D2DDc33aE52; //spirit router
    IBEP20 RewardToken = IBEP20(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75); //usdc
...
contract McDaonalds is IBEP20, Auth {
    ...
    string constant _name = "McDaonald's";
    string constant _symbol = "MCDNLDS";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x16327E3FbDaCA3bcF7E38F5Af2599D2DDc33aE52; //spirit router
    address RewardToken = 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75; //usdc
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x04F3b15571Eb22FBD022Ff7Eb2de892666AB1ED9; //marketing wallet
