...
contract FantomQuestHelms is ERC721Enumerable, Ownable, IERC2981 {
  using Strings for uint256;
  ...
  constructor(
    ...
    // constructor mint of ID 1-10 "aka first 10"
    tokenCounter = 1;
  ...
  */
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    if (whiteListOnly) {
      require(whiteList[msg.sender] == true, "User not white listed");
    }
