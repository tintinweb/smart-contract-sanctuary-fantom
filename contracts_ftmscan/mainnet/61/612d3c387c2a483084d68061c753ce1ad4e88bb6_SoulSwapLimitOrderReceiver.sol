...
// File: contracts/SoulSwapLimitOrderReceiver.sol

pragma solidity >=0.6.12;

contract SoulSwapLimitOrderReceiver is ILimitOrderReceiver {
    using BoringERC20 for IERC20;
    using BoringMath for uint256;
    ...
    function onLimitOrder (IERC20 tokenIn, IERC20 tokenOut, uint256 amountIn, uint256 amountMinOut, bytes calldata data) override external {
        ...
        uint256 amountOut = _swapExactTokensForTokens(amountIn, amountOutMinExternal, path, address(coffinBox));
