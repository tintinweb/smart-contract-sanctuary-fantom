...
contract LotteryNFT is ERC721, Ownable {
    ...
    constructor()  ERC721("Knight Lottery Ticket", "KLT") {}
...
contract Lottery is LotteryOwnable {
    ...
    function setLotteryDuration(uint256 _timeInSecond) public  onlyAdmin{
        lotteryDuration = _timeInSecond;
    }
    ...
    function reset() external onlyAdmin {
        ...
        lastTimestamp = block.timestamp;
        nextDrawTime = block.timestamp.add(lotteryDuration);
        totalAddresses = 0;
        totalAmount = 0;
        winningNumbers[0]=0;
        winningNumbers[1]=0;
