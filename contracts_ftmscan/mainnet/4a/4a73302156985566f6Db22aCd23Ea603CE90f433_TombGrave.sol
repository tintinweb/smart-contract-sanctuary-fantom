...
contract TombGrave is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Tomb Grave';
    string private constant _symbol = 'TGRAVE';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x507FE3832Dd64dD25CC1BC2f2b8F9F6CF8bFFC31, 'We can not exclude router.');
