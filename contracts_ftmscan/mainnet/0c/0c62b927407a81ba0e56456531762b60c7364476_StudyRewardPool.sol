...
// Instead, the governance will call STUDY distributeReward method and send reward to this pool at the beginning.
contract StudyRewardPool {
    ...
    // Safe STUDY transfer function, just in case if rounding error causes pool to not have enough STUDYs.
